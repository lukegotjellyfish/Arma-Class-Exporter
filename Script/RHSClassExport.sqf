...
_mods = [["CfgMagazines","Magazines"],["CfgVehicles","Vehicles"],["CfgWeapons","Weapons"],["CfgGlasses","Glasses"]];
{
	...
	// diag_log(format["START %1", _configClass]);
	// {
...
// mods = ["@RHSAFRF","@RHSUSAF","@RHSGREF","@RHSSAF"];
// {
// 	format["%1 in (configSourceModList _x)", _x] configClasses (configFile) apply {configName _x};
// } forEach _mods;
