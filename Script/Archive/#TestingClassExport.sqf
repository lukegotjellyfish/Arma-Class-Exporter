...
getClass = {
	...
	diag_log(format["Start of getClass: _property: %1", _property]);
	diag_log(format["Start of getClass: _addComma: %1", _addComma]);
	diag_log(format["Start of getClass: _propertyNameLast: %1", _propertyNameLast]);
	diag_log(format["Start of getClass: _configCategory: %1", _configCategoryperty]);
	...
	diag_log(format["End of getClass: _property: %1", _property]);
	diag_log(format["End of getClass: _addComma: %1", _addComma]);
	diag_log(format["End of getClass: _propertyNameLast: %1", _propertyNameLast]);
	diag_log(format["End of getClass: _configCategory: %1", _configCategoryperty]);
...
_basePath = "F:\USBBACKUP\GitHub\Arma-Class-Exporter\Exports\TestVer\";
{
	{
		i = 0;
		_configCategory = "";
