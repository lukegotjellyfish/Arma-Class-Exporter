rhs_ship = {
    # Class: CfgVehicles|RHS_Ship|Turrets [Indent level: 1]
    "turrets": {
    },
    ...
    # Class: CfgVehicles|Ship|Sounds [Indent level: 1],
    "sounds": {
        # Class: CfgVehicles|Ship|Sounds|Engine [Indent level: 2]
        "engine": {
            "sound": "soundEngine",
            "frequency": "(1-randomizer*0.05)*1.2*(thrust*0.7+0.5)",
            "volume": "(thrust*0.5)+0.5"
        },
        # Class: CfgVehicles|Ship|Sounds|Movement [Indent level: 2],
        "movement": {
            "sound": "soundEnviron",
