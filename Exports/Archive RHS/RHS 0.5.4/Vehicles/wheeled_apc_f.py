wheeled_apc_f = {
    ...
    "camshakecoef": 0.05,
    # Class: CfgVehicles|Wheeled_APC_F|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initfov": 0.75,
        "minfov": 0.25,
        "maxfov": 1.25,
    ...
    # Class: CfgVehicles|Wheeled_APC_F|TransportBackpacks [Indent level: 1],
    "transportbackpacks": {
    },
    # Class: CfgVehicles|Wheeled_APC_F|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|Wheeled_APC_F|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|Wheeled_APC_F|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|Wheeled_APC_F|TransportItems|_xx_FirstAidKit [Indent level: 2]
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 4
        }
    ...
    # Class: CfgVehicles|Wheeled_APC_F|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|Wheeled_APC_F|Sounds [Indent level: 1],
    "sounds": {
        # Class: CfgVehicles|Car|Sounds|Engine [Indent level: 2]
        "engine": {
            "sound": "soundEngine",
            "frequency": "(randomizer*0.05+0.95)*rpm*1.2",
            "volume": "thrust*0.5+0.5"
        },
        # Class: CfgVehicles|Car|Sounds|Movement [Indent level: 2],
        "movement": {
            "sound": "soundEnviron",
            "frequency": "1",
    ...
    # Class: CfgVehicles|Wheeled_APC_F|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|Wheeled_APC_F|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            ...
            # Class: CfgVehicles|Wheeled_APC_F|Turrets|MainTurret|Turrets [Indent level: 3],
            "turrets": {
                # Class: CfgVehicles|Wheeled_APC_F|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                    # Class: CfgVehicles|Wheeled_APC_F|Turrets|MainTurret|Turrets|CommanderOptics|Components [Indent level: 5]
                    "components": {
                        # Class: CfgVehicles|Wheeled_APC_F|Turrets|MainTurret|Turrets|CommanderOptics|Components|VehicleSystemsDisplayManagerComponentLeft [Indent level: 6]
                        "vehiclesystemsdisplaymanagercomponentleft": {
                        ...
                        # Class: CfgVehicles|Wheeled_APC_F|Turrets|MainTurret|Turrets|CommanderOptics|Components|VehicleSystemsDisplayManagerComponentRight [Indent level: 6],
                        "vehiclesystemsdisplaymanagercomponentright": {
                    ...
                    # Class: CfgVehicles|Wheeled_APC_F|Turrets|MainTurret|Turrets|CommanderOptics|ViewGunner [Indent level: 5],
                    "viewgunner": {
                        "initanglex": 5,
                        "minanglex": -75,
                        "maxanglex": 85,
    ...
    # Class: CfgVehicles|Car_F|HitPoints [Indent level: 1],
    "hitpoints": {
        ...
        # Class: CfgVehicles|Car_F|HitPoints|HitFuel [Indent level: 2],
        "hitfuel": {
            "armor": 0.5,
            "material": -1,
            "name": "palivo",
        ...
        # Class: CfgVehicles|Car_F|HitPoints|HitLFWheel [Indent level: 2],
        "hitlfwheel": {
            "armor": 0.2,
            "material": -1,
        ...
        # Class: CfgVehicles|Car_F|HitPoints|HitRFWheel [Indent level: 2],
        "hitrfwheel": {
            "armor": 0.2,
            "material": -1,
        ...
        # Class: CfgVehicles|Car_F|HitPoints|HitEngine [Indent level: 2],
        "hitengine": {
            "armor": 0.5,
            "material": -1,
            "name": "motor",
    ...
    # Class: CfgVehicles|Car_F|Reflectors [Indent level: 1],
    "reflectors": {
        # Class: CfgVehicles|Car_F|Reflectors|Left [Indent level: 2]
        "left": {
            ...
            "daylight": 0,
            "flaresize": 1,
            # Class: CfgVehicles|Car_F|Reflectors|Left|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 0,
                "linear": 0,
        ...
        # Class: CfgVehicles|Car_F|Reflectors|Right [Indent level: 2],
        "right": {
            "position": "Light_R",
        ...
        # Class: CfgVehicles|Car_F|Reflectors|Right2 [Indent level: 2],
        "right2": {
        ...
        # Class: CfgVehicles|Car_F|Reflectors|Left2 [Indent level: 2],
        "left2": {
