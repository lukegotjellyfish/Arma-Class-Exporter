rhsusf_assault_eagleaiii_ocp_engineer = {
    ...
    "maximumload": 160,
    "mass": 20,
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_ocp_engineer|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_ocp_engineer|TransportItems|_xx_ToolKit [Indent level: 2]
        "_xx_toolkit": {
            "name": "ToolKit",
            "count": 1
        }
