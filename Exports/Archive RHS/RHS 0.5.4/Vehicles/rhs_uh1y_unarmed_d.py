rhs_uh1y_unarmed_d = {
    ...
    "editorpreview": "rhsusf|addons|rhsusf_editorPreviews|data|RHS_UH1Y_UNARMED_d.paa",
    "forceingarage": 0,
    "displayname": "UH-1Y (Unarmed)",
    # Class: CfgVehicles|RHS_UH1Y_UNARMED|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_UH1Y_UNARMED|AnimationSources|hide_rockets [Indent level: 2]
        "hide_rockets": {
            "initphase": 1,
            "mass": -50,
            "source": "user",
        ...
        # Class: CfgVehicles|RHS_UH1Y_UNARMED|AnimationSources|Hide_Scopes [Indent level: 2],
        "hide_scopes": {
            "displayname": "",
            "source": "user",
            "initphase": 0,
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|AnimationSources|DoorRB [Indent level: 2],
        "doorrb": {
            "source": "door",
            "initphase": 0,
            "animperiod": 1.5,
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|AnimationSources|DoorLB [Indent level: 2],
        "doorlb": {
            "source": "door",
            "initphase": 0,
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|AnimationSources|hide_mg [Indent level: 2],
        "hide_mg": {
            "initphase": 1,
            "displayname": "hide MG",
            "mass": -120,
    ...
    # Class: CfgVehicles|RHS_UH1Y_UNARMED|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_UH1Y_UNARMED|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            "uipicture": "rhsusf|addons|rhsusf_a2port_air2|data|loadouts|RHS_UH1_EDEN_CA.paa",
            # Class: CfgVehicles|RHS_UH1Y_UNARMED|Components|TransportPylonsComponent|pylons [Indent level: 3],
            "pylons": {
                # Class: CfgVehicles|RHS_UH1Y_UNARMED|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4]
                "cmdispenser": {
    ...
    # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
            "primaryobserver": 0,
            "primarygunner": 1,
            "primary": 1,
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
            "gunnerdoor": "DoorRB",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
            "gunnerdoor": "DoorRB",
            "enabledbyanimationsource": "doorRB",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CargoTurret_03 [Indent level: 2],
        "cargoturret_03": {
            "gunnerdoor": "DoorRB",
            "enabledbyanimationsource": "doorRB",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CargoTurret_07 [Indent level: 2],
        "cargoturret_07": {
            "gunnername": "Passenger (Right Bench 4)",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CargoTurret_04 [Indent level: 2],
        "cargoturret_04": {
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CargoTurret_05 [Indent level: 2],
        "cargoturret_05": {
            "enabledbyanimationsource": "doorLB",
            "gunnerdoor": "DoorLB",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CargoTurret_06 [Indent level: 2],
        "cargoturret_06": {
            "enabledbyanimationsource": "doorLB",
            "gunnerdoor": "DoorLB",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Turrets|CargoTurret_08 [Indent level: 2],
        "cargoturret_08": {
            "gunnername": "Passenger (Left Bench 4)",
    ...
    # Class: CfgVehicles|RHS_UH1Y_FFAR|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|RHS_UH1Y_FFAR|UserActions|OpenCargoDoor [Indent level: 2]
        "opencargodoor": {
            "displayname": "Open right cargo door",
            "position": "pos driver",
            "radius": 15,
            "showwindow": 0,
            "condition": "(this animationphase 'hide_CargoDoors' !=1) and this doorPhase 'doorRB' == 0 and (alive this) and player in this;",
            "statement": "this animateDoor ['doorRB', 1];this animate ['doorHandler_R',1]",
            "onlyforplayer": 1
        },
        # Class: CfgVehicles|RHS_UH1Y_FFAR|UserActions|CloseCargoDoor [Indent level: 2],
        "closecargodoor": {
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|UserActions|OpenCargoLDoor [Indent level: 2],
        "opencargoldoor": {
            "displayname": "Open left cargo door",
            "condition": "(this animationphase 'hide_CargoDoors' !=1) and this doorPhase 'doorLB' == 0 and (alive this) and player in this;",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|UserActions|CloseCargoLDoor [Indent level: 2],
        "closecargoldoor": {
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|UserActions|ToggleLight [Indent level: 2],
        "togglelight": {
    ...
    # Class: CfgVehicles|RHS_UH1Y_FFAR|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Attributes|ObjectTexture [Indent level: 2]
        "objecttexture": {
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Attributes|DoorL [Indent level: 2],
        "doorl": {
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Attributes|DoorR [Indent level: 2],
        "doorr": {
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Attributes|DoorLB [Indent level: 2],
        "doorlb": {
            "displayname": "Open right cargo door",
            "property": "DoorLB",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Attributes|DoorRB [Indent level: 2],
        "doorrb": {
            "displayname": "Open right cargo door",
            "property": "DoorRB",
        ...
        # Class: CfgVehicles|RHS_UH1Y_FFAR|Attributes|FoldHeli [Indent level: 2],
        "foldheli": {
    ...
    # Class: CfgVehicles|RHS_UH1Y_FFAR|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|RHS_UH1Y_FFAR|EventHandlers|RHSUSF_EventHandlers [Indent level: 2]
