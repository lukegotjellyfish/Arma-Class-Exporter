rhs_mi8t_vvsc = {
    ...
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_a2port_air|Mi17|data|camo|mi8_body_g_camo1_co.paa","|rhsafrf|addons|rhs_a2port_air|Mi17|data|camo|mi8_det_g_camo1_co.paa","rhsafrf|addons|rhs_a2port_air|mi17|data|mi8t|camo|mi8t_tv2_g_camo1_co.paa","rhsafrf|addons|rhs_a2port_air|mi17|data|mi8_decals_ca.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa","rhsafrf|addons|rhs_decals|data|labels|aviation|vvs_ca.paa"],
    "scope": 2,
    "displayname": "Mi-8T",
    "side": 0,
    ...
    # Class: CfgVehicles|rhs_mi8t_base|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|rhs_mi8t_base|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            "uipicture": "rhsafrf|addons|rhs_a2port_air|data|loadouts|RHS_Mi8_NoPylon_EDEN_CA.paa",
            # Class: CfgVehicles|rhs_mi8t_base|Components|TransportPylonsComponent|pylons [Indent level: 3],
            "pylons": {
                # Class: CfgVehicles|rhs_mi8t_base|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4]
                "cmdispenser": {
    ...
    # Class: CfgVehicles|rhs_mi8t_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_mi8t_base|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
            "proxyindex": 1,
            "gunnername": "Co-pilot",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
            ...
            # Class: CfgVehicles|rhs_mi8t_base|Turrets|CargoTurret_01|Hitpoints [Indent level: 3],
            "hitpoints": {
            },
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Turrets|CargoTurret_03 [Indent level: 2],
        "cargoturret_03": {
    ...
    # Class: CfgVehicles|rhs_mi8t_base|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|standard [Indent level: 2]
        "standard": {
            "displayname": "Grey",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|Civilian [Indent level: 2],
        "civilian": {
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|Camo [Indent level: 2],
        "camo": {
            "displayname": "CDF",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|Camo1 [Indent level: 2],
        "camo1": {
            "displayname": "Chedaki",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|Camo2 [Indent level: 2],
        "camo2": {
            "displayname": "Camo #1",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|Camo3 [Indent level: 2],
        "camo3": {
            "displayname": "Camo #2",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|Camo4 [Indent level: 2],
        "camo4": {
            "displayname": "Camo #3",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|Camo5 [Indent level: 2],
        "camo5": {
            "displayname": "Camo #4",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|RHS_SAF_Camo [Indent level: 2],
        "rhs_saf_camo": {
        ...
        # Class: CfgVehicles|rhs_mi8t_base|textureSources|RHS_SAF_Green [Indent level: 2],
        "rhs_saf_green": {
    ...
    # Class: CfgVehicles|rhs_mi8t_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_mi8t_base|AnimationSources|LeftDoor [Indent level: 2]
        "leftdoor": {
            "source": "door",
            "animperiod": 0.8,
            "initphase": 1
        },
        # Class: CfgVehicles|rhs_mi8t_base|AnimationSources|hide_turrets [Indent level: 2],
        "hide_turrets": {
            "initphase": 1,
            "source": "user",
            "animperiod": 1e-015
        },
        # Class: CfgVehicles|rhs_mi8t_base|AnimationSources|hide_door_hatch [Indent level: 2],
        "hide_door_hatch": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1e-015
        },
        # Class: CfgVehicles|rhs_mi8t_base|AnimationSources|intake_hide [Indent level: 2],
        "intake_hide": {
            "displayname": "",
            "mass": 1,
            "source": "user",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|AnimationSources|antennas_switch [Indent level: 2],
        "antennas_switch": {
            "source": "user",
            "usesource": 1,
        ...
        # Class: CfgVehicles|rhs_mi8t_base|AnimationSources|hide_antennas [Indent level: 2],
        "hide_antennas": {
            "usesource": 0,
        ...
        # Class: CfgVehicles|rhs_mi8t_base|AnimationSources|hide_antenna_aft [Indent level: 2],
        "hide_antenna_aft": {
            "initphase": 1,
        ...
        # Class: CfgVehicles|rhs_mi8t_base|AnimationSources|reardoors_hide [Indent level: 2],
        "reardoors_hide": {
    ...
    # Class: CfgVehicles|rhs_mi8t_base|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|rhs_mi8t_base|Attributes|ObjectTexture [Indent level: 2]
        "objecttexture": {
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Attributes|rhs_decalNumber_type [Indent level: 2],
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Attributes|rhs_decalNumber [Indent level: 2],
        "rhs_decalnumber": {
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Attributes|rhs_decalTail [Indent level: 2],
        "rhs_decaltail": {
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Attributes|rhs_reardoors [Indent level: 2],
        "rhs_reardoors": {
            "displayname": "Open rear doors",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Attributes|rhs_leftdoor [Indent level: 2],
        "rhs_leftdoor": {
    ...
    # Class: CfgVehicles|rhs_mi8t_base|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|rhs_mi8t_base|UserActions|openDoor [Indent level: 2]
        "opendoor": {
            "displayname": "Open Rear Doors",
            "position": "",
            "radius": 3,
        ...
        # Class: CfgVehicles|rhs_mi8t_base|UserActions|closeDoor [Indent level: 2],
        "closedoor": {
            "useractionid": 56,
        ...
        # Class: CfgVehicles|rhs_mi8t_base|UserActions|openDoor_L [Indent level: 2],
        "opendoor_l": {
            "useractionid": 57,
            "displayname": "Open Left Door",
            "position": "",
        ...
        # Class: CfgVehicles|rhs_mi8t_base|UserActions|closeDoor_L [Indent level: 2],
        "closedoor_l": {
            "useractionid": 58,
        ...
        # Class: CfgVehicles|rhs_mi8t_base|UserActions|ToggleLight [Indent level: 2],
        "togglelight": {
        ...
        # Class: CfgVehicles|rhs_mi8t_base|UserActions|WheelBrakes [Indent level: 2],
        "wheelbrakes": {
    ...
    "attendant": 1,
    "threat": [0,0,0],
    # Class: CfgVehicles|rhs_mi8t_base|Reflectors [Indent level: 1],
    "reflectors": {
        # Class: CfgVehicles|rhs_mi8t_base|Reflectors|Left [Indent level: 2]
        "left": {
            "color": [1100,1000,900],
            ...
            "daylight": 0,
            "flaresize": 0.75,
            # Class: CfgVehicles|rhs_mi8t_base|Reflectors|Left|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 1,
                "linear": 0,
        ...
        # Class: CfgVehicles|rhs_mi8t_base|Reflectors|Right [Indent level: 2],
        "right": {
            "position": "P svetlo",
    ...
    # Class: CfgVehicles|rhs_mi8t_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_mi8t_base|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
