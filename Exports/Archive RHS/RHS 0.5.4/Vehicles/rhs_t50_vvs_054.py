rhs_t50_vvs_054 = {
    ...
    "displayname": "T-50 obr. 2012 (054)",
    "author": "Red Hammer Studios",
    "dlc": "RHS_AFRF",
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_air|t50|data|pakfa_bluecamo_co.paa","|rhsafrf|addons|rhs_decals|Data|Numbers|AviaBlue|0_ca.paa","|rhsafrf|addons|rhs_decals|Data|Numbers|AviaBlue|5_ca.paa","|rhsafrf|addons|rhs_decals|Data|Numbers|AviaBlue|4_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|AviationCompanies|sukhoi_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|star_new2_ca.paa","rhsafrf|addons|rhs_c_air|scripts|data|altis_co.paa","rhsafrf|addons|rhs_c_air|scripts|data|WP_move_ca.paa"],
    # Class: CfgVehicles|RHS_T50_vvs_054|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_T50_vvs_054|AnimationSources|antenna_hide [Indent level: 2]
        "antenna_hide": {
            "initphase": 1,
            "source": "user",
            "animperiod": 0.001,
        ...
        # Class: CfgVehicles|RHS_T50_vvs_054|AnimationSources|sensors_hide [Indent level: 2],
        "sensors_hide": {
            "initphase": 1,
