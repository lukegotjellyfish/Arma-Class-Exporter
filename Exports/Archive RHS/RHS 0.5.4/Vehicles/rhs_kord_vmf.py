rhs_kord_vmf = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_KORD_VDV.paa",
    "scope": 2,
    "side": 0,
    ...
    # Class: CfgVehicles|RHS_KORD_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_KORD_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
