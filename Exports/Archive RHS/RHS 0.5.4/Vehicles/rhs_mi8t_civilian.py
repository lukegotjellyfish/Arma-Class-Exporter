rhs_mi8t_civilian = {
    ...
    "faction": "CIV_F",
    "crew": "C_man_1_1_F",
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_a2port_air|Mi17|data|mi8civil_body_g_co.paa","|rhsafrf|addons|rhs_a2port_air|Mi17|data|mi8civil_det_g_co.paa","rhsafrf|addons|rhs_a2port_air|mi17|data|mi8t|mi8tcivil_tv2_g_co.paa","rhsafrf|addons|rhs_a2port_air|mi17|data|mi8_decals_ca.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa"],
    # Class: CfgVehicles|RHS_Mi8t_civilian|EventHandlers [Indent level: 1],
    "eventhandlers": {
    ...
    # Class: CfgVehicles|RHS_Mi8t_civilian|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Mi8t_civilian|AnimationSources|antennas_switch [Indent level: 2]
        "antennas_switch": {
            "initphase": 1,
            "source": "user",
            "usesource": 1,
    ...
    # Class: CfgVehicles|RHS_Mi8t_civilian|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_Mi8t_civilian|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|RHS_Mi8t_civilian|Components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|RHS_Mi8t_civilian|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4]
                "cmdispenser": {
                    "attachment": "",
