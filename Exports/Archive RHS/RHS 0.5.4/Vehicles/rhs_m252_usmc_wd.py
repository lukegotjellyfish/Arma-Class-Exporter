rhs_m252_usmc_wd = {
    ...
    "typicalcargo": ["rhsusf_usmc_marpat_wd_rifleman"],
    "dlc": "RHS_USAF",
    "availableforsupporttypes": ["Artillery"],
    "displayname": "M252",
    # Class: CfgVehicles|RHS_M252_Base|Library [Indent level: 1],
    "library": {
        "libtextdesc": "The M252 81mm Mortar is a medium-weight smooth-bore high-angle-firing weapon. It is usually operated by a 4-man crew and can be fired at ranges from 80 to 5500m. <br/>The weight of the M252 is 41,3 kg and usually it is used for long-range indirect supporting fire."
    },
    ...
    "mapsize": 1.5,
    # Class: CfgVehicles|RHS_M252_Base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|RHS_M252_Base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": -200,
            "minimalhit": -0.1,
    ...
    # Class: CfgVehicles|RHS_M252_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_M252_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            ...
            "maxturn": 180,
            "usepip": 2,
            # Class: CfgVehicles|RHS_M252_Base|Turrets|MainTurret|Hitpoints [Indent level: 3],
            "hitpoints": {
            },
    ...
    # Class: CfgVehicles|RHS_M252_Base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhsusf|addons|rhsusf_m252|data|m252.rvmat","rhsusf|addons|rhsusf_m252|data|m252_damage.rvmat","rhsusf|addons|rhsusf_heavyweapons|data|static_destroyed.rvmat","rhsusf|addons|rhsusf_m252|data|m252_chrome.rvmat","rhsusf|addons|rhsusf_m252|data|m252_damage.rvmat","rhsusf|addons|rhsusf_heavyweapons|data|static_destroyed.rvmat"]
    },
    "htmin": 1,
    "htmax": 480,
    "afmax": 0,
    ...
    "tbody": 100,
    "artilleryscanner": 1,
    # Class: CfgVehicles|RHS_M252_Base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
    ...
    # Class: CfgVehicles|RHS_M252_Base|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_1_type [Indent level: 2]
        "rhs_ammoslot_1_type": {
            ...
            "defaultvalue": 0,
            "typename": "STRING",
            # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_1_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_1_type|values|rhs_1Rnd_m821_HE [Indent level: 4]
                "rhs_1rnd_m821_he": {
                    "name": "He-FRAG M821",
        ...
        # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_1 [Indent level: 2],
        "rhs_ammoslot_1": {
        ...
        # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_2_type [Indent level: 2],
        "rhs_ammoslot_2_type": {
            "displayname": "Ammo slot #2 type",
            "tooltip": "Define type of shell for #2 slot [Smoke rounds]",
            "property": "rhs_ammoslot_2_type",
            # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_2_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_2_type|values|8Rnd_82mm_Mo_Smoke_white [Indent level: 4]
        ...
        # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_2 [Indent level: 2],
        "rhs_ammoslot_2": {
        ...
        # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_3_type [Indent level: 2],
        "rhs_ammoslot_3_type": {
            "displayname": "Ammo slot #3 type",
            "tooltip": "Define type of shell for #3 slot [Illumination rounds]",
            "property": "rhs_ammoslot_3_type",
            # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_3_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_3_type|values|8Rnd_82mm_Mo_Flare_white [Indent level: 4]
        ...
        # Class: CfgVehicles|RHS_M252_Base|Attributes|rhs_ammoslot_3 [Indent level: 2],
        "rhs_ammoslot_3": {
