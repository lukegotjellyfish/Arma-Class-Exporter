rhs_f22_canopy = {
    ...
    # Class: CfgVehicles|rhs_f22_canopy|DestructionEffects [Indent level: 1],
    "destructioneffects": {
    },
    # Class: CfgVehicles|rhs_f22_canopy|UserActions [Indent level: 1],
    "useractions": {
    },
    "driveoncomponent": [],
    # Class: CfgVehicles|rhs_f22_canopy|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|rhs_f22_canopy|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhs_f22_canopy|TransportItems [Indent level: 1],
    "transportitems": {
    },
    # Class: CfgVehicles|rhs_f22_canopy|Eventhandlers [Indent level: 1],
    "eventhandlers": {
