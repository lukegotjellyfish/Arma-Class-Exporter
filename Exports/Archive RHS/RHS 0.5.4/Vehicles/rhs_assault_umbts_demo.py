rhs_assault_umbts_demo = {
    ...
    # Class: CfgVehicles|rhs_assault_umbts_demo|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhs_assault_umbts_demo|TransportItems|_xx_ToolKit [Indent level: 2]
        "_xx_toolkit": {
            "name": "ToolKit",
            "count": 1
        },
        # Class: CfgVehicles|rhs_assault_umbts_demo|TransportItems|_xx_DemoCharge_Remote_Mag [Indent level: 2],
