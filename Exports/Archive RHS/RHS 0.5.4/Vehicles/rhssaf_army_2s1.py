rhssaf_army_2s1 = {
    ...
    "scope": 2,
    "texturelist": ["RHS_SAF_Camo",1,"light",0.3],
    "rhs_decalparameters": ["['Number', cRHS2S1SerbianNumberPlaces,'CDF']"],
    # Class: CfgVehicles|rhssaf_army_2s1|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhssaf_army_2s1|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhssaf_army_2s1|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhssaf_army_2s1|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                ...
                # Class: CfgVehicles|rhssaf_army_2s1|Turrets|MainTurret|Turrets|LoaderOptics [Indent level: 4],
                "loaderoptics": {
