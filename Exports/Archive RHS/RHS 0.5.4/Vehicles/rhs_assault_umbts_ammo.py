rhs_assault_umbts_ammo = {
    "scope": 1,
    # Class: CfgVehicles|rhs_assault_umbts_ammo|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhs_assault_umbts_ammo|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2]
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 2
        },
        # Class: CfgVehicles|rhs_assault_umbts_ammo|TransportMagazines|_xx_rhs_mag_rdg2_white [Indent level: 2],
        "_xx_rhs_mag_rdg2_white": {
            "magazine": "rhs_mag_rdg2_white",
            "count": 2
        },
        # Class: CfgVehicles|rhs_assault_umbts_ammo|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
        "_xx_rhs_mag_nspn_red": {
            "magazine": "rhs_mag_nspn_red",
            "count": 1
        },
        # Class: CfgVehicles|rhs_assault_umbts_ammo|TransportMagazines|_xx_rhs_30Rnd_545x39_7N10_AK [Indent level: 2],
