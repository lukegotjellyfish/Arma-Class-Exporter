rhsusf_m977a4_repair_usarmy_d = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_hemtt_a4|data|CAB_CO_Des.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CARGO_des_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CHASSIS_des_CO.paa"],
    "displayname": "M977A4 (Repair)",
    "model": "rhsusf|addons|rhsusf_hemtt_a4|M977A4_REPAIR_WD",
    "memorypointsupply": "doplnovani",
    "transportrepair": 2e+008,
    "supplyradius": 12,
    # Class: CfgVehicles|rhsusf_M977A4_REPAIR_usarmy_wd|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhsusf_M977A4_REPAIR_usarmy_wd|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
    ...
    # Class: CfgVehicles|rhsusf_M977A4_usarmy_wd|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhsusf_M977A4_usarmy_wd|textureSources|rhs_woodland [Indent level: 2]
        "rhs_woodland": {
            "displayname": "Woodland",
            "author": "Red Hammer Studios",
            "textures": ["rhsusf|addons|rhsusf_hemtt_a4|data|CAB_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CARGO_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CHASSIS_CO.paa"],
            "factions": []
        },
        # Class: CfgVehicles|rhsusf_M977A4_usarmy_wd|textureSources|rhs_desert [Indent level: 2],
        "rhs_desert": {
            "displayname": "Desert",
            "author": "Red Hammer Studios",
            "textures": ["rhsusf|addons|rhsusf_hemtt_a4|data|CAB_CO_Des.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CARGO_DES_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CHASSIS_DES_CO.paa"],
            "factions": []
        }
    },
    "texturelist": [],
