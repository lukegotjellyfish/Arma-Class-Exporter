rhssaf_kitbag_smb_aat = {
    ...
    "scope": 1,
    "scopecurator": 0,
    # Class: CfgVehicles|rhssaf_Kitbag_smb_AAT|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhssaf_Kitbag_smb_AAT|TransportMagazines|_xx_rhs_mag_smaw_HEAA [Indent level: 2]
        "_xx_rhs_mag_smaw_heaa": {
            "magazine": "rhs_mag_smaw_HEAA",
            "count": 2
        },
        # Class: CfgVehicles|rhssaf_Kitbag_smb_AAT|TransportMagazines|_xx_rhs_mag_smaw_SR [Indent level: 2],
        "_xx_rhs_mag_smaw_sr": {
