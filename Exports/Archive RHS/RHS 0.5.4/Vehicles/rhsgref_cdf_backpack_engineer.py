rhsgref_cdf_backpack_engineer = {
    ...
    # Class: CfgVehicles|rhsgref_cdf_backpack_engineer|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsgref_cdf_backpack_engineer|TransportItems|_xx_ToolKit [Indent level: 2]
        "_xx_toolkit": {
            "name": "ToolKit",
            "count": 1
        }
