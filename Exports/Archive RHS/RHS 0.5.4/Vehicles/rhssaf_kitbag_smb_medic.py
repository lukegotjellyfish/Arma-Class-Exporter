rhssaf_kitbag_smb_medic = {
    ...
    "scope": 1,
    "scopecurator": 0,
    # Class: CfgVehicles|rhssaf_Kitbag_smb_Medic|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhssaf_Kitbag_smb_Medic|TransportItems|_xx_Medikit [Indent level: 2]
        "_xx_medikit": {
            "name": "Medikit",
            "count": 1
        },
        # Class: CfgVehicles|rhssaf_Kitbag_smb_Medic|TransportItems|_xx_FirstAidKit [Indent level: 2],
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 10
        }
