rhs_mi24v_upk23_vdv = {
    ...
    # Class: CfgVehicles|RHS_Mi24V_UPK23_vdv|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Mi24V_UPK23_vdv|AnimationSources|exhaust_hide [Indent level: 2]
        "exhaust_hide": {
            "source": "user",
            "initphase": 1,
            "animperiod": 1e-005
    ...
    # Class: CfgVehicles|RHS_Mi24V_UPK23_vdv|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|RHS_Mi24V_UPK23_vdv|Exhausts|Exhaust01 [Indent level: 2]
        "exhaust01": {
            "direction": "exhaust1_dir",
            "position": "exhaust1",
            "effect": "ExhaustEffectHeli"
        },
        # Class: CfgVehicles|RHS_Mi24V_UPK23_vdv|Exhausts|Exhaust02 [Indent level: 2],
        "exhaust02": {
