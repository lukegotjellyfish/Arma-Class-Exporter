rhsusf_assault_eagleaiii_coy_mg = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_mg|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_mg|TransportItems|_xx_rhsusf_50Rnd_762x51 [Indent level: 2]
