rhs_flag_insurgents = {
    ...
    # Class: CfgVehicles|rhs_Flag_Insurgents|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_Flag_Insurgents|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
