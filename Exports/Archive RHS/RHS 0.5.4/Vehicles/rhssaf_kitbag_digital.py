rhssaf_kitbag_digital = {
    ...
    "scope": 2,
    "scopecurator": 2,
    # Class: CfgVehicles|rhssaf_kitbag_digital|SimpleObject [Indent level: 1],
    "simpleobject": {
    ...
    "displayname": "Kitbag (Digital)",
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["|rhssaf|addons|rhssaf_t_gear_a3|data|backpack_rhssaf_fast_digital_co.paa"],
