rhs_t50_vvs_051 = {
    ...
    "dlc": "RHS_AFRF",
    "displayname": "T-50 obr. 2011 (051)",
    "rhs_decalparameters": [],
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_air|t50|data|pakfa_bluecamo_co.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Numbers|AviaBlue|5_ca.paa","|rhsafrf|addons|rhs_decals|Data|Numbers|AviaBlue|1_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|AviationCompanies|sukhoi_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|star_new2_ca.paa","rhsafrf|addons|rhs_c_air|scripts|data|altis_co.paa","rhsafrf|addons|rhs_c_air|scripts|data|WP_move_ca.paa"],
