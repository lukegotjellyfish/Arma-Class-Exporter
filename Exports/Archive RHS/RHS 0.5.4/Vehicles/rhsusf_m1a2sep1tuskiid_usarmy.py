rhsusf_m1a2sep1tuskiid_usarmy = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_m1a2|data|rhsusf_m1a2sepv1tuskii_d_01_co.paa","rhsusf|addons|rhsusf_m1a2|data|rhsusf_m1a2sepv1tuskii_d_02_co.paa","rhsusf|addons|rhsusf_m1a1|data|rhsusf_m1a1aim_d_03_co.paa","rhsusf|addons|rhsusf_m1a1|loaderspintle|data|loaderspintle_tuski_d_co.paa","rhsusf|addons|rhsusf_m1a2|data|rhsusf_tuskiia2_d_co.paa","rhsusf|addons|rhsusf_m1a2|data|rhsusf_m1slat_d_co.paa","rhsusf|addons|rhsusf_m1a1|duke|data|duke_antennae_d_co.paa"],
    "author": "Red Hammer Studios",
    "faction": "rhs_faction_usarmy_d",
    "vehicleclass": "rhs_vehclass_tank",
    "crew": "rhsusf_army_ocp_combatcrewman",
    "rhs_decalparameters": ["['Label', cM1PlnSymPlaces, 'ArmyPlt_Abrams_D']","['Label', cM1BarrelSymPlaces, 'BarrelArt_Abrams_D']"],
    ...
    # Class: CfgVehicles|rhsusf_m1a2sep1tuskiiwd_usarmy|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhsusf_m1a2sep1tuskiiwd_usarmy|textureSources|woodland [Indent level: 2]
        "woodland": {
        ...
        # Class: CfgVehicles|rhsusf_m1a2sep1tuskiiwd_usarmy|textureSources|desert [Indent level: 2],
        "desert": {
            "displayname": "Desert",
            "author": "Red Hammer Studios",
    ...
    "turrets": {
        ...
        "mainturret": {
            ...
            "turrets": {
                ...
                # Class: CfgVehicles|rhsusf_m1a2sep1tuskiiwd_usarmy|Turrets|MainTurret|Turrets|LoaderMG [Indent level: 4],
                "loadermg": {
                    "maxturn": 117,
                    "proxyindex": 4,
                    "dontcreateai": 1,
