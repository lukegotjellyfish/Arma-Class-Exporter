rhs_uh1h_un = {
    ...
    "typicalcargo": ["rhsgref_cdf_un_pilot"],
    ...
    "getinproxyorder": [2,3,1,4,5,6,9,7,8,10],
    # Class: CfgVehicles|rhs_uh1h_un|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhs_uh1h_un|TransportItems [Indent level: 1],
    "transportitems": {
    },
    # Class: CfgVehicles|rhs_uh1h_un|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    "hiddenselections": ["Camo1","Camo2","Camo_mlod","decals"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_air|uh1h|data|uh1h_un_co.paa","rhsgref|addons|rhsgref_air|uh1h|data|uh1h_un_in_co.paa","rhsgref|addons|rhsgref_air|uh1h|data|mlod_un_co.paa","rhsgref|addons|rhsgref_air|uh1h|data|decals|uh1h_un_decals_ca.paa"],
    # Class: CfgVehicles|rhs_uh1h_un|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_uh1h_un|AnimationSources|Hide_mid_doors [Indent level: 2]
        "hide_mid_doors": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_uh1h_un|AnimationSources|Hide_guns [Indent level: 2],
        "hide_guns": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 1
    ...
    # Class: CfgVehicles|rhs_uh1h_un|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|rhs_uh1h_un|UserActions|Open_Side_Doors [Indent level: 2]
        "open_side_doors": {
        ...
        # Class: CfgVehicles|rhs_uh1h_un|UserActions|Close_Side_Doors [Indent level: 2],
        "close_side_doors": {
    ...
    # Class: CfgVehicles|rhs_uh1h_un|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|rhs_uh1h_un|Attributes|close_cargo_doors [Indent level: 2]
        "close_cargo_doors": {
    ...
    # Class: CfgVehicles|rhs_uh1h_un|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_uh1h_un|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
            "caneject": 0,
            "iscopilot": 1,
            "hideweaponsgunner": 0,
    ...
    "irscanrangemax": 1000,
    "irscantoeyefactor": 2,
    # Class: CfgVehicles|rhs_uh1h_base|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|hidf_grey [Indent level: 2]
        "hidf_grey": {
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|hidf_summer [Indent level: 2],
        "hidf_summer": {
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|hidf_tropical [Indent level: 2],
        "hidf_tropical": {
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|hidf_olv [Indent level: 2],
        "hidf_olv": {
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|hidf_tan [Indent level: 2],
        "hidf_tan": {
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|us_army [Indent level: 2],
        "us_army": {
            "displayname": "US Army",
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|us_army_med [Indent level: 2],
        "us_army_med": {
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|black [Indent level: 2],
        "black": {
            "displayname": "Black",
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|iraq [Indent level: 2],
        "iraq": {
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|takistan [Indent level: 2],
        "takistan": {
        ...
        # Class: CfgVehicles|rhs_uh1h_base|textureSources|guerilla [Indent level: 2],
        "guerilla": {
