rhs_assault_umbts_medic = {
    ...
    # Class: CfgVehicles|rhs_assault_umbts_medic|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhs_assault_umbts_medic|TransportItems|_xx_MediKit [Indent level: 2]
        "_xx_medikit": {
            "name": "MediKit",
            "count": 1
        },
        # Class: CfgVehicles|rhs_assault_umbts_medic|TransportItems|_xx_FirstAidKit [Indent level: 2],
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 10
        }
