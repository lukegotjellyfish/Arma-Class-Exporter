rhsgref_weapons_crate = {
    ...
    # Class: CfgVehicles|rhsgref_weapons_crate|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "[_this select 0,0] call rhs_fnc_virtualAmmoBoxGREF;"
    },
    "slx_xeh_disabled": 1,
    # Class: CfgVehicles|rhsgref_weapons_crate|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|rhsgref_weapons_crate|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhsgref_weapons_crate|TransportItems [Indent level: 1],
    "transportitems": {
    },
    "mapsize": 1.23,
    # Class: CfgVehicles|Box_Syndicate_Wps_F|SimpleObject [Indent level: 1],
    "simpleobject": {
        "eden": 1,
        "animate": [],
        "hide": [],
