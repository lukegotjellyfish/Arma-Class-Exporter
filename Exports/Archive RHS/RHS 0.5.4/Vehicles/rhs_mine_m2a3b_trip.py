rhs_mine_m2a3b_trip = {
    ...
    "scope": 2,
    # Ammo: CfgVehicles|rhs_mine_m2a3b_trip|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_mine_m2a3b_trip_ammo",
        ...
        # Ammo: CfgAmmo|rhs_mine_m2a3b_press_ammo|submunitionAmmo [Indent level: 1],
        "submunitionammo1": {
