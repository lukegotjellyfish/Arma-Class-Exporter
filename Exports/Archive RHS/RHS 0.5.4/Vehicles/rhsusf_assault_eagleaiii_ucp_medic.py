rhsusf_assault_eagleaiii_ucp_medic = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_medic|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_medic|TransportItems|_xx_MediKit [Indent level: 2]
        "_xx_medikit": {
            "name": "MediKit",
            "count": 1
        },
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_medic|TransportItems|_xx_FirstAidKit [Indent level: 2],
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 10
        }
