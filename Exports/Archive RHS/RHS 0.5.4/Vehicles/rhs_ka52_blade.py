rhs_ka52_blade = {
    ...
    "driveoncomponent": [],
    # Class: CfgVehicles|rhs_ka52_blade|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|rhs_ka52_blade|UserActions [Indent level: 1],
    "useractions": {
    },
    # Class: CfgVehicles|rhs_ka52_blade|Eventhandlers [Indent level: 1],
    "eventhandlers": {
