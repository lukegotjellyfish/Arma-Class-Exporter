cruisemissile2 = {
    "scope": 1,
    "displayname": "Cruise Missile 2",
    "model": "rhsusf|addons|rhsusf_a2port_air2|CruiseMissile|cruisemissile3",
    "weapons": [],
    "magazines": [],
    "soundengine": ["",1,0.5],
    "soundenviron": ["",0.316228,1],
    "soundcrash": ["",0.1,1],
    "soundgear": ["",0.000177828,1],
    "soundservo": ["",0.1,0.4],
    "maxspeed": 880,
    "animated": 0,
    # Class: CfgVehicles|CruiseMissile2|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|CruiseMissile2|EventHandlers [Indent level: 1],
    "eventhandlers": {
    },
    "slx_xeh_disabled": 1,
    "author": "Bohemia Interactive",
    # Class: CfgVehicles|B_UGV_01_F|SimpleObject [Indent level: 1],
    "simpleobject": {
        "eden": 1,
    ...
    "mapsize": 5.33,
    # Class: CfgVehicles|UGV_01_base_F|SpeechVariants [Indent level: 1],
    "speechvariants": {
        # Class: CfgVehicles|UGV_01_base_F|SpeechVariants|Default [Indent level: 2]
        "default": {
    ...
    "buildcrash0": ["A3|sounds_f|Vehicles|armor|noises|tank_building_01",1.77828,1,200],
    "buildcrash1": ["A3|sounds_f|Vehicles|armor|noises|tank_building_02",1.77828,1,200],
    "buildcrash2": ["A3|sounds_f|Vehicles|armor|noises|tank_building_03",1.77828,1,200],
    "buildcrash3": ["A3|sounds_f|Vehicles|armor|noises|tank_building_04",1.77828,1,200],
    "soundbuildingcrash": ["buildCrash0",0.25,"buildCrash1",0.25,"buildCrash2",0.25,"buildCrash3",0.25],
    "woodcrash0": ["A3|sounds_f|Vehicles|armor|noises|tank_wood_01",1.77828,1,200],
    "woodcrash1": ["A3|sounds_f|Vehicles|armor|noises|tank_wood_02",1.77828,1,200],
    "woodcrash2": ["A3|sounds_f|Vehicles|armor|noises|tank_wood_03",1.77828,1,200],
    "woodcrash3": ["A3|sounds_f|Vehicles|armor|noises|tank_wood_04",1.77828,1,200],
    "soundwoodcrash": ["woodCrash0",0.25,"woodCrash1",0.25,"woodCrash2",0.25,"woodCrash3",0.25],
    "armorcrash0": ["A3|sounds_f|Vehicles|armor|noises|tank_vehicle_01",1.77828,1,200],
    "armorcrash1": ["A3|sounds_f|Vehicles|armor|noises|tank_vehicle_02",1.77828,1,200],
    "armorcrash2": ["A3|sounds_f|Vehicles|armor|noises|tank_vehicle_03",1.77828,1,200],
    "armorcrash3": ["A3|sounds_f|Vehicles|armor|noises|tank_vehicle_04",1.77828,1,200],
    ...
    # Class: CfgVehicles|UGV_01_base_F|Sounds [Indent level: 1],
    "sounds": {
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Idle_ext [Indent level: 2]
        "idle_ext": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine [Indent level: 2],
        "engine": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine1_ext [Indent level: 2],
        "engine1_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_1400rpm",0.707946,0.8,200],
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine2_ext [Indent level: 2],
        "engine2_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_2000rpm",0.794328,0.8,250],
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine3_ext [Indent level: 2],
        "engine3_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_2400rpm",1.12202,0.8,300],
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine4_ext [Indent level: 2],
        "engine4_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_2600rpm",1.41254,0.8,350],
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine5_ext [Indent level: 2],
        "engine5_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_3200rpm",1.77828,0.8,400],
            "frequency": "0.8	+	((rpm/	3200) factor[(2700/	3200),(3200/	3200)])*0.1",
            "volume": "engineOn*camPos*((rpm/	3200) factor[(2700/	3200),(2900/	3200)])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|IdleThrust [Indent level: 2],
        "idlethrust": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_0800_exhaust",1,0.8,250],
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|EngineThrust [Indent level: 2],
        "enginethrust": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_1000rpm_exhaust",1.25893,0.8,300],
            "frequency": "0.8	+	((rpm/	3200) factor[(800/	3200),(1500/	3200)])*0.2",
            "volume": "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3200) factor[(800/	3200),(900/	3200)])	*	((rpm/	3200) factor[(1500/	3200),(1100/	3200)]))"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine1_Thrust_ext [Indent level: 2],
        "engine1_thrust_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_1400rpm_exhaust",1.41254,0.8,350],
            "frequency": "0.8	+	((rpm/	3200) factor[(1100/	3200),(1950/	3200)])*0.2",
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine2_Thrust_ext [Indent level: 2],
        "engine2_thrust_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_2000rpm_exhaust",1.58489,0.8,400],
            "frequency": "0.8	+	((rpm/	3200) factor[(1600/	3200),(2300/	3200)])*0.2",
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine3_Thrust_ext [Indent level: 2],
        "engine3_thrust_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_2400rpm_exhaust",1.99526,0.8,450],
            "frequency": "0.8	+	((rpm/	3200) factor[(2000/	3200),(2650/	3200)])*0.1",
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine4_Thrust_ext [Indent level: 2],
        "engine4_thrust_ext": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_ext_2600rpm_exhaust",1.99526,0.8,450],
            "frequency": "0.8	+	((rpm/	3200) factor[(2400/	3200),(3000/	3200)])*0.1",
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine5_Thrust_ext [Indent level: 2],
        "engine5_thrust_ext": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Idle_int [Indent level: 2],
        "idle_int": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine_int [Indent level: 2],
        "engine_int": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_int_1000rpm",0.446684,0.8],
            "frequency": "0.8	+	((rpm/	3200) factor[(800/	3200),(1500/	3200)])*0.2",
            "volume": "engineOn*(1-camPos)*(((rpm/	3200) factor[(800/	3200),(900/	3200)])	*	((rpm/	3200) factor[(1500/	3200),(1100/	3200)]))"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine1_int [Indent level: 2],
        "engine1_int": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_int_1400rpm",0.501187,0.8],
            "frequency": "0.8	+	((rpm/	3200) factor[(1100/	3200),(1950/	3200)])*0.2",
            "volume": "engineOn*(1-camPos)*(((rpm/	3200) factor[(1050/	3200),(1450/	3200)])	*	((rpm/	3200) factor[(1900/	3200),(1600/	3200)]))"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine2_int [Indent level: 2],
        "engine2_int": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_int_2000rpm",0.501187,0.8],
            "frequency": "0.8	+	((rpm/	3200) factor[(1600/	3200),(2300/	3200)])*0.2",
            "volume": "engineOn*(1-camPos)*(((rpm/	3200) factor[(1560/	3200),(1880/	3200)])	*	((rpm/	3200) factor[(2350/	3200),(2000/	3200)]))"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine3_int [Indent level: 2],
        "engine3_int": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine4_int [Indent level: 2],
        "engine4_int": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine5_int [Indent level: 2],
        "engine5_int": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|IdleThrust_int [Indent level: 2],
        "idlethrust_int": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_int_0800_exhaust",0.501187,0.8],
            "frequency": "0.8	+	((rpm/	3200) factor[(300/	3200),(950/	3200)])*0.15",
            "volume": "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3200) factor[(300/	3200),(600/	3200)])	*	((rpm/	3200) factor[(960/	3200),(800/	3200)]))"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|EngineThrust_int [Indent level: 2],
        "enginethrust_int": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine1_Thrust_int [Indent level: 2],
        "engine1_thrust_int": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine2_Thrust_int [Indent level: 2],
        "engine2_thrust_int": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine3_Thrust_int [Indent level: 2],
        "engine3_thrust_int": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_int_2400rpm_exhaust",0.707946,0.8],
            "frequency": "0.8	+	((rpm/	3200) factor[(2000/	3200),(2650/	3200)])*0.1",
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine4_Thrust_int [Indent level: 2],
        "engine4_thrust_int": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_int_2600rpm_exhaust",0.794328,0.8],
            "frequency": "0.8	+	((rpm/	3200) factor[(2400/	3200),(3000/	3200)])*0.1",
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Engine5_Thrust_int [Indent level: 2],
        "engine5_thrust_int": {
            "sound": ["A3|Sounds_F|vehicles|soft|UGV_01|UGV_01_int_3200rpm_exhaust",1,0.8],
            "frequency": "0.8	+	((rpm/	3200) factor[(2700/	3200),(3200/	3200)])*0.1",
            "volume": "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*((rpm/	3200) factor[(2700/	3200),(2900/	3200)])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|Movement [Indent level: 2],
        "movement": {
            "sound": "soundEnviron",
            "frequency": "1",
            "volume": "0"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresRockOut [Indent level: 2],
        "tiresrockout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext_tires_dirt_soft_1",1,1,60],
            "frequency": 1,
            "volume": "camPos*rock*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresSandOut [Indent level: 2],
        "tiressandout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext-tires-sand1",1,1,60],
            "frequency": 1,
            "volume": "camPos*sand*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresGrassOut [Indent level: 2],
        "tiresgrassout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext_tires_dirt_soft_2",1,1,60],
            "frequency": 1,
            "volume": "camPos*grass*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresMudOut [Indent level: 2],
        "tiresmudout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext-tires-mud2",1,1,60],
            "frequency": 1,
            "volume": "camPos*mud*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresGravelOut [Indent level: 2],
        "tiresgravelout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext_tires_gravel_1",1,1,60],
            "frequency": 1,
            "volume": "camPos*gravel*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresAsphaltOut [Indent level: 2],
        "tiresasphaltout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext_tires_asfalt_2",1,1,60],
            "frequency": 1,
            "volume": "camPos*asphalt*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|NoiseOut [Indent level: 2],
        "noiseout": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|noise_int_car_3",1,1,90],
            "frequency": 1,
            "volume": "camPos*(damper0 max 0.02)*(speed factor[0, 8])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresRockIn [Indent level: 2],
        "tiresrockin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int_tires_dirt_soft_1",0.707946,1],
            "frequency": 1,
            "volume": "(1-camPos)*rock*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresSandIn [Indent level: 2],
        "tiressandin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int-tires-sand2",0.707946,1],
            "frequency": 1,
            "volume": "(1-camPos)*sand*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresGrassIn [Indent level: 2],
        "tiresgrassin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int_tires_dirt_soft_2",0.707946,1],
            "frequency": 1,
            "volume": "(1-camPos)*grass*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresMudIn [Indent level: 2],
        "tiresmudin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int-tires-mud2",0.707946,1],
            "frequency": 1,
            "volume": "(1-camPos)*mud*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresGravelIn [Indent level: 2],
        "tiresgravelin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int_tires_gravel_1",0.707946,1],
            "frequency": 1,
            "volume": "(1-camPos)*gravel*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|TiresAsphaltIn [Indent level: 2],
        "tiresasphaltin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int_tires_asfalt_2",0.707946,1],
            "frequency": 1,
            "volume": "(1-camPos)*asphalt*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|NoiseIn [Indent level: 2],
        "noisein": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|noise_int_car_3",0.707946,1],
            "frequency": 1,
            "volume": "(damper0 max 0.1)*(speed factor[0, 8])*(1-camPos)"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|breaking_ext_road [Indent level: 2],
        "breaking_ext_road": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|acceleration_ext_road [Indent level: 2],
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|turn_left_ext_road [Indent level: 2],
        "turn_left_ext_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02",1,1,100],
            "frequency": 1,
            "volume": "engineOn*camPos*(latSlipDrive factor[0.15, 0.4])*(speed factor[0, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|turn_right_ext_road [Indent level: 2],
        "turn_right_ext_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02",1,1,100],
            "frequency": 1,
            "volume": "engineOn*camPos*(latSlipDrive factor[-0.15, -0.4])*(speed factor[0, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|breaking_ext_dirt [Indent level: 2],
        "breaking_ext_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_04",1,1,100],
            "frequency": 1,
            "volume": "engineOn*camPos*(LongSlipDrive factor[-0.2, -0.4])*(speed factor[2, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|acceleration_ext_dirt [Indent level: 2],
        "acceleration_ext_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02",1,1,100],
            "frequency": 1,
            "volume": "engineOn*camPos*(LongSlipDrive factor[0.2, 0.4])*(speed factor[10, 1])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|turn_left_ext_dirt [Indent level: 2],
        "turn_left_ext_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02",1,1,100],
            "frequency": 1,
            "volume": "engineOn*camPos*(latSlipDrive factor[0.15, 0.4])*(speed factor[0, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|turn_right_ext_dirt [Indent level: 2],
        "turn_right_ext_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02",1,1,100],
            "frequency": 1,
            "volume": "engineOn*camPos*(latSlipDrive factor[-0.15, -0.4])*(speed factor[0, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|breaking_int_road [Indent level: 2],
        "breaking_int_road": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|acceleration_int_road [Indent level: 2],
        ...
        # Class: CfgVehicles|UGV_01_base_F|Sounds|turn_left_int_road [Indent level: 2],
        "turn_left_int_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02_int",1,1],
            "frequency": 1,
            "volume": "engineOn*(1-camPos)*(latSlipDrive factor[0.15, 0.4])*(speed factor[0, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|turn_right_int_road [Indent level: 2],
        "turn_right_int_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02_int",1,1],
            "frequency": 1,
            "volume": "engineOn*(1-camPos)*(latSlipDrive factor[-0.15, -0.4])*(speed factor[0, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|breaking_int_dirt [Indent level: 2],
        "breaking_int_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_04_int",1,1],
            "frequency": 1,
            "volume": "engineOn*(1-camPos)*(LongSlipDrive factor[-0.4, -0.8])*(speed factor[2, 6])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|acceleration_int_dirt [Indent level: 2],
        "acceleration_int_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02_int",1,1],
            "frequency": 1,
            "volume": "engineOn*(1-camPos)*(LongSlipDrive factor[0.4, 0.8])*(speed factor[10, 1])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|turn_left_int_dirt [Indent level: 2],
        "turn_left_int_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02_int",1,1],
            "frequency": 1,
            "volume": "engineOn*(1-camPos)*(latSlipDrive factor[0.15, 0.4])*(speed factor[1, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|turn_right_int_dirt [Indent level: 2],
        "turn_right_int_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02_int",1,1],
            "frequency": 1,
            "volume": "engineOn*(1-camPos)*(latSlipDrive factor[-0.15, -0.4])*(speed factor[1, 10])"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|RainExt [Indent level: 2],
        "rainext": {
            "sound": ["A3|Sounds_F|vehicles|noises|rain2_ext",1,1,100],
            "frequency": 1,
            "volume": "camPos * (rain - rotorSpeed/2) * 2"
        },
        # Class: CfgVehicles|UGV_01_base_F|Sounds|RainInt [Indent level: 2],
        "rainint": {
            "sound": ["A3|Sounds_F|vehicles|noises|rain2_ext",1,1,100],
            "frequency": 1,
    ...
    "idlerpm": 800,
    "redrpm": 3200,
    # Class: CfgVehicles|UGV_01_base_F|complexGearbox [Indent level: 1],
    "complexgearbox": {
        "gearboxratios": ["R1",-3.182,"N",0,"D1",4.182,"D2",3.318,"D3",2.15],
    ...
    "torquecurve": [[0,0.2],[0.278,0.5],[0.35,0.85],[0.461,1],[0.6,0.95],[0.7,0.85],[0.8,0.7],[1,0.5]],
    "changegearmineffectivity": [0.95,0.15,0.95,0.95,0.95],
    "switchtime": 0.1,
    "latency": 1,
    # Class: CfgVehicles|UGV_01_base_F|Wheels [Indent level: 1],
    "wheels": {
        # Class: CfgVehicles|UGV_01_base_F|Wheels|L1 [Indent level: 2]
        "l1": {
            "side": "left",
        ...
        # Class: CfgVehicles|UGV_01_base_F|Wheels|L2 [Indent level: 2],
        "l2": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Wheels|L3 [Indent level: 2],
        "l3": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Wheels|R1 [Indent level: 2],
        "r1": {
            "side": "right",
            "susptraveldirection": [0.125,-1,0],
        ...
        # Class: CfgVehicles|UGV_01_base_F|Wheels|R2 [Indent level: 2],
        "r2": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Wheels|R3 [Indent level: 2],
        "r3": {
    ...
    "maxfordingdepth": -0.5,
    # Class: CfgVehicles|UGV_01_base_F|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|UGV_01_base_F|AnimationSources|Turret [Indent level: 2]
        "turret": {
            "source": "user",
            "animperiod": 1,
            "initphase": 1
        },
        # Class: CfgVehicles|UGV_01_base_F|AnimationSources|MainTurret [Indent level: 2],
        "mainturret": {
            "source": "user",
            "animperiod": 1,
            "initphase": 1
        },
        # Class: CfgVehicles|UGV_01_base_F|AnimationSources|MainGun [Indent level: 2],
        "maingun": {
            "source": "user",
            "animperiod": 1,
            "initphase": 1
        },
        # Class: CfgVehicles|UGV_01_base_F|AnimationSources|muzzle_rot_MG [Indent level: 2],
        "muzzle_rot_mg": {
            "source": "ammorandom",
            "weapon": "HMG_127_UGV"
        },
        # Class: CfgVehicles|UGV_01_base_F|AnimationSources|muzzle_rot_GMG [Indent level: 2],
        "muzzle_rot_gmg": {
            "source": "ammorandom",
            "weapon": "GMG_40mm"
        },
        # Class: CfgVehicles|UGV_01_base_F|AnimationSources|muzzle_hide_MG [Indent level: 2],
        "muzzle_hide_mg": {
            "source": "reload",
            "weapon": "HMG_127_UGV"
        },
        # Class: CfgVehicles|UGV_01_base_F|AnimationSources|muzzle_hide_GMG [Indent level: 2],
        "muzzle_hide_gmg": {
            "source": "reload",
            "weapon": "GMG_40mm"
        },
    ...
    "precision": 10,
    "acceleration": 15,
    # Class: CfgVehicles|UGV_01_base_F|PlayerSteeringCoefficients [Indent level: 1],
    ...
    # Class: CfgVehicles|UGV_01_base_F|ViewOptics [Indent level: 1],
    "viewoptics": {
    ...
    # Class: CfgVehicles|UGV_01_base_F|HitPoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 0.7,
            "material": 50,
        ...
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitEngine [Indent level: 2],
        "hitengine": {
            "armor": 2,
            "material": -1,
        ...
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitFuel [Indent level: 2],
        "hitfuel": {
            "armor": 1,
            "material": -1,
        ...
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitLFWheel [Indent level: 2],
        "hitlfwheel": {
            "armor": 0.5,
            "name": "wheel_1_1",
            "material": -1,
        ...
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitLF2Wheel [Indent level: 2],
        "hitlf2wheel": {
            "armor": 0.5,
            "name": "wheel_1_2",
            "material": -1,
        ...
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitLMWheel [Indent level: 2],
        "hitlmwheel": {
            "armor": 0.5,
            "name": "wheel_1_3",
            "material": -1,
        ...
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitRFWheel [Indent level: 2],
        "hitrfwheel": {
            "armor": 0.5,
            "name": "wheel_2_1",
            "material": -1,
        ...
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitRF2Wheel [Indent level: 2],
        "hitrf2wheel": {
            "armor": 0.5,
            "name": "wheel_2_2",
            "material": -1,
        ...
        # Class: CfgVehicles|UGV_01_base_F|HitPoints|HitRMWheel [Indent level: 2],
        "hitrmwheel": {
            "armor": 0.5,
            "name": "wheel_2_3",
            "material": -1,
    ...
    # Class: CfgVehicles|UGV_01_base_F|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|UGV_01_base_F|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
    ...
    "maximumload": 1000,
    # Class: CfgVehicles|UGV_01_base_F|TransportBackpacks [Indent level: 1],
    "transportbackpacks": {
    },
    # Class: CfgVehicles|UGV_01_base_F|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|UGV_01_base_F|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|UGV_01_base_F|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|UGV_01_base_F|TransportItems|_xx_FirstAidKit [Indent level: 2]
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 4
        }
    },
    # Class: CfgVehicles|UGV_01_base_F|Reflectors [Indent level: 1],
    "reflectors": {
        # Class: CfgVehicles|UGV_01_base_F|Reflectors|Left [Indent level: 2]
        "left": {
            ...
            "daylight": 0,
            "flaresize": 1,
            # Class: CfgVehicles|UGV_01_base_F|Reflectors|Left|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 0,
                "linear": 0,
        ...
        # Class: CfgVehicles|UGV_01_base_F|Reflectors|Right [Indent level: 2],
        "right": {
            "position": "Light_R",
        ...
        # Class: CfgVehicles|UGV_01_base_F|Reflectors|Right2 [Indent level: 2],
        "right2": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Reflectors|Left2 [Indent level: 2],
        "left2": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Reflectors|Left3 [Indent level: 2],
        "left3": {
    ...
    # Class: CfgVehicles|UGV_01_base_F|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|UGV_01_base_F|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentLeft [Indent level: 2]
        "vehiclesystemsdisplaymanagercomponentleft": {
            # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentLeft|components [Indent level: 3]
            "components": {
                # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentLeft|components|EmptyDisplay [Indent level: 4]
                "emptydisplay": {
                    "componenttype": "EmptyDisplayComponent"
                },
                # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentLeft|components|MinimapDisplay [Indent level: 4],
                "minimapdisplay": {
                    "componenttype": "MinimapDisplayComponent",
                    "resource": "RscCustomInfoMiniMap"
                },
                # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentLeft|components|UAVDisplay [Indent level: 4],
                "uavdisplay": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentRight [Indent level: 2],
        "vehiclesystemsdisplaymanagercomponentright": {
            # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentRight|components [Indent level: 3]
            "components": {
                # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentRight|components|EmptyDisplay [Indent level: 4]
                "emptydisplay": {
                    "componenttype": "EmptyDisplayComponent"
                },
                # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentRight|components|MinimapDisplay [Indent level: 4],
                "minimapdisplay": {
                    "componenttype": "MinimapDisplayComponent",
                    "resource": "RscCustomInfoMiniMap"
                },
                # Class: CfgVehicles|UGV_01_base_F|Components|VehicleSystemsDisplayManagerComponentRight|components|UAVDisplay [Indent level: 4],
                "uavdisplay": {
                    "componenttype": "UAVFeedDisplayComponent"
                }
            },
    ...
    "cargoproxyindexes": [1],
    "getinproxyorder": [1],
    # Class: CfgVehicles|UGV_01_base_F|TextureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|UGV_01_base_F|TextureSources|Indep [Indent level: 2]
        "indep": {
            "displayname": "AAF",
            "author": "Bohemia Interactive",
        ...
        # Class: CfgVehicles|UGV_01_base_F|TextureSources|Opfor [Indent level: 2],
        "opfor": {
            "author": "Bohemia Interactive",
        ...
        # Class: CfgVehicles|UGV_01_base_F|TextureSources|Blufor [Indent level: 2],
        "blufor": {
            "displayname": "BLUFOR",
            "author": "Bohemia Interactive",
        ...
        # Class: CfgVehicles|UGV_01_base_F|TextureSources|GreenHex [Indent level: 2],
        "greenhex": {
        ...
        # Class: CfgVehicles|UGV_01_base_F|TextureSources|Olive [Indent level: 2],
        "olive": {
            "displayname": "Olive",
            "author": "Bohemia Interactive",
        ...
        # Class: CfgVehicles|UGV_01_base_F|TextureSources|IDAP [Indent level: 2],
        "idap": {
            "displayname": "IDAP",
            "author": "Bohemia Interactive",
        ...
        # Class: CfgVehicles|UGV_01_base_F|TextureSources|EAF [Indent level: 2],
        "eaf": {
            "displayname": "LDF",
            "author": "Bohemia Interactive",
    ...
    "latstiffy": 18000,
    "wheelmask": "wheel_X_X",
    # Class: CfgVehicles|Car_F|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|Car_F|Exhausts|Exhaust1 [Indent level: 2]
        "exhaust1": {
            "position": "exhaust",
