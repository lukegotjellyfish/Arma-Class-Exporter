rhsusf_assault_eagleaiii_coy_assaultman = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_assaultman|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_assaultman|TransportItems|_xx_rhs_mag_smaw_HEDP [Indent level: 2]
        "_xx_rhs_mag_smaw_hedp": {
            "name": "rhs_mag_smaw_HEDP",
            "count": 1
        },
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_assaultman|TransportItems|_xx_rhsusf_m112_mag [Indent level: 2],
        "_xx_rhsusf_m112_mag": {
