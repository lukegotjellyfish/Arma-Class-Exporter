rhsusf_weapons_crate = {
    ...
    # Class: CfgVehicles|rhsusf_weapons_crate|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "[_this select 0,0] call rhs_fnc_virtualAmmoBoxUSA;"
    },
    "slx_xeh_disabled": 1,
    # Class: CfgVehicles|rhsusf_weapons_crate|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|rhsusf_weapons_crate|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhsusf_weapons_crate|TransportItems [Indent level: 1],
    "transportitems": {
    },
