rhsgref_hidf_backpack_ar = {
    "scope": 1,
    # Class: CfgVehicles|rhsgref_hidf_backpack_ar|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_hidf_backpack_ar|TransportMagazines|_xx_rhsusf_200rnd_556x45_M855_mixed_box [Indent level: 2]
