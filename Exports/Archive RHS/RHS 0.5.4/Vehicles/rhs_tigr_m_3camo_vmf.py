rhs_tigr_m_3camo_vmf = {
    ...
    # Class: CfgVehicles|rhs_tigr_m_3camo_vmf|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_tigr_m_3camo_vmf|Turrets|CargoTurret_01 [Indent level: 2]
        "cargoturret_01": {
