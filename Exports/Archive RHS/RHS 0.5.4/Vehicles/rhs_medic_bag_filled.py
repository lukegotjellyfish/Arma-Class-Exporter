rhs_medic_bag_filled = {
    "scope": 1,
    # Class: CfgVehicles|rhs_medic_bag_filled|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhs_medic_bag_filled|TransportItems|_xx_MediKit [Indent level: 2]
        "_xx_medikit": {
            "name": "MediKit",
            "count": 1
        },
        # Class: CfgVehicles|rhs_medic_bag_filled|TransportItems|_xx_FirstAidKit [Indent level: 2],
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 2
        }
