rhs_weapons_crate_ak_standard = {
    ...
    # Class: CfgVehicles|rhs_weapons_crate_ak|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "[_this select 0,0] call rhs_fnc_virtualAmmoBoxRus;"
    },
    "slx_xeh_disabled": 1,
    # Class: CfgVehicles|rhs_weapons_crate_ak|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|rhs_weapons_crate_ak|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhs_weapons_crate_ak|TransportItems [Indent level: 1],
    "transportitems": {
    },
    "mapsize": 1.47,
