rhsusf_assault_eagleaiii_coy_aa = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_aa|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_aa|TransportItems|_xx_rhs_fim92_mag [Indent level: 2]
        "_xx_rhs_fim92_mag": {
            "name": "rhs_fim92_mag",
            "count": 1
        }
