rhssaf_kitbag_md2camo = {
    ...
    "scope": 2,
    "scopecurator": 2,
    # Class: CfgVehicles|rhssaf_kitbag_md2camo|SimpleObject [Indent level: 1],
    "simpleobject": {
    ...
    "hiddenselectionstextures": ["|rhssaf|addons|rhssaf_t_gear_a3|data|backpack_rhssaf_fast_md2camo_co.paa"],
