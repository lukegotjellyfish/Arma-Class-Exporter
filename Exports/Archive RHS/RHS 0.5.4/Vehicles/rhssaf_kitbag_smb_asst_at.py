rhssaf_kitbag_smb_asst_at = {
    ...
    "scope": 1,
    "scopecurator": 0,
    # Class: CfgVehicles|rhssaf_Kitbag_smb_asst_AT|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhssaf_Kitbag_smb_asst_AT|TransportMagazines|_xx_rhssaf_30Rnd_762x39mm_M67 [Indent level: 2]
        "_xx_rhssaf_30rnd_762x39mm_m67": {
            "magazine": "rhssaf_30Rnd_762x39mm_M67",
            "count": 4
        },
        # Class: CfgVehicles|rhssaf_Kitbag_smb_asst_AT|TransportMagazines|_xx_rhs_mag_smaw_HEAA [Indent level: 2],
