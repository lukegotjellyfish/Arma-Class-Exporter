rhs_nsv_tripod_vmf = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_NSV_TriPod_VMF.paa",
    "scope": 2,
    "side": 0,
    ...
    "dlc": "RHS_AFRF",
    "model": "rhsafrf|addons|rhs_heavyweapons|mg|rhs_nsv_tripod",
    ...
    # Class: CfgVehicles|rhs_nsv_tripod_base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    # Class: CfgVehicles|rhs_nsv_tripod_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|rhs_nsv_tripod_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_nsv_tripod_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "optics": 1,
    ...
    # Class: CfgVehicles|rhs_nsv_tripod_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_nsv_tripod_base|AnimationSources|ReloadAnim [Indent level: 2]
        "reloadanim": {
            "source": "reload",
            "weapon": "rhs_weap_nsvt_effects"
        },
        # Class: CfgVehicles|rhs_nsv_tripod_base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "rhs_weap_nsvt_effects"
        },
        # Class: CfgVehicles|rhs_nsv_tripod_base|AnimationSources|Revolving [Indent level: 2],
        "revolving": {
            "source": "revolving",
            "weapon": "rhs_weap_nsvt_effects"
        },
        # Class: CfgVehicles|rhs_nsv_tripod_base|AnimationSources|muzzleHMG_ROT [Indent level: 2],
        "muzzlehmg_rot": {
            "source": "ammorandom",
            "weapon": "rhs_weap_nsvt_effects"
        }
    ...
    "armorstructural": 10,
    # Class: CfgVehicles|rhs_nsv_tripod_base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["RHS_NSV_Gun_Bag","RHS_NSV_Tripod_Bag"],
        "displayname": ""
    },
