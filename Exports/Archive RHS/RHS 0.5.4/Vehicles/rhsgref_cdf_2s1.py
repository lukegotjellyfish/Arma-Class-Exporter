rhsgref_cdf_2s1 = {
    ...
    "scope": 2,
    "texturelist": ["CDF",1],
    "rhs_decalparameters": ["['Number',[cRHS2S1NumberPlaces, cRHS2S1BackLargeNumberPlaces],'CDF']"],
    # Class: CfgVehicles|rhsgref_cdf_2s1|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_cdf_2s1|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhsgref_cdf_2s1|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhsgref_cdf_2s1|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                ...
                # Class: CfgVehicles|rhsgref_cdf_2s1|Turrets|MainTurret|Turrets|LoaderOptics [Indent level: 4],
                "loaderoptics": {
                    "gunnertype": "rhsgref_cdf_reg_crew",
                    "body": "LdrTurret",
                    "gun": "LdrGun",
    ...
    # Class: CfgVehicles|rhsgref_cdf_2s1|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_cdf_2s1|TransportMagazines|_xx_rhsusf_mag_17Rnd_9x19_FMJ [Indent level: 2]
        "_xx_rhsusf_mag_17rnd_9x19_fmj": {
            "magazine": "rhsusf_mag_17Rnd_9x19_FMJ",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_2s1|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_2s1|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
