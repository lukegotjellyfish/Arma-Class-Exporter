rhs_assault_umbts_ammo_recon = {
    "scope": 1,
    # Class: CfgVehicles|rhs_assault_umbts_ammo_recon|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhs_assault_umbts_ammo_recon|TransportMagazines|_xx_rhs_mag_rgn [Indent level: 2]
        "_xx_rhs_mag_rgn": {
            "magazine": "rhs_mag_rgn",
            "count": 2
        },
        # Class: CfgVehicles|rhs_assault_umbts_ammo_recon|TransportMagazines|_xx_rhs_mag_fakel [Indent level: 2],
        "_xx_rhs_mag_fakel": {
            "magazine": "rhs_mag_fakel",
            "count": 2
        },
        # Class: CfgVehicles|rhs_assault_umbts_ammo_recon|TransportMagazines|_xx_rhs_mag_rdg2_white [Indent level: 2],
        "_xx_rhs_mag_rdg2_white": {
            "magazine": "rhs_mag_rdg2_white",
            "count": 1
        },
        # Class: CfgVehicles|rhs_assault_umbts_ammo_recon|TransportMagazines|_xx_rhs_30Rnd_762x39mm_U [Indent level: 2],
