rhsgref_cdf_reg_mi17sh = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_reg_Mi17Sh.paa",
    "scope": 2,
    # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                    "attachment": "rhs_mag_ub32_s5m1",
                ...
                # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                    "attachment": "rhs_mag_ub32_s5m1",
                ...
                # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
                    "attachment": "rhs_mag_ub32_s5m1",
                ...
                # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent|pylons|pylon5 [Indent level: 4],
                "pylon5": {
                ...
                # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent|pylons|pylon6 [Indent level: 4],
                "pylon6": {
                    "attachment": "rhs_mag_ub32_s5ko",
                ...
                # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4],
                "cmdispenser": {
    ...
    # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|AnimationSources|exhaust_hide [Indent level: 2]
        "exhaust_hide": {
            "source": "user",
            "initphase": 1,
            "animperiod": 1e-005
    ...
    # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Exhausts|Exhaust01 [Indent level: 2]
        "exhaust01": {
            "direction": "exhaust1_dir",
            "position": "exhaust1",
            "effect": "ExhaustEffectHeli"
        },
        # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|Exhausts|Exhaust02 [Indent level: 2],
        "exhaust02": {
    ...
    # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|TransportMagazines|_xx_rhs_30Rnd_545x39_7N6M_AK [Indent level: 2]
        "_xx_rhs_30rnd_545x39_7n6m_ak": {
            "magazine": "rhs_30Rnd_545x39_7N6M_AK",
            "count": 30
        },
        # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
        "_xx_rhs_mag_nspn_red": {
            "magazine": "rhs_mag_nspn_red",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_reg_Mi17Sh|TransportMagazines|_xx_rhs_mag_rdg2_white [Indent level: 2],
