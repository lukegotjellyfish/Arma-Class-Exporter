rhsusf_assault_eagleaiii_ucp_mg = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_mg|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_mg|TransportItems|_xx_rhsusf_50Rnd_762x51 [Indent level: 2]
