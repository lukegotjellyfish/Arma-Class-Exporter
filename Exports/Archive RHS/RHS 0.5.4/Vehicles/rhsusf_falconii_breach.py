rhsusf_falconii_breach = {
    "scope": 1,
    # Class: CfgVehicles|rhsusf_falconii_breach|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_falconii_breach|TransportItems|_xx_SatchelCharge_Remote_Mag [Indent level: 2]
