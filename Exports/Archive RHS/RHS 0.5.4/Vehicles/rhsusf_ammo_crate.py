rhsusf_ammo_crate = {
    ...
    # Class: CfgVehicles|rhsusf_ammo_crate|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "[_this select 0,1] call rhs_fnc_virtualAmmoBoxUSA;"
    },
    "slx_xeh_disabled": 1,
    # Class: CfgVehicles|rhsusf_ammo_crate|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|rhsusf_ammo_crate|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhsusf_ammo_crate|TransportItems [Indent level: 1],
    "transportitems": {
    },
    "author": "Bohemia Interactive",
    # Class: CfgVehicles|Box_NATO_Ammo_F|SimpleObject [Indent level: 1],
    "simpleobject": {
        "eden": 1,
    ...
    "maximumload": 1000,
    # Class: CfgVehicles|Box_NATO_Ammo_F|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|Box_NATO_Ammo_F|AnimationSources|Ammo_source [Indent level: 2]
        "ammo_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|Box_NATO_Ammo_F|AnimationSources|AmmoOrd_source [Indent level: 2],
        "ammoord_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": 1
        },
        # Class: CfgVehicles|Box_NATO_Ammo_F|AnimationSources|Grenades_source [Indent level: 2],
        "grenades_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": 1
        },
        # Class: CfgVehicles|Box_NATO_Ammo_F|AnimationSources|Support_source [Indent level: 2],
        "support_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": 1
