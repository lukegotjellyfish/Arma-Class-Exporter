rhs_mk19_tripod_d = {
    ...
    # Class: CfgVehicles|RHS_MK19_TriPod_base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|RHS_MK19_TriPod_base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|RHS_MK19_TriPod_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|RHS_MK19_TriPod_base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    # Class: CfgVehicles|RHS_MK19_TriPod_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_MK19_TriPod_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
    ...
    # Class: CfgVehicles|RHS_MK19_TriPod_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_MK19_TriPod_base|AnimationSources|belt_rotation [Indent level: 2]
        "belt_rotation": {
            "source": "reload",
            "weapon": "RHS_MK19"
        },
        # Class: CfgVehicles|RHS_MK19_TriPod_base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "RHS_MK19"
        },
        # Class: CfgVehicles|RHS_MK19_TriPod_base|AnimationSources|Revolving [Indent level: 2],
        "revolving": {
            "source": "revolving",
            "weapon": "RHS_MK19"
        }
    },
    # Class: CfgVehicles|RHS_MK19_TriPod_base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
