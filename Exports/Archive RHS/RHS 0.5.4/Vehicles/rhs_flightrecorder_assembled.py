rhs_flightrecorder_assembled = {
    ...
    "cost": 100,
    # Class: CfgVehicles|rhs_flightrecorder_assembled|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_flightrecorder_assembled|AnimationSources|recorder_action [Indent level: 2]
        "recorder_action": {
            "source": "user",
            "initphase": 0,
            "animperiod": 1.2
    ...
    # Class: CfgVehicles|rhs_flightrecorder_assembled|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|rhs_flightrecorder_assembled|UserActions|takeItem [Indent level: 2]
        "takeitem": {
        ...
        # Class: CfgVehicles|rhs_flightrecorder_assembled|UserActions|restoreItem [Indent level: 2],
        "restoreitem": {
