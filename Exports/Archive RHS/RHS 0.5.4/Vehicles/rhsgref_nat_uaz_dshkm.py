rhsgref_nat_uaz_dshkm = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_nat_uaz_dshkm.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsgref_nat_uaz_dshkm|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_nat_uaz_dshkm|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
        ...
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
        ...
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|AnimationSources|muzzle_rot_MG [Indent level: 2],
        "muzzle_rot_mg": {
            "source": "ammorandom",
            "weapon": "rhs_weap_DSHKM"
        },
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|uaz|data|uaz_main_ind_co.paa","rhsafrf|addons|rhs_a2port_car|UAZ|Data|uaz_mount_co.paa","rhsafrf|addons|RHS_Decals|Data|Labels|Misc|no_ca.paa"],
    # Class: CfgVehicles|RHS_UAZ_DShKM_Base|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|textureSources|standard [Indent level: 2]
        "standard": {
        ...
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|textureSources|Camo [Indent level: 2],
        "camo": {
            "displayname": "Camo",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|textureSources|Camo1 [Indent level: 2],
        "camo1": {
            "displayname": "Chedaki",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|textureSources|Camo2 [Indent level: 2],
        "camo2": {
            "displayname": "CDF",
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|textureSources|Camo4 [Indent level: 2],
        "camo4": {
            "displayname": "UN",
            "author": "Red Hammer Studios",
    ...
    "texturelist": [],
    # Class: CfgVehicles|RHS_UAZ_DShKM_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "body": "mainTurret",
            "gun": "mainGun",
            ...
            "magazines": ["rhs_mag_127x108mm_50","rhs_mag_127x108mm_50","rhs_mag_127x108mm_50","rhs_mag_127x108mm_50","rhs_mag_127x108mm_50"],
            ...
            # Class: CfgVehicles|RHS_UAZ_DShKM_Base|Turrets|MainTurret|OpticsIn [Indent level: 3],
            "opticsin": {
                # Class: CfgVehicles|RHS_UAZ_DShKM_Base|Turrets|MainTurret|OpticsIn|Sight [Indent level: 4]
                "sight": {
                    "gunneropticsmodel": "A3|weapons_f|reticle|optics_empty",
                    "initfov": 0.7,
                    "minfov": 0.35,
        ...
        # Class: CfgVehicles|RHS_UAZ_DShKM_Base|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
