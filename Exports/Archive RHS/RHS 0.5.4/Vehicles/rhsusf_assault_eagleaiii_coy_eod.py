rhsusf_assault_eagleaiii_coy_eod = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_eod|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_eod|TransportItems|_xx_rhsusf_m112x4_mag [Indent level: 2]
        "_xx_rhsusf_m112x4_mag": {
            "name": "rhsusf_m112x4_mag",
            "count": 1
        },
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_eod|TransportItems|_xx_rhsusf_m112_mag [Indent level: 2],
        "_xx_rhsusf_m112_mag": {
            "name": "rhsusf_m112_mag",
            "count": 2
        },
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_eod|TransportItems|_xx_ToolKit [Indent level: 2],
        "_xx_toolkit": {
            "name": "ToolKit",
            "count": 1
        },
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_eod|TransportItems|_xx_MineDetector [Indent level: 2],
        "_xx_minedetector": {
            "name": "MineDetector",
            "count": 1
        }
