rhsgref_cdf_reg_uaz_dshkm = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_reg_uaz_dshkm.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|RHS_UAZ_DShKM_Base|AnimationSources [Indent level: 1],
    "animationsources": {
