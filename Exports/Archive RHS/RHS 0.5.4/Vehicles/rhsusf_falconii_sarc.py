rhsusf_falconii_sarc = {
    ...
    # Class: CfgVehicles|rhsusf_falconii_sarc|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_falconii_sarc|TransportItems|_xx_Medikit [Indent level: 2]
        "_xx_medikit": {
            "name": "MediKit",
            "count": 1
        },
        # Class: CfgVehicles|rhsusf_falconii_sarc|TransportItems|_xx_FirstAidKit [Indent level: 2],
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 6
        },
        # Class: CfgVehicles|rhsusf_falconii_sarc|TransportItems|_xx_Chemlight_red [Indent level: 2],
        "_xx_chemlight_red": {
            "name": "Chemlight_red",
            "count": 1
        }
