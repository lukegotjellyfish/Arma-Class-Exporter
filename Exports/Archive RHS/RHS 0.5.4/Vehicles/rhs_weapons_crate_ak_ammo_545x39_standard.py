rhs_weapons_crate_ak_ammo_545x39_standard = {
    ...
    # Class: CfgVehicles|rhs_weapons_crate_ak_ammo_545x39|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "[_this select 0,1] call rhs_fnc_virtualAmmoBoxRus;"
    },
    "slx_xeh_disabled": 1,
    # Class: CfgVehicles|rhs_weapons_crate_ak_ammo_545x39|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    "mapsize": 1.47,
