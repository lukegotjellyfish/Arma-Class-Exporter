rhs_a10_acesii_seat = {
    ...
    # Class: CfgVehicles|rhs_a10_acesII_seat|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_a10_acesII_seat|AnimationSources|hide_booster [Indent level: 2]
        "hide_booster": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
    ...
    # Class: CfgVehicles|rhs_a10_acesII_seat|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|rhs_a10_acesII_seat|UserActions [Indent level: 1],
    "useractions": {
    },
    "driveoncomponent": [],
    # Class: CfgVehicles|rhs_a10_acesII_seat|Eventhandlers [Indent level: 1],
    "eventhandlers": {
    },
    "slx_xeh_disabled": 1,
    # Class: CfgVehicles|rhs_a10_acesII_seat|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|rhs_a10_acesII_seat|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhs_a10_acesII_seat|TransportItems [Indent level: 1],
    "transportitems": {
    },
    "mapsize": 16,
    "_generalmacro": "Car_F",
