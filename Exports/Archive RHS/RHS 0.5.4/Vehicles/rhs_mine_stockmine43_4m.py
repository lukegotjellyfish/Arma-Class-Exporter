rhs_mine_stockmine43_4m = {
    ...
    "scope": 2,
    # Ammo: CfgVehicles|rhs_mine_stockmine43_4m|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_mine_stockmine43_4m_ammo",
