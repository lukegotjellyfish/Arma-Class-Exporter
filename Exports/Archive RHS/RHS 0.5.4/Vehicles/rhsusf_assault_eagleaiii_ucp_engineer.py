rhsusf_assault_eagleaiii_ucp_engineer = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_engineer|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_engineer|TransportItems|_xx_ToolKit [Indent level: 2]
        "_xx_toolkit": {
            "name": "ToolKit",
            "count": 1
        }
