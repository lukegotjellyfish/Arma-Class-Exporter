rhsgref_ins_g_ags30_tripod = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_AGS30_TriPod.paa",
    "dlc": "RHS_GREF",
    "displayname": "AGS-30 (6P17)",
    "model": "rhsafrf|addons|rhs_heavyweapons|AGS30|AGS_static",
    ...
    # Class: CfgVehicles|RHS_AGS30_TriPod_base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|RHS_AGS30_TriPod_base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|RHS_AGS30_TriPod_base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    # Class: CfgVehicles|RHS_AGS30_TriPod_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|RHS_AGS30_TriPod_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_AGS30_TriPod_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            ...
            "magazines": ["RHS_mag_VOG30_30","RHS_mag_VOG30_30","RHS_mag_VOG30_30","RHS_mag_VOG30_30"],
            "gunneraction": "rhs_AGS_Gunner",
            "memorypointsgetingunner": "pos_gunner_dir",
            "memorypointsgetingunnerdir": "pos_gunner",
            "selectionfireanim": "zasleh",
            # Class: CfgVehicles|RHS_AGS30_TriPod_base|Turrets|MainTurret|ViewGunner [Indent level: 3],
            "viewgunner": {
                "initanglex": 5,
                "minanglex": -30,
                "maxanglex": 30,
            ...
            # Class: CfgVehicles|RHS_AGS30_TriPod_base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initfov": 0.25,
                "minfov": 0.25,
                "maxfov": 0.25,
    ...
    # Class: CfgVehicles|RHS_AGS30_TriPod_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_AGS30_TriPod_base|AnimationSources|belt_rotation [Indent level: 2]
        "belt_rotation": {
            "source": "reload",
            "weapon": "RHS_weap_AGS30"
        },
        # Class: CfgVehicles|RHS_AGS30_TriPod_base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "RHS_weap_AGS30"
        },
        # Class: CfgVehicles|RHS_AGS30_TriPod_base|AnimationSources|Revolving [Indent level: 2],
        "revolving": {
            "source": "revolving",
            "weapon": "RHS_weap_AGS30"
        },
        # Class: CfgVehicles|RHS_AGS30_TriPod_base|AnimationSources|muzzle_rot_MG [Indent level: 2],
        "muzzle_rot_mg": {
            "source": "ammorandom",
            "weapon": "RHS_weap_AGS30"
        }
    },
    # Class: CfgVehicles|RHS_AGS30_TriPod_base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["RHS_AGS30_Gun_Bag","RHS_AGS30_Tripod_Bag"],
        "displayname": ""
    },
    # Class: CfgVehicles|StaticGrenadeLauncher|SpeechVariants [Indent level: 1],
    "speechvariants": {
        # Class: CfgVehicles|StaticGrenadeLauncher|SpeechVariants|Default [Indent level: 2]
        "default": {
