rhs_mine_sm320_green = {
    "editorpreview": "rhsafrf|addons|rhs_editorpreviews|data|rhs_mine_sm320_green",
    "displayname": "SM-320 (Green)",
    # Ammo: CfgVehicles|rhs_mine_sm320_green|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_mine_sm320_green_ammo",
    ...
    "nvgmarkers": "rhs_mine_sm320_green_ammo",
    ...
    # Class: CfgVehicles|rhs_mine_msk40p_white|Library [Indent level: 1],
    "library": {
        "libtextdesc": ""
    },
    ...
    "audible": 0,
    "simulation": "house",
    # Class: CfgVehicles|Static|DestructionEffects [Indent level: 1],
    "destructioneffects": {
    },
    "cost": 1000,
    "weapons": [],
