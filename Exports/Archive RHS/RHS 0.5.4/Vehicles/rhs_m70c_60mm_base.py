rhs_m70c_60mm_base = {
    ...
    # Class: CfgVehicles|rhs_m70c_60mm_base|Library [Indent level: 1],
    "library": {
        "libtextdesc": ""
    },
    ...
    "hiddenselectionstextures": ["rhssaf|addons|rhssaf_t_weapon_m70c|data|rhssaf_m70c_co.paa"],
    "transportsoldier": 0,
    "mapsize": 1.5,
    "cargoaction": ["Mortar_Gunner"],
    "getinaction": "GetInMortar",
    "getoutaction": "GetOutLow",
    # Class: CfgVehicles|rhs_m70c_60mm_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhssaf|addons|rhssaf_t_weapon_m70c|data|rhssaf_m70c.rvmat","rhssaf|addons|rhssaf_t_weapon_m70c|data|rhssaf_m70c.rvmat","rhsafrf|addons|rhs_heavyweapons|data|static_destroyed.rvmat"]
    },
    # Class: CfgVehicles|rhs_m70c_60mm_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_m70c_60mm_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "gunnerlefthandanimname": "otochlaven",
            "gunnerrighthandanimname": "otochlaven",
            "turretinfotype": "RHS_RscWeaponZeroing",
            "weapons": ["rhs_weap_m70c"],
            "magazines": ["rhssaf_mag_m73_HE"],
            ...
            "ejectdeadgunner": 1,
            "usepip": 2,
            # Class: CfgVehicles|rhs_m70c_60mm_base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 0,
                "minanglex": -30,
                "maxanglex": 30,
    ...
    "tbody": 100,
    "artilleryscanner": 1,
    # Class: CfgVehicles|rhs_m70c_60mm_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
