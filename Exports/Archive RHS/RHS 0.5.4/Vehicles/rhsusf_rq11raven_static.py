rhsusf_rq11raven_static = {
    ...
    "vehicleclass": "rq11",
    # Class: CfgVehicles|rhsusf_RQ11RAVEN_STATIC|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhsusf_RQ11RAVEN_STATIC|EventHandlers|RHSUSF_EventHandlers [Indent level: 2]
