rhs_kornet_9m133_2_vmf = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_Kornet_9M133_2_vdv.paa",
    "scope": 2,
    "side": 0,
    ...
    "dlc": "RHS_AFRF",
    # Class: CfgVehicles|rhs_Kornet_Base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["rhs_Kornet_Gun_Bag","rhs_Kornet_Tripod_Bag"],
        "displayname": ""
    },
    "displayname": "9K133-1 'Kornet-M'",
    # Class: CfgVehicles|rhs_Kornet_Base|Library [Indent level: 1],
    "library": {
        "libtextdesc": "The AT-9K115 Metis-M (NATO reporting name is AT-13 Saxhorn-2) is a Russian anti-tank missile system. Thanks to its light weight (only 13,8 kg), the AT-13 can be easily transported by infantry units or vehicles. <br/>This system is extremely easy to operate – it can fire up to 4 rounds per minute."
    },
    "model": "rhsafrf|addons|rhs_heavyweapons|kornet|kornet.p3d",
    ...
    # Class: CfgVehicles|rhs_Kornet_Base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhs_Kornet_Base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|rhs_Kornet_Base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    "hiddenselections": [],
    # Class: CfgVehicles|rhs_Kornet_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "weapons": ["rhs_weap_9K133_launcher"],
            "magazines": ["rhs_mag_9m133","rhs_mag_9m133","rhs_mag_9m133"],
            "gunneraction": "RHS_Kornet_Gunner",
            "memorypointgunneroptics": "gunnerview",
            "gunneropticsmodel": "rhsafrf|addons|rhs_optics|vehicles|rhs_1pn79_6x",
            "gunneropticseffect": ["OpticsCHAbera1","OpticsBlur2"],
            "gunnerrighthandanimname": "horizontal_handle",
            "gunnerlefthandanimname": "vertical_handle",
            "turretinfotype": "RHS_RscInfoStaticWeapon",
            ...
            "ejectdeadgunner": 0,
            "gunnerforceoptics": 0,
            # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret|ViewGunner [Indent level: 3],
            "viewgunner": {
                "initanglex": 5,
                "minanglex": -10,
                "maxanglex": 20,
            ...
            # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 5,
                "minanglex": -10,
                "maxanglex": 20,
            ...
            # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret|OpticsIn [Indent level: 3],
            "opticsin": {
                # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret|OpticsIn|Wide [Indent level: 4]
                "wide": {
                    "opticsdisplayname": "W",
                    "gunneropticsmodel": "rhsafrf|addons|rhs_optics|vehicles|rhs_1pn79_6x",
                    "initanglex": 5,
                ...
                # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret|OpticsIn|Medium [Indent level: 4],
                "medium": {
                    "opticsdisplayname": "M",
                    "initfov": 0.0292,
                    "minfov": 0.0292,
                    "maxfov": 0.0292,
                    "gunneropticsmodel": "rhsafrf|addons|rhs_optics|vehicles|rhs_1pn79_12x",
                    "initanglex": 5,
                    "minanglex": -10,
                    "maxanglex": 20,
                    "initangley": 0,
                ...
                # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret|OpticsIn|Narrow [Indent level: 4],
                "narrow": {
                    "opticsdisplayname": "N",
                    "initfov": 0.0175,
                    "minfov": 0.0175,
                    "maxfov": 0.0175,
                    "gunneropticsmodel": "rhsafrf|addons|rhs_optics|vehicles|rhs_1pn79_20x",
                    "initanglex": 5,
                    "minanglex": -10,
                    "maxanglex": 20,
                    "initangley": 0,
            ...
            # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret|OpticsOut [Indent level: 3],
            "opticsout": {
                # Class: CfgVehicles|rhs_Kornet_Base|Turrets|MainTurret|OpticsOut|ViewGunner [Indent level: 4]
                "viewgunner": {
                    "gunneropticsmodel": "",
                    "gunneropticseffect": [],
                    "initanglex": 5,
    ...
    # Class: CfgVehicles|rhs_Kornet_Base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_Kornet_Base|AnimationSources|revolving [Indent level: 2]
        "revolving": {
            "source": "revolving",
            "weapon": "rhs_weap_9K133_launcher"
        },
        # Class: CfgVehicles|rhs_Kornet_Base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "rhs_weap_9K133_launcher"
        }
    },
    # Class: CfgVehicles|rhs_Kornet_Base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_Kornet_Base|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
    ...
    # Class: CfgVehicles|AT_01_base_F|SpeechVariants [Indent level: 1],
    "speechvariants": {
        # Class: CfgVehicles|AT_01_base_F|SpeechVariants|Default [Indent level: 2]
        "default": {
    ...
    # Class: CfgVehicles|AT_01_base_F|Armory [Indent level: 1],
    "armory": {
        "description": "The Titan Multi-Purpose Rocket Launcher is a shoulder system for launching guided rockets. This compact version trades increased portability for less powerful rockets and cannot launch anti-air missiles. It's adapted to be launched from closed quarters, has several modes of guidance and thanks to its advanced jet engine, it's capable of hitting even fast moving targets at short distances."
    },
    "editorsubcategory": "EdSubcat_Turrets",
    "uipicture": "A3|Static_F_Gamma|data|UI|gear_StaticTurret_AT_CA.paa",
    "threat": [0.3,1,0.3],
    "cost": 150000,
    # Class: CfgVehicles|AT_01_base_F|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["a3|static_f_gamma|data|staticturret_01.rvmat","a3|static_f_gamma|data|staticturret_01_damage.rvmat","a3|static_f_gamma|data|staticturret_01_destruct.rvmat","a3|static_f_gamma|data|staticturret_02.rvmat","a3|static_f_gamma|data|staticturret_02_damage.rvmat","a3|static_f_gamma|data|staticturret_02_destruct.rvmat","a3|weapons_f_beta|launchers|titan|data|titan_launcher.rvmat","a3|weapons_f_beta|launchers|titan|data|titan_launcher_damage.rvmat","a3|weapons_f_beta|launchers|titan|data|titan_launcher_destruct.rvmat","a3|weapons_f_beta|launchers|titan|data|titan_mtube.rvmat","a3|weapons_f_beta|launchers|titan|data|titan_mtube_damage.rvmat","a3|weapons_f_beta|launchers|titan|data|titan_mtube_destruct.rvmat"]
    },
