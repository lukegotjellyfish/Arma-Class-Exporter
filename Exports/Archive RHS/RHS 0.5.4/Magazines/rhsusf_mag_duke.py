rhsusf_mag_duke = {
    "count": 1,
    "scope": 2,
    # Ammo: CfgMagazines|rhsusf_mag_duke|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhsusf_ammo_duke",
        "muzzleeffect": "",
        "weaponlocksystem": "1",
        "simulation": "shotCM",
        "aiammousageflags": "0",
        ...
        "indirecthit": 0,
        "indirecthitrange": 0,
        # Class: CfgAmmo|rhsusf_ammo_duke|EventHandlers [Indent level: 1],
        "eventhandlers": {
            # Class: CfgAmmo|rhsusf_ammo_duke|EventHandlers|RHS_CM [Indent level: 2]
            "rhs_cm": {
    ...
    "mindamageforcamshakehit": "rhsusf_ammo_duke",
    "initspeed": 10,
