rhs_mag_100rnd_556x45_m855_cmag_mixed = {
    ...
    # Ammo: CfgMagazines|rhs_mag_100Rnd_556x45_M855_cmag_mixed|ammo [Indent level: 1],
    "ammo": {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons|mag_proxies|data|g36_cmag_co.paa"],
