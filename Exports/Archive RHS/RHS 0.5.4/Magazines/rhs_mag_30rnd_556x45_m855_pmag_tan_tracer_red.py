rhs_mag_30rnd_556x45_m855_pmag_tan_tracer_red = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons|mag_proxies|data|pmag_tan_co.paa"],
    ...
    # Ammo: CfgMagazines|rhs_mag_30Rnd_556x45_M855_PMAG_Tracer_Red|ammo [Indent level: 1],
    "ammo": {
