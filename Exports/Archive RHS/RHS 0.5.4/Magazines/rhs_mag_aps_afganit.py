rhs_mag_aps_afganit = {
    "count": 1,
    "scope": 1,
    # Ammo: CfgMagazines|rhs_mag_aps_afganit|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_dazzler",
        "muzzleeffect": "",
        # Class: CfgAmmo|rhs_ammo_dazzler|EventHandlers [Indent level: 1],
        "eventhandlers": {
            # Class: CfgAmmo|rhs_ammo_dazzler|EventHandlers|RHS_CM [Indent level: 2]
            "rhs_cm": {
    ...
    "mindamageforcamshakehit": "rhs_ammo_dazzler",
