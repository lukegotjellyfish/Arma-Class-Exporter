rhs_vog25p = {
    ...
    "displayname": "VOG25P",
    "descriptionshort": "Type: High Explosive Bouncing Grenade Round<br />Caliber: 40 mm<br />Rounds: 1<br />Used in: GP25",
    ...
    # Ammo: CfgMagazines|rhs_VOG25P|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_g_vog25p",
        "model": "rhsafrf|addons|rhs_weapons2|vogs|rhs_vog25p",
        "deflecting": 90,
        # Class: CfgAmmo|rhs_g_vog25p|HitEffects [Indent level: 1],
        "hiteffects": {
        ...
        # Ammo: CfgAmmo|rhs_g_vog25p|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_g_vog25p_explosion",
