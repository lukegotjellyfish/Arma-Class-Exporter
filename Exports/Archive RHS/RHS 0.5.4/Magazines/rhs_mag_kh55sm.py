rhs_mag_kh55sm = {
    ...
    # Ammo: CfgMagazines|rhs_mag_kh55sm|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_kh55sm",
        "submunitionammo": "",
    ...
    "mindamageforcamshakehit": "rhs_ammo_kh55sm",
    "count": 1,
    "displayname": "Kh-55SM Nuke (camo)",
    ...
    "hardpoints": ["RHS_HP_KH55SM_INT","RHS_HP_TU95MS6_INT"],
