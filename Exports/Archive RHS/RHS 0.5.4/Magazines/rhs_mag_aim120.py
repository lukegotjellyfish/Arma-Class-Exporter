rhs_mag_aim120 = {
    ...
    "ammo": {
        ...
        "autoseektarget": 1,
        "lockseekradius": 1000,
        # Class: CfgAmmo|rhs_ammo_aim120|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_aim120|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_aim120|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_aim120|Components|SensorsManagerComponent|Components|ActiveRadarSensorComponent [Indent level: 4]
                    "activeradarsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_aim120|Components|SensorsManagerComponent|Components|ActiveRadarSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 30000,
                            "maxrange": 30000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_aim120|Components|SensorsManagerComponent|Components|ActiveRadarSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 30000,
                            "maxrange": 30000,
                            "objectdistancelimitcoef": -1,
    ...
    # Class: CfgMagazines|rhs_mag_aim120|mfdElements [Indent level: 1],
    "mfdelements": {
        # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon [Indent level: 2]
        "rhs_f22_pylon": {
            # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|material [Indent level: 3]
            "material": {
                "ambient": [3,3,3,1],
                "diffuse": [10,10,10,1],
                "emissive": [400,200,200,1]
            },
            # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Bones [Indent level: 3],
            "bones": {
                # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Bones|Center [Indent level: 4]
                "center": {
                    "type": "fixed",
                    "pos": [0,0]
                }
            },
            # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw [Indent level: 3],
            "draw": {
                # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Default [Indent level: 4]
                "default": {
                    "condition": "PylonAmmoRelative>0",
                    "color": [0.15,1,0.15],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Default|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                    ...
                    # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Default|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
                ...
                # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "(PylonSelected +  PylonAmmoRelative)/2",
                    "alpha": 1,
                    # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Selected|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0205729],1],["Center",[0.01,-0.0178161],1],["Center",[0.01732,-0.0102865],1],["Center",[0.02,0],1],["Center",[0.01732,0.0102865],1],["Center",[0.01,0.0178161],1],["Center",[0,0.0205729],1],["Center",[-0.01,0.0178161],1],["Center",[-0.01732,0.0102865],1],["Center",[-0.02,0],1],["Center",[-0.01732,-0.0102865],1],["Center",[-0.01,-0.0178161],1],["Center",[0,-0.0205729],1],[]]
                    },
                    # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Selected|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
                    ...
                    # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Selected|Background [Indent level: 5],
                    "background": {
                        "type": "polygon",
                ...
                # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Empty [Indent level: 4],
                "empty": {
                    "condition": "PylonAmmoRelative <= 0",
                    "color": [1,0,0,1],
                    # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Empty|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0205729],1],["Center",[0.01,-0.0178161],1],["Center",[0.01732,-0.0102865],1],["Center",[0.02,0],1],["Center",[0.01732,0.0102865],1],["Center",[0.01,0.0178161],1],["Center",[0,0.0205729],1],["Center",[-0.01,0.0178161],1],["Center",[-0.01732,0.0102865],1],["Center",[-0.02,0],1],["Center",[-0.01732,-0.0102865],1],["Center",[-0.01,-0.0178161],1],["Center",[0,-0.0205729],1],[]]
                    },
                    # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Empty|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
                    ...
                    # Class: CfgMagazines|rhs_mag_aim120|mfdElements|rhs_f22_pylon|Draw|Empty|Background [Indent level: 5],
                    "background": {
                        "type": "polygon",
                        "points": [[["Center",1,[0,0],1],["Center",[0.0141421,-0.0145472],1],["Center",[0.02,8.99271e-010],1],["Center",[0.0141421,0.0145472],1]],[["Center",1,[0,0],1],["Center",[0.0141421,0.0145472],1],["Center",[-1.74846e-009,0.0205729],1],["Center",[-0.0141421,0.0145472],1]],[["Center",1,[0,0],1],["Center",[-0.0141421,0.0145472],1],["Center",[-0.02,-2.4533e-010],1],["Center",[-0.0141421,-0.0145472],1]],[["Center",1,[0,0],1],["Center",[-0.0141421,-0.0145472],1],["Center",[3.49691e-009,-0.0205729],1],["Center",[0.0141421,-0.0145472],1]]]
                    },
