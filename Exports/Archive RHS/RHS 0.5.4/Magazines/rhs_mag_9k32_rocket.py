rhs_mag_9k32_rocket = {
    # Ammo: CfgMagazines|rhs_mag_9k32_rocket|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_9k32",
        ...
        # Class: CfgAmmo|rhs_ammo_9k32|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_9k32|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_9k32|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_9k32|Components|SensorsManagerComponent|Components|IRSensorComponent [Indent level: 4]
                    "irsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_9k32|Components|SensorsManagerComponent|Components|IRSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 4000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_9k32|Components|SensorsManagerComponent|Components|IRSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 1000,
                            "objectdistancelimitcoef": 1,
    ...
    "mindamageforcamshakehit": "rhs_ammo_9k32",
