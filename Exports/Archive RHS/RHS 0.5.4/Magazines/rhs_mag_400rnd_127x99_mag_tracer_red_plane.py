rhs_mag_400rnd_127x99_mag_tracer_red_plane = {
    # Ammo: CfgMagazines|rhs_mag_400rnd_127x99_mag_Tracer_Red_Plane|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_127x99_Ball_Tracer_Red_Plane",
        # Class: CfgAmmo|rhs_ammo_127x99_Ball_Tracer_Red_Plane|CamShakeFire [Indent level: 1],
        "camshakefire": {
            "power": 1.56508,
            "duration": 0.4,
            "frequency": 20,
        ...
        # Class: CfgAmmo|rhs_ammo_127x99_Ball_Tracer_Red_Plane|CamShakePlayerFire [Indent level: 1],
        "camshakeplayerfire": {
            "power": 6,
            "duration": 0.1,
            "frequency": 20,
