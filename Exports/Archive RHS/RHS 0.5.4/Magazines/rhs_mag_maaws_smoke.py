rhs_mag_maaws_smoke = {
    ...
    # Ammo: CfgMagazines|rhs_mag_maaws_SMOKE|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_maaws_SMOKE",
        ...
        # Class: CfgAmmo|rhs_ammo_maaws_SMOKE|CamShakeExplode [Indent level: 1],
        "camshakeexplode": {
            "power": "(55*0.2)",
        ...
        # Class: CfgAmmo|rhs_ammo_maaws_SMOKE|CamShakeHit [Indent level: 1],
        "camshakehit": {
            "power": 110,
        ...
        # Class: CfgAmmo|rhs_ammo_maaws_SMOKE|CamShakeFire [Indent level: 1],
        "camshakefire": {
            "power": 5,
        ...
        # Class: CfgAmmo|rhs_ammo_maaws_SMOKE|CamShakePlayerFire [Indent level: 1],
        "camshakeplayerfire": {
            "power": 2,
            "duration": 0.2,
            "frequency": 8,
    ...
    "mindamageforcamshakehit": "rhs_ammo_maaws_SMOKE",
    "type": "2*        256",
    "mass": 68.36,
    "value": 5,
    "allowedslots": [901],
