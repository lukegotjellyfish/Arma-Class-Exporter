rhsusf_200rnd_556x45_soft_pouch_ucp = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons|mag_proxies|data|stockpouch_ucp_co.paa"],
    "count": 200,
    ...
    "mass": 45.87,
    # Ammo: CfgMagazines|rhsusf_100Rnd_556x45_soft_pouch|ammo [Indent level: 1],
    "ammo": {
