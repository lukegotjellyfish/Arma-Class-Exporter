rhs_mag_m1_he_12 = {
    ...
    "namesound": "heat",
    # Ammo: CfgMagazines|RHS_mag_m1_he_12|ammo [Indent level: 1],
    "ammo": {
        ...
        "indirecthitrange": 21,
        "timetolive": 220,
        # Class: CfgAmmo|rhs_ammo_m1_he|CamShakeExplode [Indent level: 1],
        "camshakeexplode": {
            "power": "(105*0.2)*10",
        ...
        # Class: CfgAmmo|rhs_ammo_m1_he|CamShakeHit [Indent level: 1],
        "camshakehit": {
            "power": "105 * 10",
        ...
        # Class: CfgAmmo|rhs_ammo_m1_he|CamShakeFire [Indent level: 1],
        "camshakefire": {
            "power": "(105^0.25)*10",
            "duration": "((round (105^0.5))*0.2 max 0.2)",
            "frequency": 20,
