rhs_mag_kh38mte_int = {
    ...
    # Ammo: CfgMagazines|rhs_mag_Kh38mte_int|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_Kh38MTE",
        "model": "rhsafrf|addons|rhs_airweapons|rhs_m_kh38mte_fly",
        "proxyshape": "rhsafrf|addons|rhs_airweapons|rhs_m_kh38mte",
        "weaponlocksystem": "2 + 16",
        # Class: CfgAmmo|rhs_ammo_kh38mte|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_kh38mte|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_kh38mte|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_kh38mte|Components|SensorsManagerComponent|Components|IRSensorComponent [Indent level: 4]
                    "irsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_kh38mte|Components|SensorsManagerComponent|Components|IRSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 6000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_kh38mte|Components|SensorsManagerComponent|Components|IRSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 6000,
                            "objectdistancelimitcoef": 1,
    ...
    "mindamageforcamshakehit": "rhs_ammo_Kh38MTE",
