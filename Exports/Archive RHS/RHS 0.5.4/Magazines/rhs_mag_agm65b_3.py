rhs_mag_agm65b_3 = {
    ...
    "displaynameshort": "TV",
    # Ammo: CfgMagazines|rhs_mag_agm65b_3|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_agm65b",
        ...
        # Class: CfgAmmo|rhs_ammo_agm65b|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_agm65b|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_agm65b|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_agm65b|Components|SensorsManagerComponent|Components|VisualSensorComponent [Indent level: 4]
                    "visualsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_agm65b|Components|SensorsManagerComponent|Components|VisualSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 1000,
                            "maxrange": 4000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_agm65b|Components|SensorsManagerComponent|Components|VisualSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 1000,
                            "maxrange": 4000,
                            "objectdistancelimitcoef": 1,
        ...
        # Ammo: CfgAmmo|rhs_ammo_agm65|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_agm65_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
        ...
        "muzzleeffect": "",
        # Class: CfgAmmo|rhs_ammo_agm65|Hiteffects [Indent level: 1],
        "hiteffects": {
    ...
    "mindamageforcamshakehit": "rhs_ammo_agm65b",
    "hardpoints": ["RHS_HP_AGM65_3x"],
    "pylonweapon": "rhs_weap_agm65b",
    "count": 3,
    "model": "A3|Weapons_F|DynamicLoadout|PylonPod_3x_Missile_AGM_02_F",
    "mirrormissilesindexes": [2,1,3],
    # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements [Indent level: 1],
    "mfdelements": {
        # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_ammoname [Indent level: 2]
        "rhs_a10a_ammoname": {
            # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_ammoname|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_ammoname|Draw [Indent level: 3],
            "draw": {
                "color": [1,1,1],
                "alpha": 1,
                # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_ammoname|Draw|PylonText1 [Indent level: 4],
                "pylontext1": {
                    "type": "text",
                    "source": "static",
                    "text": "AGM",
        ...
        # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box [Indent level: 2],
        "rhs_a10a_box": {
            # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box|Draw [Indent level: 3],
            "draw": {
                "color": [0.15,1,0.15],
                "alpha": 1,
                # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box|Draw|Default [Indent level: 4],
                "default": {
                    "condition": "PylonAmmoRelative>=0.001",
                    "color": [0.15,1,0.15,1],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box|Draw|Default|Shape [Indent level: 5],
                    "shape": {
                        "type": "polygon",
                        "width": 4,
                ...
                # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "PylonSelected*(PylonAmmoRelative>=0.001)",
                    "color": [0.15,1,0.15,1],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box|Draw|Selected|Shape [Indent level: 5],
                    "shape": {
                        "type": "polygon",
                        "width": 4,
                ...
                # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box|Draw|Empty [Indent level: 4],
                "empty": {
                    "condition": "PylonAmmoRelative<=0",
                    "color": [0.87,0,0],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_agm65_x3|mfdElements|rhs_a10a_box|Draw|Empty|Shape [Indent level: 5],
                    "shape": {
                        "type": "polygon",
                        "width": 4,
