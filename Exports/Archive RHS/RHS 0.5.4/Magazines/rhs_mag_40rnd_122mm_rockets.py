rhs_mag_40rnd_122mm_rockets = {
    ...
    "count": 40,
    "initspeed": 690,
    # Ammo: CfgMagazines|rhs_mag_40Rnd_122mm_rockets|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_m21OF_HE",
        # Ammo: CfgAmmo|rhs_ammo_m21OF_HE|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
