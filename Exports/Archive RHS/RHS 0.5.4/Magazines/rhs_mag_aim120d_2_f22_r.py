rhs_mag_aim120d_2_f22_r = {
    ...
    "hardpoints": ["RHS_HP_F22_rBay"],
    "displayname": "AIM-120D (×2)",
    "count": 2,
    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements [Indent level: 1],
    "mfdelements": {
        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon [Indent level: 2]
        "rhs_f22_pylon": {
            # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Bones [Indent level: 3]
            "bones": {
                # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Bones|Center [Indent level: 4]
                "center": {
                    "type": "fixed",
                    "pos": [-0.025,0]
                },
                # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Bones|Center2 [Indent level: 4],
                "center2": {
                    "type": "fixed",
                    "pos": [0.02,-0]
                }
            },
            # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|material [Indent level: 3],
            "material": {
                "ambient": [3,3,3,1],
                "diffuse": [10,10,10,1],
                "emissive": [400,200,200,1]
            },
            # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw [Indent level: 3],
            "draw": {
                # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Default [Indent level: 4]
                "default": {
                    "condition": "PylonAmmoRelative>0",
                    "color": [0.15,1,0.15],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Default|Missile1 [Indent level: 5],
                    "missile1": {
                        "condition": "PylonAmmo>=2",
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Default|Missile1|Shape [Indent level: 6],
                        "shape": {
                            "type": "line",
                            "width": 4,
                    ...
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Default|Missile2 [Indent level: 5],
                    "missile2": {
                        "condition": "PylonAmmo>=1",
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Default|Missile2|Shape [Indent level: 6],
                        "shape": {
                            "type": "line",
                            "width": 4,
                            "points": [["Center2",[0,-0.0205729],1],["Center2",[0.01,-0.0178161],1],["Center2",[0.01732,-0.0102865],1],["Center2",[0.02,0],1],["Center2",[0.01732,0.0102865],1],["Center2",[0.01,0.0178161],1],["Center2",[0,0.0205729],1],["Center2",[-0.01,0.0178161],1],["Center2",[-0.01732,0.0102865],1],["Center2",[-0.02,0],1],["Center2",[-0.01732,-0.0102865],1],["Center2",[-0.01,-0.0178161],1],["Center2",[0,-0.0205729],1],[]]
                        }
                    },
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Default|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
                    ...
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Default|PylonText2 [Indent level: 5],
                    "pylontext2": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
                        ...
                        "sourcescale": 1,
                        "align": "center",
                        "pos": ["Center2",1,[0,-0.015],1],
                        "right": ["Center2",1,[0.03,-0.015],1],
                        "down": ["Center2",1,[0,0.02],1]
                    }
                },
                # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "(PylonSelected +  PylonAmmo/2)/2",
                    "alpha": 1,
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected|Missile1 [Indent level: 5],
                    "missile1": {
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected|Missile1|Shape [Indent level: 6]
                        "shape": {
                            "type": "line",
                            "width": 4,
                            "points": [["Center",[0,-0.0205729],1],["Center",[0.01,-0.0178161],1],["Center",[0.01732,-0.0102865],1],["Center",[0.02,0],1],["Center",[0.01732,0.0102865],1],["Center",[0.01,0.0178161],1],["Center",[0,0.0205729],1],["Center",[-0.01,0.0178161],1],["Center",[-0.01732,0.0102865],1],["Center",[-0.02,0],1],["Center",[-0.01732,-0.0102865],1],["Center",[-0.01,-0.0178161],1],["Center",[0,-0.0205729],1],[]]
                        },
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected|Missile1|Background [Indent level: 6],
                        "background": {
                            "type": "polygon",
                    ...
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected|Missile2 [Indent level: 5],
                    "missile2": {
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected|Missile2|Shape [Indent level: 6]
                        "shape": {
                            "type": "line",
                            "width": 4,
                            "points": [["Center2",[0,-0.0205729],1],["Center2",[0.01,-0.0178161],1],["Center2",[0.01732,-0.0102865],1],["Center2",[0.02,0],1],["Center2",[0.01732,0.0102865],1],["Center2",[0.01,0.0178161],1],["Center2",[0,0.0205729],1],["Center2",[-0.01,0.0178161],1],["Center2",[-0.01732,0.0102865],1],["Center2",[-0.02,0],1],["Center2",[-0.01732,-0.0102865],1],["Center2",[-0.01,-0.0178161],1],["Center2",[0,-0.0205729],1],[]]
                        },
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected|Missile2|Background [Indent level: 6],
                        "background": {
                            "type": "polygon",
                            "points": [[["Center2",1,[0,0],1],["Center2",[0.0141421,-0.0145472],1],["Center2",[0.02,8.99271e-010],1],["Center2",[0.0141421,0.0145472],1]],[["Center2",1,[0,0],1],["Center2",[0.0141421,0.0145472],1],["Center2",[-1.74846e-009,0.0205729],1],["Center2",[-0.0141421,0.0145472],1]],[["Center2",1,[0,0],1],["Center2",[-0.0141421,0.0145472],1],["Center2",[-0.02,-2.4533e-010],1],["Center2",[-0.0141421,-0.0145472],1]],[["Center2",1,[0,0],1],["Center2",[-0.0141421,-0.0145472],1],["Center2",[3.49691e-009,-0.0205729],1],["Center2",[0.0141421,-0.0145472],1]]]
                        },
                        "condition": "PylonAmmo>=1"
                    },
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
                    ...
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Selected|PylonText2 [Indent level: 5],
                    "pylontext2": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
                ...
                # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|HalfEmpty [Indent level: 4],
                "halfempty": {
                    "alpha": 0.15,
                    "condition": "PylonAmmoRelative <= 1",
                    "color": [1,0,0,1],
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|HalfEmpty|Missile1 [Indent level: 5],
                    "missile1": {
                        "condition": "PylonAmmo<=1",
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|HalfEmpty|Missile1|Shape [Indent level: 6],
                        "shape": {
                            "type": "line",
                            "width": 4,
                            "points": [["Center",[0,-0.0205729],1],["Center",[0.01,-0.0178161],1],["Center",[0.01732,-0.0102865],1],["Center",[0.02,0],1],["Center",[0.01732,0.0102865],1],["Center",[0.01,0.0178161],1],["Center",[0,0.0205729],1],["Center",[-0.01,0.0178161],1],["Center",[-0.01732,0.0102865],1],["Center",[-0.02,0],1],["Center",[-0.01732,-0.0102865],1],["Center",[-0.01,-0.0178161],1],["Center",[0,-0.0205729],1],[]]
                        },
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|HalfEmpty|Missile1|Background [Indent level: 6],
                        "background": {
                            "type": "polygon",
                            "points": [[["Center",1,[0,0],1],["Center",[0.0141421,-0.0145472],1],["Center",[0.02,8.99271e-010],1],["Center",[0.0141421,0.0145472],1]],[["Center",1,[0,0],1],["Center",[0.0141421,0.0145472],1],["Center",[-1.74846e-009,0.0205729],1],["Center",[-0.0141421,0.0145472],1]],[["Center",1,[0,0],1],["Center",[-0.0141421,0.0145472],1],["Center",[-0.02,-2.4533e-010],1],["Center",[-0.0141421,-0.0145472],1]],[["Center",1,[0,0],1],["Center",[-0.0141421,-0.0145472],1],["Center",[3.49691e-009,-0.0205729],1],["Center",[0.0141421,-0.0145472],1]]]
                        }
                    },
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|HalfEmpty|Missile2 [Indent level: 5],
                    "missile2": {
                        "condition": "PylonAmmo<=0",
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|HalfEmpty|Missile2|Shape [Indent level: 6],
                        "shape": {
                            "type": "line",
                            "width": 4,
                            "points": [["Center2",[0,-0.0205729],1],["Center2",[0.01,-0.0178161],1],["Center2",[0.01732,-0.0102865],1],["Center2",[0.02,0],1],["Center2",[0.01732,0.0102865],1],["Center2",[0.01,0.0178161],1],["Center2",[0,0.0205729],1],["Center2",[-0.01,0.0178161],1],["Center2",[-0.01732,0.0102865],1],["Center2",[-0.02,0],1],["Center2",[-0.01732,-0.0102865],1],["Center2",[-0.01,-0.0178161],1],["Center2",[0,-0.0205729],1],[]]
                        },
                        # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|HalfEmpty|Missile2|Background [Indent level: 6],
                        "background": {
                            "type": "polygon",
                            "points": [[["Center2",1,[0,0],1],["Center2",[0.0141421,-0.0145472],1],["Center2",[0.02,8.99271e-010],1],["Center2",[0.0141421,0.0145472],1]],[["Center2",1,[0,0],1],["Center2",[0.0141421,0.0145472],1],["Center2",[-1.74846e-009,0.0205729],1],["Center2",[-0.0141421,0.0145472],1]],[["Center2",1,[0,0],1],["Center2",[-0.0141421,0.0145472],1],["Center2",[-0.02,-2.4533e-010],1],["Center2",[-0.0141421,-0.0145472],1]],[["Center2",1,[0,0],1],["Center2",[-0.0141421,-0.0145472],1],["Center2",[3.49691e-009,-0.0205729],1],["Center2",[0.0141421,-0.0145472],1]]]
                        }
                ...
                # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Empty [Indent level: 4],
                "empty": {
                    "condition": "PylonAmmoRelative <= 0",
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Empty|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
                    ...
                    # Class: CfgMagazines|rhs_mag_aim120d_2_F22_l|mfdElements|rhs_f22_pylon|Draw|Empty|PylonText2 [Indent level: 5],
                    "pylontext2": {
                        "type": "text",
                        "source": "static",
                        "text": "C",
