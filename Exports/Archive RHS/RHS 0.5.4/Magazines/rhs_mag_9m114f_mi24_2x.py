rhs_mag_9m114f_mi24_2x = {
    ...
    # Ammo: CfgMagazines|rhs_mag_9M114F_Mi24_2x|ammo [Indent level: 1],
    "ammo": {
        ...
        "indirecthitrange": 15,
        "explosive": 1,
        # Class: CfgAmmo|rhs_ammo_9m114f|CamShakeExplode [Indent level: 1],
        "camshakeexplode": {
            "power": 22,
            "duration": 2,
            "frequency": 20,
        ...
        # Class: CfgAmmo|rhs_ammo_9m114f|CamShakeHit [Indent level: 1],
        "camshakehit": {
            "power": 110,
            "duration": 0.6,
            "frequency": 20,
