rhsusf_opscore_coy_cover_pelt = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_opscore_coy_cover_pelt_ca.paa",
    "scope": 2,
    "displayname": "FAST Ballistic (Coyote Cover/Headset/NSW)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|comtac_fg_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|nsw_co.paa","","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|fs_cover_cb_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
    ...
    # Class: CfgWeapons|rhsusf_opscore_cover|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 30,
        "armor": 6,
