rhs_acc_pgs64 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_pgs64_ca.paa",
    "author": "Red Hammer Studios",
    "model": "rhsafrf|addons|rhs_weapons|acc|muzzle|pgs64|pgs64.p3d",
    "displayname": "PG S64",
    # Class: CfgWeapons|rhs_acc_pgs64|ItemInfo [Indent level: 1],
    "iteminfo": {
        "alternativefire": "rhs_muzzleflash_pgs64",
        # Class: CfgWeapons|rhs_acc_pgs64|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "visiblefire": 0.95,
        ...
        # Class: CfgWeapons|rhs_acc_pgs64|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
