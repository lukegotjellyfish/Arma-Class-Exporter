rhsusf_ach_bare_wood = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_bare_wood_ca.paa",
    "displayname": "ACH (Woodland)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|ach_bare_01",
    "hiddenselections": ["Camo","Camo1"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_mich_wood_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
    # Class: CfgWeapons|rhsusf_ach_bare_wood|ItemInfo [Indent level: 1],
    "iteminfo": {
