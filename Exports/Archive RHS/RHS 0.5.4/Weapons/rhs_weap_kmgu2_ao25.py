rhs_weap_kmgu2_ao25 = {
    "magazines": ["rhs_mag_kmgu2_ao25","rhs_mag_kmgu2_ao25_bd3_umk2a","rhs_mag_kmgu2_ao25_ka52"],
    "displayname": "KMGU-2",
    "airateoffire": 1,
    ...
    "reloadtime": 0.4,
    "salvo": 2,
    "modes": ["Instant","Fast","Medium","Slow"],
    # Class: CfgWeapons|rhs_weap_kmgu2|Instant [Indent level: 1],
    "instant": {
        "burst": 8,
        "reloadtime": 0.05,
        "salvo": 2,
    ...
    # Class: CfgWeapons|rhs_weap_kmgu2|Fast [Indent level: 1],
    "fast": {
        "reloadtime": 0.2,
    ...
    # Class: CfgWeapons|rhs_weap_kmgu2|Medium [Indent level: 1],
    "medium": {
        "reloadtime": 1,
        "texturetype": "burst",
        "burst": 8,
    ...
    # Class: CfgWeapons|rhs_weap_kmgu2|Slow [Indent level: 1],
    "slow": {
        "reloadtime": 1.5,
        "texturetype": "semi",
        "burst": 8,
