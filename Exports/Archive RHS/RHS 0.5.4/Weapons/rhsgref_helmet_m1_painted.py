rhsgref_helmet_m1_painted = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_M1_painted_ca.paa",
    ...
    # Class: CfgWeapons|rhsgref_helmet_M1_painted|ItemInfo [Indent level: 1],
    "iteminfo": {
