rhsusf_spcs_ocp_teamleader_alt = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry|data|rhs_spcs_ocp_01_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_vest_iotv2_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_vest_iotv3_co.paa","rhsusf|addons|rhsusf_infantry2|gear|vests|mbav|data|mbav_gear_co.paa","rhsusf|addons|rhsusf_weapons|grenades|m18|data|m18_green_ca.paa"],
    # Class: CfgWeapons|rhsusf_spcs_ocp_teamleader_alt|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["camo","camo1","camo2","camo3","camo4"],
        "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry|data|rhs_spcs_ocp_01_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_vest_iotv2_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_vest_iotv3_co.paa","rhsusf|addons|rhsusf_infantry2|gear|vests|mbav|data|mbav_gear_co.paa","rhsusf|addons|rhsusf_weapons|grenades|m18|data|m18_green_ca.paa"],
