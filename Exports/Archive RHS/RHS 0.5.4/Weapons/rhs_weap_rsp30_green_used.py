rhs_weap_rsp30_green_used = {
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_weapons|rsp30|rhs_rsp30_green_co.paa"],
    "hiddenselectionsmaterials": ["rhsafrf|addons|rhs_weapons|rsp30|rhs_rsp30_green.rvmat"],
