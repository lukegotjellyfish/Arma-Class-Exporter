rhs_acc_pgo7v3 = {
    ...
    # Class: CfgWeapons|rhs_acc_pgo7v3|ItemInfo [Indent level: 1],
    "iteminfo": {
        ...
        "optics": 1,
        # Class: CfgWeapons|rhs_acc_pgo7v|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pgo7v|ItemInfo|OpticsModes|rhs_pgo7v_scope [Indent level: 3]
            "rhs_pgo7v_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_pgo7v|ItemInfo|OpticsModes|rhs_pgo7v_iron [Indent level: 3],
            "rhs_pgo7v_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
