rhsusf_opscore_mar_ut = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|maritime_tan.paa","rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|tan2_co.paa",""],
