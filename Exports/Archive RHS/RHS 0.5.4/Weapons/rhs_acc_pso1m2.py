rhs_acc_pso1m2 = {
    ...
    "scope": 2,
    # Class: CfgWeapons|rhs_acc_pso1m2|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_pso1m2|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pso1m2|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
            ...
            # Class: CfgWeapons|rhs_acc_pso1m2|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
