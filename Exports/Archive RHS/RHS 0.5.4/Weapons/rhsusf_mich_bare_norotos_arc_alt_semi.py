rhsusf_mich_bare_norotos_arc_alt_semi = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_arc_alt_semi_ca.paa",
    "displayname": "MICH 2000 (Semi-Arid/Norotos/ARC/Alt)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_bare_01_nor1_arc_alt",
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_arc_alt_semi|ItemInfo [Indent level: 1],
    "iteminfo": {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_norotos_painted_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_painted_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa"],
    "scope": 2,
    "hiddenselections": ["Camo","Camo1","Camo2"],
