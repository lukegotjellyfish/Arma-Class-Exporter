rhsusf_mich_helmet_marpatd_norotos_arc = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry|gear|head|data|mich_covered_norotos_arc_des_co.paa","rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_od_co.paa"],
