rhsgref_mg42_acc_aasight = {
    ...
    # Class: CfgWeapons|rhsgref_mg42_acc_AAsight|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 4,
        ...
        # Class: CfgWeapons|rhsgref_mg42_acc_AAsight|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsgref_mg42_acc_AAsight|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
