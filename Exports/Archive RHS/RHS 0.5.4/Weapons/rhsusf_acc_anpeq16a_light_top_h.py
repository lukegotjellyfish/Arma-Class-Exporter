rhsusf_acc_anpeq16a_light_top_h = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    "model": "rhsusf|addons|rhsusf_weapons|acc|lasers|ANPEQ16|peq16a_top_h",
    "rhs_acc_combo": "rhsusf_acc_anpeq16a_top_h",
    "dlc": "RHS_USAF",
    "displayname": "AN/PEQ-16A (Top/Light)",
    "rhs_anpeq15_base": "rhsusf_acc_anpeq16a_light_top",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_anpeq16a_light_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_acc_anpeq15_light|ItemInfo [Indent level: 1],
    "iteminfo": {
        "rmbhint": "Flashlight",
        "mass": 8,
        # Class: CfgWeapons|rhsusf_acc_anpeq15_light|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
        },
        # Class: CfgWeapons|rhsusf_acc_anpeq15_light|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
            "color": [25,22,20],
            ...
            "flaresize": 0.7,
            "onlyinnvg": 0,
            # Class: CfgWeapons|rhsusf_acc_anpeq15_light|ItemInfo|FlashLight|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 2,
                "linear": 1,
