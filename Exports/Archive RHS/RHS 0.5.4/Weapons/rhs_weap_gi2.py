rhs_weap_gi2 = {
    "displayname": "GI-2",
    # Class: CfgWeapons|rhs_weap_gi2|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_gi2|GunParticles|Effect [Indent level: 2]
        "effect": {
    ...
    "magazines": [],
    "muzzles": ["HE","AP"],
    # Class: CfgWeapons|rhs_weap_gi2|HE [Indent level: 1],
    "he": {
        "displayname": "GI-2 HE",
        "magazines": ["rhs_mag_GI2_420_HE"],
        "aidispersioncoefx": 2,
        "aidispersioncoefy": 4,
    ...
    # Class: CfgWeapons|rhs_weap_gi2|AP [Indent level: 1],
    "ap": {
        "displayname": "GI-2 AP",
        "magazines": ["rhs_mag_GI2_420_AP"],
        "aidispersioncoefx": 2,
        "scope": 1,
        "cursor": "mg",
        "cursoraim": "EmptyCursor",
