rhsusf_acc_elcan_3d = {
    ...
    # Class: CfgWeapons|rhsusf_acc_elcan_3d|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_elcan_3d|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_elcan_3d|ItemInfo|OpticsModes|elcan_scope [Indent level: 3]
            "elcan_scope": {
                "opticsid": 2,
                "usemodeloptics": 0,
                "opticsppeffects": ["OpticsCHAbera1","OpticsBlur2","rhs_m150_Blur"],
                "discretedistance": [100],
                "discretedistanceinitindex": 0,
                "opticszoommin": "0.125/1.3",
                "opticszoommax": 0.125,
            ...
            # Class: CfgWeapons|rhsusf_acc_elcan_3d|ItemInfo|OpticsModes|alternative_view [Indent level: 3],
            "alternative_view": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_ELCAN_ca.paa",
    "displayname": "M145 MGO",
    "descriptionshort": "M145 MGO",
