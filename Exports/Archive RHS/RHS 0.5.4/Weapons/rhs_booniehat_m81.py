rhs_booniehat_m81 = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhs_Booniehat_m81_ca.paa",
    "scope": 2,
    "displayname": "Booniehat M81",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|booniehat_m81_co"],
