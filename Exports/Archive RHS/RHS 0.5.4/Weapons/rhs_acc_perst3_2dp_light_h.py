rhs_acc_perst3_2dp_light_h = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_perst3_2dp_light_h_ca.paa",
    "dlc": "RHS_AFRF",
    "author": "Red Hammer Studios",
    "scope": 2,
    "scopearsenal": 2,
    "rhs_acc_combo": "rhs_acc_perst3_2dp_h",
    "rhs_acc_combo_text": "Switched to Laser",
    "model": "rhsafrf|addons|rhs_weapons3|acc|lasers|lcu3|rhs_lcu3_2dp_side.p3d",
    "displayname": "Perst-3/2DP (Light)",
    "rhs_anpeq15_base": "rhs_acc_perst3_2dp_light",
    # Class: CfgWeapons|rhs_acc_perst3_2dp_light|ItemInfo [Indent level: 1],
    "iteminfo": {
        "rmbhint": "Flashlight",
        "mass": 8,
        # Class: CfgWeapons|rhs_acc_perst3_2dp_light|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
        },
        # Class: CfgWeapons|rhs_acc_perst3_2dp_light|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
            "color": [25,22,20],
            ...
            "flaresize": 0.7,
            "onlyinnvg": 0,
            # Class: CfgWeapons|rhs_acc_perst3_2dp_light|ItemInfo|FlashLight|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 2,
                "linear": 1,
    ...
    "weaponinfotype": "RHS_FlashlightRU",
    "inertia": 0.2,
