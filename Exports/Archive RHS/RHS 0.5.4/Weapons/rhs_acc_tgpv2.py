rhs_acc_tgpv2 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_tgpv2_ca.paa",
    "author": "Red Hammer Studios",
    "scope": 2,
    "model": "rhsafrf|addons|rhs_weapons3|acc|muzzle|tgpv2|rhs_tgpv2.p3d",
    "displayname": "TGP-V2",
    "dlc": "RHS_AFRF",
    # Class: CfgWeapons|rhs_silencer_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 7,
        # Class: CfgWeapons|rhs_silencer_base|ItemInfo|MagazineCoef [Indent level: 2],
        "magazinecoef": {
            "initspeed": 1.01
        },
        # Class: CfgWeapons|rhs_silencer_base|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "visiblefire": 0.2,
            "audiblefire": 0.4,
        ...
        # Class: CfgWeapons|rhs_silencer_base|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "dispersioncoef": "0.8f",
