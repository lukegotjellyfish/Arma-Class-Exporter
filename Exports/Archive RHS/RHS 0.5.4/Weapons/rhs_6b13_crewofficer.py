rhs_6b13_crewofficer = {
    ...
    "displayname": "6B13 VSR (Crew Officer)",
    "model": "rhsafrf|addons|rhs_infantry|gear|vests|rhs_6b13_crewofficer",
    # Class: CfgWeapons|rhs_6b13_crewofficer|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsafrf|addons|rhs_infantry|gear|vests|rhs_6b13_crewofficer",
        "containerclass": "Supply40",
        "mass": 85,
        # Class: CfgWeapons|rhs_6b13|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_6b13|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
            ...
            # Class: CfgWeapons|rhs_6b13|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
            ...
            # Class: CfgWeapons|rhs_6b13|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
            ...
            # Class: CfgWeapons|rhs_6b13|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
            ...
            # Class: CfgWeapons|rhs_6b13|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
