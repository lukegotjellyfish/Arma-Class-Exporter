rhsusf_acc_m8541_mrds = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_M8541_mrds_ca.paa",
    "scope": 2,
    "displayname": "M8541 (MRDS)",
    "author": "Red Hammer Studios",
    "model": "rhsusf|addons|rhsusf_scopes|sb_M8541|rhs_M8541_pt",
    # Class: CfgWeapons|rhsusf_acc_M8541_mrds|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 9,
        # Class: CfgWeapons|rhsusf_acc_M8541_mrds|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_M8541_mrds|ItemInfo|OpticsModes|Snip [Indent level: 3]
            "snip": {
                "opticsid": 1,
                ...
                "modeloptics": ["|rhsusf|addons|rhsusf_weapons|acc|scopes|optics|rhsusf_prem_mildot3","|rhsusf|addons|rhsusf_weapons|acc|scopes|optics|rhsusf_prem_mildot6","|rhsusf|addons|rhsusf_weapons|acc|scopes|optics|rhsusf_prem_mildot9","|rhsusf|addons|rhsusf_weapons|acc|scopes|optics|rhsusf_prem_mildot12"],
                "visionmode": ["Normal"],
                "opticsflare": 1,
                "opticsdisableperipherialvision": 1,
                "cameradir": ""
            },
            # Class: CfgWeapons|rhsusf_acc_M8541_mrds|ItemInfo|OpticsModes|Mrds [Indent level: 3],
            "mrds": {
                "opticsid": 2,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
    ...
    "descriptionshort": "Magnification: 3-12x",
