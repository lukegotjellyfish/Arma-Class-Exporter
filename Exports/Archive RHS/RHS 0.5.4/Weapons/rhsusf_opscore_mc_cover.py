rhsusf_opscore_mc_cover = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_opscore_mc_cover_ca.paa",
    "scope": 2,
    "displayname": "FAST Ballistic (Multicam Cover)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_co.paa","","","","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|fs_cover_co.paa",""],
