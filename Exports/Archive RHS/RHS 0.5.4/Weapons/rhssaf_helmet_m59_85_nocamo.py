rhssaf_helmet_m59_85_nocamo = {
    ...
    # Class: CfgWeapons|rhssaf_helmet_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 42,
        ...
        "modelsides": [6],
        "hiddenselections": ["camo"],
        # Class: CfgWeapons|rhssaf_helmet_base|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_helmet_base|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
