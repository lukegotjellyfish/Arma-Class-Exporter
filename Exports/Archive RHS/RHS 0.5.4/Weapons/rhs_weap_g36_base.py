rhs_weap_g36_base = {
    ...
    # Class: CfgWeapons|rhs_weap_g36_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_g36_base|WeaponSlotsInfo|PointerSlot [Indent level: 2]
        "pointerslot": {
        },
        # Class: CfgWeapons|rhs_weap_g36_base|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        },
        "mass": 2,
        # Class: CfgWeapons|Rifle|WeaponSlotsInfo|CowsSlot [Indent level: 2],
