rhs_weap_scarh_std_grip2_su230a = {
    # Class: CfgWeapons|rhs_weap_SCARH_STD_grip2_su230a|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_STD_grip2_su230a|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_su230a"
        },
        # Class: CfgWeapons|rhs_weap_SCARH_STD_grip2_su230a|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
            "slot": "GripodSlot",
