rhsusf_lwh_helmet_marpatwd = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_lwh_helmet_marpatwd_ca.paa",
    "displayname": "LWH MARPAT-WD",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|lwh_wd_co.paa"],
    "allowedfacewear": ["",6,"rhs_googles_black",3,"rhs_googles_clear",1],
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|lwh_wd",
    "hiddenselections": ["camo","Camo2"],
    # Class: CfgWeapons|rhsusf_lwh_helmet_marpatd|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
