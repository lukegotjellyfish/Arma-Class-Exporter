rhs_weap_vhsd2_bg_ct15x = {
    ...
    # Class: CfgWeapons|rhs_weap_vhsd2_bg_ct15x|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 136.4,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_vhsd2_bg_ct15x|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_vhsd2_bg_ct15x|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
