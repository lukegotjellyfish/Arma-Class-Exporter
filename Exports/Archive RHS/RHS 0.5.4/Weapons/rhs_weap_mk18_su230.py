rhs_weap_mk18_su230 = {
    # Class: CfgWeapons|rhs_weap_mk18_SU230|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_SU230|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_su230_mrds_c"
        },
        # Class: CfgWeapons|rhs_weap_mk18_SU230|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
