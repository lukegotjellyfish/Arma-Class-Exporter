rhs_6sh46 = {
    ...
    # Class: CfgWeapons|rhs_6sh46|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo"],
        "uniformmodel": "rhsafrf|addons|rhs_infantry|gear|vests|rhs_6sh46",
        "containerclass": "Supply40",
        "mass": 15,
        # Class: CfgWeapons|rhs_6sh46|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_6sh46|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3]
            "body": {
