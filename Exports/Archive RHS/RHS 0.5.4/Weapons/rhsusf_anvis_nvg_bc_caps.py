rhsusf_anvis_nvg_bc_caps = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_anvis_nvg_bc_caps_ca.paa",
    "scope": 1,
    "scopecurator": 1,
    ...
    # Class: CfgWeapons|rhsusf_anvis_nvg_bc_caps|ItemInfo [Indent level: 1],
    "iteminfo": {
        "type": 616,
        "hmdtype": 0,
