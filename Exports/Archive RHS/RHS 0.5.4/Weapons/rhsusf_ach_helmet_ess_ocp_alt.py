rhsusf_ach_helmet_ess_ocp_alt = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_helmet_ESS_ocp_alt_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_ach_helmet_ESS_ocp|ItemInfo [Indent level: 1],
    "iteminfo": {
