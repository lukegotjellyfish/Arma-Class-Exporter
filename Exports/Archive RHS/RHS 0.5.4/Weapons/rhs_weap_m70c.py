rhs_weap_m70c = {
    ...
    "modes": ["Single0","Single1","Single2","Burst0","Burst1"],
    # Class: CfgWeapons|rhs_weap_m70c|Single0 [Indent level: 1],
    "single0": {
        "displayname": "CHARGE 0",
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_m70c|Single0|StandardSound [Indent level: 2],
        "standardsound": {
    ...
    # Class: CfgWeapons|rhs_weap_m70c|Single1 [Indent level: 1],
    "single1": {
    ...
    # Class: CfgWeapons|rhs_weap_m70c|Single2 [Indent level: 1],
    "single2": {
    ...
    # Class: CfgWeapons|rhs_weap_m70c|Burst0 [Indent level: 1],
    "burst0": {
        "showtoplayer": 0,
        ...
        "aiburstterminable": 1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_m70c|Burst0|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_01",1.25893,1,250],
            "begin2": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_02",1.25893,1,250],
            "soundbegin": ["begin1",0.5,"begin2",0.5]
    ...
    # Class: CfgWeapons|rhs_weap_m70c|Burst1 [Indent level: 1],
    "burst1": {
        "showtoplayer": 0,
    ...
    # Class: CfgWeapons|mortar_82mm|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|mortar_82mm|GunParticles|FirstEffect [Indent level: 2]
        "firsteffect": {
    ...
    # Class: CfgWeapons|mortar_82mm|Single3 [Indent level: 1],
    "single3": {
        "displayname": "Semi (far)",
        "artillerycharge": 1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|mortar_82mm|Single1|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_01",1.25893,1,250],
            "begin2": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_02",1.25893,1,250],
            "soundbegin": ["begin1",0.5,"begin2",0.5],
    ...
    # Class: CfgWeapons|mortar_82mm|Burst2 [Indent level: 1],
    "burst2": {
        "showtoplayer": 0,
        "displayname": "Burst (medium)",
        "artillerycharge": 0.7,
        ...
        "aiburstterminable": 1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|mortar_82mm|Burst1|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_01",1.25893,1,250],
            "begin2": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_02",1.25893,1,250],
            "soundbegin": ["begin1",0.5,"begin2",0.5],
    ...
    # Class: CfgWeapons|mortar_82mm|Burst3 [Indent level: 1],
    "burst3": {
        "showtoplayer": 0,
