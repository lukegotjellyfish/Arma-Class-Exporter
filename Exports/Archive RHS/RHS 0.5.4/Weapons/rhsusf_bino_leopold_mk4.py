rhsusf_bino_leopold_mk4 = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_bino_leopold_mk4p_ca.paa",
    "author": "Red Hammer Studios",
    "dlc": "RHS_USAF",
    "scope": 2,
    "displayname": "M151 Spotting Scope",
    # Class: CfgWeapons|rhsusf_bino_leopold_mk4|Library [Indent level: 1],
    "library": {
    ...
    "descriptionshort": "Leupold spotting Scope",
    "model": "rhsusf|addons|rhsusf_weapons|misc|LeupoldMk4|Rhs_Spotter_mk4.p3d",
    "modeloptics": "rhsusf|addons|rhsusf_weapons|acc|scopes|optics|rhsusf_leu_H58_20",
    "opticszoommin": 0.0175,
    "opticszoommax": 0.0175,
    "opticszoominit": 0.0175,
    "distancezoommin": 1097,
    "distancezoommax": 1097,
    "visionmode": ["Normal"],
    # Class: CfgWeapons|rhsusf_bino_leopold_mk4|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 20
    },
