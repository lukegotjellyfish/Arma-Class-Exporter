rhsusf_acc_anpvs27 = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_anpvs27_ca.paa",
    "dlc": "RHS_USAF",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsusf_acc_anpvs27|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 4,
        ...
        # Class: CfgWeapons|rhsusf_acc_anpvs27|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_anpvs27|ItemInfo|OpticsModes|PVS27 [Indent level: 3]
            "pvs27": {
                "opticsid": 1,
                "usemodeloptics": 1,
