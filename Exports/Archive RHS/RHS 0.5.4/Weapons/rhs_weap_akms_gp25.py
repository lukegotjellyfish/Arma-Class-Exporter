rhs_weap_akms_gp25 = {
    ...
    # Class: CfgWeapons|rhs_weap_akms_gp25|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 105.6,
        # Class: CfgWeapons|rhs_weap_akms_gp25|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_akms_gp25|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_akms_gp25|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        # Class: CfgWeapons|rhs_weap_akms_gp25|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        "allowedslots": [901]
    },
