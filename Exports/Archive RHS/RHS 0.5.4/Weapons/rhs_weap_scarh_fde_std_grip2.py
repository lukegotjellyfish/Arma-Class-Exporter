rhs_weap_scarh_fde_std_grip2 = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_FDE_STD_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_FDE_STD_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
