rhsusf_acc_sf3p556 = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_SF3P556_ca.paa",
    "scope": 2,
    "displayname": "SF3P-556-1/2-28",
    "author": "Red Hammer Studios",
    "model": "rhsusf|addons|rhsusf_weapons|acc|silencers|surefirebrakes|SF3P556.p3d",
    # Class: CfgWeapons|rhsusf_acc_SF3P556|ItemInfo [Indent level: 1],
    "iteminfo": {
        "soundtypeindex": 0,
        "inertia": 0.05,
        ...
        # Class: CfgWeapons|rhsusf_acc_SF3P556|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "dispersioncoef": "1.0f",
