rhssaf_helmet_m97_olive_nocamo_black_ess_bare = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "displayname": "M97 (Olive/Black ESS/Bare)",
    ...
    # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo_black_ess_bare|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 42,
        ...
        "modelsides": [6],
        "hiddenselections": ["camo","camo2"],
        # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo_black_ess_bare|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo_black_ess_bare|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
    ...
    "descriptionshort": "Armor Level IIIA",
