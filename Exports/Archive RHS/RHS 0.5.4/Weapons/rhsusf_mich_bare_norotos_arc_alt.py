rhsusf_mich_bare_norotos_arc_alt = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_arc_alt_ca.paa",
    "displayname": "MICH 2000 (Norotos/ARC/Alt)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_bare_01_nor1_arc_alt",
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_arc_alt|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_od_norotos_arc_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_od_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
    "scope": 2,
    "hiddenselections": ["Camo","Camo1","Camo2"],
