rhsgref_helmet_pasgt_un = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_pasgt_un_ca.paa",
    "scope": 2,
    "displayname": "PASGT (UN)",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|pasgt_helmet_un_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_pasgt_un|ItemInfo [Indent level: 1],
    "iteminfo": {
