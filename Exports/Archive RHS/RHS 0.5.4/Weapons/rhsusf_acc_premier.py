rhsusf_acc_premier = {
    ...
    # Class: CfgWeapons|rhsusf_acc_premier|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 2,
        "mass": 8,
        ...
        # Class: CfgWeapons|rhsusf_acc_premier|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_premier|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
                "opticsid": 1,
                "usemodeloptics": 1,
