rhsgref_hat_m43cap_heer = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_hat_m43cap_heer_ca.paa",
    "displayname": "M43 Cap",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|m43cap",
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m43_heer1_co.paa"],
    # Class: CfgWeapons|rhsgref_hat_m43cap_heer|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 5,
        "uniformmodel": "rhsgref|addons|rhsgref_infantry|gear|Head|m43cap",
