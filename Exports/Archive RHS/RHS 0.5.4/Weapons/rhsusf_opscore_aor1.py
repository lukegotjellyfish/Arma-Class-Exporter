rhsusf_opscore_aor1 = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_opscore_aor1_ca.paa",
    "scope": 2,
    "displayname": "FAST Ballistic (AOR1)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_aor1_co.paa"],
