rhs_weap_mk18_grip_kac_d = {
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip_KAC_d|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 54.56,
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip_KAC_d|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_grip_KAC_d|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
