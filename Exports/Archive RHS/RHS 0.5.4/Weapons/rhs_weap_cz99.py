rhs_weap_cz99 = {
    ...
    "magazines": ["rhssaf_mag_15Rnd_9x19_FMJ","rhssaf_mag_15Rnd_9x19_JHP"],
    "magazinewell": ["CZ99_9x19_PARA"],
    "minrange": 5,
    "minrangeprobab": 0.3,
    "midrange": 25,
    "midrangeprobab": 0.6,
    ...
    "dispersion": 0.02,
    "reloadtime": 0.13,
    # Class: CfgWeapons|rhs_weap_cz99|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "holsterscale": 1,
        "holsteroffset": "holster",
        "mass": 20.9,
        # Class: CfgWeapons|rhs_weap_cz99|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_cz99|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        },
        # Class: CfgWeapons|rhs_weap_cz99|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        }
    },
    "muzzles": ["this"],
