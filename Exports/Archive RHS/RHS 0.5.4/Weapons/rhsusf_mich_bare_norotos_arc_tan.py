rhsusf_mich_bare_norotos_arc_tan = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_arc_tan_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_arc_tan|ItemInfo [Indent level: 1],
    "iteminfo": {
