rhsusf_mich_bare_alt_tan = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_alt_tan_ca.paa",
    "displayname": "MICH 2000 (Tan/Alt)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_bare_01_alt",
    # Class: CfgWeapons|rhsusf_mich_bare_alt_tan|ItemInfo [Indent level: 1],
    "iteminfo": {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_tan_rhino_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_tan_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa"],
    "scope": 2,
    "hiddenselections": ["Camo","Camo1","Camo2"],
