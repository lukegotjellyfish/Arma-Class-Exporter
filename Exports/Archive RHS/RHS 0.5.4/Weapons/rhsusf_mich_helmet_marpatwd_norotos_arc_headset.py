rhsusf_mich_helmet_marpatwd_norotos_arc_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_helmet_marpatwd_norotos_arc_headset_ca.paa",
    "displayname": "MICH 2000 MARPAT-WD (Norotos/ARC/Headset)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_01_nor1_arc_bowman",
    # Class: CfgWeapons|rhsusf_mich_helmet_marpatwd_norotos_arc_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry|gear|head|data|mich_covered_norotos_arc_wd_co.paa","rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_od_co.paa"],
    "scope": 2,
