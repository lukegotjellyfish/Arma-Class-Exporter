rhs_weap_m240h_1 = {
    # Class: CfgWeapons|rhs_weap_m240H_1|GunParticles [Indent level: 1]
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_m240H_1|GunParticles|FirstEffect [Indent level: 2]
        "firsteffect": {
            "effectname": "MachineGun1",
            "positionname": "muzzle_1",
            "directionname": "chamber_1"
        },
        # Class: CfgWeapons|rhs_weap_m240H_1|GunParticles|effect1 [Indent level: 2],
        "effect1": {
            "positionname": "shelleject_1_start",
            "directionname": "shelleject_1_end",
            "effectname": "RHSUSF_762Cartridge"
        },
        # Class: CfgWeapons|rhs_weap_m240H_1|GunParticles|RHSUSF_BarrelRefract [Indent level: 2],
