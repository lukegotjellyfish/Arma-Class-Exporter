rhsusf_ach_helmet_ucp_norotos = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_helmet_ucp_norotos_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_ach_helmet_ucp_norotos|ItemInfo [Indent level: 1],
    "iteminfo": {
