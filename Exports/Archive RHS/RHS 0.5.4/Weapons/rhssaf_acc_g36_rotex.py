rhssaf_acc_g36_rotex = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "model": "rhssaf|addons|rhssaf_m_weapon_g36|G36_rotex_muzzle.p3d",
    "displayname": "G36 Rotex adapter",
    # Class: CfgWeapons|rhssaf_acc_G36_Rotex|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 5,
        "soundtypeindex": 0,
        # Class: CfgWeapons|rhssaf_acc_G36_Rotex|ItemInfo|MagazineCoef [Indent level: 2],
        "magazinecoef": {
            "initspeed": 1
        },
        # Class: CfgWeapons|rhssaf_acc_G36_Rotex|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "typicalspeed": 1,
            "airfriction": 1,
        ...
        # Class: CfgWeapons|rhssaf_acc_G36_Rotex|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "dispersioncoef": "1f",
            "firelightcoef": "1f",
            "recoilcoef": "1f",
        ...
        "muzzleend": "mf",
        "alternativefire": "rhsusf_acc_muzzleFlash_ar15",
        "inertia": 0.2,
        "type": 101,
