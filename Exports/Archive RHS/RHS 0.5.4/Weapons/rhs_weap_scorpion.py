rhs_weap_scorpion = {
    ...
    "swaydecayspeed": 1.25,
    # Class: CfgWeapons|rhs_weap_scorpion|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_scorpion|GunParticles|FirstEffect [Indent level: 2]
        "firsteffect": {
            "effectname": "PistolCloud",
            "positionname": "Usti hlavne",
            "directionname": "Konec hlavne"
        },
        # Class: CfgWeapons|rhs_weap_scorpion|GunParticles|SecondEffect [Indent level: 2],
        "secondeffect": {
    ...
    # Class: CfgWeapons|rhs_weap_scorpion|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 28.16,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_scorpion|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        ...
        # Class: CfgWeapons|rhs_weap_scorpion|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0.5,0.35],
            "iconscale": 0.2,
            "compatibleitems": []
        },
        # Class: CfgWeapons|rhs_weap_scorpion|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        }
    },
    "opticszoommin": 0.375,
    ...
    "handanim": ["OFP2_ManSkeleton","|rhssaf|addons|rhssaf_c_weapons|anims|rhs_hand_scorpion.rtm"],
    "selectionfireanim": "zasleh",
    "modes": ["Single","FullAuto"],
    # Class: CfgWeapons|rhs_weap_scorpion|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.075,
        "dispersion": 0.0005,
        "minrange": 2,
        ...
        # Class: CfgWeapons|rhs_weap_scorpion|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHSSAF_scorp_Shot_SoundSet","RHSSAF_pistol1_Tail_SoundSet"]
        },
    ...
    # Class: CfgWeapons|rhs_weap_scorpion|FullAuto [Indent level: 1],
    "fullauto": {
        "reloadtime": 0.075,
        "dispersion": 0.0005,
        "minrange": 0,
        ...
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_scorpion|FullAuto|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHSSAF_scorp_Shot_SoundSet","RHSSAF_pistol1_Tail_SoundSet"]
        },
