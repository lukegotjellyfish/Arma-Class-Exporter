rhsgref_helmet_m1942_heerwintercover = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1942_heerwintercover_ca.paa",
    "displayname": "M42 Covered (Winter)",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|M1942_heercoverwinter",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1942cover_hbt_white_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_m1942_heerwintercover|ItemInfo [Indent level: 1],
    "iteminfo": {
