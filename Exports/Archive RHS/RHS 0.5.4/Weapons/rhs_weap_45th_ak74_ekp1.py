rhs_weap_45th_ak74_ekp1 = {
    # Class: CfgWeapons|rhs_weap_45th_ak74_ekp1|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_45th_ak74_ekp1|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_ekp1"
        },
        # Class: CfgWeapons|rhs_weap_45th_ak74_ekp1|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtk1"
        }
