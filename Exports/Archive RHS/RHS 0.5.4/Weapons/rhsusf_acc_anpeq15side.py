rhsusf_acc_anpeq15side = {
    ...
    # Class: CfgWeapons|rhsusf_acc_anpeq15side|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 8,
        # Class: CfgWeapons|rhsusf_acc_anpeq15side|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
            "irlaserpos": "laser pos",
            "irlaserend": "laser dir",
            "irdistance": 5
        },
        # Class: CfgWeapons|rhsusf_acc_anpeq15side|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
        },
        "type": 301,
