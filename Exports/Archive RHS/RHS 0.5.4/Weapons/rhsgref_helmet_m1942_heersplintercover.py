rhsgref_helmet_m1942_heersplintercover = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1942_heersplintercover_ca.paa",
    "displayname": "M42 Covered (Splitter 31)",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|M1942_heercoversummer",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1942cover_splinter_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_m1942_heersplintercover|ItemInfo [Indent level: 1],
    "iteminfo": {
