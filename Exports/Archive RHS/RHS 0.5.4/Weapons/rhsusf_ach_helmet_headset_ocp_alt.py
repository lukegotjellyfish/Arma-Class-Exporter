rhsusf_ach_helmet_headset_ocp_alt = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_helmet_headset_ocp_alt_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_ach_helmet_headset_ocp|ItemInfo [Indent level: 1],
    "iteminfo": {
