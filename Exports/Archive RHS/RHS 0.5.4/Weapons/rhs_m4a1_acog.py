rhs_m4a1_acog = {
    # Class: CfgWeapons|rhs_m4a1_acog|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4a1_acog|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG"
        },
        # Class: CfgWeapons|rhs_m4a1_acog|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
