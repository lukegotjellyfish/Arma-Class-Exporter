rhsusf_ach_bare_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_bare_headset_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_ach_bare_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
