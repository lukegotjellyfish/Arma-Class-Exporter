rhsusf_lwh_helmet_marpatd_ess = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_lwh_helmet_marpatd_ess_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_lwh_helmet_marpatd_ess|ItemInfo [Indent level: 1],
    "iteminfo": {
