rhsusf_acc_anpeq15_top_h = {
    ...
    # Class: CfgWeapons|acc_pointer_IR|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 6,
        # Class: CfgWeapons|acc_pointer_IR|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
            "irlaserpos": "laser pos",
            "irlaserend": "laser dir",
            "irdistance": 5
        },
        # Class: CfgWeapons|acc_pointer_IR|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
        },
        "type": 301,
