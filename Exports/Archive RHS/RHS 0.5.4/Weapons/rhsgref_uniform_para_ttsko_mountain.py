rhsgref_uniform_para_ttsko_mountain = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|uniform|rhsgref_uniform_para_ttsko_mountain_ca.paa",
    "scope": 2,
    "dlc": "RHS_GREF",
    "displayname": "M10 TTsKO (Mountain)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_blufor_diver",
    # Class: CfgWeapons|rhsgref_uniform_para_ttsko_mountain|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
