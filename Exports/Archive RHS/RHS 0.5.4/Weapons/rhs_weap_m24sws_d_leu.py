rhs_weap_m24sws_d_leu = {
    # Class: CfgWeapons|rhs_weap_m24sws_d_leu|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m24sws_d_leu|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_LEUPOLDMK4_d"
        },
        # Class: CfgWeapons|rhs_weap_m24sws_d_leu|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
            "item": "rhsusf_acc_harris_swivel",
            "slot": "UnderBarrelSlot"
        },
        # Class: CfgWeapons|rhs_weap_m24sws_d_leu|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons2|M24|Data|M24_metallic_d_co.paa","|rhsusf|addons|rhsusf_weapons2|M24|Data|M24_nonmetallic_d_co.paa"],
