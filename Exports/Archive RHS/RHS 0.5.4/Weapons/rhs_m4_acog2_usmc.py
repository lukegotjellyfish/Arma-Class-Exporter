rhs_m4_acog2_usmc = {
    # Class: CfgWeapons|rhs_m4_acog2_usmc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4_acog2_usmc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG2_USMC"
        },
        # Class: CfgWeapons|rhs_m4_acog2_usmc|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
