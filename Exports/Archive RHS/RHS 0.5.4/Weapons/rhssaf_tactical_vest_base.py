rhssaf_tactical_vest_base = {
    ...
    # Class: CfgWeapons|rhssaf_tactical_vest_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["camo"],
        "uniformmodel": "rhssaf|addons|rhssaf_m_vest_m99|rhssaf_md99",
        "containerclass": "Supply90",
        "mass": 40,
        # Class: CfgWeapons|rhssaf_tactical_vest_base|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_tactical_vest_base|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
                "hitpointname": "HitNeck",
                "armor": 0,
                "passthrough": 1
            },
            # Class: CfgWeapons|rhssaf_tactical_vest_base|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
                "hitpointname": "HitChest",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhssaf_tactical_vest_base|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhssaf_tactical_vest_base|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhssaf_tactical_vest_base|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
