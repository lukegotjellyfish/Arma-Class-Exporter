rhs_optic_maaws = {
    ...
    # Class: CfgWeapons|rhs_optic_maaws|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 8,
        "optictype": 0,
        "optics": 2,
        "modeloptics": "rhsusf|addons|rhsusf_weapons2|m3maaws|optic_m3maaws.p3d",
        # Class: CfgWeapons|rhs_optic_maaws|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_optic_maaws|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 100,
                "distancezoommax": 900,
                "opticsid": 1,
                "optictype": 1,
                "modeloptics": ["rhsusf|addons|rhsusf_weapons2|m3maaws|optic_m3maaws_2d"],
                "usemodeloptics": 1,
