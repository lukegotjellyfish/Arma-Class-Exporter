rhsgref_acc_l1a1_l2a2_3d = {
    ...
    # Class: CfgWeapons|rhsgref_acc_l2a2_3d|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsgref_acc_l2a2_3d|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsgref_acc_l2a2_3d|ItemInfo|OpticsModes|rhs_scope [Indent level: 3]
            "rhs_scope": {
                "usemodeloptics": 0,
            ...
            # Class: CfgWeapons|rhsgref_acc_l2a2_3d|ItemInfo|OpticsModes|rhs_iron [Indent level: 3],
            "rhs_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|accessories|rhsgref_acc_l1a1_l2a2_ca.paa",
