rhsusf_weap_m6_glua = {
    "modes": ["Double"],
    # Class: CfgWeapons|rhsusf_weap_M6_GLUA|Double [Indent level: 1],
    "double": {
        "reloadtime": 1,
        "burst": 1,
        "displayname": "M6 (4)",
        # Class: CfgWeapons|rhsusf_weap_M6_GLUA|Double|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["UGL_InteriorTail_SoundSet"]
        },
        "showtoplayer": 1,
        "multiplier": 1,
        "minrange": 0,
    ...
    # Class: CfgWeapons|rhsusf_weap_M6_GLUA|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M6_GLUA|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "_this spawn rhs_fnc_stryker_m1127_fireSmoke"
        }
    },
    "magazines": ["rhsusf_mag_L8A3_48"],
