rhsusf_acc_elcan_pip = {
    ...
    "displayname": "M145 MGO (PiP)",
    "descriptionshort": "M145 MGO (PiP)",
    "scopearsenal": 0,
    "scope": 1,
    "model": "rhsusf|addons|rhsusf_scopes|elcan|elcan_pip",
    "weaponinfotype": "rhs_elcan_pip_handler",
    # Class: CfgWeapons|rhsusf_acc_ELCAN_pip|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_ELCAN_pip|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_ELCAN_pip|ItemInfo|OpticsModes|elcan_scope [Indent level: 3]
            "elcan_scope": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.275,
            ...
            # Class: CfgWeapons|rhsusf_acc_ELCAN_pip|ItemInfo|OpticsModes|alternative_view [Indent level: 3],
            "alternative_view": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
