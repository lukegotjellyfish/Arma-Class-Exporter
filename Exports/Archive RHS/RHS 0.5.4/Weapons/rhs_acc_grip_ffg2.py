rhs_acc_grip_ffg2 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_grip_ffg2_ca.paa",
    "author": "Red Hammer Studios",
    "displayname": "FFG-2",
    "descriptionshort": "Folding vertical grip",
    "model": "rhsafrf|addons|rhs_weapons3|acc|grips|ffg2",
    "weaponinfotype": "RHS_Grip_FFG2",
    "inertia": -0.2,
    "rhs_grip_type": "rhs_grip3_change",
    # Class: CfgWeapons|rhs_acc_grip_rk6|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hasbipod": 0,
        "deployedpivot": "bipod",
        "mass": 10,
