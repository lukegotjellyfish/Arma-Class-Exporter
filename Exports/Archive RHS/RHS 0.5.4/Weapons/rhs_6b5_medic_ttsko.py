rhs_6b5_medic_ttsko = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhs_6b5_medic_ttsko_ca.paa",
    "displayname": "6B5-19 TTsKO (Medic)",
    ...
    # Class: CfgWeapons|rhs_6b5_medic|ItemInfo [Indent level: 1],
    "iteminfo": {
