rhssaf_vest_md99_woodland_rifleman_radio = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "displayname": "PBB M-99T (Woodland/Rifleman/Radio)",
    ...
    # Class: CfgWeapons|rhssaf_vest_md99_woodland_rifleman_radio|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["camo","pouches"],
        "uniformmodel": "rhssaf|addons|rhssaf_m_vest_m99|rhssaf_md99_rifleman_radio",
        "containerclass": "Supply90",
        "mass": 75,
        # Class: CfgWeapons|rhssaf_balistic_vest_base|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_balistic_vest_base|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
                "hitpointname": "HitNeck",
                "armor": 8,
                "passthrough": 0.5
            },
            # Class: CfgWeapons|rhssaf_balistic_vest_base|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
                "hitpointname": "HitChest",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhssaf_balistic_vest_base|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhssaf_balistic_vest_base|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhssaf_balistic_vest_base|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
