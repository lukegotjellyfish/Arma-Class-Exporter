rhsgref_6b23_ttsko_digi_medic = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_ttsko_digi_medic_ca.paa",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsgref_6b23_ttsko_digi_medic|ItemInfo [Indent level: 1],
    "iteminfo": {
