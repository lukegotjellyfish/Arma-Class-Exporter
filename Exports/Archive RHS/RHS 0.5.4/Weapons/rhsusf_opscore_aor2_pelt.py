rhsusf_opscore_aor2_pelt = {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_aor2_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|comtac_fg_co.paa"],
