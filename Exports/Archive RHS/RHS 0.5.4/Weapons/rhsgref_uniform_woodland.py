rhsgref_uniform_woodland = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|uniform|rhsgref_uniform_woodland_ca.paa",
    "scope": 2,
    "dlc": "RHS_GREF",
    "displayname": "M93 (Woodland)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_blufor_diver",
    # Class: CfgWeapons|rhsgref_uniform_woodland|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
