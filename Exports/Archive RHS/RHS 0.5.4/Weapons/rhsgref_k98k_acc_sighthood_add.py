rhsgref_k98k_acc_sighthood_add = {
    ...
    # Class: CfgWeapons|rhsgref_K98k_acc_sighthood_add|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 2,
        # Class: CfgWeapons|rhsgref_K98k_acc_sighthood_add|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
        },
        # Class: CfgWeapons|rhsgref_K98k_acc_sighthood_add|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
            "color": [0,0,0],
            "ambient": [0,0,0],
            "size": 0,
            ...
            "position": "flashdir",
            "direction": "flash",
            # Class: CfgWeapons|rhsgref_K98k_acc_sighthood_add|ItemInfo|FlashLight|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 0,
                "linear": 0,
