rhs_weap_m16a4_pmag_grip3 = {
    ...
    # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip3|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip3|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip3",
            "slot": "UnderBarrelSlot"
        }
    },
    # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 74.8,
