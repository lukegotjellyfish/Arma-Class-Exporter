rhsgref_6b27m_ttsko_forest = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_6b27m_ttsko_forest_ca.paa",
    "dlc": "RHS_GREF",
    "scope": 2,
    "displayname": "Kaska K93 TTsKO (Forest)",
    "allowedfacewear": ["G_Squares_Tinted","G_Aviator"],
    "hiddenselections": ["Camo1"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_cdf|6b27_cdf_ttskosummer_co.paa"],
    "hiddenselectionsmaterials": ["rhsgref|addons|rhsgref_infantry|data_cdf|6b27_cdf.rvmat"],
    "model": "rhsgref|addons|rhsgref_infantry|gear_cdf|head|gref_6b27m",
    # Class: CfgWeapons|rhsgref_6b27m|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo1"],
        "mass": 40,
        "uniformmodel": "rhsgref|addons|rhsgref_infantry|gear_cdf|head|gref_6b27m",
        "allowedslots": [801,901,701,605],
        "modelsides": [3,1],
        # Class: CfgWeapons|rhsgref_6b27m|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_6b27m|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
