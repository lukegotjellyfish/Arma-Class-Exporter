rhs_acc_mtz = {
    ...
    "model": "rhsafrf|addons|rhs_weapons|acc|scopes|npz|rhs_npz",
    "inertia": 0,
    # Class: CfgWeapons|rhs_acc_scope_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_scope_base|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_scope_base|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
            ...
            # Class: CfgWeapons|rhs_acc_scope_base|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsppeffects": [""],
