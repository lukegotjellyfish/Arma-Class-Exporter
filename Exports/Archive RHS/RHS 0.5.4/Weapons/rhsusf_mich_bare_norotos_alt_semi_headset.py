rhsusf_mich_bare_norotos_alt_semi_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_alt_semi_headset_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_alt_semi_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_rhino_painted_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_painted_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|bowman_base_co.paa"],
    "hiddenselections": ["Camo","Camo1","Camo2","bowman"],
    "scope": 2,
