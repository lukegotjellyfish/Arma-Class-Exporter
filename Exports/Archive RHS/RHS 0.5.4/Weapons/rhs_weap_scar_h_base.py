rhs_weap_scar_h_base = {
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_H_Base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_H_Base|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.1,
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_H_Base|FullAuto [Indent level: 1],
    "fullauto": {
        "reloadtime": 0.1,
        "sounds": ["Standardsound","SilencedSound"],
