rhs_weap_lmg_minimi_railed = {
    ...
    "initspeed": -1,
    "hasbipod": 0,
    # Class: CfgWeapons|rhs_weap_lmg_minimi_railed|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 156.2,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_lmg_minimi_railed|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        ...
        # Class: CfgWeapons|rhs_weap_lmg_minimi_railed|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "compatibleitems": []
        }
    },
