rhs_tr8_periscope = {
    ...
    "scope": 2,
    "model": "rhsafrf|addons|rhs_weapons2|misc|tr8|rhs_tr8_periscope.p3d",
    ...
    "opticszoommax": 0.35,
    # Class: CfgWeapons|rhs_tr8_periscope|OpticsModes [Indent level: 1],
    "opticsmodes": {
        # Class: CfgWeapons|rhs_tr8_periscope|OpticsModes|periscope [Indent level: 2]
        "periscope": {
            "opticsid": 1,
    ...
    # Class: CfgWeapons|rhs_tr8_periscope|Library [Indent level: 1],
    "library": {
        "libtextdesc": "Binoculars allow the soldier to survey the battlefield over long distances."
    },
    "descriptionshort": "Magnification: 4x-12x",
    # Class: CfgWeapons|rhs_tr8_periscope|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 19.36
    },
