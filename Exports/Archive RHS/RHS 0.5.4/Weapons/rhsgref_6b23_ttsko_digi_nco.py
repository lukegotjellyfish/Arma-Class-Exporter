rhsgref_6b23_ttsko_digi_nco = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_ttsko_digi_nco_ca.paa",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsgref_6b23_ttsko_digi_nco|ItemInfo [Indent level: 1],
    "iteminfo": {
