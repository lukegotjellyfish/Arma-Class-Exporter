rhsusf_weap_m6_r2 = {
    "magazines": ["rhsusf_mag_L8A3_R2_8"],
    # Class: CfgWeapons|rhsusf_weap_M6_R2|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M6_R2|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "(_this + [['smoke_R2_','_pos','_dir']]) call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
