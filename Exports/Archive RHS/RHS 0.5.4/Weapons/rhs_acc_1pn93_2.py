rhs_acc_1pn93_2 = {
    ...
    # Class: CfgWeapons|rhs_acc_1pn93_2|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 2,
        "mass": 13.64,
        ...
        # Class: CfgWeapons|rhs_acc_1pn93_2|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_1pn93_2|ItemInfo|OpticsModes|rhs_pgo7v_scope [Indent level: 3]
            "rhs_pgo7v_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
