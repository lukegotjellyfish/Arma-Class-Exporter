rhs_weap_m249_pip_elcan = {
    # Class: CfgWeapons|rhs_weap_m249_pip_elcan|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m249_pip_elcan|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ELCAN_ard"
        },
        # Class: CfgWeapons|rhs_weap_m249_pip_elcan|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
