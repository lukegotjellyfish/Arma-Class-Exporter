rhsgref_un_mi24v = {
    ...
    # Class: CfgVehicles|rhsgref_un_Mi24V|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_un_Mi24V|AnimationSources|exhaust_hide [Indent level: 2]
        "exhaust_hide": {
            "source": "user",
            "initphase": 1,
            "animperiod": 1e-005
    ...
    # Class: CfgVehicles|rhsgref_un_Mi24V|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhsgref_un_Mi24V|Exhausts|Exhaust01 [Indent level: 2]
        "exhaust01": {
            "direction": "exhaust1_dir",
            "position": "exhaust1",
            "effect": "ExhaustEffectHeli"
        },
        # Class: CfgVehicles|rhsgref_un_Mi24V|Exhausts|Exhaust02 [Indent level: 2],
        "exhaust02": {
    ...
    # Class: CfgVehicles|rhsgref_un_Mi24V|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_un_Mi24V|TransportMagazines|_xx_rhs_30Rnd_545x39_7N6M_AK [Indent level: 2]
        "_xx_rhs_30rnd_545x39_7n6m_ak": {
            "magazine": "rhs_30Rnd_545x39_7N6M_AK",
            "count": 30
        },
        # Class: CfgVehicles|rhsgref_un_Mi24V|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_un_Mi24V|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
        "_xx_rhs_mag_nspn_red": {
            "magazine": "rhs_mag_nspn_red",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_un_Mi24V|TransportMagazines|_xx_rhs_mag_rdg2_white [Indent level: 2],
