rhsusf_m978a4_bkit_usarmy_d = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_hemtt_a4|data|CAB_CO_Des.paa","rhsusf|addons|rhsusf_hemtt_a4|data|BKIT_Des_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|FUEL_des_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CHASSIS_des_CO.paa"],
    "displayname": "M978A4-B",
    "model": "rhsusf|addons|rhsusf_hemtt_a4|M978A4_WD_APK.p3d",
    "transportfuel": 300000,
    "supplyradius": 10,
    "fuelexplosionpower": 10,
    # Class: CfgVehicles|rhsusf_M978A4_BKIT_usarmy_wd|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhsusf_M978A4_BKIT_usarmy_wd|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
    ...
    "hiddenselections": ["Camo","Camo1","Camo3","Camo5"],
    # Class: CfgVehicles|rhsusf_M978A4_BKIT_usarmy_wd|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhsusf_M978A4_BKIT_usarmy_wd|textureSources|rhs_woodland [Indent level: 2]
        "rhs_woodland": {
            "textures": ["rhsusf|addons|rhsusf_hemtt_a4|data|CAB_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|BKIT_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|FUEL_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CHASSIS_CO.paa"],
            "displayname": "Woodland",
            "author": "Red Hammer Studios",
            "factions": []
        },
        # Class: CfgVehicles|rhsusf_M978A4_BKIT_usarmy_wd|textureSources|rhs_desert [Indent level: 2],
        "rhs_desert": {
            "textures": ["rhsusf|addons|rhsusf_hemtt_a4|data|CAB_CO_Des.paa","rhsusf|addons|rhsusf_hemtt_a4|data|BKIT_DES_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|FUEL_DES_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CHASSIS_DES_CO.paa"],
            "displayname": "Desert",
            "author": "Red Hammer Studios",
            "factions": []
        }
