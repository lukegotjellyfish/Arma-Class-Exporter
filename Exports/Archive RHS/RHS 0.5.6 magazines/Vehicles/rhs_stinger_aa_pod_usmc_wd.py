rhs_stinger_aa_pod_usmc_wd = {
    ...
    "memorypointmissile": ["Rocket_2","Rocket_1"],
    "memorypointmissiledir": ["Rocket_2_End","Rocket_1_End"],
    # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhsusf|addons|rhsusf_heavyweapons|stinger|data|stinger_tripod.rvmat","rhsusf|addons|rhsusf_heavyweapons|stinger|data|stinger_tripod.rvmat","rhsusf|addons|rhsusf_heavyweapons|data|static_destroyed.rvmat","rhsusf|addons|rhsusf_weapons|fim92|data|stinger.rvmat","rhsusf|addons|rhsusf_weapons|fim92|data|stinger.rvmat","rhsusf|addons|rhsusf_heavyweapons|data|static_destroyed.rvmat"]
    },
    # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            ...
            "magazines": ["Rhs_mag_2Rnd_stinger","Rhs_mag_2Rnd_stinger","Rhs_mag_2Rnd_stinger","Rhs_mag_2Rnd_stinger","Rhs_mag_2Rnd_stinger"],
            "minturn": -180,
            "maxturn": 180,
            "minelev": -10,
            "maxelev": 120,
            ...
            # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 0,
                "initangley": 0,
                "initfov": 0.155,
    ...
    # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|AnimationSources|MagazineReload [Indent level: 2]
        "magazinereload": {
            "source": "reloadmagazine",
            "weapon": "Rhs_weap_stinger_Launcher_static"
        },
        # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|AnimationSources|Revolving [Indent level: 2],
        "revolving": {
            "source": "revolving",
            "weapon": "Rhs_weap_stinger_Launcher_static"
        }
    },
    # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|RenderTargets [Indent level: 1],
    "rendertargets": {
        # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|RenderTargets|Scope [Indent level: 2]
        "scope": {
            "rendertarget": "rendertarget0",
            # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|RenderTargets|Scope|CameraView1 [Indent level: 3],
            "cameraview1": {
    ...
    # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|RHS_Stinger_AA_pod_Base|EventHandlers|RHSUSF_EventHandlers [Indent level: 2]
