rhsgref_nat_uaz_ags = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_nat_uaz_ags.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsgref_nat_uaz_ags|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_nat_uaz_ags|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
