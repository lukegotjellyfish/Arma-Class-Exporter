rhs_uaz_open_vdv = {
    ...
    "rhs_decalparameters": ["['Number', cDecals4CarsNumberPlaces, 'LicensePlate']","['Label', cDecalsCarsRightArmyPlaces, 'Army', 2]","['Label', cDecalsCarsRightPlatoonPlaces, 'Platoon',11]"],
