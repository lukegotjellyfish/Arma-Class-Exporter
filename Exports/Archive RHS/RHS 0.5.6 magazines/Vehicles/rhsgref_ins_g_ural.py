rhsgref_ins_g_ural = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_ural.paa",
    "displayname": "Ural-4320",
    "dlc": "RHS_GREF",
    # Class: CfgVehicles|rhsgref_ins_ural|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_ural|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_plachta_chdkz_co.paa","rhsafrf|addons|RHS_Decals|Data|Labels|Misc|no_ca.paa"],
    "accuracy": 0.5,
    "rhs_decalparameters": [],
