rhsgref_hidf_backpack_gr = {
    "scope": 1,
    # Class: CfgVehicles|rhsgref_hidf_backpack_gr|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsgref_hidf_backpack_gr|TransportItems|_xx_rhs_mag_M441_HE [Indent level: 2]
        "_xx_rhs_mag_m441_he": {
            "name": "rhs_mag_M441_HE",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_hidf_backpack_gr|TransportItems|_xx_rhs_mag_M583A1_white [Indent level: 2],
