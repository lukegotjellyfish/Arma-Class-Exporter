rhs_ural_flat_vmf_01 = {
    ...
    # Class: CfgVehicles|RHS_Ural_Flat_MSV_01|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Ural_Flat_MSV_01|AnimationSources|bench_hide [Indent level: 2]
        "bench_hide": {
            "initphase": 1,
    ...
    # Class: CfgVehicles|RHS_Ural_Flat_MSV_01|Turrets [Indent level: 1],
    "turrets": {
    },
    "accuracy": 0.5,
    "side": 0,
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_khk_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_plachta_co.paa","rhsafrf|addons|RHS_Decals|Data|Labels|Misc|no_ca.paa"],
