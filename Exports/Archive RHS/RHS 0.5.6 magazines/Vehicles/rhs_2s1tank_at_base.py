rhs_2s1tank_at_base = {
    ...
    # Class: CfgVehicles|rhs_2s1tank_at_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_2s1tank_at_base|AnimationSources|reload_source [Indent level: 2]
        "reload_source": {
            "source": "reload",
            "weapon": "rhs_weap_2a31_at"
        },
        # Class: CfgVehicles|rhs_2s1tank_at_base|AnimationSources|reload_magazine_source [Indent level: 2],
        "reload_magazine_source": {
            "source": "reloadMagazine",
            "weapon": "rhs_weap_2a31_at"
        },
        # Class: CfgVehicles|rhs_2s1tank_at_base|AnimationSources|muzzle_hide_arty [Indent level: 2],
        "muzzle_hide_arty": {
            "source": "reload",
            "weapon": "rhs_weap_2a31_at"
        },
    ...
    # Class: CfgVehicles|rhs_2s1tank_at_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_2s1tank_at_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "elevationmode": 0,
            # Class: CfgVehicles|rhs_2s1tank_at_base|Turrets|MainTurret|Turrets [Indent level: 3],
            "turrets": {
                # Class: CfgVehicles|rhs_2s1tank_at_base|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                    "body": "obsTurret",
                    "gun": "obsGun",
                ...
                # Class: CfgVehicles|rhs_2s1tank_at_base|Turrets|MainTurret|Turrets|LoaderOptics [Indent level: 4],
                "loaderoptics": {
                    "body": "LdrTurret",
                    "gun": "LdrGun",
            ...
            "maxelev": 70,
            "weapons": ["rhs_weap_2a31_at","rhs_weap_fcs_noLRF"],
            "magazines": ["rhs_mag_3of56_direct_30","rhs_mag_bk13_10","rhs_laserfcsmag","rhs_laserfcsmag"],
