rhsgref_hidf_m998_4dr_halftop = {
    ...
    # Class: CfgVehicles|rhsgref_hidf_M998_4dr_halftop|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|rhsgref_hidf_M998_4dr_halftop|RHS_TowingSystem|Carrier [Indent level: 2]
        "carrier": {
