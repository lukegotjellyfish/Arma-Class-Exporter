rhsgref_cdf_b_zsu234 = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_zsu234.paa",
    "dlc": "RHS_GREF",
    "hiddenselectionstextures": ["|rhsgref|addons|rhsgref_vehicles_ret|data|cdf|zsu_01_cdf_co.paa","|rhsgref|addons|rhsgref_vehicles_ret|data|cdf|zsu_02_cdf_co.paa","|rhsgref|addons|rhsgref_vehicles_ret|data|cdf|zsu_03_cdf_co.paa"],
    "rhs_decalparameters": ["['Number',cRHSZSUNumberPlaces,'CDF']"],
    # Class: CfgVehicles|rhsgref_cdf_zsu234|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_cdf_zsu234|TransportMagazines|_xx_rhs_30Rnd_545x39_7N6M_AK [Indent level: 2]
        "_xx_rhs_30rnd_545x39_7n6m_ak": {
            "magazine": "rhs_30Rnd_545x39_7N6M_AK",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_zsu234|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_zsu234|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
        "_xx_rhs_mag_nspn_red": {
            "magazine": "rhs_mag_nspn_red",
            "count": 10
        }
    },
    # Class: CfgVehicles|rhsgref_cdf_zsu234|TransportWeapons [Indent level: 1],
    "transportweapons": {
        # Class: CfgVehicles|rhsgref_cdf_zsu234|TransportWeapons|_xx_rhs_weap_ak74 [Indent level: 2]
        "_xx_rhs_weap_ak74": {
