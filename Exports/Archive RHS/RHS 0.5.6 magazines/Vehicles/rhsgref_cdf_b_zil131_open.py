rhsgref_cdf_b_zil131_open = {
    ...
    "hiddenselectionstextures": ["|rhsgref|addons|rhsgref_vehicles_ret|data|cdf|rhs_zil131_cargo_CDF_co.paa","|rhsgref|addons|rhsgref_vehicles_ret|data|cdf|rhs_zil131_cabin_CDF_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_base_co.paa"],
    "texturelist": ["CDF",1],
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_zil131_open.paa",
    "dlc": "RHS_GREF",
