rhsusf_falconii_gr = {
    "scope": 1,
    # Class: CfgVehicles|rhsusf_falconii_gr|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_falconii_gr|TransportItems|_xx_rhs_mag_M433_HEDP [Indent level: 2]
        "_xx_rhs_mag_m433_hedp": {
            "name": "rhs_mag_M433_HEDP",
            "count": 10
        },
        # Class: CfgVehicles|rhsusf_falconii_gr|TransportItems|_xx_rhs_mag_M583A1_white [Indent level: 2],
