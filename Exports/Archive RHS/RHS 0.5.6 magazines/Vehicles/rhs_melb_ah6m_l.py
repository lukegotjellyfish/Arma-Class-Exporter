rhs_melb_ah6m_l = {
    ...
    # Class: CfgVehicles|RHS_MELB_AH6M_L|components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_MELB_AH6M_L|components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|RHS_MELB_AH6M_L|components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|RHS_MELB_AH6M_L|components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|RHS_MELB_AH6M_L|components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                ...
                # Class: CfgVehicles|RHS_MELB_AH6M_L|components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                    "attachment": "rhs_mag_m134_pylon_3000",
                ...
                # Class: CfgVehicles|RHS_MELB_AH6M_L|components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
                    "attachment": "rhs_mag_M151_7",
