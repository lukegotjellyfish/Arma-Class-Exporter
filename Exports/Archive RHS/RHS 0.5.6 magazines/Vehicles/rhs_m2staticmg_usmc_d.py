rhs_m2staticmg_usmc_d = {
    ...
    # Class: CfgVehicles|rhs_m2staticmg_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_m2staticmg_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "optics": 1,
    ...
    "armorstructural": 10,
    # Class: CfgVehicles|rhs_m2staticmg_base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["RHS_M2_Gun_Bag","RHS_M2_Tripod_Bag"],
        "displayname": ""
    },
