rhsgref_ins_g_ural_open = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_ural_open.paa",
    "displayname": "Ural-4320 (Open)",
    "dlc": "RHS_GREF",
    # Class: CfgVehicles|rhsgref_ins_ural_open|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_ural_open|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
