rhs_ural_ammo_msv_01 = {
    ...
    # Class: CfgVehicles|RHS_Ural_Ammo_Base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Ural_Ammo_Base|AnimationSources|ammo_cargo_hide [Indent level: 2]
        "ammo_cargo_hide": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|RHS_Ural_Ammo_Base|AnimationSources|bench_hide [Indent level: 2],
        "bench_hide": {
            "initphase": 1,
    ...
    # Class: CfgVehicles|RHS_Ural_Ammo_Base|Turrets [Indent level: 1],
    "turrets": {
    },
