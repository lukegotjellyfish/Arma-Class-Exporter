rhsusf_ch53e_usmc_d_cargo = {
    ...
    # Class: CfgVehicles|rhsusf_CH53e_USMC_D_cargo|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsusf_CH53e_USMC_D_cargo|AnimationSources|hide_cargo [Indent level: 2]
        "hide_cargo": {
            "displayname": "",
            "initphase": 1,
            "source": "user",
    ...
    # Class: CfgVehicles|rhsusf_CH53e_USMC_D_cargo|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsusf_CH53e_USMC_D_cargo|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
    ...
    "transportsoldier": 0,
    # Class: CfgVehicles|rhsusf_CH53e_USMC_D_cargo|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhsusf_CH53e_USMC_D_cargo|VehicleTransport|Carrier [Indent level: 2]
        "carrier": {
