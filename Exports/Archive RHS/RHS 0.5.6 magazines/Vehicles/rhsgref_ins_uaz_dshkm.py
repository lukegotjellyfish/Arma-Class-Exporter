rhsgref_ins_uaz_dshkm = {
    ...
    # Class: CfgVehicles|rhsgref_ins_uaz_dshkm|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_uaz_dshkm|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
        ...
        # Class: CfgVehicles|rhsgref_ins_uaz_dshkm|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
