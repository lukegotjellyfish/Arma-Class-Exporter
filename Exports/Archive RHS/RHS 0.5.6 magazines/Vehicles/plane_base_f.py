plane_base_f = {
    ...
    "ejectspeed": [0,60,0],
    # Class: CfgVehicles|Plane_Base_F|Turrets [Indent level: 1],
    "turrets": {
    ...
    # Class: CfgVehicles|Plane_Base_F|HitPoints [Indent level: 1],
    "hitpoints": {
    ...
    # Class: CfgVehicles|Plane|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "",
    ...
    "flarevelocity": 100,
    "enableradio": 1,
    # Class: CfgVehicles|Air|AnimationSources [Indent level: 1],
    "animationsources": {
