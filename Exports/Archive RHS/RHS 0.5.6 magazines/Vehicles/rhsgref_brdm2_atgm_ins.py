rhsgref_brdm2_atgm_ins = {
    ...
    # Class: CfgVehicles|rhsgref_BRDM2_ATGM_ins|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_BRDM2_ATGM_ins|AnimationSources|small_numbers_hide [Indent level: 2]
        "small_numbers_hide": {
            "initphase": 1,
            "source": "user",
            "animperiod": 0
    ...
    "hiddenselectionstextures": ["|rhsgref|addons|rhsgref_a2port_armor|brdm2|data|brdm2_atgm_01_co.paa","|rhsgref|addons|rhsgref_a2port_armor|brdm2|data|brdm2_02_camo_co.paa","|rhsgref|addons|rhsgref_a2port_armor|brdm2|data|zbik_04_co.paa"],
    "rhs_decalparameters": [],
