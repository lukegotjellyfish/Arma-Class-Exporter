rhsgref_ins_pack_saboteur = {
    ...
    # Class: CfgVehicles|rhsgref_ins_pack_saboteur|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsgref_ins_pack_saboteur|TransportItems|_xx_rhs_mine_tm62m_mag [Indent level: 2]
        "_xx_rhs_mine_tm62m_mag": {
            "name": "rhs_mine_tm62m_mag",
            "count": 1
        },
        # Class: CfgVehicles|rhsgref_ins_pack_saboteur|TransportItems|_xx_IEDUrbanSmall_Remote_Mag [Indent level: 2],
