rhs_vs1_seat = {
    ...
    # Class: CfgVehicles|rhs_vs1_seat|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_vs1_seat|AnimationSources|hide_booster [Indent level: 2]
        "hide_booster": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_vs1_seat|AnimationSources|handle_move [Indent level: 2],
        "handle_move": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
    ...
    # Class: CfgVehicles|rhs_vs1_seat|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|rhs_vs1_seat|UserActions [Indent level: 1],
    "useractions": {
    },
    "driveoncomponent": [],
    # Class: CfgVehicles|rhs_vs1_seat|Eventhandlers [Indent level: 1],
    "eventhandlers": {
    },
    "slx_xeh_disabled": 1,
    "mapsize": 16,
