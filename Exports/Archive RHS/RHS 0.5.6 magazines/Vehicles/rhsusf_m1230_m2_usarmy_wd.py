rhsusf_m1230_m2_usarmy_wd = {
    ...
    # Class: CfgVehicles|rhsusf_M1230_M2_usarmy_wd|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsusf_M1230_M2_usarmy_wd|AnimationSources|lwpk_hide [Indent level: 2]
        "lwpk_hide": {
            "initphase": 1,
            "source": "user",
            "animperiod": 1e-005,
