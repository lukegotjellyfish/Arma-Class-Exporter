rhsgref_cdf_backpack_medic = {
    ...
    # Class: CfgVehicles|rhsgref_cdf_backpack_medic|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsgref_cdf_backpack_medic|TransportItems|_xx_Medikit [Indent level: 2]
        "_xx_medikit": {
            "name": "MediKit",
            "count": 1
        },
        # Class: CfgVehicles|rhsgref_cdf_backpack_medic|TransportItems|_xx_FirstAidKit [Indent level: 2],
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 6
        }
