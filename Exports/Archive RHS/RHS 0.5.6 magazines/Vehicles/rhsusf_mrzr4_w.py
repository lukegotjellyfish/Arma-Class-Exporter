rhsusf_mrzr4_w = {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_mrzr|data|blue_tan_pnt1_co.paa","|rhsusf|addons|rhsusf_mrzr|data|yel_tan_pnt1_co.paa","|rhsusf|addons|rhsusf_mrzr|data|red_tan_pnt1_co.paa","|rhsusf|addons|rhsusf_mrzr|data|grn_tan_pnt1_co.paa","|rhsusf|addons|rhsusf_mrzr|data|merged|orng_grn_co.paa"],
    ...
    "weapons": ["MRZRHorn"],
    "rhs_decalparameters": ["['Label', [5,6,7,8,9], 'ODA_MRZR_D']","['Label', [10,11], 'MRZR_Bumperstickers']"],
    # Class: CfgVehicles|rhsusf_mrzr_base|TransportBackpacks [Indent level: 1],
    "transportbackpacks": {
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportBackpacks|_xx_rhsusf_falconii [Indent level: 2]
        "_xx_rhsusf_falconii": {
            "backpack": "rhsusf_falconii",
            "count": 4
        }
    },
    # Class: CfgVehicles|rhsusf_mrzr_base|RenderTargets [Indent level: 1],
    "rendertargets": {
    },
    # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_30Rnd_556x45_M855A1_Stanag [Indent level: 2]
        "_xx_rhs_mag_30rnd_556x45_m855a1_stanag": {
            "count": 30,
            "magazine": "rhs_mag_30Rnd_556x45_M855A1_Stanag"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_M433_HEDP [Indent level: 2],
        "_xx_rhs_mag_m433_hedp": {
            "count": 20,
            "magazine": "rhs_mag_M433_HEDP"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhsusf_100Rnd_556x45_soft_pouch [Indent level: 2],
        "_xx_rhsusf_100rnd_556x45_soft_pouch": {
            "count": 11,
            "magazine": "rhsusf_100Rnd_556x45_soft_pouch"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_M441_HE [Indent level: 2],
        "_xx_rhs_mag_m441_he": {
            "count": 10,
            "magazine": "rhs_mag_M441_HE"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_M714_white [Indent level: 2],
        "_xx_rhs_mag_m714_white": {
            "count": 4,
            "magazine": "rhs_mag_M714_white"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_M662_red [Indent level: 2],
        "_xx_rhs_mag_m662_red": {
            "count": 2,
            "magazine": "rhs_mag_M662_red"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_m67 [Indent level: 2],
        "_xx_rhs_mag_m67": {
            "count": 4,
            "magazine": "rhs_mag_m67"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_m18_green [Indent level: 2],
        "_xx_rhs_mag_m18_green": {
            "count": 2,
            "magazine": "rhs_mag_m18_green"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_m18_red [Indent level: 2],
        "_xx_rhs_mag_m18_red": {
            "count": 2,
            "magazine": "rhs_mag_m18_red"
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportMagazines|_xx_rhs_mag_an_m8hc [Indent level: 2],
        "_xx_rhs_mag_an_m8hc": {
            "count": 4,
            "magazine": "rhs_mag_an_m8hc"
        }
    },
    # Class: CfgVehicles|rhsusf_mrzr_base|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportItems|_xx_FirstAidKit [Indent level: 2]
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 8
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportItems|_xx_Medikit [Indent level: 2],
        "_xx_medikit": {
            "name": "Medikit",
            "count": 1
        }
    },
    # Class: CfgVehicles|rhsusf_mrzr_base|TransportWeapons [Indent level: 1],
    "transportweapons": {
        # Class: CfgVehicles|rhsusf_mrzr_base|TransportWeapons|_xx_weap [Indent level: 2]
        "_xx_weap": {
            "count": 2,
            "weapon": "rhs_weap_m4_carryhandle"
        }
    },
    # Class: CfgVehicles|rhsusf_mrzr_base|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhsusf_mrzr_base|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|VehicleTransport|Carrier [Indent level: 2],
        "carrier": {
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhsusf_mrzr_base|EventHandlers|RHSUSF_EventHandlers [Indent level: 2]
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_01 [Indent level: 2]
        "cargoturret_01": {
            ...
            "proxyindex": 2,
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_01|TurnOut [Indent level: 3],
            "turnout": {
            ...
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_01|TurnIn [Indent level: 3],
            "turnin": {
                "limitsarraytop": [[28.7267,-86.447],[26.7899,-30.4307],[10.0909,-16.9596],[5.3567,-1.3237],[3.7548,54.7238]],
                "limitsarraybottom": [[-8.7914,-95.7334],[-26.2615,-38.6995],[-24.1625,-23.4721],[-12.2238,-3.9537],[-10.9171,46.5569],[-8.2158,49.7788]]
            },
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
            "canhidegunner": 0,
            ...
            "proxyindex": 3,
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_02|TurnOut [Indent level: 3],
            "turnout": {
                "limitsarraytop": [[35.4526,63.7415],[32.4939,116.493]],
                "limitsarraybottom": [[-18.7593,73.6969],[-23.6628,109.831]]
            },
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_02|TurnIn [Indent level: 3],
            "turnin": {
                "limitsarraytop": [[35.4526,63.7415],[32.4939,116.493]],
                "limitsarraybottom": [[-18.7593,73.6969],[-23.6628,109.831]]
            },
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_03 [Indent level: 2],
        "cargoturret_03": {
            ...
            "proxyindex": 4,
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_03|TurnOut [Indent level: 3],
            "turnout": {
                "limitsarraytop": [[32.7761,-88.5404],[34.2324,-49.191]],
                "limitsarraybottom": [[-29.9524,-99.7416],[-16.9604,-47.9381]]
            },
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_03|TurnIn [Indent level: 3],
            "turnin": {
                "limitsarraytop": [[32.7761,-88.5404],[34.2324,-49.191]],
                "limitsarraybottom": [[-29.9524,-99.7416],[-16.9604,-47.9381]]
            },
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_04 [Indent level: 2],
        "cargoturret_04": {
            ...
            "allowlauncherin": 0,
            "allowlauncherout": 0,
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_04|TurnIn [Indent level: 3],
            "turnin": {
            ...
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_04|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_05 [Indent level: 2],
        "cargoturret_05": {
            "gunnername": "Passenger (Left Seat 2)",
            "gunneraction": "passenger_flatground_4",
            "gunnerinaction": "passenger_flatground_4",
            "proxyindex": 6,
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_05|TurnIn [Indent level: 3],
            "turnin": {
            ...
            # Class: CfgVehicles|rhsusf_mrzr_base|Turrets|CargoTurret_05|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|HitPoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhsusf_mrzr_base|HitPoints|HitLFWheel [Indent level: 2]
        "hitlfwheel": {
            "armor": 9.825,
            "name": "wheel_1_1_disc",
            "visual": "wheel_1_1",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|HitPoints|HitLF2Wheel [Indent level: 2],
        "hitlf2wheel": {
            "armor": 9.825,
            "name": "wheel_1_2_arm",
            "visual": "wheel_1_2",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|HitPoints|HitRFWheel [Indent level: 2],
        "hitrfwheel": {
            "armor": 9.825,
            "name": "wheel_2_1_disc",
            "visual": "wheel_2_1",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|HitPoints|HitRF2Wheel [Indent level: 2],
        "hitrf2wheel": {
            "armor": 9.825,
            "name": "wheel_2_2_arm",
            "visual": "wheel_2_2",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|HitPoints|HitFuel [Indent level: 2],
        "hitfuel": {
            "armor": 0.5,
            "material": -1,
            "name": "fueltank",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|HitPoints|HitEngine [Indent level: 2],
        "hitengine": {
            "armor": 0.5,
            "material": -1,
            "name": "engine",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|HitPoints|HitBody [Indent level: 2],
        "hitbody": {
            "name": "body",
            "visual": "camo1",
            "passthrough": 1,
    ...
    "soundgetin": ["",0.446684,1],
    "soundgetout": ["",0.446684,1,40],
    "sounddammage": ["",0.562341,1],
    "soundengineonint": ["A3|Sounds_F|vehicles2|soft|Quadbike_01|Quadbike_01_Engine_Ext_Start",0.501187,1],
    "soundengineoffint": ["A3|Sounds_F|vehicles2|soft|Quadbike_01|Quadbike_01_Engine_Ext_stop",0.398107,1],
    "soundengineonext": ["A3|Sounds_F|vehicles2|soft|Quadbike_01|Quadbike_01_Engine_Ext_Start",0.501187,1,50],
    "soundengineoffext": ["A3|Sounds_F|vehicles2|soft|Quadbike_01|Quadbike_01_Engine_Ext_stop",0.398107,1,50],
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|Sounds [Indent level: 1],
    "sounds": {
        "soundsetsint": ["Quadbike_01_Engine_RPM0_INT_SoundSet","Quadbike_01_Engine_RPM1_INT_SoundSet","Quadbike_01_Engine_RPM2_INT_SoundSet","Quadbike_01_Engine_RPM3_INT_SoundSet","Quadbike_01_Engine_RPM4_INT_SoundSet","Quadbike_01_Engine_RPM5_INT_SoundSet","Quadbike_01_Engine_RPM6_INT_SoundSet","Quadbike_01_Rattling_INT_SoundSet","Quadbike_01_Stress_INT_SoundSet","Quadbike_01_Rain_INT_SoundSet","Quadbike_01_Tires_Rock_Fast_OPEN_SoundSet","Quadbike_01_Tires_Grass_Fast_OPEN_SoundSet","Quadbike_01_Tires_Sand_Fast_OPEN_SoundSet","Quadbike_01_Tires_Gravel_Fast_OPEN_SoundSet","Quadbike_01_Tires_Mud_Fast_OPEN_SoundSet","Quadbike_01_Tires_Asphalt_Fast_OPEN_SoundSet","Quadbike_01_Tires_Water_Fast_OPEN_SoundSet","Quadbike_01_Tires_Rock_Slow_OPEN_SoundSet","Quadbike_01_Tires_Grass_Slow_OPEN_SoundSet","Quadbike_01_Tires_Sand_Slow_OPEN_SoundSet","Quadbike_01_Tires_Gravel_Slow_OPEN_SoundSet","Quadbike_01_Tires_Mud_Slow_OPEN_SoundSet","Quadbike_01_Tires_Asphalt_Slow_OPEN_SoundSet","Quadbike_01_Tires_Water_Slow_OPEN_SoundSet","Quadbike_01_Tires_Turn_Hard_OPEN_SoundSet","Quadbike_01_Tires_Turn_Soft_OPEN_SoundSet","Quadbike_01_Tires_Brake_Hard_OPEN_SoundSet","Quadbike_01_Tires_Brake_Soft_OPEN_SoundSet","","Tires_Movement_Dirt_Int_01_SoundSet"],
        "soundsetsext": ["Quadbike_01_Engine_RPM0_EXT_SoundSet","Quadbike_01_Engine_RPM1_EXT_SoundSet","Quadbike_01_Engine_RPM2_EXT_SoundSet","Quadbike_01_Engine_RPM3_EXT_SoundSet","Quadbike_01_Engine_RPM4_EXT_SoundSet","Quadbike_01_Engine_RPM5_EXT_SoundSet","Quadbike_01_Engine_RPM6_EXT_SoundSet","Quadbike_01_Rattling_EXT_SoundSet","Quadbike_01_Stress_EXT_SoundSet","Quadbike_01_Rain_EXT_SoundSet","Quadbike_01_Tires_Rock_Fast_EXT_SoundSet","Quadbike_01_Tires_Grass_Fast_EXT_SoundSet","Quadbike_01_Tires_Sand_Fast_EXT_SoundSet","Quadbike_01_Tires_Gravel_Fast_EXT_SoundSet","Quadbike_01_Tires_Mud_Fast_EXT_SoundSet","Quadbike_01_Tires_Asphalt_Fast_EXT_SoundSet","Quadbike_01_Tires_Water_Fast_EXT_SoundSet","Quadbike_01_Tires_Rock_Slow_EXT_SoundSet","Quadbike_01_Tires_Grass_Slow_EXT_SoundSet","Quadbike_01_Tires_Sand_Slow_EXT_SoundSet","Quadbike_01_Tires_Gravel_Slow_EXT_SoundSet","Quadbike_01_Tires_Mud_Slow_EXT_SoundSet","Quadbike_01_Tires_Asphalt_Slow_EXT_SoundSet","Quadbike_01_Tires_Water_Slow_EXT_SoundSet","Quadbike_01_Tires_Turn_Hard_EXT_SoundSet","Quadbike_01_Tires_Turn_Soft_EXT_SoundSet","Quadbike_01_Tires_Brake_Hard_EXT_SoundSet","Quadbike_01_Tires_Brake_Soft_EXT_SoundSet","","Tires_Movement_Dirt_Ext_01_SoundSet"]
    },
    ...
    "changegearomegaratios": [0.36875,0.125,0.0875,0.0625,0.94375,0.2,0.85625,0.425,1,0.5],
    # Class: CfgVehicles|rhsusf_mrzr_base|complexGearbox [Indent level: 1],
    "complexgearbox": {
        "gearboxratios": ["R1",-2.47,"N",0,"D1",3.95,"D2",2.21,"D3",1.435],
    ...
    "torquecurve": [[0.125,0.421053],[0.25,0.578947],[0.375,0.631579],[0.5,0.684211],[0.625,0.789474],[0.75,0.842105],[0.875,1],[1.12513,0]],
    "enginemoi": 0.1,
    "enginepower": 66,
    "peaktorque": 118.75,
    "minomega": 40,
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|Wheels [Indent level: 1],
    "wheels": {
        # Class: CfgVehicles|rhsusf_mrzr_base|Wheels|LF [Indent level: 2]
        "lf": {
            "side": "left",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Wheels|LR [Indent level: 2],
        "lr": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Wheels|RF [Indent level: 2],
        "rf": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Wheels|RR [Indent level: 2],
        "rr": {
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhsusf_mrzr_base|Exhausts|Exhaust [Indent level: 2]
        "exhaust": {
            "position": "exhaust",
    ...
    "memorypointsgetincargo": ["pos codriver","pos cargo 1","pos cargo 2","pos cargo 3","pos cargo 3","pos cargo 3","pos cargo 3"],
    "memorypointsgetincargodir": ["pos codriver dir","pos cargo dir 1","pos cargo dir 2","pos cargo dir 3","pos cargo dir 3","pos cargo dir 3","pos cargo dir 3"],
    "model": "rhsusf|addons|rhsusf_mrzr|rhs_mrzr4",
    "mapsize": 8.02,
    "side": 1,
    # Class: CfgVehicles|rhsusf_mrzr_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_rubber.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_rubber_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_metal.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_metal_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_mud.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_mud_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_rubber.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_rubber_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_metal.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_metal_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_mud.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_mud_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_rubber.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_rubber_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_metal.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_metal_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_mud.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_mud_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_rubber.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_rubber_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal_mud.rvmat","rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal_mud_dam.rvmat","rhsusf|addons|rhsusf_mrzr|data|mrzr_destr.rvmat","a3|data_f|default.rvmat","a3|data_f|default.rvmat","a3|data_f|default_destruct.rvmat"]
    },
    # Class: CfgVehicles|rhsusf_mrzr_base|Reflectors [Indent level: 1],
    "reflectors": {
        # Class: CfgVehicles|rhsusf_mrzr_base|Reflectors|LSvetla [Indent level: 2]
        "lsvetla": {
            "color": [800,900,650],
            "ambient": [2,2,2],
            "position": "L svetlo",
            ...
            "daylight": 0,
            "flaresize": 0.85,
            # Class: CfgVehicles|rhsusf_mrzr_base|Reflectors|LSvetla|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 0,
                "linear": 0,
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Reflectors|RSvetla [Indent level: 2],
        "rsvetla": {
            "position": "P svetlo",
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|rhsusf_mrzr_base|UserActions|light_bo_off [Indent level: 2]
        "light_bo_off": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|UserActions|light_bo_on [Indent level: 2],
        "light_bo_on": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|UserActions|light_stop_off [Indent level: 2],
        "light_stop_off": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|UserActions|light_stop_on [Indent level: 2],
        "light_stop_on": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|UserActions|cage_fold_on [Indent level: 2],
        "cage_fold_on": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|UserActions|cage_fold_off [Indent level: 2],
        "cage_fold_off": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|UserActions|PressXToFlipTheThing [Indent level: 2],
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsusf_mrzr_base|AnimationSources|light_bo [Indent level: 2]
        "light_bo": {
            "source": "user",
            "animperiod": 1e-005,
            "initphase": 1
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|AnimationSources|light_stop [Indent level: 2],
        "light_stop": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1e-005
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|AnimationSources|tailgateHide [Indent level: 2],
        "tailgatehide": {
            "source": "user",
            "animperiod": 1e-005,
            "initphase": 0,
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|AnimationSources|tailgate_open [Indent level: 2],
        "tailgate_open": {
            "source": "user",
            "animperiod": 2,
            "initphase": 0,
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|AnimationSources|cage_fold [Indent level: 2],
        "cage_fold": {
            "source": "user",
            "animperiod": 3,
            "initphase": 0,
    ...
    # Class: CfgVehicles|rhsusf_mrzr_base|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhsusf_mrzr_base|textureSources|standard [Indent level: 2]
        "standard": {
            "displayname": "Tan",
            ...
            "materials": ["|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn.rvmat"],
            "factions": ["rhs_faction_socom"]
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|textureSources|mud [Indent level: 2],
        "mud": {
            "displayname": "Tan (Muddy)",
            "textures": ["|rhsusf|addons|rhsusf_mrzr|data|blue_tan_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|yel_tan_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|red_tan_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|grn_tan_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|merged|orng_tan_mud_co.paa"],
            "materials": ["|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_mud.rvmat"],
            "factions": ["rhs_faction_socom"]
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|textureSources|paint1 [Indent level: 2],
        "paint1": {
            "displayname": "Painted (Woodland)",
            "textures": ["|rhsusf|addons|rhsusf_mrzr|data|blue_tan_pnt1_co.paa","|rhsusf|addons|rhsusf_mrzr|data|yel_tan_pnt1_co.paa","|rhsusf|addons|rhsusf_mrzr|data|red_tan_pnt1_co.paa","|rhsusf|addons|rhsusf_mrzr|data|grn_tan_pnt1_co.paa","|rhsusf|addons|rhsusf_mrzr|data|merged|orng_tan_paint_co.paa"],
            "factions": ["rhs_faction_socom"],
            "materials": ["|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn.rvmat"]
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|textureSources|mud_pnt1 [Indent level: 2],
        "mud_pnt1": {
            "displayname": "Painted (Woodland, Muddy)",
            "textures": ["|rhsusf|addons|rhsusf_mrzr|data|blue_tan_pnt1_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|yel_tan_pnt1_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|red_tan_pnt1_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|grn_tan_pnt1_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|merged|orng_tan_paint_mud_co.paa"],
            "factions": ["rhs_faction_socom"],
            "materials": ["|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_mud.rvmat"]
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|textureSources|olive [Indent level: 2],
        "olive": {
            "displayname": "Olive",
            "textures": ["|rhsusf|addons|rhsusf_mrzr|data|blue_grn_co.paa","|rhsusf|addons|rhsusf_mrzr|data|yel_grn_co.paa","|rhsusf|addons|rhsusf_mrzr|data|red_grn_co.paa","|rhsusf|addons|rhsusf_mrzr|data|grn_grn_co.paa","|rhsusf|addons|rhsusf_mrzr|data|merged|orng_grn_co.paa"],
            "factions": ["rhs_faction_socom"],
            "materials": ["|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn.rvmat"]
        },
        # Class: CfgVehicles|rhsusf_mrzr_base|textureSources|mud_olive [Indent level: 2],
        "mud_olive": {
            "displayname": "Olive (Muddy)",
            "textures": ["|rhsusf|addons|rhsusf_mrzr|data|blue_grn_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|yel_grn_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|red_grn_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|grn_grn_mud_co.paa","|rhsusf|addons|rhsusf_mrzr|data|merged|orng_grn_mud_co.paa"],
            "factions": ["rhs_faction_socom"],
            "materials": ["|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_mud.rvmat"]
        }
    },
    "texturelist": [],
    # Class: CfgVehicles|rhsusf_mrzr_base|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|ObjectTexture [Indent level: 2]
        "objecttexture": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_define_mainset [Indent level: 2],
        "rhs_define_mainset": {
            "control": "Combo",
            ...
            "defaultvalue": 0,
            "typename": "STRING",
            # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_define_mainset|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_define_mainset|values|ODA_MRZR_D [Indent level: 4]
                "oda_mrzr_d": {
                    "name": "ODA Desert",
                    "value": "ODA_MRZR_D",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_hood_main [Indent level: 2],
        "rhs_hood_main": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_hood_first [Indent level: 2],
        "rhs_hood_first": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_hood_battalion [Indent level: 2],
        "rhs_hood_battalion": {
            "displayname": "Define Battalion Hood Decal",
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_hood_company [Indent level: 2],
        "rhs_hood_company": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_hood_team [Indent level: 2],
        "rhs_hood_team": {
        ...
        # Class: CfgVehicles|rhsusf_mrzr_base|Attributes|rhs_bumerstickers [Indent level: 2],
        "rhs_bumerstickers": {
