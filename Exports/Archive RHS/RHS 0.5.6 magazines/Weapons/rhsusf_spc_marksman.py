rhsusf_spc_marksman = {
    ...
    # Class: CfgWeapons|rhsusf_spc_marksman|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry|gear|vests|rhs_spc_marksman",
        "containerclass": "Supply80",
        "mass": 80,
        # Class: CfgWeapons|rhsusf_spc_marksman|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_spc_marksman|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
                "hitpointname": "HitChest",
                "armor": 28,
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_spc_marksman|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_spc_marksman|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
