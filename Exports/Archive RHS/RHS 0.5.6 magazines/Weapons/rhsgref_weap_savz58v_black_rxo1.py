rhsgref_weap_savz58v_black_rxo1 = {
    # Class: CfgWeapons|rhsgref_weap_savz58v_black_rxo1|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhsgref_weap_savz58v_black_rxo1|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
    ...
    "hiddenselectionstextures": ["|rhsgref|addons|rhsgref_weapons|savz58|data|main_co","|rhsgref|addons|rhsgref_weapons|savz58|data|sec_black_co","|rhsgref|addons|rhsgref_weapons|savz58|data|vz58TopRailCover_co"],
    "hiddenselectionsmaterials": ["|rhsgref|addons|rhsgref_weapons|savz58|data|main.rvmat","|rhsgref|addons|rhsgref_weapons|savz58|data|sec_black.rvmat","|rhsgref|addons|rhsgref_weapons|savz58|data|vz58railcover.rvmat"],
