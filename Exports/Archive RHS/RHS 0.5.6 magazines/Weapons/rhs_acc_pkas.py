rhs_acc_pkas = {
    ...
    # Class: CfgWeapons|rhs_acc_pkas|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 0,
        "mass": 8.8,
        ...
        # Class: CfgWeapons|rhs_acc_pkas|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pkas|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
            ...
            # Class: CfgWeapons|rhs_acc_pkas|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
