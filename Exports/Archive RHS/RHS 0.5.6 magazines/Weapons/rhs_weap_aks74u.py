rhs_weap_aks74u = {
    ...
    "aidispersioncoefx": 8,
    # Class: CfgWeapons|rhs_weap_aks74u|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 59.62,
        # Class: CfgWeapons|rhs_weap_aks74u|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_aks74u|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_aks74u|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        # Class: CfgWeapons|rhs_weap_aks74u|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        "allowedslots": [901]
    },
