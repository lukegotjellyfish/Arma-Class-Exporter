rhsusf_opscore_paint_pelt = {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_Paint1_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|comtac_fg_co.paa"],
