rhsusf_acc_nt4_tan = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_nt4_tan_ca.paa",
    "scope": 2,
    "author": "Red Hammer Studios",
    "displayname": "NT4 QDSS (Tan)",
    "model": "rhsusf|addons|rhsusf_weapons|acc|silencers|nt4|nt4_tan.p3d",
    "inertia": 0.1,
    "dlc": "RHS_USAF",
