rhs_acc_2dpzenit = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_2dpZenit_ca.paa",
    "dlc": "RHS_AFRF",
    "author": "Red Hammer Studios",
    "scope": 2,
    "displayname": "2DP",
    "descriptionshort": "2DP Zenit LED Flashlight",
    "model": "rhsafrf|addons|rhs_weapons2|acc|flashlights|2dpZenit|rhs_2dpZenit.p3d",
    # Class: CfgWeapons|rhs_acc_2dpZenit|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 2,
        # Class: CfgWeapons|rhs_acc_2dpZenit|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
        },
        # Class: CfgWeapons|rhs_acc_2dpZenit|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
            "color": [25,22,20],
            ...
            "position": "flashdir",
            "direction": "flash",
            # Class: CfgWeapons|rhs_acc_2dpZenit|ItemInfo|FlashLight|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 2,
                "linear": 1,
