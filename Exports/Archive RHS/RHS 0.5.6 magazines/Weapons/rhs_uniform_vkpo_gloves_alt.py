rhs_uniform_vkpo_gloves_alt = {
    ...
    "displayname": "VKPO (Gloves/Alt.)",
    # Class: CfgWeapons|rhs_uniform_vkpo_gloves_alt|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_vkpo_gloves_alt_base",
        "uniformmodel": "-",
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_vkpo_alt_ca.paa",
    "scope": 2,
    "dlc": "RHS_AFRF",
