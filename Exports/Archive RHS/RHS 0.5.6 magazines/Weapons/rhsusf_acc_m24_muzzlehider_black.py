rhsusf_acc_m24_muzzlehider_black = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_m24_muzzlehider_black_ca.paa",
    "scope": 2,
    "displayname": "M24 15OX. Flash Hider",
    "author": "Red Hammer Studios",
    "model": "rhsusf|addons|rhsusf_weapons2|M24|M24_Muzzlehider_black.p3d",
    # Class: CfgWeapons|rhsusf_acc_m24_muzzlehider_black|ItemInfo [Indent level: 1],
    "iteminfo": {
        "soundtypeindex": 0,
        "inertia": 0.05,
        # Class: CfgWeapons|rhsusf_acc_m24_muzzlehider_black|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "visiblefire": 0.8,
            "audiblefire": 0.95,
        ...
        # Class: CfgWeapons|rhsusf_acc_m24_muzzlehider_black|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "dispersioncoef": "1.0f",
        ...
        "alternativefire": "rhsusf_acc_muzzleFlash_SF3P556",
        "mass": 7,
