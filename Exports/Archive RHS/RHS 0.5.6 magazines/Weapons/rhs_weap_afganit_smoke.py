rhs_weap_afganit_smoke = {
    ...
    "magazines": ["rhs_mag_afganit_smoke_12"],
    "modes": ["Double","Volley","AIDouble","AIVolley"],
    # Class: CfgWeapons|rhs_weap_afganit_smoke|Double [Indent level: 1],
    "double": {
        "reloadtime": 0.099,
        "burst": 2,
        "showtoplayer": 1,
        ...
        # Class: CfgWeapons|rhs_weap_902a|StandardSound [Indent level: 1],
        "standardsound": {
            "begin1": ["rhsafrf|addons|rhs_sounds|smoke|902A_1",2.8,1,600],
            "begin2": ["rhsafrf|addons|rhs_sounds|smoke|902A_2",2.8,1,600],
    ...
    # Class: CfgWeapons|rhs_weap_afganit_smoke|Volley [Indent level: 1],
    "volley": {
        "burst": 6,
        "autofire": 1,
    ...
    # Class: CfgWeapons|rhs_weap_afganit_smoke|AIDouble [Indent level: 1],
    "aidouble": {
        "showtoplayer": 0,
        "reloadtime": 0.099,
        "burst": 2,
    ...
    # Class: CfgWeapons|rhs_weap_afganit_smoke|AIVolley [Indent level: 1],
    "aivolley": {
        "showtoplayer": 0,
        "burst": 6,
        "autofire": 1,
