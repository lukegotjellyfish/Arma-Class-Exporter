rhs_weap_dircm_vitebsk = {
    ...
    "magazines": ["RHS_mag_DIRCM_Vitebsk"],
    "magazinereloadtime": 60,
    "simulation": "cmlauncher",
    "modes": ["Burst1"],
    "reloadmagazinesound": ["A3|sounds_f|dummysound",2,1,5],
    # Class: CfgWeapons|rhs_weap_DIRCM_Vitebsk|Burst1 [Indent level: 1],
    "burst1": {
        "displayname": "DIRCM",
        "reloadtime": 0.5,
        "burst": 120,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_DIRCM_Vitebsk|Burst1|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": ["rhsafrf|addons|rhs_c_heavyweapons|Sounds|ircm_on1",2,1,5],
            "begin2": ["rhsafrf|addons|rhs_c_heavyweapons|Sounds|ircm_on2",2,1,5],
