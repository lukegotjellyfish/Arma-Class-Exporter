rhs_fieldcap_m88_klmk_back = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_klmk_ca.paa",
    "displayname": "Field Cap M88 (KLMK/Back)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_klmk_co.paa"],
