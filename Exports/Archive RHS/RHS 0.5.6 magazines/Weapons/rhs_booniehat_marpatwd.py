rhs_booniehat_marpatwd = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhs_Booniehat_marpatwd_ca.paa",
    "scope": 1,
    "displayname": "Booniehat MARPAT-WD (Alt.)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|booniehat_marpatwd_co"],
