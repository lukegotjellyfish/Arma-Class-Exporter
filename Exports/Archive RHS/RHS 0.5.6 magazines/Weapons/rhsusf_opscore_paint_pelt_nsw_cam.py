rhsusf_opscore_paint_pelt_nsw_cam = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_opscore_paint_pelt_nsw_cam_ca.paa",
    "scope": 2,
    "displayname": "FAST Ballistic (Paint/Headset/NSW/Cam)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_Paint3_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|comtac_fg_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|nsw_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa","","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
