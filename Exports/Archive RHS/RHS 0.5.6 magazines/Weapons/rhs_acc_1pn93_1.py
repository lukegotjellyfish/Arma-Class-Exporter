rhs_acc_1pn93_1 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_1pn93_1_ca.paa",
    "author": "Red Hammer Studios",
    "scope": 2,
    "displayname": "1PN93-1",
    "model": "rhsafrf|addons|rhs_weapons|acc|scopes|1pn93|rhs_1pn93_1",
    "descriptionshort": "Optical Night Sight<br />Magnification: 4x",
    # Class: CfgWeapons|rhs_acc_1pn93_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 14,
        ...
        # Class: CfgWeapons|rhs_acc_1pn93_base|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_1pn93_base|ItemInfo|OpticsModes|1pn93_scope [Indent level: 3]
            "1pn93_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_1pn93_base|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
