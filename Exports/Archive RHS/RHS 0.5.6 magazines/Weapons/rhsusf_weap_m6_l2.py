rhsusf_weap_m6_l2 = {
    # Compatible Magazines: magazines parameter (+ inherited)    "magazines": [        "rhsusf_mag_l8a3_l2_8",],
    # Class: CfgWeapons|rhsusf_weap_M6_L2|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M6_L2|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "(_this + [['smoke_L2_','_pos','_dir']]) call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
    # Class: CfgWeapons|rhsusf_weap_M6_L1|Double [Indent level: 1],
    "double": {
        "reloadtime": 0.01,
        "burst": 4,
        "showtoplayer": 0,
        # Class: CfgWeapons|rhsusf_weap_M6_L1|Double|StandardSound [Indent level: 2],
        "standardsound": {
    ...
    "modes": ["Double"],
    # Class: CfgWeapons|rhsusf_weap_M257|Volley [Indent level: 1],
    "volley": {
        "burst": 16,
        "displayname": "M257 (16)",
        "reloadtime": 0.099,
