rhs_weap_ak74_2 = {
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_weapons3|aks74|data|rhs_ak74_2_co.paa"],
    # Class: CfgWeapons|rhs_weap_ak74_2|ItemInfo [Indent level: 1],
    "iteminfo": {
        "priority": 1,
        "rmbhint": "AK-74",
        "onhovertext": "AK-74"
    },
    # Class: CfgWeapons|rhs_weap_ak74_2|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 80,
        # Class: CfgWeapons|rhs_weap_ak74_2|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
