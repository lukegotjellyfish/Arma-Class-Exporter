rhsgref_uniform_para_ttsko_urban = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|uniform|rhsgref_uniform_para_ttsko_urban_ca.paa",
    "scope": 2,
    "dlc": "RHS_GREF",
    "displayname": "M10 TTsKO (Urban)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_blufor_diver",
    # Class: CfgWeapons|rhsgref_uniform_para_ttsko_urban|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
