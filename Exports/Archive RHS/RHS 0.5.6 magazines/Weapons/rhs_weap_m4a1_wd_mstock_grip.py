rhs_weap_m4a1_wd_mstock_grip = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_m4a1_wd_mstock_grip_ca.paa",
    "handanim": ["OFP2_ManSkeleton","|rhsusf|addons|rhsusf_c_weapons|anims|rhs_hand_m16a4.rtm"],
    # Class: CfgWeapons|rhs_weap_m4a1_wd_mstock_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_wd_mstock_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons|m4|data|m4a1_actual_wd_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|magazine_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|m4acc_wd_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|kacrailcover_wd_co.paa","|rhsusf|addons|rhsusf_weapons|acc|grips|grippod|data|acc_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|magpulstock_wd_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|m203s_wd_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|kacleaf_wd_co.paa","|rhsusf|addons|rhsusf_weapons|m320|data|m320_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|m4a1_actual_wd_co.paa"],
    "scope": 2,
