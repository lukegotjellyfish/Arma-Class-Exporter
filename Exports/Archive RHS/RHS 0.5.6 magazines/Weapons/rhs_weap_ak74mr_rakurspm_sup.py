rhs_weap_ak74mr_rakurspm_sup = {
    # Class: CfgWeapons|rhs_weap_ak74mr_rakursPM_sup|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak74mr_rakursPM_sup|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_rakursPM"
        },
        # Class: CfgWeapons|rhs_weap_ak74mr_rakursPM_sup|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
