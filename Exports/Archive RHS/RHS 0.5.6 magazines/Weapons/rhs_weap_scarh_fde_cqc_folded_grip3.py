rhs_weap_scarh_fde_cqc_folded_grip3 = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_FDE_CQC_Folded_grip3|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_FDE_CQC_Folded_grip3|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_FDE_CQC_Folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 76.78,
    ...
    "hiddenselectionstextures": ["rhssaf|addons|rhssaf_t_weapon_scar|data|scarh_tan_co.paa"],
