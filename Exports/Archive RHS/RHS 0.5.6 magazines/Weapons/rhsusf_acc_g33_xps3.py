rhsusf_acc_g33_xps3 = {
    ...
    "dlc": "RHS_USAF",
    "descriptionshort": "Magnifier<br />Magnification: 4x",
    "weaponinfotype": "rhs_rscOptics_combo_optics",
    "model": "rhsusf|addons|rhsusf_weapons3|acc|scopes|G33|g33_xps3",
    "rhs_accessory_next": "rhsusf_acc_g33_xps3_flip",
    "inertia": 0,
    # Class: CfgWeapons|rhsusf_acc_g33_xps3|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 6,
        "rmbhint": "Magnifier",
        ...
        # Class: CfgWeapons|rhsusf_acc_g33_xps3|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_g33_xps3|ItemInfo|OpticsModes|MAG [Indent level: 3]
            "mag": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": ["OpticsCHAbera1","OpticsBlur1","rhs_g33_Blur"],
