rhs_uniform_afghanka_winter_boots_spetsodezhda = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_boots_spetsodezhda_ca.paa",
    "displayname": "M88 Winter Sapogi (Spetsodezhda)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_boots_spetsodezhda|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_boots_spetsodezhda_base",
        "uniformmodel": "-",
