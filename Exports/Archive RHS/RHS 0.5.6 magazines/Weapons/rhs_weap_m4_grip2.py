rhs_weap_m4_grip2 = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_m4_grip2_ca.paa",
    "handanim": ["OFP2_ManSkeleton","|rhsusf|addons|rhsusf_c_weapons|anims|rhs_hand_m4a1_afg.rtm"],
    # Class: CfgWeapons|rhs_weap_m4_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
