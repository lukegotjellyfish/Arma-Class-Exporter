rhsusf_ach_helmet_headset_ess_ocp_alt = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_helmet_headset_ess_ocp_alt_ca.paa",
    "displayname": "ACH OEF-CP (Headset/ESS/Alt)",
    "hiddenselections": ["Camo","Camo1"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_ocp_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
    ...
    # Class: CfgWeapons|rhsusf_ach_helmet_headset_ess_ocp|ItemInfo [Indent level: 1],
    "iteminfo": {
