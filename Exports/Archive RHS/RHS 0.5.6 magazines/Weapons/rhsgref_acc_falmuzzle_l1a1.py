rhsgref_acc_falmuzzle_l1a1 = {
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|accessories|rhsgref_acc_falMuzzle_l1a1_ca.paa",
    "author": "Red Hammer Studios",
    "scope": 2,
    "model": "rhsgref|addons|rhsgref_weapons3|acc|muzzle|rhs_L1A1_flashHider",
    "displayname": "L1A1 SLR Flash Hider",
    # Class: CfgWeapons|rhsgref_acc_falMuzzle_l1a1|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 5,
        "soundtypeindex": 0,
        # Class: CfgWeapons|rhsgref_acc_falMuzzle_l1a1|ItemInfo|MagazineCoef [Indent level: 2],
        "magazinecoef": {
            "initspeed": 1
        },
        # Class: CfgWeapons|rhsgref_acc_falMuzzle_l1a1|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "typicalspeed": 1,
            "airfriction": 1,
        ...
        # Class: CfgWeapons|rhsgref_acc_falMuzzle_l1a1|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
