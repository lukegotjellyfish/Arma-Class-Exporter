rhs_weap_m21s_pr_hamr = {
    # Class: CfgWeapons|rhs_weap_m21s_pr_hamr|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m21s_pr_hamr|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "optic_Hamr"
        }
    },
    # Class: CfgWeapons|rhs_weap_m21s_pr|Single [Indent level: 1],
    "single": {
        "dispersion": 0.00325,
        "sounds": ["StandardSound","SilencedSound"],
        # Class: CfgWeapons|rhs_weap_m21_base|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHSSAF_M21_Shot_SoundSet","RHSSAF_rifle1_Tail_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_m21_base|Single|SilencedSound [Indent level: 2],
        "silencedsound": {
            "soundsetshot": ["RHSSAF_sd_M21_Shot_SoundSet","RHSSAF_sd_rifle1_Tail_SoundSet"]
        },
        "reloadtime": 0.1,
        "minrange": 2,
        "minrangeprobab": 0.5,
    ...
    # Class: CfgWeapons|rhs_weap_m21s_pr|FullAuto [Indent level: 1],
    "fullauto": {
        "dispersion": 0.00325,
        "sounds": ["StandardSound","SilencedSound"],
    ...
    # Class: CfgWeapons|rhs_weap_m21s_pr|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 89.54,
        # Class: CfgWeapons|rhs_weap_m21a_pr|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_m21a_pr|WeaponSlotsInfo|rhs_mtz_slot [Indent level: 2],
        "rhs_mtz_slot": {
        },
    ...
    "magazines": [
        "rhsgref_30rnd_556x45_m21","rhsgref_30rnd_556x45_m21_t",],
