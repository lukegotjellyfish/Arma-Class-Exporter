rhs_pdu4 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_pdu4_ca.paa",
    "author": "Red Hammer Studios",
    "dlc": "RHS_AFRF",
    "scope": 2,
    "displayname": "PDU-4",
    # Class: CfgWeapons|rhs_pdu4|Library [Indent level: 1],
    "library": {
    ...
    # Class: CfgWeapons|rhs_pdu4|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 20
    },
