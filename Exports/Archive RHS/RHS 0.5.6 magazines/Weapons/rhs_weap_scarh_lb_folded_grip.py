rhs_weap_scarh_lb_folded_grip = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_LB_Folded_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_LB_Folded_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    "scopearsenal": 0,
    "baseweapon": "rhs_weap_SCARH_LB_Folded",
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_LB_Folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 76.78,
