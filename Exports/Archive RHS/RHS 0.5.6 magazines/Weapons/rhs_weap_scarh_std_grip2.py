rhs_weap_scarh_std_grip2 = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_STD_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_STD_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
