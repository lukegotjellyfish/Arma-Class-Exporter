rhs_weap_xm2010_wd_leu = {
    # Class: CfgWeapons|rhs_weap_XM2010_wd_leu|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_XM2010_wd_leu|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_LEUPOLDMK4_2"
        },
        # Class: CfgWeapons|rhs_weap_XM2010_wd_leu|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
