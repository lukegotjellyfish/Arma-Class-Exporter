rhs_acc_1pn34 = {
    ...
    # Class: CfgWeapons|rhs_acc_1pn34|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 18,
        "modeloptics": "rhsafrf|addons|rhs_accessory|scopes|1pn34|NV_nspu_optic",
        # Class: CfgWeapons|rhs_acc_1pn34|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_1pn34|ItemInfo|OpticsModes|1pn34_scope [Indent level: 3]
            "1pn34_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_1pn34|ItemInfo|OpticsModes|rhs_1pn34_iron [Indent level: 3],
            "rhs_1pn34_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
