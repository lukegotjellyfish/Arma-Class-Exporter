rhsusf_acc_nxs_3515x50_md = {
    ...
    "displayname": "NXS 3.5-15x50 (mil-dot)",
    "descriptionshort": "Reticle: Second focal plane mildot<br />Magnification: 3.5-15x",
    # Class: CfgWeapons|rhsusf_acc_nxs_3515x50_md|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsusf|addons|rhsusf_scopes|optics|nf|f2|rhsusf_nxs_15xf2_mildot",
        "optictype": 2,
        "mass": 8,
        "rmbhint": "Optical Sight",
        "optics": 1,
        # Class: CfgWeapons|rhsusf_acc_nxs_3515x50_base|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_nxs_3515x50_base|ItemInfo|OpticsModes|nxs_scope [Indent level: 3]
            "nxs_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
