rhsusf_acc_anpeq15_wmx_h = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    "rhs_acc_combo": "rhsusf_acc_anpeq15_wmx_light_h",
    "model": "rhsusf|addons|rhsusf_weapons|acc|flashlight|WMX|WMX_A3_side_h",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_anpeq15_wmx_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_acc_anpeq15|ItemInfo [Indent level: 1],
    "iteminfo": {
        "rmbhint": "IR Laser",
        "mass": 8,
        # Class: CfgWeapons|rhsusf_acc_anpeq15|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
            "irlaserpos": "laser pos",
            "irlaserend": "laser dir",
            "irdistance": 5
        },
        # Class: CfgWeapons|rhsusf_acc_anpeq15|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
        },
        "type": 301,
