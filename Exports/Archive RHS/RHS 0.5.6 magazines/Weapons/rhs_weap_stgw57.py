rhs_weap_stgw57 = {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_weapons|stgw57|Data|stgw57_ca"],
    ...
    # Class: CfgWeapons|rhs_weap_stgw57_base|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_stgw57_base|GunParticles|SecondEffect [Indent level: 2]
        "secondeffect": {
            "positionname": "Nabojnicestart",
            "directionname": "Nabojniceend",
            "effectname": "CaselessAmmoCloud"
        },
        # Class: CfgWeapons|rhs_weap_stgw57_base|GunParticles|RHS_BarrelRefract [Indent level: 2],
        "rhs_barrelrefract": {
    ...
    # Class: CfgWeapons|rhs_weap_stgw57_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 125.4,
        # Class: CfgWeapons|rhs_weap_stgw57_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_stgw57_base|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        },
        # Class: CfgWeapons|rhs_weap_stgw57_base|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        "allowedslots": [901]
    },
    ...
    "dexterity": 1.6,
    # Class: CfgWeapons|rhs_weap_stgw57_base|SAFE [Indent level: 1],
    "safe": {
        "showtoplayer": 0,
        "magazines": [],
        "displayname": "SAFE",
    ...
    # Class: CfgWeapons|rhs_weap_stgw57_base|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.12,
        "dispersion": 0.0021,
        "minrange": 2,
        ...
        # Class: CfgWeapons|rhs_weap_stgw57_base|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHS_akm_Closure_SoundSet","RHS_akm_Shot_SoundSet","RHS_lmg1_Tail_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_stgw57_base|Single|SilencedSound [Indent level: 2],
        "silencedsound": {
    ...
    # Class: CfgWeapons|rhs_weap_stgw57_base|FullAuto [Indent level: 1],
    "fullauto": {
        "reloadtime": 0.12,
        "dispersion": 0.0021,
        "minrange": 0,
        ...
        "airateoffire": 1e-006,
        "sounds": ["StandardSound","SilencedSound"],
        # Class: CfgWeapons|rhs_weap_stgw57_base|FullAuto|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHS_akm_Closure_SoundSet","RHS_akm_Shot_SoundSet","RHS_lmg1_Tail_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_stgw57_base|FullAuto|SilencedSound [Indent level: 2],
        "silencedsound": {
            "soundsetshot": ["RHS_akm_Closure_SoundSet","RHS_akm_ShotSD_SoundSet","RHS_Rifle1_SD_Tail_SoundSet"]
        },
        "sound": ["",10,1],
    ...
    # Class: CfgWeapons|rhs_weap_stgw57_base|single_medium_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_stgw57_base|single_far_optics2 [Indent level: 1],
    "single_far_optics2": {
        "requiredoptictype": 2,
        "minrange": 100,
        "minrangeprobab": 0.1,
    ...
    # Class: CfgWeapons|rhs_weap_stgw57_base|fullauto_medium [Indent level: 1],
    "fullauto_medium": {
        "showtoplayer": 0,
        "burst": 3,
        "minrange": 2,
