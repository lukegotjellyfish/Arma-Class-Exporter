rhs_acc_at4_handler = {
    ...
    # Class: CfgWeapons|rhs_acc_at4_handler|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 0,
        # Class: CfgWeapons|rhs_acc_at4_handler|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
        },
        # Class: CfgWeapons|rhs_acc_at4_handler|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
        },
        "type": 301,
