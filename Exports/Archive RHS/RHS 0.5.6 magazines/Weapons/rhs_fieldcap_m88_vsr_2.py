rhs_fieldcap_m88_vsr_2 = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_vsr_2_ca.paa",
    "displayname": "Field Cap M88 (VSR Alt.)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_VSR_co.paa"],
    "scope": 2,
