rhs_weap_optic_smaw_6 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_6|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_6|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_6|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 300,
                "distancezoommax": 300,
                "discreteinitindex": 5,
