rhs_6b23_6sh116_vog_mixed = {
    ...
    "displayname": "6B23 Mixed (6Sh116/VOG)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry|data|6b23_digi_co.paa","rhsafrf|addons|rhs_infantry2|data|rhs_6sh116_flora_co.paa","rhsafrf|addons|rhs_infantry2|data|rhs_6sh116_gear1_flora_co.paa"],
    "model": "rhsafrf|addons|rhs_infantry2|gear|vests|rhs_6b23_6sh116_vog",
    # Class: CfgWeapons|rhs_6b23_6sh116_vog_mixed|ItemInfo [Indent level: 1],
    "iteminfo": {
