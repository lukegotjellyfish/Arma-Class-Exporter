rhs_weap_ak103_gp25_npz = {
    ...
    "weaponinfotype": "rhs_rscOptics_ak103_gp25_npz",
    ...
    # Class: CfgWeapons|rhs_weap_ak103_gp25_npz|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 116.3,
        # Class: CfgWeapons|rhs_weap_ak103_gp25_npz|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_ak103_gp25_npz|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_ak103_gp25_npz|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        # Class: CfgWeapons|rhs_weap_ak103_gp25_npz|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        "allowedslots": [901]
    },
    # Class: CfgWeapons|rhs_weap_ak103_gp25_npz|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak103_gp25_npz|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtk"
        }
