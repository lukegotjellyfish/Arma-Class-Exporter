rhs_acc_nita_3d = {
    ...
    # Class: CfgWeapons|rhs_acc_nita_3d|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_nita_3d|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_nita_3d|ItemInfo|OpticsModes|rhs_nita_scope [Indent level: 3]
            "rhs_nita_scope": {
                "usemodeloptics": 0,
                ...
                "opticszoommin": 0.2492,
                "opticszoommax": 0.2492,
                "opticszoominit": 0.2492,
                "visionmode": ["Normal"],
                "opticsflare": 0,
            ...
            # Class: CfgWeapons|rhs_acc_nita_3d|ItemInfo|OpticsModes|rhs_nita_iron [Indent level: 3],
            "rhs_nita_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
        ...
        "optictype": 0,
        "mass": 11.64,
        "rmbhint": "Collimated Optic",
        "optics": 1,
        "modeloptics": "rhsafrf|addons|rhs_weapons3|acc|scopes|optics|rhs_nita_scope",
        "type": 201,
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_nita_ca.paa",
    "displayname": "NIT-A",
    "model": "rhsafrf|addons|rhs_weapons3|acc|scopes|nit-a|rhs_nita.p3d",
    "descriptionshort": "Collimator Sight<br />Magnification: 1x",
    "weaponinfotype": "rhs_rscOptics_acc_nita",
    "rhs_optic_base": "rhs_acc_nita",
    "inertia": 0.1,
    "dlc": "RHS_AFRF",
    "muzzles": [],
