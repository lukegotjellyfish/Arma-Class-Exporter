rhs_acc_pgo7v3_ak = {
    ...
    # Class: CfgWeapons|rhs_acc_pgo7v3_ak|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsafrf|addons|rhs_weapons|acc|scopes|optics|rhs_pgo7v3_scope",
        # Class: CfgWeapons|rhs_acc_pgo7v_ak|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pgo7v_ak|ItemInfo|OpticsModes|rhs_pgo7v_scope [Indent level: 3]
            "rhs_pgo7v_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_pgo7v_ak|ItemInfo|OpticsModes|rhs_pgo7v_iron [Indent level: 3],
            "rhs_pgo7v_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
                ...
                "discretedistancecamerapoint": ["eye_ak","eye_ak_100","eye_ak_200","eye_ak_300","eye_ak_400","eye_ak_500","eye_ak_600","eye_ak_700","eye_ak_800","eye_ak_900","eye_ak_1000"],
