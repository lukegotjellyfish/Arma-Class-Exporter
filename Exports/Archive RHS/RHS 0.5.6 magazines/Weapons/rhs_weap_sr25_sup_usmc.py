rhs_weap_sr25_sup_usmc = {
    # Class: CfgWeapons|rhs_weap_sr25_sup_usmc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_sr25_sup_usmc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_premier"
        },
        # Class: CfgWeapons|rhs_weap_sr25_sup_usmc|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhsusf_acc_SR25S"
        },
        # Class: CfgWeapons|rhs_weap_sr25_sup_usmc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
