rhs_weap_m4a1_d_grip2 = {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_d_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_d_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip2",
            "slot": "UnderBarrelSlot"
        }
    },
    # Class: CfgWeapons|rhs_weap_m4a1_d_grip|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 65,
        # Class: CfgWeapons|rhs_weap_m4a1_d_grip|WeaponSlotsInfo|UnderBarrelSlot [Indent level: 2],
        "underbarrelslot": {
        },
        "allowedslots": [901],
