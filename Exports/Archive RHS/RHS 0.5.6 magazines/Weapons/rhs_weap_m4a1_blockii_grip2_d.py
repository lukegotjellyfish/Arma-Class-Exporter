rhs_weap_m4a1_blockii_grip2_d = {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_d|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_d|WeaponSlotsInfo|GripodSlot [Indent level: 2]
        "gripodslot": {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_d|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_d|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip2",
            "slot": "UnderBarrelSlot"
        }
    },
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons|m4|data|m4a1_actual_d_co.paa","|rhsusf|addons|rhsusf_weapons3|M4BII|Data|rhs_block2rail_d_co.paa","|rhsusf|addons|rhsusf_weapons|acc|grips|grippod|data|acc_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|m4acc_d_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|magpulstock_d_co.paa"],
