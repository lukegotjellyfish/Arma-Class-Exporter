rhsgref_helmet_pasgt_woodland_rhino = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_pasgt_woodland_rhino_ca.paa",
    "scope": 2,
    "displayname": "PASGT (Woodland, Rhino)",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_gue|pasgt_helmet_USwoodland_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_pasgt_woodland_rhino|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
