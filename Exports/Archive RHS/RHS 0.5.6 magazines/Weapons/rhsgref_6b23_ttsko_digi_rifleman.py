rhsgref_6b23_ttsko_digi_rifleman = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_ttsko_digi_rifleman_ca.paa",
    "scope": 2,
    "displayname": "6B23 TTsKO Digital (Rifleman)",
    "model": "rhsafrf|addons|rhs_infantry|gear|vests|rhs_6b23_vydra_3m",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_cdf|6b23_cdf_digisummer_co.paa","rhsafrf|addons|rhs_infantry|data|gearpack1_6sh92_co.paa"],
    # Class: CfgWeapons|rhsgref_6b23_ttsko_digi_rifleman|ItemInfo [Indent level: 1],
    "iteminfo": {
