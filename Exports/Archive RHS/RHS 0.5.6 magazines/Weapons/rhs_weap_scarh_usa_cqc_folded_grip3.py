rhs_weap_scarh_usa_cqc_folded_grip3 = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_USA_CQC_Folded_grip3|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_USA_CQC_Folded_grip3|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_USA_CQC_Folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 76.78,
    ...
    "inertia": 0.5,
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_weap_scarh_folded_recoil [Indent level: 0],
    "recoil": {
