rhsgref_6b23_ttsko_digi_officer = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_ttsko_digi_officer_ca.paa",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsgref_6b23_ttsko_digi_officer|ItemInfo [Indent level: 1],
    "iteminfo": {
