rhssaf_helmet_m97_veil_woodland = {
    ...
    # Class: CfgWeapons|rhssaf_helmet_m97_veil_Base|ItemInfo [Indent level: 1],
    "iteminfo": {
        ...
        "modelsides": [6],
        # Class: CfgWeapons|rhssaf_helmet_m97_woodland|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_helmet_m97_woodland|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
