rhsusf_mbav = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry2|gear|vests|mbav|data|mbav_tan_co.paa"],
    "descriptionshort": "Armor Level IV",
    # Class: CfgWeapons|rhsusf_mbav|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["camo"],
        "uniformmodel": "rhsusf|addons|rhsusf_infantry2|gear|vests|mbav|mbav_clean",
        "containerclass": "Supply20",
        "mass": 60,
        # Class: CfgWeapons|rhsusf_mbav|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_mbav|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
                "hitpointname": "HitChest",
                "armor": 28,
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_mbav|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 28,
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_mbav|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
