rhsusf_mich_bare_norotos_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_headset_ca.paa",
    "displayname": "MICH 2000 (Norotos/Headset)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_bare_01_nor1_bowman",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_norotos_od_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_od_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|bowman_base_co.paa"],
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
