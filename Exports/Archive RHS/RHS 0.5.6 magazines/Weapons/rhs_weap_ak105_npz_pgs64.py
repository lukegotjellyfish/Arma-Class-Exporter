rhs_weap_ak105_npz_pgs64 = {
    # Class: CfgWeapons|rhs_weap_ak105_npz_pgs64|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak105_npz_pgs64|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_pgs64"
        }
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_ak105_npz_ca.paa",
    "displayname": "AK-105 (B-13)",
    "model": "rhsafrf|addons|rhs_weapons|rhs_ak105_npz",
    "muzzles": ["this","SAFE"],
    # Class: CfgWeapons|rhs_weap_ak105_npz|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 66,
        # Class: CfgWeapons|rhs_weap_ak105_npz|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_ak105_npz|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_ak105_npz|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_ak105_npz|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        "allowedslots": [901]
    },
    "rhs_npz": "rhs_weap_ak105",
    "weaponinfotype": "rhs_rscOptics_ak105_npz",
