rhs_weap_m21a_pr_aco = {
    # Class: CfgWeapons|rhs_weap_m21a_pr_aco|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m21a_pr_aco|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "optic_ACO"
        }
    },
    # Class: CfgWeapons|rhs_weap_m21a_pr|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
