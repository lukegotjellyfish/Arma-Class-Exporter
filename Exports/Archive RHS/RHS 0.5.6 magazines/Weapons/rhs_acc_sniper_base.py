rhs_acc_sniper_base = {
    ...
    # Class: CfgWeapons|rhs_acc_sniper_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 13.64,
        ...
        # Class: CfgWeapons|rhs_acc_sniper_base|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_sniper_base|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_sniper_base|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
