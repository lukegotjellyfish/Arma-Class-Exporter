rhs_weap_m27iar_bipod_acog_usmc_sup_tan = {
    # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup_tan|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup_tan|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG3_USMC"
        },
        # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup_tan|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq16a"
        },
        # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup_tan|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhsusf_acc_nt4_tan"
        },
        # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup_tan|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
    ...
    "reloadtime": 0.07,
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_m27 [Indent level: 0],
    "recoil": {
    ...
    # Class: CfgWeapons|rhs_weap_m27iar|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 79.2,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_m27iar|WeaponSlotsInfo|UnderBarrelSlot [Indent level: 2],
        "underbarrelslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_m27iar|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        ...
        # Class: CfgWeapons|rhs_weap_m27iar|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_m27iar|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_m27iar|WeaponSlotsInfo|GripodSlot [Indent level: 2],
        "gripodslot": {
    ...
    # Class: CfgWeapons|rhs_weap_m27iar|Single [Indent level: 1],
    "single": {
    ...
    # Class: CfgWeapons|rhs_weap_m27iar|FullAuto [Indent level: 1],
    "fullauto": {
        "reloadtime": 0.075,
        "dispersion": 0.0005818,
        "minrange": 2,
