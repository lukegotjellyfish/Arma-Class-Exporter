rhsgref_chicom_m88 = {
    ...
    "model": "rhsgref|addons|rhsgref_infantry|gear_tanoa|vest|rhs_vest_chicom2.p3d",
    "scope": 1,
    # Class: CfgWeapons|rhsgref_chicom_m88|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsgref|addons|rhsgref_infantry|gear_tanoa|vest|rhs_vest_chicom2.p3d",
        "hiddenselections": ["Camo1"],
        "containerclass": "Supply100",
        "mass": 15,
        # Class: CfgWeapons|rhsgref_chicom|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_chicom|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3]
            "body": {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_chicom_ca.paa",
    "dlc": "RHS_GREF",
    "hiddenselections": ["Camo1"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|vest|chicom|rhs_chicom_co.paa"],
