rhs_weap_kh55sm_launcher = {
    "modes": ["this"],
    "displayname": "MKU-5-6 rotary launcher",
    "magazines": ["rhs_mag_kh55sm","rhs_mag_kh55sm_6","rhs_mag_kh55sm_nocamo","rhs_mag_kh55sm_nocamo_6","rhs_mag_kh55sh","rhs_mag_kh55sh_6","rhs_mag_kh55sh_nocamo","rhs_mag_kh55sh_nocamo_6"],
    "reloadtime": 5,
    # Class: CfgWeapons|rhs_weap_kh55sm_Launcher|Eventhandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhs_weap_kh55sm_Launcher|Eventhandlers|RHS_MissileDeploy [Indent level: 2]
        "rhs_missiledeploy": {
