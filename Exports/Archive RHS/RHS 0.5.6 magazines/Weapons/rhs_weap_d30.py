rhs_weap_d30 = {
    ...
    # Class: CfgWeapons|rhs_weap_d30|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_d30|GunParticles|Effect1 [Indent level: 2]
        "effect1": {
            "directionname": "Konec hlavne",
            "positionname": "Usti hlavne",
            "effectname": "ArtilleryFired1"
        },
        # Class: CfgWeapons|rhs_weap_d30|GunParticles|Effec2 [Indent level: 2],
        "effec2": {
    ...
    "modes": ["Single1","Single2","Single3","Single4","Single5","Single6"],
    # Class: CfgWeapons|rhs_weap_d30|Single1 [Indent level: 1],
    "single1": {
        ...
        # Class: CfgWeapons|rhs_weap_d30|Single1|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHS_155mm_Shot_SoundSet","RHS_155mm_int_Shot_SoundSet","RHS_cannon_Tail_SoundSet"]
        },
        "multiplier": 1,
        "burst": 1,
        "burstrangemax": -1,
    ...
    # Class: CfgWeapons|rhs_weap_d30|Single2 [Indent level: 1],
    "single2": {
    ...
    # Class: CfgWeapons|rhs_weap_d30|Single3 [Indent level: 1],
    "single3": {
    ...
    # Class: CfgWeapons|rhs_weap_d30|Single4 [Indent level: 1],
    "single4": {
    ...
    # Class: CfgWeapons|rhs_weap_d30|Single5 [Indent level: 1],
    "single5": {
    ...
    # Class: CfgWeapons|rhs_weap_d30|Single6 [Indent level: 1],
    "single6": {
    ...
    # Class: CfgWeapons|rhs_weap_d30|close [Indent level: 1],
    "close": {
        "artillerycharge": 1,
    ...
    # Class: CfgWeapons|rhs_weap_d30|short [Indent level: 1],
    "short": {
        "airateoffire": 6,
        "airateoffiredispersion": 1,
    ...
    # Class: CfgWeapons|rhs_weap_d30|medium [Indent level: 1],
    "medium": {
        "airateoffire": 8,
    ...
    # Class: CfgWeapons|rhs_weap_d30|far [Indent level: 1],
    "far": {
        "airateoffire": 10,
    ...
    "magazines": [
        "rhs_mag_of462","rhs_mag_of462_10","rhs_mag_3of56","rhs_mag_3of56_10",
        "rhs_mag_3of56_5","rhs_mag_of462_direct","rhs_mag_of462_direct_10","rhs_mag_3of56_direct",
        "rhs_mag_3of56_direct_10","rhs_mag_3of56_direct_5","rhs_mag_bk6m","rhs_mag_bk6m_26",
        "rhs_mag_bk6m_5","rhs_mag_bk13","rhs_mag_bk13_26","rhs_mag_bk13_5",
        "rhs_mag_d462","rhs_mag_d462_2","rhs_mag_s463","rhs_mag_s463_2",
        "rhs_mag_3of69m","rhs_mag_3of69m_2",],
    # Class: CfgWeapons|rhs_weap_d30|Burst1 [Indent level: 1],
    "burst1": {
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_d30|Burst1|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHS_155mm_Shot_SoundSet","RHS_155mm_int_Shot_SoundSet","RHS_cannon_Tail_SoundSet"]
        },
        "sound": ["",10,1],
    ...
    "autoreload": 1,
    "canlock": 0,
    # Class: CfgWeapons|mortar_155mm_AMOS|Burst2 [Indent level: 1],
    "burst2": {
        "showtoplayer": 0,
    ...
    # Class: CfgWeapons|mortar_155mm_AMOS|Burst3 [Indent level: 1],
    "burst3": {
        "showtoplayer": 0,
