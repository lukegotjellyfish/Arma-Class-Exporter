rhs_m2_abrams_commander = {
    ...
    # Class: CfgWeapons|RHS_M2_Abrams_Commander|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|GunParticles|effect1 [Indent level: 2]
        "effect1": {
            "positionname": "usti hlavne3",
            "directionname": "konec hlavne3",
            "effectname": "MachineGunCloud"
        },
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|GunParticles|effect2 [Indent level: 2],
        "effect2": {
            "positionname": "nabojnicestart",
            "directionname": "nabojniceend",
            "effectname": "MachineGunEject"
        },
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|GunParticles|effect3 [Indent level: 2],
        "effect3": {
            "positionname": "nabojnicestart",
            "directionname": "nabojniceend",
            "effectname": "MachineGunCartridge2"
        },
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|GunParticles|RHSUSF_BarrelRefract [Indent level: 2],
    ...
    # Class: CfgWeapons|RHS_M2_Abrams_Commander|manual [Indent level: 1],
    "manual": {
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|manual|StandardSound [Indent level: 2]
        "standardsound": {
    ...
    # Class: CfgWeapons|RHS_M2_Abrams_Commander|close [Indent level: 1],
    "close": {
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|close|StandardSound [Indent level: 2]
        "standardsound": {
            "soundsetshot": ["RHSUSF_veh_m2_Shot_SoundSet","RHSUSF_veh_m2_int_Shot_SoundSet","RHSUSF_veh_rifle2_Tail_SoundSet"]
        },
        "aiburstterminable": 1,
    ...
    # Class: CfgWeapons|RHS_M2_Abrams_Commander|short [Indent level: 1],
    "short": {
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|short|StandardSound [Indent level: 2]
        "standardsound": {
            "soundsetshot": ["RHSUSF_veh_m2_Shot_SoundSet","RHSUSF_veh_m2_int_Shot_SoundSet","RHSUSF_veh_rifle2_Tail_SoundSet"]
        },
        "aiburstterminable": 1,
    ...
    # Class: CfgWeapons|RHS_M2_Abrams_Commander|medium [Indent level: 1],
    "medium": {
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|medium|StandardSound [Indent level: 2]
        "standardsound": {
            "soundsetshot": ["RHSUSF_veh_m2_Shot_SoundSet","RHSUSF_veh_m2_int_Shot_SoundSet","RHSUSF_veh_rifle2_Tail_SoundSet"]
        },
        "aiburstterminable": 1,
    ...
    # Class: CfgWeapons|RHS_M2_Abrams_Commander|far [Indent level: 1],
    "far": {
        # Class: CfgWeapons|RHS_M2_Abrams_Commander|far|StandardSound [Indent level: 2]
        "standardsound": {
            "soundsetshot": ["RHSUSF_veh_m2_Shot_SoundSet","RHSUSF_veh_m2_int_Shot_SoundSet","RHSUSF_veh_rifle2_Tail_SoundSet"]
        },
        "aiburstterminable": 1,
