rhsusf_opscore_mc_pelt = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_opscore_mc_pelt_ca.paa",
    "scope": 2,
    "displayname": "FAST Ballistic (Multicam Paint/Headset)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_MC2_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|comtac_co.paa"],
