rhsusf_acc_acog_rmr_pip = {
    "rhs_optic_base": "rhsusf_acc_ACOG_RMR",
    "weaponinfotype": "rhs_acog_rmr_pip_handler",
    "author": "Red Hammer Studios",
    "displayname": "TA31RCO-RMR",
    "model": "rhsusf|addons|rhsusf_scopes|rmr|acog_rmr_pip",
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhsusf_acc_ACOG_pip|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_ACOG_pip|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_ACOG_pip|ItemInfo|OpticsModes|elcan_scope [Indent level: 3]
            "elcan_scope": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.275,
            ...
            # Class: CfgWeapons|rhsusf_acc_ACOG_pip|ItemInfo|OpticsModes|alternative_view [Indent level: 3],
            "alternative_view": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_ACOG_ca.paa",
    "descriptionshort": "Rifle Combat Optics<br />Magnification: 4x",
    "opticsdisableperipherialvision": 0,
    "inertia": 0.1,
    "dlc": "RHS_USAF",
    "muzzles": [],
