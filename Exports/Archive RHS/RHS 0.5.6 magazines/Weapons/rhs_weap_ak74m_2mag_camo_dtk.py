rhs_weap_ak74m_2mag_camo_dtk = {
    ...
    # Class: CfgWeapons|rhs_weap_ak74m_2mag_camo_dtk|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak74m_2mag_camo_dtk|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtk"
        }
    },
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_ak74m_2mag_camo_ca.paa",
    "displayname": "AK-74M (2 Mag./Camo)",
