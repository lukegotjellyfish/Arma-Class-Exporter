rhs_m4_grip_compm4 = {
    # Class: CfgWeapons|rhs_m4_grip_compm4|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4_grip_compm4|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_compm4"
        },
        # Class: CfgWeapons|rhs_m4_grip_compm4|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15side"
        },
        # Class: CfgWeapons|rhs_m4_grip_compm4|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_m4_grip|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 73.04,
        # Class: CfgWeapons|rhs_weap_m4_grip|WeaponSlotsInfo|UnderBarrelSlot [Indent level: 2],
        "underbarrelslot": {
        },
        "allowedslots": [901],
