rhs_weap_optic_smaw_8 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_8|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_8|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_8|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 400,
                "distancezoommax": 400,
                "discreteinitindex": 7,
