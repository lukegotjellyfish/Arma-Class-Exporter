rhs_weap_optic_smaw = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 8,
        "optictype": 1,
        "optics": 1,
        "modeloptics": "rhsusf|addons|rhsusf_weapons2|smaw|optic_smaw_2d.p3d",
        # Class: CfgWeapons|rhs_weap_optic_smaw|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "opticsid": 1,
                "usemodeloptics": 1,
                "opticszoommin": 0.07,
