rhsusf_spc_patchless = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|vests|rhsusf_spc_patchless_ca.paa",
    "displayname": "SPC (Patchless)",
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry|data|rhs_spc02_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_spc_gear1_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_spc_gear2_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_usmc_camelbak_co.paa"],
    "hiddenselectionsmaterials": ["rhsusf|addons|rhsusf_infantry|data|rhs_spc_02.rvmat","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_vest_gear1.rvmat","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_vest_gear2.rvmat","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_usmc_camelbak.rvmat"],
    "model": "rhsusf|addons|rhsusf_infantry|gear|vests|rhs_spc_light",
    # Class: CfgWeapons|rhsusf_spc_light|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry|gear|vests|rhs_spc_light",
        "containerclass": "Supply100",
        "mass": 100,
        # Class: CfgWeapons|rhsusf_spc_light|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_spc_light|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
                "hitpointname": "HitChest",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_spc_light|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_spc_light|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhsusf_spc_light|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
