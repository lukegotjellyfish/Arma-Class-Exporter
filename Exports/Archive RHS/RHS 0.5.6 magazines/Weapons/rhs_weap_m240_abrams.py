rhs_weap_m240_abrams = {
    # Class: CfgWeapons|rhs_weap_m240_abrams|GunParticles [Indent level: 1]
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_m240_abrams|GunParticles|effect1 [Indent level: 2]
        "effect1": {
            "positionname": "usti hlavne5",
            "directionname": "konec hlavne5",
            "effectname": "MachineGunCloud"
        },
        # Class: CfgWeapons|rhs_weap_m240_abrams|GunParticles|RHSUSF_BarrelRefract [Indent level: 2],
    ...
    # Class: CfgWeapons|rhs_weap_m240veh|manual [Indent level: 1],
    "manual": {
        "reloadtime": 0.0631,
