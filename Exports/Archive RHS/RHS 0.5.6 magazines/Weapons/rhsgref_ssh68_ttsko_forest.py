rhsgref_ssh68_ttsko_forest = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_ssh68_ttsko_forest_ca.paa",
    "dlc": "RHS_GREF",
    "scope": 2,
    "displayname": "SSh-68 TTsKO (Forest)",
    "allowedfacewear": ["G_Squares_Tinted","G_Aviator"],
    "hiddenselectionstextures": ["|rhsgref|addons|rhsgref_infantry|data_cdf|SSH68_cloth_ttskosummer_co.paa"],
    "model": "rhsgref|addons|rhsgref_infantry|gear|head|rhs_ssh68_cloth",
    "hiddenselections": ["Camo2"],
    # Class: CfgWeapons|rhsgref_ssh68|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo2"],
        "mass": 40,
        ...
        "modelsides": [3,1],
        # Class: CfgWeapons|rhsgref_ssh68|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_ssh68|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
