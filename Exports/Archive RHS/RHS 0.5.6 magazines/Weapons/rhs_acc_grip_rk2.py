rhs_acc_grip_rk2 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_grip_rk2_ca.paa",
    "dlc": "RHS_AFRF",
    "author": "Red Hammer Studios",
    "scope": 2,
    "model": "rhsafrf|addons|rhs_weapons3|acc|grips|rk2",
    "displayname": "RK-2",
    "descriptionshort": "Zenitco RK-2 grip",
    "weaponinfotype": "RHS_Grip_RK2",
    # Class: CfgWeapons|rhs_acc_grip_rk2|ItemInfo [Indent level: 1],
    "iteminfo": {
        "deployedpivot": "bipod",
        "hasbipod": 0,
        "mass": 10,
