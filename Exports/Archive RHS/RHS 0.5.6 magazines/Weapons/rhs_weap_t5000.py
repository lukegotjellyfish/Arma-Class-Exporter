rhs_weap_t5000 = {
    ...
    # Class: CfgWeapons|rhs_weap_t5000|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 132.2,
        # Class: CfgWeapons|rhs_weap_orsis_Base_F|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_orsis_Base_F|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        # Class: CfgWeapons|rhs_weap_orsis_Base_F|WeaponSlotsInfo|UnderBarrelSlot [Indent level: 2],
        "underbarrelslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
            "iconpinpoint": "Left",
            # Class: rhs_russian_rifle_underbarrel_slot|compatibleItems [Indent level: 0],
            "compatibleitems": {
    ...
    # Class: CfgWeapons|rhs_weap_t5000|ItemInfo [Indent level: 1],
    "iteminfo": {
        "priority": 1,
        "rmbhint": "T-5000",
    ...
    # Class: CfgWeapons|rhs_weap_orsis_Base_F|Library [Indent level: 1],
    "library": {
        "libtextdesc": ""
    },
    "optics": 0,
    ...
    "swaydecayspeed": 1.25,
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_orsis [Indent level: 0],
    "recoil": {
    ...
    # Class: CfgWeapons|rhs_weap_orsis_Base_F|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_orsis_Base_F|GunParticles|SecondEffect [Indent level: 2]
        "secondeffect": {
            "positionname": "Nabojnicestart",
            "directionname": "Nabojniceend",
            "effectname": "RifleAssaultCloud"
        },
        # Class: CfgWeapons|rhs_weap_orsis_Base_F|GunParticles|RHS_BarrelRefract [Indent level: 2],
        "rhs_barrelrefract": {
    ...
    # Class: CfgWeapons|rhs_weap_orsis_Base_F|Single [Indent level: 1],
    "single": {
        "reloadtime": 1.6,
        ...
        # Class: CfgWeapons|rhs_weap_orsis_Base_F|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHS_orsis_Shot_SoundSet","RHS_rifle2_Tail_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_orsis_Base_F|Single|SilencedSound [Indent level: 2],
        "silencedsound": {
    ...
    # Class: CfgWeapons|rhs_weap_orsis_Base_F|far_optic1 [Indent level: 1],
    "far_optic1": {
        "showtoplayer": 0,
        "minrange": 150,
        "minrangeprobab": 0.1,
    ...
    # Class: CfgWeapons|rhs_weap_orsis_Base_F|medium_optic2 [Indent level: 1],
    "medium_optic2": {
        "showtoplayer": 0,
        "minrange": 250,
        "minrangeprobab": 0.1,
    ...
    # Class: CfgWeapons|rhs_weap_orsis_Base_F|far_optic2 [Indent level: 1],
    "far_optic2": {
        "minrange": 500,
        "minrangeprobab": 0.1,
        "midrange": 1050,
    ...
    "muzzles": ["this","SAFE"],
    # Class: CfgWeapons|rhs_weap_orsis_Base_F|SAFE [Indent level: 1],
    "safe": {
        "showtoplayer": 0,
        "magazines": [],
        "displayname": "SAFE",
    ...
    # Class: CfgWeapons|rhs_weap_orsis_Base_F|Eventhandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhs_weap_orsis_Base_F|Eventhandlers|RHS_BoltAction [Indent level: 2]
        "rhs_boltaction": {
