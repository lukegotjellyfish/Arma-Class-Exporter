rhs_uniform_afghanka_winter_vsr_2 = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_vsr_2_ca.paa",
    "displayname": "M88 Winter (VSR 2)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_vsr_2|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_vsr_2_base",
        "uniformmodel": "-",
