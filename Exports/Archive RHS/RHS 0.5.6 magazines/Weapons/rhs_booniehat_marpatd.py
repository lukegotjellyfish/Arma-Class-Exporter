rhs_booniehat_marpatd = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhs_Booniehat_marpatd_ca.paa",
    "scope": 1,
    "displayname": "Booniehat MARPAT-D (Alt.)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|booniehat_marpatd_co"],
