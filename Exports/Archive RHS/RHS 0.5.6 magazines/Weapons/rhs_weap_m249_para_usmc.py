rhs_weap_m249_para_usmc = {
    # Class: CfgWeapons|rhs_weap_m249_para_usmc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m249_para_usmc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG2_USMC"
        },
        # Class: CfgWeapons|rhs_weap_m249_para_usmc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
