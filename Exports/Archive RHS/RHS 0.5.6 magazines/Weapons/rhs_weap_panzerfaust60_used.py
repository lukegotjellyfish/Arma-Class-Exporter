rhs_weap_panzerfaust60_used = {
    ...
    # Class: CfgWeapons|rhs_weap_panzerfaust60_used|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 70.84,
        "allowedslots": [901]
    },
    ...
    "inertia": 0.8,
    "dispersion": 0.25,
    "handanim": ["OFP2_ManSkeleton","|rhsgref|addons|rhsgref_c_weapons|anims|rhs_hand_pzf60.rtm"],
    "sounds": ["StandardSound"],
    # Class: CfgWeapons|rhs_weap_panzerfaust60|StandardSound [Indent level: 1],
    "standardsound": {
    ...
    # Class: CfgWeapons|rhs_weap_panzerfaust60|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_panzerfaust60|GunParticles|effect1 [Indent level: 2]
        "effect1": {
    ...
    "optics": 1,
    "modeloptics": "-",
    # Class: CfgWeapons|rhs_weap_panzerfaust60|OpticsModes [Indent level: 1],
    "opticsmodes": {
        # Class: CfgWeapons|rhs_weap_panzerfaust60|OpticsModes|ironsight [Indent level: 2]
        "ironsight": {
            "opticsid": 2,
            ...
            "cameradir": "eye_look",
            "discretedistancecamerapoint": ["eye_30","eye_60","eye_80"],
            "distancezoommin": 100,
            "distancezoommax": 100
        }
    },
    "baseweapon": "rhs_weap_panzerfaust60",
    # Class: CfgWeapons|rhs_weap_panzerfaust60|Eventhandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhs_weap_panzerfaust60|Eventhandlers|RHS_DisposableWeapon [Indent level: 2]
