rhs_uniform_cossack = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_cossack_ca.paa",
    "displayname": "Cossack Uniform",
    # Class: CfgWeapons|rhs_uniform_cossack|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_cossack_base",
        "uniformmodel": "-",
