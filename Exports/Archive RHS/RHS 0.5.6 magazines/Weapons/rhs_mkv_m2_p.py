rhs_mkv_m2_p = {
    "aidispersioncoefx": 7,
    "aidispersioncoefy": 9,
    # Class: CfgWeapons|RHS_MKV_M2_p|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|RHS_MKV_M2_p|GunParticles|effect1 [Indent level: 2]
        "effect1": {
            "positionname": "m2_p_muzzle",
            "directionname": "m2_p_endBarrel",
            "effectname": "MachineGunCloud"
        },
        # Class: CfgWeapons|RHS_MKV_M2_p|GunParticles|effect2 [Indent level: 2],
        "effect2": {
            "positionname": "m2_p_caseStart",
            "directionname": "m2_p_caseEnd",
            "effectname": "MachineGunEject"
        },
        # Class: CfgWeapons|RHS_MKV_M2_p|GunParticles|effect3 [Indent level: 2],
        "effect3": {
            "positionname": "m2_p_caseStart",
            "directionname": "m2_p_caseEnd",
