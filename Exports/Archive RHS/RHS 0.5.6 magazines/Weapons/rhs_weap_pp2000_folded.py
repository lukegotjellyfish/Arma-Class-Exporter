rhs_weap_pp2000_folded = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_pp2000_folded_ca.paa",
    "type": 2,
    "mass": 30.8,
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_pp2000_folded [Indent level: 0],
    "recoil": {
    ...
    "model": "rhsafrf|addons|rhs_weapons2|PP2000|rhs_PP2000_folded_pistol",
    "handanim": ["OFP2_ManSkeleton","|rhsafrf|addons|rhs_c_weapons|anims|rhs_hand_pp2000_pistol.rtm"],
    # Class: CfgWeapons|rhs_weap_pp2000_folded|SAFE_PISTOL [Indent level: 1],
    "safe_pistol": {
        "showtoplayer": 0,
        "magazines": [],
        "displayname": "SAFE",
    ...
    "descriptionshort": "PP-2000 (Folded)",
    "rhs_fold": "rhs_weap_pp2000",
    "baseweapon": "rhs_weap_pp2000_folded",
    "dlc": "RHS_AFRF",
    "scope": 2,
    "weaponinfotype": "rhs_rscOptics_pp2000",
    "magazinereloadswitchphase": 0.3,
    "initspeed": -0.97826,
    # Class: CfgWeapons|rhs_weap_pp2000|SAFE [Indent level: 1],
    "safe": {
        "showtoplayer": 0,
        "magazines": [],
        "displayname": "SAFE",
    ...
    "magazines": [
        "rhs_mag_9x19mm_7n21_20","rhs_mag_9x19mm_7n31_20","rhs_mag_9x19mm_7n21_44","rhs_mag_9x19mm_7n31_44",
    ],
    "magazinewell": ["CBA_9x19_PP2000"],
    "modes": ["Single","FullAuto"],
    # Class: CfgWeapons|rhs_weap_pp2000|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.075,
        "dispersion": 0.00203,
        "minrange": 2,
    ...
    # Class: CfgWeapons|rhs_weap_pp2000|FullAuto [Indent level: 1],
    "fullauto": {
        "reloadtime": 0.075,
        "dispersion": 0.00203,
        "minrange": 0,
    ...
    # Class: CfgWeapons|rhs_weap_pp2000|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "holsterscale": 0,
        # Class: CfgWeapons|rhs_weap_pp2000|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        },
        # Class: CfgWeapons|rhs_weap_pp2000|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            ...
            "linkproxy": "A3|data_f|proxies|weapon_slots|TOP",
            "displayname": "Optics Slot",
            # Class: rhs_picattinny_russian_rifle_scopes_slot_short|compatibleItems [Indent level: 0],
            "compatibleitems": {
        ...
        "mass": 30,
        # Class: CfgWeapons|pdw2000_base_F|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
    ...
    "dexterity": 1.8,
    # Class: CfgWeapons|hgun_PDW2000_F|ItemInfo [Indent level: 1],
    "iteminfo": {
        "priority": 2
    },
    "uipicture": "A3|Weapons_F|data|UI|icon_regular_CA.paa",
    # Class: CfgWeapons|hgun_PDW2000_F|Library [Indent level: 1],
    "library": {
