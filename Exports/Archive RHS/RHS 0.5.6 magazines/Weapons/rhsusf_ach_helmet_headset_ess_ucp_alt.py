rhsusf_ach_helmet_headset_ess_ucp_alt = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_helmet_headset_ess_ucp_alt_ca.paa",
    "displayname": "ACH UCP (Headset/ESS/Alt)",
    "hiddenselections": ["Camo","Camo1"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_ucp_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa"],
