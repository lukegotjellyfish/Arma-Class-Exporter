rhssaf_beret_blue_un = {
    ...
    # Class: CfgWeapons|rhssaf_beret_blue_un|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 6,
        ...
        # Class: CfgWeapons|rhssaf_beret_blue_un|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_beret_blue_un|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
