rhs_weap_ak74m_gp25_pso1m2 = {
    # Class: CfgWeapons|rhs_weap_ak74m_gp25_pso1m2|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak74m_gp25_pso1m2|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_pso1m2"
        },
        # Class: CfgWeapons|rhs_weap_ak74m_gp25_pso1m2|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtk"
        }
    ...
    # Class: CfgWeapons|rhs_weap_ak74m_gp25|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 107.5,
        # Class: CfgWeapons|rhs_weap_ak74m_gp25|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
