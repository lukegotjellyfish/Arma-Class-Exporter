rhsgref_6b23_ttsko_mountain_sniper = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_ttsko_mountain_sniper_ca.paa",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsgref_6b23_ttsko_mountain_sniper|ItemInfo [Indent level: 1],
    "iteminfo": {
