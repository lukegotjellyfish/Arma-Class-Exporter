rhs_weap_m240_m113 = {
    ...
    # Class: CfgWeapons|rhs_weap_m240_m113|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_m240_m113|GunParticles|M240_AmmoBeltLinkEject [Indent level: 2]
        "m240_ammobeltlinkeject": {
            "positionname": "ammobeltlinks_start",
            "directionname": "ammobeltlinks_end",
            "effectname": "MachineGunEject2"
        },
        # Class: CfgWeapons|rhs_weap_m240_m113|GunParticles|M240_AmmoBeltCaseEject [Indent level: 2],
        "m240_ammobeltcaseeject": {
            "positionname": "shelleject_start",
            "directionname": "shelleject_end",
            "effectname": "RHSUSF_762Cartridge"
        },
        # Class: CfgWeapons|rhs_weap_m240_m113|GunParticles|M240_WhiteGas [Indent level: 2],
        "m240_whitegas": {
            "positionname": "usti hlavne",
            "directionname": "konec hlavne",
            "effectname": "RifleAssaultCloud"
        },
        # Class: CfgWeapons|rhs_weap_m240_m113|GunParticles|M240_RHSUSF_BarrelRefract [Indent level: 2],
