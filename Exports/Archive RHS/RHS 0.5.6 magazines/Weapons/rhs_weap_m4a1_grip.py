rhs_weap_m4a1_grip = {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_grip|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 65,
        # Class: CfgWeapons|rhs_weap_m4a1_grip|WeaponSlotsInfo|UnderBarrelSlot [Indent level: 2],
        "underbarrelslot": {
        },
        "allowedslots": [901],
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
