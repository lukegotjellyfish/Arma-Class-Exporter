rhsgref_helmet_m1_liner = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_M1_liner_ca.paa",
    "displayname": "M1 (Liner)",
    "scope": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|M1_liner",
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|m1liner_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_M1_liner|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
        "uniformmodel": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|M1_liner",
        "allowedslots": [801,901,701,605],
        "modelsides": [6],
        # Class: CfgWeapons|rhsgref_helmet_M1_liner|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_helmet_M1_liner|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
