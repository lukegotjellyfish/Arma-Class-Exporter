rhs_acc_uuk = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_uuk_ca.paa",
    "author": "Red Hammer Studios",
    "model": "rhsafrf|addons|rhs_weapons3|acc|muzzle|ak74_uuk|rhs_ak74_uuk.p3d",
    "displayname": "AK74M UKK",
    # Class: CfgWeapons|rhs_acc_uuk|ItemInfo [Indent level: 1],
    "iteminfo": {
        "alternativefire": "rhs_muzzleflash_uuk",
        # Class: CfgWeapons|rhs_acc_uuk|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "visiblefire": 0.75,
        ...
        # Class: CfgWeapons|rhs_acc_uuk|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
