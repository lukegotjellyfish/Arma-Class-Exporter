rhsusf_opscore_paint = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_opscore_paint_ca.paa",
    "scope": 2,
    "displayname": "FAST Ballistic (Paint)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_Paint2_co.paa"],
