rhs_weap_vmf_asval = {
    # Class: CfgWeapons|rhs_weap_vmf_asval|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_vmf_asval|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_1p63"
        },
        # Class: CfgWeapons|rhs_weap_vmf_asval|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_weapons2|asval|data|asval_co.paa","rhsafrf|addons|rhs_weapons2|asval|data|mag_co.paa","rhsafrf|addons|rhs_weapons2|asval|data|grip_co.paa"],
    # Class: CfgWeapons|rhs_weap_asval_grip|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_asval_grip|WeaponSlotsInfo|MuzzleSlot [Indent level: 2]
        "muzzleslot": {
        },
        # Class: CfgWeapons|rhs_weap_asval_grip|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            # Class: CfgWeapons|rhs_weap_asval_grip|WeaponSlotsInfo|CowsSlot|compatibleItems [Indent level: 3]
            "compatibleitems": {
                "rhs_acc_pso1m2": 1,
                "rhs_acc_pso1m21": 1,
                "rhs_acc_1p29": 1,
        ...
        # Class: CfgWeapons|rhs_weap_asval_grip|WeaponSlotsInfo|GripodSlot [Indent level: 2],
        "gripodslot": {
        ...
        # Class: CfgWeapons|rhs_weap_asval_grip|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        ...
        # Class: CfgWeapons|rhs_weap_asval_grip|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
            ...
            # Class: rhs_russian_ris_side_slot|compatibleItems [Indent level: 0],
            "compatibleitems": {
    ...
    "magazines": [
        "rhs_20rnd_9x39mm_sp5","rhs_20rnd_9x39mm_sp6","rhs_10rnd_9x39mm_sp5","rhs_10rnd_9x39mm_sp6",
    ],
