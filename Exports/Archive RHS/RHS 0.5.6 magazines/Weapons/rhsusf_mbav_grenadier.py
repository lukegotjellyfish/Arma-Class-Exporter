rhsusf_mbav_grenadier = {
    ...
    # Class: CfgWeapons|rhsusf_mbav_grenadier|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry2|gear|vests|mbav|mbav_grenadier",
        "containerclass": "Supply150",
        # Class: CfgWeapons|rhsusf_mbav_grenadier|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_mbav_grenadier|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
                "hitpointname": "HitChest",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_mbav_grenadier|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_mbav_grenadier|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
