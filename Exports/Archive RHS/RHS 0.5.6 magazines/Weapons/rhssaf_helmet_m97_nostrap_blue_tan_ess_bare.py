rhssaf_helmet_m97_nostrap_blue_tan_ess_bare = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "displayname": "M97 (Blue/UN/Tan ESS/Bare)",
    ...
    # Class: CfgWeapons|rhssaf_helmet_m97_nostrap_blue_tan_ess_bare|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
        ...
        "modelsides": [6],
        "hiddenselections": ["camo","camo2"],
        # Class: CfgWeapons|rhssaf_helmet_m97_nostrap_blue_tan_ess_bare|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_helmet_m97_nostrap_blue_tan_ess_bare|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
