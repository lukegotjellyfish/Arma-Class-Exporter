lerca_1200_black = {
    "scope": 1,
    "scopearsenal": 0,
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_bino_lerca_1200_black_ca.paa",
    "author": "Red Hammer Studios",
    "dlc": "RHS_USAF",
    "displayname": "Lerca 1200 Rangefinder (Black)",
    # Class: CfgWeapons|rhsusf_bino_lerca_1200_black|Library [Indent level: 1],
    "library": {
    ...
    "visionmode": ["Normal"],
    # Class: CfgWeapons|rhsusf_bino_lerca_1200_black|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 20
    },
