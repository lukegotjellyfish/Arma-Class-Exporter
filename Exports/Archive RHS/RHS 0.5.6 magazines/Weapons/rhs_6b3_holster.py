rhs_6b3_holster = {
    ...
    # Class: CfgWeapons|rhs_6b3_holster|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsafrf|addons|rhs_infantry3|gear|vests|rhs_6b3_holster",
        "containerclass": "Supply90",
        "mass": 55,
        "hiddenselections": ["Camo","Camo1","Camo2"],
        # Class: CfgWeapons|rhs_6b3|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_6b3|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
            ...
            # Class: CfgWeapons|rhs_6b3|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
            ...
            # Class: CfgWeapons|rhs_6b3|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
            ...
            # Class: CfgWeapons|rhs_6b3|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
