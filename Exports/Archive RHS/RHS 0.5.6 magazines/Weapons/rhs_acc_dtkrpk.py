rhs_acc_dtkrpk = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_dtkrpk_ca.paa",
    "author": "Red Hammer Studios",
    "model": "rhsafrf|addons|rhs_weapons3|acc|muzzle|dtkrpk|dtk_rpk.p3d",
    "displayname": "ShhPG RPK-74",
    # Class: CfgWeapons|rhs_acc_dtkrpk|ItemInfo [Indent level: 1],
    "iteminfo": {
        "alternativefire": "rhs_muzzleflash_uuk",
        # Class: CfgWeapons|rhs_acc_dtkrpk|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "visiblefire": 0.8,
            "visiblefiretime": 0.8,
            "hit": 1,
        ...
        # Class: CfgWeapons|rhs_acc_dtkrpk|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
