rhs_weap_dazzler = {
    ...
    "reloadtime": 20,
    "modes": ["Single","Continuos"],
    # Class: CfgWeapons|rhs_weap_smokegen|Single [Indent level: 1],
    "single": {
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_smokegen|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": [],
            "soundbegin": [],
            "weaponsoundeffect": ""
    ...
    # Class: CfgWeapons|rhs_weap_smokegen|Continuos [Indent level: 1],
    "continuos": {
