rhsgref_helmet_pasgt_press = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_pasgt_press_ca.paa",
    "displayname": "PASGT (Press)",
    "scope": 2,
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|pasgt_helmet_press_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_pasgt_press|ItemInfo [Indent level: 1],
    "iteminfo": {
