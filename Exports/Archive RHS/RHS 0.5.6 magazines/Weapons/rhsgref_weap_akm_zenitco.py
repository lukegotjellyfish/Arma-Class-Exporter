rhsgref_weap_akm_zenitco = {
    # Class: CfgWeapons|rhsgref_weap_akm_zenitco|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhsgref_weap_akm_zenitco|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtkakm"
        },
        # Class: CfgWeapons|rhsgref_weap_akm_zenitco|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
            "slot": "GripodSlot",
