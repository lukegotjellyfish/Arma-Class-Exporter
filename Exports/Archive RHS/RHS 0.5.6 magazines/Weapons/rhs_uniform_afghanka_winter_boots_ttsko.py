rhs_uniform_afghanka_winter_boots_ttsko = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_boots_ttsko_ca.paa",
    "displayname": "M88 Winter Sapogi (TTsKO)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_boots_ttsko|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_boots_ttsko_base",
        "uniformmodel": "-",
