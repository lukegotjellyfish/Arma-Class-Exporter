rhsgref_uniform_tigerstripe = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|uniform|rhsgref_uniform_tigerstripe_ca.paa",
    "scope": 2,
    "dlc": "RHS_GREF",
    "displayname": "M93 (Tiger Stripe)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_blufor_diver",
    # Class: CfgWeapons|rhsgref_uniform_tigerstripe|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
