rhsgref_helmet_m1942_heermarshcover = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1942_heermarshcover_ca.paa",
    "displayname": "M42 Covered (Sumpf 44)",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|M1942_heercoversummer",
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1942cover_hbt_sumpf44_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_m1942_heermarshcover|ItemInfo [Indent level: 1],
    "iteminfo": {
