rhsusf_acc_acog_mdo = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_ACOG_MDO_ca.paa",
    ...
    "inertia": 0.4,
    # Class: CfgWeapons|rhsusf_acc_ACOG_MDO|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 2,
        "mass": 11,
        "rmbhint": "MDO",
        ...
        # Class: CfgWeapons|rhsusf_acc_ACOG_MDO|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_ACOG_MDO|ItemInfo|OpticsModes|RMR [Indent level: 3]
            "rmr": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
            ...
            # Class: CfgWeapons|rhsusf_acc_ACOG_MDO|ItemInfo|OpticsModes|ACOGMDO [Indent level: 3],
            "acogmdo": {
                "opticsid": 1,
                "usemodeloptics": 1,
