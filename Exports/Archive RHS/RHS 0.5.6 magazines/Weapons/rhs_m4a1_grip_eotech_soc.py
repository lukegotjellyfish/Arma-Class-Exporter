rhs_m4a1_grip_eotech_soc = {
    # Class: CfgWeapons|rhs_m4a1_grip_eotech_soc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4a1_grip_eotech_soc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_eotech_xps3"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_eotech_soc|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15_top"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_eotech_soc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
            "slot": "UnderBarrelSlot",
            "item": "rhsusf_acc_rvg_blk"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_eotech_soc|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
