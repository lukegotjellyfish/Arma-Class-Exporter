rhsusf_acc_nxs_3515x50f1_md = {
    ...
    # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_md|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_15xf1_mildot",
        # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_md|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_md|ItemInfo|OpticsModes|nxs_scope [Indent level: 3]
            "nxs_scope": {
