rhs_weap_45th_akm = {
    # Class: CfgWeapons|rhs_weap_45th_akm|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_45th_akm|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_pbs1"
        }
    ...
    # Class: CfgWeapons|rhs_weap_akm|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 69.08,
