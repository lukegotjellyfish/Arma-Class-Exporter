rhsusf_weap_m257_8 = {
    # Compatible Magazines: magazines parameter (+ inherited)    "magazines": [        "rhsusf_mag_l8a3_8",],
    "modes": ["Double","Volley"],
    ...
    # Class: CfgWeapons|rhsusf_weap_M257_8|Volley [Indent level: 1],
    "volley": {
        "burst": 8,
        "displayname": "M257 (8)",
        "reloadtime": 0.099,
    ...
    # Class: CfgWeapons|rhsusf_weap_M257_8|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M257_8|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "_this call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
