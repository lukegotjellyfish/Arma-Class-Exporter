rhs_weap_m14_bipod_m8541 = {
    # Class: CfgWeapons|rhs_weap_m14_bipod_M8541|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m14_bipod_M8541|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_M8541_low"
        },
        # Class: CfgWeapons|rhs_weap_m14_bipod_M8541|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_m14_rail_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 95.2,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_m14_rail_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            # Class: CfgWeapons|rhs_weap_m14_rail_base|WeaponSlotsInfo|CowsSlot|compatibleItems [Indent level: 3]
            "compatibleitems": {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons3|m14|data|m14_base_co.paa"],
    "htmin": 1,
    "htmax": 420,
    "afmax": 0,
    "mfmax": 0,
