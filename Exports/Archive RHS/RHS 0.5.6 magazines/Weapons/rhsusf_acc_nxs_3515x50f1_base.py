rhsusf_acc_nxs_3515x50f1_base = {
    "scope": 1,
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_nxs_3515x50_md_ca.paa",
    "dlc": "RHS_USAF",
    "author": "Red Hammer Studios",
    "displayname": "NXS 3.5-15x50 F1",
    "model": "rhsusf|addons|rhsusf_scopes|nf|rhs_nxs_3515x50",
    "descriptionshort": "Reticle: First focal plane<br />Magnification: 3.5-15x",
    "weaponinfotype": "RscWeaponZeroing",
    "inertia": 0.2,
    # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 2,
        "mass": 8,
        ...
        # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_base|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_base|ItemInfo|OpticsModes|nxs_scope [Indent level: 3]
            "nxs_scope": {
                "opticsid": 1,
                "usemodeloptics": 1,
                ...
                "discreteinitindex": 0,
                "modeloptics": ["|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_3-5xf1_mildot","|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_6xf1_mildot","|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_9xf1_mildot","|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_12xf1_mildot","|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_15xf1_mildot"],
