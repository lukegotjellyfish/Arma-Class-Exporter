rhs_weap_m14_socom_rail_base = {
    "model": "rhsusf|addons|rhsusf_weapons3|M14|RHS_M14_SOCOM_RAIL.p3d",
    "displayname": "SOCOM 16 (Rail)",
    # Class: CfgWeapons|rhs_weap_m14_socom_rail_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 83.2,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_m14_socom_rail_base|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_m14_socom_rail_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            # Class: CfgWeapons|rhs_weap_m14_socom_rail_base|WeaponSlotsInfo|CowsSlot|compatibleItems [Indent level: 3]
            "compatibleitems": {
        ...
        # Class: CfgWeapons|rhs_weap_m14_base|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
            "iconpinpoint": "Left",
            # Class: rhs_western_m14_muzzle_slot|compatibleItems [Indent level: 0],
            "compatibleitems": {
        ...
        # Class: CfgWeapons|rhs_weap_m14_base|WeaponSlotsInfo|UnderBarrelSlot [Indent level: 2],
        "underbarrelslot": {
            # Class: rhs_western_m14_underbarrel_slot|compatibleItems [Indent level: 0]
            "compatibleitems": {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons3|m14|data|m14_socom_co.paa"],
    "initspeed": -0.97,
    "inertia": 0.4,
    # Class: CfgWeapons|rhs_weap_m14_socom_base|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m14_socom_base|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "slot": "MuzzleSlot",
            "item": "rhsusf_acc_m14_flashsuppresor"
        }
    },
    # Class: CfgWeapons|rhs_weap_m14_socom_base|Single [Indent level: 1],
    "single": {
        "dispersion": 0.00075,
        ...
        # Class: CfgWeapons|rhs_weap_m14_base|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHSUSF_m14_Shot_SoundSet","RHSUSF_rifle2_Tail_SoundSet","RHSUSF_m14_stereoLayer_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_m14_base|Single|SilencedSound [Indent level: 2],
        "silencedsound": {
    ...
    # Class: CfgWeapons|rhs_weap_m14_socom_base|FullAuto [Indent level: 1],
    "fullauto": {
        "dispersion": 0.00075,
        "reloadtime": 0.0827586,
        "minrange": 0,
    ...
    "handanim": ["OFP2_ManSkeleton","rhsusf|addons|rhsusf_c_weapons|anims|rhs_hand_m14.rtm"],
    "magazinereloadswitchphase": 0.33,
    # Compatible Magazines: magazines parameter (+ inherited),
    "magazines": [
        "rhsusf_20rnd_762x51_m80_mag","rhsusf_20rnd_762x51_m118_special_mag","rhsusf_20rnd_762x51_m993_mag","rhsusf_20rnd_762x51_m62_mag",
    ...
    "reloadtime": 2,
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_m14 [Indent level: 0],
    "recoil": {
        "muzzleouter": [0.5,2.1,0.7,0.5],
        "kickback": [0.05,0.09],
        "permanent": 0.02,
        "temporary": 0.01,
    ...
    # Class: CfgWeapons|rhs_weap_m14_base|single_close_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_m14_base|single_medium_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_m14_base|single_far_optics1 [Indent level: 1],
    "single_far_optics1": {
        "requiredoptictype": 2,
        "minrange": 300,
        "minrangeprobab": 0.05,
