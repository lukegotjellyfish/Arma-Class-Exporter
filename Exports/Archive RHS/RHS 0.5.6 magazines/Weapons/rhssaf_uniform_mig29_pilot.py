rhssaf_uniform_mig29_pilot = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "picture": "rhssaf|addons|rhssaf_inventoryicons|data|uniform|rhssaf_uniform_mig29_pilot_ca.paa",
    "displayname": "DF-15 (MIG29)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_universal_F.p3d",
    "hiddenselections": ["camo1"],
    "hiddenselectionstextures": ["|rhssaf|addons|rhssaf_t_uniform_pilot|data|rhssaf_pilot_co_mig29.paa"],
    # Class: CfgWeapons|rhssaf_uniform_mig29_pilot|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
