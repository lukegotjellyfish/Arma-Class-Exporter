rhs_weap_m16a4_grip_acog = {
    # Class: CfgWeapons|rhs_weap_m16a4_grip_acog|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m16a4_grip_acog|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG3"
        },
        # Class: CfgWeapons|rhs_weap_m16a4_grip_acog|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15_top"
        },
        # Class: CfgWeapons|rhs_weap_m16a4_grip_acog|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_m16a4_grip|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 74.8,
