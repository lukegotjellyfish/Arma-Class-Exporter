rhs_acc_dtk3 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_dtk3_ca.paa",
    "author": "Red Hammer Studios",
    "scope": 2,
    "model": "rhsafrf|addons|rhs_weapons|acc|muzzle|dtk3|dtk3.p3d",
    "displayname": "DTK-3",
    # Class: CfgWeapons|rhs_acc_dtk3|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 5,
        "soundtypeindex": 0,
        ...
        # Class: CfgWeapons|rhs_acc_dtk3|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
