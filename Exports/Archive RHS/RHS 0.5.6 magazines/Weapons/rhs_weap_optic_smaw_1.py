rhs_weap_optic_smaw_1 = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_weap_optic_smaw_1|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_1|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_1|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 50,
                "distancezoommax": 50,
                "discreteinitindex": 0,
