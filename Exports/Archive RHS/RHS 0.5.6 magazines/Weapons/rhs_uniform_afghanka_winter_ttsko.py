rhs_uniform_afghanka_winter_ttsko = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_ttsko_ca.paa",
    "displayname": "M88 Winter (TTsKO)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_ttsko|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_ttsko_base",
        "uniformmodel": "-",
