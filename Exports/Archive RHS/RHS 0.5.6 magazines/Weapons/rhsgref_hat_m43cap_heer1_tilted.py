rhsgref_hat_m43cap_heer1_tilted = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_hat_m43cap_heer1_tilted_ca.paa",
    "displayname": "M43 Cap (Tilted)",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|m43cap_tilted",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m43_heer1_co.paa"],
    # Class: CfgWeapons|rhsgref_hat_m43cap_heer1_tilted|ItemInfo [Indent level: 1],
    "iteminfo": {
