rhsusf_mich_helmet_marpatd_norotos = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry|gear|head|data|mich_covered_norotos_des_co.paa","rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_od_co.paa"],
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_01_nor1",
    # Class: CfgWeapons|rhsusf_mich_helmet_marpatwd_norotos|ItemInfo [Indent level: 1],
    "iteminfo": {
