rhsusf_plateframe_teamleader = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|vests|rhsusf_plateframe_teamleader_ca.paa",
    "displayname": "Plateframe (Teamleader)",
    "author": "Red Hammer Studios",
    "model": "rhsusf|addons|rhsusf_infantry2|gear|vests|plateframe|rhs_plateframe_sapi_teamleader",
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry2|gear|vests|plateframe|data|rhs_plateframe_sapi_tan_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_spc_gear1_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_spc_gear2_co.paa","rhsusf|addons|rhsusf_infantry2|gear|vests|mbav|data|mbav_gear_co.paa","rhsusf|addons|rhsusf_infantry|gear|vests|data|rhs_vest_iotv2_co.paa","rhsusf|addons|rhsusf_weapons|mag_proxies|data|rhs_30rn_usgi_alum_co.paa","rhsusf|addons|rhsusf_weapons|mag_proxies|data|rhs_30rn_magpul_drab_co.paa","rhsusf|addons|rhsusf_weapons3|mk17|data|mk17_co.paa"],
    # Class: CfgWeapons|rhsusf_plateframe_teamleader|ItemInfo [Indent level: 1],
    "iteminfo": {
