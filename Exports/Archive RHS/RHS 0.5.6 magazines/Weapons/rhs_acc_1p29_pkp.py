rhs_acc_1p29_pkp = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_acc_1p29_pkp|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_1p29_pkp|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_1p29_pkp|ItemInfo|OpticsModes|rhs_1p29_scope [Indent level: 3]
            "rhs_1p29_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_1p29_pkp|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
