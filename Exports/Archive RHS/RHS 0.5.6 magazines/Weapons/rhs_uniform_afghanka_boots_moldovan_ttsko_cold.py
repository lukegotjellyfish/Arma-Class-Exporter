rhs_uniform_afghanka_boots_moldovan_ttsko_cold = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_boots_moldovan_ttsko_cold_ca.paa",
    "displayname": "M88 Sapogi (Moldovan TTsKO Cold)",
    # Class: CfgWeapons|rhs_uniform_afghanka_boots_moldovan_ttsko_cold|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_boots_moldovan_ttsko_cold_base",
        "uniformmodel": "-",
