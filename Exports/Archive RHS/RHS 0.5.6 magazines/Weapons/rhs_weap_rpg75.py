rhs_weap_rpg75 = {
    ...
    # Class: CfgWeapons|rhs_weap_rpg75|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_rpg75|GunParticles|effect1 [Indent level: 2]
        "effect1": {
    ...
    "magazines": ["rhs_rpg75_mag"],
    "reloadaction": "ReloadRPG",
    "handanim": ["OFP2_ManSkeleton","|rhsgref|addons|rhsgref_c_weapons|anims|rhs_hand_rpg75.rtm"],
    "sounds": ["StandardSound"],
    # Class: CfgWeapons|rhs_weap_rpg75|StandardSound [Indent level: 1],
    "standardsound": {
    ...
    "optics": 1,
    # Class: CfgWeapons|rhs_weap_rpg75|OpticsModes [Indent level: 1],
    "opticsmodes": {
        # Class: CfgWeapons|rhs_weap_rpg75|OpticsModes|ironsight [Indent level: 2]
        "ironsight": {
            "opticsid": 2,
            "opticsppeffects": ["OpticsCHAbera1","WeaponsOptics"],
            "usemodeloptics": 0,
            "opticsflare": 0,
    ...
    # Class: CfgWeapons|rhs_weap_rpg75|Library [Indent level: 1],
    "library": {
        "libtextdesc": "The RPG-75 is a portable, disposable, single-shot anti-tank weapon, developed in the 1970s in Czechoslovakia."
    },
    # Class: CfgWeapons|rhs_weap_rpg75|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "allowedslots": [901],
        "mass": 70.4
    },
    # Class: CfgWeapons|rhs_weap_rpg75|ItemInfo [Indent level: 1],
    "iteminfo": {
        "priority": 3,
        "rmbhint": "RPG-26",
        "onhovertext": "RPG-26"
    },
    # Class: CfgWeapons|rhs_weap_rpg75|Eventhandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhs_weap_rpg75|Eventhandlers|RHS_DisposableWeapon [Indent level: 2]
    ...
    "reloadmagazinesound": ["A3|sounds_f|weapons|rockets|titan_reload_final",0.562341,1,20],
