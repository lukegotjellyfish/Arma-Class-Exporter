rhs_acc_ak5 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_ak5_ca.paa",
    "author": "Red Hammer Studios",
    "model": "rhsafrf|addons|rhs_weapons|acc|muzzle|ak5|ak5.p3d",
    "displayname": "DPM-AK-5",
    # Class: CfgWeapons|rhs_acc_ak5|ItemInfo [Indent level: 1],
    "iteminfo": {
        "alternativefire": "rhs_muzzleFlash_ak5",
        # Class: CfgWeapons|rhs_acc_ak5|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "visiblefire": 0.25,
            "visiblefiretime": 0.45,
            "hit": 1,
            "typicalspeed": 1,
            "airfriction": 1,
            "audiblefire": 1,
        ...
        # Class: CfgWeapons|rhs_acc_ak5|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "dispersioncoef": 0.97,
            "firelightcoef": 0.09,
            "recoilcoef": 0.89,
            "recoilpronecoef": 0.89,
