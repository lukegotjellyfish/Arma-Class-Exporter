rhs_acc_pkas_pkp = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_acc_pkas_pkp|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_pkas_pkp|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pkas_pkp|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
            ...
            # Class: CfgWeapons|rhs_acc_pkas_pkp|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "memorypointcamera": "eye_pkp",
                "discretedistance": [420,100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500],
                "discretedistancecamerapoint": ["eye_pkp","eye_pkp_100","eye_pkp_200","eye_pkp_300","eye_pkp_400","eye_pkp_500","eye_pkp_600","eye_pkp_700","eye_pkp_800","eye_pkp_900","eye_pkp_1000","eye_pkp_1100","eye_pkp_1200","eye_pkp_1300","eye_pkp_1400","eye_pkp_1500"],
                "distancezoommin": 100,
                "distancezoommax": 1500,
                "cameradir": "eye_pkp_look",
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
                "opticszoommin": 0.25,
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_pkas_ca.paa",
    "displayname": "PK-AS",
    "model": "rhsafrf|addons|rhs_weapons|acc|scopes|pkas|rhs_pkas",
    "descriptionshort": "Collimator Sight<br />Magnification: 1x",
    "weaponinfotype": "rhs_rscOptics_acc_pkas",
    "inertia": 0.1,
    "dlc": "RHS_AFRF",
    "muzzles": [],
