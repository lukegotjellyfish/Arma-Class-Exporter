rhs_weap_u5ts = {
    "scope": 2,
    "displayname": "2A20",
    "sound": ["|rhsafrf|addons|rhs_c_heavyweapons|sounds|rhs_s_u5ts.ogg",2.51189,1,1500],
    "reloadsound": ["|rhsafrf|addons|rhs_c_heavyweapons|sounds|rhs_s_u5ts_reload.ogg",1,1],
    # Compatible Magazines: magazines parameter (+ inherited),
    "magazines": [
        "rhs_mag_bm4_15","rhs_mag_of11_20","rhs_mag_of28_20","rhs_mag_bk4_5",
        "rhs_mag_bk15_5","rhs_mag_bm23_15","rhs_mag_9m118_3",],
    "magazinewell": [],
    "reloadtime": 12,
    "magazinereloadtime": 8.5,
    # Class: CfgWeapons|rhs_weap_u5ts|gunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_u5ts|gunParticles|Effect [Indent level: 2]
        "effect": {
