rhs_weap_akms_folded = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_akms_folded_ca.paa",
    "scope": 1,
    "scopearsenal": 0,
    "displayname": "AKMS (Folded)",
    "model": "rhsafrf|addons|rhs_weapons|akm|rhs_akms_folded",
    ...
    # Class: CfgWeapons|rhs_weap_akms_folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 54.45,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_akm|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_akm|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_akm|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        # Class: CfgWeapons|rhs_weap_akm|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
    ...
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_akms_folded [Indent level: 0],
    "recoil": {
    ...
    "weaponinfotype": "rhs_rscOptics_akms",
