rhsusf_acc_premier_anpvs27 = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_premier_anpvs27_ca.paa",
    "displayname": "M8541A + AN/PVS-27",
    "scope": 2,
    "author": "Red Hammer Studios",
    "weaponinfotype": "RscWeaponZeroing",
    "model": "rhsusf|addons|rhsusf_weapons|acc|scopes|PVS27|PVS_27_M8451A",
    # Class: CfgWeapons|rhsusf_acc_premier_anpvs27|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 2,
        "mass": 14,
        ...
        # Class: CfgWeapons|rhsusf_acc_premier_anpvs27|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_premier_anpvs27|ItemInfo|OpticsModes|pso1_nvg [Indent level: 3]
            "pso1_nvg": {
                "opticsid": 2,
                "usemodeloptics": 1,
