rhs_6b26_digi_bala = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_6b26_digi_bala_ca.paa",
    "allowedfacewear": [],
    "displayname": "6B26 EMR-Summer (Balaclava)",
    "model": "rhsafrf|addons|rhs_infantry|gear|head|rhs_6b26_bala",
    # Class: CfgWeapons|rhs_6b26_digi_bala|ItemInfo [Indent level: 1],
    "iteminfo": {
