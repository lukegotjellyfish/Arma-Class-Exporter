rhs_acc_pso1m21_ads_night = {
    "model": "rhsafrf|addons|rhs_weapons|acc|scopes|pso1m21|rhs_pso1m21_ads_night",
    "author": "Red Hammer Studios",
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_acc_pso1m21_ads|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_pso1m21_ads|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pso1m21_ads|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
                "usemodeloptics": 0,
                ...
                "discretedistanceinitindex": "(missionNameSpace getVariable ['rhs_acc_pso_index',3]) min 16 max 0",
            ...
            # Class: CfgWeapons|rhs_acc_pso1m21_ads|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
