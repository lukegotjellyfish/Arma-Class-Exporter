rhs_6sh117_mg = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|vests|rhs_6sh117_mg_ca.paa",
    "dlc": "RHS_AFRF",
    "displayname": "6Sh117 (Machine Gunner)",
    "model": "rhsafrf|addons|rhs_infantry3|ratnik|rhs_emr_6sh117_PK",
    "hiddenselections": ["Camo","Camo1","Camo2"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|ratnik|data|6sh117_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|pouchs_117_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|pouchs_118_co.paa"],
    # Class: CfgWeapons|rhs_6sh117_mg|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo","Camo1","Camo2"],
