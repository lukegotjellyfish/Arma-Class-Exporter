rhs_weap_pkp_1p63 = {
    "scope": 1,
    # Class: CfgWeapons|rhs_weap_pkp_1p63|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_pkp_1p63|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_1p63"
        }
    ...
    # Class: CfgWeapons|rhs_weap_pkp|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 191.4,
        # Class: CfgWeapons|rhs_pkp_base|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        },
        # Class: CfgWeapons|rhs_pkp_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_pkp_base|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        "allowedslots": []
    },
    ...
    "magazines": [
        "rhs_100rnd_762x54mmr","rhs_100rnd_762x54mmr_green","rhs_100rnd_762x54mmr_7n13","rhs_100rnd_762x54mmr_7n26",
    ...
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_pkm [Indent level: 0],
    "recoil": {
    ...
    # Class: CfgWeapons|rhs_pkp_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "priority": 1,
        "rmbhint": "PKP",
        "onhovertext": "TODO PKP DSS"
    },
    # Class: CfgWeapons|rhs_pkp_base|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_pkp_base|GunParticles|SecondEffect [Indent level: 2]
        "secondeffect": {
            "positionname": "Nabojnicestart",
            "directionname": "Nabojniceend",
            "effectname": "CaselessAmmoCloud"
        },
        # Class: CfgWeapons|rhs_pkp_base|GunParticles|RHS_BarrelRefract [Indent level: 2],
        "rhs_barrelrefract": {
    ...
    # Class: CfgWeapons|rhs_pkp_base|SAFE [Indent level: 1],
    "safe": {
        "showtoplayer": 0,
        "magazines": [],
        "displayname": "SAFE",
    ...
    "cameradir": "eye_look",
    "maxzeroing": 1500,
    # Class: CfgWeapons|rhs_pkp_base|FullAuto [Indent level: 1],
    "fullauto": {
        "reloadtime": 0.092,
    ...
    # Class: CfgWeapons|rhs_pkp_base|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.092,
        "dispersion": 0.00101,
        "autofire": 0,
    ...
    # Class: CfgWeapons|rhs_pkp_base|close [Indent level: 1],
    "close": {
        "burst": 6,
        "burstrangemax": 12,
        "airateoffire": 0.5,
    ...
    # Class: CfgWeapons|rhs_pkp_base|short [Indent level: 1],
    "short": {
        "burst": 5,
        "burstrangemax": 10,
        "airateoffire": 2,
    ...
    # Class: CfgWeapons|rhs_pkp_base|medium [Indent level: 1],
    "medium": {
        "burst": 4,
        "burstrangemax": 8,
        "airateoffire": 4,
    ...
    # Class: CfgWeapons|rhs_pkp_base|far_optic1 [Indent level: 1],
    "far_optic1": {
        "requiredoptictype": 1,
        "showtoplayer": 0,
        "burst": 3,
    ...
    # Class: CfgWeapons|rhs_pkp_base|far_optic2 [Indent level: 1],
    "far_optic2": {
        "requiredoptictype": 2,
        "autofire": 0,
        "burst": 2,
    ...
    # Class: CfgWeapons|rhs_pkp_base|Eventhandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhs_pkp_base|Eventhandlers|RHS_pk_firedSoundHandler [Indent level: 2]
