rhsusf_mich_bare_tan_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_tan_headset_ca.paa",
    "displayname": "MICH 2000 (Tan/Headset)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_bare_01_bowman",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_tan_rhino_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_tan_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|bowman_base_co.paa"],
    # Class: CfgWeapons|rhsusf_mich_bare_tan_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
