rhs_weap_sr25_sup_marsoc = {
    # Class: CfgWeapons|rhs_weap_sr25_sup_marsoc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_sr25_sup_marsoc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_premier"
        },
        # Class: CfgWeapons|rhs_weap_sr25_sup_marsoc|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhsusf_acc_aac_762sdn6_silencer"
        },
        # Class: CfgWeapons|rhs_weap_sr25_sup_marsoc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_sr25_ec|Library [Indent level: 1],
    "library": {
    ...
    # Class: CfgWeapons|rhs_weap_sr25_ec|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 84.92,
        # Class: CfgWeapons|rhs_weap_sr25_ec|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
