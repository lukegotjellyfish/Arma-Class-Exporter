rhsusf_cvc_green_helmet = {
    ...
    "allowedfacewear": ["",5,"rhs_ess_black",2,"rhs_googles_black",2,"rhs_googles_clear",1,"rhsusf_shemagh2_od",3,"rhsusf_shemagh2_gogg_od",5],
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry2|gear|head|cvc|data|rhs_cvc_green_co.paa"],
    "scope": 2,
