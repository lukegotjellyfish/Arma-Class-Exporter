rhs_weap_optic_smaw_3 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_3|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_3|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_3|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 150,
                "distancezoommax": 150,
                "discreteinitindex": 2,
