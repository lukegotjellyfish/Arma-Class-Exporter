rhsusf_acc_nxs_3515x50f1_h58 = {
    ...
    "displayname": "NXS 3.5-15x50 F1 (H58)",
    "descriptionshort": "Reticle: First focal plane H58<br />Magnification: 3.5-15x",
    # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_h58|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_15xf1_h58",
        # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_h58|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_nxs_3515x50f1_h58|ItemInfo|OpticsModes|nxs_scope [Indent level: 3]
            "nxs_scope": {
                "modeloptics": ["|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_3-5xf1_h58","|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_6xf1_h58","|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_9xf1_h58","|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_12xf1_h58","|rhsusf|addons|rhsusf_scopes|optics|nf|f1|rhsusf_nxs_15xf1_h58"],
                "opticsid": 1,
                "usemodeloptics": 1,
                ...
                "discretefov": ["0.25/3.5","0.25/6","0.25/9","0.25/12","0.25/15"],
                "discreteinitindex": 0,
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_nxs_3515x50_md_ca.paa",
    "model": "rhsusf|addons|rhsusf_scopes|nf|rhs_nxs_3515x50",
