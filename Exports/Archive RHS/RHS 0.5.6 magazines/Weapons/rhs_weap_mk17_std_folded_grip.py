rhs_weap_mk17_std_folded_grip = {
    ...
    # Class: CfgWeapons|rhs_weap_mk17_STD_Folded_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk17_STD_Folded_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip1",
            "slot": "UnderBarrelSlot"
        }
    },
    "rhs_fold": "rhs_weap_mk17_STD_grip",
    "scope": 1,
    ...
    # Class: CfgWeapons|rhs_weap_mk17_STD_Folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 76.78,
