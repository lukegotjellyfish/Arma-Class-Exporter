rhs_weap_aks74un_folded = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_aks74un_folded_ca.paa",
    "displayname": "AKS-74UN (Folded)",
    "model": "rhsafrf|addons|rhs_weapons2|aks74u|rhs_aks74un_folded",
    ...
    "scope": 1,
    "inertia": 0.28,
    # Class: CfgWeapons|rhs_weap_aks74un_folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 45.465,
        # Class: CfgWeapons|rhs_weap_aks74un_folded|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
            "iconpinpoint": "Left",
            # Class: rhs_russian_aks74u_muzzle_slot|compatibleItems [Indent level: 0],
            "compatibleitems": {
                "rhs_acc_pgs64_74u": 1,
        ...
        # Class: CfgWeapons|rhs_weap_aks74un_folded|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_aks74un_folded|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        # Class: CfgWeapons|rhs_weap_aks74un_folded|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        "allowedslots": [901]
    },
    "rhs_fold": "rhs_weap_aks74un",
    "rhs_fold_anim": "RHS_GestureUnfoldAK74M",
    "baseweapon": "rhs_weap_aks74un_folded",
    "hiddenselections": ["camo1","camo2"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_weapons2|aks74u|data|rhs_aks74un_co.paa","rhsafrf|addons|rhs_weapons2|aks74u|data|rhs_aks74u_plum_co.paa"],
    "weaponinfotype": "rhs_rscOptics_aks74un",
    # Class: CfgWeapons|rhs_weap_aks74un|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_aks74un|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
    ...
    # Class: CfgWeapons|rhs_weap_aks74u|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.0923,
    ...
    # Class: CfgWeapons|rhs_weap_aks74u|FullAuto [Indent level: 1],
    "fullauto": {
        "reloadtime": 0.0923,
        "dispersion": 0.0017454,
        "minrange": 0,
    ...
    # Class: CfgWeapons|rhs_weap_aks74u|single_medium_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_aks74u|single_far_optics2 [Indent level: 1],
    "single_far_optics2": {
        "requiredoptictype": 2,
        "showtoplayer": 0,
        "minrange": 2,
    ...
    # Class: CfgWeapons|rhs_weap_aks74u|fullauto_medium [Indent level: 1],
    "fullauto_medium": {
        "showtoplayer": 0,
        "burst": 2,
        "burstrangemax": 5,
