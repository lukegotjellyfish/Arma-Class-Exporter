rhs_weap_grad = {
    ...
    # Class: CfgWeapons|rhs_weap_grad|Mode_1 [Indent level: 1],
    "mode_1": {
    ...
    # Class: CfgWeapons|rhs_weap_grad|Mode_2 [Indent level: 1],
    "mode_2": {
    ...
    # Class: CfgWeapons|rhs_weap_grad|Mode_3 [Indent level: 1],
    "mode_3": {
    ...
    # Class: CfgWeapons|rhs_weap_grad|Mode_4 [Indent level: 1],
    "mode_4": {
    ...
    # Class: CfgWeapons|rhs_weap_grad|Mode_5 [Indent level: 1],
    "mode_5": {
    ...
    # Class: CfgWeapons|rhs_weap_grad|Mode_6 [Indent level: 1],
    "mode_6": {
