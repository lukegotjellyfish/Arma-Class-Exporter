rhsgref_helmet_pasgt_flecktarn = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_pasgt_flecktarn_ca.paa",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsgref_helmet_pasgt_flecktarn|ItemInfo [Indent level: 1],
    "iteminfo": {
