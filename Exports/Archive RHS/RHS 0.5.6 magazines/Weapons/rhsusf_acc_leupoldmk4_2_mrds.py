rhsusf_acc_leupoldmk4_2_mrds = {
    ...
    # Class: CfgWeapons|rhsusf_acc_LEUPOLDMK4_2_mrds|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 9,
        # Class: CfgWeapons|rhsusf_acc_LEUPOLDMK4_2_mrds|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_LEUPOLDMK4_2_mrds|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhsusf_acc_LEUPOLDMK4_2_mrds|ItemInfo|OpticsModes|Mrds [Indent level: 3],
            "mrds": {
                "opticsid": 2,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
