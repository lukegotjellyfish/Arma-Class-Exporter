rhs_m4a1_acog2_usmc_sup = {
    # Class: CfgWeapons|rhs_m4a1_acog2_usmc_sup|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4a1_acog2_usmc_sup|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG2_USMC"
        },
        # Class: CfgWeapons|rhs_m4a1_acog2_usmc_sup|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq16a_top"
        },
        # Class: CfgWeapons|rhs_m4a1_acog2_usmc_sup|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
