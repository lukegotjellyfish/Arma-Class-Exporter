rhsusf_weap_m6_r1 = {
    # Compatible Magazines: magazines parameter (+ inherited)    "magazines": [        "rhsusf_mag_l8a3_r1_8",],
    # Class: CfgWeapons|rhsusf_weap_M6_R1|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M6_R1|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "(_this + [['smoke_R1_','_pos','_dir']]) call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
