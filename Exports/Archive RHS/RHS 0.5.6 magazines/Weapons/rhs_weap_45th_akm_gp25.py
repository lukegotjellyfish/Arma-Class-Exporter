rhs_weap_45th_akm_gp25 = {
    # Class: CfgWeapons|rhs_weap_45th_akm_gp25|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_45th_akm_gp25|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_pbs1"
        }
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_akm_gp25_ca.paa",
    ...
    # Class: CfgWeapons|rhs_weap_akm_gp25|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 102.08,
        # Class: CfgWeapons|rhs_weap_akm_gp25|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 0
        },
        # Class: CfgWeapons|rhs_weap_akm_gp25|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_akm_gp25|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        # Class: CfgWeapons|rhs_weap_akm_gp25|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        "allowedslots": [901]
    },
    "weaponinfotype": "rhs_rscOptics_akm_gp25",
