rhs_weap_ags30 = {
    ...
    # Class: CfgWeapons|RHS_weap_Ags30|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|RHS_weap_Ags30|GunParticles|effect1 [Indent level: 2]
        "effect1": {
    ...
    # Class: CfgWeapons|RHS_weap_Ags30|manual [Indent level: 1],
    "manual": {
        "displayname": "AGS-30 Grenade Launcher",
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|RHS_weap_Ags30|manual|StandardSound [Indent level: 2],
        "standardsound": {
    ...
    # Class: CfgWeapons|RHS_weap_Ags30|close [Indent level: 1],
    "close": {
        "burst": 3,
        "burstrangemax": 8,
        "airateoffire": 1,
    ...
    # Class: CfgWeapons|RHS_weap_Ags30|short [Indent level: 1],
    "short": {
        "burst": 4,
        "burstrangemax": 8,
        "airateoffire": 1,
    ...
    # Class: CfgWeapons|RHS_weap_Ags30|medium [Indent level: 1],
    "medium": {
        "burst": 2,
        "burstrangemax": 6,
        "airateoffire": 2,
    ...
    # Class: CfgWeapons|RHS_weap_Ags30|far [Indent level: 1],
    "far": {
        "burst": 2,
        "burstrangemax": 6,
        "airateoffire": 2,
