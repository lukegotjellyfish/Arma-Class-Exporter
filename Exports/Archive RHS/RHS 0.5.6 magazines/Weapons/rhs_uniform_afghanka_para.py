rhs_uniform_afghanka_para = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_para_ca.paa",
    "displayname": "M88 VDV",
    # Class: CfgWeapons|rhs_uniform_afghanka_para|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_para_base",
        "uniformmodel": "-",
