rhs_fieldcap_m88_back = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_back_ca.paa",
    "displayname": "Field Cap M88 (Back)",
    ...
    "scope": 2,
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan_co.paa"],
