rhsusf_ach_helmet_dcu = {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry3|gear|head|data|rhs_helmet_ach_DCU_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
