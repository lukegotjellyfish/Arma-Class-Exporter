rhsgref_otv_khaki = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_otv_khaki_ca.paa",
    "scope": 2,
    "displayname": "OTV (Khaki)",
    "hiddenselections": ["camo"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_cdf|otv_cdf_khaki_co.paa"],
    "model": "A3|Characters_F_Beta|INDEP|equip_ia_vest01",
    # Class: CfgWeapons|rhsgref_otv_khaki|ItemInfo [Indent level: 1],
    "iteminfo": {
        ...
        # Class: CfgWeapons|rhsgref_otv_khaki|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_otv_khaki|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
                "hitpointname": "HitNeck",
                "armor": 0,
                "passthrough": 0.9
            },
            # Class: CfgWeapons|rhsgref_otv_khaki|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
                "hitpointname": "HitChest",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhsgref_otv_khaki|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhsgref_otv_khaki|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhsgref_otv_khaki|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
