rhs_weap_m21s_fold = {
    # Class: CfgWeapons|rhs_weap_m21s_fold|WeaponSlotsInfo [Indent level: 1]
    "weaponslotsinfo": {
        "mass": 67.16,
    ...
    # Class: CfgWeapons|rhs_weap_m21s|Single [Indent level: 1],
    "single": {
        "dispersion": 0.00325,
    ...
    # Class: CfgWeapons|rhs_weap_m21s|FullAuto [Indent level: 1],
    "fullauto": {
        "dispersion": 0.00325,
        "sounds": ["StandardSound","SilencedSound"],
