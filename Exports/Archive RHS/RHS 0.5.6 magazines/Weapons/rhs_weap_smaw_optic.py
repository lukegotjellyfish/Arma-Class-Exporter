rhs_weap_smaw_optic = {
    # Class: CfgWeapons|rhs_weap_smaw_optic|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_smaw_optic|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
    ...
    "magazines": [
        "rhs_mag_smaw_heaa","rhs_mag_smaw_hedp","rhs_mag_smaw_sr",],
