rhs_weap_dsr1 = {
    ...
    "magazines": [
        "rhsusf_5rnd_762x51_m118_special_mag","rhsusf_5rnd_762x51_m993_mag","rhsusf_5rnd_762x51_m62_mag","rhsusf_5rnd_300winmag_xm2010",
    ],
    ...
    "initspeed": -0.96,
    "inertia": 0.87,
    # Class: CfgWeapons|rhs_weap_dsr1|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_dsr1|WeaponSlotsInfo|CowsSlot [Indent level: 2]
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_dsr1|WeaponSlotsInfo|rhs_mtz_slot [Indent level: 2],
        "rhs_mtz_slot": {
        },
        "mass": 129.8
    },
    # Class: CfgWeapons|rhs_weap_dsr1|ItemInfo [Indent level: 1],
    "iteminfo": {
        "priority": 1,
