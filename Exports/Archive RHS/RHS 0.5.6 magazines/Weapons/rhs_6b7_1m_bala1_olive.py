rhs_6b7_1m_bala1_olive = {
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_6b7-1m_co.paa","rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_6b7-1m_olive_co.paa","rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_bala1_olive_co.paa"],
    # Class: CfgWeapons|rhs_6b7_1m_bala1_olive|ItemInfo [Indent level: 1],
    "iteminfo": {
