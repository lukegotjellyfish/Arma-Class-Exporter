rhs_weap_nsvt_obj681 = {
    # Class: CfgWeapons|rhs_weap_nsvt_obj681|GunParticles [Indent level: 1]
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_nsvt_obj681|GunParticles|effect1a [Indent level: 2]
        "effect1a": {
            "effectname": "MachineGunCloud",
            "positionname": "nsvt_start",
            "directionname": "nsvt_end"
        }
    },
    "holdsteranimvalue": 1,
    "scope": 1,
