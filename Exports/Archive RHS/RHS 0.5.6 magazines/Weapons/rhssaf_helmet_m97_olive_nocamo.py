rhssaf_helmet_m97_olive_nocamo = {
    ...
    # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
        ...
        "modelsides": [6],
        "hiddenselections": ["camo"],
        # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
