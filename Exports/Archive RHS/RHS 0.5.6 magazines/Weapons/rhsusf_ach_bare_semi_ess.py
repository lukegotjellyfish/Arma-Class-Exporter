rhsusf_ach_bare_semi_ess = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_bare_semi_ess_ca.paa",
    "displayname": "ACH (Semi-Arid/ESS)",
    "allowedfacewear": ["",6,"rhs_googles_black",3,"rhs_googles_clear",1],
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|ach_bare_ess_01",
    "hiddenselections": ["Camo","Camo1"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_mich_semi_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa"],
    # Class: CfgWeapons|rhsusf_ach_bare_semi_ess|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry|gear|head|ach_bare_ess_01",
        "mass": 40,
        "hiddenselections": ["Camo","Camo1"],
