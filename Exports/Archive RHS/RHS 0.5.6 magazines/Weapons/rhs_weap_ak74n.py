rhs_weap_ak74n = {
    ...
    # Class: CfgWeapons|rhs_weap_ak74n|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_ak74n|WeaponSlotsInfo|CowsSlot [Indent level: 2]
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_ak74n|WeaponSlotsInfo|rhs_picattinny_russian_rifle_bis_scopes_slot [Indent level: 2],
        "rhs_picattinny_russian_rifle_bis_scopes_slot": {
        },
        # Class: CfgWeapons|rhs_weap_ak74n|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
