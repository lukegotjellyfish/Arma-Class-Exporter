rhsusf_acc_nxs_5522x56_md_sun = {
    "scope": 2,
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_nxs_5522x56_md_sun_ca.paa",
    "dlc": "RHS_USAF",
    "author": "Red Hammer Studios",
    "model": "rhsusf|addons|rhsusf_scopes|nf|rhs_nxs_5522x56_sun",
    "displayname": "NXS 5.5-22x56 (sunshade/mil-dot)",
    "descriptionshort": "Reticle: Second focal plane mildot<br />Magnification: 5.5-22x",
    # Class: CfgWeapons|rhsusf_acc_nxs_5522x56_md|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsusf|addons|rhsusf_scopes|optics|nf|f2|rhsusf_nxs_22xf2_mildot",
        "optictype": 2,
        "mass": 13.64,
        "rmbhint": "Optical Sight",
        "optics": 1,
        # Class: CfgWeapons|rhsusf_acc_nxs_5522x56_base|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_nxs_5522x56_base|ItemInfo|OpticsModes|nxs_scope [Indent level: 3]
            "nxs_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
