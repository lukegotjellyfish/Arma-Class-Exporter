rhs_acc_pso1m21 = {
    ...
    # Class: CfgWeapons|rhs_acc_pso1m21|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsafrf|addons|rhs_weapons|acc|scopes|optics|rhs_pso1m21_scope",
        # Class: CfgWeapons|rhs_acc_pso1m21|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pso1m21|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
            ...
            # Class: CfgWeapons|rhs_acc_pso1m21|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
