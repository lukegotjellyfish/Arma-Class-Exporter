rhsgref_helmet_m1_mit = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_M1_mit_ca.paa",
    "displayname": "M1 (Mitchell)",
    "scope": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|m1_cover",
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|m1_cover_mit_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_M1_mit|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 42,
        "uniformmodel": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|m1_cover",
        "allowedslots": [801,901,701,605],
        "modelsides": [6],
        # Class: CfgWeapons|rhsgref_helmet_M1_mit|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_helmet_M1_mit|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
