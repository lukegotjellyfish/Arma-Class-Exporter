rhs_weap_g36c_compm4 = {
    # Class: CfgWeapons|rhs_weap_g36c_compm4|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_g36c_compm4|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_compm4"
        },
        # Class: CfgWeapons|rhs_weap_g36c_compm4|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
