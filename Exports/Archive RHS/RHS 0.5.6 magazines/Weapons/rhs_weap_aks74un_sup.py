rhs_weap_aks74un_sup = {
    # Class: CfgWeapons|rhs_weap_aks74un_sup|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_aks74un_sup|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_pbs4"
        }
    ...
    # Class: CfgWeapons|rhs_weap_aks74un|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 60.62,
        # Class: CfgWeapons|rhs_weap_aks74un|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_aks74un|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_aks74un|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        # Class: CfgWeapons|rhs_weap_aks74un|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        "allowedslots": [901]
    },
    ...
    # Recoil Class: recoil,
    # Class: CfgRecoils|recoil_ktb [Indent level: 0],
    "recoil": {
