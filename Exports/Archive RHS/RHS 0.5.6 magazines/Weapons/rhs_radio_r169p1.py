rhs_radio_r169p1 = {
    ...
    "model": "rhsafrf|addons|rhs_infantry|gear|rhs_radio_R169P.p3d",
    "displayname": "R-169P-1-01",
    # Class: CfgWeapons|rhs_radio_R169P1|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 6.6
    },
    ...
    "descriptionshort": "Enables communications.",
    "muzzles": [],
