rhsusf_hgu56p_mask_black_skull = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_hgu56p_mask_black_skull_ca.paa",
    "displayname": "HGU-56/P (Black/Mask/Skull)",
    "model": "rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|rhs_hgu56_mask",
    # Class: CfgWeapons|rhsusf_hgu56p_mask_black_skull|ItemInfo [Indent level: 1],
    "iteminfo": {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_blk_skull_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_patches_usPirate_co.paa"],
