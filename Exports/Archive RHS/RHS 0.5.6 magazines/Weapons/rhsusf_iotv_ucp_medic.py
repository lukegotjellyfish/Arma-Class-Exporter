rhsusf_iotv_ucp_medic = {
    ...
    # Class: CfgWeapons|rhsusf_iotv_ucp_Medic|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry|gear|vests|rhs_iotv_Medic",
        "containerclass": "Supply120",
        "mass": 120,
        # Class: CfgWeapons|rhsusf_iotv_ucp_Medic|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_iotv_ucp_Medic|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
                "hitpointname": "HitNeck",
                "armor": 12,
                "passthrough": 0.4
            },
            # Class: CfgWeapons|rhsusf_iotv_ucp_Medic|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
                "hitpointname": "HitChest",
                "armor": 28,
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_iotv_ucp_Medic|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_iotv_ucp_Medic|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_iotv_ucp_Medic|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
