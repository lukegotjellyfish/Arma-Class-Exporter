rhs_acc_rakurspm = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_rakursPM_ca.paa",
    "scope": 2,
    "author": "Red Hammer Studios",
    "displayname": "1P76 Rakurs-PM",
    "model": "rhsafrf|addons|rhs_weapons2|acc|scopes|Rakurs|rhs_RakursPM",
    "descriptionshort": "1P76 Rakurs-PM RIS Collimator",
    "weaponinfotype": "RscWeaponZeroing",
    "inertia": 0.1,
    # Class: CfgWeapons|rhs_acc_rakursPM|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 0,
        "mass": 4,
        ...
        # Class: CfgWeapons|rhs_acc_rakursPM|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_rakursPM|ItemInfo|OpticsModes|rhs_rakurs_collimator [Indent level: 3]
            "rhs_rakurs_collimator": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
                "opticszoommax": 1.1,
