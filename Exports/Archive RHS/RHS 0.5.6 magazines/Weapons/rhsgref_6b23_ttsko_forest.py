rhsgref_6b23_ttsko_forest = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_ttsko_forest_ca.paa",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsgref_6b23_ttsko_forest|ItemInfo [Indent level: 1],
    "iteminfo": {
