rhs_weap_sr25_ec_wd = {
    ...
    # Class: CfgWeapons|rhs_weap_sr25_ec_wd|Library [Indent level: 1],
    "library": {
        "libtextdesc": "An SR 25 EC rifle manufactured by Knights Armament company"
    },
    # Class: CfgWeapons|rhs_weap_sr25_ec_wd|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 84.92,
        # Class: CfgWeapons|rhs_weap_sr25_ec_wd|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons2|sr25|data|camo|wd|reciever_co.paa","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|wd|rail_co.paa","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|wd|misc_co.paa","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|wd|buttstock1_co.paa","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|wd|buttstock2_co.paa","rhsusf|addons|rhsusf_weapons|M4|data|kacrailcover_wd_co.paa"],
    "hiddenselectionsmaterials": ["rhsusf|addons|rhsusf_weapons2|sr25|data|camo|reciever_mat.rvmat","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|rail_mat.rvmat","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|misc_mat.rvmat","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|buttstock1_mat.rvmat","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|buttstock2_mat.rvmat","rhsusf|addons|rhsusf_weapons|m4|data|kacrailcover.rvmat"],
