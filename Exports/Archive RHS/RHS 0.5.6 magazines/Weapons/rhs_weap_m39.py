rhs_weap_m39 = {
    "displayname": "M39 EMR",
    "dexterity": 1.5,
    # Class: CfgWeapons|rhs_weap_m39|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m39|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_LEUPOLDMK4"
        },
        # Class: CfgWeapons|rhs_weap_m39|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
