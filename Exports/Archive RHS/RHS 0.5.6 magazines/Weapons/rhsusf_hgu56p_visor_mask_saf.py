rhsusf_hgu56p_visor_mask_saf = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_hgu56p_visor_mask_saf_ca.paa",
    "displayname": "HGU-56/P (SAF/Visor/Mask)",
    "model": "rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|rhs_hgu56_visor_mask",
    # Class: CfgWeapons|rhsusf_hgu56p_visor_mask_saf|ItemInfo [Indent level: 1],
    "iteminfo": {
    ...
    "hiddenselections": ["camo","visor"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_saf_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_visor_yellow_ca.paa"],
    "hiddenselectionsmaterials": ["|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56.rvmat","|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_visor.rvmat"],
    "allowedfacewear": [],
    "scope": 2,
