rhs_weap_rpg18_used = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_rpg18_ca.paa",
    "dlc": "RHS_AFRF",
    "model": "rhsafrf|addons|rhs_weapons3|RPG18|rpg18",
    "discretedistance": [50,100,150,200],
    "discretedistancecamerapoint": ["eye","OP_eye1","OP_eye2","OP_eye3"],
    "dispersion": 0.2,
    # Class: CfgWeapons|rhs_weap_rpg18|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "allowedslots": [901],
        "mass": 57.2
    },
    # Class: CfgWeapons|rhs_weap_rpg18|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_rpg18|GunParticles|effect1 [Indent level: 2]
        "effect1": {
