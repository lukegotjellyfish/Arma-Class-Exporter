rhssaf_uniform_gendarmes_acu = {
    ...
    "scope": 0,
    "scopecurator": 0,
    "picture": "rhssaf|addons|rhssaf_inventoryicons|data|uniform|rhssaf_uniform_gendarmes_acu_ca.paa",
    "displayname": "Tactical One [WIP]",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_universal_F.p3d",
    "hiddenselections": ["camo1","camo2","camo3"],
    "hiddenselectionstextures": ["|rhssaf|addons|rhssaf_t_uniform_mdt|data|rhssaf_uniform_mdt_01_digi_co.paa","|rhssaf|addons|rhssaf_t_uniform_mdt|data|rhssaf_uniform_mdt_02_digi_co.paa","|rhssaf|addons|rhssaf_t_uniform_mdt|data|rhssaf_uniform_mdt_03_digi_co.paa"],
    # Class: CfgWeapons|rhssaf_uniform_gendarmes_acu|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
