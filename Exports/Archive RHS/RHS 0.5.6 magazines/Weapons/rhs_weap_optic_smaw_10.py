rhs_weap_optic_smaw_10 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_10|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_10|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_10|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 500,
                "distancezoommax": 500,
                "discreteinitindex": 9,
        ...
        "optictype": 1,
        "optics": 1,
        "modeloptics": "rhsusf|addons|rhsusf_weapons2|smaw|optic_smaw_2d.p3d",
        "type": 201,
