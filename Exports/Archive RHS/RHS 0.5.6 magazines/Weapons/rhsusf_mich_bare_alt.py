rhsusf_mich_bare_alt = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_alt_ca.paa",
    "displayname": "MICH 2000 (Alt)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_bare_01_alt",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_od_rhino_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_od_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
    # Class: CfgWeapons|rhsusf_mich_bare_alt|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
