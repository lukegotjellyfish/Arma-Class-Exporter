rhsusf_acc_anpas13gv1 = {
    ...
    # Class: CfgWeapons|rhsusf_acc_anpas13gv1|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 14,
        "weaponinfotype": "RscWeaponRangeZeroingModeFOV",
        "optics": 1,
        "modeloptics": "rhsusf|addons|rhsusf_weapons3|acc|scopes|optics|LWTS_optic",
        # Class: CfgWeapons|rhsusf_acc_anpas13gv1|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_anpas13gv1|ItemInfo|OpticsModes|TWS [Indent level: 3]
            "tws": {
                "opticsid": 1,
                ...
                "distancezoommin": 100,
                "distancezoommax": 300,
                "modeloptics": ["|rhsusf|addons|rhsusf_weapons3|acc|scopes|optics|LWTS_optic","|rhsusf|addons|rhsusf_weapons3|acc|scopes|optics|LWTS_optic2x"],
            ...
            # Class: CfgWeapons|rhsusf_acc_anpas13gv1|ItemInfo|OpticsModes|TWS_5mil [Indent level: 3],
            "tws_5mil": {
                "opticsid": 2,
                "opticsdisplayname": "  - 5 MIL ",
                "modeloptics": ["|rhsusf|addons|rhsusf_weapons3|acc|scopes|optics|LWTS_5miloptic","|rhsusf|addons|rhsusf_weapons3|acc|scopes|optics|LWTS_5milopticx2"],
                "usemodeloptics": 1,
                "opticsppeffects": ["OpticsCHAbera1","OpticsBlur1"],
                "opticszoommin": 0.125,
                "opticszoommax": 0.25,
