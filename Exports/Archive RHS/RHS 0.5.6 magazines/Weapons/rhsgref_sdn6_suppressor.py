rhsgref_sdn6_suppressor = {
    ...
    "scope": 2,
    "scopearsenal": 2,
    "displayname": "AAC 762-SDN-6 (cover)",
    "picture": "rhsgref|addons|rhsgref_weapons|icons|sdn6.paa",
    "model": "rhsgref|addons|rhsgref_weapons|m38|rhs_sdn6",
    "dlc": "RHS_GREF",
    # Class: CfgWeapons|rhsgref_silencer_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 7,
        # Class: CfgWeapons|rhsgref_silencer_base|ItemInfo|MagazineCoef [Indent level: 2],
        "magazinecoef": {
            "initspeed": 1.01
        },
        # Class: CfgWeapons|rhsgref_silencer_base|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "visiblefire": 0.2,
            "audiblefire": 0.4,
        ...
        # Class: CfgWeapons|rhsgref_silencer_base|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "dispersioncoef": "0.8f",
