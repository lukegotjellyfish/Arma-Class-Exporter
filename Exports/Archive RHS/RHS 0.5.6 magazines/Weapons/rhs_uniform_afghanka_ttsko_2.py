rhs_uniform_afghanka_ttsko_2 = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_ttsko_2_ca.paa",
    "displayname": "M88 (TTsKO/Alt)",
    # Class: CfgWeapons|rhs_uniform_afghanka_ttsko_2|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_ttsko_2_base",
        "uniformmodel": "-",
