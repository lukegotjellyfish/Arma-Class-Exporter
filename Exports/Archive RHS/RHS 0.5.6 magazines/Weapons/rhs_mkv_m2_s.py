rhs_mkv_m2_s = {
    "displayname": "Stbd M2",
    # Class: CfgWeapons|RHS_MKV_M2_s|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|RHS_MKV_M2_s|GunParticles|effect1 [Indent level: 2]
        "effect1": {
            "positionname": "m2_s_muzzle",
            "directionname": "m2_s_endBarrel",
            "effectname": "MachineGunCloud"
        },
        # Class: CfgWeapons|RHS_MKV_M2_s|GunParticles|effect2 [Indent level: 2],
        "effect2": {
            "positionname": "m2_s_caseStart",
            "directionname": "m2_s_caseEnd",
            "effectname": "MachineGunEject"
        },
        # Class: CfgWeapons|RHS_MKV_M2_s|GunParticles|effect3 [Indent level: 2],
        "effect3": {
            "positionname": "m2_s_caseStart",
            "directionname": "m2_s_caseEnd",
