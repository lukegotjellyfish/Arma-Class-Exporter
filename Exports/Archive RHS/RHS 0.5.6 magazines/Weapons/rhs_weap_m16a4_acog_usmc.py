rhs_weap_m16a4_acog_usmc = {
    # Class: CfgWeapons|rhs_weap_m16a4_acog_usmc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m16a4_acog_usmc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG_USMC"
        },
        # Class: CfgWeapons|rhs_weap_m16a4_acog_usmc|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
    ...
    # Class: CfgWeapons|rhs_weap_m16a4_carryhandle|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 74.8,
