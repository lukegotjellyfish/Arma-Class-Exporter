rhsusf_acc_su230a = {
    ...
    # Class: CfgWeapons|rhsusf_acc_su230a|ItemInfo [Indent level: 1],
    "iteminfo": {
        ...
        "optics": 1,
        # Class: CfgWeapons|rhsusf_acc_su230_base|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_su230_base|ItemInfo|OpticsModes|Elcan_x1 [Indent level: 3]
            "elcan_x1": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
            ...
            # Class: CfgWeapons|rhsusf_acc_su230_base|ItemInfo|OpticsModes|Elcan_x4 [Indent level: 3],
            "elcan_x4": {
                "opticsid": 2,
                "usemodeloptics": 1,
                "opticsppeffects": ["OpticsCHAbera1","OpticsBlur1","rhs_su230_Blur"],
    ...
    "weaponinfotype": "rhsusf_acc_su230a_handler",
    "dlc": "RHS_USAF",
    "opticsdisableperipherialvision": 0,
    "inertia": 0.2,
    "muzzles": [],
