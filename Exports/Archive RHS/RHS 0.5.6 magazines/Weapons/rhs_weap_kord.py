rhs_weap_kord = {
    ...
    # Class: CfgWeapons|rhs_weap_kord|manual [Indent level: 1],
    "manual": {
        "displayname": "KORD (6U16)",
        "reloadtime": 0.095,
        "dispersion": 0.002,
        ...
        "maxrange": 3,
        "maxrangeprobab": 0.01,
        # Class: CfgWeapons|rhs_weap_kord|manual|StandardSound [Indent level: 2],
        "standardsound": {
    ...
    # Class: CfgWeapons|rhs_weap_kord|close [Indent level: 1],
    "close": {
        "showtoplayer": 0,
        "soundburst": 0,
        "burst": 10,
    ...
    # Class: CfgWeapons|rhs_weap_kord|short [Indent level: 1],
    "short": {
        "burst": 9,
        "burstrangemax": 14,
        "airateoffire": 2,
    ...
    # Class: CfgWeapons|rhs_weap_kord|medium [Indent level: 1],
    "medium": {
        "burst": 8,
        "burstrangemax": 12,
        "airateoffire": 4,
    ...
    # Class: CfgWeapons|rhs_weap_kord|far [Indent level: 1],
    "far": {
        "burst": 5,
        "burstrangemax": 10,
        "airateoffire": 5,
    ...
    # Class: CfgWeapons|rhs_weap_nsvt_effects|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_nsvt_effects|GunParticles|effect1a [Indent level: 2]
        "effect1a": {
