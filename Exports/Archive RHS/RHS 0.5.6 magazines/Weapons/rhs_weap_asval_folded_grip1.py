rhs_weap_asval_folded_grip1 = {
    ...
    # Class: CfgWeapons|rhs_weap_asval_grip_folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 41.25,
        # Class: CfgWeapons|rhs_weap_asval_grip_folded|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_asval_grip_folded|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
    ...
    "inertia": 0.65,
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_asval_folded [Indent level: 0],
    "recoil": {
        "muzzleouter": [0.3,1.2,0.5,0.4],
        "kickback": [0.03,0.05],
        "permanent": 0.1,
        "temporary": 0.05,
