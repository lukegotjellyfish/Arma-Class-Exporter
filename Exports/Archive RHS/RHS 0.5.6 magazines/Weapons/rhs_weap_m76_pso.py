rhs_weap_m76_pso = {
    # Class: CfgWeapons|rhs_weap_m76_pso|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m76_pso|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_pso1m2"
        }
    ...
    # Class: CfgWeapons|rhs_weap_m76|Single [Indent level: 1],
    "single": {
    ...
    # Class: CfgWeapons|rhs_weap_m76|single_medium_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_m76|single_far_optics2 [Indent level: 1],
    "single_far_optics2": {
        "requiredoptictype": 2,
        "minrange": 100,
        "minrangeprobab": 0.1,
    ...
    # Class: CfgWeapons|rhs_weap_m76|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m76|WeaponSlotsInfo|CowsSlot [Indent level: 2]
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_m76|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        "mass": 95.7,
    ...
    # Recoil Class: recoil,
    # Class: CfgRecoils|recoil_akm [Indent level: 0],
    "recoil": {
