rhs_weap_m14_ris_fiberglass = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_m14_ris_fiberglass_ca.paa",
    "baseweapon": "rhs_weap_m14_ris_fiberglass",
    "displayname": "M14 (RIS/Fiberglass)",
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons3|m14|data|m14_fiberglass_co.paa"],
    "scope": 2,
    "model": "rhsusf|addons|rhsusf_weapons3|M14|RHS_M14_RIS.p3d",
    # Class: CfgWeapons|rhs_weap_m14_ris_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m14_ris_base|WeaponSlotsInfo|PointerSlot [Indent level: 2]
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_m14_ris_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            # Class: CfgWeapons|rhs_weap_m14_ris_base|WeaponSlotsInfo|CowsSlot|compatibleItems [Indent level: 3]
            "compatibleitems": {
    ...
    # Class: CfgWeapons|rhs_weap_m14_base|Single [Indent level: 1],
    "single": {
