rhsusf_acc_acog_rmr_3d = {
    ...
    "weaponinfotype": "rhs_acog_rmr_3d_handler",
    "author": "Red Hammer Studios",
    "displayname": "TA31RCO-RMR",
    "model": "rhsusf|addons|rhsusf_scopes|rmr|acog_rmr",
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhsusf_acc_ACOG_3d|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_ACOG_3d|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_ACOG_3d|ItemInfo|OpticsModes|elcan_scope [Indent level: 3]
            "elcan_scope": {
                "usemodeloptics": 0,
                "opticszoommin": 0.08,
                "opticszoommax": 0.125,
            ...
            # Class: CfgWeapons|rhsusf_acc_ACOG_3d|ItemInfo|OpticsModes|alternative_view [Indent level: 3],
            "alternative_view": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
