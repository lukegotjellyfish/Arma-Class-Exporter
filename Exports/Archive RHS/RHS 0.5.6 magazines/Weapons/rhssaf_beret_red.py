rhssaf_beret_red = {
    ...
    # Class: CfgWeapons|rhssaf_beret_green|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 6,
        ...
        # Class: CfgWeapons|rhssaf_beret_green|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_beret_green|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
