rhsusf_cvc_helmet = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_cvc_helmet_ca.paa",
    "displayname": "ACVC-H, MK-1697 (Tan)",
    "allowedfacewear": ["",2,"rhs_ess_black",2,"rhs_googles_black",2,"rhs_googles_clear",1,"rhsusf_shemagh2_tan",5,"rhsusf_shemagh2_gogg_tan",10],
    "scope": 2,
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_infantry2|gear|head|cvc|data|rhs_cvc_co.paa"],
    "model": "rhsusf|addons|rhsusf_infantry2|gear|head|cvc|rhs_cvc",
    # Class: CfgWeapons|rhsusf_cvc_helmet|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo1"],
        "mass": 40,
        "uniformmodel": "rhsusf|addons|rhsusf_infantry2|gear|head|cvc|rhs_cvc",
        "armor": 6,
        "modelsides": [3,1],
