rhs_uniform_afghanka_boots_grey = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_boots_grey_ca.paa",
    "displayname": "M88 Sapogi (Grey)",
    # Class: CfgWeapons|rhs_uniform_afghanka_boots_grey|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_boots_grey_base",
        "uniformmodel": "-",
