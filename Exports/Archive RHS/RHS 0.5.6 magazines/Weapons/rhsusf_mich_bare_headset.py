rhsusf_mich_bare_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_headset_ca.paa",
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_od_rhino_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_od_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|bowman_base_co.paa"],
    # Class: CfgWeapons|rhsusf_mich_bare_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo","Camo1","Camo2","bowman"],
