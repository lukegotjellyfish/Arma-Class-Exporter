rhs_uniform_omon = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_omon_ca.paa",
    "displayname": "Omon Uniform",
    # Class: CfgWeapons|rhs_uniform_omon|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_omon_base",
        "uniformmodel": "-",
