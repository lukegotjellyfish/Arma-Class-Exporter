rhs_acc_pso1m2_ads = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    "model": "rhsafrf|addons|rhs_weapons|acc|scopes|pso1|rhs_pso1_ads",
    # Class: CfgWeapons|rhs_acc_pso1m2_ads|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_pso1m2_ads|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pso1m2_ads|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
                "usemodeloptics": 0,
            ...
            # Class: CfgWeapons|rhs_acc_pso1m2_ads|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
