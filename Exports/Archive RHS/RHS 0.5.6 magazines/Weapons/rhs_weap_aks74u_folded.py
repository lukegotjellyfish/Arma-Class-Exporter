rhs_weap_aks74u_folded = {
    ...
    "scope": 1,
    "inertia": 0.28,
    # Class: CfgWeapons|rhs_weap_aks74u_folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 44.715,
        # Class: CfgWeapons|rhs_weap_aks74u_folded|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_aks74u_folded|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_aks74u_folded|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        # Class: CfgWeapons|rhs_weap_aks74u_folded|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        "allowedslots": [901]
    },
    ...
    "aidispersioncoefx": 8,
    # Class: CfgWeapons|rhs_weap_aks74u|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_aks74u|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
