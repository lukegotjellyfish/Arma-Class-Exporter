rhs_weap_scarh_fde_std_folded_grip = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_FDE_STD_Folded_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_FDE_STD_Folded_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
