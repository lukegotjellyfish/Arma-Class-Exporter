rhsgref_m56 = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_M56_ca.paa",
    "scope": 2,
    "allowedfacewear": ["rhs_scarf","G_Aviator"],
    "displayname": "M56",
    "model": "rhsgref|addons|rhsgref_infantry|gear|head|m56",
    "hidddenselections": ["Camo2"],
    # Class: CfgWeapons|rhsgref_M56|ItemInfo [Indent level: 1],
    "iteminfo": {
        ...
        "modelsides": [3,1],
        # Class: CfgWeapons|rhsgref_M56|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_M56|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
