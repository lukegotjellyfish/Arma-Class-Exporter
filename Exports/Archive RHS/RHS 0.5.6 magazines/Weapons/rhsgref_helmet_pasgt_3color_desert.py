rhsgref_helmet_pasgt_3color_desert = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_pasgt_3color_desert_ca.paa",
    "scope": 2,
    "displayname": "PASGT (3-Color Desert)",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|pasgt_helmet_3color_desert_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_pasgt_3color_desert|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|pasgt_helmet",
        "mass": 40,
        "allowedslots": [801,901,701,605],
        "modelsides": [6],
        # Class: CfgWeapons|rhsgref_helmet_pasgt_erdl|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_helmet_pasgt_erdl|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
