rhs_acc_dtk1 = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_dtk1_ca.paa",
    "author": "Red Hammer Studios",
    "model": "rhsafrf|addons|rhs_weapons|acc|muzzle|dtk1|dtk1.p3d",
    "displayname": "DTK-1",
    # Class: CfgWeapons|rhs_acc_dtk1|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_dtk1|ItemInfo|MuzzleCoef [Indent level: 2]
        "muzzlecoef": {
        ...
        "alternativefire": "rhs_muzzleFlash_dtk1",
        "mass": 5,
        "soundtypeindex": 0,
        # Class: CfgWeapons|rhs_acc_dtk3|ItemInfo|MagazineCoef [Indent level: 2],
        "magazinecoef": {
            "initspeed": 1
        },
        # Class: CfgWeapons|rhs_acc_dtk3|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "typicalspeed": 1,
            "airfriction": 1,
