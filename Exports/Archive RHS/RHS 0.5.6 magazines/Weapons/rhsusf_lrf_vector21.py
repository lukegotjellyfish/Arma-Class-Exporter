rhsusf_lrf_vector21 = {
    "scope": 1,
    "scopearsenal": 0,
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_bino_lrf_Vector21_ca.paa",
    "author": "Red Hammer Studios",
    "dlc": "RHS_USAF",
    "displayname": "Vector 21-B",
    "model": "rhsusf|addons|rhsusf_weapons|misc|vector21|vector21.p3d",
    # Class: CfgWeapons|rhsusf_bino_lrf_Vector21|Library [Indent level: 1],
    "library": {
        "libtextdesc": "A rangefinder is a basic tool for spotting distances and targets. It has several active parts: one being the rangefinder itself on the right side where you can see the distance to the target. AZT displays the azimuth and the mode switches between the visible spectrum and night vision."
    },
    "descriptionshort": "Vector 21 Rangefinder",
    "modeloptics": "rhsusf|addons|rhsusf_weapons|misc|vector21|rhs_vector21_reticle.p3d",
    "opticszoommin": 0.05,
    "opticszoommax": 0.05,
    "opticszoominit": 0.05,
    "weaponinfotype": "rhs_gui_optic_Vector21_rangefinder",
    "visionmode": ["Normal"],
    # Class: CfgWeapons|rhsusf_bino_lrf_Vector21|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 37.62
    },
