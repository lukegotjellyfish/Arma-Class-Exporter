rhssaf_uniform_m10_digital_summer = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "picture": "rhssaf|addons|rhssaf_inventoryicons|data|uniform|rhssaf_uniform_m10_digital_summer_ca.paa",
    "displayname": "M10 (Digital/Summer)",
    ...
    # Class: CfgWeapons|rhssaf_uniform_m10_digital_summer|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
