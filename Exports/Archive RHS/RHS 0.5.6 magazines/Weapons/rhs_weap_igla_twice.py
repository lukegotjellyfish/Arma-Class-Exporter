rhs_weap_igla_twice = {
    ...
    "magazines": ["rhs_mag_2Rnd_Igla"],
    "weaponlocksystem": 2,
    "modes": ["Single","Burst"],
    # Class: CfgWeapons|rhs_weap_Igla_twice|Single [Indent level: 1],
    "single": {
        "airateoffire": 5,
        ...
        # Class: CfgWeapons|rhs_weap_Igla_twice|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RocketsHeavy_Shot_SoundSet"]
        },
        # Compatible Magazines: magazines parameter (+ inherited),
        "magazines": [
            "1rnd_gat_missiles","1rnd_gaa_missiles",],
    ...
    # Class: CfgWeapons|rhs_weap_Igla_twice|Burst [Indent level: 1],
    "burst": {
        "reloadtime": 0,
        "multiplier": 1,
        "burst": 2,
