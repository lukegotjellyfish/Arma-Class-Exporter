rhssaf_uniform_m10_digital_tan_boots = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "picture": "rhssaf|addons|rhssaf_inventoryicons|data|uniform|rhssaf_uniform_m10_digital_tan_boots_ca.paa",
    "displayname": "M10 (Digital/Tan Boots)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_universal_F.p3d",
    "hiddenselections": ["camo"],
    "hiddenselectionstextures": ["|rhssaf|addons|rhssaf_t_uniform_m10|data|rhssaf_uniform_m10_digital_summer_tan_boots_co.paa"],
    # Class: CfgWeapons|rhssaf_uniform_m10_digital_tan_boots|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
