rhs_weap_hk416d10_lmt_wd_grip = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_hk416d10_LMT_wd_grip_ca.paa",
    "handanim": ["OFP2_ManSkeleton","|rhsusf|addons|rhsusf_c_weapons|anims|rhs_hand_m16a4.rtm"],
    # Class: CfgWeapons|rhs_weap_hk416d10_LMT_wd_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_hk416d10_LMT_wd_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    "dexterity": 1.6,
    "initspeed": -0.8979,
    # Class: CfgWeapons|rhs_weap_hk416d10|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 72.82,
        "allowedslots": [901],
