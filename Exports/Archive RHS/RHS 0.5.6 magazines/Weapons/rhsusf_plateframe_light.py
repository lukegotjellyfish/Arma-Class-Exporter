rhsusf_plateframe_light = {
    ...
    # Class: CfgWeapons|rhsusf_plateframe_light|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry2|gear|vests|plateframe|rhs_plateframe_sapi_light",
        "containerclass": "Supply100",
        "mass": 80,
        # Class: CfgWeapons|rhsusf_plateframe_light|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_plateframe_light|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
                "hitpointname": "HitChest",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhsusf_plateframe_light|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": "22 + 		3",
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhsusf_plateframe_light|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
