rhs_weap_optic_smaw_4 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_4|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_4|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_4|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 200,
                "distancezoommax": 200,
                "discreteinitindex": 3,
