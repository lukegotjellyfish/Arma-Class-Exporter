rhs_vkpo_cap_alt = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_vkpo_cap_alt_ca.paa",
    "displayname": "VKPO Field Cap (Alt.)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|ratnik|data|emr_cap_co.paa"],
