rhsusf_lwh_helmet_marpatwd_headset_blk = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_lwh_helmet_marpatwd_headset_blk_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_lwh_helmet_marpatwd_headset_blk|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["camo","Camo2"],
        "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|lwh_wd_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|lwh_acc_wd_co.paa"],
