rhs_weap_m4a1_m320 = {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_m320|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 96.8,
        # Class: CfgWeapons|rhs_weap_m4a1_m320|WeaponSlotsInfo|UnderBarrelSlot [Indent level: 2],
        "underbarrelslot": {
        },
        # Class: CfgWeapons|rhs_weap_m4a1_m320|WeaponSlotsInfo|GripodSlot [Indent level: 2],
        "gripodslot": {
        },
        "allowedslots": [901],
