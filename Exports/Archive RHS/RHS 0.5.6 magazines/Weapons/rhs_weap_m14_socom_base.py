rhs_weap_m14_socom_base = {
    "model": "rhsusf|addons|rhsusf_weapons3|M14|RHS_M14_SOCOM.p3d",
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons3|m14|data|m14_socom_co.paa"],
    "displayname": "SOCOM 16",
    "initspeed": -0.97,
    # Class: CfgWeapons|rhs_weap_m14_socom_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 77.2,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_m14_socom_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            # Class: CfgWeapons|rhs_weap_m14_socom_base|WeaponSlotsInfo|CowsSlot|compatibleItems [Indent level: 3]
            "compatibleitems": {
