rhsgref_uniform_altis_lizard_olive = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|uniform|rhsgref_uniform_altis_lizard_olive_ca.paa",
    "scope": 2,
    "dlc": "RHS_GREF",
    "displayname": "M93 (Altis Lizard/Olive)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_blufor_diver",
    # Class: CfgWeapons|rhsgref_uniform_altis_lizard_olive|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
