rhs_uniform_afghanka_vsr_1 = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_vsr_1_ca.paa",
    "displayname": "M88 (VSR 1)",
    # Class: CfgWeapons|rhs_uniform_afghanka_vsr_1|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_vsr_1_base",
        "uniformmodel": "-",
