rhsusf_opscore_fg = {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_fg_co.paa","","","","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_tan_co.paa",""],
