rhs_weap_m21a_pbg40_fold = {
    ...
    "recoil": "recoil_mxc",
    # Class: CfgWeapons|rhs_weap_m21a_pbg40_fold|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 68.48,
        # Class: CfgWeapons|rhs_weap_m21a_pbg40|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
    ...
    "scope": 2,
    "scopecurator": 2,
    "handanim": ["OFP2_ManSkeleton","|rhssaf|addons|rhssaf_c_weapons|anims|rhs_hand_m21_gp.rtm"],
    "muzzles": ["this","PBG40Muzzle","SAFE"],
