rhs_fieldcap_m88_ttsko_alt = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_ttsko_alt_ca.paa",
    "displayname": "Field Cap M88 (TTsKO Alt.)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_TTSKO_var_co.paa"],
    "scope": 2,
