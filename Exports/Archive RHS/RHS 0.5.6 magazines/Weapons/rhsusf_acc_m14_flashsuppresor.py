rhsusf_acc_m14_flashsuppresor = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_m14_flashsuppresor_ca.paa",
    "displayname": "M14 SOCOM Flash Hider",
    "author": "Red Hammer Studios",
    "model": "rhsusf|addons|rhsusf_weapons3|acc|silencers|m14_flashsupp|acca_soc_flashsupp.p3d",
    # Class: CfgWeapons|rhsusf_acc_m14_flashsuppresor|ItemInfo [Indent level: 1],
    "iteminfo": {
        "alternativefire": "rhsusf_acc_muzzleFlash_SFMB556",
        # Class: CfgWeapons|rhsusf_acc_m14_flashsuppresor|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "firelightcoef": "0.9f",
            "dispersioncoef": "1.0f",
        ...
        "soundtypeindex": 0,
        "inertia": 0.05,
        # Class: CfgWeapons|rhsusf_acc_SF3P556|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "visiblefire": 0.8,
            "audiblefire": 0.95,
        ...
        "mass": 7,
        # Class: CfgWeapons|rhsusf_silencer_base|ItemInfo|MagazineCoef [Indent level: 2],
        "magazinecoef": {
            "initspeed": 1.01
        },
