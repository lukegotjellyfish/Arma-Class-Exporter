rhsusf_weap_lwircm = {
    "scope": 2,
    "displayname": "LWIRCM",
    "magazines": ["rhsusf_mag_LWIRCM"],
    "magazinereloadtime": 60,
    "simulation": "cmlauncher",
    "modes": ["Burst1","Burst2"],
    "reloadmagazinesound": ["A3|sounds_f|dummysound",2,1,5],
    # Class: CfgWeapons|rhsusf_weap_LWIRCM|Burst1 [Indent level: 1],
    "burst1": {
        "displayname": "LWIRCM",
        "reloadtime": 0.25,
        "burst": 120,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhsusf_weap_LWIRCM|Burst1|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": ["rhsusf|addons|rhsusf_melb|Sound|ircm_on1",2,1,5],
            "begin2": ["rhsusf|addons|rhsusf_melb|Sound|ircm_on2",2,1,5],
    ...
    # Class: CfgWeapons|rhsusf_weap_LWIRCM|Burst2 [Indent level: 1],
    "burst2": {
        "displayname": "LWIRCM",
        "reloadtime": 0.25,
        "burst": 120,
