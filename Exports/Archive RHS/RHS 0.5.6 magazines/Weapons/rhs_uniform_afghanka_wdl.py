rhs_uniform_afghanka_wdl = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_wdl_ca.paa",
    "displayname": "M88 (Woodland)",
    # Class: CfgWeapons|rhs_uniform_afghanka_wdl|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_wdl_base",
        "uniformmodel": "-",
