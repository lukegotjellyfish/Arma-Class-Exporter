rhs_weap_svdp_wd = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_svdp_wd_ca.paa",
    ...
    # Class: CfgWeapons|rhs_weap_svdp|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 81.62,
    ...
    # Class: CfgWeapons|rhs_weap_svdp|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.085,
    ...
    "muzzles": ["this","SAFE"],
    # Class: CfgWeapons|rhs_weap_svd|LinkedItems [Indent level: 1],
    "linkeditems": {
    },
    "inertia": 0.65,
    "dexterity": 1.4,
