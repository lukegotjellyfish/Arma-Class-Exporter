rhs_weap_dshkm = {
    ...
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_DSHKM|GunParticles|effect1 [Indent level: 2]
        "effect1": {
            "positionname": "usti hlavne",
            "directionname": "konec hlavne",
            "effectname": "MachineGunCloud"
        },
        # Class: CfgWeapons|rhs_weap_DSHKM|GunParticles|effect2 [Indent level: 2],
        "effect2": {
    ...
    "magazines": [
        "rhs_mag_127x108mm_50","rhs_mag_127x108mm_150",],
    "soundservo": ["",0.0001,1],
    "reloadtime": 0.1,
    "dispersion": 0.002,
    "minrange": 1,
    ...
    # Class: CfgWeapons|rhs_weap_DSHKM|manual [Indent level: 1],
    "manual": {
        "displayname": "NSVT",
        "autofire": 1,
        "reloadtime": 0.1,
    ...
    # Class: CfgWeapons|rhs_weap_DSHKM|close [Indent level: 1],
    "close": {
        "showtoplayer": 0,
        "soundburst": 0,
        "burst": 10,
    ...
    # Class: CfgWeapons|rhs_weap_DSHKM|short [Indent level: 1],
    "short": {
        "burst": 9,
        "burstrangemax": 15,
        "airateoffire": 2,
    ...
    # Class: CfgWeapons|rhs_weap_DSHKM|medium [Indent level: 1],
    "medium": {
        "burst": 6,
        "burstrangemax": 10,
        "airateoffire": 4,
    ...
    # Class: CfgWeapons|rhs_weap_DSHKM|far [Indent level: 1],
    "far": {
        "burst": 5,
        "burstrangemax": 9,
        "airateoffire": 5,
