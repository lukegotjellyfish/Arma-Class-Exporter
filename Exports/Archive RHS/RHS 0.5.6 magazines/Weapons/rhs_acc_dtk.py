rhs_acc_dtk = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_dtk_ca.paa",
    "author": "Red Hammer Studios",
    "model": "rhsafrf|addons|rhs_weapons|acc|muzzle|dtk1|dtk.p3d",
    "displayname": "DTK",
    # Class: CfgWeapons|rhs_acc_dtk|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_dtk|ItemInfo|AmmoCoef [Indent level: 2]
        "ammocoef": {
            "visiblefire": 0.85,
        ...
        # Class: CfgWeapons|rhs_acc_dtk|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
        ...
        "alternativefire": "rhs_muzzleFlash_dtk",
        "mass": 5,
        "soundtypeindex": 0,
