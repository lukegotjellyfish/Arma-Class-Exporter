rhssaf_zrak_rd7j = {
    ...
    "visionmode": ["Normal"],
    "picture": "rhssaf|addons|rhssaf_inventoryicons|data|accessories|rhssaf_zrak_rd7j_ca.paa",
    "displayname": "Zrak RD-7J",
    "optics": 1,
    "forceoptics": 0,
    "useasbinocular": 1,
    "primary": 0,
    ...
    # Class: CfgWeapons|rhssaf_zrak_rd7j|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 10
    },
    ...
    "inertia": 0.1,
    "swaycoef": 0.34,
    # Class: CfgWeapons|Binocular|Library [Indent level: 1],
    "library": {
