rhs_weap_ak74m_zenitco01_npz_grip1 = {
    ...
    # Class: CfgWeapons|rhs_weap_ak74m_zenitco01_npz|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 83.3,
        # Class: CfgWeapons|rhs_weap_ak74m_zenitco01_npz|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
