rhs_weap_dircm_lipa = {
    ...
    "magazines": ["rhs_mag_DIRCM_Lipa"],
    # Class: CfgWeapons|rhs_weap_DIRCM_Lipa|Burst1 [Indent level: 1],
    "burst1": {
        "displayname": "DIRCM",
        "reloadtime": 1,
        "burst": 80,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_DIRCM_Lipa|Burst1|StandardSound [Indent level: 2],
        "standardsound": {
