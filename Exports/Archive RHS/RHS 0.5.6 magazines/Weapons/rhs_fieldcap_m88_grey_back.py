rhs_fieldcap_m88_grey_back = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_grey_ca.paa",
    "displayname": "Field Cap M88 (Gray/Back)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_grey_co.paa"],
