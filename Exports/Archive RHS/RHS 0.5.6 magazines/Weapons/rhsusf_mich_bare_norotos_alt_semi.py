rhsusf_mich_bare_norotos_alt_semi = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_alt_semi_ca.paa",
    "scope": 2,
    "displayname": "MICH 2000 (Semi-Arid/Norotos/Alt)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_bare_01_nor1_alt",
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_alt_semi|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_rhino_painted_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_painted_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa"],
    "hiddenselections": ["Camo","Camo1","Camo2"],
