rhsusf_weap_m250 = {
    # Compatible Magazines: magazines parameter (+ inherited)    "magazines": [        "rhsusf_mag_l8a3_12",],
    "modes": ["Double","Volley"],
    # Class: CfgWeapons|rhsusf_weap_M250|Double [Indent level: 1],
    "double": {
        "reloadtime": 0.099,
        "burst": 6,
        "showtoplayer": 1,
    ...
    # Class: CfgWeapons|rhsusf_weap_M250|Volley [Indent level: 1],
    "volley": {
        "burst": 12,
        "displayname": "M250 (12)",
        "reloadtime": 0.099,
    ...
    # Class: CfgWeapons|rhsusf_weap_M250|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M250|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "_this call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
