rhs_weap_ak74m_2mag_npz_dtk = {
    ...
    # Class: CfgWeapons|rhs_weap_ak74m_2mag_npz_dtk|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak74m_2mag_npz_dtk|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtk"
        }
    ...
    # Class: CfgWeapons|rhs_weap_ak74m_2mag_npz|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_ak74m_2mag_npz|WeaponSlotsInfo|MuzzleSlot [Indent level: 2]
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_ak74m_2mag_npz|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_ak74m_2mag_npz|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_ak74m_2mag_npz|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        "mass": 74.5,
        "allowedslots": [901]
