rhssaf_uniform_m93_oakleaf = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "picture": "rhssaf|addons|rhssaf_inventoryicons|data|uniform|rhssaf_uniform_m93_oakleaf_ca.paa",
    "displayname": "M93 (Oakleaf)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_universal_F.p3d",
    "hiddenselections": ["camo"],
    "hiddenselectionstextures": ["|rhssaf|addons|rhssaf_t_uniform_m93|data|rhssaf_uniform_m93_oakleaf_co.paa"],
    # Class: CfgWeapons|rhssaf_uniform_m93_oakleaf|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
