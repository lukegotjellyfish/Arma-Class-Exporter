rhs_weap_m4a1_blockii_grip_kac_wd = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_m4a1_blockII_grip_KAC_wd_ca.paa",
    "handanim": ["OFP2_ManSkeleton","|rhsusf|addons|rhsusf_c_weapons|anims|rhs_hand_m16a4.rtm"],
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_KAC_wd|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_KAC_wd|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip1",
            "slot": "UnderBarrelSlot"
        }
    },
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_KAC_wd|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 67.78,
    ...
    "displayname": "M4A1 Block II (Woodland/SOPMOD Stock)",
