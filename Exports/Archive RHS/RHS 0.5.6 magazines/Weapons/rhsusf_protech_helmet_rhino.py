rhsusf_protech_helmet_rhino = {
    ...
    "displayname": "Pro-Tech SF (Rhino)",
    "model": "rhsusf|addons|rhsusf_infantry2|gear|head|protech|pt_helmet_rhino",
    # Class: CfgWeapons|rhsusf_protech_helmet_rhino|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry2|gear|head|protech|pt_helmet_rhino",
        "mass": 15,
        "allowedslots": [801,901,701,605],
        "modelsides": [6],
        # Class: CfgWeapons|rhsusf_protech_helmet|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_protech_helmet|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
