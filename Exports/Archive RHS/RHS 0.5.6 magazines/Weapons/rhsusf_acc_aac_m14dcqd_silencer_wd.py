rhsusf_acc_aac_m14dcqd_silencer_wd = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_aac_m14dcqd_silencer_wd_ca.paa",
    "author": "Red Hammer Studios",
    "displayname": "M14 DCQD (Woodland)",
    "model": "rhsusf|addons|rhsusf_weapons3|acc|silencers|m14_dcqd|acca_dcqd_wdl.p3d",
    "scope": 2,
    "inertia": 0.12,
    "dlc": "RHS_USAF",
    # Class: CfgWeapons|rhsusf_silencer_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 7,
        ...
        # Class: CfgWeapons|rhsusf_silencer_base|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "visiblefire": 0.2,
            "audiblefire": 0.4,
        ...
        # Class: CfgWeapons|rhsusf_silencer_base|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "dispersioncoef": "0.8f",
