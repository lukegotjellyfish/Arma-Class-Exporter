rhs_acc_perst3_2dp_h = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_perst3_2dp_h_ca.paa",
    "dlc": "RHS_AFRF",
    "author": "Red Hammer Studios",
    "scope": 2,
    "scopearsenal": 2,
    "rhs_acc_combo": "rhs_acc_perst3_2dp_light_h",
    "rhs_acc_combo_text": "Switched to Flashlight",
    "model": "rhsafrf|addons|rhs_weapons3|acc|lasers|lcu3|rhs_lcu3_2dp_side.p3d",
    "displayname": "Perst-3/2DP (Laser)",
    "weaponinfotype": "RHS_FlashlightRU",
    "rhs_anpeq15_base": "rhs_acc_perst3_2dp",
    # Class: CfgWeapons|rhs_acc_perst1ik|ItemInfo [Indent level: 1],
    "iteminfo": {
        "rmbhint": "IR Laser",
        "mass": 8,
        # Class: CfgWeapons|rhs_acc_perst1ik|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
            "irlaserpos": "laser pos",
            "irlaserend": "laser dir",
            "irdistance": 5
        },
        # Class: CfgWeapons|rhs_acc_perst1ik|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
        },
        "type": 301,
