rhs_weap_vhsd2_ct15x_grip1 = {
    "scope": 1,
    "handanim": ["OFP2_ManSkeleton","|rhsgref|addons|rhsgref_c_weapons|anims|rhs_hand_vhs_vfg.rtm"],
    # Class: CfgWeapons|rhs_weap_vhsd2_ct15x_grip1|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_vhsd2_ct15x_grip1|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_vhsd2_ct15x|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 94.6,
        "allowedslots": [901],
        # Class: CfgWeapons|rhs_weap_vhsd2_ct15x|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_vhsd2_ct15x|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_vhsd2_ct15x|WeaponSlotsInfo|GripodSlot [Indent level: 2],
        "gripodslot": {
    ...
    # Class: CfgWeapons|rhs_weap_vhsd2_ct15x|OpticsModes [Indent level: 1],
    "opticsmodes": {
        # Class: CfgWeapons|rhs_weap_vhsd2_ct15x|OpticsModes|Optic [Indent level: 2]
        "optic": {
            "opticsid": 1,
            "usemodeloptics": 0,
        ...
        # Class: CfgWeapons|rhs_weap_vhsd2_ct15x|OpticsModes|Ironsight [Indent level: 2],
        "ironsight": {
            "opticsid": 2,
            "opticsflare": 0,
    ...
    "magazines": [
        "rhsgref_30rnd_556x45_vhs2","rhsgref_30rnd_556x45_vhs2_t","rhssaf_30rnd_556x45_epr_g36","rhssaf_30rnd_556x45_sost_g36",
        "rhssaf_30rnd_556x45_spr_g36","rhssaf_30rnd_556x45_tracers_g36","rhssaf_30rnd_556x45_mdim_g36","rhssaf_30rnd_556x45_tdim_g36",
