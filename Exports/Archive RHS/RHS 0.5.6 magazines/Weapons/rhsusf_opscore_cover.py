rhsusf_opscore_cover = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_opscore_cover_ca.paa",
    "scope": 1,
