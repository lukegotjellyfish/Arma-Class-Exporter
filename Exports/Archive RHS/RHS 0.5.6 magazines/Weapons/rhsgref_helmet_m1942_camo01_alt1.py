rhsgref_helmet_m1942_camo01_alt1 = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1942_camo01_alt1_ca.paa",
    "displayname": "M42 (Strap Up/Painted)",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|M1942_strapup",
    # Class: CfgWeapons|rhsgref_helmet_m1942_camo01_alt1|ItemInfo [Indent level: 1],
    "iteminfo": {
        ...
        "modelsides": [6],
        # Class: CfgWeapons|rhsgref_helmet_M1_bare|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_helmet_M1_bare|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1942_camo01_co.paa","rhsgref|addons|rhsgref_infantry|gear|Head|data|decals|blank_ca.paa"],
    "hiddenselections": ["Camo","Camo1"],
