rhsgref_helmet_m1942_h = {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1942_co.paa","rhsgref|addons|rhsgref_infantry|gear|Head|data|decals|heer_ca.paa"],
    # Class: CfgWeapons|rhsgref_helmet_m1942_h|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo","Camo1"],
