rhs_acc_1p29_asval_3d = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_acc_1p29_asval_3d|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_1p29_asval_3d|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_1p29_asval_3d|ItemInfo|OpticsModes|rhs_1p29_scope [Indent level: 3]
            "rhs_1p29_scope": {
                "usemodeloptics": 0,
                ...
                "opticsid": 2,
                "opticsppeffects": ["OpticsCHAbera1","OpticsBlur1","rhs_1P29_Blur"],
            ...
            # Class: CfgWeapons|rhs_acc_1p29_asval_3d|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
    ...
    "weaponinfotype": "rhs_rscOptics_acc_1p29_3d",
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_1p29_ca.paa",
    "displayname": "1P29",
    "model": "rhsafrf|addons|rhs_weapons|acc|scopes|1p29|rhs_1p29",
    "descriptionshort": "Optical Sight<br />Magnification: 4x",
    "inertia": 0.1,
    "rhs_optic_base": "rhs_acc_1p29",
    "dlc": "RHS_AFRF",
    "muzzles": [],
