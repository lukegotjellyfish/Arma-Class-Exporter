rhsgref_helmet_m1940_h = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1940_h_ca.paa",
    "displayname": "M40 (Heer Decal)",
    "scope": 0,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|M1940_strapdown",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1940_co.paa","rhsgref|addons|rhsgref_infantry|gear|Head|data|decals|heer_ca.paa"],
    # Class: CfgWeapons|rhsgref_helmet_m1940_h|ItemInfo [Indent level: 1],
    "iteminfo": {
