rhsusf_acc_elcan_ard = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_ELCAN_ard_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_acc_ELCAN|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 4,
        ...
        # Class: CfgWeapons|rhsusf_acc_ELCAN|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_ELCAN|ItemInfo|OpticsModes|elcan_scope [Indent level: 3]
            "elcan_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
                ...
                "opticszoommax": 0.0732941,
                "opticszoommin": 0.0732941,
                "opticszoominit": 0.0732941,
            ...
            # Class: CfgWeapons|rhsusf_acc_ELCAN|ItemInfo|OpticsModes|alternative_view [Indent level: 3],
            "alternative_view": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
