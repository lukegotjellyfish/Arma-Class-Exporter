rhsusf_ach_bare_tan_headset_ess = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_bare_tan_headset_ess_ca.paa",
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_mich_tan_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa"],
    # Class: CfgWeapons|rhsusf_ach_bare_tan_headset_ess|ItemInfo [Indent level: 1],
    "iteminfo": {
