rhs_weap_m92_fold = {
    # Class: CfgWeapons|rhs_weap_m92_fold|WeaponSlotsInfo [Indent level: 1]
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m92_fold|WeaponSlotsInfo|PointerSlot [Indent level: 2]
        "pointerslot": {
        },
        "mass": 58.91,
        # Class: CfgWeapons|rhs_weap_m70_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
    ...
    "handanim": ["OFP2_ManSkeleton","|rhssaf|addons|rhssaf_c_weapons|anims|rhs_hand_m92_stock.rtm"],
    "magazinewell": ["AK_762x39","CBA_762x39_AK","CBA_762x39_RPK"],
    # Class: CfgWeapons|rhs_weap_m92|Single [Indent level: 1],
    "single": {
        "dispersion": 0.00255,
    ...
    # Class: CfgWeapons|rhs_weap_m92|FullAuto [Indent level: 1],
    "fullauto": {
        "dispersion": 0.00255,
        "sounds": ["StandardSound","SilencedSound"],
