rhs_weap_g36c_folded_grip3 = {
    ...
    "scope": 1,
    "handanim": ["OFP2_ManSkeleton","|rhssaf|addons|rhssaf_c_weapons|anims|rhs_hand_g36c_grip.rtm"],
    # Class: CfgWeapons|rhs_weap_g36c_Folded_grip3|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_g36c_Folded_grip3|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip2",
            "slot": "UnderBarrelSlot"
        }
    },
    "rhs_fold": "rhs_weap_g36c_grip3",
    ...
    # Class: CfgWeapons|rhs_weap_g36c_Folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 65.74,
        "allowedslots": [901],
