rhs_weap_ak104_npz_pgs64 = {
    # Class: CfgWeapons|rhs_weap_ak104_npz_pgs64|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak104_npz_pgs64|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_pgs64"
        }
