rhs_weap_m4_mstock_grip3 = {
    ...
    # Class: CfgWeapons|rhs_weap_m4_mstock_grip3|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4_mstock_grip3|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_m4_mstock|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 73.04,
        "allowedslots": [901],
