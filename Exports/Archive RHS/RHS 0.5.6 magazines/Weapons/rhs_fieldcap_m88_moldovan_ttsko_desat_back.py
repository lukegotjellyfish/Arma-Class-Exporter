rhs_fieldcap_m88_moldovan_ttsko_desat_back = {
    ...
    "displayname": "Field Cap M88 (Moldovan TTsKO Desat|Back)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_moldova_desat_co.paa"],
