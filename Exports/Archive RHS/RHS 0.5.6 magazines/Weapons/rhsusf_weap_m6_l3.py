rhsusf_weap_m6_l3 = {
    # Compatible Magazines: magazines parameter (+ inherited)    "magazines": [        "rhsusf_mag_l8a3_l3_8",],
    # Class: CfgWeapons|rhsusf_weap_M6_L3|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M6_L3|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "(_this + [['smoke_L3_','_pos','_dir']]) call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
