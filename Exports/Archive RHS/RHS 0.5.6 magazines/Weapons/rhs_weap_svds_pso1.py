rhs_weap_svds_pso1 = {
    # Class: CfgWeapons|rhs_weap_svds_pso1|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_svds_pso1|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_pso1m2"
        }
    ...
    # Class: CfgWeapons|rhs_weap_svds|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 85.58,
        # Class: CfgWeapons|rhs_weap_svdp|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
            "iconpinpoint": "Left",
            # Class: asdg_MuzzleSlot_762R_SVD|compatibleItems [Indent level: 0],
            "compatibleitems": {
                "rhs_acc_tgpv": 1,
                "rhs_acc_tgpv2": 1
            },
        ...
        # Class: CfgWeapons|rhs_weap_svdp|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
            ...
            # Class: rhs_russian_svd_scopes_slot|compatibleItems [Indent level: 0],
            "compatibleitems": {
                "rhs_acc_pso1m2": 1,
        ...
        # Class: CfgWeapons|rhs_weap_svdp|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
    ...
    # Class: CfgWeapons|rhs_weap_svds|Single [Indent level: 1],
    "single": {
    ...
    # Class: CfgWeapons|rhs_weap_svdp|single_close_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_svdp|single_medium_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_svdp|single_far_optics1 [Indent level: 1],
    "single_far_optics1": {
        "requiredoptictype": 2,
        "minrange": 300,
        "minrangeprobab": 0.05,
    ...
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_svd [Indent level: 0],
    "recoil": {
    ...
    "magazines": [
        "rhs_10rnd_762x54mmr_7n1","rhs_10rnd_762x54mmr_7n14",],
