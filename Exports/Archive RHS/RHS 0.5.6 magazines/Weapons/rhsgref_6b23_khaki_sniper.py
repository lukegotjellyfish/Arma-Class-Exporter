rhsgref_6b23_khaki_sniper = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_khaki_sniper_ca.paa",
    "scope": 2,
    "displayname": "6B23 Khaki (Sniper)",
    "model": "rhsafrf|addons|rhs_infantry|gear|vests|rhs_6b23_sniper",
    # Class: CfgWeapons|rhsgref_6b23_khaki_sniper|ItemInfo [Indent level: 1],
    "iteminfo": {
