rhs_weap_45th_ak74m_camo = {
    # Class: CfgWeapons|rhs_weap_45th_ak74m_camo|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_45th_ak74m_camo|LinkedItems|LinkedItemsAcc [Indent level: 2]
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhs_acc_2dpZenit"
        },
        # Class: CfgWeapons|rhs_weap_45th_ak74m_camo|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtk1"
        }
