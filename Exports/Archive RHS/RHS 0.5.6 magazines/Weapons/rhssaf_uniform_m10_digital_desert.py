rhssaf_uniform_m10_digital_desert = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "picture": "rhssaf|addons|rhssaf_inventoryicons|data|uniform|rhssaf_uniform_m10_digital_desert_ca.paa",
    "displayname": "M10 (Digital/Desert)",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_universal_F.p3d",
    "hiddenselections": ["camo"],
    "hiddenselectionstextures": ["|rhssaf|addons|rhssaf_t_uniform_m10|data|rhssaf_uniform_m10_digital_desert_co.paa"],
    # Class: CfgWeapons|rhssaf_uniform_m10_digital_desert|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
