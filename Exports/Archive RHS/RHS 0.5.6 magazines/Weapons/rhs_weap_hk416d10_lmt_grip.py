rhs_weap_hk416d10_lmt_grip = {
    ...
    # Class: CfgWeapons|rhs_weap_hk416d10_LMT_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_hk416d10_LMT_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons2|hk416|data|wep_hk416d_2_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|magazine_co.paa","|rhsusf|addons|rhsusf_weapons2|sr25|data|buttstock2_co.paa"],
