rhs_weap_scar_l_base = {
    # Recoil Class: recoil    # Class: CfgRecoils|rhs_recoil_m4 [Indent level: 0]
    "recoil": {
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_L_Base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_SCAR_L_Base|WeaponSlotsInfo|MuzzleSlot [Indent level: 2]
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_L_Base|Single [Indent level: 1],
    "single": {
        "sounds": ["Standardsound","SilencedSound"],
        # Class: CfgWeapons|rhs_weap_SCAR_L_Base|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHSUSF_M4_Shot_SoundSet","RHSUSF_Rifle1_Tail_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_SCAR_L_Base|Single|SilencedSound [Indent level: 2],
        "silencedsound": {
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_L_Base|FullAuto [Indent level: 1],
    "fullauto": {
        "sounds": ["Standardsound","SilencedSound"],
        # Class: CfgWeapons|rhs_weap_SCAR_L_Base|FullAuto|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHSUSF_M4_Shot_SoundSet","RHSUSF_Rifle1_Tail_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_SCAR_L_Base|FullAuto|SilencedSound [Indent level: 2],
        "silencedsound": {
            "soundsetshot": ["RHSUSF_sd_M4_Shot_SoundSet","RHSUSF_sd_Rifle1_Tail_SoundSet"]
        },
        "reloadtime": 0.075,
    ...
    "aidispersioncoefy": 6,
    "aidispersioncoefx": 4,
    "weaponinfotype": "rhs_rscOptics_scar",
    "opticszoommin": 0.275,
    "opticszoommax": 1.1,
    "opticszoominit": 0.75,
    "distancezoommin": 200,
