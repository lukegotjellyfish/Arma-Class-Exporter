rhssaf_vest_otv_md2camo = {
    ...
    "iteminfo": {
        ...
        # Class: CfgWeapons|rhssaf_vest_otv_md2camo|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_vest_otv_md2camo|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
                "hitpointname": "HitNeck",
                "armor": 0,
                "passthrough": 0.9
            },
            # Class: CfgWeapons|rhssaf_vest_otv_md2camo|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
                "hitpointname": "HitChest",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhssaf_vest_otv_md2camo|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhssaf_vest_otv_md2camo|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhssaf_vest_otv_md2camo|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
