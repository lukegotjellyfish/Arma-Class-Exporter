rhsusf_plateframe_sapi = {
    ...
    # Class: CfgWeapons|rhsusf_plateframe_sapi|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo","Camo1","Camo2","Camo3","Camo4","Camo5","Camo6","Camo7"],
        "uniformmodel": "rhsusf|addons|rhsusf_infantry2|gear|vests|plateframe|rhs_plateframe_sapi",
        "containerclass": "Supply20",
        "mass": 60,
        # Class: CfgWeapons|rhsusf_plateframe_sapi|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_plateframe_sapi|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
                "hitpointname": "HitChest",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhsusf_plateframe_sapi|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhsusf_plateframe_sapi|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
