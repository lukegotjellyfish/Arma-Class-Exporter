rhsusf_acc_saw_lw_bipod = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_saw_lw_bipod_ca.paa",
    "author": "Red Hammer Studios",
    "displayname": "SAW Improved Bipod",
    "descriptionshort": "M249 SAW Improved Bipod.",
    "model": "rhsusf|addons|rhsusf_weapons2|acc|grips|sawgrip|saw_lw_bipod",
    # Class: CfgWeapons|rhsusf_acc_saw_lw_bipod|ItemInfo [Indent level: 1],
    "iteminfo": {
        "scope": 0,
        "mass": 10,
        "deployedpivot": "bipod",
