rhs_uniform_afghanka_winter_boots = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_boots_ca.paa",
    "displayname": "M88 Winter Sapogi",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_boots|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_boots_base",
        "uniformmodel": "-",
