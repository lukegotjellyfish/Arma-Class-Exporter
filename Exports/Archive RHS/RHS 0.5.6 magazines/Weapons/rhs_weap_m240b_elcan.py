rhs_weap_m240b_elcan = {
    # Class: CfgWeapons|rhs_weap_m240b_elcan|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m240b_elcan|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
    ...
    "magazines": [
        "rhsusf_50rnd_762x51","rhsusf_50rnd_762x51_m61_ap","rhsusf_50rnd_762x51_m62_tracer","rhsusf_50rnd_762x51_m80a1epr",
        "rhsusf_50rnd_762x51_m82_blank","rhsusf_100rnd_762x51","rhsusf_100rnd_762x51_m61_ap","rhsusf_100rnd_762x51_m62_tracer",
        "rhsusf_100rnd_762x51_m80a1epr","rhsusf_100rnd_762x51_m82_blank",],
    "model": "rhsusf|addons|rhsusf_weapons2|M240|M240B.p3d",
    # Class: CfgWeapons|rhs_weap_m240B|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m240B|WeaponSlotsInfo|PointerSlot [Indent level: 2]
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons2|m240|data|m240b_2k_co.paa","|rhsusf|addons|rhsusf_weapons2|m240|data|m240b_4k_co.paa","|rhsusf|addons|rhsusf_weapons2|m240|data|m240_co.paa"],
    "uipicture": "",
    # Recoil Class: recoil,
