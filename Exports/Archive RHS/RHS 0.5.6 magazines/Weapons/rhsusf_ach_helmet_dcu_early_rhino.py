rhsusf_ach_helmet_dcu_early_rhino = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_helmet_DCU_early_rhino_ca.paa",
    "displayname": "ACH DCU (Early/Rhino)",
    "model": "rhsusf|addons|rhsusf_infantry3|gear|head|ach_early_rhino",
    "hiddenselections": ["camo","Camo1"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry3|gear|head|data|rhs_helmet_ach_DCU_early_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
    # Class: CfgWeapons|rhsusf_ach_helmet_DCU_early_rhino|ItemInfo [Indent level: 1],
    "iteminfo": {
