rhs_6b26_digi_ess_bala = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_6b26_digi_ess_bala_ca.paa",
    "allowedfacewear": [],
    "displayname": "6B26 EMR-Summer (ESS/Balaclava)",
    "model": "rhsafrf|addons|rhs_infantry|gear|head|rhs_6b26_ess_bala",
    # Class: CfgWeapons|rhs_6b26_digi_ess_bala|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
        ...
        "modelsides": [3,1],
        # Class: CfgWeapons|rhs_6b26|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_6b26|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
    ...
    "scope": 2,
    "hiddenselections": ["Camo1"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry|data|6b26_digi_co.paa"],
