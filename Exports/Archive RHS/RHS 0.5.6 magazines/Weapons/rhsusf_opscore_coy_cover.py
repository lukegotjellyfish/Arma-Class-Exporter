rhsusf_opscore_coy_cover = {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|opscore_co.paa","","","","|rhsusf|addons|rhsusf_infantry2|gear|head|opscore|data|fs_cover_cb_co.paa",""],
