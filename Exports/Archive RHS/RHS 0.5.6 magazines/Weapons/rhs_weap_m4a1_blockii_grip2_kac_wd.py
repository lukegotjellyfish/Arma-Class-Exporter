rhs_weap_m4a1_blockii_grip2_kac_wd = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_m4a1_blockII_grip2_KAC_wd_ca.paa",
    "displayname": "M4A1 Block II (AFG/SOPMOD Stock)",
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC_wd|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC_wd|WeaponSlotsInfo|GripodSlot [Indent level: 2]
        "gripodslot": {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC_wd|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC_wd|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip2",
            "slot": "UnderBarrelSlot"
        }
    },
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons|m4|data|m4a1_actual_wd_co.paa","|rhsusf|addons|rhsusf_weapons3|M4BII|Data|rhs_block2rail_wd_co.paa","|rhsusf|addons|rhsusf_weapons|acc|grips|grippod|data|acc_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|m4acc_wd_co.paa","|rhsusf|addons|rhsusf_weapons2|sr25|data|buttstock2_wd_co.paa"],
    "rhs_grip1_change": "rhs_weap_m4a1_blockII_grip_KAC_wd",
    "rhs_grip2_change": "rhs_weap_m4a1_blockII_grip2_KAC_wd",
    "rhs_grip3_change": "rhs_weap_m4a1_blockII_grip_KAC_wd",
    "baseweapon": "rhs_weap_m4a1_blockII_KAC_wd",
