rhs_weap_2p130 = {
    ...
    "magazines": [
        "rhs_mag_9m41_20",],
    # Class: CfgWeapons|rhs_weap_2p130|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_2p130|GunParticles|FirstEffect [Indent level: 2]
        "firsteffect": {
    ...
    # Class: CfgWeapons|rhs_weap_2p130|Burst1 [Indent level: 1],
    "burst1": {
        "reloadtime": 5.8,
        "showtoplayer": 0,
    ...
    # Class: CfgWeapons|rhs_weap_2p130|Burst2 [Indent level: 1],
    "burst2": {
        "reloadtime": 5.8,
        "showtoplayer": 0,
    ...
    # Class: CfgWeapons|rhs_weap_2p130|Burst3 [Indent level: 1],
    "burst3": {
        "reloadtime": 5.8,
        "showtoplayer": 0,
        "displayname": "Burst (far)",
    ...
    # Class: CfgWeapons|rhs_weap_2p130|Single1 [Indent level: 1],
    "single1": {
        "reloadtime": 5.8,
    ...
    # Class: CfgWeapons|rhs_weap_2p130|Single2 [Indent level: 1],
    "single2": {
        "reloadtime": 5.8,
    ...
    # Class: CfgWeapons|rhs_weap_2p130|Single3 [Indent level: 1],
    "single3": {
        "reloadtime": 5.8,
