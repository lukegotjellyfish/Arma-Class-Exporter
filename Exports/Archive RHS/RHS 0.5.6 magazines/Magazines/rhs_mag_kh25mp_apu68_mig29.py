rhs_mag_kh25mp_apu68_mig29 = {
    # Ammo: CfgMagazines|rhs_mag_kh25MP_apu68_mig29|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_kh25MP",
        "maxspeed": 920,
        "weaponlocksystem": 16,
        # Class: CfgAmmo|rhs_ammo_kh25mp|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_kh25mp|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_kh25mp|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_kh25mp|Components|SensorsManagerComponent|Components|AntiRadiationSensorComponent [Indent level: 4]
                    "antiradiationsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_kh25mp|Components|SensorsManagerComponent|Components|AntiRadiationSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 10000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_kh25mp|Components|SensorsManagerComponent|Components|AntiRadiationSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 10000,
                            "objectdistancelimitcoef": 1,
    ...
    "hardpoints": ["RHS_HP_KH25_APU68_MIG29"],
    "namesound": "missiles",
    "count": 1,
    "initspeed": 0,
