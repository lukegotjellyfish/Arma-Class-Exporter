rhs_mag_kh25ma = {
    # Ammo: CfgMagazines|rhs_mag_kh25MA|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_kh25MA",
        "weaponlocksystem": "8 + 16",
        # Class: CfgAmmo|rhs_ammo_kh25ma|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_kh25ma|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_kh25ma|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_kh25ma|Components|SensorsManagerComponent|Components|RadarSensorComponent [Indent level: 4]
                    "radarsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_kh25ma|Components|SensorsManagerComponent|Components|RadarSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 10000,
                            "maxrange": 10000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_kh25ma|Components|SensorsManagerComponent|Components|RadarSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 5000,
                            "maxrange": 5000,
                            "objectdistancelimitcoef": -1,
    ...
    "mindamageforcamshakehit": "rhs_ammo_kh25MA",
    "displayname": "Kh-25MA",
