rhs_mag_kmgu2_ptm1 = {
    # Ammo: CfgMagazines|rhs_mag_kmgu2_ptm1|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_kmgu2_ptm1",
        # Ammo: CfgAmmo|rhs_ammo_kmgu2_ptm1|submunitionAmmo [Indent level: 1],
        "submunitionammo1": {
            "_dictAmmoName": "rhs_ammo_ptm1_deploy",
            "_dictAmmoChance": "1",
            "model": "rhsafrf|addons|rhs_airweapons|rhs_m_ptm1",
            # Ammo: CfgAmmo|rhs_ammo_ptm1_deploy|submunitionAmmo [Indent level: 1],
            "submunitionammo": {
        ...
        "eventhandlers": ["rhs_ammo_ptm1_deploy",1],
    ...
    "eventhandlers": "rhs_ammo_kmgu2_ptm1",
    "displayname": "KMGU-2 PTM-1",
