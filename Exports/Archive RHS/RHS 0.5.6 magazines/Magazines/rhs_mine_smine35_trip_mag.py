rhs_mine_smine35_trip_mag = {
    ...
    "scope": 2,
    # Ammo: CfgMagazines|rhs_mine_smine35_trip_mag|ammo [Indent level: 1],
    "ammo": {
        ...
        "mineplacedist": 0.5,
        # Ammo: CfgAmmo|rhs_mine_smine35_trip_ammo|submunitionAmmo [Indent level: 1],
        "submunitionammo1": {
        ...
        "eventhandlers": ["rhs_mine_smine35_trip_explo_ammo",1],
    ...
    "eventhandlers": "rhs_mine_smine35_trip_ammo",
