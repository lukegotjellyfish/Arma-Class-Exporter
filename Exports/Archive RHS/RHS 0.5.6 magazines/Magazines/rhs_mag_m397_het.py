rhs_mag_m397_het = {
    ...
    # Ammo: CfgMagazines|rhs_mag_M397_HET|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_m397",
        "deflecting": 90,
        # Class: CfgAmmo|rhs_ammo_m397|HitEffects [Indent level: 1],
        "hiteffects": {
        ...
        # Ammo: CfgAmmo|rhs_ammo_m397|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_m397_explosion",
