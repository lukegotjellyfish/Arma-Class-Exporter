rhs_mag_m69 = {
    ...
    # Ammo: CfgMagazines|rhs_mag_m69|ammo [Indent level: 1],
    "ammo": {
        ...
        "cost": 1,
        "whistledist": 0,
        # Class: CfgAmmo|GrenadeHand_stone|CamShakeExplode [Indent level: 1],
        "camshakeexplode": {
            "power": 0,
            "duration": 0.2,
            "frequency": 20,
        ...
        # Class: CfgAmmo|GrenadeHand_stone|CamShakeHit [Indent level: 1],
        "camshakehit": {
            "power": 5,
            "duration": 0.2,
            "frequency": 20,
