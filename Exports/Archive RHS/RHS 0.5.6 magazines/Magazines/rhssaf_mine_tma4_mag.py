rhssaf_mine_tma4_mag = {
    ...
    "mass": 69.3,
    # Ammo: CfgMagazines|rhssaf_mine_tma4_mag|ammo [Indent level: 1],
    "ammo": {
    ...
    "displayname": "TMA-4",
    "model": "rhssaf|addons|rhssaf_m_explosives|mines_at|tma4|rhssaf_tma4_d",
    "descriptionshort": "Type: Anti-tank mine<br />Rounds: 1<br />Used on: Ground",
    # Class: CfgMagazines|rhssaf_mine_tma4_mag|Library [Indent level: 1],
    "library": {
