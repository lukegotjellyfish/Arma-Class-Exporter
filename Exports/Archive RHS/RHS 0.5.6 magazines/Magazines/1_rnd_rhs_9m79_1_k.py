1_rnd_rhs_9m79_1_k = {
    ...
    # Ammo: CfgMagazines|1_Rnd_RHS_9M79_1_K|ammo [Indent level: 1],
    "ammo": {
        ...
        # Class: CfgAmmo|Missile_AGM_02_F|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|Missile_AGM_02_F|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|Missile_AGM_02_F|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|Missile_AGM_02_F|Components|SensorsManagerComponent|Components|IRSensorComponent [Indent level: 4]
                    "irsensorcomponent": {
                        # Class: CfgAmmo|Missile_AGM_02_F|Components|SensorsManagerComponent|Components|IRSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 8000,
                        ...
                        # Class: CfgAmmo|Missile_AGM_02_F|Components|SensorsManagerComponent|Components|IRSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 8000,
                            "objectdistancelimitcoef": 1,
