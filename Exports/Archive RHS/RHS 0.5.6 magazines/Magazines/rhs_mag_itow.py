rhs_mag_itow = {
    "count": 1,
    "scope": 2,
    # Ammo: CfgMagazines|rhs_mag_2Rnd_ITOW|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_ITOW_AT",
        # Ammo: CfgAmmo|rhs_ammo_ITOW_AT|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
            "_dictAmmoName": "rhs_ammo_ITOW_AT_penetrator",
            "caliber": 42,
            "warheadname": "HEAT",
            "hit": 290,
            "indirecthit": 0,
        ...
        "eventhandlers": "rhs_ammo_ITOW_AT_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
    ...
    "mindamageforcamshakehit": "rhs_ammo_ITOW_AT",
