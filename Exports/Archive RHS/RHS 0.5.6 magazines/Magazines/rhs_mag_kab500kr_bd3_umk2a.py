rhs_mag_kab500kr_bd3_umk2a = {
    ...
    "hardpoints": ["RHS_HP_KAB500_BD3_UMK2A"],
    # Ammo: CfgMagazines|rhs_mag_kab500kr|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_kab500kr",
        "hit": 8000,
        "indirecthitrange": 15,
        ...
        "rhs_tv_guidance": "BW",
        # Class: CfgAmmo|rhs_ammo_kab500od|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_kab500od|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_kab500od|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_kab500od|Components|SensorsManagerComponent|Components|VisualSensorComponent [Indent level: 4]
                    "visualsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_kab500od|Components|SensorsManagerComponent|Components|VisualSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 11000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_kab500od|Components|SensorsManagerComponent|Components|VisualSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 11000,
                            "objectdistancelimitcoef": 1,
    ...
    "eventhandlers": "rhs_ammo_kab500kr",
