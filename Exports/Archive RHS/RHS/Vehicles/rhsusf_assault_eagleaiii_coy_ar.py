rhsusf_assault_eagleaiii_coy_ar = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_ar|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_ar|TransportItems|_xx_rhsusf_100Rnd_556x45_M855_soft_pouch [Indent level: 2]
