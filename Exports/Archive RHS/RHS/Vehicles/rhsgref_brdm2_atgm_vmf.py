rhsgref_brdm2_atgm_vmf = {
    ...
    # Class: CfgVehicles|rhsgref_BRDM2_ATGM_vmf|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_BRDM2_ATGM_vmf|AnimationSources|small_numbers_hide [Indent level: 2]
        "small_numbers_hide": {
            "initphase": 1,
            "source": "user",
            "animperiod": 0
