rhssaf_virtual_crate = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "displayname": "RHSSAF Virtual Weapon Crate",
    "type": 0,
    "transportmaxweapons": 70,
    "transportmaxmagazines": 40,
    # Class: CfgVehicles|rhssaf_virtual_crate|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "[_this select 0,0] call rhs_fnc_virtualAmmoBoxSAF;"
    },
    "slx_xeh_disabled": 1,
    # Class: CfgVehicles|rhssaf_virtual_crate|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|rhssaf_virtual_crate|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhssaf_virtual_crate|TransportItems [Indent level: 1],
    "transportitems": {
    },
    # Class: CfgVehicles|I_supplyCrate_F|SimpleObject [Indent level: 1],
    "simpleobject": {
        "eden": 1,
        "animate": [],
        "hide": [],
    ...
    # Class: CfgVehicles|I_supplyCrate_F|TransportBackpacks [Indent level: 1],
    "transportbackpacks": {
        # Class: CfgVehicles|I_supplyCrate_F|TransportBackpacks|_xx_B_Fieldpack_oli [Indent level: 2]
        "_xx_b_fieldpack_oli": {
