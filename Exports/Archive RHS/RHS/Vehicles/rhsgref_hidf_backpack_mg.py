rhsgref_hidf_backpack_mg = {
    "scope": 1,
    # Class: CfgVehicles|rhsgref_hidf_backpack_mg|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_hidf_backpack_mg|TransportMagazines|_xx_rhsusf_100Rnd_762x51 [Indent level: 2]
