rhs_tigr_sts_msv = {
    ...
    # Class: CfgVehicles|rhs_tigr_sts_msv|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_tigr_sts_msv|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
        ...
        # Class: CfgVehicles|rhs_tigr_sts_msv|Turrets|AGS_Turret [Indent level: 2],
        "ags_turret": {
            "gunnertype": "rhs_msv_grenadier",
