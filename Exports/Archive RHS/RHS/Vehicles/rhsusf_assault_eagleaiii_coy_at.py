rhsusf_assault_eagleaiii_coy_at = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_at|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_coy_at|TransportItems|_xx_rhs_fgm148_magazine_AT [Indent level: 2]
