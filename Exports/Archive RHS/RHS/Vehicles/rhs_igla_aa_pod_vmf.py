rhs_igla_aa_pod_vmf = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_Igla_AA_pod_vdv.paa",
    "scope": 2,
    "side": 0,
    ...
    "mapsize": 2.8,
    "model": "rhsafrf|addons|rhs_heavyweapons|igla|igla_AA_pod",
    "icon": "rhsafrf|addons|rhs_heavyweapons|data|mapico|icomap_igla_aa_pod_CA.paa",
    "picture": "rhsafrf|addons|rhs_heavyweapons|data|ico|rhs_Igla_AA_pod_msv_ca.paa",
    # Class: CfgVehicles|rhs_Igla_AA_pod_Base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhs_Igla_AA_pod_Base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|rhs_Igla_AA_pod_Base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    # Class: CfgVehicles|rhs_Igla_AA_pod_Base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|rhs_Igla_AA_pod_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_Igla_AA_pod_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "minturn": -180,
            "maxturn": 180,
            "gunneraction": "RHS_IglaPod_Gunner",
            "gunneropticseffect": ["OpticsCHAbera1","OpticsBlur2"],
            "gunnerlefthandanimname": "OtocHlaven",
            "gunnerrighthandanimname": "OtocHlaven",
            "gunneropticsmodel": "A3|weapons_f|reticle|optics_empty",
            "weapons": ["rhs_weap_Igla_twice"],
            "magazines": ["rhs_mag_2Rnd_Igla","rhs_mag_2Rnd_Igla","rhs_mag_2Rnd_Igla","rhs_mag_2Rnd_Igla","rhs_mag_2Rnd_Igla"],
            "maxelev": 120,
            "memorypointsgetingunner": "pos_gunner",
            "memorypointsgetingunnerdir": "pos_gunner_dir",
            "minelev": -10,
            # Class: CfgVehicles|rhs_Igla_AA_pod_Base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 0,
                "initangley": 0,
                "initfov": 0.155,
    ...
    # Class: CfgVehicles|rhs_Igla_AA_pod_Base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_Igla_AA_pod_Base|AnimationSources|MagazineReload [Indent level: 2]
        "magazinereload": {
            "source": "reloadmagazine",
            "weapon": "rhs_weap_Igla_twice"
        },
        # Class: CfgVehicles|rhs_Igla_AA_pod_Base|AnimationSources|Revolving [Indent level: 2],
        "revolving": {
            "source": "revolving",
            "weapon": "rhs_weap_Igla_twice"
        }
    },
    # Class: CfgVehicles|rhs_Igla_AA_pod_Base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_Igla_AA_pod_Base|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
