rhs_k36d5_seat = {
    ...
    "hideunitinfo": 1,
    "cargoaction": ["RHS_K36D_PilotEject"],
    "hasdriver": 0,
    "weapons": [],
    "magazines": [],
    "fuelcapacity": 0,
    ...
    # Class: CfgVehicles|rhs_k36d5_seat|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_k36d5_seat|AnimationSources|hide_booster [Indent level: 2]
        "hide_booster": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_k36d5_seat|AnimationSources|handle_move [Indent level: 2],
        "handle_move": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
    ...
    # Class: CfgVehicles|rhs_k36d5_seat|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|rhs_k36d5_seat|MFD [Indent level: 1],
    "mfd": {
    },
    # Class: CfgVehicles|rhs_k36d5_seat|RenderTargets [Indent level: 1],
    "rendertargets": {
    },
    # Class: CfgVehicles|rhs_k36d5_seat|UserActions [Indent level: 1],
    "useractions": {
    },
    "driveoncomponent": [],
    # Class: CfgVehicles|rhs_k36d5_seat|Eventhandlers [Indent level: 1],
    "eventhandlers": {
    },
    "slx_xeh_disabled": 1,
    "mapsize": 16,
