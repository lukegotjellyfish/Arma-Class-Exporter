rhssaf_kitbag_smb_aaa = {
    ...
    "scope": 1,
    "scopecurator": 0,
    # Class: CfgVehicles|rhssaf_Kitbag_smb_AAA|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhssaf_Kitbag_smb_AAA|TransportMagazines|_xx_rhs_mag_9k38_rocket [Indent level: 2]
