rhs_mi8amt_civilian = {
    ...
    # Class: CfgVehicles|RHS_Mi8amt_civilian|EventHandlers [Indent level: 1],
    "eventhandlers": {
    ...
    # Class: CfgVehicles|RHS_Mi8amt_civilian|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Mi8amt_civilian|AnimationSources|intake_hide [Indent level: 2]
        "intake_hide": {
            "initphase": 1,
            "mass": 1,
    ...
    # Class: CfgVehicles|RHS_Mi8amt_civilian|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_Mi8amt_civilian|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|RHS_Mi8amt_civilian|Components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|RHS_Mi8amt_civilian|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4]
                "cmdispenser": {
                    "attachment": "",
