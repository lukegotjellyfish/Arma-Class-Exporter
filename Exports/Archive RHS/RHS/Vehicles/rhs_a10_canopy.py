rhs_a10_canopy = {
    ...
    # Class: CfgVehicles|rhs_a10_canopy|Eventhandlers [Indent level: 1],
    "eventhandlers": {
        "handledamage": "deleteVehicle (_this select 0)"
    },
    # Class: CfgVehicles|rhs_a10_canopy|UserActions [Indent level: 1],
    "useractions": {
    },
    "driveoncomponent": [],
    "slx_xeh_disabled": 1,
    # Class: CfgVehicles|rhs_a10_canopy|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    # Class: CfgVehicles|rhs_a10_canopy|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhs_a10_canopy|TransportItems [Indent level: 1],
    "transportitems": {
    },
