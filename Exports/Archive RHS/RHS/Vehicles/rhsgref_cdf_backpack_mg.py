rhsgref_cdf_backpack_mg = {
    ...
    # Class: CfgVehicles|rhsgref_cdf_backpack_mg|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_cdf_backpack_mg|TransportMagazines|_xx_PKP [Indent level: 2]
        "_xx_pkp": {
