rhsgref_ins_g_uaz_dshkm_chdkz = {
    ...
    # Class: CfgVehicles|rhsgref_ins_g_uaz_dshkm_chdkz|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_g_uaz_dshkm_chdkz|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "gunnertype": "rhsgref_ins_g_rifleman_aksu",
            "body": "mainTurret",
            "gun": "mainGun",
        ...
        # Class: CfgVehicles|rhsgref_ins_g_uaz_dshkm_chdkz|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_uaz_dshkm.paa",
    # Class: CfgVehicles|rhsgref_ins_uaz_dshkm|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_uaz_dshkm|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
