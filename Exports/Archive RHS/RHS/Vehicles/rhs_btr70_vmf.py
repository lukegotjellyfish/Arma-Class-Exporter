rhs_btr70_vmf = {
    ...
    "rhs_decalparameters": ["['Number', cBTR3NumberPlaces, 'Default']","['Label', cBTRPlnSymPlaces, 'Army',[3,1]]"],
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_btr70|data|btr70_1_co.paa","rhsafrf|addons|rhs_btr70|data|btr70_2_co.paa","","rhsafrf|addons|rhs_btr70|habar|data|sa_gear_02_co.paa","rhsafrf|addons|rhs_btr70|habar|data|sa_gear_02_co.paa"],
