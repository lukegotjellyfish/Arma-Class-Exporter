rhs_su25sm_cluster_vvsc = {
    ...
    "scope": 1,
    "scopecurator": 2,
    # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                    "attachment": "rhs_mag_rbk250_ao1",
                    "uiposition": [0.32,0.2],
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                    "attachment": "rhs_mag_rbk250_ao1",
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
                    "attachment": "rhs_mag_rbk250_ao1",
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon5 [Indent level: 4],
                "pylon5": {
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon6 [Indent level: 4],
                "pylon6": {
                    "attachment": "rhs_mag_b8m1_s8df",
                    "uiposition": [0.34,0.1],
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon7 [Indent level: 4],
                "pylon7": {
                    "attachment": "rhs_mag_b8m1_s8df",
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon8 [Indent level: 4],
                "pylon8": {
                    "attachment": "rhs_mag_b8m1_s8df",
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon9 [Indent level: 4],
                "pylon9": {
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|pylon10 [Indent level: 4],
                "pylon10": {
                    "uiposition": [0.36,0],
                ...
                # Class: CfgVehicles|RHS_Su25SM_Cluster_vvsc|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4],
                "cmdispenser": {
    ...
    "rhs_decalparameters": ["['Number',cRHSAIRSU25NumberPlaces,'AviaBlue']","['Label', cRHSAIRSU25NosePlaces, 'Su25NoseArt']","['Label', cRHSAIRSU25SidePlaces, 'Su25Ex']"],
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_a2port_air|Su25|DATA|camo|su25_body1_camo1_co.paa","|rhsafrf|addons|rhs_a2port_air|Su25|DATA|camo|su25_body2_camo1_co.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa","rhsafrf|addons|rhs_decals|data|labels|aviation|vvs_ca.paa"],
    "accuracy": 0.5,
    "side": 0,
