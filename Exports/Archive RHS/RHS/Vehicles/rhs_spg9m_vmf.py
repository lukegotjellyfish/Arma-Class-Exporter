rhs_spg9m_vmf = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_SPG9M_VDV.paa",
    "scope": 2,
    "side": 0,
    ...
    "displayname": "SPG-9M",
    # Class: CfgVehicles|rhs_SPG9M_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_SPG9M_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "magazines": ["rhs_mag_OG9VM","rhs_mag_OG9VM","rhs_mag_OG9VM","rhs_mag_OG9VM","rhs_mag_OG9VM","rhs_mag_OG9VM","rhs_mag_OG9VM","rhs_mag_PG9N","rhs_mag_PG9N","rhs_mag_PG9N","rhs_mag_PG9N","rhs_mag_PG9VNT","rhs_mag_PG9VNT"],
            # Class: CfgVehicles|rhs_SPG9M_base|Turrets|MainTurret|OpticsIn [Indent level: 3],
            "opticsin": {
                # Class: CfgVehicles|rhs_SPG9M_base|Turrets|MainTurret|OpticsIn|HEAT [Indent level: 4]
                "heat": {
                ...
                # Class: CfgVehicles|rhs_SPG9M_base|Turrets|MainTurret|OpticsIn|HE [Indent level: 4],
                "he": {
            ...
            # Class: CfgVehicles|rhs_SPG9_base|Turrets|MainTurret|ViewGunner [Indent level: 3],
            "viewgunner": {
                "initanglex": 5,
                "minanglex": -30,
                "maxanglex": 30,
            ...
            # Class: CfgVehicles|rhs_SPG9_base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 0,
                "minanglex": -30,
                "maxanglex": 30,
    ...
    "dlc": "RHS_AFRF",
    "model": "rhsafrf|addons|rhs_heavyweapons|spg9|spg9.p3d",
    ...
    # Class: CfgVehicles|rhs_SPG9_base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhs_SPG9_base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|rhs_SPG9_base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    "hiddenselections": [],
    # Class: CfgVehicles|rhs_SPG9_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_SPG9_base|AnimationSources|ReloadAnim [Indent level: 2]
        "reloadanim": {
            "source": "reload",
            "weapon": "rhs_weap_SPG9"
        }
    },
    # Class: CfgVehicles|rhs_SPG9_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhsafrf|addons|rhs_heavyweapons|spg9|data|spg9.rvmat","rhsafrf|addons|rhs_heavyweapons|spg9|data|spg9.rvmat","rhsafrf|addons|rhs_heavyweapons|data|static_destroyed.rvmat"]
    },
    # Class: CfgVehicles|rhs_SPG9_base|Library [Indent level: 1],
    "library": {
        "libtextdesc": "The SPG-9 Kopye (in English: Spear) is a Russian recoilless gun. It fires fin-stabilized, rocked-assisted 73 mm HE or HEAT projectiles with effective range of about 800 m. <br/>The SPG-9 is usually used as a light anti-tank weapon, transported by vehicles."
    },
    # Class: CfgVehicles|rhs_SPG9_base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["rhs_SPG9_Gun_Bag","rhs_SPG9_Tripod_Bag"],
        "displayname": ""
    },
