rhsusf_m142_usmc_wd = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_HIMARS|data|M142_Cab_MC_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Rear_MC_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Chassis_MC_co.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Wheel_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Int_CO.paa"],
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsusf_himars_base|DriverOpticsIn [Indent level: 1],
    "driveropticsin": {
        # Class: CfgVehicles|rhsusf_himars_base|DriverOpticsIn|DVE_Wide [Indent level: 2]
        "dve_wide": {
            "campos": "dve_view_pos",
        ...
        # Class: CfgVehicles|rhsusf_himars_base|DriverOpticsIn|DVS_Rear [Indent level: 2],
        "dvs_rear": {
    ...
    # Class: CfgVehicles|rhsusf_himars_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsusf_himars_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "commanding": 1,
            "body": "mainTurret",
            "gun": "mainGun",
            ...
            # Class: CfgVehicles|rhsusf_himars_base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 0,
                "minanglex": -30,
                "maxanglex": 30,
            ...
            "elevationmode": 3,
            "forcehidegunner": 1,
            # Class: CfgVehicles|rhsusf_himars_base|Turrets|MainTurret|Turrets [Indent level: 3],
            "turrets": {
            },
            # Class: CfgVehicles|rhsusf_himars_base|Turrets|MainTurret|Hitpoints [Indent level: 3],
            "hitpoints": {
                # Class: CfgVehicles|rhsusf_himars_base|Turrets|MainTurret|Hitpoints|HitLauncher [Indent level: 4]
                "hitlauncher": {
                    "isgun": 1,
                    "armor": -80,
                ...
                # Class: CfgVehicles|rhsusf_himars_base|Turrets|MainTurret|Hitpoints|HitTurret [Indent level: 4],
                "hitturret": {
                    "isturret": 1,
                    "armor": -80,
                    "explosionshielding": 0.25,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
            ...
            "maxturn": 61,
            "minturn": -65,
            # Class: CfgVehicles|rhsusf_himars_base|Turrets|CargoTurret_01|TurnIn [Indent level: 3],
            "turnin": {
                "limitsarraytop": [[0,0],[0,0]],
                "limitsarraybottom": [[0,0],[0,0]]
            },
            # Class: CfgVehicles|rhsusf_himars_base|Turrets|CargoTurret_01|TurnOut [Indent level: 3],
            "turnout": {
            ...
            # Class: CfgVehicles|rhsusf_himars_base|Turrets|CargoTurret_01|Hitpoints [Indent level: 3],
            "hitpoints": {
            },
    ...
    # Class: CfgVehicles|rhsusf_himars_base|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhsusf_himars_base|textureSources|rhs_desert [Indent level: 2]
        "rhs_desert": {
            "displayname": "Desert",
            "author": "Red Hammer Studios",
            "textures": ["rhsusf|addons|rhsusf_HIMARS|data|M142_Cab_D_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Rear_D_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Chassis_D_co.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Wheel_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Int_CO.paa"],
            "factions": []
        },
        # Class: CfgVehicles|rhsusf_himars_base|textureSources|rhs_woodland [Indent level: 2],
        "rhs_woodland": {
            "displayname": "Woodland",
            "author": "Red Hammer Studios",
            "textures": ["rhsusf|addons|rhsusf_HIMARS|data|M142_Cab_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Rear_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Chassis_co.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Wheel_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Int_CO.paa"],
            "factions": []
        },
        # Class: CfgVehicles|rhsusf_himars_base|textureSources|rhs_usmc_woodland [Indent level: 2],
        "rhs_usmc_woodland": {
            "displayname": "USMC Woodland",
            "author": "Red Hammer Studios",
            "textures": ["rhsusf|addons|rhsusf_HIMARS|data|M142_CAB_MC_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Rear_MC_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Chassis_MC_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Wheel_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Int_CO.paa"],
            "factions": []
        }
    },
    "texturelist": [],
    # Class: CfgVehicles|rhsusf_himars_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|longlights_hide [Indent level: 2]
        "longlights_hide": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 1
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|shortlights_hide [Indent level: 2],
        "shortlights_hide": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1e-006
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|lights_hide [Indent level: 2],
        "lights_hide": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1e-006
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|cabinlights_hide [Indent level: 2],
        "cabinlights_hide": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 1
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|light_bo [Indent level: 2],
        "light_bo": {
            "source": "user",
            "animperiod": 1e-005,
            "initphase": 1
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|light_stop [Indent level: 2],
        "light_stop": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1e-005
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|light_svc [Indent level: 2],
        "light_svc": {
            "initphase": 1,
            "source": "user",
            "animperiod": 1e-005
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|Door_LF [Indent level: 2],
        "door_lf": {
            "source": "door",
            "animperiod": 0.8,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|Door_RF [Indent level: 2],
        "door_rf": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|hatch_door [Indent level: 2],
        "hatch_door": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|Missiles_revolving [Indent level: 2],
        "missiles_revolving": {
            "source": "revolving",
            "weapon": "rhs_weap_mlrs"
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|Missiles_revolving2 [Indent level: 2],
        "missiles_revolving2": {
            "weapon": "rhs_weap_mlrs_guided",
            "source": "revolving"
        },
        # Class: CfgVehicles|rhsusf_himars_base|AnimationSources|dve_fold [Indent level: 2],
        "dve_fold": {
            "source": "user",
            "animperiod": 1.5,
            "initphase": 0
    ...
    # Class: CfgVehicles|rhsusf_himars_base|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|light_bo_off [Indent level: 2]
        "light_bo_off": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|toggle_dve [Indent level: 2],
        "toggle_dve": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|light_bo_on [Indent level: 2],
        "light_bo_on": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|light_stop_off [Indent level: 2],
        "light_stop_off": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|light_stop_on [Indent level: 2],
        "light_stop_on": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|light_svc_on [Indent level: 2],
        "light_svc_on": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|light_svc_off [Indent level: 2],
        "light_svc_off": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|lights_toggle [Indent level: 2],
        "lights_toggle": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|UserActions|cabinlights_toggle [Indent level: 2],
        "cabinlights_toggle": {
            "shortcut": "lockTarget",
    ...
    # Class: CfgVehicles|rhsusf_himars_base|HitPoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitFuel [Indent level: 2]
        "hitfuel": {
            "armor": 0.5,
            "material": -1,
            "name": "palivo",
        ...
        # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitEngine [Indent level: 2],
        "hitengine": {
            "armor": 0.5,
            "material": -1,
            "name": "motor",
            "visual": "",
            "passthrough": 0.2,
            # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitEngine|DestructionEffects [Indent level: 3],
            "destructioneffects": {
                "ammoexplosioneffect": "",
                # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Smoke [Indent level: 4],
                "rhs_engine_smoke": {
                ...
                # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Fire [Indent level: 4],
                "rhs_engine_fire": {
                ...
                # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Sparks [Indent level: 4],
                "rhs_engine_sparks": {
                    "type": "RHS_FireSparks",
                    "simulation": "particles",
                    "position": "engine_smoke1",
                ...
                # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Sounds [Indent level: 4],
                "rhs_engine_sounds": {
                    "simulation": "sound",
                    "type": "Fire",
                    "position": "engine_smoke1",
                ...
                # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Smoke_small1 [Indent level: 4],
                ...
                # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Smoke_small2 [Indent level: 4],
        ...
        # Class: CfgVehicles|rhsusf_himars_base|HitPoints|HitBody [Indent level: 2],
        "hitbody": {
            "name": "",
            "visual": "zbytek",
            "passthrough": 1,
    ...
    # Class: CfgVehicles|rhsusf_himars_base|Reflectors [Indent level: 1],
    "reflectors": {
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Left [Indent level: 2]
        "left": {
            "color": [1900,1300,950],
            "ambient": [5,5,5],
            "position": "Light_L",
            ...
            "daylight": 0,
            "flaresize": 1,
            # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Left|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 0,
                "linear": 0,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Right [Indent level: 2],
        "right": {
            "position": "Light_R",
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Right2 [Indent level: 2],
        "right2": {
            "useflare": 1,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Left2 [Indent level: 2],
        "left2": {
            "useflare": 1,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Long_Left [Indent level: 2],
        "long_left": {
            "color": [1900,1300,950],
            "ambient": [5,5,5],
            ...
            # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Long_Left|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 0,
                "linear": 0.1,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Long_Right [Indent level: 2],
        "long_right": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Long_Right2 [Indent level: 2],
        "long_right2": {
            "useflare": 1,
            ...
            "conefadecoef": 51,
            "intensity": 1,
            # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Long_Right2|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 0,
                "linear": 1,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Long_Left2 [Indent level: 2],
        "long_left2": {
            "useflare": 1,
            ...
            "conefadecoef": 51,
            "intensity": 1,
            # Class: CfgVehicles|rhsusf_himars_base|Reflectors|Long_Left2|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 0,
                "linear": 1,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Reflectors|cabin1 [Indent level: 2],
        "cabin1": {
            "color": [800,900,650],
            "ambient": [5,0,0],
            "intensity": 4,
            ...
            "daylight": 0,
            "blinking": 0,
            # Class: CfgVehicles|rhsusf_himars_base|Reflectors|cabin1|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 0,
                "linear": 1,
    ...
    "armorlights": 0.01,
    # Class: CfgVehicles|rhsusf_himars_base|RenderTargets [Indent level: 1],
    "rendertargets": {
        # Class: CfgVehicles|rhsusf_himars_base|RenderTargets|LeftMirror [Indent level: 2]
        "leftmirror": {
            "rendertarget": "rendertarget0",
            # Class: CfgVehicles|rhsusf_himars_base|RenderTargets|LeftMirror|CameraView1 [Indent level: 3],
            "cameraview1": {
                "pointposition": "m1p",
                "pointdirection": "m1d",
                "renderquality": 2,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|RenderTargets|RightMirror [Indent level: 2],
        "rightmirror": {
            "rendertarget": "rendertarget1",
            # Class: CfgVehicles|rhsusf_himars_base|RenderTargets|RightMirror|CameraView1 [Indent level: 3],
            "cameraview1": {
                "pointposition": "m2p",
                "pointdirection": "m2d",
                "renderquality": 2,
        ...
        # Class: CfgVehicles|rhsusf_himars_base|RenderTargets|DVE_Monitor [Indent level: 2],
        "dve_monitor": {
            "rendertarget": "rendertarget_dve",
            # Class: CfgVehicles|rhsusf_himars_base|RenderTargets|DVE_Monitor|CameraView1 [Indent level: 3],
            "cameraview1": {
    ...
    # Class: CfgVehicles|rhsusf_himars_base|complexGearbox [Indent level: 1],
    "complexgearbox": {
    ...
    # Class: CfgVehicles|rhsusf_himars_base|Wheels [Indent level: 1],
    "wheels": {
        # Class: CfgVehicles|rhsusf_himars_base|Wheels|L1 [Indent level: 2]
        "l1": {
            "side": "left",
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Wheels|L2 [Indent level: 2],
        "l2": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Wheels|L3 [Indent level: 2],
        "l3": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Wheels|R1 [Indent level: 2],
        "r1": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Wheels|R2 [Indent level: 2],
        "r2": {
        ...
        # Class: CfgVehicles|rhsusf_himars_base|Wheels|R3 [Indent level: 2],
        "r3": {
    ...
    # Class: CfgVehicles|rhsusf_himars_base|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhsusf_himars_base|Exhausts|Exhaust1 [Indent level: 2]
        "exhaust1": {
    ...
    # Class: CfgVehicles|rhsusf_himars_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["a3|data_f|glass_veh.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_int.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","rhsusf|addons|rhsusf_rg33|data|kamaz_glass_in.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|default.rvmat","a3|data_f|default.rvmat","a3|data_f|default_destruct.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Cab.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Cab_dam.rvmat","rhsusf|addons|rhsusf_himars|data|M142_destruction.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Chassis.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Chassis_dam.rvmat","rhsusf|addons|rhsusf_himars|data|M142_destruction.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Rear.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Rear_dam.rvmat","rhsusf|addons|rhsusf_himars|data|M142_destruction.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Int.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Int_dam.rvmat","rhsusf|addons|rhsusf_himars|data|M142_destruction.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Int.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Int_dam.rvmat","rhsusf|addons|rhsusf_himars|data|M142_destruction.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Wheel.rvmat","rhsusf|addons|rhsusf_himars|data|M142_Wheel_dam.rvmat","rhsusf|addons|rhsusf_himars|data|M142_destruction.rvmat"]
    },
    # Class: CfgVehicles|rhsusf_himars_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhsusf_himars_base|EventHandlers|RHSUSF_EventHandlers [Indent level: 2]
    ...
    # Class: CfgVehicles|rhsusf_himars_base|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|rhsusf_himars_base|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            "uipicture": "rhsusf|addons|rhsusf_himars|Pictures|RHS_M142_EDEN_CA.paa",
            # Class: CfgVehicles|rhsusf_himars_base|Components|TransportPylonsComponent|pylons [Indent level: 3],
            "pylons": {
                # Class: CfgVehicles|rhsusf_himars_base|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
    ...
    # Class: CfgVehicles|rhsusf_himars_base|TransportBackpacks [Indent level: 1],
    "transportbackpacks": {
        # Class: CfgVehicles|rhsusf_himars_base|TransportBackpacks|_xx_rhsusf_falconii [Indent level: 2]
        "_xx_rhsusf_falconii": {
            "backpack": "rhsusf_falconii",
            "count": 1
        }
    },
    # Class: CfgVehicles|rhsusf_himars_base|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsusf_himars_base|TransportMagazines|_xx_rhs_mag_30Rnd_556x45_M855A1_Stanag [Indent level: 2]
        "_xx_rhs_mag_30rnd_556x45_m855a1_stanag": {
            "count": 10,
            "magazine": "rhs_mag_30Rnd_556x45_M855A1_Stanag"
        },
        # Class: CfgVehicles|rhsusf_himars_base|TransportMagazines|_xx_rhs_mag_m67 [Indent level: 2],
        "_xx_rhs_mag_m67": {
            "count": 2,
            "magazine": "rhs_mag_m67"
        },
        # Class: CfgVehicles|rhsusf_himars_base|TransportMagazines|_xx_rhs_mag_an_m8hc [Indent level: 2],
        "_xx_rhs_mag_an_m8hc": {
            "count": 4,
            "magazine": "rhs_mag_an_m8hc"
        }
    },
    # Class: CfgVehicles|rhsusf_himars_base|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_himars_base|TransportItems|_xx_FirstAidKit [Indent level: 2]
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 4
        },
        # Class: CfgVehicles|rhsusf_himars_base|TransportItems|_xx_Toolkit [Indent level: 2],
        "_xx_toolkit": {
            "name": "Toolkit",
            "count": 1
        }
    },
    # Class: CfgVehicles|rhsusf_himars_base|TransportWeapons [Indent level: 1],
    "transportweapons": {
        # Class: CfgVehicles|rhsusf_himars_base|TransportWeapons|_xx_weap [Indent level: 2]
        "_xx_weap": {
            "count": 2,
