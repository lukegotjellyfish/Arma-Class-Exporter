rhs_ch_47f_light = {
    ...
    "editorpreview": "rhsusf|addons|rhsusf_editorPreviews|data|RHS_CH_47F_light.paa",
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_a2port_air|ch47|data|ch47_ext_1_light_co.paa","rhsusf|addons|rhsusf_a2port_air|ch47|data|ch47_ext_2_light_co.paa","rhsusf|addons|rhsusf_a2port_air|ch47|data|ch47f_nalepky_ca.paa","rhsusf|addons|rhsusf_a2port_air|ch47|data|ch47_ext_light_mlod_co.paa"],
    "accuracy": 1000,
