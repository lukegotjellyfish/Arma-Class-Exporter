rhs_mag_smokegen = {
    "scope": 2,
    "count": 999,
    # Ammo: CfgMagazines|rhs_mag_smokegen|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_smokegen",
        # Class: CfgAmmo|rhs_ammo_smokegen|EventHandlers [Indent level: 1],
        "eventhandlers": {
            # Class: CfgAmmo|rhs_ammo_smokegen|EventHandlers|RHS_CM [Indent level: 2]
            "rhs_cm": {
