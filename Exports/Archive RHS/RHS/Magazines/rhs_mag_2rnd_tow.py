rhs_mag_2rnd_tow = {
    "scope": 2,
    # Ammo: CfgMagazines|rhs_mag_2Rnd_TOW|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_TOW_AT",
        # Ammo: CfgAmmo|rhs_ammo_TOW_AT|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
    ...
    "mindamageforcamshakehit": "rhs_ammo_TOW_AT",
