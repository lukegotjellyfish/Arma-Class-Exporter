rhs_30rnd_545x39_ak_plum_green = {
    ...
    "displayname": "30rnd AK-74 (Plum) 7Т3М (Tracer)",
    ...
    "descriptionshort": "Caliber: 5.45x39mm Tracers<br />Rounds: 30<br />Used in: AK-74M, AK-105",
    "displaynameshort": "7T3M Tracer",
    # Ammo: CfgMagazines|rhs_30Rnd_545x39_AK_green|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_B_545x39_Ball_Tracer_Green",
    ...
    "eventhandlers": "rhs_B_545x39_Ball_Tracer_Green",
    "initspeed": 883,
    "tracersevery": 1,
    "scope": 2,
