rhs_weap_mk17_lb_grip = {
    ...
    # Class: CfgWeapons|rhs_weap_mk17_LB_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk17_LB_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip1",
            "slot": "UnderBarrelSlot"
        }
    },
    "rhs_fold": "rhs_weap_mk17_LB_Folded_grip",
    "scope": 2,
