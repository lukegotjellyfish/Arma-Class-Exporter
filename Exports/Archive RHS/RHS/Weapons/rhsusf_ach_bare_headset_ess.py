rhsusf_ach_bare_headset_ess = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_bare_headset_ess_ca.paa",
    "displayname": "ACH (Headset/ESS)",
    "allowedfacewear": ["",6,"rhs_googles_black",3,"rhs_googles_clear",1],
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|ach_bare_headset_ess",
    "hiddenselections": ["Camo","Camo1"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_mich_green_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa"],
    # Class: CfgWeapons|rhsusf_ach_bare_headset_ess|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry|gear|head|ach_bare_headset_ess",
        "mass": 40,
        "hiddenselections": ["Camo","Camo1"],
