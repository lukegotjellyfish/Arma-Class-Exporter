rhsgref_patrolcap_specter = {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_cdf|cappatrol_specters_co.paa"],
    # Class: CfgWeapons|rhsgref_patrolcap_specter|ItemInfo [Indent level: 1],
    "iteminfo": {
