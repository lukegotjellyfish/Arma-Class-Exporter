rhsgref_acc_zendl = {
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|accessories|rhsgref_acc_zendl_ca.paa",
    "author": "Red Hammer Studios",
    "scope": 2,
    "model": "rhsgref|addons|rhsgref_weapons|acc|muzzle|zendl_comp|zendl.p3d",
    "displayname": "Zendl compensator",
    # Class: CfgWeapons|rhsgref_acc_zendl|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 5,
        "soundtypeindex": 0,
        # Class: CfgWeapons|rhsgref_acc_zendl|ItemInfo|MagazineCoef [Indent level: 2],
        "magazinecoef": {
            "initspeed": 1
        },
        # Class: CfgWeapons|rhsgref_acc_zendl|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "typicalspeed": 1,
            "airfriction": 1,
        ...
        # Class: CfgWeapons|rhsgref_acc_zendl|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
