rhsgref_helmet_pasgt_altis_lizard = {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|pasgt_helmet_altis_lizard_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_pasgt_altis_lizard|ItemInfo [Indent level: 1],
    "iteminfo": {
