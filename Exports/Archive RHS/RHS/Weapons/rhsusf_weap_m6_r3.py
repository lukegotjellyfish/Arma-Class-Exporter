rhsusf_weap_m6_r3 = {
    "magazines": ["rhsusf_mag_L8A3_R3_8"],
    # Class: CfgWeapons|rhsusf_weap_M6_R3|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M6_R3|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
