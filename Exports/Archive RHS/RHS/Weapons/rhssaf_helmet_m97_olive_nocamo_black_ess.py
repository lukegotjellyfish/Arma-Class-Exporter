rhssaf_helmet_m97_olive_nocamo_black_ess = {
    ...
    # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo_black_ess|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 42,
        ...
        "modelsides": [6],
        "hiddenselections": ["camo","camo2"],
        # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo_black_ess|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhssaf_helmet_m97_olive_nocamo_black_ess|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
