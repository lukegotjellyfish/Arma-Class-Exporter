rhs_weap_m249_light_s_elcan = {
    # Class: CfgWeapons|rhs_weap_m249_light_S_elcan|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m249_light_S_elcan|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ELCAN_ard"
        },
        # Class: CfgWeapons|rhs_weap_m249_light_S_elcan|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15side"
        },
        # Class: CfgWeapons|rhs_weap_m249_light_S_elcan|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
    ...
    "displayname": "M249 PIP (Short/Ltwt.)",
