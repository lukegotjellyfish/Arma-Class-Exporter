rhs_acc_ekp8_18b = {
    ...
    "model": "rhsafrf|addons|rhs_accessory|scopes|ekp-8-02|rhs_ekp_8_18b",
    "rhs_accessory_next": "rhs_acc_ekp8_18c",
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_ekp8_18_ca.paa",
    "displayname": "EKP-8-18",
    "descriptionshort": "Collimator Sight<br />Magnification: 1x",
    "inertia": 0,
    "weaponinfotype": "RHS_RscOptics_Kobra",
    # Class: CfgWeapons|rhs_acc_1p63|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 8.8,
        ...
        # Class: CfgWeapons|rhs_acc_1p63|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_1p63|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
