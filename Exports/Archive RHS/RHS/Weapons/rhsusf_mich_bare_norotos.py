rhsusf_mich_bare_norotos = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_mich_bare_norotos|ItemInfo [Indent level: 1],
    "iteminfo": {
