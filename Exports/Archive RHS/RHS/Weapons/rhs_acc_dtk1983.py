rhs_acc_dtk1983 = {
    ...
    # Class: CfgWeapons|rhs_acc_dtk1983|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_dtk1983|ItemInfo|AmmoCoef [Indent level: 2]
        "ammocoef": {
            "visiblefire": 0.85,
        ...
        # Class: CfgWeapons|rhs_acc_dtk1983|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
