rhs_weap_dagr_launcher = {
    ...
    "magazines": ["rhs_mag_DAGR_4","rhs_mag_DAGR_8","rhs_mag_DAGR_16","rhs_mag_DAGR_4_plane","rhs_mag_DAGR_8_plane"],
    "weaponlockdelay": 3,
    "cursoraim": "EmptyCursor",
    "cursor": "EmptyCursor",
    "showaimcursorinternal": 0,
    # Class: CfgWeapons|rhs_weap_DAGR_Launcher|Direct [Indent level: 1],
    "direct": {
        "texturetype": "semi",
        "displayname": "LOBL",
        "airateoffire": 5,
        ...
        # Class: CfgWeapons|rhs_weap_DAGR_Launcher|Direct|StandardSound [Indent level: 2],
        "standardsound": {
    ...
    # Class: CfgWeapons|rhs_weap_DAGR_Launcher|LoalDistance [Indent level: 1],
    "loaldistance": {
        "displayname": "LOAL-DIR",
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_DAGR_Launcher|LoalDistance|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": ["rhsusf|addons|rhsusf_melb|Sound|M260|M260_1",2.6,1,1800],
            "begin2": ["rhsusf|addons|rhsusf_melb|Sound|M260|M260_2",2.6,1,1800],
            "soundbegin": ["begin1",0.5,"begin2",0.5]
