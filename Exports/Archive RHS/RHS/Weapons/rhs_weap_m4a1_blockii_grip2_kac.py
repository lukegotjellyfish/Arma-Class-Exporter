rhs_weap_m4a1_blockii_grip2_kac = {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
