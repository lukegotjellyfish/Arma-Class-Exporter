rhs_weap_m1garand_base_f = {
    ...
    "cameradir": "eye_look",
    "maxzeroing": 1200,
    # Class: CfgWeapons|rhs_weap_M1garand_Base_F|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_M1garand_Base_F|WeaponSlotsInfo|PointerSlot [Indent level: 2]
        "pointerslot": {
        },
        # Class: CfgWeapons|rhs_weap_M1garand_Base_F|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_M1garand_Base_F|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        },
        # Class: CfgWeapons|rhs_weap_M1garand_Base_F|WeaponSlotsInfo|UnderBarrelSlot [Indent level: 2],
        "underbarrelslot": {
        },
        "mass": 2,
        "allowedslots": [901]
