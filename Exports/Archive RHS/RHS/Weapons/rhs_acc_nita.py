rhs_acc_nita = {
    ...
    # Class: CfgWeapons|rhs_acc_nita|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 11.64,
        ...
        # Class: CfgWeapons|rhs_acc_nita|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_nita|ItemInfo|OpticsModes|rhs_nita_scope [Indent level: 3]
            "rhs_nita_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_nita|ItemInfo|OpticsModes|rhs_nita_iron [Indent level: 3],
            "rhs_nita_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
