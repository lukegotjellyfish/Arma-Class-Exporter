rhs_weap_vmf_vss = {
    # Class: CfgWeapons|rhs_weap_vmf_vss|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_vmf_vss|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_pso1m21"
        },
        # Class: CfgWeapons|rhs_weap_vmf_vss|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
