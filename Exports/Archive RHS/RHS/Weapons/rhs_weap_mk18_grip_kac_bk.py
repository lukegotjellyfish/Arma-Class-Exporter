rhs_weap_mk18_grip_kac_bk = {
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip_KAC_bk|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 54.56,
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip_KAC_bk|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_grip_KAC_bk|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
