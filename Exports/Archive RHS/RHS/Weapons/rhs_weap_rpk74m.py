rhs_weap_rpk74m = {
    ...
    "dexterity": 1.3,
    "displayname": "RPK-74",
    # Class: CfgWeapons|rhs_weap_rpk74m|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 50,
        # Class: CfgWeapons|rhs_weap_rpk74m|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        },
        # Class: CfgWeapons|rhs_weap_rpk74m|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_rpk74m|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
        "allowedslots": []
    },
    ...
    # Class: CfgWeapons|rhs_weap_rpk74|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.092,
        "dispersion": 0.00123,
        "autofire": 0,
        ...
        # Class: CfgWeapons|rhs_weap_rpk74|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundclosure": [],
            "begin1": ["rhsafrf|addons|rhs_sounds|rpk|rpk_1",2.35,1,2000],
            "begin2": ["rhsafrf|addons|rhs_sounds|rpk|rpk_2",2.35,1,2000],
    ...
    # Class: CfgWeapons|rhs_weap_rpk74|Manual [Indent level: 1],
    "manual": {
        "reloadtime": 0.092,
        "dispersion": 0.00123,
        "aiburstterminable": 1,
        ...
        "showtoplayer": 1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_rpk74|Manual|StandardSound [Indent level: 2],
        "standardsound": {
            "soundclosure": [],
            "begin1": ["rhsafrf|addons|rhs_sounds|rpk|rpk_1",2.35,1,2000],
            "begin2": ["rhsafrf|addons|rhs_sounds|rpk|rpk_2",2.35,1,2000],
    ...
    # Class: CfgWeapons|rhs_weap_rpk74|close [Indent level: 1],
    "close": {
        "burst": 6,
        "burstrangemax": 12,
        "airateoffire": 0.5,
    ...
    # Class: CfgWeapons|rhs_weap_rpk74|short [Indent level: 1],
    "short": {
        "burst": 5,
        "burstrangemax": 10,
        "airateoffire": 2,
    ...
    # Class: CfgWeapons|rhs_weap_rpk74|medium [Indent level: 1],
    "medium": {
        "burst": 5,
        "burstrangemax": 8,
        "airateoffire": 4,
    ...
    # Class: CfgWeapons|rhs_weap_rpk74|far_optic1 [Indent level: 1],
    "far_optic1": {
        "requiredoptictype": 1,
        "showtoplayer": 0,
        "burst": 3,
    ...
    # Class: CfgWeapons|rhs_weap_rpk74|far_optic2 [Indent level: 1],
    "far_optic2": {
        "burst": 3,
        "burstrangemax": 6,
        "requiredoptictype": 2,
