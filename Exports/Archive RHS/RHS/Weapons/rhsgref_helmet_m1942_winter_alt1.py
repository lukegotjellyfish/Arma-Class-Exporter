rhsgref_helmet_m1942_winter_alt1 = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1942_winter_alt1_ca.paa",
    "displayname": "M42 (Strap Up/Winter)",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|M1942_strapup",
    # Class: CfgWeapons|rhsgref_helmet_m1942_winter_alt1|ItemInfo [Indent level: 1],
    "iteminfo": {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1942_w_co.paa","rhsgref|addons|rhsgref_infantry|gear|Head|data|decals|blank_ca.paa"],
    "hiddenselections": ["Camo","Camo1"],
