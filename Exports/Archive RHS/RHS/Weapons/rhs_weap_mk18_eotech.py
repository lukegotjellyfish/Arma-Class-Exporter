rhs_weap_mk18_eotech = {
    # Class: CfgWeapons|rhs_weap_mk18_eotech|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_eotech|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_eotech_xps3"
        },
        # Class: CfgWeapons|rhs_weap_mk18_eotech|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
