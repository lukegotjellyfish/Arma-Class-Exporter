rhs_weap_d30_at = {
    ...
    "autoreload": 1,
    "reloadsound": ["",3.16228,1,200],
    # Class: CfgWeapons|rhs_weap_d30_at|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_d30_at|GunParticles|Effect1 [Indent level: 2]
        "effect1": {
            "directionname": "Konec hlavne",
            "effectname": "ArtilleryFired1",
            "positionname": "Usti hlavne"
        },
        # Class: CfgWeapons|rhs_weap_d30_at|GunParticles|Effec2 [Indent level: 2],
        "effec2": {
