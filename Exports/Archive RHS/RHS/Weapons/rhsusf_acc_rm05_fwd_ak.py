rhsusf_acc_rm05_fwd_ak = {
    ...
    "model": "rhsusf|addons|rhsusf_scopes|rmr|rhs_rm05_front_ak",
    "weaponinfotype": "RHS_RMR_fwd",
    "displayname": "RM05 RMR LT726 (Forward)",
    "rhs_t1_base": "rhsusf_acc_RM05_fwd",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_RM05_ca.paa",
    "descriptionshort": "Collimator Sight<br />Magnification: 1x",
    "inertia": 0,
    # Class: CfgWeapons|rhsusf_acc_RM05|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_RM05|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_RM05|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "distancezoommin": 100,
                "distancezoommax": 100,
                "opticsid": 1,
