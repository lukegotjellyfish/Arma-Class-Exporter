rhsgref_helmet_m1942_winter = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1942_winter_ca.paa",
    ...
    # Class: CfgWeapons|rhsgref_helmet_m1942_winter|ItemInfo [Indent level: 1],
    "iteminfo": {
