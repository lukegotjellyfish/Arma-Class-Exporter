rhsusf_mich_bare_norotos_arc_semi = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_arc_semi_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_arc_semi|ItemInfo [Indent level: 1],
    "iteminfo": {
