rhs_6b5_sniper_ttsko = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhs_6b5_sniper_ttsko_ca.paa",
    "displayname": "6B5-19 TTsKO (Sniper)",
    ...
    # Class: CfgWeapons|rhs_6b5_sniper|ItemInfo [Indent level: 1],
    "iteminfo": {
