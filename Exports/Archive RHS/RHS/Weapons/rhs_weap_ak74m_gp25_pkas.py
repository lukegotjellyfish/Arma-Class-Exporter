rhs_weap_ak74m_gp25_pkas = {
    # Class: CfgWeapons|rhs_weap_ak74m_gp25_pkas|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak74m_gp25_pkas|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_pkas"
        },
        # Class: CfgWeapons|rhs_weap_ak74m_gp25_pkas|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtk"
        }
