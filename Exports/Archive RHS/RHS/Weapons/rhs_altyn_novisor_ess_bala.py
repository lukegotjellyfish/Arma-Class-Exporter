rhs_altyn_novisor_ess_bala = {
    ...
    "displayname": "Altyn (ESS/Balaclava)",
    "model": "rhsafrf|addons|rhs_infantry2|gear|head|rhs_altyn_novisor_ess_bala",
    # Class: CfgWeapons|rhs_altyn_novisor_ess_bala|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsafrf|addons|rhs_infantry2|gear|head|rhs_altyn_novisor_ess_bala",
        "hiddenselections": ["Camo1"],
        # Class: CfgWeapons|rhs_altyn|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_altyn|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
