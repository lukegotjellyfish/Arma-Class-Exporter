rhsgref_hat_m1951 = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_hat_M1951_ca.paa",
    "displayname": "Patrol Cap (OG-107)",
    "scope": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|M1951cap",
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|m1951fieldcap_co.paa"],
    # Class: CfgWeapons|rhsgref_hat_M1951|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 5,
        "uniformmodel": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|M1951cap",
        "allowedslots": [801,901,701,605],
        "modelsides": [6],
        # Class: CfgWeapons|rhsgref_hat_M1951|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_hat_M1951|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
