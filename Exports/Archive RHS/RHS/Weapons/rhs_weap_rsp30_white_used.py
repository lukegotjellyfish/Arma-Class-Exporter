rhs_weap_rsp30_white_used = {
    ...
    "descriptionshort": "ROP-30 White Flare",
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_weapons|rsp30|rhs_rsp30_white_co.paa"],
    "hiddenselectionsmaterials": ["rhsafrf|addons|rhs_weapons|rsp30|rhs_rsp30_white.rvmat"],
    "optics": 0,
    "sounds": ["StandardSound"],
    # Class: CfgWeapons|rhs_weap_rsp30_white|BaseSoundModeType [Indent level: 1],
    "basesoundmodetype": {
    ...
    # Class: CfgWeapons|rhs_weap_rsp30_white|StandardSound [Indent level: 1],
    "standardsound": {
    ...
    # Class: CfgWeapons|rhs_weap_rsp30_white|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_rsp30_white|GunParticles|Effect1 [Indent level: 2]
        "effect1": {
            "effectname": "StarterPistolCloud1",
            "positionname": "usti hlavne",
            "directionname": "konec hlavne"
        },
        # Class: CfgWeapons|rhs_weap_rsp30_white|GunParticles|Effect2 [Indent level: 2],
        "effect2": {
    ...
    # Class: CfgWeapons|rhs_weap_rsp30_white|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 10,
        "holsterscale": 0
    },
    # Class: CfgWeapons|rhs_weap_rsp30_white|Eventhandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhs_weap_rsp30_white|Eventhandlers|RHS_DisposableWeapon [Indent level: 2]
        "rhs_disposableweapon": {
            "fired": "_this call rhs_fnc_disposable;"
        }
    },
    "baseweapon": "rhs_weap_rsp30_white",
