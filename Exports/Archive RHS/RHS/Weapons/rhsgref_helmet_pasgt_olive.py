rhsgref_helmet_pasgt_olive = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_pasgt_olive_ca.paa",
    "scope": 2,
    "displayname": "PASGT (Olive)",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|pasgt_helmet_olive_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_pasgt_olive|ItemInfo [Indent level: 1],
    "iteminfo": {
