rhs_mag_kh38mle_int = {
    ...
    # Ammo: CfgMagazines|rhs_mag_Kh38mle_int|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_Kh38MLE",
    ...
    "mindamageforcamshakehit": "rhs_ammo_Kh38MLE",
    "hardpoints": ["RHS_HP_Kh38_INT"],
    "ejectspeed": [1,0,0],
    "initspeed": 0,
    "initspeedy": -25,
    "initspeedz": 0,
