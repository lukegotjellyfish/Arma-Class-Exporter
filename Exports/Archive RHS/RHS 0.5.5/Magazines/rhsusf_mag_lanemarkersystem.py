rhsusf_mag_lanemarkersystem = {
    "count": 50,
    "scope": 2,
    # Ammo: CfgMagazines|rhsusf_mag_laneMarkerSystem|ammo [Indent level: 1],
    "ammo": {
        ...
        "indirecthit": 0,
        "indirecthitrange": 0,
        # Class: CfgAmmo|rhsusf_ammo_laneMarkerSystem|EventHandlers [Indent level: 1],
        "eventhandlers": {
            # Class: CfgAmmo|rhsusf_ammo_laneMarkerSystem|EventHandlers|RHS_CM [Indent level: 2]
            "rhs_cm": {
