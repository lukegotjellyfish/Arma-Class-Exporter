rhs_mag_m31_6 = {
    ...
    # Ammo: CfgMagazines|rhs_mag_m31_6|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_m31_rocket",
        "model": "rhsusf|addons|rhsusf_heavyweapons|rockets|rhs_M30_rocket_fly.p3d",
        # Ammo: CfgAmmo|rhs_ammo_m31_rocket|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_m31_rocket_deploy",
        "artillerylock": 1,
        "triggerdistance": 500,
        "cost": 1000,
        "airfriction": 0,
