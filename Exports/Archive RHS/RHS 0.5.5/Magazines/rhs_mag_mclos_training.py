rhs_mag_mclos_training = {
    ...
    "count": 999,
    # Ammo: CfgMagazines|rhs_mag_MCLOS_Training|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_mclos_training",
        "hit": 24,
        # Ammo: CfgAmmo|rhs_ammo_mclos_training|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_mclos_training_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
        ...
        "locktype": 0,
        # Class: CfgAmmo|rhs_ammo_9m14|EventHandlers [Indent level: 1],
        "eventhandlers": {
            # Class: CfgAmmo|rhs_ammo_9m14|EventHandlers|RHS_Guidance [Indent level: 2]
            "rhs_guidance": {
