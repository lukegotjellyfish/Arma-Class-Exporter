rhs_mag_smoke_2a33 = {
    ...
    "count": 5,
    # Ammo: CfgMagazines|rhs_mag_SMOKE_2a33|ammo [Indent level: 1],
    "ammo": {
        ...
        "cratereffects": "",
        "whistledist": 0,
        # Ammo: CfgAmmo|Smoke_120mm_AMOS_White|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
