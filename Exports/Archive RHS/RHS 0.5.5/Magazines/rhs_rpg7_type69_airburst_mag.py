rhs_rpg7_type69_airburst_mag = {
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_weapons|rpg7|data|rhs_rpg7v2_02_co.paa","rhsafrf|addons|rhs_weapons|rpg7|data|type_69_co.paa"],
    # Ammo: CfgMagazines|rhs_rpg7_type69_airburst_mag|ammo [Indent level: 1],
    "ammo": {
        ...
        # Class: CfgAmmo|rhs_rpg7v2_type63_airburst|EventHandlers [Indent level: 1],
        "eventhandlers": {
            # Class: CfgAmmo|rhs_rpg7v2_type63_airburst|EventHandlers|RHS_Airburst [Indent level: 2]
            "rhs_airburst": {
