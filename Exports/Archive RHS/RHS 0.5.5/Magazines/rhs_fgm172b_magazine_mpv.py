rhs_fgm172b_magazine_mpv = {
    ...
    "count": 1,
    # Ammo: CfgMagazines|rhs_fgm172b_magazine_MPV|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_M_fgm172b_MPV",
        # Ammo: CfgAmmo|rhs_ammo_M_fgm172b_MPV|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_M_fgm148_AT_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
        ...
        # Class: CfgAmmo|M_NLAW_AT_F|CamShakeExplode [Indent level: 1],
        "camshakeexplode": {
            "power": 11,
            "duration": 1.4,
            "frequency": 20,
        ...
        # Class: CfgAmmo|M_NLAW_AT_F|CamShakeHit [Indent level: 1],
        "camshakehit": {
            "power": 110,
            "duration": 0.6,
            "frequency": 20,
        ...
        # Class: CfgAmmo|M_NLAW_AT_F|CamShakeFire [Indent level: 1],
        "camshakefire": {
            "power": 2.51487,
            "duration": 1.2,
            "frequency": 20,
        ...
        # Class: CfgAmmo|M_NLAW_AT_F|CamShakePlayerFire [Indent level: 1],
        "camshakeplayerfire": {
            "power": 2,
            "duration": 0.1,
            "frequency": 20,
        ...
        # Class: CfgAmmo|M_NLAW_AT_F|Direct [Indent level: 1],
        "direct": {
        },
        # Class: CfgAmmo|M_NLAW_AT_F|Overfly [Indent level: 1],
        "overfly": {
        ...
        "cmimmunity": 0.2,
        # Class: CfgAmmo|M_NLAW_AT_F|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|M_NLAW_AT_F|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|M_NLAW_AT_F|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|M_NLAW_AT_F|Components|SensorsManagerComponent|Components|VisualSensorComponent [Indent level: 4]
                    "visualsensorcomponent": {
                        # Class: CfgAmmo|M_NLAW_AT_F|Components|SensorsManagerComponent|Components|VisualSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 800,
                        ...
                        # Class: CfgAmmo|M_NLAW_AT_F|Components|SensorsManagerComponent|Components|VisualSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 800,
                            "objectdistancelimitcoef": 1,
