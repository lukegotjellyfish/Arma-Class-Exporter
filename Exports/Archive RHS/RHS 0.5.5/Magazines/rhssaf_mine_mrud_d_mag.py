rhssaf_mine_mrud_d_mag = {
    ...
    # Ammo: CfgMagazines|rhssaf_mine_mrud_d_mag|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhssaf_mine_mrud_d_ammo",
    ...
    "mass": 48.4,
    # Class: CfgMagazines|rhssaf_mine_mrud_a_mag|Library [Indent level: 1],
    "library": {
