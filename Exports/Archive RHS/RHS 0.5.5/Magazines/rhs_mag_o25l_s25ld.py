rhs_mag_o25l_s25ld = {
    ...
    # Ammo: CfgMagazines|rhs_mag_o25l_s25ld|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_s25ld",
        "maxcontrolrange": 10000,
        "missilelockmaxdistance": 10000,
        # Class: CfgAmmo|rhs_ammo_s25ld|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_s25ld|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_s25ld|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_s25ld|Components|SensorsManagerComponent|Components|LaserSensorComponent [Indent level: 4]
                    "lasersensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_s25ld|Components|SensorsManagerComponent|Components|LaserSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 10000,
                            "maxrange": 10000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_s25ld|Components|SensorsManagerComponent|Components|LaserSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 10000,
                            "maxrange": 10000,
                            "objectdistancelimitcoef": -1,
