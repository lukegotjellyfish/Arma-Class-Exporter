rhs_mag_kh29d = {
    # Ammo: CfgMagazines|rhs_mag_kh29D|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_kh29D",
        "weaponlocksystem": "2 + 16",
        "rhs_tv_guidance": "TI",
        # Class: CfgAmmo|rhs_ammo_kh29d|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_kh29d|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_kh29d|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_kh29d|Components|SensorsManagerComponent|Components|IRSensorComponent [Indent level: 4]
                    "irsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_kh29d|Components|SensorsManagerComponent|Components|IRSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 9000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_kh29d|Components|SensorsManagerComponent|Components|IRSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 9000,
                            "objectdistancelimitcoef": 1,
    ...
    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements [Indent level: 1],
    "mfdelements": {
        # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_ammoname [Indent level: 2]
        "rhs_rus_ammoname": {
            # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_ammoname|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_ammoname|Draw [Indent level: 3],
            "draw": {
                "condition": "PylonSelected",
                "color": [0.15,1,0.15],
                "alpha": 1,
                # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_ammoname|Draw|PylonText1 [Indent level: 4],
                "pylontext1": {
                    "type": "text",
                    "source": "static",
                    "text": "Х29Д",
        ...
        # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_ammoname_right [Indent level: 2],
        "rhs_rus_ammoname_right": {
            # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_ammoname_right|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_ammoname_right|Draw [Indent level: 3],
            "draw": {
                "condition": "PylonSelected",
                "color": [0.15,1,0.15],
                "alpha": 1,
                # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_ammoname_right|Draw|PylonText1 [Indent level: 4],
                "pylontext1": {
                    "type": "text",
                    "source": "static",
                    "text": "Х29Д",
        ...
        # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_su25_box [Indent level: 2],
        "rhs_su25_box": {
            # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_su25_box|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_su25_box|Draw [Indent level: 3],
            "draw": {
                "condition": "1-pylonMagazineEmpty",
                "color": [0.15,1,0.15,1],
                "alpha": 0.22,
                # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_su25_box|Draw|Shape [Indent level: 4],
                "shape": {
                    "type": "polygon",
                    "width": 4,
                    "points": [[[[-0.022,-0.04],1],[[0.022,-0.04],1],[[0.022,0.04],1],[[-0.022,0.04],1]]]
                },
                # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_su25_box|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "PylonSelected*(PylonAmmoRelative>=0.001)",
                    "color": [0.58,0.23,0],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_su25_box|Draw|Selected|Shape [Indent level: 5],
                    "shape": {
                        "type": "polygon",
                        "width": 4,
        ...
        # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle [Indent level: 2],
        "rhs_rus_circle": {
            # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Bones [Indent level: 3]
            "bones": {
                # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Bones|Center [Indent level: 4]
                "center": {
                    "type": "fixed",
                    "pos": [0,0]
                }
            },
            # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw [Indent level: 3],
            "draw": {
                "color": [0.15,1,0.15,1],
                "alpha": 0.22,
                # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Default [Indent level: 4],
                "default": {
                    "condition": "1-PylonSelected-pylonMagazineEmpty",
                    "color": [1,1,1],
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Default|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "Х29Д",
                    ...
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Default|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                ...
                # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "PylonSelected*(PylonAmmoRelative>=0.001)",
                    "color": [0.15,1,0.15,1],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Selected|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "Х29Д",
                    ...
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Selected|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0226277],1],["Center",[0.01,-0.0195956],1],["Center",[0.01732,-0.0113139],1],["Center",[0.02,0],1],["Center",[0.01732,0.0113139],1],["Center",[0.01,0.0195956],1],["Center",[0,0.0226277],1],["Center",[-0.01,0.0195956],1],["Center",[-0.01732,0.0113139],1],["Center",[-0.02,0],1],["Center",[-0.01732,-0.0113139],1],["Center",[-0.01,-0.0195956],1],["Center",[0,-0.0226277],1],[],["Center",[0.0141421,-0.0160002],1],["Center",[0.0282843,-0.0320005],1],[],["Center",[0.0141421,0.0160002],1],["Center",[0.0282843,0.0320005],1],[],["Center",[-0.0141421,0.0160002],1],["Center",[-0.0282843,0.0320005],1],[],["Center",[-0.0141421,-0.0160002],1],["Center",[-0.0282843,-0.0320004],1],[]]
                    },
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Selected|Polygon [Indent level: 5],
                    "polygon": {
                        "type": "polygon",
                        "width": 4,
                ...
                # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Empty [Indent level: 4],
                "empty": {
                    "condition": "pylonMagazineEmpty",
                    "color": [1,0,0,1],
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Empty|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "Х29Д",
                    ...
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Empty|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0226277],1],["Center",[0.01,-0.0195956],1],["Center",[0.01732,-0.0113139],1],["Center",[0.02,0],1],["Center",[0.01732,0.0113139],1],["Center",[0.01,0.0195956],1],["Center",[0,0.0226277],1],["Center",[-0.01,0.0195956],1],["Center",[-0.01732,0.0113139],1],["Center",[-0.02,0],1],["Center",[-0.01732,-0.0113139],1],["Center",[-0.01,-0.0195956],1],["Center",[0,-0.0226277],1],[],["Center",[0.0141421,-0.0160002],1],["Center",[0.0282843,-0.0320005],1],[],["Center",[0.0141421,0.0160002],1],["Center",[0.0282843,0.0320005],1],[],["Center",[-0.0141421,0.0160002],1],["Center",[-0.0282843,0.0320005],1],[],["Center",[-0.0141421,-0.0160002],1],["Center",[-0.0282843,-0.0320004],1],[]]
                    },
                    # Class: CfgMagazines|rhs_mag_kh29D|mfdElements|rhs_rus_circle|Draw|Empty|Polygon [Indent level: 5],
                    "polygon": {
                        "type": "polygon",
                        "width": 4,
                        "points": [[["Center",1,[0,0],1],["Center",[0.0141421,-0.0160002],1],["Center",[0.02,9.8909e-010],1],["Center",[0.0141421,0.0160002],1]],[["Center",1,[0,0],1],["Center",[0.0141421,0.0160002],1],["Center",[-1.74846e-009,0.0226277],1],["Center",[-0.0141421,0.0160002],1]],[["Center",1,[0,0],1],["Center",[-0.0141421,0.0160002],1],["Center",[-0.02,-2.69833e-010],1],["Center",[-0.0141421,-0.0160002],1]],[["Center",1,[0,0],1],["Center",[-0.0141421,-0.0160002],1],["Center",[3.49691e-009,-0.0226277],1],["Center",[0.0141421,-0.0160002],1]]]
