rhsgref_brdm2_hq_ins = {
    ...
    # Class: CfgVehicles|rhsgref_BRDM2_HQ_ins|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_BRDM2_HQ_ins|AnimationSources|small_numbers_hide [Indent level: 2]
        "small_numbers_hide": {
            "initphase": 1,
            "source": "user",
            "animperiod": 0
