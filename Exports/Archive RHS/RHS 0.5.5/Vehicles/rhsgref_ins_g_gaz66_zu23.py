rhsgref_ins_g_gaz66_zu23 = {
    ...
    # Class: CfgVehicles|rhsgref_ins_g_gaz66_zu23|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_g_gaz66_zu23|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            ...
            "opticsin": {
                # Class: CfgVehicles|rhs_gaz66_zu23_base|Turrets|MainTurret|OpticsIn|Collimator [Indent level: 4]
                "collimator": {
                ...
                # Class: CfgVehicles|rhs_gaz66_zu23_base|Turrets|MainTurret|OpticsIn|CollimatorZoom [Indent level: 4],
                "collimatorzoom": {
                    "initfov": 0.35,
                    "minfov": 0.35,
                    "maxfov": 0.35,
                ...
                # Class: CfgVehicles|rhs_gaz66_zu23_base|Turrets|MainTurret|OpticsIn|T3_Optic [Indent level: 4],
                "t3_optic": {
            ...
            "turnin": {
                ...
                "limitsarraybottom": [[-10,-180],[-8,-28.6867],[14.3683,-26.6867],[18,0],[14.7173,26.6372],[-8,27.6867],"",[-10,134],[-6,134.5],[-6,178],[-10,180]]
            },
            ...
            "hitpoints": {
                ...
                # Class: CfgVehicles|rhs_gaz66_zu23_base|Turrets|MainTurret|HitPoints|Hit_Optic_Collimator [Indent level: 4],
                ...
                # Class: CfgVehicles|rhs_gaz66_zu23_base|Turrets|MainTurret|HitPoints|Hit_Optic_T3 [Indent level: 4],
                "hit_optic_t3": {
                    "armor": -40,
                    "explosionshielding": 0,
                    "name": "",
        ...
        # Class: CfgVehicles|rhsgref_ins_g_gaz66_zu23|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
        ...
        # Class: CfgVehicles|rhsgref_ins_g_gaz66_zu23|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
            "playerposition": 1,
            "commanding": 2,
            "primaryobserver": 0,
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_gaz66_zu23.paa",
    "dlc": "RHS_GREF",
    ...
    # Class: CfgVehicles|rhsgref_ins_gaz66_zu23|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_gaz66_zu23|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "initphase": 1,
        ...
        # Class: CfgVehicles|rhs_gaz66_zu23_base|AnimationSources|Elevation [Indent level: 2],
        "elevation": {
            "source": "user",
            "animperiod": 0.1,
            "initphase": 5
