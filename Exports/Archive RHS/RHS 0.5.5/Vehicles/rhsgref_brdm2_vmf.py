rhsgref_brdm2_vmf = {
    ...
    # Class: CfgVehicles|rhsgref_BRDM2_vmf|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_BRDM2_vmf|AnimationSources|small_numbers_hide [Indent level: 2]
        "small_numbers_hide": {
            "initphase": 1,
            "source": "user",
            "animperiod": 0
    ...
    "rhs_decalparameters": ["['Number', [3,4,5], 'Default']","['Label', [6], 'Army',[3,1]]"],
    "side": 0,
