rhs_uh60m_esss2 = {
    ...
    "editorpreview": "rhsusf|addons|rhsusf_editorPreviews|data|RHS_UH60M_ESSS2.paa",
    # Class: CfgVehicles|RHS_UH60M_ESSS2|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_UH60M_ESSS2|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            "uipicture": "rhsusf|addons|rhsusf_a2port_air|data|loadouts|RHS_UH60_EWS_EDEN_CA.paa",
            # Class: CfgVehicles|RHS_UH60M_ESSS2|Components|TransportPylonsComponent|pylons [Indent level: 3],
            "pylons": {
                # Class: CfgVehicles|RHS_UH60M_ESSS2|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|RHS_UH60M_ESSS2|Components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                ...
                # Class: CfgVehicles|RHS_UH60M_ESSS2|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4],
                "cmdispenser": {
    ...
    # Class: CfgVehicles|RHS_UH60M_ESSS2|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_UH60M_ESSS2|AnimationSources|ESSS_2x [Indent level: 2]
        "esss_2x": {
            "source": "user",
            "animperiod": 0.0001,
            "initphase": 1
