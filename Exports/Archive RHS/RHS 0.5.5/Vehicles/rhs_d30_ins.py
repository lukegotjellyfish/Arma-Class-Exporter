rhs_d30_ins = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_D30_ins.paa",
    "scope": 1,
    "side": 2,
    ...
    # Class: CfgVehicles|rhs_D30_ins|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_D30_ins|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "magazines": ["rhs_mag_of462_10","rhs_mag_d462_2","rhs_mag_s463_2","rhs_mag_3of69m_2"],
            "gunbeg": "Usti hlavne",
            "gunend": "Konec hlavne",
            "weapons": ["rhs_weap_D30"],
            ...
            # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret|OpticsIn [Indent level: 3],
            "opticsin": {
                # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret|OpticsIn|PanoramicSight [Indent level: 4]
                "panoramicsight": {
                    "hitpoint": "Hit_Optic_PG1M",
                    "initfov": 0.175,
                    "minfov": 0.175,
                    "maxfov": 0.175,
                    "gunneropticsmodel": "rhsafrf|addons|rhs_optics|vehicles|rhs_pg1m.p3d",
                    "initanglex": 0,
                    "minanglex": -30,
                    "maxanglex": 30,
                    "initangley": 0,
                ...
                # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret|OpticsIn|OP4M_45 [Indent level: 4],
                "op4m_45": {
                    ...
                    "maxfov": 0.116667,
                    "visionmode": ["Normal"],
                    "gunneropticsmodel": "rhsafrf|addons|rhs_optics|vehicles|rhs_op4m45.p3d"
                }
            },
            "disablesoundattenuation": 1,
            # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret|HitPoints [Indent level: 3],
            "hitpoints": {
                # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret|HitPoints|HitTurret [Indent level: 4]
                "hitturret": {
                    "armor": -100,
                    "material": -1,
                    "name": "Hit_Turret",
                ...
                # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret|HitPoints|HitGun [Indent level: 4],
                "hitgun": {
                    "armor": -100,
                    "material": -1,
                    "name": "Hit_Gun",
                ...
                # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret|HitPoints|Hit_Optic_PG1M [Indent level: 4],
                "hit_optic_pg1m": {
                    "armor": -40,
                    "explosionshielding": 0.1,
                    "name": "Hit_Optic_Panoramic",
                    "visual": "vis_optic_pg1m",
                    "armorcomponent": "Hit_Optic_Panoramic",
                    "passthrough": 0
                },
                # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret|HitPoints|Hit_Optic_OP4M [Indent level: 4],
                "hit_optic_op4m": {
                    "armor": -40,
                    "explosionshielding": 0.1,
                    "name": "Hit_Optic_Direct",
                    "visual": "vis_optic_op4m",
                    "armorcomponent": "Hit_Optic_Direct",
                    "passthrough": 0
                }
            },
            "gunnerforceoptics": 1,
    ...
    # Class: CfgVehicles|rhs_D30_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_D30_base|AnimationSources|recoil [Indent level: 2]
        "recoil": {
            "source": "door",
            "animperiod": 6
        },
        ...
        # Class: CfgVehicles|rhs_D30_base|AnimationSources|Wheel_1_source [Indent level: 2],
        "wheel_1_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_D30_base|AnimationSources|Wheel_2_source [Indent level: 2],
        "wheel_2_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_D30_base|AnimationSources|RaiseWheels [Indent level: 2],
        "raisewheels": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
    ...
    "mfact": 1,
    "tbody": 450,
    # Class: CfgVehicles|rhs_D30_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_D30_base|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
    ...
    "useractions": {
        ...
        "fold": {
            ...
            "radius": 2.51,
            "onlyforplayer": 0,
            "condition": "(alive this)&& ((count (crew this)) == 0) && (this animationPhase 'leftT' <= 0.1)",
        ...
        "unfold": {
            ...
            "condition": "(alive this)&& (this  animationPhase 'leftT' >= 2.2)",
            "statement": "[this,0] call rhs_fnc_d30_pack;",
            "position": "aimpoint",
            "radius": 2.51,
            "onlyforplayer": 0
        },
        # Class: CfgVehicles|rhs_D30_base|UserActions|AttachVehicle [Indent level: 2],
        "attachvehicle": {
            "position": "tow_point",
            "condition": "(alive this)&& (this  animationPhase 'leftT' >= 2.2)",
            "displaynamedefault": "<img image='|rhsusf|addons|rhsusf_main|data|actions|rhs_tow_attach_ca.paa' size='3.5' />",
            "displayname": "<img image='|rhsusf|addons|rhsusf_main|data|actions|rhs_tow_attach_ca.paa' size='1.5' /> <t color='#00FF7F'>Select towing vehicle</t>",
            "radius": 2.5,
            "onlyforplayer": 1,
            "priority": 15,
            "showwindow": 1,
            "statement": "[this] call rhs_fnc_towing_selectVehicle"
        },
        # Class: CfgVehicles|rhs_D30_base|UserActions|DragVehicle [Indent level: 2],
        "dragvehicle": {
            "position": "tow_point",
            "condition": "(alive this)&& (this  animationPhase 'leftT' >= 2.2)",
            "displaynamedefault": "<img image='|a3|Ui_f|data|IGUI|Cfg|Actions|ladderup_ca.paa' size='2.5' />",
            "displayname": "<img image='|a3|Ui_f|data|IGUI|Cfg|Actions|ladderup_ca.paa' /> <t color='#00FF7F'>Drag heavy weapon</t>",
            "radius": 1.5,
            "onlyforplayer": 1,
            "priority": 15,
            "showwindow": 1,
            "statement": "[this] call rhs_fnc_towing_drag"
        }
    },
    # Class: CfgVehicles|rhs_D30_base|Attributes [Indent level: 1],
    "attributes": {
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_caseDeleteTime [Indent level: 2],
        "rhs_casedeletetime": {
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_1_type [Indent level: 2],
        "rhs_ammoslot_1_type": {
            ...
            "defaultvalue": 0,
            "typename": "STRING",
            # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_1_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_1_type|values|rhs_mag_3of56_10 [Indent level: 4]
                "rhs_mag_3of56_10": {
                    "name": "3OF56",
                    "value": "rhs_mag_3of56_10",
                    "defaultvalue": "rhs_mag_3of56_10"
                },
                # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_1_type|values|rhs_mag_of462_10 [Indent level: 4],
                "rhs_mag_of462_10": {
                    "name": "53-OF-462",
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_1 [Indent level: 2],
        "rhs_ammoslot_1": {
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_2_type [Indent level: 2],
        "rhs_ammoslot_2_type": {
            "displayname": "Ammo slot #2 type",
            "tooltip": "Define type of shell for #2 slot [Smoke rounds]",
            "property": "rhs_ammoslot_2_type",
            # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_2_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_2_type|values|rhs_mag_d462_2 [Indent level: 4]
                "rhs_mag_d462_2": {
                    "name": "53-D-462",
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_2 [Indent level: 2],
        "rhs_ammoslot_2": {
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_3_type [Indent level: 2],
        "rhs_ammoslot_3_type": {
            "displayname": "Ammo slot #3 type",
            "tooltip": "Define type of shell for #3 slot [Illumination rounds]",
            "property": "rhs_ammoslot_3_type",
            # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_3_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_3_type|values|rhs_mag_s463_2 [Indent level: 4]
                "rhs_mag_s463_2": {
                    "name": "53-S-463",
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_3 [Indent level: 2],
        "rhs_ammoslot_3": {
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_4_type [Indent level: 2],
        "rhs_ammoslot_4_type": {
            "displayname": "Ammo slot #4 type",
            "tooltip": "Define type of shell for #4 slot [Laser guided rounds]",
            "property": "rhs_ammoslot_4_type",
            # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_4_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_4_type|values|rhs_mag_3of69m_2 [Indent level: 4]
                "rhs_mag_3of69m_2": {
                    "name": "3OF69M",
        ...
        # Class: CfgVehicles|rhs_D30_base|Attributes|rhs_ammoslot_4 [Indent level: 2],
        "rhs_ammoslot_4": {
    ...
    # Class: CfgVehicles|rhs_D30_base|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|rhs_D30_base|RHS_TowingSystem|Cargo [Indent level: 2]
        "cargo": {
            "rhs_fakevehicle": "rhs_D30_towingVehicle",
            "rhs_animationsonattach": ["RaiseWheels",1],
            "rhs_animationsondetach": ["RaiseWheels",0],
            "rhs_towedmass": 1420,
            "rhs_towingpoint": "tow_point",
            "rhs_additionalropeoffset": [0,0,0.6],
            "rhs_ropelength": 0.1,
            "rhs_maxattachdistance": 2,
            "rhs_dragoffset": [0,0.6,0.9]
        }
    },
