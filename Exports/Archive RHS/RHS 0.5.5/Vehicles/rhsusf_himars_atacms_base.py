rhsusf_himars_atacms_base = {
    # Class: CfgVehicles|rhsusf_himars_atacms_base|Turrets [Indent level: 1]
    "turrets": {
        # Class: CfgVehicles|rhsusf_himars_atacms_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "weapons": ["rhs_weap_atacms"],
            "magazines": ["rhs_mag_mgm140a_1"],
            "commanding": 1,
            "body": "mainTurret",
            "gun": "mainGun",
            "minelev": 0,
        ...
        # Class: CfgVehicles|rhsusf_himars_atacms_base|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
    ...
    # Class: CfgVehicles|rhsusf_himars_atacms_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsusf_himars_atacms_base|AnimationSources|Missiles_revolving [Indent level: 2]
        "missiles_revolving": {
            "weapon": "rhs_weap_atacms",
            "source": "revolving"
        },
        # Class: CfgVehicles|rhsusf_himars_atacms_base|AnimationSources|Missiles_revolving2 [Indent level: 2],
        "missiles_revolving2": {
    ...
    "hiddenselectionstextures": ["|a3|soft_f_beta|truck_01|data|truck_01_ext_01_co.paa","|a3|soft_f_beta|truck_01|data|truck_01_ext_02_co.paa"],
