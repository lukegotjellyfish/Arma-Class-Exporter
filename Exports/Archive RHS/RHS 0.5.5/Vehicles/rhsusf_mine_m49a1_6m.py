rhsusf_mine_m49a1_6m = {
    ...
    # Ammo: CfgVehicles|rhsusf_mine_m49a1_6m|ammo [Indent level: 1],
    "ammo": {
        ...
        # Class: CfgAmmo|rhsusf_mine_m49a1_3m_ammo|CamShakeExplode [Indent level: 1],
        "camshakeexplode": {
            "power": 0,
            "duration": 0.2,
            "frequency": 20,
        ...
        # Class: CfgAmmo|rhsusf_mine_m49a1_3m_ammo|CamShakeHit [Indent level: 1],
        "camshakehit": {
            "power": 0,
            "duration": 0.2,
            "frequency": 20,
        ...
        "whistledist": 8,
        "cost": 200,
        # Class: CfgAmmo|rhsusf_mine_m49a1_3m_ammo|Eventhandlers [Indent level: 1],
        "eventhandlers": {
            # Class: CfgAmmo|rhsusf_mine_m49a1_3m_ammo|Eventhandlers|RHS_FlareExplosion [Indent level: 2]
            "rhs_flareexplosion": {
    ...
    "editorpreview": "rhsusf|addons|rhsusf_editorpreviews|data|rhsusf_mine_m49a1_6m",
    "model": "rhsusf|addons|rhsusf_weapons|mines|rhsusf_m49a1_b_e",
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsusf_mine_m49a1_3m|Library [Indent level: 1],
    "library": {
        "libtextdesc": ""
    },
