rhs_metis_9k115_1_ins = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_Metis_9k115_1_ins.paa",
    "scope": 1,
    "side": 2,
    ...
    # Class: CfgVehicles|rhs_Metis_9k115_1_ins|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_Metis_9k115_1_ins|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "weapons": ["rhs_weap_9K115_1_launcher"],
            "magazines": ["rhs_mag_9M131","rhs_mag_9M131","rhs_mag_9M131","rhs_mag_9M131"],
            "gunneraction": "rhs_Metis_Gunner",
            "gunnergetinaction": "RHS_StaticWeapon_GetOut_Low",
            "gunnergetoutaction": "RHS_StaticWeapon_GetOut_Low",
            ...
            "ejectdeadgunner": 0,
            "gunnerforceoptics": 0,
            # Class: CfgVehicles|rhs_Metis_Base|Turrets|MainTurret|ViewGunner [Indent level: 3],
            "viewgunner": {
                "initanglex": 5,
                "minanglex": -30,
                "maxanglex": 30,
            ...
            # Class: CfgVehicles|rhs_Metis_Base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 0,
                "minanglex": -30,
                "maxanglex": 30,
    ...
    # Class: CfgVehicles|rhs_Metis_9k115_1_ins|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_Metis_9k115_1_ins|AnimationSources|revolving [Indent level: 2]
        "revolving": {
            "source": "revolving",
            "weapon": "rhs_weap_9K115_1_launcher"
        },
        # Class: CfgVehicles|rhs_Metis_9k115_1_ins|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "rhs_weap_9K115_1_launcher"
        }
    },
    # Class: CfgVehicles|rhs_Metis_9k115_1_ins|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_Metis_9k115_1_ins|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
    ...
    "dlc": "RHS_AFRF",
    # Class: CfgVehicles|rhs_Metis_Base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["rhs_Metis_Gun_Bag","rhs_Metis_Tripod_Bag"],
        "displayname": ""
    },
    # Class: CfgVehicles|rhs_Metis_Base|Library [Indent level: 1],
    "library": {
    ...
    "model": "rhsafrf|addons|rhs_heavyweapons|metis_at_13|metis.p3d",
    ...
    "mapsize": 1.5,
    "hiddenselections": [],
    # Class: CfgVehicles|rhs_Metis_Base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhs_Metis_Base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|rhs_Metis_Base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    # Class: CfgVehicles|rhs_Metis_Base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
