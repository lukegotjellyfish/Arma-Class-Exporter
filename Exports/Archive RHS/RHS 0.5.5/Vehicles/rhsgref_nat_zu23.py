rhsgref_nat_zu23 = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_nat_ZU23.paa",
    ...
    # Class: CfgVehicles|RHS_ZU23_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_ZU23_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "minturn": -180,
            "maxturn": 180,
            "initturn": 0,
        ...
        # Class: CfgVehicles|RHS_ZU23_base|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
