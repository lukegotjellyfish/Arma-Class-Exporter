rhsgref_ins_zil131_flatbed = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_zil131_flatbed.paa",
    ...
    "animationlist": ["cover_hide",1,"bench_hide",1],
    # Class: CfgVehicles|rhs_zil131_flatbed_base|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhs_zil131_flatbed_base|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
        ...
        # Class: CfgVehicles|rhs_zil131_flatbed_base|VehicleTransport|Carrier [Indent level: 2],
        "carrier": {
