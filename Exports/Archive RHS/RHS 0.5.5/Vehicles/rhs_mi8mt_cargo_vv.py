rhs_mi8mt_cargo_vv = {
    ...
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_a2port_air|Mi17|data|camo|mi8_body_g_camo3_co.paa","|rhsafrf|addons|rhs_a2port_air|Mi17|data|camo|mi8_det_g_camo1_co.paa","a3|data_f|clear_empty.paa","rhsafrf|addons|rhs_a2port_air|mi17|data|mi8_decals_ca.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa","rhsafrf|addons|rhs_decals|data|labels|aviation|vvs_ca.paa"],
    ...
    # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
            "proxyindex": 3,
            "gunnername": "Co-pilot",
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
            ...
            # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Turrets|CargoTurret_01|Hitpoints [Indent level: 3],
            "hitpoints": {
            },
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Turrets|CargoTurret_03 [Indent level: 2],
        "cargoturret_03": {
    ...
    # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|AnimationSources|LeftDoor [Indent level: 2]
        "leftdoor": {
            "source": "door",
            "animperiod": 0.8,
            "initphase": 1
        },
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|AnimationSources|hide_turrets [Indent level: 2],
        "hide_turrets": {
            "initphase": 1,
            "source": "user",
            "animperiod": 1e-015
        },
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|AnimationSources|hide_door_hatch [Indent level: 2],
        "hide_door_hatch": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1e-015
    ...
    # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Attributes|ObjectTexture [Indent level: 2]
        "objecttexture": {
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Attributes|rhs_decalNumber_type [Indent level: 2],
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Attributes|rhs_decalNumber [Indent level: 2],
        "rhs_decalnumber": {
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Attributes|rhs_decalTail [Indent level: 2],
        "rhs_decaltail": {
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Attributes|rhs_reardoors [Indent level: 2],
        "rhs_reardoors": {
            "displayname": "Open rear doors",
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|Attributes|rhs_leftdoor [Indent level: 2],
        "rhs_leftdoor": {
    ...
    # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|UserActions|openDoor [Indent level: 2]
        "opendoor": {
            "displayname": "Open Rear Doors",
            "position": "",
            "radius": 3,
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|UserActions|closeDoor [Indent level: 2],
        "closedoor": {
            "useractionid": 56,
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|UserActions|openDoor_L [Indent level: 2],
        "opendoor_l": {
            "useractionid": 57,
            "displayname": "Open Left Door",
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|UserActions|closeDoor_L [Indent level: 2],
        "closedoor_l": {
            "useractionid": 58,
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|UserActions|ToggleLight [Indent level: 2],
        "togglelight": {
        ...
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|UserActions|WheelBrakes [Indent level: 2],
        "wheelbrakes": {
    ...
    # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|RHS_Mi8mt_Cargo_vvs|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
