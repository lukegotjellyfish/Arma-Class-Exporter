rhs_rpg_at = {
    ...
    "scope": 1,
    # Class: CfgVehicles|rhs_rpg_at|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhs_rpg_at|TransportMagazines|_xx_rhs_rpg7_PG7VR_mag [Indent level: 2]
        "_xx_rhs_rpg7_pg7vr_mag": {
            "magazine": "rhs_rpg7_PG7VR_mag",
            "count": 2
        },
        # Class: CfgVehicles|rhs_rpg_at|TransportMagazines|_xx_rhs_rpg7_PG7VL_mag [Indent level: 2],
