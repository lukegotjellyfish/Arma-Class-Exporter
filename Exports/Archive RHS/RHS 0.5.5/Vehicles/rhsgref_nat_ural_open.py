rhsgref_nat_ural_open = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_nat_ural_open.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsgref_nat_ural_open|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_nat_ural_open|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_khk_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_plachta_co.paa"],
    "accuracy": 0.5,
    "rhs_decalparameters": [],
