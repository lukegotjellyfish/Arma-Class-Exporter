rhs_tigr_sts_3camo_vmf = {
    ...
    # Class: CfgVehicles|rhs_tigr_sts_3camo_vmf|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_tigr_sts_3camo_vmf|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            ...
            "animationsourcestickx": "weapon_pkm_Turret_Inertia",
            "animationsourcesticky": "weapon_pkm_Gun_Inertia",
        ...
        # Class: CfgVehicles|rhs_tigr_sts_3camo_vmf|Turrets|AGS_Turret [Indent level: 2],
        "ags_turret": {
            "gunnertype": "rhs_vmf_flora_grenadier",
    ...
    "displayname": "GAZ-233014 (Camo)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_tigr|data|rhs_tigr_co_camo.paa","rhsafrf|addons|rhs_tigr|data|rhs_tigr_int_01_co.paa","rhsafrf|addons|rhs_tigr|data|rhs_tigr_int_02_co.paa","rhsafrf|addons|rhs_tigr|sts_proxies|data|tigr_ext_ads_co.paa","rhsafrf|addons|rhs_tigr|m_proxies|data|tigr_m_adds_co.paa","rhsafrf|addons|rhs_decals|Data|Labels|Misc|no_ca.paa"],
    "scope": 2,
    "scopecurator": 2,
    ...
    "animationsources": {
        ...
        # Class: CfgVehicles|rhs_tigr_sts_vdv|AnimationSources|turret_correct [Indent level: 2],
        "turret_correct": {
            "animperiod": 1.8,
            "source": "user",
            "initphase": 0
