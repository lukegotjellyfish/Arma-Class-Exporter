rhsgref_cdf_b_ural = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_ural.paa",
    "displayname": "Ural-4320",
    "dlc": "RHS_GREF",
    "rhs_decalparameters": ["['Number', cDecals4CarsNumberPlaces, 'CDF']"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_camo_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_plachta_camo_co.paa","rhsafrf|addons|RHS_Decals|Data|Labels|Misc|no_ca.paa"],
    "accuracy": 0.5,
