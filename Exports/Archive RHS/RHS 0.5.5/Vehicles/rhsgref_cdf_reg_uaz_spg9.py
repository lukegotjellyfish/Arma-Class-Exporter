rhsgref_cdf_reg_uaz_spg9 = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_reg_uaz_spg9.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|RHS_UAZ_SPG9_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_UAZ_SPG9_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            ...
            "maxelev": 30,
            "initelev": 0,
            # Class: CfgVehicles|RHS_UAZ_SPG9_Base|Turrets|MainTurret|ViewGunner [Indent level: 3],
            "viewgunner": {
                "initanglex": 5,
                "minanglex": -30,
                "maxanglex": 30,
            ...
            # Class: CfgVehicles|RHS_UAZ_SPG9_Base|Turrets|MainTurret|OpticsIn [Indent level: 3],
            "opticsin": {
                # Class: CfgVehicles|RHS_UAZ_SPG9_Base|Turrets|MainTurret|OpticsIn|Sight [Indent level: 4]
                "sight": {
        ...
        # Class: CfgVehicles|RHS_UAZ_SPG9_Base|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
    ...
    # Class: CfgVehicles|RHS_UAZ_SPG9_Base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_UAZ_SPG9_Base|AnimationSources|ReloadAnim [Indent level: 2]
        "reloadanim": {
