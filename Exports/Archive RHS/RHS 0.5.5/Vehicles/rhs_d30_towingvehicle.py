rhs_d30_towingvehicle = {
    ...
    # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|leftT_source [Indent level: 2]
        "leftt_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": 2.3
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|rightT_source [Indent level: 2],
        "rightt_source": {
            "initphase": 2.3,
            "source": "user",
            "animperiod": 1
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|leftW_source [Indent level: 2],
        "leftw_source": {
            "initphase": 0.7,
            "source": "user",
            "animperiod": 1
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|rightW_source [Indent level: 2],
        "rightw_source": {
            "initphase": 0.7,
            "source": "user",
            "animperiod": 1
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|maingunT_source [Indent level: 2],
        "maingunt_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": -0.165
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|mainTurretT_source [Indent level: 2],
        "mainturrett_source": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|szpilki_source [Indent level: 2],
        "szpilki_source": {
            "source": "user",
            "animperiod": 0.1,
            "initphase": 0.7
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|body_source [Indent level: 2],
        "body_source": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|d30_kolo [Indent level: 2],
        "d30_kolo": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|fold_arty_handler [Indent level: 2],
        "fold_arty_handler": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|Wheel_1_source [Indent level: 2],
        "wheel_1_source": {
            "source": "wheel",
            "wheel": "Wheel_1"
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|Wheel_2_source [Indent level: 2],
        "wheel_2_source": {
            "source": "wheel",
            "wheel": "Wheel_2"
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|AnimationSources|RaiseWheels [Indent level: 2],
        "raisewheels": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
    ...
    "maxomega": 1000,
    "maxspeed": 40,
    # Class: CfgVehicles|rhs_D30_towingVehicle_base|Wheels [Indent level: 1],
    "wheels": {
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|Wheels|Wheel_1 [Indent level: 2]
        "wheel_1": {
            "steering": 1,
            "side": "left",
            ...
            "springdamperrate": 3280,
            "longitudinalstiffnessperunitgravity": 25000,
            "latstiffx": 12.5,
            "latstiffy": 18,
            "frictionvsslipgraph": [[0,5],[0.5,2],[1,1]]
        },
        # Class: CfgVehicles|rhs_D30_towingVehicle_base|Wheels|Wheel_2 [Indent level: 2],
        "wheel_2": {
            "steering": 1,
            "side": "right",
    ...
    # Class: CfgVehicles|RHS_TowedWeapons_Base|Hitpoints [Indent level: 1],
    "hitpoints": {
    },
    # Class: CfgVehicles|RHS_TowedWeapons_Base|Reflectors [Indent level: 1],
    "reflectors": {
    },
    # Class: CfgVehicles|RHS_TowedWeapons_Base|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|RHS_TowedWeapons_Base|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|RHS_TowedWeapons_Base|UserActions|Detach [Indent level: 2]
        "detach": {
            "displaynamedefault": "<img image='|rhsusf|addons|rhsusf_main|data|actions|rhs_tow_detach_ca.paa' size='3.5' />",
            "displayname": "<img image='|rhsusf|addons|rhsusf_main|data|actions|rhs_tow_detach_ca.paa' size='1.5' /> <t color='#00FF7F'>Detach vehicle</t>",
            "position": "",
            "radius": 2.5,
            "onlyforplayer": 1,
            "priority": 15,
    ...
    # Class: CfgVehicles|RHS_TowedWeapons_Base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "killed": "_this call rhs_fnc_towing_destroyed",
        "fired": "",
        "init": ""
    },
    ...
    # Class: CfgVehicles|Air|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|Air|TransportItems|_xx_FirstAidKit [Indent level: 2]
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 4
        }
