rhsusf_m1083a1p2_b_m2_d_fmtv_usarmy = {
    ...
    "displayname": "M1083A1P2-B (O-GPK/M2)",
    ...
    "maxfordingdepth": 0,
    "accuracy": 0.5,
    # Class: CfgVehicles|rhsusf_M1083A1P2_B_M2_fmtv_usarmy|AnimationSources [Indent level: 1],
    "animationsources": {
        ...
        # Class: CfgVehicles|rhsusf_fmtv_base|AnimationSources|hide_cover [Indent level: 2],
        "hide_cover": {
            "source": "user",
            "mass": -20,
        ...
        # Class: CfgVehicles|rhsusf_fmtv_base|AnimationSources|hide_scaffold [Indent level: 2],
        "hide_scaffold": {
            "author": "Red Hammer Studios",
