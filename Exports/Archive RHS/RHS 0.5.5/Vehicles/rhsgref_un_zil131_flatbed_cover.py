rhsgref_un_zil131_flatbed_cover = {
    ...
    "scope": 2,
    "scopecurator": 2,
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_un_zil131_flatbed_cover.paa",
    ...
    "animationlist": ["bench_hide",1],
    # Class: CfgVehicles|rhs_zil131_flatbed_cover_base|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhs_zil131_flatbed_cover_base|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
        ...
        # Class: CfgVehicles|rhs_zil131_flatbed_cover_base|VehicleTransport|Carrier [Indent level: 2],
        "carrier": {
    ...
    "cargoproxyindexes": [2],
    "getinproxyorder": [1,2],
    # Class: CfgVehicles|rhs_zil131_flatbed_base|Turrets [Indent level: 1],
    "turrets": {
    },
