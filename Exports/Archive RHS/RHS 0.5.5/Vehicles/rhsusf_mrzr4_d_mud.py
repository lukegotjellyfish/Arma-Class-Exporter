rhsusf_mrzr4_d_mud = {
    ...
    "hiddenselectionsmaterials": ["|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_blue_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_yel_metal_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_red_mud.rvmat","|rhsusf|addons|rhsusf_mrzr|data|rhsusf_mrzr_grn_mud.rvmat"],
