rhs_flag_trn_f = {
    ...
    "scope": 2,
    "displayname": "Flag (Transnistria)",
    # Class: CfgVehicles|rhs_Flag_TRN_F|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '|rhsafrf|addons|rhs_main|data|Flag_trn_CO.paa'"
    },
    "scopecurator": 2,
