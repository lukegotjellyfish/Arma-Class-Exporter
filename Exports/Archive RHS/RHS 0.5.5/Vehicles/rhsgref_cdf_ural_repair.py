rhsgref_cdf_ural_repair = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_ural_repair.paa",
    "scope": 2,
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_camo_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa"],
