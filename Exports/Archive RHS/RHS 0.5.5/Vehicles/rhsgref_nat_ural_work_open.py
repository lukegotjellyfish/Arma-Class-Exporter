rhsgref_nat_ural_work_open = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_nat_ural_work_open.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsgref_nat_ural_work_open|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_nat_ural_work_open|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
