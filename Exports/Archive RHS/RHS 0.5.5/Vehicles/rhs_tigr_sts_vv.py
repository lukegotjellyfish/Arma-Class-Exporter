rhs_tigr_sts_vv = {
    ...
    # Class: CfgVehicles|rhs_tigr_sts_vv|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_tigr_sts_vv|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
        ...
        # Class: CfgVehicles|rhs_tigr_sts_vv|Turrets|AGS_Turret [Indent level: 2],
        "ags_turret": {
            "gunnertype": "rhs_msv_grenadier",
