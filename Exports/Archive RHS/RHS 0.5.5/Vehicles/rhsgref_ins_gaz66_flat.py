rhsgref_ins_gaz66_flat = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_gaz66_flat.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsgref_ins_gaz66_flat|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_gaz66_flat|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "initphase": 1,
        ...
        # Class: CfgVehicles|rhs_gaz66_flat_vmf|AnimationSources|bench_hide [Indent level: 2],
        "bench_hide": {
            "initphase": 1,
    ...
    "transportsoldier": 1,
    "cargoproxyindexes": [1],
    # Class: CfgVehicles|rhs_gaz66_flat_vmf|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|rhs_gaz66_flat_vmf|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhs_gaz66_flat_vmf|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
        ...
        # Class: CfgVehicles|rhs_gaz66_flat_vmf|VehicleTransport|Carrier [Indent level: 2],
        "carrier": {
