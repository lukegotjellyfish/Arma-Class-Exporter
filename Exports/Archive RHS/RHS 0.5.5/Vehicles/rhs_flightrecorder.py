rhs_flightrecorder = {
    ...
    "isground": 1,
    # Class: CfgVehicles|rhs_flightrecorder|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhs_flightrecorder|TransportItems|rhs_item_flightrecorder [Indent level: 2]
