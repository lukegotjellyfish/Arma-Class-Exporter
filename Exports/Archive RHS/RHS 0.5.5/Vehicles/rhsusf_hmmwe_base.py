rhsusf_hmmwe_base = {
    ...
    "insidesoundcoef": 0.4,
    "tf_haslrradio_api": 1,
    # Class: CfgVehicles|rhsusf_hmmwe_base|Sounds [Indent level: 1],
    "sounds": {
    ...
    "castdrivershadow": 0,
    "castcargoshadow": 0,
    # Class: CfgVehicles|rhsusf_hmmwe_base|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|ObjectTexture [Indent level: 2]
        "objecttexture": {
        ...
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|rhs_decalMask [Indent level: 2],
        "rhs_decalmask": {
        ...
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|rhs_decalDoors [Indent level: 2],
        "rhs_decaldoors": {
        ...
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|rhs_hideCIP [Indent level: 2],
        "rhs_hidecip": {
        ...
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|rhs_hideBFT [Indent level: 2],
        "rhs_hidebft": {
        ...
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|rhs_hideAntennas [Indent level: 2],
        "rhs_hideantennas": {
        ...
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|rhs_hideA2Parts [Indent level: 2],
        "rhs_hidea2parts": {
        ...
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|Door_LF [Indent level: 2],
        "door_lf": {
        ...
        # Class: CfgVehicles|rhsusf_hmmwe_base|Attributes|Door_RF [Indent level: 2],
        "door_rf": {
    ...
    # Class: CfgVehicles|rhsusf_hmmwe_base|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|rhsusf_hmmwe_base|RHS_TowingSystem|Carrier [Indent level: 2]
        "carrier": {
            "rhs_maxcargomass": 1500,
            "rhs_attachpoint": "",
            "rhs_attachpointpos": [0,-2.35,-1.15]
        }
    },
    ...
    # Class: CfgVehicles|MRAP_01_base_F|Reflectors [Indent level: 1],
    "reflectors": {
        # Class: CfgVehicles|MRAP_01_base_F|Reflectors|Left [Indent level: 2]
        "left": {
            "color": [1.9,1.8,1.7],
            "ambient": [5,5,5],
            "position": "Light_L",
            ...
            "daylight": 0,
            "flaresize": 1,
            # Class: CfgVehicles|MRAP_01_base_F|Reflectors|Left|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 0,
                "linear": 0,
        ...
        # Class: CfgVehicles|MRAP_01_base_F|Reflectors|Right [Indent level: 2],
        "right": {
            "position": "Light_R",
        ...
        # Class: CfgVehicles|MRAP_01_base_F|Reflectors|Right2 [Indent level: 2],
        "right2": {
        ...
        # Class: CfgVehicles|MRAP_01_base_F|Reflectors|Left2 [Indent level: 2],
        "left2": {
        ...
        # Class: CfgVehicles|MRAP_01_base_F|Reflectors|Right3 [Indent level: 2],
        "right3": {
        ...
        # Class: CfgVehicles|MRAP_01_base_F|Reflectors|Left3 [Indent level: 2],
        "left3": {
    ...
    "weapons": ["TruckHorn2"],
    "magazines": [],
    # Class: CfgVehicles|MRAP_01_base_F|RenderTargets [Indent level: 1],
    "rendertargets": {
        # Class: CfgVehicles|MRAP_01_base_F|RenderTargets|Driver_display [Indent level: 2]
        "driver_display": {
            "rendertarget": "rendertarget1",
            # Class: CfgVehicles|MRAP_01_base_F|RenderTargets|Driver_display|CameraView1 [Indent level: 3],
            "cameraview1": {
        ...
        # Class: CfgVehicles|MRAP_01_base_F|RenderTargets|mirrors_Left [Indent level: 2],
        "mirrors_left": {
            "rendertarget": "rendertarget4",
            # Class: CfgVehicles|MRAP_01_base_F|RenderTargets|mirrors_Left|CameraView1 [Indent level: 3],
            "cameraview1": {
        ...
        # Class: CfgVehicles|MRAP_01_base_F|RenderTargets|mirrors_Right [Indent level: 2],
        "mirrors_right": {
            "rendertarget": "rendertarget5",
            # Class: CfgVehicles|MRAP_01_base_F|RenderTargets|mirrors_Right|CameraView1 [Indent level: 3],
            "cameraview1": {
    ...
    "idlerpm": 800,
    "redrpm": 4500,
    # Class: CfgVehicles|MRAP_01_base_F|complexGearbox [Indent level: 1],
    "complexgearbox": {
    ...
    "switchtime": 0.31,
    "latency": 1,
    # Class: CfgVehicles|MRAP_01_base_F|Wheels [Indent level: 1],
    "wheels": {
        # Class: CfgVehicles|MRAP_01_base_F|Wheels|LF [Indent level: 2]
        "lf": {
            "side": "left",
        ...
        # Class: CfgVehicles|MRAP_01_base_F|Wheels|LR [Indent level: 2],
        "lr": {
            "bonename": "wheel_1_2",
            "steering": 0,
        ...
        # Class: CfgVehicles|MRAP_01_base_F|Wheels|RF [Indent level: 2],
        "rf": {
            "side": "right",
            "susptraveldirection": [0.125,-1,0],
            "bonename": "wheel_2_1",
        ...
        # Class: CfgVehicles|MRAP_01_base_F|Wheels|RR [Indent level: 2],
        "rr": {
            "bonename": "wheel_2_2",
            "steering": 0,
    ...
    # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_30Rnd_65x39_caseless_mag [Indent level: 2]
        "_xx_30rnd_65x39_caseless_mag": {
            "magazine": "30Rnd_65x39_caseless_mag",
            "count": 16
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_100Rnd_65x39_caseless_mag [Indent level: 2],
        "_xx_100rnd_65x39_caseless_mag": {
            "magazine": "100Rnd_65x39_caseless_mag",
            "count": 6
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_HandGrenade [Indent level: 2],
        "_xx_handgrenade": {
            "magazine": "HandGrenade",
            "count": 10
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_1Rnd_HE_Grenade_shell [Indent level: 2],
        "_xx_1rnd_he_grenade_shell": {
            "magazine": "1Rnd_HE_Grenade_shell",
            "count": 10
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_1Rnd_Smoke_Grenade_shell [Indent level: 2],
        "_xx_1rnd_smoke_grenade_shell": {
            "magazine": "1Rnd_Smoke_Grenade_shell",
            "count": 4
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_1Rnd_SmokeGreen_Grenade_shell [Indent level: 2],
        "_xx_1rnd_smokegreen_grenade_shell": {
            "magazine": "1Rnd_SmokeGreen_Grenade_shell",
            "count": 4
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_1Rnd_SmokeOrange_Grenade_shell [Indent level: 2],
        "_xx_1rnd_smokeorange_grenade_shell": {
            "magazine": "1Rnd_SmokeOrange_Grenade_shell",
            "count": 4
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_1Rnd_SmokeBlue_Grenade_shell [Indent level: 2],
        "_xx_1rnd_smokeblue_grenade_shell": {
            "magazine": "1Rnd_SmokeBlue_Grenade_shell",
            "count": 4
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_16Rnd_9x21_Mag [Indent level: 2],
        "_xx_16rnd_9x21_mag": {
            "magazine": "16Rnd_9x21_Mag",
            "count": 12
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_SmokeShell [Indent level: 2],
        "_xx_smokeshell": {
            "magazine": "SmokeShell",
            "count": 4
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_SmokeShellGreen [Indent level: 2],
        "_xx_smokeshellgreen": {
            "magazine": "SmokeShellGreen",
            "count": 4
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_SmokeShellOrange [Indent level: 2],
        "_xx_smokeshellorange": {
            "magazine": "SmokeShellOrange",
            "count": 4
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_SmokeShellBlue [Indent level: 2],
        "_xx_smokeshellblue": {
            "magazine": "SmokeShellBlue",
            "count": 4
        },
        # Class: CfgVehicles|MRAP_01_base_F|TransportMagazines|_xx_NLAW_F [Indent level: 2],
        "_xx_nlaw_f": {
            "magazine": "NLAW_F",
            "count": 2
        }
    },
    # Class: CfgVehicles|MRAP_01_base_F|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|MRAP_01_base_F|TransportItems|_xx_FirstAidKit [Indent level: 2]
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 10
        }
    },
    # Class: CfgVehicles|MRAP_01_base_F|TransportWeapons [Indent level: 1],
    "transportweapons": {
        # Class: CfgVehicles|MRAP_01_base_F|TransportWeapons|_xx_arifle_MX_F [Indent level: 2]
        "_xx_arifle_mx_f": {
            "weapon": "arifle_MX_F",
            "count": 2
        }
    ...
    # Class: CfgVehicles|MRAP_01_base_F|TextureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|MRAP_01_base_F|TextureSources|Blufor [Indent level: 2]
        "blufor": {
            "displayname": "Sand",
            "textures": ["|A3|soft_f|MRAP_01|data|MRAP_01_base_CO.paa","|a3|soft_f|mrap_01|data|mrap_01_adds_co.paa","|a3|data_f|vehicles|turret_co.paa"],
            "decals": [2],
            "factions": ["BLU_F"]
        },
        # Class: CfgVehicles|MRAP_01_base_F|TextureSources|Olive [Indent level: 2],
        "olive": {
            "displayname": "Olive",
            "author": "Bohemia Interactive",
    ...
    # Class: CfgVehicles|Car_F|Turrets [Indent level: 1],
    "turrets": {
