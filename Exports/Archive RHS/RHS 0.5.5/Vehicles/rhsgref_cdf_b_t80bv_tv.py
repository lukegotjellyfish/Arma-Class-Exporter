rhsgref_cdf_b_t80bv_tv = {
    ...
    # Class: CfgVehicles|rhsgref_cdf_b_t80bv_tv|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_cdf_b_t80bv_tv|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhsgref_cdf_b_t80bv_tv|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhsgref_cdf_b_t80bv_tv|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                ...
                # Class: CfgVehicles|rhsgref_cdf_b_t80bv_tv|Turrets|MainTurret|Turrets|CommanderMG [Indent level: 4],
                "commandermg": {
