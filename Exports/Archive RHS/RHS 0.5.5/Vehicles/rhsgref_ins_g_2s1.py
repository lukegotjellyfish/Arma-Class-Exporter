rhsgref_ins_g_2s1 = {
    ...
    # Class: CfgVehicles|rhsgref_ins_g_2s1|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_g_2s1|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhsgref_ins_g_2s1|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhsgref_ins_g_2s1|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                ...
                # Class: CfgVehicles|rhsgref_ins_g_2s1|Turrets|MainTurret|Turrets|LoaderOptics [Indent level: 4],
                "loaderoptics": {
                    "gunnertype": "rhsgref_ins_g_crew",
                    "body": "LdrTurret",
                    "gun": "LdrGun",
