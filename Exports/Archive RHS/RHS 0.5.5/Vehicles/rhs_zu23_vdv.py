rhs_zu23_vdv = {
    ...
    # Class: CfgVehicles|RHS_ZU23_VDV|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_ZU23_VDV|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "minturn": -180,
            "maxturn": 180,
            "initturn": 0,
        ...
        # Class: CfgVehicles|RHS_ZU23_VDV|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
