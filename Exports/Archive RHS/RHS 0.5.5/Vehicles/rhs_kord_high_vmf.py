rhs_kord_high_vmf = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_KORD_high_VDV.paa",
    "scope": 2,
    "side": 0,
    ...
    # Class: CfgVehicles|RHS_KORD_high_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_KORD_high_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "minelev": -7,
            "maxelev": 45,
            ...
            # Class: CfgVehicles|RHS_KORD_Base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 0,
                "minanglex": -30,
                "maxanglex": 30,
    ...
    "mapsize": 3,
    # Class: CfgVehicles|RHS_KORD_Base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|RHS_KORD_Base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    # Class: CfgVehicles|RHS_KORD_Base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_KORD_Base|AnimationSources|ReloadAnim [Indent level: 2]
        "reloadanim": {
            "source": "reload",
            "weapon": "rhs_weap_KORD"
        },
        # Class: CfgVehicles|RHS_KORD_Base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "rhs_weap_KORD"
        },
        # Class: CfgVehicles|RHS_KORD_Base|AnimationSources|Revolving [Indent level: 2],
        "revolving": {
            "source": "revolving",
            "weapon": "rhs_weap_KORD"
        },
        # Class: CfgVehicles|RHS_KORD_Base|AnimationSources|muzzleHMG_ROT [Indent level: 2],
        "muzzlehmg_rot": {
            "source": "ammorandom",
            "weapon": "rhs_weap_KORD"
        }
    ...
    "armorstructural": 10,
    # Class: CfgVehicles|RHS_KORD_Base|Library [Indent level: 1],
    "library": {
        "libtextdesc": "The Kord is a Russian heavy machine gun. This weapon entered service in 1998 and replaced the older NSV machine gun. At first glance the Kord resembles the NSV but it provides greater accuracy during sustained fire. The Kord uses 12.7x108 mm cartridges and has a rate of fire of about 750 rpm with an effective range of 2000m."
    },
    # Class: CfgVehicles|RHS_KORD_Base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
    ...
    # Class: CfgVehicles|rhs_nsv_tripod_base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhs_nsv_tripod_base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
