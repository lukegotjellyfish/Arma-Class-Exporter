rhs_p37 = {
    ...
    "mapsize": 23,
    # Class: CfgVehicles|rhs_p37|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_p37|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
            "init": "_this call rhs_fnc_radar_init;[(_this select 0),'rhs_Sound_radar1'] spawn rhs_fnc_radar_engineSoundSource"
        }
    },
    # Class: CfgVehicles|rhs_p37|DestructionEffects [Indent level: 1],
    "destructioneffects": {
        # Class: CfgVehicles|rhs_p37|DestructionEffects|Ruin1 [Indent level: 2]
        "ruin1": {
            "simulation": "ruin",
