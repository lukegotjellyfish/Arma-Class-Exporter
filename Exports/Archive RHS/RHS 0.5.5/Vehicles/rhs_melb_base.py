rhs_melb_base = {
    ...
    # Class: CfgVehicles|RHS_MELB_base|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|RHS_MELB_base|Attributes|rhs_MELB_TailNumber [Indent level: 2]
        "rhs_melb_tailnumber": {
        ...
        # Class: CfgVehicles|RHS_MELB_base|Attributes|rhs_MELB_SN_Nose [Indent level: 2],
        "rhs_melb_sn_nose": {
        ...
        # Class: CfgVehicles|RHS_MELB_base|Attributes|rhs_MELB_clan [Indent level: 2],
        "rhs_melb_clan": {
            "displayname": "Squad XML",
            "property": "MELB_clan",
        ...
        # Class: CfgVehicles|RHS_MELB_base|Attributes|MELB_ToggleBoy [Indent level: 2],
        "melb_toggleboy": {
            "displayname": "Bobblehead",
    ...
    # Class: CfgVehicles|RHS_MELB_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_MELB_base|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
