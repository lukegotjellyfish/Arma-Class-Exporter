rhs_d30_vdv = {
    ...
    # Class: CfgVehicles|rhs_D30_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_D30_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "gunbeg": "Usti hlavne",
            "gunend": "Konec hlavne",
            "weapons": ["rhs_weap_D30"],
            "magazines": ["rhs_mag_3of56_10","rhs_mag_d462_2","rhs_mag_s463_2","rhs_mag_3of69m_2"],
