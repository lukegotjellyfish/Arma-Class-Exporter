rhsgref_tla_dshkm_mini_tripod = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_DSHKM_Mini_TriPod.paa",
    "scope": 2,
    ...
    "model": "rhsafrf|addons|rhs_heavyweapons|DShKM|DShKM_mg2",
    # Class: CfgVehicles|rhs_DSHkM_Mini_TriPod_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_DSHkM_Mini_TriPod_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "turretinfotype": "RHS_RscInfoStaticWeapon",
            "gunneraction": "rhs_LowTripod_Gunner",
            ...
            # Class: CfgVehicles|rhs_DSHKM_base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initanglex": 0,
                "minanglex": -30,
                "maxanglex": 30,
    ...
    # Class: CfgVehicles|rhs_DSHkM_Mini_TriPod_base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["rhs_DShkM_Gun_Bag","rhs_DShkM_TripodLow_Bag"],
        "displayname": ""
    },
    "icon": "rhsafrf|addons|rhs_heavyweapons|data|mapico|icomap_DShKM_CA.paa",
    "picture": "rhsafrf|addons|rhs_heavyweapons|data|ico|rhs_DSHKM_ins_ca.paa",
    "mapsize": 2,
    "sensorposition": "gunnerView",
    # Class: CfgVehicles|rhs_DSHKM_base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhs_DSHKM_base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|rhs_DSHKM_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_DSHKM_base|AnimationSources|muzzle_source [Indent level: 2]
        "muzzle_source": {
            "source": "reload",
            "weapon": "rhs_weap_DSHKM"
        },
        # Class: CfgVehicles|rhs_DSHKM_base|AnimationSources|ReloadAnim [Indent level: 2],
        "reloadanim": {
            "source": "reload",
            "weapon": "rhs_weap_DSHKM"
        },
        # Class: CfgVehicles|rhs_DSHKM_base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "rhs_weap_DSHKM"
        },
        # Class: CfgVehicles|rhs_DSHKM_base|AnimationSources|Revolving [Indent level: 2],
        "revolving": {
            "source": "revolving",
            "weapon": "rhs_weap_DSHKM"
        },
        # Class: CfgVehicles|rhs_DSHKM_base|AnimationSources|muzzleHMG_ROT [Indent level: 2],
        "muzzlehmg_rot": {
            "source": "ammorandom",
            "weapon": "rhs_weap_DSHKM"
        }
    },
    # Class: CfgVehicles|rhs_DSHKM_base|Library [Indent level: 1],
    "library": {
        "libtextdesc": "The DShK (Degtyarev-Shpagin Large Calibre) is a Soviet heavy machine gun firing 12.7mm (.50 in) Soviet cartridges. The 'modernized' DShKM version was introduced in 1946. It has been largely replaced by modern NSV and Kord machine guns, but still finds its place in armies and resistance groups the world over."
    },
    # Class: CfgVehicles|StaticMGWeapon|SpeechVariants [Indent level: 1],
    "speechvariants": {
        # Class: CfgVehicles|StaticMGWeapon|SpeechVariants|Default [Indent level: 2]
        "default": {
