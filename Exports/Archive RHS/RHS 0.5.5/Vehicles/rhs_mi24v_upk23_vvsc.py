rhs_mi24v_upk23_vvsc = {
    ...
    # Class: CfgVehicles|RHS_Mi24V_UPK23_vvsc|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|RHS_Mi24V_UPK23_vvsc|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
