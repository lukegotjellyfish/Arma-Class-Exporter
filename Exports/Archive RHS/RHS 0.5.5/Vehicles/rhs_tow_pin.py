rhs_tow_pin = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_tow_pin.paa",
    "scope": 1,
    "collisioneffect": "",
    "scopecurator": 0,
    "model": "rhsafrf|addons|rhs_heavyweapons|D30|pin",
    "accuracy": 1000,
    "animated": 0,
    "countsforscoreboard": 0,
    # Class: CfgVehicles|rhs_tow_pin|DestructionEffects [Indent level: 1],
    "destructioneffects": {
    },
