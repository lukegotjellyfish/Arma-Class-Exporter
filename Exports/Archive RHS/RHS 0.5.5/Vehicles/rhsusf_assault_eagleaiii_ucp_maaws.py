rhsusf_assault_eagleaiii_ucp_maaws = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_maaws|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_maaws|TransportItems|_xx_rhs_mag_maaws_HEDP [Indent level: 2]
