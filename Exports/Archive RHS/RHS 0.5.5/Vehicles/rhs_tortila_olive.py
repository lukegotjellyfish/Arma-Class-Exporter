rhs_tortila_olive = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|backpacks|rhs_tortila_olive_ca.paa",
    "displayname": "SPOSN Tortila Backpack (Olive)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|tortilla_olive_co.paa"],
    "dlc": "RHS_AFRF",
    "scope": 2,
    "mapsize": 0.55,
