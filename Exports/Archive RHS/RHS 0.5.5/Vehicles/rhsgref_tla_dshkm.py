rhsgref_tla_dshkm = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_DSHKM.paa",
    "scope": 2,
    ...
    "model": "rhsafrf|addons|rhs_heavyweapons|DShKM|DShKM_mg",
    ...
    # Class: CfgVehicles|rhs_DSHKM_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_DSHKM_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
    ...
    # Class: CfgVehicles|rhs_DSHKM_base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["rhs_DShkM_Gun_Bag","rhs_DShkM_TripodHigh_Bag"],
        "displayname": ""
    },
