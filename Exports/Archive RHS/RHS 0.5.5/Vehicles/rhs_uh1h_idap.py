rhs_uh1h_idap = {
    ...
    # Class: CfgVehicles|rhs_uh1h_idap|TransportMagazines [Indent level: 1],
    "transportmagazines": {
    },
    # Class: CfgVehicles|rhs_uh1h_idap|TransportItems [Indent level: 1],
    "transportitems": {
    },
    # Class: CfgVehicles|rhs_uh1h_idap|TransportWeapons [Indent level: 1],
    "transportweapons": {
    },
    "hiddenselections": ["Camo1","Camo2","Camo_mlod","decals"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_air|uh1h|data|uh1h_idap_co.paa","rhsgref|addons|rhsgref_air|uh1h|data|uh1h_idap_in_co.paa","rhsgref|addons|rhsgref_air|uh1h|data|mlod_un_co.paa","rhsgref|addons|rhsgref_air|uh1h|data|decals|uh1h_idap_decals_ca.paa"],
    # Class: CfgVehicles|rhs_uh1h_idap|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_uh1h_idap|AnimationSources|Hide_mid_doors [Indent level: 2]
        "hide_mid_doors": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_uh1h_idap|AnimationSources|Hide_guns [Indent level: 2],
        "hide_guns": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 1
    ...
    # Class: CfgVehicles|rhs_uh1h_idap|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|rhs_uh1h_idap|UserActions|Open_Side_Doors [Indent level: 2]
        "open_side_doors": {
        ...
        # Class: CfgVehicles|rhs_uh1h_idap|UserActions|Close_Side_Doors [Indent level: 2],
        "close_side_doors": {
    ...
    # Class: CfgVehicles|rhs_uh1h_idap|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|rhs_uh1h_idap|Attributes|close_cargo_doors [Indent level: 2]
        "close_cargo_doors": {
    ...
    # Class: CfgVehicles|rhs_uh1h_idap|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_uh1h_idap|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
            "caneject": 0,
            "iscopilot": 1,
            "hideweaponsgunner": 0,
