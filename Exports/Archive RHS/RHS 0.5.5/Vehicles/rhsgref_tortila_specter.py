rhsgref_tortila_specter = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Backpacks|rhsgref_tortila_specter_ca.paa",
    "scope": 2,
    "displayname": "SPOSN Tortila (Spectre-SKWO)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|tortilla_specter_co.paa"],
    "mapsize": 0.55,
