rhsusf_m977a4_bkit_m2_usarmy_d = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_hemtt_a4|data|CAB_CO_Des.paa","rhsusf|addons|rhsusf_hemtt_a4|data|BKIT_Des_CO.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CARGO_des_CO.paa","rhsusf|addons|rhsusf_rg33l|data|rg33_turretd_co.paa","rhsusf|addons|rhsusf_hemtt_a4|data|CHASSIS_des_CO.paa"],
    "displayname": "M977A4-B (O-GPK/M2)",
    ...
    # Class: CfgVehicles|rhsusf_HEMTT_A4_base|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhsusf_HEMTT_A4_base|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
        ...
        # Class: CfgVehicles|rhsusf_HEMTT_A4_base|VehicleTransport|Carrier [Indent level: 2],
        "carrier": {
