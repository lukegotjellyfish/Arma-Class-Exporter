rhsusf_caiman_gpk_base = {
    "threat": [0.9,0.3,0.1],
    "shownvggunner": 1,
    # Class: CfgVehicles|rhsusf_caiman_GPK_base|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|rhsusf_caiman_base|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|rhsusf_caiman_base|RHS_TowingSystem|Carrier [Indent level: 2]
        "carrier": {
            "rhs_maxcargomass": 5443,
            "rhs_attachpoint": "",
            "rhs_attachpointpos": [-0.04,-3.38,-1.49]
        }
    },
