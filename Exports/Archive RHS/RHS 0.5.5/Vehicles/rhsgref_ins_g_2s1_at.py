rhsgref_ins_g_2s1_at = {
    ...
    # Class: CfgVehicles|rhsgref_ins_g_2s1_at|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_g_2s1_at|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhsgref_ins_g_2s1_at|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhsgref_ins_g_2s1_at|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                ...
                # Class: CfgVehicles|rhsgref_ins_g_2s1_at|Turrets|MainTurret|Turrets|LoaderOptics [Indent level: 4],
                "loaderoptics": {
                    "gunnertype": "rhsgref_ins_g_crew",
                    "body": "LdrTurret",
                    "gun": "LdrGun",
    ...
    # Class: CfgVehicles|rhsgref_ins_2s1_at|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_ins_2s1_at|TransportMagazines|_xx_rhs_30Rnd_545x39_7N6M_plum_AK [Indent level: 2]
        "_xx_rhs_30rnd_545x39_7n6m_plum_ak": {
            "magazine": "rhs_30Rnd_545x39_7N6M_plum_AK",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_ins_2s1_at|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_ins_2s1_at|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
