rhs_m119_towingvehicle_base = {
    "reversed": 0,
    "displayname": "M119 Tow",
    "model": "rhsusf|addons|rhsusf_heavyweapons|M119_Howitzer|M119",
    "driveoncomponent": ["wheels"],
    # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|fold_arty [Indent level: 2]
        "fold_arty": {
            "source": "user",
            "animperiod": 1.8,
            "initphase": 1
        },
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|fold_arty_gun [Indent level: 2],
        "fold_arty_gun": {
            "source": "user",
            "animperiod": 1.8,
            "initphase": "rad(4)"
        },
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|fold_arty_plate [Indent level: 2],
        "fold_arty_plate": {
            "animperiod": 0.001,
            "initphase": 0,
            "source": "user"
        },
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|fold_arty_handler [Indent level: 2],
        "fold_arty_handler": {
            "animperiod": 0.001,
            "initphase": 0,
            "source": "user"
        },
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|recoil_source [Indent level: 2],
        "recoil_source": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|muzzle_hide_arty [Indent level: 2],
        "muzzle_hide_arty": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|Wheel_1_source [Indent level: 2],
        "wheel_1_source": {
            "source": "wheel",
            "wheel": "Wheel_1"
        },
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|Wheel_2_source [Indent level: 2],
        "wheel_2_source": {
            "source": "wheel",
            "wheel": "Wheel_2"
        },
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|AnimationSources|HideWheels [Indent level: 2],
        "hidewheels": {
            "source": "user",
            "animperiod": 1,
            "initphase": 1
    ...
    "maxomega": 1000,
    "maxspeed": 40,
    # Class: CfgVehicles|rhs_M119_towingVehicle_base|Wheels [Indent level: 1],
    "wheels": {
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|Wheels|Wheel_1 [Indent level: 2]
        "wheel_1": {
            "steering": 1,
            "side": "left",
        ...
        # Class: CfgVehicles|rhs_M119_towingVehicle_base|Wheels|Wheel_2 [Indent level: 2],
        "wheel_2": {
            "steering": 1,
            "side": "right",
