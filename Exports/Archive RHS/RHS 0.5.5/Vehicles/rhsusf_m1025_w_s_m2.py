rhsusf_m1025_w_s_m2 = {
    ...
    # Class: CfgVehicles|rhsusf_m1025_w_s_m2|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhsusf_m1025_w_s_m2|Exhausts|exhaust1 [Indent level: 2]
        "exhaust1": {
            "position": "exhaust2_1",
    ...
    # Class: CfgVehicles|rhsusf_m1025_w_s_m2|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsusf_m1025_w_s_m2|AnimationSources|hide_snorkel [Indent level: 2]
        "hide_snorkel": {
            "initphase": 0,
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_hmmwv|textures|m998_exterior_w_co.paa","rhsusf|addons|rhsusf_hmmwv|textures|m998_interior_w_co.paa","rhsusf|addons|rhsusf_hmmwv|textures|A2_parts_WD_co.paa","rhsusf|addons|rhsusf_hmmwv|textures|wheel_wranglermt_b_co.paa","rhsusf|addons|rhsusf_hmmwv|textures|m998_mainbody_co.paa","rhsusf|addons|rhsusf_hmmwv|textures|gratting_w_co.paa","rhsusf|addons|rhsusf_hmmwv|textures|tile_exmetal_co.paa","rhsusf|addons|rhsusf_hmmwv|textures|m1025_w_co.paa","rhsusf|addons|rhsusf_hmmwv|textures|mk64mount_w_co.paa","rhsusf|addons|rhsusf_hmmwv|unitdecals|usmc_210321_ca.paa",""],
