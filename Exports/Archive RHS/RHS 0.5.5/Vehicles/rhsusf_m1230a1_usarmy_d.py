rhsusf_m1230a1_usarmy_d = {
    ...
    "transportsoldier": 5,
    "cargoaction": ["passenger_generic01_foldhands","passenger_apc_generic02","passenger_apc_generic04","passenger_injured_medevac_truck03","passenger_injured_medevac_truck02"],
    "scope": 2,
    "accuracy": 0.5,
    "attendant": 1,
    # Class: CfgVehicles|rhsusf_M1230a1_usarmy_d|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_M1230a1_usarmy_d|TransportItems|_xx_FirstAidKit [Indent level: 2]
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 20
        },
        # Class: CfgVehicles|rhsusf_M1230a1_usarmy_d|TransportItems|_xx_Toolkit [Indent level: 2],
        "_xx_toolkit": {
            "name": "Toolkit",
            "count": 1
        },
        # Class: CfgVehicles|rhsusf_M1230a1_usarmy_d|TransportItems|_xx_Medikit [Indent level: 2],
        "_xx_medikit": {
            "name": "Medikit",
            "count": 2
        }
    ...
    # Class: CfgVehicles|rhsusf_M1230a1_usarmy_d|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|rhsusf_M1230a1_usarmy_d|RHS_TowingSystem|Carrier [Indent level: 2]
        "carrier": {
            "rhs_attachpointpos": [-0.04,-3.38,-2.07],
