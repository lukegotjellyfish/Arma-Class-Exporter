rhsgref_un_zil131_open = {
    "hiddenselectionstextures": ["|rhsgref|addons|rhsgref_vehicles_ret|data|un|rhs_zil131_cargo_UN_co.paa","|rhsgref|addons|rhsgref_vehicles_ret|data|un|rhs_zil131_cabin_UN_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_base_co.paa"],
    "texturelist": ["UN",1],
    "scope": 2,
    "scopecurator": 2,
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_un_zil131_open.paa",
    "crew": "rhsgref_cdf_un_rifleman_lite",
    "author": "RHS (A2 port)",
    "side": 2,
    "dlc": "RHS_GREF",
    ...
    # Class: CfgVehicles|rhs_zil131_open_base|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|rhs_zil131_open_base|UserActions|lights_toggle [Indent level: 2]
        "lights_toggle": {
        ...
        # Class: CfgVehicles|rhs_zil131_open_base|UserActions|cabinlights_toggle [Indent level: 2],
        "cabinlights_toggle": {
            "shortcut": "lockTarget",
        ...
        # Class: CfgVehicles|rhs_zil131_open_base|UserActions|searchlight_toggle [Indent level: 2],
        "searchlight_toggle": {
            "shortcut": "",
        ...
        # Class: CfgVehicles|rhs_zil131_open_base|UserActions|searchlight_adjust [Indent level: 2],
        "searchlight_adjust": {
            "shortcut": "",
    ...
    # Class: CfgVehicles|rhs_zil131_base|complexGearbox [Indent level: 1],
    "complexgearbox": {
        "gearboxratios": ["R1",-7.09,"N",0,"D1",7.15,"D2",4.1,"D3",2.29,"D4",1.47,"D5",1],
        "transmissionratios": ["High",7.35],
        "gearboxmode": "auto",
        "moveoffgear": 1,
        "drivestring": "D",
        "neutralstring": "N",
    ...
    # Class: CfgVehicles|rhs_zil131_base|Wheels [Indent level: 1],
    "wheels": {
        # Class: CfgVehicles|rhs_zil131_base|Wheels|L1 [Indent level: 2]
        "l1": {
            "side": "left",
            ...
            "latstiffx": 2.5,
            "latstiffy": 18,
            "frictionvsslipgraph": [[0,0.8],[0.16,1.3],[0.9,0.9]]
        },
        # Class: CfgVehicles|rhs_zil131_base|Wheels|L2 [Indent level: 2],
        "l2": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Wheels|L3 [Indent level: 2],
        "l3": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Wheels|R1 [Indent level: 2],
        "r1": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Wheels|R2 [Indent level: 2],
        "r2": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Wheels|R3 [Indent level: 2],
        "r3": {
    ...
    # Class: CfgVehicles|rhs_zil131_base|Sounds [Indent level: 1],
    "sounds": {
        # Class: CfgVehicles|rhs_zil131_base|Sounds|Idle_ext [Indent level: 2]
        "idle_ext": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Sounds|Engine [Indent level: 2],
        "engine": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Sounds|EngineThrust [Indent level: 2],
        "enginethrust": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Sounds|Idle_int [Indent level: 2],
        "idle_int": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Sounds|Engine_int [Indent level: 2],
        "engine_int": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Sounds|EngineThrust_int [Indent level: 2],
        "enginethrust_int": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Sounds|Movement [Indent level: 2],
        "movement": {
            "sound": "soundEnviron",
            "frequency": "1",
            "volume": "0"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresRockOut [Indent level: 2],
        "tiresrockout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext_tires_dirt_soft_1",1,1,60],
            "frequency": "1",
            "volume": "camPos*rock*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresSandOut [Indent level: 2],
        "tiressandout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext-tires-sand1",1,1,60],
            "frequency": "1",
            "volume": "camPos*sand*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresGrassOut [Indent level: 2],
        "tiresgrassout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext_tires_dirt_soft_2",1,1,60],
            "frequency": "1",
            "volume": "camPos*grass*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresMudOut [Indent level: 2],
        "tiresmudout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext-tires-mud2",1,1,60],
            "frequency": "1",
            "volume": "camPos*mud*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresGravelOut [Indent level: 2],
        "tiresgravelout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext_tires_gravel_1",1,1,60],
            "frequency": "1",
            "volume": "camPos*gravel*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresAsphaltOut [Indent level: 2],
        "tiresasphaltout": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|ext_tires_asfalt_2",1,1,60],
            "frequency": "1",
            "volume": "camPos*asphalt*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|NoiseOut [Indent level: 2],
        "noiseout": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|noise_int_car_3",1,1,90],
            "frequency": "1",
            "volume": "camPos*(damper0 max 0.02)*(speed factor[0, 8])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresRockIn [Indent level: 2],
        "tiresrockin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int_tires_dirt_soft_1",0.707946,1],
            "frequency": "1",
            "volume": "(1-camPos)*rock*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresSandIn [Indent level: 2],
        "tiressandin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int-tires-sand2",0.707946,1],
            "frequency": "1",
            "volume": "(1-camPos)*sand*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresGrassIn [Indent level: 2],
        "tiresgrassin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int_tires_dirt_soft_2",0.707946,1],
            "frequency": "1",
            "volume": "(1-camPos)*grass*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresMudIn [Indent level: 2],
        "tiresmudin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int-tires-mud2",0.707946,1],
            "frequency": "1",
            "volume": "(1-camPos)*mud*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresGravelIn [Indent level: 2],
        "tiresgravelin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int_tires_gravel_1",0.707946,1],
            "frequency": "1",
            "volume": "(1-camPos)*gravel*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|TiresAsphaltIn [Indent level: 2],
        "tiresasphaltin": {
            "sound": ["A3|Sounds_F|vehicles|soft|tires|int_tires_asfalt_2",0.707946,1],
            "frequency": "1",
            "volume": "(1-camPos)*asphalt*(speed factor[2, 20])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|NoiseIn [Indent level: 2],
        "noisein": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|noise_int_car_3",0.707946,1],
            "frequency": "1",
            "volume": "(damper0 max 0.1)*(speed factor[0, 8])*(1-camPos)"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|breaking_ext_road [Indent level: 2],
        "breaking_ext_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_04",0.707946,1,80],
            "frequency": 1,
            "volume": "engineOn*camPos*asphalt*(LongSlipDrive Factor[-0.15, -0.3])*(Speed Factor[2, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|acceleration_ext_road [Indent level: 2],
        "acceleration_ext_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02",0.707946,1,80],
            "frequency": 1,
            "volume": "engineOn*camPos*asphalt*(LongSlipDrive Factor[0.15, 0.3])*(Speed Factor[10, 0])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|turn_left_ext_road [Indent level: 2],
        "turn_left_ext_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02",0.707946,1,80],
            "frequency": 1,
            "volume": "engineOn*camPos*asphalt*(latSlipDrive Factor[0.15, 0.3])*(Speed Factor[0, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|turn_right_ext_road [Indent level: 2],
        "turn_right_ext_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02",0.707946,1,80],
            "frequency": 1,
            "volume": "engineOn*camPos*asphalt*(latSlipDrive Factor[-0.15, -0.3])*(Speed Factor[0, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|breaking_ext_dirt [Indent level: 2],
        "breaking_ext_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_14_dirt_breaking",0.707946,1,60],
            "frequency": 1,
            "volume": "engineOn*camPos*(1-asphalt)*(LongSlipDrive Factor[-0.15, -0.3])*(Speed Factor[2, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|acceleration_ext_dirt [Indent level: 2],
        "acceleration_ext_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|acceleration_dirt_ext_1",0.707946,1,60],
            "frequency": 1,
            "volume": "engineOn*camPos*(1-asphalt)*(LongSlipDrive Factor[0.15, 0.3])*(Speed Factor[10, 0])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|turn_left_ext_dirt [Indent level: 2],
        "turn_left_ext_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_18_dirt",0.707946,1,60],
            "frequency": 1,
            "volume": "engineOn*camPos*(1-asphalt)*(latSlipDrive Factor[0.15, 0.3])*(Speed Factor[0, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|turn_right_ext_dirt [Indent level: 2],
        "turn_right_ext_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_18_dirt",0.707946,1,60],
            "frequency": 1,
            "volume": "engineOn*camPos*(1-asphalt)*(latSlipDrive Factor[-0.15, -0.3])*(Speed Factor[0, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|breaking_int_road [Indent level: 2],
        "breaking_int_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_04_int",0.630957,1],
            "frequency": 1,
            "volume": "engineOn*asphalt*(1-camPos)*(LongSlipDrive Factor[-0.15, -0.3])*(Speed Factor[2, 6])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|acceleration_int_road [Indent level: 2],
        "acceleration_int_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02_int",0.630957,1],
            "frequency": 1,
            "volume": "engineOn*asphalt*(1-camPos)*(LongSlipDrive Factor[0.15, 0.3])*(Speed Factor[10, 0])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|turn_left_int_road [Indent level: 2],
        "turn_left_int_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02_int",0.630957,1],
            "frequency": 1,
            "volume": "engineOn*asphalt*(1-camPos)*(latSlipDrive Factor[0.15, 0.3])*(Speed Factor[0, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|turn_right_int_road [Indent level: 2],
        "turn_right_int_road": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_loop_02_int",0.630957,1],
            "frequency": 1,
            "volume": "engineOn*asphalt*(1-camPos)*(latSlipDrive Factor[-0.15, -0.3])*(Speed Factor[0, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|breaking_int_dirt [Indent level: 2],
        "breaking_int_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_14_dirt_breaking_int",0.630957,1],
            "frequency": 1,
            "volume": "engineOn*(1-asphalt)*(1-camPos)*(LongSlipDrive Factor[-0.15, -0.3])*(Speed Factor[2, 6])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|acceleration_int_dirt [Indent level: 2],
        "acceleration_int_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|acceleration_dirt_int_1",0.630957,1],
            "frequency": 1,
            "volume": "engineOn*(1-asphalt)*(1-camPos)*(LongSlipDrive Factor[0.15, 0.3])*(Speed Factor[10, 0])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|turn_left_int_dirt [Indent level: 2],
        "turn_left_int_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_18_dirt_int",0.630957,1],
            "frequency": 1,
            "volume": "engineOn*(1-asphalt)*(1-camPos)*(latSlipDrive Factor[0.15, 0.3])*(Speed Factor[0, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|turn_right_int_dirt [Indent level: 2],
        "turn_right_int_dirt": {
            "sound": ["A3|Sounds_F|vehicles|soft|noises|slipping_tires_18_dirt_int",0.630957,1],
            "frequency": 1,
            "volume": "engineOn*(1-asphalt)*(1-camPos)*(latSlipDrive Factor[-0.15, -0.3])*(Speed Factor[0, 10])"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|RainIn [Indent level: 2],
        "rainin": {
            "sound": ["rhsafrf|addons|rhs_a2port_car|sounds|rain.wss",1.41254,1],
            "frequency": 1,
            "volume": "rain*(1-camPos)"
        },
        # Class: CfgVehicles|rhs_zil131_base|Sounds|RainExt [Indent level: 2],
        "rainext": {
            "sound": ["rhsafrf|addons|rhs_a2port_car|sounds|rain.wss",1.41254,1],
            "frequency": 1,
            "volume": "rain*camPos"
        },
        "soundsetsint": ["RHS_zil131_Engine_RPM0_INT_SoundSet","RHS_zil131_Engine_RPM1_INT_SoundSet","RHS_zil131_Engine_RPM2_INT_SoundSet","RHS_zil131_Engine_RPM3_INT_SoundSet","RHS_zil131_Engine_INT_Burst_SoundSet","RHS_zil131_Rattling_INT_SoundSet","RHS_zil131_Stress_INT_SoundSet","RHS_zil131_Rain_INT_SoundSet","RHS_zil131_Tires_Rock_Fast_INT_SoundSet","RHS_zil131_Tires_Grass_Fast_INT_SoundSet","RHS_zil131_Tires_Sand_Fast_INT_SoundSet","RHS_zil131_Tires_Gravel_Fast_INT_SoundSet","RHS_zil131_Tires_Mud_Fast_INT_SoundSet","RHS_zil131_Tires_Asphalt_Fast_INT_SoundSet","RHS_zil131_Tires_Water_Fast_INT_SoundSet","RHS_zil131_Tires_Rock_Slow_INT_SoundSet","RHS_zil131_Tires_Grass_Slow_INT_SoundSet","RHS_zil131_Tires_Sand_Slow_INT_SoundSet","RHS_zil131_Tires_Gravel_Slow_INT_SoundSet","RHS_zil131_Tires_Mud_Slow_INT_SoundSet","RHS_zil131_Tires_Asphalt_Slow_INT_SoundSet","RHS_zil131_Tires_Water_Slow_INT_SoundSet","RHS_zil131_Tires_Turn_Hard_INT_SoundSet","RHS_zil131_Tires_Turn_Soft_INT_SoundSet","RHS_zil131_Tires_Brake_Hard_INT_SoundSet","RHS_zil131_Tires_Brake_Soft_INT_SoundSet"],
        "soundsetsext": ["RHS_zil131_Engine_RPM0_EXT_SoundSet","RHS_zil131_Engine_RPM1_EXT_SoundSet","RHS_zil131_Engine_RPM2_EXT_SoundSet","RHS_zil131_Engine_RPM3_EXT_SoundSet","RHS_zil131_Engine_EXT_Burst_SoundSet","RHS_zil131_Rattling_EXT_SoundSet","RHS_zil131_Stress_EXT_SoundSet","RHS_zil131_Rain_EXT_SoundSet","RHS_zil131_Tires_Rock_Fast_EXT_SoundSet","RHS_zil131_Tires_Grass_Fast_EXT_SoundSet","RHS_zil131_Tires_Sand_Fast_EXT_SoundSet","RHS_zil131_Tires_Gravel_Fast_EXT_SoundSet","RHS_zil131_Tires_Mud_Fast_EXT_SoundSet","RHS_zil131_Tires_Asphalt_Fast_EXT_SoundSet","RHS_zil131_Tires_Water_Fast_EXT_SoundSet","RHS_zil131_Tires_Rock_Slow_EXT_SoundSet","RHS_zil131_Tires_Grass_Slow_EXT_SoundSet","RHS_zil131_Tires_Sand_Slow_EXT_SoundSet","RHS_zil131_Tires_Gravel_Slow_EXT_SoundSet","RHS_zil131_Tires_Mud_Slow_EXT_SoundSet","RHS_zil131_Tires_Asphalt_Slow_EXT_SoundSet","RHS_zil131_Tires_Water_Slow_EXT_SoundSet","RHS_zil131_Tires_Turn_Hard_EXT_SoundSet","RHS_zil131_Tires_Turn_Soft_EXT_SoundSet","RHS_zil131_Tires_Brake_Hard_EXT_SoundSet","RHS_zil131_Tires_Brake_Soft_EXT_SoundSet"]
    },
    "rhs_decalparameters": ["['Number', [5,6,7,8], 'Default']"],
    "tf_haslrradio_api": 0,
    "category": "Car",
    ...
    "viewdrivershadow": 1,
    "viewgunnershadow": 1,
    "viewcargoshadowdiff": 0.95,
    "viewdrivershadowdiff": 0.95,
    "viewgunnershadowdiff": 0.95,
    "hideproxyincombat": 1,
    "canhidedriver": 0,
    ...
    # Class: CfgVehicles|rhs_zil131_base|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhs_zil131_base|Exhausts|Exhaust1 [Indent level: 2]
        "exhaust1": {
    ...
    # Class: CfgVehicles|rhs_zil131_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels_damage.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_destruct.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_base.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_base_damage.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_destruct.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_cabin.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_cabin_damage.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_destruct.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_cargo.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_cargo_damage.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_destruct.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_glass.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_glass_damage.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_glass_damage.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_damage.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_destruct.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_detail.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_detail_damage.rvmat","rhsafrf|addons|rhs_zil131|data|rhs_zil131_destruct.rvmat"]
    },
    # Class: CfgVehicles|rhs_zil131_base|Reflectors [Indent level: 1],
    "reflectors": {
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Left [Indent level: 2]
        "left": {
            "color": [1900,1300,950],
            "ambient": [5,5,5],
            "position": "Light_L",
            ...
            "daylight": 0,
            "flaresize": 1,
            # Class: CfgVehicles|rhs_zil131_base|Reflectors|Left|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 0,
                "linear": 0,
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Right [Indent level: 2],
        "right": {
            "position": "Light_R",
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Right2 [Indent level: 2],
        "right2": {
            "useflare": 1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Left2 [Indent level: 2],
        "left2": {
            "useflare": 1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Long_Left [Indent level: 2],
        "long_left": {
            "color": [1900,1300,950],
            "ambient": [5,5,5],
            ...
            # Class: CfgVehicles|rhs_zil131_base|Reflectors|Long_Left|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 1,
                "constant": 0,
                "linear": 0.1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Long_Right [Indent level: 2],
        "long_right": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Long_Right2 [Indent level: 2],
        "long_right2": {
            "useflare": 1,
            ...
            "conefadecoef": 51,
            "intensity": 5,
            # Class: CfgVehicles|rhs_zil131_base|Reflectors|Long_Right2|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 0,
                "linear": 1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Long_Left2 [Indent level: 2],
        "long_left2": {
            "useflare": 1,
            ...
            "conefadecoef": 11,
            "intensity": 5,
            # Class: CfgVehicles|rhs_zil131_base|Reflectors|Long_Left2|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 0,
                "linear": 1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|Searchlight [Indent level: 2],
        "searchlight": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Reflectors|cabin [Indent level: 2],
        "cabin": {
            "color": [800,900,650],
            "ambient": [5,0,0],
            "intensity": 4,
            ...
            "daylight": 0,
            "blinking": 0,
            # Class: CfgVehicles|rhs_zil131_base|Reflectors|cabin|Attenuation [Indent level: 3],
            "attenuation": {
                "start": 0,
                "constant": 0,
                "linear": 1,
    ...
    "aggregatereflectors": [["Left","Right","Left2","Right2"],["Long_Left2","Long_Right2"]],
    "armorlights": 0.01,
    # Class: CfgVehicles|rhs_zil131_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|Door_LF [Indent level: 2]
        "door_lf": {
            "source": "door",
            "animperiod": 0.8,
            "sound": "RHS_Ural_Door",
        ...
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|Door_RF [Indent level: 2],
        "door_rf": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|gearbox [Indent level: 2],
        "gearbox": {
            "sound": "RHS_gearbox",
        ...
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|HitSpare [Indent level: 2],
        "hitspare": {
            "source": "Hit",
            "hitpoint": "HitSpare",
            "raw": 1
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|UseSpare [Indent level: 2],
        "usespare": {
            "hitpoint": "UseSpare",
            "source": "Hit",
            "raw": 1
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|longlights_hide [Indent level: 2],
        "longlights_hide": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 1
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|shortlights_hide [Indent level: 2],
        "shortlights_hide": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1e-006
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|lights_hide [Indent level: 2],
        "lights_hide": {
            "initphase": 0,
            "source": "user",
            "animperiod": 1e-006
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|searchlight_hide [Indent level: 2],
        "searchlight_hide": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 1
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|cabinlights_hide [Indent level: 2],
        "cabinlights_hide": {
            "source": "user",
            "animperiod": 1e-006,
            "initphase": 1
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|searchlight_rot [Indent level: 2],
        "searchlight_rot": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|turnout1 [Indent level: 2],
        "turnout1": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|turnout2 [Indent level: 2],
        "turnout2": {
            "source": "user",
            "animperiod": 1,
            "initphase": 0
        },
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|spare_hide [Indent level: 2],
        "spare_hide": {
            "mass": 1,
            "source": "user",
        ...
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|rearnum_hide [Indent level: 2],
        "rearnum_hide": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|bench_hide [Indent level: 2],
        "bench_hide": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|AnimationSources|cover_hide [Indent level: 2],
        "cover_hide": {
    ...
    # Class: CfgVehicles|rhs_zil131_base|HitPoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitFuel_L [Indent level: 2]
        "hitfuel_l": {
            "armor": -30,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitFuel_R [Indent level: 2],
        "hitfuel_r": {
            "armor": -30,
            "explosionshielding": 0.5,
            "passthrough": 0.1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitFuel [Indent level: 2],
        "hitfuel": {
            "armor": -999,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine [Indent level: 2],
        "hitengine": {
            "name": "hit_engine",
            "visual": "zbytek",
            "armor": -30,
            ...
            "explosionshielding": 0.5,
            "radius": 0.12,
            # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine|DestructionEffects [Indent level: 3],
            "destructioneffects": {
                "ammoexplosioneffect": "",
                # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Smoke [Indent level: 4],
                "rhs_engine_smoke": {
                ...
                # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Fire [Indent level: 4],
                "rhs_engine_fire": {
                ...
                # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Sparks [Indent level: 4],
                "rhs_engine_sparks": {
                    "type": "RHS_FireSparks",
                    "simulation": "particles",
                    "position": "engine_smoke1",
                ...
                # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Sounds [Indent level: 4],
                "rhs_engine_sounds": {
                    "simulation": "sound",
                    "type": "Fire",
                    "position": "engine_smoke1",
                ...
                # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Smoke_small1 [Indent level: 4],
                ...
                # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Smoke_small2 [Indent level: 4],
                ...
                # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitEngine|DestructionEffects|RHS_Engine_Smoke_small3 [Indent level: 4],
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitLFWheel [Indent level: 2],
        "hitlfwheel": {
            "radius": 0.25,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitLF2Wheel [Indent level: 2],
        "hitlf2wheel": {
            "radius": 0.25,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitLMWheel [Indent level: 2],
        "hitlmwheel": {
            "radius": 0.25,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitLBWheel [Indent level: 2],
        "hitlbwheel": {
            "radius": 0.25,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitRFWheel [Indent level: 2],
        "hitrfwheel": {
            "radius": 0.25,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitRF2Wheel [Indent level: 2],
        "hitrf2wheel": {
            "radius": 0.25,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitRMWheel [Indent level: 2],
        "hitrmwheel": {
            "radius": 0.25,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitRBWheel [Indent level: 2],
        "hitrbwheel": {
            "radius": 0.25,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitGlass1 [Indent level: 2],
        "hitglass1": {
            "armor": -2,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitGlass2 [Indent level: 2],
        "hitglass2": {
            "armor": -2,
            "explosionshielding": 1.5,
            "passthrough": 0.1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitGlass3 [Indent level: 2],
        "hitglass3": {
            "armor": -2,
            "explosionshielding": 1.5,
            "passthrough": 0.1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitGlass4 [Indent level: 2],
        "hitglass4": {
            "armor": -2,
            "explosionshielding": 1.5,
            "passthrough": 0.1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitGlass5 [Indent level: 2],
        "hitglass5": {
            "armor": -2,
            "explosionshielding": 1.5,
            "passthrough": 0.1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|HitSpare [Indent level: 2],
        "hitspare": {
            "name": "spare1",
            "radius": 0.25,
            "visual": "wheel_2_2_damage",
        ...
        # Class: CfgVehicles|rhs_zil131_base|HitPoints|UseSpare [Indent level: 2],
        "usespare": {
            "name": "",
            "visual": "-",
            "armor": 1,
    ...
    # Class: CfgVehicles|rhs_zil131_base|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhs_zil131_base|textureSources|standard [Indent level: 2]
        "standard": {
            "displayname": "Standard",
            "textures": ["|rhsafrf|addons|rhs_zil131|data|rhs_zil131_cargo_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_cabin_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_base_co.paa"],
            "factions": ["rhs_faction_vmf","rhs_faction_vdv","rhs_faction_vdv","rhs_faction_vv"]
        },
        # Class: CfgVehicles|rhs_zil131_base|textureSources|CDF [Indent level: 2],
        "cdf": {
            "displayname": "CDF",
            "textures": ["|rhsgref|addons|rhsgref_vehicles_ret|data|cdf|rhs_zil131_cargo_CDF_co.paa","|rhsgref|addons|rhsgref_vehicles_ret|data|cdf|rhs_zil131_cabin_CDF_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_base_co.paa"],
            "factions": []
        },
        # Class: CfgVehicles|rhs_zil131_base|textureSources|UN [Indent level: 2],
        "un": {
            "displayname": "UN",
            "textures": ["|rhsgref|addons|rhsgref_vehicles_ret|data|un|rhs_zil131_cargo_UN_co.paa","|rhsgref|addons|rhsgref_vehicles_ret|data|un|rhs_zil131_cabin_UN_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_base_co.paa"],
            "factions": []
        },
        # Class: CfgVehicles|rhs_zil131_base|textureSources|CHDKZ [Indent level: 2],
        "chdkz": {
            "displayname": "CHDKZ",
            "textures": ["|rhsgref|addons|rhsgref_vehicles_ret|data|chdkz|rhs_zil131_cargo_CHDKZ_co.paa","|rhsgref|addons|rhsgref_vehicles_ret|data|chdkz|rhs_zil131_cabin_CHDKZ_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_base_co.paa"],
            "factions": []
        }
    },
    # Class: CfgVehicles|rhs_zil131_base|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|rhs_zil131_base|Attributes|ObjectTexture [Indent level: 2]
        "objecttexture": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type [Indent level: 2],
        "rhs_decalnumber_type": {
            ...
            "defaultvalue": 0,
            "typename": "STRING",
            # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values|Default [Indent level: 4]
                "default": {
                    "name": "Default",
                    "value": "Default",
                    "defaultvalue": "Default"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values|DefaultRed [Indent level: 4],
                "defaultred": {
                    "name": "Default (Red)",
                    "value": "DefaultRed"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values|BoldRed [Indent level: 4],
                "boldred": {
                    "name": "Bold Red",
                    "value": "BoldRed"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values|CDF [Indent level: 4],
                "cdf": {
                    "name": "CDF",
                    "value": "CDF"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values|Handpaint [Indent level: 4],
                "handpaint": {
                    "name": "Handpaint",
                    "value": "Handpaint"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values|HandpaintBlack [Indent level: 4],
                "handpaintblack": {
                    "name": "Handpaint Black",
                    "value": "HandpaintBlack"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values|Iraqi [Indent level: 4],
                "iraqi": {
                    "name": "Iraqi",
                    "value": "Iraqi"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber_type|values|LicensePlate [Indent level: 4],
                "licenseplate": {
                    "name": "License Plate",
                    "value": "LicensePlate"
                }
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalNumber [Indent level: 2],
        "rhs_decalnumber": {
            "collapsed": 1,
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy_type [Indent level: 2],
        "rhs_decalarmy_type": {
            ...
            "defaultvalue": "0",
            "typename": "STRING",
            # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy_type|values|Army [Indent level: 4]
                "army": {
                    "name": "Army",
                    "value": "Army",
                    "defaultvalue": "Army"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy_type|values|Honor [Indent level: 4],
                "honor": {
                    "name": "Honor",
                    "value": "Honor"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy_type|values|HonorGDR [Indent level: 4],
                "honorgdr": {
                    "name": "Honor GDR",
                    "value": "HonorGDR"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy_type|values|Platoon [Indent level: 4],
                "platoon": {
                    "name": "Platoon",
                    "value": "Platoon"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy_type|values|PlatoonGDR [Indent level: 4],
                "platoongdr": {
                    "name": "Platoon GDR",
                    "value": "PlatoonGDR"
                },
                # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy_type|values|PlatoonVDV [Indent level: 4],
                "platoonvdv": {
                    "name": "Platoon VDV",
                    "value": "PlatoonVDV"
                }
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalArmy [Indent level: 2],
        "rhs_decalarmy": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalPlatoon_type [Indent level: 2],
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_decalPlatoon [Indent level: 2],
        "rhs_decalplatoon": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_hidespare [Indent level: 2],
        "rhs_hidespare": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|rhs_hidebench [Indent level: 2],
        "rhs_hidebench": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|Door_LF [Indent level: 2],
        "door_lf": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|Door_RF [Indent level: 2],
        "door_rf": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|Attributes|back_door [Indent level: 2],
        "back_door": {
    ...
    # Class: CfgVehicles|rhs_zil131_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_zil131_base|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|EventHandlers|BIS_Randomisation [Indent level: 2],
        "bis_randomisation": {
    ...
    # Class: CfgVehicles|rhs_zil131_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_01 [Indent level: 2]
        "cargoturret_01": {
            ...
            # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_01|TurnIn [Indent level: 3],
            "turnin": {
                "limitsarraytop": [[-5.9651,-65.8681],[17.3442,-42.6425],[19.0929,-7.8701],[-2.3451,2.5708]],
                "limitsarraybottom": [[-44.4687,-70.9972],[-23.5626,5.0429]]
            },
            "commanding": -2,
            # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_01|Hitpoints [Indent level: 3],
            "hitpoints": {
            },
        ...
        # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
            ...
            "proxyindex": 9,
            # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_02|TurnIn [Indent level: 3],
            "turnin": {
                "limitsarraytop": [[-9.815,-4.5301],[-1.5719,-1.2185],[17.505,16.3857],[19.004,46.8344],[-14.3588,76.1193],[-21.8244,80]],
                "limitsarraybottom": [[-22.8074,-7.2107],[-44.7521,10.6169],[-44.8467,80]]
            },
            "gunnergetinaction": "GetInHemttBack",
            "gunnergetoutaction": "GetOutHighZamak",
        ...
        # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_03 [Indent level: 2],
        "cargoturret_03": {
            "gunnercompartments": "Compartment2",
            ...
            "canhidegunner": 1,
            "allowlauncherout": 1,
            # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_03|TurnIn [Indent level: 3],
            "turnin": {
                "limitsarraytop": [[45,-85],"",[35,-17],[15,-15]],
                "limitsarraybottom": [[10.85,-85],[6,-31],[-22,-25],[-13.5,-15]]
            },
            # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_03|TurnOut [Indent level: 3],
            "turnout": {
                "limitsarraytop": [[35,-85],[35,80]],
                "limitsarraybottom": [[-25,-65],[-25,-49],[-3,-46],[-2,-41],[-0.4,11],[-1.6,52],[-4.5,55],[-45,60],[-42,74],[-29,78],[-15,80]],
                "turnoffset": -90
            },
            "gunnergetinaction": "GetInHemttBack",
            "gunnergetoutaction": "GetOutHighZamak",
        ...
        # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_04 [Indent level: 2],
        "cargoturret_04": {
            ...
            "maxturn": 25,
            "minturn": -60,
            # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_04|TurnIn [Indent level: 3],
            "turnin": {
                "limitsarraytop": [[25,20],[55,94]],
                "limitsarraybottom": [[-14,20],[-10,23],[-14,28],[4.21,30],[9.27,81],[7,94]]
            },
            # Class: CfgVehicles|rhs_zil131_base|Turrets|CargoTurret_04|TurnOut [Indent level: 3],
            "turnout": {
                "limitsarraytop": [[35,-60],[35,95]],
                "limitsarraybottom": [[-28,-66],[-21,-55],[-0.4,-54],[-0.32,-37],[-0.2,-1],[-2,40],[-4,43],[-14,47],[-42,54],[-45,61],[-15,95]],
                "turnoffset": -90
            },
            "gunnercompartments": "Compartment2",
            "gunnerinaction": "RHS_Ural_Turnout01",
    ...
    # Class: CfgVehicles|rhs_zil131_base|RenderTargets [Indent level: 1],
    "rendertargets": {
        # Class: CfgVehicles|rhs_zil131_base|RenderTargets|mirrorL [Indent level: 2]
        "mirrorl": {
            "rendertarget": "rendertarget0",
            # Class: CfgVehicles|rhs_zil131_base|RenderTargets|mirrorL|mirror [Indent level: 3],
            "mirror": {
        ...
        # Class: CfgVehicles|rhs_zil131_base|RenderTargets|mirrorR [Indent level: 2],
        "mirrorr": {
            "rendertarget": "rendertarget1",
            # Class: CfgVehicles|rhs_zil131_base|RenderTargets|mirrorR|mirror [Indent level: 3],
            "mirror": {
    ...
    # Class: CfgVehicles|rhs_zil131_base|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|rhs_zil131_base|RHS_TowingSystem|Carrier [Indent level: 2]
        "carrier": {
            "rhs_maxcargomass": 2000,
            "rhs_attachpoint": "",
            "rhs_attachpointpos": [0,-2.7,-0.85]
        }
    },
