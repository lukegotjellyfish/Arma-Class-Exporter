rhsusf_m1078a1p2_wd_open_fmtv_usarmy = {
    ...
    # Class: CfgVehicles|rhsusf_M1078A1P2_open_fmtv_usarmy|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsusf_M1078A1P2_open_fmtv_usarmy|AnimationSources|hide_cover [Indent level: 2]
        "hide_cover": {
            "initphase": 1,
            "source": "user",
            "mass": -20,
        ...
        # Class: CfgVehicles|rhsusf_M1078A1P2_open_fmtv_usarmy|AnimationSources|hide_scaffold [Indent level: 2],
        "hide_scaffold": {
            "initphase": 1,
            "author": "Red Hammer Studios",
