rhsgref_tla_backpack_rpg = {
    "scope": 1,
    # Class: CfgVehicles|rhsgref_tla_backpack_rpg|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_tla_backpack_rpg|TransportMagazines|_xx_rhs_rpg7_PG7V_mag [Indent level: 2]
        "_xx_rhs_rpg7_pg7v_mag": {
            "magazine": "rhs_rpg7_PG7V_mag",
            "count": 1
        },
        # Class: CfgVehicles|rhsgref_tla_backpack_rpg|TransportMagazines|_xx_rhs_rpg7_type69_airburst_mag [Indent level: 2],
