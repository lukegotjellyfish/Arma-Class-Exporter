rhs_sidormg = {
    ...
    # Class: CfgVehicles|rhs_sidorMG|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhs_sidorMG|TransportMagazines|_xx_rhs_100Rnd_762x54mmR [Indent level: 2]
