rhs_t50_vvs_blueonblue = {
    ...
    "displayname": "T-50 obr. 2013 (055)",
    "author": "Red Hammer Studios",
    "dlc": "RHS_AFRF",
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_air|t50|data|pakfa_blueonblue_co.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Numbers|AviaBlue|0_ca.paa","|rhsafrf|addons|rhs_decals|Data|Numbers|AviaBlue|5_ca.paa","|rhsafrf|addons|rhs_decals|Data|Numbers|AviaBlue|5_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|no_ca.paa","|rhsafrf|addons|rhs_decals|Data|Labels|Aviation|star_new_ca.paa","rhsafrf|addons|rhs_c_air|scripts|data|altis_co.paa","rhsafrf|addons|rhs_c_air|scripts|data|WP_move_ca.paa"],
    # Class: CfgVehicles|RHS_T50_vvs_blueonblue|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_T50_vvs_blueonblue|AnimationSources|antenna_hide [Indent level: 2]
        "antenna_hide": {
            "initphase": 0,
            "source": "user",
            "animperiod": 0.001,
        ...
        # Class: CfgVehicles|RHS_T50_vvs_blueonblue|AnimationSources|sensors_hide [Indent level: 2],
        "sensors_hide": {
            "initphase": 1,
