rhsgref_ins_zsu234 = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_zsu234.paa",
    ...
    "scope": 2,
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_a2port_armor|data|zsu_01_gue_co.paa","|rhsafrf|addons|rhs_a2port_armor|data|zsu_02_gue_co.paa","|rhsafrf|addons|rhs_a2port_armor|data|zsu_03_gue_co.paa","rhsafrf|addons|rhs_decals|Data|Labels|Misc|no_ca.paa"],
    "rhs_decalparameters": ["['Number',cRHSZSUNumberPlaces,'Handpaint']"],
    # Class: CfgVehicles|rhsgref_ins_zsu234|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_ins_zsu234|TransportMagazines|_xx_rhs_30Rnd_762x39mm_bakelite [Indent level: 2]
        "_xx_rhs_30rnd_762x39mm_bakelite": {
            "magazine": "rhs_30Rnd_762x39mm_bakelite",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_ins_zsu234|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_ins_zsu234|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
        "_xx_rhs_mag_nspn_red": {
            "magazine": "rhs_mag_nspn_red",
            "count": 10
        }
    },
    # Class: CfgVehicles|rhsgref_ins_zsu234|TransportWeapons [Indent level: 1],
    "transportweapons": {
        # Class: CfgVehicles|rhsgref_ins_zsu234|TransportWeapons|_xx_rhs_weap_akm [Indent level: 2]
        "_xx_rhs_weap_akm": {
            "weapon": "rhs_weap_akm",
            "count": 1
        }
