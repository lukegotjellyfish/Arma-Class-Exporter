rhs_uh60m_mev2 = {
    ...
    "editorpreview": "rhsusf|addons|rhsusf_editorPreviews|data|RHS_UH60M_MEV2.paa",
    # Class: CfgVehicles|RHS_UH60M_MEV2|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_UH60M_MEV2|AnimationSources|fuelTanks_hide [Indent level: 2]
        "fueltanks_hide": {
            "source": "user",
            "animperiod": 0.0001,
            "initphase": 1
