rhsgref_un_ural = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_un_ural.paa",
    "scope": 2,
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_un_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_plachta_un_co.paa","rhsafrf|addons|RHS_Decals|Data|Labels|Misc|no_ca.paa"],
