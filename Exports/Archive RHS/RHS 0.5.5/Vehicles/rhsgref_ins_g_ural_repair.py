rhsgref_ins_g_ural_repair = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_ural_repair.paa",
    "displayname": "Ural-4320 (Repair)",
    "dlc": "RHS_GREF",
    # Class: CfgVehicles|rhsgref_ins_ural_repair|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_ural_repair|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa"],
    "rhs_decalparameters": ["['Number', cDecals4CarsNumberPlaces, 'Default']","['Label', cDecalsCarsRightArmyPlaces, 'Platoon', 12]"],
