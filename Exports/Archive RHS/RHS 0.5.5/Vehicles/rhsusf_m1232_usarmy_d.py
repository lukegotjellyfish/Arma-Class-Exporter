rhsusf_m1232_usarmy_d = {
    ...
    # Class: CfgVehicles|rhsusf_RG33L_base|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|rhsusf_RG33L_base|RHS_TowingSystem|Carrier [Indent level: 2]
        "carrier": {
            "rhs_maxcargomass": 8754,
            "rhs_attachpoint": "",
            "rhs_attachpointpos": [-0.05,-3.6,0]
        }
    },
