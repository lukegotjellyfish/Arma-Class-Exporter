rhs_melb_ah6m_m = {
    ...
    # Class: CfgVehicles|RHS_MELB_AH6M_M|components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_MELB_AH6M_M|components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|RHS_MELB_AH6M_M|components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|RHS_MELB_AH6M_M|components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|RHS_MELB_AH6M_M|components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                    "attachment": "",
                ...
                # Class: CfgVehicles|RHS_MELB_AH6M_M|components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                    "attachment": "",
                ...
                # Class: CfgVehicles|RHS_MELB_AH6M_M|components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
