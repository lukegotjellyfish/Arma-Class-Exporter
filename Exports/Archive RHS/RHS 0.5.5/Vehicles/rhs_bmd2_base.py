rhs_bmd2_base = {
    ...
    "texturelist": [],
    # Class: CfgVehicles|rhs_bmd2_base|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|rhs_bmd2_base|UserActions [Indent level: 1],
    "useractions": {
    ...
    # Class: CfgVehicles|rhs_bmd2_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_bmd2_base|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
