rhsgref_un_uaz = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_un_uaz.paa",
    "scope": 2,
    ...
    "accuracy": 0.5,
    "rhs_decalparameters": ["['Number', cDecals4CarsNumberPlaces, 'LicensePlate']","['Label', cDecalsCarsRightArmyPlaces, 'Army', 16]"],
