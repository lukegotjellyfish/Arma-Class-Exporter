rhsgref_ins_g_t72bc = {
    ...
    # Class: CfgVehicles|rhsgref_ins_g_t72bc|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_g_t72bc|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhsgref_ins_g_t72bc|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhsgref_ins_g_t72bc|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                ...
                # Class: CfgVehicles|rhsgref_ins_g_t72bc|Turrets|MainTurret|Turrets|CommanderMG [Indent level: 4],
                "commandermg": {
