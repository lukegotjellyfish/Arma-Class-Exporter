rhs_mi8amtsh_fab_vvsc = {
    ...
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_a2port_air|Mi17|data|camo|mi_171_camo1_co.paa","|rhsafrf|addons|rhs_a2port_air|Mi17|data|camo|mi8_det_g_camo1_co.paa","a3|data_f|clear_empty.paa","rhsafrf|addons|rhs_a2port_air|mi17|data|mi8_decals_ca.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa","rhsafrf|addons|rhs_decals|data|labels|aviation|vvs_ca.paa"],
    "displayname": "Mi-8AMTSh (FAB)",
    "scope": 1,
    "scopecurator": 2,
    # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                    "attachment": "rhs_mag_fab250",
                ...
                # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                ...
                # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
                    "attachment": "rhs_mag_b8v20a_s8kom",
                ...
                # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent|pylons|pylon5 [Indent level: 4],
                "pylon5": {
                ...
                # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent|pylons|pylon6 [Indent level: 4],
                "pylon6": {
                    "attachment": "rhs_mag_b8v20a_s8df",
                ...
                # Class: CfgVehicles|RHS_Mi8AMTSh_FAB_vvs|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4],
                "cmdispenser": {
    ...
    # Class: CfgVehicles|rhs_mi8amtsh_base|AnimationSources [Indent level: 1],
    "animationsources": {
