rhsgref_ins_uaz_spg9 = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_uaz_spg9.paa",
    "rhs_decalparameters": ["['Number', cDecals4CarsNumberPlaces, 'LicensePlate']"],
    "scope": 2,
    # Class: CfgVehicles|rhsgref_ins_uaz_spg9|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_uaz_spg9|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
    ...
    # Class: CfgVehicles|rhsgref_ins_uaz_spg9|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_uaz_spg9|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
        ...
        # Class: CfgVehicles|rhsgref_ins_uaz_spg9|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
