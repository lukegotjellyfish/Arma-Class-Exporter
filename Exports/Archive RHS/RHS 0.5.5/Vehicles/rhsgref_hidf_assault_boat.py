rhsgref_hidf_assault_boat = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_hidf_assault_boat.paa",
    "typicalcargo": [],
    "hiddenselectionstextures": ["|A3|boat_F|Boat_Transport_01|data|boat_transport_01_co.paa"],
    "texturelist": ["Black",1],
    # Class: CfgVehicles|B_Boat_Transport_01_F|SimpleObject [Indent level: 1],
    "simpleobject": {
        "eden": 1,
        "animate": [["damagehide",0],["damagehide_zbytek",0],["damage_unhide",0],["drivingwheel",0],["propeller",0],["vehicletransported_engine",0],["vehicletransported_drivingwheel",0]],
        "hide": ["zasleh","zadni svetlo","brzdove svetlo","clan","podsvit pristroju","poskozeni"],
        "verticaloffset": 1.236,
    ...
    # Class: CfgVehicles|Rubber_duck_base_F|Sounds [Indent level: 1],
    "sounds": {
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|IdleOut [Indent level: 2]
        "idleout": {
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|Engine [Indent level: 2],
        "engine": {
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|EngineMidOut [Indent level: 2],
        "enginemidout": {
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|EngineMaxOut [Indent level: 2],
        "enginemaxout": {
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|WaternoiseOutW0 [Indent level: 2],
        "waternoiseoutw0": {
            "sound": ["A3|Sounds_F|vehicles|boat|SFX|voda-o-bok-lodi-0-speed1",1,1,100],
            "frequency": "1",
            "volume": "(speed factor[4, 1]) * water"
        },
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|WaternoiseOutW1 [Indent level: 2],
        "waternoiseoutw1": {
            "sound": ["A3|Sounds_F|vehicles|boat|SFX|voda-o-bok-lodi-20-speed",1,1,150],
            "frequency": "1",
            "volume": "((speed factor[2, 6]) min (speed factor[6, 4]))"
        },
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|WaternoiseOutW2 [Indent level: 2],
        "waternoiseoutw2": {
            "sound": ["A3|Sounds_F|vehicles|boat|SFX|voda-o-bok-lodi-50-speed",1,1,300],
            "frequency": "1",
            "volume": "(speed factor[3, 9])"
        },
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|WaternoiseOutW3 [Indent level: 2],
        "waternoiseoutw3": {
            "sound": ["A3|Sounds_F|vehicles|boat|SFX|voda-o-bok-lodi-0-speed1",1,1,100],
            "frequency": "1",
            "volume": "(speed factor[-4, -1]) * water"
        },
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|WaternoiseOutW4 [Indent level: 2],
        "waternoiseoutw4": {
            "sound": ["A3|Sounds_F|vehicles|boat|SFX|voda-o-bok-lodi-20-speed",1,0.9,150],
            "frequency": "1",
            "volume": "((speed factor[-2, -6]) min (speed factor[-6, -4]))"
        },
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|WaternoiseOutW5 [Indent level: 2],
        "waternoiseoutw5": {
            "sound": ["A3|Sounds_F|vehicles|boat|SFX|voda-o-bok-lodi-50-speed",1,0.9,300],
            "frequency": "1",
            "volume": "(speed factor[-3, -9])"
        },
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|scrubLandExt [Indent level: 2],
        "scrublandext": {
            "sound": ["A3|Sounds_F|vehicles|boat|noises|boat_land_on_shallow",1.77828,1,100],
            "frequency": 1,
            "volume": "(scrubLand factor[0.01, 0.20])"
        },
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|RainExt [Indent level: 2],
        "rainext": {
            "sound": ["A3|Sounds_F|vehicles|noises|rain2_ext",1,1,100],
            "frequency": 1,
            "volume": "camPos * (rain - rotorSpeed/2) * 2"
        },
        # Class: CfgVehicles|Rubber_duck_base_F|Sounds|RainInt [Indent level: 2],
        "rainint": {
            "sound": ["A3|Sounds_F|vehicles|noises|rain2_ext",1,1,100],
            "frequency": 1,
    ...
    "transportsoldier": 0,
    # Class: CfgVehicles|Rubber_duck_base_F|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|Rubber_duck_base_F|Turrets|CargoTurret_01 [Indent level: 2]
        "cargoturret_01": {
            ...
            "minturn": -60,
            "ispersonturret": 1,
            # Class: CfgVehicles|Rubber_duck_base_F|Turrets|CargoTurret_01|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
            ...
            "minturn": -45,
            "minelev": -7,
            # Class: CfgVehicles|Rubber_duck_base_F|Turrets|CargoTurret_02|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
                "cargoturret_03": [-5,80],
                "cargoturret_04": [3,80]
            },
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|Turrets|CargoTurret_03 [Indent level: 2],
        "cargoturret_03": {
            ...
            "maxturn": 95,
            "minturn": -95,
            # Class: CfgVehicles|Rubber_duck_base_F|Turrets|CargoTurret_03|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
            },
            "gunnercompartments": "Compartment1",
            "gunnergetoutaction": "GetOutBoat",
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|Turrets|CargoTurret_04 [Indent level: 2],
        "cargoturret_04": {
            ...
            "maxturn": 80,
            "minturn": -45,
            # Class: CfgVehicles|Rubber_duck_base_F|Turrets|CargoTurret_04|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
    ...
    # Class: CfgVehicles|Rubber_duck_base_F|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|Rubber_duck_base_F|TextureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|Rubber_duck_base_F|TextureSources|Black [Indent level: 2]
        "black": {
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|TextureSources|Hex [Indent level: 2],
        "hex": {
            "author": "Bohemia Interactive",
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|TextureSources|Rescue [Indent level: 2],
        "rescue": {
            "displayname": "Rescue",
            "author": "Bohemia Interactive",
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|TextureSources|Civilian [Indent level: 2],
        "civilian": {
        ...
        # Class: CfgVehicles|Rubber_duck_base_F|TextureSources|Digital [Indent level: 2],
        "digital": {
            "displayname": "Digital",
            "author": "Bohemia Interactive",
    ...
    # Class: CfgVehicles|Rubber_duck_base_F|EventHandlers [Indent level: 1],
    "eventhandlers": {
