rhsgref_ins_g_uaz_spg9 = {
    ...
    # Class: CfgVehicles|rhsgref_ins_g_uaz_spg9|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_g_uaz_spg9|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
        ...
        # Class: CfgVehicles|rhsgref_ins_g_uaz_spg9|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
