rhs_2s3tank_at_base = {
    ...
    # Class: CfgVehicles|rhs_2s3tank_at_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_2s3tank_at_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "elevationmode": 0,
            # Class: CfgVehicles|rhs_2s3tank_at_base|Turrets|MainTurret|Turrets [Indent level: 3],
            "turrets": {
                # Class: CfgVehicles|rhs_2s3tank_at_base|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                    "body": "obsTurret",
                    "gun": "obsGun",
            ...
            "weapons": ["rhs_weap_2a33_at","rhs_weap_fcs"],
            "magazines": ["rhs_mag_HE_2a33_32","rhs_mag_br540_10","rhs_mag_bp540_4","rhs_laserfcsmag","rhs_laserfcsmag"],
