rhs_tortila_grey = {
    ...
    "dlc": "RHS_AFRF",
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|backpacks|rhs_tortila_grey_ca.paa",
    "scope": 2,
    "displayname": "SPOSN Tortila Backpack (Grey)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|tortilla_grey_co.paa"],
    "mapsize": 0.55,
