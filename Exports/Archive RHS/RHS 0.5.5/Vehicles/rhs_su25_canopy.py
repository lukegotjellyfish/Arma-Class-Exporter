rhs_su25_canopy = {
    ...
    # Class: CfgVehicles|rhs_t50_canopy|Eventhandlers [Indent level: 1],
    "eventhandlers": {
        "handledamage": "deleteVehicle (_this select 0)"
    },
    # Class: CfgVehicles|rhs_t50_canopy|MFD [Indent level: 1],
    "mfd": {
    },
    # Class: CfgVehicles|rhs_t50_canopy|RenderTargets [Indent level: 1],
    "rendertargets": {
    },
    # Class: CfgVehicles|rhs_t50_canopy|UserActions [Indent level: 1],
    "useractions": {
    },
    "driveoncomponent": [],
    "slx_xeh_disabled": 1,
