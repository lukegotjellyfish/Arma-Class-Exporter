rhsgref_cdf_b_2s1_at = {
    ...
    # Class: CfgVehicles|rhsgref_cdf_b_2s1_at|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_cdf_b_2s1_at|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhsgref_cdf_b_2s1_at|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhsgref_cdf_b_2s1_at|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                ...
                # Class: CfgVehicles|rhsgref_cdf_b_2s1_at|Turrets|MainTurret|Turrets|LoaderOptics [Indent level: 4],
                "loaderoptics": {
