rhs_uniform_afghanka_ttsko = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_ttsko_ca.paa",
    "displayname": "M88 (TTsKO)",
    # Class: CfgWeapons|rhs_uniform_afghanka_ttsko|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_ttsko_base",
        "uniformmodel": "-",
