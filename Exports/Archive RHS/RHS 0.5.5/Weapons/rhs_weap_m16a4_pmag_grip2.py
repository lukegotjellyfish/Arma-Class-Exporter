rhs_weap_m16a4_pmag_grip2 = {
    ...
    # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip2|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip2|WeaponSlotsInfo|GripodSlot [Indent level: 2]
        "gripodslot": {
    ...
    # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    "hiddenselections": ["camo1","camo2","camo3","camo4","camo7"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons|m16|data|m16a4_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|magazine_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|m4acc_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|kacrailcover_co.paa","|rhsusf|addons|rhsusf_weapons|acc|grips|grippod|data|acc_co.paa"],
