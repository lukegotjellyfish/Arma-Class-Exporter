rhs_weap_izh18 = {
    ...
    # Class: CfgWeapons|rhs_weap_Izh18|Single [Indent level: 1],
    "single": {
    ...
    # Class: CfgWeapons|rhs_weap_Izh18|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_Izh18|WeaponSlotsInfo|CowsSlot [Indent level: 2]
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
