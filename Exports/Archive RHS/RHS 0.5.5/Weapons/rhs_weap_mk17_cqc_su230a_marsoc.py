rhs_weap_mk17_cqc_su230a_marsoc = {
    # Class: CfgWeapons|rhs_weap_mk17_CQC_SU230A_marsoc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk17_CQC_SU230A_marsoc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_su230a_c"
        },
        # Class: CfgWeapons|rhs_weap_mk17_CQC_SU230A_marsoc|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15side"
        },
        # Class: CfgWeapons|rhs_weap_mk17_CQC_SU230A_marsoc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
            "slot": "GripodSlot",
