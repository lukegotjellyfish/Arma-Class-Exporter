rhs_weap_mk18_grip = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_mk18_grip_ca.paa",
    "displayname": "Mk 18 Mod 1 (AFG)",
    # Class: CfgWeapons|rhs_weap_mk18_grip|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 59.9,
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
