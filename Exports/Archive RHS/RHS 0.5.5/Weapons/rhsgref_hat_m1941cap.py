rhsgref_hat_m1941cap = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_hat_m1941cap_ca.paa",
    "displayname": "M1941 Wool Cap",
    "scope": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|m1941cap",
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|m1941cap_co.paa"],
    # Class: CfgWeapons|rhsgref_hat_m1941cap|ItemInfo [Indent level: 1],
    "iteminfo": {
