rhs_acc_dtkakm = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_dtkakm_ca.paa",
    "author": "Red Hammer Studios",
    "model": "rhsafrf|addons|rhs_weapons|acc|muzzle|dtk|dtk.p3d",
    "displayname": "DTK",
    # Class: CfgWeapons|rhs_acc_dtkakm|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_dtkakm|ItemInfo|AmmoCoef [Indent level: 2]
        "ammocoef": {
            "visiblefire": 0.95,
        ...
        # Class: CfgWeapons|rhs_acc_dtkakm|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
        ...
        "alternativefire": "rhs_muzzleflash_dtkakm",
        "mass": 5,
        "soundtypeindex": 0,
