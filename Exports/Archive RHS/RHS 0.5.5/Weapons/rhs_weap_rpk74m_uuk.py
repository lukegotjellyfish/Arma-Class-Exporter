rhs_weap_rpk74m_uuk = {
    # Class: CfgWeapons|rhs_weap_rpk74m_uuk|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_rpk74m_uuk|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_1p87"
        },
        # Class: CfgWeapons|rhs_weap_rpk74m_uuk|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_uuk"
        }
