rhs_m4a1_grip_eotech = {
    # Class: CfgWeapons|rhs_m4a1_grip_eotech|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4a1_grip_eotech|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_eotech_552"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_eotech|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq16a_top"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_eotech|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
