rhsusf_acc_mrds_fwd_c = {
    ...
    "weaponinfotype": "RHS_mrds_c_fwd",
    "displayname": "MRDS Coyote (Forward)",
    "model": "rhsusf|addons|rhsusf_scopes|specter|rhs_mrds_front_c",
    "rhs_t1_base": "rhsusf_acc_mrds_fwd_c",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_mrds_c_ca.paa",
    "descriptionshort": "Collimator Sight<br />Magnification: 1x",
    "inertia": 0,
    # Class: CfgWeapons|rhsusf_acc_mrds|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_mrds|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_mrds|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "distancezoommin": 200,
                "distancezoommax": 200,
                "opticsid": 1,
