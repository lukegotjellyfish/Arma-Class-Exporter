rhs_weap_fab100_mbd3_u6 = {
    "magazines": ["rhs_mag_fab100_mbd3_u6"],
    # Class: CfgWeapons|rhs_weap_fab100_mbd3_u6|Burst [Indent level: 1],
    "burst": {
        "burst": 6,
        "minrange": 200,
        "salvo": 2,
    ...
    "modes": ["Single","Burst"],
    # Class: CfgWeapons|rhs_weap_fab100_mbd3_u4t|Single [Indent level: 1],
    "single": {
        "texturetype": "semi",
        "cursor": "bomb",
        "cursoraim": "EmptyCursor",
