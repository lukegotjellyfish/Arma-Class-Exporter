rhs_m4a1_grip_acog2 = {
    # Class: CfgWeapons|rhs_m4a1_grip_acog2|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4a1_grip_acog2|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG2"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_acog2|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_acog2|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
