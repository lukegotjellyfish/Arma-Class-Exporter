rhs_uniform_afghanka_boots_klmk = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_boots_klmk_ca.paa",
    "displayname": "M88 Sapogi (KLMK)",
    # Class: CfgWeapons|rhs_uniform_afghanka_boots_klmk|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_boots_klmk_base",
        "uniformmodel": "-",
