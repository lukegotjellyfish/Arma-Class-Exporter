rhs_fieldcap_m88_woodland = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_woodland_ca.paa",
    "displayname": "Field Cap M88 (Woodland)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_woodland_co.paa"],
    "scope": 2,
