rhs_weap_optic_smaw_5 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_5|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_5|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_5|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 250,
                "distancezoommax": 250,
                "discreteinitindex": 4,
