rhsgref_bcap_specter = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_bcap_specter_ca.paa",
    "dlc": "RHS_GREF",
    "scope": 2,
    "displayname": "Baseball Cap (Spectre-SKWO)",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_cdf|capb_specters_co.paa"],
    ...
    # Class: CfgWeapons|H_Cap_red|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 4,
