rhsusf_acc_leupoldmk4_2_d = {
    ...
    # Class: CfgWeapons|rhsusf_acc_LEUPOLDMK4_2|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 2,
        "mass": 8,
        ...
        # Class: CfgWeapons|rhsusf_acc_LEUPOLDMK4_2|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_LEUPOLDMK4_2|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
