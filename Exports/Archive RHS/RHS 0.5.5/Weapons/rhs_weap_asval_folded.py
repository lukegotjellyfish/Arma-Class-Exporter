rhs_weap_asval_folded = {
    ...
    # Class: CfgWeapons|rhs_weap_asval_folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 41.25,
        # Class: CfgWeapons|rhs_weap_asval_folded|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_asval_folded|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
