rhsusf_acc_saw_bipod = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_saw_bipod_ca.paa",
    "dlc": "RHS_USAF",
    "author": "Red Hammer Studios",
    "displayname": "SAW Bipod",
    "descriptionshort": "M249 SAW Bipod.",
    "model": "rhsusf|addons|rhsusf_weapons2|acc|grips|sawgrip|saw_bipod",
    # Class: CfgWeapons|rhsusf_acc_saw_bipod|ItemInfo [Indent level: 1],
    "iteminfo": {
        "scope": 0,
        "mass": 20,
        "deployedpivot": "bipod",
