rhs_weap_optic_smaw_2 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_2|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_2|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_2|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 100,
                "distancezoommax": 100,
                "discreteinitindex": 1,
