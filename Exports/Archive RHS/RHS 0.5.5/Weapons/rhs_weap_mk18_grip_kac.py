rhs_weap_mk18_grip_kac = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_mk18_grip_KAC_ca.paa",
    "displayname": "Mk 18 Mod 1 (AFG/SOPMOD Stock)",
    # Class: CfgWeapons|rhs_weap_mk18_grip_KAC|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 54.56,
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip_KAC|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_grip_KAC|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
