rhs_uniform_vkpo = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_vkpo_ca.paa",
    "displayname": "VKPO",
    # Class: CfgWeapons|rhs_uniform_vkpo|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_vkpo_base",
        "uniformmodel": "-",
