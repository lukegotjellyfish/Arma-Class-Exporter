rhs_6b45_rifleman_2 = {
    ...
    # Class: CfgWeapons|rhs_6b45_rifleman_2|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo","Camo1","Camo2"],
        "uniformmodel": "rhsafrf|addons|rhs_infantry3|ratnik|rhs_emr_6b45_new_shovel",
        "containerclass": "Supply120",
        "mass": 90,
        # Class: CfgWeapons|rhs_6b45|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_6b45|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
            ...
            # Class: CfgWeapons|rhs_6b45|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
            ...
            # Class: CfgWeapons|rhs_6b45|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
            ...
            # Class: CfgWeapons|rhs_6b45|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
            ...
            # Class: CfgWeapons|rhs_6b45|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
