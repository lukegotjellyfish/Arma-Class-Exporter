rhs_fieldcap_m88_ttsko_vdv_back = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_ttsko_vdv_back_ca.paa",
    "displayname": "Field Cap M88 (TTsKO VDV/Back)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_butan1_VDV_co.paa"],
