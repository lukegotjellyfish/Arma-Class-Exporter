rhsgref_6b23_khaki_officer = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_khaki_officer_ca.paa",
    "scope": 2,
    "displayname": "6B23 Khaki (Officer)",
    "model": "rhsafrf|addons|rhs_infantry|gear|vests|rhs_6b23_crewofficer",
    # Class: CfgWeapons|rhsgref_6b23_khaki_officer|ItemInfo [Indent level: 1],
    "iteminfo": {
