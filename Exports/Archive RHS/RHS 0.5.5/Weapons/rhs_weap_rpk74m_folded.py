rhs_weap_rpk74m_folded = {
    ...
    # Class: CfgWeapons|rhs_weap_rpk74m_folded|DUMMY [Indent level: 1],
    "dummy": {
        "discretedistance": [0,1],
    ...
    "muzzles": ["this","SAFE","DUMMY","FOLD"],
    # Class: CfgWeapons|rhs_weap_rpk74m_folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 78.3,
        # Class: CfgWeapons|rhs_weap_rpk74m_folded|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
        # Class: CfgWeapons|rhs_weap_rpk74m_folded|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
    ...
    "inertia": 0.7,
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_rpk74_folded [Indent level: 0],
    "recoil": {
