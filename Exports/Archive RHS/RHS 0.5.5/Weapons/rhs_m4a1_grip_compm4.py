rhs_m4a1_grip_compm4 = {
    # Class: CfgWeapons|rhs_m4a1_grip_compm4|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4a1_grip_compm4|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_compm4"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_compm4|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15_top"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_compm4|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
