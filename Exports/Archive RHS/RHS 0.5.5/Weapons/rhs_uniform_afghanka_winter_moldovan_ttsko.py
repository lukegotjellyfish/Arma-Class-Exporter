rhs_uniform_afghanka_winter_moldovan_ttsko = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_moldovan_ttsko_ca.paa",
    "displayname": "M88 Winter (Moldovan TTsKO)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_moldovan_ttsko|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_moldovan_ttsko_base",
        "uniformmodel": "-",
