rhs_acc_pso1m2_ak = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_acc_pso1m2_ak|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_pso1m2_ak|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pso1m2_ak|ItemInfo|OpticsModes|pso1_scope [Indent level: 3]
            "pso1_scope": {
            ...
            # Class: CfgWeapons|rhs_acc_pso1m2_ak|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
