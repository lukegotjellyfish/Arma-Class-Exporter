rhsusf_hgu56p_visor_mask_black = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_hgu56p_visor_mask_black_ca.paa",
    "displayname": "HGU-56/P (Black/Visor/Mask)",
    "hiddenselections": ["camo","patches"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_blk_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_patches_usPirate_co.paa"],
    ...
    # Class: CfgWeapons|rhsusf_hgu56p_visor_mask_black|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["camo","patches"],
