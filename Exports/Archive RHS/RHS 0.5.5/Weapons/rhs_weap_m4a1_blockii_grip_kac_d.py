rhs_weap_m4a1_blockii_grip_kac_d = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_m4a1_blockII_grip_KAC_d_ca.paa",
    "handanim": ["OFP2_ManSkeleton","|rhsusf|addons|rhsusf_c_weapons|anims|rhs_hand_m16a4.rtm"],
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_KAC_d|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_KAC_d|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip1",
            "slot": "UnderBarrelSlot"
        }
    },
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_KAC_d|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 67.78,
    ...
    "displayname": "M4A1 Block II (Desert/SOPMOD Stock)",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons|m4|data|m4a1_actual_d_co.paa","|rhsusf|addons|rhsusf_weapons3|M4BII|Data|rhs_block2rail_d_co.paa","|rhsusf|addons|rhsusf_weapons|acc|grips|grippod|data|acc_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|m4acc_d_co.paa","|rhsusf|addons|rhsusf_weapons2|sr25|data|buttstock2_d_co.paa"],
