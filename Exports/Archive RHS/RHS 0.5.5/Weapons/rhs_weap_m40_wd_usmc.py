rhs_weap_m40_wd_usmc = {
    # Class: CfgWeapons|rhs_weap_m40_wd_usmc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m40_wd_usmc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_M8541_low_wd"
        },
        # Class: CfgWeapons|rhs_weap_m40_wd_usmc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
