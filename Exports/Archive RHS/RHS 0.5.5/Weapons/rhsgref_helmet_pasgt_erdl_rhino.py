rhsgref_helmet_pasgt_erdl_rhino = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_pasgt_erdl_rhino_ca.paa",
    "scope": 2,
    "displayname": "PASGT (ERDL, Rhino)",
    "model": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|pasgt_helmet_rhino",
    "hiddenselections": ["Camo"],
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|pasgt_helmet_erdl_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_pasgt_erdl_rhino|ItemInfo [Indent level: 1],
    "iteminfo": {
