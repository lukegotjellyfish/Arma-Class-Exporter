rhs_weap_mk18_grip2_bk = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_mk18_grip2_bk_ca.paa",
    "displayname": "Mk 18 Mod 1 (AFG)",
    # Class: CfgWeapons|rhs_weap_mk18_grip2_bk|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_mk18_grip2_bk|WeaponSlotsInfo|GripodSlot [Indent level: 2]
        "gripodslot": {
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip2_bk|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_grip2_bk|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
