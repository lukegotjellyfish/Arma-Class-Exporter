rhs_m4_grip_acog_usmc = {
    # Class: CfgWeapons|rhs_m4_grip_acog_usmc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4_grip_acog_usmc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG_USMC"
        },
        # Class: CfgWeapons|rhs_m4_grip_acog_usmc|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq16a"
        },
        # Class: CfgWeapons|rhs_m4_grip_acog_usmc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
