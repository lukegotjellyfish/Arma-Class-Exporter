rhsusf_plateframe_machinegunner = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|vests|rhsusf_plateframe_machinegunner_ca.paa",
    "displayname": "Plateframe (Machinegunner)",
    "author": "Red Hammer Studios",
    "model": "rhsusf|addons|rhsusf_infantry2|gear|vests|plateframe|rhs_plateframe_sapi_machinegunner",
    # Class: CfgWeapons|rhsusf_plateframe_machinegunner|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry2|gear|vests|plateframe|rhs_plateframe_sapi_machinegunner",
        "containerclass": "Supply160",
        "mass": 100,
        # Class: CfgWeapons|rhsusf_plateframe_rifleman|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_plateframe_rifleman|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
                "hitpointname": "HitChest",
                "armor": 22,
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhsusf_plateframe_rifleman|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": "22 + 		3",
                "passthrough": 0.2
            },
            # Class: CfgWeapons|rhsusf_plateframe_rifleman|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhsusf_plateframe_rifleman|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
