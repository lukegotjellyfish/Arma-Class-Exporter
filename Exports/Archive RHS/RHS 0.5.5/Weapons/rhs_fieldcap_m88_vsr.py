rhs_fieldcap_m88_vsr = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_vsr_ca.paa",
    "displayname": "Field Cap M88 (VSR)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_VSR01_co.paa"],
    "scope": 2,
