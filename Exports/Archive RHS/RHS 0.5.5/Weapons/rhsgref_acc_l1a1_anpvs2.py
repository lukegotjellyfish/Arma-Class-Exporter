rhsgref_acc_l1a1_anpvs2 = {
    ...
    # Class: CfgWeapons|rhsgref_acc_anpvs2_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 2,
        "mass": 14,
        ...
        # Class: CfgWeapons|rhsgref_acc_anpvs2_base|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsgref_acc_anpvs2_base|ItemInfo|OpticsModes|1pn93_scope [Indent level: 3]
            "1pn93_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
                "opticsppeffects": ["rhs_ANPVS2_Abera","rhs_ANPVS2_Blur","rhs_ANPVS2_FilmGrain"],
            ...
            # Class: CfgWeapons|rhsgref_acc_anpvs2_base|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
