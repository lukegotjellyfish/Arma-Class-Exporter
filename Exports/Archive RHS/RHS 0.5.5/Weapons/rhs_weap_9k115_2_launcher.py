rhs_weap_9k115_2_launcher = {
    ...
    "magazines": ["rhs_mag_9M131M","rhs_mag_9M131F"],
    "maxrange": 2000,
    "midrange": 500,
    "minrange": 80,
    ...
    "autoreload": 0,
    "texturetype": "semi",
    # Class: CfgWeapons|rhs_weap_9K115_launcher|gunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_9K115_launcher|gunParticles|effect1 [Indent level: 2]
        "effect1": {
            "effectname": "RHS_ATGM_Cap_x2",
            "positionname": "spice rakety",
            "directionname": "cap_ejection_dir1"
        },
        # Class: CfgWeapons|rhs_weap_9K115_launcher|gunParticles|effect2 [Indent level: 2],
        "effect2": {
            "effectname": "RHS_ATGM_Cap_x2",
