rhs_weap_mk17_lb_dmr_marsoc = {
    # Class: CfgWeapons|rhs_weap_mk17_LB_DMR_marsoc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk17_LB_DMR_marsoc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_M8541_mrds"
        },
        # Class: CfgWeapons|rhs_weap_mk17_LB_DMR_marsoc|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15side"
        },
        # Class: CfgWeapons|rhs_weap_mk17_LB_DMR_marsoc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
