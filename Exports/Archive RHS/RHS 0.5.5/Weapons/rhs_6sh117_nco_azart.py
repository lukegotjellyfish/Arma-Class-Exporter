rhs_6sh117_nco_azart = {
    ...
    "dlc": "RHS_AFRF",
    "displayname": "6Sh117 (Squad Leader/Azart)",
    "model": "rhsafrf|addons|rhs_infantry3|ratnik|rhs_emr_6sh117_NCO_azart",
    "hiddenselections": ["Camo","Camo1","Camo2","Camo3"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|ratnik|data|6sh117_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|pouchs_117_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|pouchs_118_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|azart_co.paa"],
    # Class: CfgWeapons|rhs_6sh117_nco_azart|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo","Camo1","Camo2","Camo3"],
        "uniformmodel": "rhsafrf|addons|rhs_infantry3|ratnik|rhs_emr_6sh117_NCO_azart",
        "containerclass": "Supply140",
        "mass": 20,
        # Class: CfgWeapons|rhs_6sh117_rifleman|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_6sh117_rifleman|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3]
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhs_6sh117_rifleman|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|vests|rhs_6sh117_rifleman_ca.paa",
    "scope": 2,
