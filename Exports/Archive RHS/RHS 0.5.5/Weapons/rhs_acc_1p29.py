rhs_acc_1p29 = {
    ...
    # Class: CfgWeapons|rhs_acc_1p29|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 17.6,
        ...
        # Class: CfgWeapons|rhs_acc_1p29|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_1p29|ItemInfo|OpticsModes|rhs_1p29_scope [Indent level: 3]
            "rhs_1p29_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_1p29|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
