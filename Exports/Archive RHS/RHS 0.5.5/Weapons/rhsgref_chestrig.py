rhsgref_chestrig = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_chestrig_ca.paa",
    "scope": 2,
    "dlc": "RHS_GREF",
    ...
    "model": "a3|Characters_F|Common|equip_chestrig_light",
    "descriptionshort": "No Armor",
    # Class: CfgWeapons|rhsgref_chestrig|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "a3|Characters_F|Common|equip_chestrig_light",
        "hiddenselections": ["Camo1","Camo2"],
        "containerclass": "Supply100",
        "mass": 15,
        # Class: CfgWeapons|rhsgref_chestrig|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_chestrig|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3]
            "body": {
