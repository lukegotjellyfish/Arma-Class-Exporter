rhs_acc_okp7_picatinny = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_okp7_picatinny_ca.paa",
    "scope": 2,
    "author": "Red Hammer Studios",
    "displayname": "OKP7 (Picatinny)",
    "model": "rhsafrf|addons|rhs_weapons2|acc|scopes|okp7|rhs_okp7_picatinny",
    "descriptionshort": "Collimator Sight<br />Magnification: 1x",
    "weaponinfotype": "RscWeaponZeroing",
    # Class: CfgWeapons|rhs_acc_okp7_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_okp7_base|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_okp7_base|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
