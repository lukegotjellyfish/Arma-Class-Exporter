rhs_weap_ak105_zenitco01 = {
    ...
    "displayname": "AK-105 (Zenitco)",
    "model": "rhsafrf|addons|rhs_weapons3|zenitco|rhs_ak105_zenit",
    "handanim": ["OFP2_ManSkeleton","|rhsafrf|addons|rhs_c_weapons|anims|rhs_hand_ak.rtm"],
    "weaponinfotype": "rhs_rscOptics_ak105_zenitco01",
    # Class: CfgWeapons|rhs_weap_ak105_zenitco01|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 57.2,
        # Class: CfgWeapons|rhs_weap_ak105_zenitco01|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_ak105_zenitco01|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        ...
        # Class: CfgWeapons|rhs_weap_ak105_zenitco01|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
    ...
    "rhs_fold": "",
    "rhs_npz": "rhs_weap_ak105_zenitco01_npz",
    "rhs_grip1_change": "rhs_weap_ak105_zenitco01_grip1",
    "rhs_grip2_change": "rhs_weap_ak105_zenitco01_afg",
    "rhs_grip3_change": "rhs_weap_ak105_zenitco01_grip1",
    "rhsusf_acc_anpeq15": 1,
    "rhsusf_acc_t1": 1,
    "baseweapon": "rhs_weap_ak105_zenitco01",
    "scopearsenal": 2,
    "scope": 2,
