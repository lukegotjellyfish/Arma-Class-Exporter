rhs_weap_m4a1_blockii_grip = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_m4a1_blockII_grip_ca.paa",
    "inertia": 0.4,
    "dexterity": 1.6,
    "handanim": ["OFP2_ManSkeleton","|rhsusf|addons|rhsusf_c_weapons|anims|rhs_hand_m16a4.rtm"],
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
