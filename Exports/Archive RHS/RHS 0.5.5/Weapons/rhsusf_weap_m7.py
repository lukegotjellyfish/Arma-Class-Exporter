rhsusf_weap_m7 = {
    # Class: CfgWeapons|rhsusf_weap_M7|Double [Indent level: 1]
    "double": {
        "displayname": "M7 (8)",
        "reloadtime": 0.099,
        "burst": 8,
    ...
    # Class: CfgWeapons|rhsusf_weap_M7|Volley [Indent level: 1],
    "volley": {
        "displayname": "M7 (16)",
        "burst": 16,
        "reloadtime": 0.099,
    ...
    # Class: CfgWeapons|rhsusf_weap_M7|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M7|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "(_this + [['smoke_','_pos','_dir']]) call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
    "magazines": ["rhsusf_mag_L8A3_16"],
    "modes": ["Double","Volley"],
    "scope": 2,
