rhs_weap_mk18_grip_wd = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_mk18_grip_wd_ca.paa",
    "displayname": "Mk 18 Mod 1 (AFG)",
    # Class: CfgWeapons|rhs_weap_mk18_grip_wd|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 54.56,
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip_wd|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_grip_wd|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
