rhs_weap_scarh_usa_std_grip3 = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_USA_STD_grip3|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_USA_STD_grip3|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip2",
            "slot": "UnderBarrelSlot"
        }
    },
    "rhs_fold": "rhs_weap_SCARH_USA_STD_Folded_grip3",
