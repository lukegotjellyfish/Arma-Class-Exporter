rhs_weap_2k4 = {
    ...
    "displayname": "2K4",
    "reloadsound": ["|rhsafrf|addons|rhs_c_heavyweapons|sounds|rhs_s_2a37_reload.ogg",1,1],
    "magazines": ["rhs_mag_3m7_12"],
    # Class: CfgWeapons|rhs_weap_2k4|gunParticles [Indent level: 1],
    "gunparticles": {
    },
    "sounds": ["StandardSound"],
    # Class: CfgWeapons|rhs_weap_2k4|StandardSound [Indent level: 1],
    "standardsound": {
