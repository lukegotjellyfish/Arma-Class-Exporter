rhs_weap_svd_pso1 = {
    "scope": 1,
    # Class: CfgWeapons|rhs_weap_svd_pso1|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_svd_pso1|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_pso1m2"
        }
    ...
    # Class: CfgWeapons|rhs_weap_svd|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 77,
        # Class: CfgWeapons|rhs_weap_svd|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_svd|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_svd|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
    ...
    # Class: CfgWeapons|rhs_weap_svd|Single [Indent level: 1],
    "single": {
        "reloadtime": 0.085,
        "dispersion": 0.0007,
        "minrange": 2,
        ...
        "maxrange": 500,
        "maxrangeprobab": 0.05,
        # Class: CfgWeapons|rhs_weap_svd|Single|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHS_dragunov_Shot_SoundSet","RHS_rifle2_Tail_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_svd|Single|SilencedSound [Indent level: 2],
        "silencedsound": {
    ...
    # Class: CfgWeapons|rhs_weap_svd|single_close_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_svd|single_medium_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_svd|single_far_optics1 [Indent level: 1],
    "single_far_optics1": {
        "requiredoptictype": 2,
        "minrange": 300,
        "minrangeprobab": 0.05,
