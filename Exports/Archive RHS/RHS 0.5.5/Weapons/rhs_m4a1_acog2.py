rhs_m4a1_acog2 = {
    # Class: CfgWeapons|rhs_m4a1_acog2|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4a1_acog2|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG2"
        },
        # Class: CfgWeapons|rhs_m4a1_acog2|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
