rhs_uniform_afghanka_winter_spetsodezhda = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_spetsodezhda_ca.paa",
    "displayname": "M88 Winter (Spetsodezhda)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_spetsodezhda|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_spetsodezhda_base",
        "uniformmodel": "-",
