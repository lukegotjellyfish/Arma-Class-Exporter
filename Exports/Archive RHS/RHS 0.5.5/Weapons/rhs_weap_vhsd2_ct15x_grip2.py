rhs_weap_vhsd2_ct15x_grip2 = {
    "scope": 1,
    "handanim": ["OFP2_ManSkeleton","|rhsgref|addons|rhsgref_c_weapons|anims|rhs_hand_vhs_afg.rtm"],
    # Class: CfgWeapons|rhs_weap_vhsd2_ct15x_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_vhsd2_ct15x_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
