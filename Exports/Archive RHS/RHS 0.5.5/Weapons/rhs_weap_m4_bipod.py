rhs_weap_m4_bipod = {
    ...
    # Class: CfgWeapons|rhs_weap_m4_bipod|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4_bipod|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    # Class: CfgWeapons|rhs_weap_m4|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 73.04,
        "allowedslots": [901],
