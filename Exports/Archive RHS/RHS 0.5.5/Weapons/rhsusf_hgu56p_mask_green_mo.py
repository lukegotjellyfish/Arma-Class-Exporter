rhsusf_hgu56p_mask_green_mo = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_hgu56p_mask_green_mo_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_hgu56p_mask_green|ItemInfo [Indent level: 1],
    "iteminfo": {
