rhs_weap_m24sws_leu = {
    # Class: CfgWeapons|rhs_weap_m24sws_leu|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m24sws_leu|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_LEUPOLDMK4"
        },
        # Class: CfgWeapons|rhs_weap_m24sws_leu|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
