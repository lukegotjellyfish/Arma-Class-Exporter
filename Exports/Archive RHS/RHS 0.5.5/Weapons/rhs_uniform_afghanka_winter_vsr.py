rhs_uniform_afghanka_winter_vsr = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_vsr_ca.paa",
    "displayname": "M88 Winter (VSR 1)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_vsr|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_vsr_base",
        "uniformmodel": "-",
