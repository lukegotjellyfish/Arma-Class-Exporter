rhsusf_acc_su230a_mrds = {
    ...
    # Class: CfgWeapons|rhsusf_acc_su230a_mrds|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsusf|addons|rhsusf_scopes|optics|elcan|rhsusf_optic_SU230A",
        # Class: CfgWeapons|rhsusf_acc_su230_mrds_base|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_su230_mrds_base|ItemInfo|OpticsModes|Elcan_x1 [Indent level: 3]
            "elcan_x1": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
            ...
            # Class: CfgWeapons|rhsusf_acc_su230_mrds_base|ItemInfo|OpticsModes|Elcan_x4 [Indent level: 3],
            "elcan_x4": {
                "opticsid": 2,
                "usemodeloptics": 1,
                "opticsppeffects": ["OpticsCHAbera1","OpticsBlur1","rhs_su230_Blur"],
            ...
            # Class: CfgWeapons|rhsusf_acc_su230_mrds_base|ItemInfo|OpticsModes|Elcan_mrds [Indent level: 3],
            "elcan_mrds": {
            ...
            # Class: CfgWeapons|rhsusf_acc_su230_mrds_base|ItemInfo|OpticsModes|Elcan_iron_aux [Indent level: 3],
            "elcan_iron_aux": {
                "opticsid": 3,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
            ...
            # Class: CfgWeapons|rhsusf_acc_su230_base|ItemInfo|OpticsModes|Elcan_iron [Indent level: 3],
            "elcan_iron": {
                "opticsid": 3,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
    ...
    "weaponinfotype": "rhsusf_acc_su230a_mrds_handler",
    "dlc": "RHS_USAF",
    "opticsdisableperipherialvision": 0,
    "inertia": 0.2,
    "muzzles": [],
