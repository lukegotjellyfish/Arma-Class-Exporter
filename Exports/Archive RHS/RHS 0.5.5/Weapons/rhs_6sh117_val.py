rhs_6sh117_val = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|vests|rhs_6sh117_svd_ca.paa",
    "dlc": "RHS_AFRF",
    "displayname": "6Sh117 (Val/VSS)",
    "model": "rhsafrf|addons|rhs_infantry3|ratnik|rhs_emr_6sh117_VAL",
    "hiddenselections": ["Camo","Camo1","Camo2","Camo3"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|ratnik|data|6sh117_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|pouchs_117_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|pouchs_118_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|radio_co.paa"],
    # Class: CfgWeapons|rhs_6sh117_val|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo","Camo1","Camo2","Camo3"],
