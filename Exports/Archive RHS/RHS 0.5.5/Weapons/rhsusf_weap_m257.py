rhsusf_weap_m257 = {
    ...
    "modes": ["Double","Volley"],
    # Class: CfgWeapons|rhsusf_weap_M257|Double [Indent level: 1],
    "double": {
        "reloadtime": 0.099,
        "burst": 8,
        "showtoplayer": 1,
    ...
    # Class: CfgWeapons|rhsusf_weap_M257|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M257|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "_this call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
