rhs_uh60m = {
    ...
    # Class: CfgVehicles|RHS_UH60M|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_UH60M|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
            "caneject": 0,
    ...
    # Class: CfgVehicles|RHS_UH60M|AnimationSources [Indent level: 1],
    "animationsources": {
