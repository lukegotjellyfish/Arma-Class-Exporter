rhsusf_ch53e_usmc_d = {
    ...
    # Class: CfgVehicles|rhsusf_CH53E_USMC|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|rhsusf_CH53E_USMC|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsusf_CH53E_USMC|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
