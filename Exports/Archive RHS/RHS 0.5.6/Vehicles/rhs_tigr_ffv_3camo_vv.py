rhs_tigr_ffv_3camo_vv = {
    ...
    "rhs_decalparameters": ["['Number', cDecalsTigr4NumberPlaces, 'LicensePlate']","['Label', cDecalsTigrRightArmyPlaces, 'Army', [6,1]]"],
    "author": "Red Hammer Studios",
    "displayname": "GAZ-233011 (Camo/Hatch)",
    ...
    "scope": 1,
    "scopecurator": 0,
    # Class: CfgVehicles|rhs_tigr_ffv_vdv|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_tigr_ffv_vdv|Turrets|CargoTurret_01 [Indent level: 2]
        "cargoturret_01": {
            "ispersonturret": 1,
        ...
        # Class: CfgVehicles|rhs_tigr_ffv_vdv|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
            "ispersonturret": 1,
            "proxyindex": 7,
    ...
    "picture": "rhsafrf|addons|rhs_tigr|data|ico|RHS_Tigr_ca.paa",
    ...
    # Class: CfgVehicles|rhs_tigr_base|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|rhs_tigr_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_tigr_base|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
        ...
        # Class: CfgVehicles|rhs_tigr_base|EventHandlers|RHS_TigrHandler [Indent level: 2],
        "rhs_tigrhandler": {
