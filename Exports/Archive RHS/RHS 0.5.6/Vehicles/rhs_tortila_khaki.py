rhs_tortila_khaki = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|backpacks|rhs_tortila_khaki_ca.paa",
    "scope": 2,
    "displayname": "SPOSN Tortila Backpack (Khaki)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|tortilla_khaki_co.paa"],
    "dlc": "RHS_AFRF",
    "mapsize": 0.55,
