rhsgref_nat_ural_work = {
    ...
    # Class: CfgVehicles|rhsgref_nat_ural_work|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_nat_ural_work|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
