rhs_m119_d = {
    ...
    "typicalcargo": ["rhsusf_army_ocp_rifleman"],
    "dlc": "RHS_USAF",
    "accuracy": 0.12,
    "cost": 10000,
    ...
    "mapsize": 4.5,
    "cargoaction": ["rhs_M119_Cargo","rhs_M119_Commander"],
    "transportsoldier": 2,
    "memorypointsgetincargo": "pos_cargo_dir",
    "memorypointsgetincargodir": "pos_cargo",
    # Class: CfgVehicles|RHS_M119_base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|RHS_M119_base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|RHS_M119_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|RHS_M119_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_M119_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "gunbeg": "Usti hlavne",
            "gunend": "Konec hlavne",
            ...
            # Class: CfgVehicles|RHS_M119_base|Turrets|MainTurret|ViewOptics [Indent level: 3],
            "viewoptics": {
                "initfov": 0.155,
                "minfov": 0.155,
                "maxfov": 0.155,
    ...
    # Class: CfgVehicles|RHS_M119_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_M119_base|AnimationSources|fold_arty [Indent level: 2]
        "fold_arty": {
            "source": "door",
            "animperiod": 1.8
        },
        # Class: CfgVehicles|RHS_M119_base|AnimationSources|fold_arty_gun [Indent level: 2],
        "fold_arty_gun": {
            "source": "user",
            "animperiod": 1.8
        },
        # Class: CfgVehicles|RHS_M119_base|AnimationSources|fold_arty_plate [Indent level: 2],
        "fold_arty_plate": {
            "animperiod": 0.001,
            "source": "user"
        },
        # Class: CfgVehicles|RHS_M119_base|AnimationSources|fold_arty_handler [Indent level: 2],
        "fold_arty_handler": {
            "mass": -1,
        ...
        # Class: CfgVehicles|RHS_M119_base|AnimationSources|recoil_source [Indent level: 2],
        "recoil_source": {
            "source": "reload",
            "weapon": "RHS_weap_M119"
        },
        # Class: CfgVehicles|RHS_M119_base|AnimationSources|muzzle_hide_arty [Indent level: 2],
        "muzzle_hide_arty": {
            "source": "reload",
            "weapon": "RHS_weap_M119"
        }
    },
    # Class: CfgVehicles|RHS_M119_base|Library [Indent level: 1],
    "library": {
        "libtextdesc": "The M119A2 is a lightweight air-mobile artillery piece used to provide direct and indirect fire support to infantry units. The howitzer can be quickly moved and deployed to provide maximum fire power in a short period of time."
    },
    "htmin": 1,
    "htmax": 480,
    "afmax": 0,
    ...
    "mfact": 1,
    "tbody": 450,
    # Class: CfgVehicles|RHS_M119_base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|RHS_M119_base|EventHandlers|RHSUSF_EventHandlers [Indent level: 2]
        "rhsusf_eventhandlers": {
            "fired": "_this spawn rhs_fnc_fired_m119"
        },
        "fired": "_this call (uinamespace getvariable 'BIS_fnc_effectFired');"
    },
    # Class: CfgVehicles|RHS_M119_base|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|RHS_M119_base|UserActions|Fold [Indent level: 2]
        "fold": {
            ...
            "onlyforplayer": 0,
            "priority": 10,
            "condition": "(alive this) && (this doorPhase 'fold_arty' >= 0.99)",
            "statement": "[this,0] call rhs_fnc_m119_fold;"
        },
        # Class: CfgVehicles|RHS_M119_base|UserActions|Unfold [Indent level: 2],
        "unfold": {
            "priority": 0,
            ...
            "condition": "(alive this) && ((count (crew this)) == 0) && (this  doorPhase 'fold_arty' <= 0.01)",
            "statement": "[this,1] call rhs_fnc_m119_fold;",
            "position": "zamerny",
            "radius": 4,
            "onlyforplayer": 0
        },
        # Class: CfgVehicles|RHS_M119_base|UserActions|AttachVehicle [Indent level: 2],
        "attachvehicle": {
            "position": "tow_point",
            "condition": "(alive this)&& (this  doorPhase 'fold_arty' >= 0.99)",
        ...
        # Class: CfgVehicles|RHS_M119_base|UserActions|DragVehicle [Indent level: 2],
        "dragvehicle": {
            "position": "tow_point",
            "condition": "(alive this)&& (this  doorPhase 'fold_arty' >= 0.99)",
    ...
    # Class: CfgVehicles|RHS_M119_base|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|RHS_M119_base|Attributes|ObjectTexture [Indent level: 2]
        "objecttexture": {
        ...
        # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_caseDeleteTime [Indent level: 2],
        "rhs_casedeletetime": {
        ...
        # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_1_type [Indent level: 2],
        "rhs_ammoslot_1_type": {
            ...
            "defaultvalue": 0,
            "typename": "STRING",
            # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_1_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_1_type|values|RHS_mag_m1_he_12 [Indent level: 4]
                "rhs_mag_m1_he_12": {
                    "name": "He-FRAG M1",
        ...
        # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_1 [Indent level: 2],
        "rhs_ammoslot_1": {
        ...
        # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_2_type [Indent level: 2],
        "rhs_ammoslot_2_type": {
            "displayname": "Ammo slot #2 type",
            "tooltip": "Define type of shell for #2 slot [Smoke rounds]",
            "property": "rhs_ammoslot_2_type",
            # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_2_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_2_type|values|rhs_mag_m60a2_smoke_4 [Indent level: 4]
        ...
        # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_2 [Indent level: 2],
        "rhs_ammoslot_2": {
        ...
        # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_3_type [Indent level: 2],
        "rhs_ammoslot_3_type": {
            "displayname": "Ammo slot #3 type",
            "tooltip": "Define type of shell for #3 slot [Illumination rounds]",
            "property": "rhs_ammoslot_3_type",
            # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_3_type|values [Indent level: 3],
            "values": {
                # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_3_type|values|rhs_mag_m314_ilum_4 [Indent level: 4]
                "rhs_mag_m314_ilum_4": {
        ...
        # Class: CfgVehicles|RHS_M119_base|Attributes|rhs_ammoslot_3 [Indent level: 2],
        "rhs_ammoslot_3": {
    ...
    # Class: CfgVehicles|RHS_M119_base|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|RHS_M119_base|RHS_TowingSystem|Cargo [Indent level: 2]
        "cargo": {
            "rhs_fakevehicle": "rhs_M119_towingVehicle",
            "rhs_animationsonattach": [],
