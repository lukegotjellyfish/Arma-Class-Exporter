rhs_gaz66_repair_vdv = {
    ...
    "supplyradius": 6.8,
    # Class: CfgVehicles|rhs_gaz66_repair_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhsafrf|addons|rhs_gaz66|data|rhs_gaz66_repkung.rvmat","rhsafrf|addons|rhs_gaz66|data|rhs_dam_gaz66_repkung.rvmat","rhsafrf|addons|rhs_gaz66|data|rhs_destr_gaz66_repkung.rvmat","rhsafrf|addons|rhs_gaz66|data|gaz66.rvmat","rhsafrf|addons|rhs_gaz66|data|gaz66_dam.rvmat","rhsafrf|addons|rhs_gaz66|data|gaz66_des.rvmat","rhsafrf|addons|rhs_gaz66|data|tent.rvmat","rhsafrf|addons|rhs_gaz66|data|tent.rvmat","rhsafrf|addons|rhs_gaz66|data|tent_des.rvmat","rhsafrf|addons|rhs_gaz66|data|glass.rvmat","rhsafrf|addons|rhs_gaz66|data|glass_damage.rvmat","rhsafrf|addons|rhs_gaz66|data|glass_damage.rvmat","rhsafrf|addons|rhs_gaz66|data|glass_in.rvmat","rhsafrf|addons|rhs_gaz66|data|glass_in_damage.rvmat","rhsafrf|addons|rhs_gaz66|data|glass_in_damage.rvmat","a3|data_f|default.rvmat","rhsafrf|addons|rhs_gaz66|data|default_destruct.rvmat","rhsafrf|addons|rhs_gaz66|data|default_destruct.rvmat"]
    },
    # Class: CfgVehicles|rhs_gaz66_repair_base|Turrets [Indent level: 1],
    "turrets": {
    },
    "mapsize": 5.66,
