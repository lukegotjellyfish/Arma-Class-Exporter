rhs_mi8t_vv = {
    ...
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_a2port_air|Mi17|data|camo|mi8_body_g_camo3_co.paa","|rhsafrf|addons|rhs_a2port_air|mi17|data|camo|mi8_det_g_camo_mvd_co.paa","rhsafrf|addons|rhs_a2port_air|mi17|data|mi8t|camo|mi8t_tv2_g_camo3_co.paa","rhsafrf|addons|rhs_a2port_air|mi17|data|mi8_decals_ca.paa","a3|data_f|clear_empty.paa","a3|data_f|clear_empty.paa","rhsafrf|addons|rhs_decals|data|labels|aviation|vvs_ca.paa"],
    # Class: CfgVehicles|RHS_Mi8t_vv|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Mi8t_vv|AnimationSources|hide_antenna_aft [Indent level: 2]
        "hide_antenna_aft": {
            "initphase": 0,
