rhsgref_ins_gaz66_repair = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_gaz66_repair.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsgref_ins_gaz66_repair|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_gaz66_repair|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "initphase": 1,
