rhsgref_cdf_mi24d_early = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_Mi24D.paa",
    "scope": 2,
    ...
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_a2port_air|Mi35|Data|mi35_001_co.paa","|rhsafrf|addons|rhs_a2port_air|Mi35|Data|mi35_002_co.paa","|rhsafrf|addons|rhs_a2port_air|Mi17|data|camo|mi8_det_g_camo1_co.paa"],
    # Class: CfgVehicles|rhsgref_cdf_Mi24D_early|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_cdf_Mi24D_early|TransportMagazines|_xx_rhs_30Rnd_545x39_7N6M_AK [Indent level: 2]
        "_xx_rhs_30rnd_545x39_7n6m_ak": {
            "magazine": "rhs_30Rnd_545x39_7N6M_AK",
            "count": 30
        },
        # Class: CfgVehicles|rhsgref_cdf_Mi24D_early|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_Mi24D_early|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
        "_xx_rhs_mag_nspn_red": {
            "magazine": "rhs_mag_nspn_red",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_Mi24D_early|TransportMagazines|_xx_rhs_mag_rdg2_white [Indent level: 2],
    ...
    # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                    "attachment": "rhs_mag_ub32_s5ko",
                    "turret": [],
                ...
                # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                ...
                # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
                    "attachment": "rhs_mag_ub32_s5k1",
                    "turret": [],
                ...
                # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent|pylons|pylon5 [Indent level: 4],
                "pylon5": {
                ...
                # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent|pylons|pylon6 [Indent level: 4],
                "pylon6": {
                    "attachment": "rhs_mag_9M17_Mi24_2x",
                    "turret": [0],
                    "uiposition": [0.04,0.4],
                ...
                # Class: CfgVehicles|RHS_Mi24D_Early_Base|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4],
                "cmdispenser": {
    ...
    # Class: CfgVehicles|RHS_Mi24D_Base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|RHS_Mi24D_Base|AnimationSources|exhaust_hide [Indent level: 2]
        "exhaust_hide": {
            "source": "user",
            "initphase": 1,
            "animperiod": 1e-005
    ...
    # Class: CfgVehicles|RHS_Mi24D_Base|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|RHS_Mi24D_Base|Exhausts|Exhaust01 [Indent level: 2]
        "exhaust01": {
            "direction": "exhaust1_dir",
            "position": "exhaust1",
            "effect": "ExhaustEffectHeli"
        },
        # Class: CfgVehicles|RHS_Mi24D_Base|Exhausts|Exhaust02 [Indent level: 2],
        "exhaust02": {
    ...
    "magazines": [],
    # Class: CfgVehicles|RHS_Mi24D_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_Mi24D_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "weapons": ["rhs_weap_MASTERSAFE","rhs_weap_yakB"],
            "magazines": ["rhs_mag_127x108mm_1SLT_1470"],
            "body": "mainTurret",
            "gun": "mainGun",
            "gunbeg": "muzzle_1",
            "gunend": "chamber_1",
        ...
        # Class: CfgVehicles|RHS_Mi24D_Base|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
        ...
        # Class: CfgVehicles|RHS_Mi24D_Base|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
        ...
        # Class: CfgVehicles|RHS_Mi24D_Base|Turrets|CargoTurret_03 [Indent level: 2],
        "cargoturret_03": {
        ...
        # Class: CfgVehicles|RHS_Mi24D_Base|Turrets|CargoTurret_04 [Indent level: 2],
        "cargoturret_04": {
