rhsgref_tla_offroad = {
    ...
    # Class: CfgVehicles|rhsgref_tla_offroad|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhsgref_tla_offroad|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
    ...
    "turrets": {
        ...
        "cargoturret_01": {
            ...
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_01|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
        ...
        # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_02 [Indent level: 2],
        "cargoturret_02": {
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_02|TurnIn [Indent level: 3]
            "turnin": {
            ...
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_02|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
        ...
        # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_03 [Indent level: 2],
        "cargoturret_03": {
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_03|TurnIn [Indent level: 3]
            "turnin": {
            ...
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_03|TurnOut [Indent level: 3],
            "turnout": {
            ...
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_03|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
                "cargoturret_01": [5,75],
        ...
        # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_04 [Indent level: 2],
        "cargoturret_04": {
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_04|TurnIn [Indent level: 3]
            "turnin": {
            ...
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_04|TurnOut [Indent level: 3],
            "turnout": {
            ...
            # Class: CfgVehicles|I_G_Offroad_01_F|Turrets|CargoTurret_04|dynamicViewLimits [Indent level: 3],
            "dynamicviewlimits": {
    ...
    # Class: CfgVehicles|Offroad_01_military_base_F|AnimationSources [Indent level: 1],
    "animationsources": {
        ...
        # Class: CfgVehicles|Offroad_01_base_F|AnimationSources|hidePolice [Indent level: 2],
        "hidepolice": {
        ...
        # Class: CfgVehicles|Offroad_01_base_F|AnimationSources|HideServices [Indent level: 2],
        "hideservices": {
            ...
            "lockcargo": [3,4],
            "forceanimatephase": 0,
            "forceanimate": ["HideConstruction",1,"HideBumper1",1,"HideBumper2",1,"hidePolice",1]
        },
        # Class: CfgVehicles|Offroad_01_base_F|AnimationSources|BeaconsStart [Indent level: 2],
        "beaconsstart": {
            "displayname": "Start police light bar",
            "author": "Bohemia Interactive",
            "initphase": 0
        },
        # Class: CfgVehicles|Offroad_01_base_F|AnimationSources|BeaconsServicesStart [Indent level: 2],
    ...
    # Class: CfgVehicles|Offroad_01_base_F|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|Offroad_01_base_F|UserActions|beacons_start [Indent level: 2]
        "beacons_start": {
            "useractionid": 50,
        ...
        # Class: CfgVehicles|Offroad_01_base_F|UserActions|beacons_stop [Indent level: 2],
        "beacons_stop": {
            "useractionid": 51,
        ...
        # Class: CfgVehicles|Offroad_01_base_F|UserActions|siren_Start [Indent level: 2],
        "siren_start": {
            "useractionid": 52,
        ...
        # Class: CfgVehicles|Offroad_01_base_F|UserActions|siren_stop [Indent level: 2],
        "siren_stop": {
            "useractionid": 53,
