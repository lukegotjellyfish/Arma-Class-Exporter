rhs_tigr_sts_vmf = {
    ...
    # Class: CfgVehicles|rhs_tigr_sts_vmf|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_tigr_sts_vmf|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
        ...
        # Class: CfgVehicles|rhs_tigr_sts_vmf|Turrets|AGS_Turret [Indent level: 2],
        "ags_turret": {
            "gunnertype": "rhs_vmf_flora_grenadier",
    ...
    "picture": "rhsafrf|addons|rhs_tigr|data|ico|rhs_tigr_sts_ca.paa",
    "dlc": "RHS_AFRF",
