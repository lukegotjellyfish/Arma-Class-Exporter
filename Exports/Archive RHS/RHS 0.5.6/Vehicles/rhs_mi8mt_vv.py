rhs_mi8mt_vv = {
    ...
    # Class: CfgVehicles|RHS_Mi8_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_Mi8_base|Turrets|CopilotTurret [Indent level: 2]
        "copilotturret": {
            "proxyindex": 3,
            "gunnername": "Co-pilot",
    ...
    # Class: CfgVehicles|RHS_Mi8_base|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|RHS_Mi8_base|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|RHS_Mi8_base|UserActions|ToggleLight [Indent level: 2]
        "togglelight": {
        ...
        # Class: CfgVehicles|RHS_Mi8_base|UserActions|WheelBrakes [Indent level: 2],
        "wheelbrakes": {
