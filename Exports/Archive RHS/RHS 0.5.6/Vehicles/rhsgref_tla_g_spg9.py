rhsgref_tla_g_spg9 = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_SPG9.paa",
    "dlc": "RHS_GREF",
    "displayname": "SPG-9",
    ...
    # Class: CfgVehicles|rhs_SPG9_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_SPG9_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "weapons": ["rhs_weap_SPG9"],
            "magazines": ["rhs_mag_PG9V","rhs_mag_OG9V","rhs_mag_OG9V","rhs_mag_OG9V","rhs_mag_OG9V","rhs_mag_OG9V","rhs_mag_OG9V","rhs_mag_PG9V","rhs_mag_PG9V","rhs_mag_PG9V","rhs_mag_PG9V","rhs_mag_PG9V","rhs_mag_PG9V"],
