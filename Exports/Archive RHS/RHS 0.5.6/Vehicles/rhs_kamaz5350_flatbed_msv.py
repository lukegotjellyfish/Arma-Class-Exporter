rhs_kamaz5350_flatbed_msv = {
    ...
    # Class: CfgVehicles|rhs_kamaz5350_flatbed|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|rhs_kamaz5350_flatbed|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhs_kamaz5350_flatbed|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
        ...
        # Class: CfgVehicles|rhs_kamaz5350_flatbed|VehicleTransport|Carrier [Indent level: 2],
        "carrier": {
