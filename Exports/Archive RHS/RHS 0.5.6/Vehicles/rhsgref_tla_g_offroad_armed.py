rhsgref_tla_g_offroad_armed = {
    ...
    # Class: CfgVehicles|rhsgref_tla_offroad_armed|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhsgref_tla_offroad_armed|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
