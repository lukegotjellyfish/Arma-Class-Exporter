rhsusf_pack_slackman_m240 = {
    "scope": 1,
    # Class: CfgVehicles|rhsusf_pack_slackman_m240|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_pack_slackman_m240|TransportItems|_xx_rhsusf_50Rnd_762x51 [Indent level: 2]
