rhsusf_assault_eagleaiii_ucp_demo = {
    ...
    # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_demo|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_demo|TransportItems|_xx_rhsusf_m112x4_mag [Indent level: 2]
        "_xx_rhsusf_m112x4_mag": {
            "name": "rhsusf_m112x4_mag",
            "count": 1
        },
        # Class: CfgVehicles|rhsusf_assault_eagleaiii_ucp_demo|TransportItems|_xx_rhsusf_m112_mag [Indent level: 2],
        "_xx_rhsusf_m112_mag": {
