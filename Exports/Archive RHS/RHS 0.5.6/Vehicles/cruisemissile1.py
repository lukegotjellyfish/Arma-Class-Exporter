cruisemissile1 = {
    "dlc": "RHS_USAF",
    "scope": 1,
    "model": "rhsusf|addons|rhsusf_a2port_air2|CruiseMissile|cruisemissile4",
    "displayname": "Cruise Missile",
    "faction": "rhs_faction_usmc_14",
    "animated": 1,
    "dammagehalf": [],
    "dammagefull": [],
    "weapons": [],
    "magazines": [],
    # Class: CfgVehicles|CruiseMissile1|Turrets [Indent level: 1],
    "turrets": {
    },
    "hiddenselections": ["WaterCover1","WaterCover2","WaterCover3","Booster1","Flame1"],
    # Class: CfgVehicles|CruiseMissile1|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Wing1 [Indent level: 2]
        "wing1": {
            "source": "user",
            "animperiod": 3,
            "initphase": 0
        },
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Wing2 [Indent level: 2],
        "wing2": {
            "animperiod": 3,
            "source": "user",
            "initphase": 0
        },
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Intake1 [Indent level: 2],
        "intake1": {
            "animperiod": 1,
            "source": "user",
            "initphase": 0
        },
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Cover1 [Indent level: 2],
        "cover1": {
            "animperiod": 0.5,
            "source": "user",
            "initphase": 0
        },
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Cover2 [Indent level: 2],
        "cover2": {
            "animperiod": 0.6,
            "source": "user",
            "initphase": 0
        },
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Fin1 [Indent level: 2],
        "fin1": {
            "animperiod": 0.3,
            "source": "user",
            "initphase": 0
        },
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Fin2 [Indent level: 2],
        "fin2": {
            "animperiod": 0.3,
            "source": "user",
            "initphase": 0
        },
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Fin3 [Indent level: 2],
        "fin3": {
            "animperiod": 0.3,
            "source": "user",
            "initphase": 0
        },
        # Class: CfgVehicles|CruiseMissile1|AnimationSources|Fin4 [Indent level: 2],
        "fin4": {
            "animperiod": 0.3,
            "source": "user",
            "initphase": 0
    ...
    # Class: CfgVehicles|Helicopter|Reflectors [Indent level: 1],
    "reflectors": {
        # Class: CfgVehicles|Helicopter|Reflectors|Reflector [Indent level: 2]
        "reflector": {
            "color": [0.8,0.8,1,1],
    ...
    # Class: CfgVehicles|Helicopter|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "",
