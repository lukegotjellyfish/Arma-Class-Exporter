rhsgref_cdf_b_reg_bm21 = {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_reg_BM21.paa",
    "dlc": "RHS_GREF",
    "rhs_decalparameters": ["['Number', cDecals4CarsNumberPlaces, 'CDF']"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_camo_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_bm21_cdf_co.paa","rhsafrf|addons|RHS_Decals|Data|Labels|Misc|no_ca.paa"],
    "accuracy": 0.5,
