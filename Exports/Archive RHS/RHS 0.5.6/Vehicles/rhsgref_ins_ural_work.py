rhsgref_ins_ural_work = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_ural_work.paa",
    "scope": 2,
    ...
    # Class: CfgVehicles|rhsgref_ins_ural_work|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_ural_work|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
