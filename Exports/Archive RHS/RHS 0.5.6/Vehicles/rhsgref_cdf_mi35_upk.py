rhsgref_cdf_mi35_upk = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_cdf_Mi35_UPK.paa",
    "scope": 1,
    "scopecurator": 2,
    "rhs_decalparameters": ["['Number',cRHSAIRMI24NumberPlaces,'AviaCDF']"],
    "weapons": ["rhs_weap_CMFlareLauncher"],
    "magazines": ["168Rnd_CMFlare_Chaff_Magazine"],
    # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                    "attachment": "rhs_mag_upk23_mixed",
                    "turret": [],
                ...
                # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                ...
                # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
                    "attachment": "rhs_mag_ub32_s5ko",
                    "turret": [],
                ...
                # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent|pylons|pylon5 [Indent level: 4],
                "pylon5": {
                    "attachment": "rhs_mag_9M114M_Mi24_2x",
                    "turret": [0],
                ...
                # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent|pylons|pylon6 [Indent level: 4],
                "pylon6": {
                    "attachment": "rhs_mag_9M114M_Mi24_2x",
                    "turret": [0],
                    "uiposition": [0.04,0.4],
                ...
                # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4],
                "cmdispenser": {
    ...
    # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|AnimationSources|exhaust_hide [Indent level: 2]
        "exhaust_hide": {
            "source": "user",
            "initphase": 1,
            "animperiod": 1e-005
    ...
    # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Exhausts|Exhaust01 [Indent level: 2]
        "exhaust01": {
            "direction": "exhaust1_dir",
            "position": "exhaust1",
            "effect": "ExhaustEffectHeli"
        },
        # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|Exhausts|Exhaust02 [Indent level: 2],
        "exhaust02": {
    ...
    # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|TransportMagazines|_xx_rhs_30Rnd_545x39_7N6M_AK [Indent level: 2]
        "_xx_rhs_30rnd_545x39_7n6m_ak": {
            "magazine": "rhs_30Rnd_545x39_7N6M_AK",
            "count": 30
        },
        # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
        "_xx_rhs_mag_nspn_red": {
            "magazine": "rhs_mag_nspn_red",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_Mi35_UPK|TransportMagazines|_xx_rhs_mag_rdg2_white [Indent level: 2],
    ...
    "turrets": {
        ...
        "mainturret": {
            "body": "mainTurret",
            "gun": "mainGun",
            "weapons": ["rhs_weap_MASTERSAFE","rhs_weap_yakB","rhs_weap_fcs_mi24"],
