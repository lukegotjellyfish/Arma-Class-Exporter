rhs_m2a3_buski = {
    ...
    "hiddenselections": ["camo1","camo2","camo3","duke_tex"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|base_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|a3_buski_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|ultralp_co.paa","rhsusf|addons|rhsusf_m1a1|duke|data|duke_antennae_d_co.paa"],
    # Class: CfgVehicles|RHS_M2A3_BUSKI|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|RHS_M2A3_BUSKI|textureSources|standard [Indent level: 2]
        "standard": {
            "displayname": "Woodland",
            "author": "Red Hammer Studios",
            "textures": ["|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|woodland|base_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|woodland|a3_buski_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|woodland|ultralp_co.paa","rhsusf|addons|rhsusf_m1a1|duke|data|duke_antennae_wd_co.paa"],
            "factions": ["rhs_faction_usarmy_wd"]
        },
        # Class: CfgVehicles|RHS_M2A3_BUSKI|textureSources|Desert [Indent level: 2],
        "desert": {
            "displayname": "Desert",
            "author": "Red Hammer Studios",
            "textures": ["|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|base_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|a3_buski_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|ultralp_co.paa","rhsusf|addons|rhsusf_m1a1|duke|data|duke_antennae_d_co.paa"],
            "factions": ["rhs_faction_usarmy_d"]
        },
        # Class: CfgVehicles|RHS_M2A3_BUSKI|textureSources|Olive [Indent level: 2],
        "olive": {
            "displayname": "Olive",
            "author": "Red Hammer Studios",
            "textures": ["|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|woodland|m6_base_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|woodland|m6_a3_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|woodland|ultralp_co.paa","rhsusf|addons|rhsusf_m1a1|duke|data|duke_antennae_wd_co.paa"],
            "factions": ["rhs_faction_usarmy_wd"]
        }
    },
    # Class: CfgVehicles|RHS_M2A3_BUSKI|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|RHS_M2A3_BUSKI|HitPoints [Indent level: 1],
    "hitpoints": {
