rhs_pontoon_float = {
    ...
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_pontoon_float.paa",
    "scope": 2,
    "scopecurator": 2,
    "cost": 8000,
    "armor": 1500,
    "model": "rhsafrf|addons|rhs_pontoon|rhs_pmp_float.p3d",
    "displayname": "PMP-60 Pontoon (floating)",
    "vehicleclass": "rhs_vehclass_boat",
    "icon": "iconObject_2x3",
    "editorsubcategory": "rhs_EdSubcat_boat",
    "waterleakiness": 0.0001,
    "waterresistancecoef": 0.2,
    # Class: CfgVehicles|rhs_pontoon_float|Attributes [Indent level: 1],
    "attributes": {
        # Class: CfgVehicles|rhs_pontoon_float|Attributes|rhs_fold_pontoon [Indent level: 2]
        "rhs_fold_pontoon": {
    ...
    # Class: CfgVehicles|rhs_pontoon_float|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_pontoon_float|AnimationSources|fold_source [Indent level: 2]
        "fold_source": {
            "source": "user",
            "animperiod": 4,
            "initphase": 0
    ...
    # Class: CfgVehicles|rhs_pontoon_float|UserActions [Indent level: 1],
    "useractions": {
        # Class: CfgVehicles|rhs_pontoon_float|UserActions|climbAboard [Indent level: 2]
        "climbaboard": {
        ...
        # Class: CfgVehicles|rhs_pontoon_float|UserActions|fold [Indent level: 2],
        "fold": {
            "displayname": "Fold pontoon",
            "shortcut": "",
            "priority": 3,
        ...
        # Class: CfgVehicles|rhs_pontoon_float|UserActions|unfold [Indent level: 2],
        "unfold": {
        ...
        # Class: CfgVehicles|rhs_pontoon_float|UserActions|load [Indent level: 2],
        "load": {
    ...
    # Class: CfgVehicles|rhs_pontoon_float|VehicleTransport [Indent level: 1],
    "vehicletransport": {
        # Class: CfgVehicles|rhs_pontoon_float|VehicleTransport|Cargo [Indent level: 2]
        "cargo": {
    ...
    # Class: CfgVehicles|rhs_pontoon_float|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_pontoon_float|EventHandlers|rhs_pontoon_static [Indent level: 2]
        "rhs_pontoon_static": {
