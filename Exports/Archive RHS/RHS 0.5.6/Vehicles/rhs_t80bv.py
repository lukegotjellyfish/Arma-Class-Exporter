rhs_t80bv = {
    ...
    # Class: CfgVehicles|rhs_t80bv|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_t80bv|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            ...
            "armorlights": 0.1,
            # Class: CfgVehicles|rhs_t80bv|Turrets|MainTurret|Turrets [Indent level: 3],
            "turrets": {
                # Class: CfgVehicles|rhs_t80bv|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                    "weapons": [],
                    "magazines": [],
                    "outgunnermayfire": 1,
