rhs_assault_umbts_engineer = {
    ...
    # Class: CfgVehicles|rhs_assault_umbts_engineer|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhs_assault_umbts_engineer|TransportItems|_xx_ToolKit [Indent level: 2]
        "_xx_toolkit": {
            "name": "ToolKit",
            "count": 1
        }
