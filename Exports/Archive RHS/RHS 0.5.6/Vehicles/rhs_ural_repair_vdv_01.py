rhs_ural_repair_vdv_01 = {
    ...
    "transportrepair": 2e+009,
    "supplyradius": 9.5,
    "hiddenselections": ["camo1","camo2","n1","n2","n3","n4","i1","i2","i3","i4"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_khk_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa","rhsafrf|addons|RHS_Decals|Data|Labels|Misc|no_ca.paa"],
    # Class: CfgVehicles|RHS_Ural_Repair_MSV_01|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhsafrf|addons|rhs_tigr|data|glass.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_int.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_kabina.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_kabina_damage.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_kabina_destruct.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_open.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_open_damage.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_open_destruct.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_repair.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_repair_damage.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_repair_destruct.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_interier.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_interier_damage.rvmat","rhsafrf|addons|rhs_a2port_car|Ural|Data|ural_interier_destruct.rvmat","a3|data_f|default.rvmat","a3|data_f|default.rvmat","a3|data_f|default_destruct.rvmat"]
    },
    # Class: CfgVehicles|RHS_Ural_Repair_MSV_01|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|RHS_Ural_Repair_MSV_01|textureSources|standard [Indent level: 2]
        "standard": {
            "displayname": "Khaki",
            "author": "Red Hammer Studios",
            "textures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_khk_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa"],
            "factions": ["rhs_faction_vmf","rhs_faction_vdv","rhs_faction_vdv","rhs_faction_vv"]
        },
        # Class: CfgVehicles|RHS_Ural_Repair_MSV_01|textureSources|Camo [Indent level: 2],
        "camo": {
            "displayname": "3-Color Camo",
            "author": "Red Hammer Studios",
            "textures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_rus_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa"],
            "factions": ["rhs_faction_vmf","rhs_faction_vdv","rhs_faction_vdv","rhs_faction_vv"]
        },
        # Class: CfgVehicles|RHS_Ural_Repair_MSV_01|textureSources|Camo1 [Indent level: 2],
        "camo1": {
            "displayname": "CDF",
            "author": "Red Hammer Studios",
            "textures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_camo_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa"],
            "factions": ["rhs_faction_vmf","rhs_faction_vdv","rhs_faction_vdv","rhs_faction_vv"]
        },
        # Class: CfgVehicles|RHS_Ural_Repair_MSV_01|textureSources|Camo2 [Indent level: 2],
        "camo2": {
            "displayname": "Takistan",
            "author": "Red Hammer Studios",
            "textures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_tka_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa"],
            "factions": ["rhs_faction_vmf","rhs_faction_vdv","rhs_faction_vdv","rhs_faction_vv"]
        },
        # Class: CfgVehicles|RHS_Ural_Repair_MSV_01|textureSources|Camo3 [Indent level: 2],
        "camo3": {
            "displayname": "Chedaki",
            "author": "Red Hammer Studios",
            "textures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa"],
            "factions": ["rhs_faction_vmf","rhs_faction_vdv","rhs_faction_vdv","rhs_faction_vv"]
        },
        # Class: CfgVehicles|RHS_Ural_Repair_MSV_01|textureSources|rhs_sand [Indent level: 2],
        "rhs_sand": {
            "displayname": "Sand",
            "author": "Red Hammer Studios",
            "textures": ["rhsafrf|addons|rhs_a2port_car_camo|data|ural_kabina_sand_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_repair_co.paa"],
            "factions": ["rhs_faction_vmf","rhs_faction_vdv","rhs_faction_vdv","rhs_faction_vv"]
        }
    },
    "texturelist": [],
    ...
    "getinproxyorder": [1,2],
    # Class: CfgVehicles|RHS_Ural_Support_MSV_Base_01|Turrets [Indent level: 1],
    "turrets": {
    },
    "accuracy": 0.5,
    "side": 0,
