rhsgref_un_mi24v_upk = {
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_un_Mi24V_UPK.paa",
    ...
    "scopecurator": 2,
    "rhs_decalparameters": [],
    "hiddenselectionstextures": ["|rhsgref|addons|rhsgref_tohport_air|Mi24|data|26_unitednations_white_001_co.paa","|rhsgref|addons|rhsgref_tohport_air|Mi24|data|26_unitednations_white_002_co.paa"],
    # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|AnimationSources|exhaust_hide [Indent level: 2]
        "exhaust_hide": {
            "source": "user",
            "initphase": 1,
            "animperiod": 1e-005
    ...
    # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|Exhausts|Exhaust01 [Indent level: 2]
        "exhaust01": {
            "direction": "exhaust1_dir",
            "position": "exhaust1",
            "effect": "ExhaustEffectHeli"
        },
        # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|Exhausts|Exhaust02 [Indent level: 2],
        "exhaust02": {
    ...
    # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|TransportMagazines|_xx_rhs_30Rnd_545x39_7N6M_AK [Indent level: 2]
        "_xx_rhs_30rnd_545x39_7n6m_ak": {
            "magazine": "rhs_30Rnd_545x39_7N6M_AK",
            "count": 30
        },
        # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
        "_xx_rhs_mag_nspn_red": {
            "magazine": "rhs_mag_nspn_red",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_un_Mi24V_UPK|TransportMagazines|_xx_rhs_mag_rdg2_white [Indent level: 2],
    ...
    # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent|pylons [Indent level: 3]
            "pylons": {
                # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                    "attachment": "rhs_mag_upk23_mixed",
                    "turret": [],
                ...
                # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                ...
                # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
                    "attachment": "rhs_mag_b8v20a_s8kom",
                    "turret": [],
                ...
                # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent|pylons|pylon5 [Indent level: 4],
                "pylon5": {
                ...
                # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent|pylons|pylon6 [Indent level: 4],
                "pylon6": {
                    "attachment": "rhs_mag_9M120M_Mi24_2x",
                    "turret": [0],
                    "uiposition": [0.04,0.4],
                ...
                # Class: CfgVehicles|RHS_Mi24V_UPK23_VVS_Base|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4],
                "cmdispenser": {
    ...
    "weapons": ["rhs_weap_MASTERSAFE","rhs_weap_DIRCM_Lipa"],
