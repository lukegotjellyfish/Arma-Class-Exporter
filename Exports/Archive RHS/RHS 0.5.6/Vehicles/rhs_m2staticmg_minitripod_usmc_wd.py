rhs_m2staticmg_minitripod_usmc_wd = {
    ...
    # Class: CfgVehicles|RHS_M2StaticMG_MiniTripod_base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|RHS_M2StaticMG_MiniTripod_base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "initturn": 0,
            "maxturn": 90,
            "minturn": -90,
    ...
    # Class: CfgVehicles|RHS_M2StaticMG_MiniTripod_base|assembleInfo [Indent level: 1],
    "assembleinfo": {
        "primary": 0,
        "base": "",
        "assembleto": "",
        "dissasembleto": ["RHS_M2_Gun_Bag","RHS_M2_MiniTripod_Bag"],
        "displayname": ""
    },
    "dlc": "RHS_USAF",
    ...
    # Class: CfgVehicles|rhs_m2staticmg_base|Hitpoints [Indent level: 1],
    "hitpoints": {
        # Class: CfgVehicles|rhs_m2staticmg_base|Hitpoints|HitHull [Indent level: 2]
        "hithull": {
            "armor": 1,
            "passthrough": 1,
            "name": "telo"
    ...
    # Class: CfgVehicles|rhs_m2staticmg_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|rhs_m2staticmg_base|ViewPilot [Indent level: 1],
    "viewpilot": {
        "initanglex": -0,
        "initangley": 0,
        "initfov": 0.9,
    ...
    # Class: CfgVehicles|rhs_m2staticmg_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_m2staticmg_base|AnimationSources|ReloadAnim [Indent level: 2]
        "reloadanim": {
            "source": "reload",
            "weapon": "RHS_M2"
        },
        # Class: CfgVehicles|rhs_m2staticmg_base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "RHS_M2"
        },
        # Class: CfgVehicles|rhs_m2staticmg_base|AnimationSources|Revolving [Indent level: 2],
        "revolving": {
            "source": "revolving",
            "weapon": "RHS_M2"
        },
        # Class: CfgVehicles|rhs_m2staticmg_base|AnimationSources|muzzleHMG_ROT [Indent level: 2],
        "muzzlehmg_rot": {
            "source": "ammorandom",
            "weapon": "RHS_M2"
        }
