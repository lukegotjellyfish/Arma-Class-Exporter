rhs_rpg_6b3_at = {
    "scope": 1,
    # Class: CfgVehicles|rhs_rpg_6b3_at|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhs_rpg_6b3_at|TransportMagazines|_xx_rhs_rpg7_PG7VL_mag [Indent level: 2]
