rhs_fakecarrier = {
    ...
    # Class: CfgVehicles|RHS_FakeCarrier|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|RHS_FakeCarrier|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|RHS_FakeCarrier|RHS_TowingSystem|Carrier [Indent level: 2]
        "carrier": {
            "rhs_attachpointpos": [0,0,0],
            "rhs_maxcargomass": 9999,
            "rhs_attachpoint": ""
        }
    },
    "scope": 1,
    "model": "rhsafrf|addons|rhs_heavyweapons|data|rhs_fakeTow",
    "accuracy": 1000,
