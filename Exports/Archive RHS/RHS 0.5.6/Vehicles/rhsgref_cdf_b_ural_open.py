rhsgref_cdf_b_ural_open = {
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_car|ural|data|ural_kabina_camo_co.paa","rhsafrf|addons|rhs_a2port_car|ural|data|ural_open_cdf_co.paa","rhsafrf|addons|RHS_Decals|Data|Labels|Misc|no_ca.paa"],
