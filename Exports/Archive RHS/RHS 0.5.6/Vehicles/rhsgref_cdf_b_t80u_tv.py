rhsgref_cdf_b_t80u_tv = {
    ...
    # Class: CfgVehicles|rhsgref_cdf_b_t80u_tv|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_cdf_b_t80u_tv|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhsgref_cdf_b_t80u_tv|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhsgref_cdf_b_t80u_tv|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_vehicles_ret|data|cdf|rhs_t80u_01_cdf_co.paa","rhsgref|addons|rhsgref_vehicles_ret|data|cdf|rhs_t80u_02_cdf_co.paa","rhsgref|addons|rhsgref_vehicles_ret|data|cdf|rhs_t80u_03_cdf_co.paa","rhsafrf|addons|rhs_t80|data|searchlightopen_co.paa"],
    # Class: CfgVehicles|rhsgref_cdf_t80u_tv|TransportMagazines [Indent level: 1],
    "transportmagazines": {
        # Class: CfgVehicles|rhsgref_cdf_t80u_tv|TransportMagazines|_xx_rhsusf_mag_17Rnd_9x19_FMJ [Indent level: 2]
        "_xx_rhsusf_mag_17rnd_9x19_fmj": {
            "magazine": "rhsusf_mag_17Rnd_9x19_FMJ",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_t80u_tv|TransportMagazines|_xx_rhs_mag_rgd5 [Indent level: 2],
        "_xx_rhs_mag_rgd5": {
            "magazine": "rhs_mag_rgd5",
            "count": 10
        },
        # Class: CfgVehicles|rhsgref_cdf_t80u_tv|TransportMagazines|_xx_rhs_mag_nspn_red [Indent level: 2],
