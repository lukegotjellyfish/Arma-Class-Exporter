rhsusf_m1045_d_s = {
    ...
    "animationlist": [],
    # Class: CfgVehicles|rhsusf_m1045_w|RHS_TowingSystem [Indent level: 1],
    "rhs_towingsystem": {
        # Class: CfgVehicles|rhsusf_m1045_w|RHS_TowingSystem|Carrier [Indent level: 2]
        "carrier": {
    ...
    "hitpoints": {
        # Class: CfgVehicles|rhsusf_m966_w|HitPoints|Hit_Ammo [Indent level: 2]
        "hit_ammo": {
            "armor": -100,
            "minimalhit": -0.2,
        ...
        # Class: CfgVehicles|rhsusf_m966_w|HitPoints|HitHull [Indent level: 2],
        "hithull": {
            "depends": "Hit_Ammo",
            "armor": 1,
            "material": -1,
