rhs_zil131_open_vdv = {
    ...
    "side": 0,
    "crew": "rhs_vdv_driver",
    "rhs_decalparameters": ["['Number', [5,6,7,8], 'Default']","['Label', [9,10], 'Army', 2]","['Label', [11,12], 'Platoon',11]"],
    "scope": 2,
    ...
    "hiddenselectionstextures": ["|rhsafrf|addons|rhs_zil131|data|rhs_zil131_cargo_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_cabin_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_interior_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_wheels_co.paa","|rhsafrf|addons|rhs_zil131|data|rhs_zil131_base_co.paa"],
    "viewcargoshadow": 1,
    "viewdrivershadow": 1,
    "viewgunnershadow": 1,
