rhs_metis_9k115_2_vmf = {
    "editorpreview": "rhsafrf|addons|rhs_editorPreviews|data|rhs_Metis_9k115_2_vdv.paa",
    "scope": 2,
    "side": 0,
    ...
    # Class: CfgVehicles|rhs_Metis_Base|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhs_Metis_Base|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "weapons": ["rhs_weap_9K115_2_launcher"],
            "magazines": ["rhs_mag_9M131m","rhs_mag_9M131m","rhs_mag_9M131m","rhs_mag_9M131f"],
    ...
    # Class: CfgVehicles|rhs_Metis_Base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_Metis_Base|AnimationSources|revolving [Indent level: 2]
        "revolving": {
            "source": "revolving",
            "weapon": "rhs_weap_9K115_2_launcher"
        },
        # Class: CfgVehicles|rhs_Metis_Base|AnimationSources|ReloadMagazine [Indent level: 2],
        "reloadmagazine": {
            "source": "reloadmagazine",
            "weapon": "rhs_weap_9K115_2_launcher"
        }
    },
    # Class: CfgVehicles|rhs_Metis_Base|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgVehicles|rhs_Metis_Base|EventHandlers|RHS_EventHandlers [Indent level: 2]
        "rhs_eventhandlers": {
