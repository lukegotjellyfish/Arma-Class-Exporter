rhs_weap_rpk74m_sup = {
    # Class: CfgWeapons|rhs_weap_rpk74m_sup|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_rpk74m_sup|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_1p87"
        },
        # Class: CfgWeapons|rhs_weap_rpk74m_sup|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
    ...
    # Class: CfgWeapons|rhs_weap_rpk74m_npz|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 113.2,
        # Class: CfgWeapons|rhs_weap_rpk74m_npz|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_rpk74m_npz|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_weapons3|rpk74|data|rhs_rpk74_base_co.paa","rhsafrf|addons|rhs_weapons3|rpk74|data|rhs_rpk74_stock_co.paa"],
    # Class: CfgWeapons|rhs_weap_rpk74m|FOLD [Indent level: 1],
    "fold": {
    ...
    "magazines": ["rhs_45Rnd_545x39_7N6M_AK"],
