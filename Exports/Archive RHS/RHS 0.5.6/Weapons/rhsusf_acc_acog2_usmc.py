rhsusf_acc_acog2_usmc = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_ACOG2_USMC_ca.paa",
    "rhs_optic_base": "rhsusf_acc_ACOG2_USMC",
    "weaponinfotype": "rhs_acog2_usmc_handler",
    "author": "Red Hammer Studios",
    "displayname": "AN/PVQ-31A (ARD)",
    # Class: CfgWeapons|rhsusf_acc_ACOG2_USMC|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsusf|addons|rhsusf_weapons|acc|scopes|optics|rhsusf_acog2_hex",
        # Class: CfgWeapons|rhsusf_acc_ACOG2|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_ACOG2|ItemInfo|OpticsModes|elcan_scope [Indent level: 3]
            "elcan_scope": {
                "opticsflare": 0,
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhsusf_acc_ACOG2|ItemInfo|OpticsModes|alternative_view [Indent level: 3],
            "alternative_view": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
