rhsgref_weap_savz58v_saboteur = {
    # Class: CfgWeapons|rhsgref_weap_savz58v_saboteur|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhsgref_weap_savz58v_saboteur|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_T1_low_fwd"
        },
        # Class: CfgWeapons|rhsgref_weap_savz58v_saboteur|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhsgref_acc_zendl"
        },
        # Class: CfgWeapons|rhsgref_weap_savz58v_saboteur|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
            "slot": "GripodSlot",
    ...
    "scope": 1,
    "handanim": ["OFP2_ManSkeleton","|rhsgref|addons|rhsgref_c_weapons|anims|rhs_hand_savz58_vfg.rtm"],
    ...
    "hiddenselectionstextures": ["|rhsgref|addons|rhsgref_weapons|savz58|data|main_co","|rhsgref|addons|rhsgref_weapons|savz58|data|sec_co","|rhsgref|addons|rhsgref_weapons|savz58|data|vz58TopRailCover_co","rhsgref|addons|rhsgref_weapons|savz58|data|vz_ups_co","rhsusf|addons|rhsusf_weapons|m4|data|magpulstock_co","rhsusf|addons|rhsusf_weapons|m4|data|m4a1_actual_co"],
    # Class: CfgWeapons|rhs_weap_savz58_ris_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 70,
        # Class: CfgWeapons|rhs_weap_savz58_ris_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_savz58_ris_base|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        ...
        # Class: CfgWeapons|rhs_weap_savz58_ris_base|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons|rhs_weap_savz58_ris_base|WeaponSlotsInfo|GripodSlot [Indent level: 2],
        "gripodslot": {
