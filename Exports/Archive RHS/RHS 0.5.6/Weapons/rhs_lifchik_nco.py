rhs_lifchik_nco = {
    ...
    "dlc": "RHS_AFRF",
    "displayname": "Lifchik Chest Rig (Officer)",
    ...
    # Class: CfgWeapons|rhs_lifchik_NCO|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsafrf|addons|rhs_infantry3|gear|vests|rhs_lichifka_NCO",
        "containerclass": "Supply100",
        "hiddenselections": ["Camo","Camo1"],
        "mass": 15,
        # Class: CfgWeapons|rhs_chicom|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_chicom|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3]
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhs_chicom|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
