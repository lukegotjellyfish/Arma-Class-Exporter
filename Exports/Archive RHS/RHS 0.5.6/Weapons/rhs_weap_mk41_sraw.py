rhs_weap_mk41_sraw = {
    ...
    "magazines": ["rhs_fgm172b_magazine_MPV"],
    # Class: CfgWeapons|rhs_weap_mk41_sraw|ItemInfo [Indent level: 1],
    "iteminfo": {
        "priority": 3,
        "rmbhint": "FGM-172",
        "onhovertext": "TODO FGM172B DSS"
    },
    # Class: CfgWeapons|rhs_weap_mk41_sraw|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 72.6
    },
    "airateoffire": 10,
