rhs_stsh81_butan = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_stsh81_butan_ca.paa",
    "displayname": "STSh-81 (Butan)",
    "model": "rhsafrf|addons|rhs_infantry3|gear|head|rhs_sfera_butan",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|sfera_butan_co.paa"],
    # Class: CfgWeapons|rhs_stsh81_butan|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsafrf|addons|rhs_infantry3|gear|head|rhs_sfera_butan",
        "hiddenselections": ["camo"],
        # Class: CfgWeapons|rhs_stsh81|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_stsh81|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
