rhsusf_mich_bare_norotos_arc_alt_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_arc_alt_headset_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_arc_alt_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_od_norotos_arc_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_od_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|rhs_helmet_ach_acc_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|bowman_base_co.paa"],
    "hiddenselections": ["Camo","Camo1","Camo2","bowman"],
    "scope": 2,
