rhs_acc_pso1m2_ironsight = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_acc_pso1m2_ironsight|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_pso1m2_ironsight|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pso1m2_ironsight|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3]
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
            ...
            # Class: CfgWeapons|rhs_acc_pso1m2_ironsight|ItemInfo|OpticsModes|pso1_scope [Indent level: 3],
            "pso1_scope": {
