rhsusf_acc_g33_xps3_flip = {
    ...
    "model": "rhsusf|addons|rhsusf_weapons3|acc|scopes|G33|g33_xps3_flip",
    "rhs_accessory_next": "rhsusf_acc_g33_xps3",
    "inertia": 0,
    "_generalmacro": "optic_Holosight",
    # Class: CfgWeapons|optic_Holosight|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 6,
        "modeloptics": "A3|Weapons_F|empty",
        "optics": 1,
        # Class: CfgWeapons|optic_Holosight|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|optic_Holosight|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
