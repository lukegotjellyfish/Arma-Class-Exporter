rhs_6b26_digi_ess = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_6b26_digi_ess_ca.paa",
    "displayname": "6B26 EMR-Summer (ESS)",
    "model": "rhsafrf|addons|rhs_infantry|gear|head|rhs_6b26_ess",
    "allowedfacewear": ["rhs_scarf","G_Aviator"],
    # Class: CfgWeapons|rhs_6b26_digi_ess|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
