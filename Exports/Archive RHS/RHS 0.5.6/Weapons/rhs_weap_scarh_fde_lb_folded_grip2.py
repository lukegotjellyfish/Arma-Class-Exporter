rhs_weap_scarh_fde_lb_folded_grip2 = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_FDE_LB_Folded_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_FDE_LB_Folded_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
    ...
    "scopearsenal": 0,
    "baseweapon": "rhs_weap_SCARH_FDE_LB_Folded",
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_FDE_LB_Folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 76.78,
