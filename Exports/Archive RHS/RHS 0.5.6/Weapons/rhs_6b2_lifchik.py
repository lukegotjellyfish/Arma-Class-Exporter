rhs_6b2_lifchik = {
    ...
    # Class: CfgWeapons|rhs_6b2_lifchik|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsafrf|addons|rhs_infantry3|gear|vests|rhs_6b2_lichifka",
        "containerclass": "Supply100",
        "mass": 50,
        "hiddenselections": ["Camo","Camo1"],
        # Class: CfgWeapons|rhs_6b2|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_6b2|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
            ...
            # Class: CfgWeapons|rhs_6b2|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
            ...
            # Class: CfgWeapons|rhs_6b2|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
            ...
            # Class: CfgWeapons|rhs_6b2|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
