rhs_weap_optic_smaw_9 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_9|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_9|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_9|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 450,
                "distancezoommax": 450,
                "discreteinitindex": 8,
