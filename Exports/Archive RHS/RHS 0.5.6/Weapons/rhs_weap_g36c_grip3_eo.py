rhs_weap_g36c_grip3_eo = {
    # Class: CfgWeapons|rhs_weap_g36c_grip3_eo|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_g36c_grip3_eo|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_eotech_552"
        },
        # Class: CfgWeapons|rhs_weap_g36c_grip3_eo|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
            "item": "rhs_acc_grip_ffg2",
            "slot": "UnderBarrelSlot"
        },
        # Class: CfgWeapons|rhs_weap_g36c_grip3_eo|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
