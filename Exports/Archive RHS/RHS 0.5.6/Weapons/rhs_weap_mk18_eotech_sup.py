rhs_weap_mk18_eotech_sup = {
    # Class: CfgWeapons|rhs_weap_mk18_eotech_sup|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_eotech_sup|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_eotech_xps3"
        },
        # Class: CfgWeapons|rhs_weap_mk18_eotech_sup|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15"
        },
        # Class: CfgWeapons|rhs_weap_mk18_eotech_sup|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
