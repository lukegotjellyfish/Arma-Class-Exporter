rhs_6b7_1m_bala1_emr = {
    ...
    "allowedfacewear": [],
    "displayname": "6B7-1M (EMR/Balaclava)",
    "model": "rhsafrf|addons|rhs_infantry2|gear|head|rhs_6b7_1m_cover_balaclava1",
    "hiddenselections": ["Camo1","Camo2","Camo3"],
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_6b7-1m_co.paa","rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_6b7-1m_emr_co.paa","rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_bala1_olive_co.paa"],
    # Class: CfgWeapons|rhs_6b7_1m_bala1_emr|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo1","Camo2","Camo3"],
        "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_6b7-1m_co.paa","rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_6b7-1m_emr_co.paa","rhsafrf|addons|rhs_infantry2|gear|head|data|rhs_bala1_olive_co.paa"],
