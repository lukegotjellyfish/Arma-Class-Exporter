rhs_ss21_dummy_launcher = {
    ...
    # Class: CfgWeapons|RHS_9M79_1Launcher|StandardSound [Indent level: 1],
    "standardsound": {
        "weaponsoundeffect": "DefaultRifle",
        "begin1": ["|rhsafrf|addons|rhs_ss21|sound|launchA",3.41254,1,1200],
        "soundbegin": ["begin1",1]
    },
    "sound": ["|rhsafrf|addons|rhs_ss21|sound|launchA",10,1,1100],
    # Recoil Array: recoil,
