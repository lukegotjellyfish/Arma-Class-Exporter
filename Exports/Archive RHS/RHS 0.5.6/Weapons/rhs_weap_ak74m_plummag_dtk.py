rhs_weap_ak74m_plummag_dtk = {
    # Class: CfgWeapons|rhs_weap_ak74m_plummag_dtk|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak74m_plummag_dtk|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_dtk"
        }
