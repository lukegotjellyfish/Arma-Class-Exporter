rhs_weap_sr25_ec_d = {
    ...
    # Class: CfgWeapons|rhs_weap_sr25_ec_d|Library [Indent level: 1],
    "library": {
        "libtextdesc": "An SR 25 EC rifle manufactured by Knights Armament company"
    },
    # Class: CfgWeapons|rhs_weap_sr25_ec_d|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 84.92,
        # Class: CfgWeapons|rhs_weap_sr25_ec_d|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_weapons2|sr25|data|camo|d|reciever_co.paa","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|d|rail_co.paa","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|d|misc_co.paa","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|d|buttstock1_co.paa","rhsusf|addons|rhsusf_weapons2|sr25|data|camo|d|buttstock2_co.paa","rhsusf|addons|rhsusf_weapons|M4|data|kacrailcover_d_co.paa"],
