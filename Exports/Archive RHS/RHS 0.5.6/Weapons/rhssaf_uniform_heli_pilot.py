rhssaf_uniform_heli_pilot = {
    ...
    "displayname": "Pilot overalls",
    "model": "A3|Characters_F|Common|Suitpacks|suitpack_universal_F.p3d",
    "hiddenselections": ["camo1"],
    "hiddenselectionstextures": ["|rhssaf|addons|rhssaf_t_uniform_pilot|data|rhssaf_pilot_co.paa"],
    # Class: CfgWeapons|rhssaf_uniform_heli_pilot|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "-",
