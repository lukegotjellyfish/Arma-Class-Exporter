rhs_acc_pgo7v3_asval = {
    "displayname": "PGO-7V3",
    "weaponinfotype": "rhs_rscOptics_acc_pgo7v3",
    # Class: CfgWeapons|rhs_acc_pgo7v3_asval|ItemInfo [Indent level: 1],
    "iteminfo": {
        "modeloptics": "rhsafrf|addons|rhs_weapons|acc|scopes|optics|rhs_pgo7v3_scope",
        # Class: CfgWeapons|rhs_acc_pgo7v_asval|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pgo7v_asval|ItemInfo|OpticsModes|rhs_pgo7v_scope [Indent level: 3]
            "rhs_pgo7v_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_pgo7v_asval|ItemInfo|OpticsModes|rhs_pgo7v_iron [Indent level: 3],
            "rhs_pgo7v_iron": {
                "discretedistance": [100,150,200,220,250,270,300,320,350,370,400,420],
                "discretedistancecamerapoint": ["eye_val","eye_val_150","eye_val_200","eye_val_220","eye_val_250","eye_val_270","eye_val_300","eye_val_320","eye_val_350","eye_val_370","eye_val_400","eye_val_420"],
    ...
    "scope": 1,
    "scopearsenal": 0,
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_pgo7v_ca.paa",
    "model": "rhsafrf|addons|rhs_weapons|acc|scopes|pgo7v|rhs_pgo7v",
    "descriptionshort": "Optical Sight<br />Magnification: 2.7x",
    "inertia": 0.1,
    "dlc": "RHS_AFRF",
    "muzzles": [],
