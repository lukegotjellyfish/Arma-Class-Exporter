rhs_weap_ak103_zenitco01_folded_afg = {
    ...
    "inertia": 0.7,
    # Class: CfgWeapons|rhs_weap_ak103_zenitco01_folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 55.875,
        # Class: CfgWeapons|rhs_weap_ak103_zenitco01_folded|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            "iconpicture": "A3|Weapons_F|Data|clear_empty.paa",
            "iconpinpoint": "Left",
            # Class: rhs_picattinny_russian_handguard_scopes_slot|compatibleItems [Indent level: 0],
            "compatibleitems": {
