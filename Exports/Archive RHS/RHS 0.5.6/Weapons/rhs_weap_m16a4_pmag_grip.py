rhs_weap_m16a4_pmag_grip = {
    ...
    # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m16a4_pmag_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
