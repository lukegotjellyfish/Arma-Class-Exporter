rhs_6b23_digi_vydra_3m = {
    ...
    "displayname": "6B23 EMR-Summer (Vydra-3M)",
    ...
    # Class: CfgWeapons|rhs_6b23_vydra_3m|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo1","Camo2","Camo3"],
        "uniformmodel": "rhsafrf|addons|rhs_infantry|gear|vests|rhs_6b23_vydra_3m",
        "containerclass": "Supply100",
        "mass": 75,
        # Class: CfgWeapons|rhs_6b23_vydra_3m|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhs_6b23_vydra_3m|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
            ...
            # Class: CfgWeapons|rhs_6b23_vydra_3m|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
            ...
            # Class: CfgWeapons|rhs_6b23_vydra_3m|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
            ...
            # Class: CfgWeapons|rhs_6b23_vydra_3m|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
            ...
            # Class: CfgWeapons|rhs_6b23_vydra_3m|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
