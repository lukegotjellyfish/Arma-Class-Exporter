rhs_mortar_81mm = {
    ...
    "magazines": ["rhs_1Rnd_m821_HE","rhs_12Rnd_m821_HE","8Rnd_82mm_Mo_shells","8Rnd_82mm_Mo_Flare_white","8Rnd_82mm_Mo_Smoke_white","8Rnd_82mm_Mo_guided","8Rnd_82mm_Mo_LG"],
    "minrange": 90,
    "midrange": 4000,
    "maxrange": 8000,
    # Class: CfgWeapons|rhs_mortar_81mm|GunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_mortar_81mm|GunParticles|FirstEffect [Indent level: 2]
        "firsteffect": {
    ...
    "modes": ["Single0","Single1","Single2","Single3","Single4","Burst0","Burst1","Burst2","Burst3","Burst4"],
    # Class: CfgWeapons|rhs_mortar_81mm|Single0 [Indent level: 1],
    "single0": {
        "displayname": "CHARGE 0",
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_mortar_81mm|Single0|StandardSound [Indent level: 2],
        "standardsound": {
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Single1 [Indent level: 1],
    "single1": {
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Single2 [Indent level: 1],
    "single2": {
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Single3 [Indent level: 1],
    "single3": {
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Single4 [Indent level: 1],
    "single4": {
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Burst0 [Indent level: 1],
    "burst0": {
        "showtoplayer": 0,
        ...
        "aiburstterminable": 1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_mortar_81mm|Burst0|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_01",1.25893,1,250],
            "begin2": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_02",1.25893,1,250],
            "soundbegin": ["begin1",0.5,"begin2",0.5]
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Burst1 [Indent level: 1],
    "burst1": {
        "showtoplayer": 0,
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Burst2 [Indent level: 1],
    "burst2": {
        "showtoplayer": 0,
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Burst3 [Indent level: 1],
    "burst3": {
        "showtoplayer": 0,
        "displayname": "Burst (far)",
        "minrange": 540,
    ...
    # Class: CfgWeapons|rhs_mortar_81mm|Burst4 [Indent level: 1],
    "burst4": {
        "showtoplayer": 0,
        "displayname": "Burst (far)",
        "minrange": 540,
    ...
    "sounds": ["StandardSound"],
    # Class: CfgWeapons|mortar_82mm|StandardSound [Indent level: 1],
    "standardsound": {
        "begin1": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_01",1.25893,1,250],
        "begin2": ["A3|Sounds_F|arsenal|weapons_static|Mortar|mortar_02",1.25893,1,250],
        "soundbegin": ["begin1",0.5,"begin2",0.5],
