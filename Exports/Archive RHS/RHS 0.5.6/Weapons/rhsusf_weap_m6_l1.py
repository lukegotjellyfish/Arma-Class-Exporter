rhsusf_weap_m6_l1 = {
    ...
    # Class: CfgWeapons|rhsusf_weap_M6_L1|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhsusf_weap_M6_L1|EventHandlers|RHS_CM [Indent level: 2]
        "rhs_cm": {
            "fired": "(_this + [['smoke_L1_','_pos','_dir']]) call RHSUSF_fnc_effectFiredSmokeLauncher"
        }
    },
    "magazines": ["rhsusf_mag_L8A3_L1_8"],
    "modes": ["Double"],
