rhs_6b47_6b50 = {
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|ratnik|data|6b47_co.paa","rhsafrf|addons|rhs_infantry3|ratnik|data|housse_co.paa"],
    # Class: CfgWeapons|rhs_6b47_6B50|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["Camo","Camo1"],
