rhs_weap_optic_smaw_7 = {
    ...
    # Class: CfgWeapons|rhs_weap_optic_smaw_7|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_weap_optic_smaw_7|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_weap_optic_smaw_7|ItemInfo|OpticsModes|optic [Indent level: 3]
            "optic": {
                "distancezoommin": 350,
                "distancezoommax": 350,
                "discreteinitindex": 6,
