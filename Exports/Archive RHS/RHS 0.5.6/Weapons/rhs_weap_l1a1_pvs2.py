rhs_weap_l1a1_pvs2 = {
    # Class: CfgWeapons|rhs_weap_l1a1_pvs2|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_l1a1_pvs2|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsgref_acc_l1a1_anpvs2"
        },
        # Class: CfgWeapons|rhs_weap_l1a1_pvs2|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
