rhs_weap_ak74mr_folded = {
    ...
    "handanim": ["OFP2_ManSkeleton","|rhsafrf|addons|rhs_c_weapons|anims|rhs_hand_akmr_stock.rtm"],
    # Recoil Class: recoil,
    ...
    # Class: CfgWeapons|rhs_weap_ak74mr_folded|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 52.5,
        "allowedslots": [901],
