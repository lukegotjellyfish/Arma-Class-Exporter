rhsgref_helmet_m1940_camo01 = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1940_camo01_ca.paa",
    "displayname": "M40 (Painted)",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|M1940_strapdown",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1940_camo01_co.paa","rhsgref|addons|rhsgref_infantry|gear|Head|data|decals|blank_ca.paa"],
    # Class: CfgWeapons|rhsgref_helmet_m1940_camo01|ItemInfo [Indent level: 1],
    "iteminfo": {
