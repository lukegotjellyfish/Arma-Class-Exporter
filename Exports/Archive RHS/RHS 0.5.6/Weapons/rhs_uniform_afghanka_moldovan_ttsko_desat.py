rhs_uniform_afghanka_moldovan_ttsko_desat = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_moldovan_ttsko_desat_ca.paa",
    "displayname": "M88 (Moldovan TTsKO Desaturated)",
    # Class: CfgWeapons|rhs_uniform_afghanka_moldovan_ttsko_desat|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_moldovan_ttsko_desat_base",
        "uniformmodel": "-",
