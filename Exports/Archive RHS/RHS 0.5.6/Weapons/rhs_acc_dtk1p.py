rhs_acc_dtk1p = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_dtk1p_ca.paa",
    "author": "Red Hammer Studios",
    "model": "rhsafrf|addons|rhs_weapons3|acc|muzzle|dtk1p|dtk1p.p3d",
    "displayname": "DTK-1P",
    # Class: CfgWeapons|rhs_acc_dtk1p|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_dtk1p|ItemInfo|MuzzleCoef [Indent level: 2]
        "muzzlecoef": {
