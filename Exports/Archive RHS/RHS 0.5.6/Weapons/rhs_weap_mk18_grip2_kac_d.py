rhs_weap_mk18_grip2_kac_d = {
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip2_KAC_d|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_mk18_grip2_KAC_d|WeaponSlotsInfo|GripodSlot [Indent level: 2]
        "gripodslot": {
    ...
    # Class: CfgWeapons|rhs_weap_mk18_grip2_KAC_d|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_mk18_grip2_KAC_d|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip2",
            "slot": "UnderBarrelSlot"
        }
    },
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_weapons|m4|data|m4a1_actual_d_co.paa","|rhsusf|addons|rhsusf_weapons3|M4BII|Data|rhs_mk18rail_d_co.paa","|rhsusf|addons|rhsusf_weapons|acc|grips|grippod|data|acc_co.paa","|rhsusf|addons|rhsusf_weapons|m4|data|m4acc_d_co.paa","|rhsusf|addons|rhsusf_weapons2|sr25|data|buttstock2_d_co.paa"],
