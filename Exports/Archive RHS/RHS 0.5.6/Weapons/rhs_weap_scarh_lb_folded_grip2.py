rhs_weap_scarh_lb_folded_grip2 = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_LB_Folded_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_LB_Folded_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
