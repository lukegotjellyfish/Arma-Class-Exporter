rhsusf_acc_acog3_usmc = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_ACOG3_USMC_ca.paa",
    "rhs_optic_base": "rhsusf_acc_ACOG3_USMC",
    "weaponinfotype": "rhs_acog3_usmc_handler",
    "author": "Red Hammer Studios",
    "displayname": "AN/PVQ-31A (ARD/Lens Cover)",
    # Class: CfgWeapons|rhsusf_acc_ACOG3_USMC|ItemInfo [Indent level: 1],
    "iteminfo": {
        ...
        "optics": 1,
        # Class: CfgWeapons|rhsusf_acc_ACOG|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_ACOG|ItemInfo|OpticsModes|elcan_scope [Indent level: 3]
            "elcan_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhsusf_acc_ACOG|ItemInfo|OpticsModes|alternative_view [Indent level: 3],
            "alternative_view": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
