rhs_weap_ak74mr_gp25_rakurspm = {
    # Class: CfgWeapons|rhs_weap_ak74mr_gp25_rakursPM|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_ak74mr_gp25_rakursPM|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhs_acc_rakursPM"
        },
        # Class: CfgWeapons|rhs_weap_ak74mr_gp25_rakursPM|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_uuk"
        }
