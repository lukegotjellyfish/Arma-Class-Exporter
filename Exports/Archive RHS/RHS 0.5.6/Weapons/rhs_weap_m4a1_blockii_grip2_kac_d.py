rhs_weap_m4a1_blockii_grip2_kac_d = {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC_d|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC_d|WeaponSlotsInfo|GripodSlot [Indent level: 2]
        "gripodslot": {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC_d|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC_d|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
