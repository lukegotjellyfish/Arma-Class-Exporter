rhs_weap_m4a1_blockii_grip2_kac = {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip2_KAC|WeaponSlotsInfo|GripodSlot [Indent level: 2]
        "gripodslot": {
