rhsgref_acc_l1a1_l2a2 = {
    ...
    # Class: CfgWeapons|rhsgref_acc_l2a2|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 2,
        "mass": 17.6,
        ...
        # Class: CfgWeapons|rhsgref_acc_l2a2|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsgref_acc_l2a2|ItemInfo|OpticsModes|rhs_scope [Indent level: 3]
            "rhs_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhsgref_acc_l2a2|ItemInfo|OpticsModes|rhs_iron [Indent level: 3],
            "rhs_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
