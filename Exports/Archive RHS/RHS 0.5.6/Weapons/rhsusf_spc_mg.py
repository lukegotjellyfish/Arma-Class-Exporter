rhsusf_spc_mg = {
    ...
    # Class: CfgWeapons|rhsusf_spc_mg|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformmodel": "rhsusf|addons|rhsusf_infantry|gear|vests|rhs_spc_mg",
        "containerclass": "Supply120",
        "mass": 100,
        # Class: CfgWeapons|rhsusf_spc_mg|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsusf_spc_mg|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3]
            "chest": {
                "hitpointname": "HitChest",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_spc_mg|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": "28 + 		3",
                "passthrough": 0.1
            },
            # Class: CfgWeapons|rhsusf_spc_mg|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhsusf_spc_mg|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
