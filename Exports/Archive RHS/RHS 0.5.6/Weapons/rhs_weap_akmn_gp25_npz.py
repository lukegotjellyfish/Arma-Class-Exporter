rhs_weap_akmn_gp25_npz = {
    ...
    # Class: CfgWeapons|rhs_weap_akmn_gp25_npz|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 111.88,
        # Class: CfgWeapons|rhs_weap_akmn_gp25_npz|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_akmn_gp25_npz|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        },
        # Class: CfgWeapons|rhs_weap_akmn_gp25_npz|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
