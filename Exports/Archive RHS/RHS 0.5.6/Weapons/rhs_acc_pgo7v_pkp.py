rhs_acc_pgo7v_pkp = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_acc_pgo7v_pkp|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_pgo7v_pkp|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pgo7v_pkp|ItemInfo|OpticsModes|rhs_pgo7v_scope [Indent level: 3]
            "rhs_pgo7v_scope": {
                "opticsid": 2,
                "usemodeloptics": 1,
            ...
            # Class: CfgWeapons|rhs_acc_pgo7v_pkp|ItemInfo|OpticsModes|rhs_pgo7v_iron [Indent level: 3],
            "rhs_pgo7v_iron": {
