rhs_uniform_afghanka_winter_boots_vsr = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_boots_vsr_ca.paa",
    "displayname": "M88 Winter Sapogi (VSR 1)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_boots_vsr|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_boots_vsr_base",
        "uniformmodel": "-",
