rhs_uniform_afghanka_spetsodezhda = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_spetsodezhda_ca.paa",
    "displayname": "M88 (Spetsodezhda)",
    # Class: CfgWeapons|rhs_uniform_afghanka_spetsodezhda|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_spetsodezhda_base",
        "uniformmodel": "-",
