rhs_uniform_afghanka_winter_vsr_3 = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_winter_vsr_3_ca.paa",
    "displayname": "M88 Winter (VSR 3)",
    # Class: CfgWeapons|rhs_uniform_afghanka_winter_vsr_3|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_winter_vsr_3_base",
        "uniformmodel": "-",
