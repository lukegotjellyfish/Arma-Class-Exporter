rhs_weap_scarh_lb_folded_grip3 = {
    ...
    # Class: CfgWeapons|rhs_weap_SCARH_LB_Folded_grip3|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_SCARH_LB_Folded_grip3|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
