rhsusf_hgu56p = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_hgu56p_ca.paa",
    "displayname": "HGU-56/P (Olive)",
    "allowedfacewear": [],
    "scope": 2,
    "hiddenselections": ["camo","patches"],
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_olv_co.paa","|rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|Data|rhs_hgu56_patches_co.paa"],
    ...
    "model": "rhsusf|addons|rhsusf_infantry2|gear|head|hgu56|rhs_hgu56",
    # Class: CfgWeapons|rhsusf_hgu56p|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["camo","patches"],
        "mass": 40,
