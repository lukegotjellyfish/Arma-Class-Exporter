m24_bino_ard = {
    "scope": 1,
    "scopearsenal": 0,
    "displayname": "M24 Binoculars (ARD)",
    "descriptionshort": "Magnification 7X",
    "model": "rhsusf|addons|rhsusf_weapons3|misc|m24binocular|m24binocular_ARD.p3d",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_bino_m24p_ca.paa",
    "author": "Red Hammer Studios",
    "dlc": "RHS_USAF",
    # Class: CfgWeapons|rhsusf_bino_m24|Library [Indent level: 1],
    "library": {
        "libtextdesc": ""
    },
    "opticszoommin": 0.05,
    ...
    "opticszoominit": 0.05,
    "visionmode": ["Normal"],
    # Class: CfgWeapons|rhsusf_bino_m24|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 20
    },
