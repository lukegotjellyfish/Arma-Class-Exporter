rhs_weap_m27iar_bipod_acog_usmc_sup = {
    # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG3_USMC"
        },
        # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq16a"
        },
        # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhsusf_acc_nt4_black"
        },
        # Class: CfgWeapons|rhs_weap_m27iar_bipod_acog_usmc_sup|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
