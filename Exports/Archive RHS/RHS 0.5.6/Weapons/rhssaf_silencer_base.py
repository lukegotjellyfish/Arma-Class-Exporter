rhssaf_silencer_base = {
    ...
    "scope": 0,
    "scopecurator": 0,
    # Class: CfgWeapons|rhssaf_silencer_base|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 7,
        # Class: CfgWeapons|rhssaf_silencer_base|ItemInfo|MagazineCoef [Indent level: 2],
        "magazinecoef": {
            "initspeed": 1.01
        },
        # Class: CfgWeapons|rhssaf_silencer_base|ItemInfo|AmmoCoef [Indent level: 2],
        "ammocoef": {
            "hit": 1,
            "visiblefire": 0.2,
            "audiblefire": 0.4,
        ...
        # Class: CfgWeapons|rhssaf_silencer_base|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
            "dispersioncoef": "0.8f",
