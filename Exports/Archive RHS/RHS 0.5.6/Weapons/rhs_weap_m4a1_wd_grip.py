rhs_weap_m4a1_wd_grip = {
    ...
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|weapons|rhs_weap_m4a1_wd_grip_ca.paa",
    "handanim": ["OFP2_ManSkeleton","|rhsusf|addons|rhsusf_c_weapons|anims|rhs_hand_m16a4.rtm"],
    # Class: CfgWeapons|rhs_weap_m4a1_wd_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_wd_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
