rhs_weap_s25l = {
    "displayname": "S25L",
    "magazines": ["rhs_mag_o25l_s25l","rhs_mag_bd3_usk_a_o25l_s25l","rhs_mag_bd3_umk2a_o25l_s25l"],
    "cursor": "missile",
    "canlock": 2,
    "weaponlocksystem": 4,
    "weaponlockdelay": 0.5,
    "cmimmunity": 0.3,
    # Class: CfgWeapons|rhs_weap_s25l|EventHandlers [Indent level: 1],
    "eventhandlers": {
        # Class: CfgWeapons|rhs_weap_s25l|EventHandlers|RHS_KlenPS [Indent level: 2]
        "rhs_klenps": {
            "fired": "_this call rhs_fnc_klenpsGuide"
        }
    },
    "modes": ["AI_Burst","Burst","Single"],
    # Class: CfgWeapons|rhs_weap_s25|AI_Burst [Indent level: 1],
    "ai_burst": {
        "dispersion": 0.01,
        "displayname": "S25",
        "reloadtime": 0.15,
    ...
    # Class: CfgWeapons|rhs_weap_s25|Burst [Indent level: 1],
    "burst": {
        "dispersion": 0.01,
        "displayname": "S25",
        "reloadtime": 0.15,
    ...
    # Class: CfgWeapons|rhs_weap_s25|Single [Indent level: 1],
    "single": {
        "autofire": 0,
        "displayname": "S25",
        "reloadtime": 0.08,
