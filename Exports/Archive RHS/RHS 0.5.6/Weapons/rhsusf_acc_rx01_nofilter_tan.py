rhsusf_acc_rx01_nofilter_tan = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_RX01_NoFilter_tan_ca.paa",
    "dlc": "RHS_USAF",
    "author": "Red Hammer Studios",
    "displayname": "RX01 Tan (w/o Filter)",
    "model": "rhsusf|addons|rhsusf_weapons3|acc|scopes|RX01|rhs_reflexsight_nofilter_tan.p3d",
    "descriptionshort": "Collimator Sight<br />Magnification: 1x",
    "inertia": 0,
    "scope": 2,
    # Class: CfgWeapons|rhsusf_acc_compm4|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 0,
        "mass": 4,
        "optics": 1,
        "modeloptics": "A3|Weapons_F|empty",
        # Class: CfgWeapons|rhsusf_acc_compm4|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_compm4|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
