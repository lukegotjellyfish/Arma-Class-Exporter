rhs_uniform_afghanka_moldovan_ttsko_hot = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_moldovan_ttsko_hot_ca.paa",
    "displayname": "M88 (Moldovan TTsKO Hot)",
    # Class: CfgWeapons|rhs_uniform_afghanka_moldovan_ttsko_hot|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_moldovan_ttsko_hot_base",
        "uniformmodel": "-",
