rhsusf_acc_acog_anpvs27 = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_ACOG_anpvs27_ca.paa",
    "displayname": "M150 RCO + AN/PVS-27",
    "model": "rhsusf|addons|rhsusf_weapons|acc|scopes|pvs27|PVS_27_ACOG.p3d",
    "scope": 2,
    "author": "Red Hammer Studios",
    "weaponinfotype": "RscWeaponZeroing",
    # Class: CfgWeapons|rhsusf_acc_ACOG_anpvs27|ItemInfo [Indent level: 1],
    "iteminfo": {
        "optictype": 1,
        "mass": 10,
        ...
        # Class: CfgWeapons|rhsusf_acc_ACOG_anpvs27|ItemInfo|OpticsModes [Indent level: 2],
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_ACOG_anpvs27|ItemInfo|OpticsModes|elcan_nvg [Indent level: 3]
            "elcan_nvg": {
                "opticsid": 2,
                "usemodeloptics": 1,
