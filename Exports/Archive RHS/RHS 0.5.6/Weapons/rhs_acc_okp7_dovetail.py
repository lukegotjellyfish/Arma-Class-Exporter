rhs_acc_okp7_dovetail = {
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_okp7_dovetail_ca.paa",
    "scope": 2,
    "author": "Red Hammer Studios",
    "displayname": "OKP7",
    "model": "rhsafrf|addons|rhs_weapons2|acc|scopes|okp7|rhs_okp7_dovetail",
    "inertia": 0,
    # Class: CfgWeapons|rhs_acc_okp7_dovetail|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_okp7_dovetail|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_okp7_dovetail|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
            ...
            # Class: CfgWeapons|rhs_acc_okp7_dovetail|ItemInfo|OpticsModes|cowitness [Indent level: 3],
            "cowitness": {
                "memorypointcamera": "cowitness_ak74",
                "discretedistance": [100],
                "discretedistanceinitindex": 0,
                "cameradir": "",
                "opticsid": 1,
