rhs_uniform_afghanka_boots_moldovan_ttsko_blue = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_afghanka_boots_moldovan_ttsko_blue_ca.paa",
    "displayname": "M88 Sapogi (Moldovan TTsKO Blue)",
    # Class: CfgWeapons|rhs_uniform_afghanka_boots_moldovan_ttsko_blue|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_afghanka_boots_moldovan_ttsko_blue_base",
        "uniformmodel": "-",
