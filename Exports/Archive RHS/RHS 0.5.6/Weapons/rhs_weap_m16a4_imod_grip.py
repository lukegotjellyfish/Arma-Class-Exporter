rhs_weap_m16a4_imod_grip = {
    ...
    # Class: CfgWeapons|rhs_weap_m16a4_imod_grip|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 74.8,
    ...
    # Class: CfgWeapons|rhs_weap_m16a4_imod_grip|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m16a4_imod_grip|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
