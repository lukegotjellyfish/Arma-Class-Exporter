rhs_uniform_klmk_oversuit = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|uniform|rhs_uniform_klmk_oversuit_ca.paa",
    "displayname": "KLMK Oversuit",
    # Class: CfgWeapons|rhs_uniform_klmk_oversuit|ItemInfo [Indent level: 1],
    "iteminfo": {
        "uniformclass": "rhs_klmk_oversuit_base",
        "uniformmodel": "-",
