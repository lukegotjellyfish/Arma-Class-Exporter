rhs_weap_scar_base = {
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_Base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 73.04,
        "allowedslots": [901],
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_Base|Single [Indent level: 1],
    "single": {
    ...
    # Class: CfgWeapons|rhs_weap_SCAR_Base|FullAuto [Indent level: 1],
    "fullauto": {
        "sounds": ["StandardSound","SilencedSound"],
    ...
    "magazinewell": ["MX_65x39","MX_65x39_Large"],
