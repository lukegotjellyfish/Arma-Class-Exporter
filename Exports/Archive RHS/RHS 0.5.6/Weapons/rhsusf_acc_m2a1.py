rhsusf_acc_m2a1 = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_M2A1_ca.paa",
    "author": "Red Hammer Studios",
    "displayname": "M2A1 GL Sight",
    "model": "rhsusf|addons|rhsusf_weapons2|M32|rhs_m2a1",
    # Class: CfgWeapons|rhsusf_acc_M2A1|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_M2A1|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_M2A1|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "distancezoommin": 100,
                "distancezoommax": 100,
                "opticsid": 1,
