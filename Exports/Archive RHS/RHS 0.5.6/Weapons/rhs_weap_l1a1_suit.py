rhs_weap_l1a1_suit = {
    # Class: CfgWeapons|rhs_weap_l1a1_suit|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_l1a1_suit|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsgref_acc_l1a1_l2a2"
        },
        # Class: CfgWeapons|rhs_weap_l1a1_suit|LinkedItems|LinkedItemsMuzzle [Indent level: 2],
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
