rhs_fieldcap_m88_ttsko_back = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|headgear|rhs_fieldcap_m88_ttsko_ca.paa",
    "displayname": "Field Cap M88 (TTsKO/Back)",
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_infantry3|data|cap_afghan|cap_afghan_TTSKO_co.paa"],
