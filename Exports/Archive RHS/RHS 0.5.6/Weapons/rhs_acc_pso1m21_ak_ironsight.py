rhs_acc_pso1m21_ak_ironsight = {
    ...
    "scope": 1,
    "scopearsenal": 0,
    # Class: CfgWeapons|rhs_acc_pso1m21_ak_ironsight|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_pso1m21_ak_ironsight|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_pso1m21_ak_ironsight|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3]
            "rhs_1p29_iron": {
                "discretedistance": [440,100,200,300,400,500],
                "discretedistancecamerapoint": ["eye_ak","eye_ak_100","eye_ak_200","eye_ak_300","eye_ak_400","eye_ak_500"],
                "cameradir": "eye_ak_look",
                "distancezoommax": 420,
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
            ...
            # Class: CfgWeapons|rhs_acc_pso1m21_ak_ironsight|ItemInfo|OpticsModes|pso1_scope [Indent level: 3],
            "pso1_scope": {
                "discretedistance": [50,75,100,125,150,175,200,225,250,275,300,325,350,375,400],
                "discretedistanceinitindex": "(missionNameSpace getVariable ['rhs_acc_pso_index',3]) min 14 max 0",
                "distancezoommin": 50,
                "distancezoommax": 400,
                "opticsid": 2,
                "usemodeloptics": 1,
                "opticsppeffects": ["OpticsCHAbera1","OpticsBlur1","rhs_pso1_Blur"],
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|accessories|rhs_acc_pso1m21_ca.paa",
    "displayname": "PSO-1M2-1",
    "model": "rhsafrf|addons|rhs_weapons|acc|scopes|pso1m21|rhs_pso1m21",
    "weaponinfotype": "rhs_rscOptics_acc_pso11",
    "inertia": 0.2,
    "rhs_optic_ads": "rhs_acc_pso1m21_ads",
    "rhs_optic_ads_night": "rhs_acc_pso1m21_ads_night",
    "rhs_optic_ads_base": "rhs_acc_pso1m21",
    "dlc": "RHS_AFRF",
