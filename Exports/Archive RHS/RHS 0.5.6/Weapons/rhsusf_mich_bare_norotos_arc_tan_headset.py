rhsusf_mich_bare_norotos_arc_tan_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_mich_bare_norotos_arc_tan_headset_ca.paa",
    "scope": 1,
    "displayname": "MICH 2000 (Tan/Norotos/ARC/Headset)",
    "model": "rhsusf|addons|rhsusf_infantry|gear|head|mich_bare_01_nor1_arc_bowman",
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_infantry|gear|head|data|bare_mich_tan_norotos_arc_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|mich_acc_tan_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|ach_acc_tan_co.paa","|rhsusf|addons|rhsusf_infantry|gear|head|data|bowman_base_co.paa"],
    # Class: CfgWeapons|rhsusf_mich_bare_norotos_arc_tan_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
