rhsusf_acc_t1_low = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_T1_low_ca.paa",
    "author": "Red Hammer Studios",
    "displayname": "SU-278/PVS LT661",
    "model": "rhsusf|addons|rhsusf_weapons3|acc|scopes|T1|rhs_T1_l.p3d",
    "descriptionshort": "Collimator Sight<br />Magnification: 1x",
    "inertia": 0,
    # Class: CfgWeapons|rhsusf_acc_T1_low|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_T1_low|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_T1_low|ItemInfo|OpticsModes|ACO [Indent level: 3]
            "aco": {
                "distancezoommin": 100,
                "distancezoommax": 100,
                "opticsid": 1,
