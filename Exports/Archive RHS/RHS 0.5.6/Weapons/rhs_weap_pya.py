rhs_weap_pya = {
    ...
    # Class: CfgWeapons|rhs_weap_pya|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 18.86,
        "holsterscale": 1,
        # Class: CfgWeapons|rhs_weap_pya|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
    ...
    "magazines": ["rhs_mag_9x19_17","rhs_mag_9x19_7n31_17"],
