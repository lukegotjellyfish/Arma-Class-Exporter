rhs_mag_kh25ml = {
    # Ammo: CfgMagazines|rhs_mag_kh25ML|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_kh25ML",
        "weaponlocksystem": "4 + 16",
        # Class: CfgAmmo|rhs_ammo_kh25ml|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_kh25ml|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_kh25ml|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_kh25ml|Components|SensorsManagerComponent|Components|NVSensorComponent [Indent level: 4]
                    "nvsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_kh25ml|Components|SensorsManagerComponent|Components|NVSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 10000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_kh25ml|Components|SensorsManagerComponent|Components|NVSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 10000,
                            "objectdistancelimitcoef": 1,
                    ...
                    # Class: CfgAmmo|rhs_ammo_kh25ml|Components|SensorsManagerComponent|Components|LaserSensorComponent [Indent level: 4],
                    "lasersensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_kh25ml|Components|SensorsManagerComponent|Components|LaserSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 8000,
                            "maxrange": 8000,
                            "objectdistancelimitcoef": -1,
                        ...
                        # Class: CfgAmmo|rhs_ammo_kh25ml|Components|SensorsManagerComponent|Components|LaserSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 8000,
                            "maxrange": 8000,
                            "objectdistancelimitcoef": -1,
        ...
        # Ammo: CfgAmmo|rhs_ammo_kh25_base|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_kh25_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
        ...
        # Class: CfgAmmo|rhs_ammo_kh25_base|CamShakeExplode [Indent level: 1],
        "camshakeexplode": {
            "power": 102,
            "duration": 4.6,
            "frequency": 20,
        ...
        # Class: CfgAmmo|rhs_ammo_kh25_base|CamShakeHit [Indent level: 1],
        "camshakehit": {
            "power": 510,
            "duration": 1,
            "frequency": 20,
        ...
        # Class: CfgAmmo|Missile_AGM_01_F|Direct [Indent level: 1],
        "direct": {
        },
        "cost": 800,
        "airlock": 0,
    ...
    "count": 1,
    "initspeed": 0,
    "hardpoints": ["RHS_HP_KH25"],
    # Class: CfgMagazines|rhs_mag_kh25|mfdElements [Indent level: 1],
    "mfdelements": {
        # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_ammoname [Indent level: 2]
        "rhs_rus_ammoname": {
            # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_ammoname|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_ammoname|Draw [Indent level: 3],
            "draw": {
                "condition": "PylonSelected",
                "color": [0.15,1,0.15],
                "alpha": 1,
                # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_ammoname|Draw|PylonText1 [Indent level: 4],
                "pylontext1": {
                    "type": "text",
                    "source": "static",
                    "text": "Х25",
        ...
        # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_ammoname_right [Indent level: 2],
        "rhs_rus_ammoname_right": {
            # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_ammoname_right|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_ammoname_right|Draw [Indent level: 3],
            "draw": {
                "condition": "PylonSelected",
                "color": [0.15,1,0.15],
                "alpha": 1,
                # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_ammoname_right|Draw|PylonText1 [Indent level: 4],
                "pylontext1": {
                    "type": "text",
                    "source": "static",
                    "text": "Х25",
        ...
        # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_su25_box [Indent level: 2],
        "rhs_su25_box": {
            # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_su25_box|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_su25_box|Draw [Indent level: 3],
            "draw": {
                "condition": "1-pylonMagazineEmpty",
                "color": [0.15,1,0.15,1],
                "alpha": 0.22,
                # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_su25_box|Draw|Shape [Indent level: 4],
                "shape": {
                    "type": "polygon",
                    "width": 4,
                    "points": [[[[-0.022,-0.04],1],[[0.022,-0.04],1],[[0.022,0.04],1],[[-0.022,0.04],1]]]
                },
                # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_su25_box|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "PylonSelected*(PylonAmmoRelative>=0.001)",
                    "color": [0.58,0.23,0],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_su25_box|Draw|Selected|Shape [Indent level: 5],
                    "shape": {
                        "type": "polygon",
                        "width": 4,
        ...
        # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle [Indent level: 2],
        "rhs_rus_circle": {
            # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Bones [Indent level: 3]
            "bones": {
                # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Bones|Center [Indent level: 4]
                "center": {
                    "type": "fixed",
                    "pos": [0,0]
                }
            },
            # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw [Indent level: 3],
            "draw": {
                "color": [0.15,1,0.15,1],
                "alpha": 0.22,
                # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Default [Indent level: 4],
                "default": {
                    "condition": "1-PylonSelected-pylonMagazineEmpty",
                    "color": [1,1,1],
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Default|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "Х25",
                    ...
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Default|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0113139],1],["Center",[0.005,-0.00979781],1],["Center",[0.00866,-0.00565693],1],["Center",[0.01,0],1],["Center",[0.00866,0.00565693],1],["Center",[0.005,0.00979781],1],["Center",[0,0.0113139],1],["Center",[-0.005,0.00979781],1],["Center",[-0.00866,0.00565693],1],["Center",[-0.01,0],1],["Center",[-0.00866,-0.00565693],1],["Center",[-0.005,-0.00979781],1],["Center",[0,-0.0113139],1],[],["Center",[0.00707107,-0.00800011],1],["Center",[0.0176777,-0.0200003],1],[],["Center",[0.00707107,0.00800011],1],["Center",[0.0176777,0.0200003],1],[],["Center",[-0.00707107,0.00800011],1],["Center",[-0.0176777,0.0200003],1],[],["Center",[-0.00707107,-0.00800011],1],["Center",[-0.0176777,-0.0200003],1],[]]
                    }
                },
                # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "PylonSelected*(PylonAmmoRelative>=0.001)",
                    "color": [0.15,1,0.15,1],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Selected|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "Х25",
                    ...
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Selected|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0113139],1],["Center",[0.005,-0.00979781],1],["Center",[0.00866,-0.00565693],1],["Center",[0.01,0],1],["Center",[0.00866,0.00565693],1],["Center",[0.005,0.00979781],1],["Center",[0,0.0113139],1],["Center",[-0.005,0.00979781],1],["Center",[-0.00866,0.00565693],1],["Center",[-0.01,0],1],["Center",[-0.00866,-0.00565693],1],["Center",[-0.005,-0.00979781],1],["Center",[0,-0.0113139],1],[],["Center",[0.00707107,-0.00800011],1],["Center",[0.0176777,-0.0200003],1],[],["Center",[0.00707107,0.00800011],1],["Center",[0.0176777,0.0200003],1],[],["Center",[-0.00707107,0.00800011],1],["Center",[-0.0176777,0.0200003],1],[],["Center",[-0.00707107,-0.00800011],1],["Center",[-0.0176777,-0.0200003],1],[]]
                    },
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Selected|Polygon [Indent level: 5],
                    "polygon": {
                        "type": "polygon",
                        "width": 4,
                ...
                # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Empty [Indent level: 4],
                "empty": {
                    "condition": "pylonMagazineEmpty",
                    "color": [1,0,0,1],
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Empty|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "Х25",
                    ...
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Empty|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0113139],1],["Center",[0.005,-0.00979781],1],["Center",[0.00866,-0.00565693],1],["Center",[0.01,0],1],["Center",[0.00866,0.00565693],1],["Center",[0.005,0.00979781],1],["Center",[0,0.0113139],1],["Center",[-0.005,0.00979781],1],["Center",[-0.00866,0.00565693],1],["Center",[-0.01,0],1],["Center",[-0.00866,-0.00565693],1],["Center",[-0.005,-0.00979781],1],["Center",[0,-0.0113139],1],[],["Center",[0.00707107,-0.00800011],1],["Center",[0.0176777,-0.0200003],1],[],["Center",[0.00707107,0.00800011],1],["Center",[0.0176777,0.0200003],1],[],["Center",[-0.00707107,0.00800011],1],["Center",[-0.0176777,0.0200003],1],[],["Center",[-0.00707107,-0.00800011],1],["Center",[-0.0176777,-0.0200003],1],[]]
                    },
                    # Class: CfgMagazines|rhs_mag_kh25|mfdElements|rhs_rus_circle|Draw|Empty|Polygon [Indent level: 5],
                    "polygon": {
                        "type": "polygon",
                        "width": 4,
                        "points": [[["Center",1,[0,0],1],["Center",[0.00707107,-0.00800011],1],["Center",[0.01,4.94545e-010],1],["Center",[0.00707107,0.00800011],1]],[["Center",1,[0,0],1],["Center",[0.00707107,0.00800011],1],["Center",[-8.74228e-010,0.0113139],1],["Center",[-0.00707107,0.00800011],1]],[["Center",1,[0,0],1],["Center",[-0.00707107,0.00800011],1],["Center",[-0.01,-1.34917e-010],1],["Center",[-0.00707107,-0.00800011],1]],[["Center",1,[0,0],1],["Center",[-0.00707107,-0.00800011],1],["Center",[1.74846e-009,-0.0113139],1],["Center",[0.00707107,-0.00800011],1]]]
