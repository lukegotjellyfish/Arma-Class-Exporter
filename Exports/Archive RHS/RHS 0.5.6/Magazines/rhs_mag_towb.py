rhs_mag_towb = {
    "count": 1,
    "scope": 2,
    # Ammo: CfgMagazines|rhs_mag_2Rnd_TOWB|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_TOWB_AT",
        # Ammo: CfgAmmo|rhs_ammo_TOWB_AT|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_TOW_AT_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
