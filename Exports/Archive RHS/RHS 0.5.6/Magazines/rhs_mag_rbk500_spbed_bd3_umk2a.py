rhs_mag_rbk500_spbed_bd3_umk2a = {
    ...
    # Ammo: CfgMagazines|rhs_mag_rbk500_spbed|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_rbk500_spbed",
        "model": "rhsafrf|addons|rhs_airweapons|rhs_m_rbk500_spbed",
        # Ammo: CfgAmmo|rhs_ammo_rbk500_spbed|submunitionAmmo [Indent level: 1],
        "submunitionammo1": {
            "_dictAmmoName": "rhs_ammo_sub_spbed",
            # Ammo: CfgAmmo|rhs_ammo_sub_spbed|submunitionAmmo [Indent level: 1],
            "submunitionammo": {
            ...
            "eventhandlers": "rhs_ammo_sub_spbed_penetrator",
            "submunitiondirectiontype": "SubmunitionModelDirection",
            ...
            # Class: CfgAmmo|rhs_ammo_sub_spbed|Components [Indent level: 1],
            "components": {
                # Class: CfgAmmo|rhs_ammo_sub_spbed|Components|SensorsManagerComponent [Indent level: 2]
                "sensorsmanagercomponent": {
                    # Class: CfgAmmo|rhs_ammo_sub_spbed|Components|SensorsManagerComponent|Components [Indent level: 3]
                    "components": {
                        # Class: CfgAmmo|rhs_ammo_sub_spbed|Components|SensorsManagerComponent|Components|VisualSensorComponent [Indent level: 4]
                        "visualsensorcomponent": {
                            # Class: CfgAmmo|rhs_ammo_sub_spbed|Components|SensorsManagerComponent|Components|VisualSensorComponent|AirTarget [Indent level: 5]
                            "airtarget": {
                                "minrange": 500,
                                "maxrange": 2000,
                            ...
                            # Class: CfgAmmo|rhs_ammo_sub_spbed|Components|SensorsManagerComponent|Components|VisualSensorComponent|GroundTarget [Indent level: 5],
                            "groundtarget": {
                                "minrange": 500,
                                "maxrange": 2000,
                                "objectdistancelimitcoef": 1,
                        ...
                        # Class: CfgAmmo|rhs_ammo_sub_spbed|Components|SensorsManagerComponent|Components|IRSensorComponent [Indent level: 4],
                        "irsensorcomponent": {
                            # Class: CfgAmmo|rhs_ammo_sub_spbed|Components|SensorsManagerComponent|Components|IRSensorComponent|AirTarget [Indent level: 5]
                            "airtarget": {
                                "minrange": 500,
                                "maxrange": 500,
                                "objectdistancelimitcoef": -1,
                            ...
                            # Class: CfgAmmo|rhs_ammo_sub_spbed|Components|SensorsManagerComponent|Components|IRSensorComponent|GroundTarget [Indent level: 5],
                            "groundtarget": {
                                "minrange": 500,
                                "maxrange": 500,
                                "objectdistancelimitcoef": 1,
