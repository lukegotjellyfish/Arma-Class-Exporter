rhs_mag_9m17_mi24_2x = {
    ...
    "mass": 85,
    "weight": 85,
    "hardpoints": ["RHS_HP_9m17_Mi24"],
    "pylonweapon": "rhs_weap_2K8_launcher",
    "scope": 1,
    "displayname": "ATGM 9M17",
    "displaynameshort": "9M17",
    # Ammo: CfgMagazines|rhs_mag_9m17|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_9m17",
        # Ammo: CfgAmmo|rhs_ammo_9m17|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_9m17_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
        ...
        # Class: CfgAmmo|rhs_ammo_9m17|EventHandlers [Indent level: 1],
        "eventhandlers": {
            # Class: CfgAmmo|rhs_ammo_9m17|EventHandlers|RHS_Guidance [Indent level: 2]
            "rhs_guidance": {
