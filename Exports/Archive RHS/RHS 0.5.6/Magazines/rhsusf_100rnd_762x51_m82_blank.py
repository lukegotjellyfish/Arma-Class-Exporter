rhsusf_100rnd_762x51_m82_blank = {
    ...
    # Ammo: CfgMagazines|rhsusf_50Rnd_762x51_m82_blank|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_762x51_M82_blank",
        "hit": 7,
        "cost": 0.1,
        # Ammo: CfgAmmo|rhs_ammo_556x45_blank|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
