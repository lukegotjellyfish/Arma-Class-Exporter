rhs_mag_zt6 = {
    # Ammo: CfgMagazines|rhs_mag_zt6|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_zt6",
        # Ammo: CfgAmmo|rhs_ammo_zt6|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_ammo_zt6_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
        ...
        "thrusttime": 4.1,
        "thrust": 300,
        # Class: CfgAmmo|rhs_ammo_zt6|Direct [Indent level: 1],
        "direct": {
        },
        ...
        # Class: CfgAmmo|rhs_ammo_zt6|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_zt6|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_zt6|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_zt6|Components|SensorsManagerComponent|Components|LaserSensorComponent [Indent level: 4]
                    "lasersensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_zt6|Components|SensorsManagerComponent|Components|LaserSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 2000,
                            "maxrange": 10000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_zt6|Components|SensorsManagerComponent|Components|LaserSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 10000,
                            "maxrange": 10000,
                            "objectdistancelimitcoef": -1,
