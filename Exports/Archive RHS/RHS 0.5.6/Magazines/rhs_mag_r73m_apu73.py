rhs_mag_r73m_apu73 = {
    ...
    "hardpoints": ["RHS_HP_R73_APU73"],
    # Ammo: CfgMagazines|rhs_mag_R73M|ammo [Indent level: 1],
    "ammo": {
        ...
        # Ammo: CfgAmmo|rhs_ammo_r73|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        # Class: CfgAmmo|rhs_ammo_r73|Components [Indent level: 1],
        "components": {
            # Class: CfgAmmo|rhs_ammo_r73|Components|SensorsManagerComponent [Indent level: 2]
            "sensorsmanagercomponent": {
                # Class: CfgAmmo|rhs_ammo_r73|Components|SensorsManagerComponent|Components [Indent level: 3]
                "components": {
                    # Class: CfgAmmo|rhs_ammo_r73|Components|SensorsManagerComponent|Components|IRSensorComponent [Indent level: 4]
                    "irsensorcomponent": {
                        # Class: CfgAmmo|rhs_ammo_r73|Components|SensorsManagerComponent|Components|IRSensorComponent|AirTarget [Indent level: 5]
                        "airtarget": {
                            "minrange": 500,
                            "maxrange": 8000,
                        ...
                        # Class: CfgAmmo|rhs_ammo_r73|Components|SensorsManagerComponent|Components|IRSensorComponent|GroundTarget [Indent level: 5],
                        "groundtarget": {
                            "minrange": 500,
                            "maxrange": 4500,
                            "objectdistancelimitcoef": 1,
    ...
    # Class: CfgMagazines|rhs_mag_R73M|mfdElements [Indent level: 1],
    "mfdelements": {
        # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_ammoname [Indent level: 2]
        "rhs_rus_ammoname": {
            # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_ammoname|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_ammoname|Draw [Indent level: 3],
            "draw": {
                "condition": "PylonSelected",
                "color": [0.15,1,0.15],
                "alpha": 1,
                # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_ammoname|Draw|PylonText1 [Indent level: 4],
                "pylontext1": {
                    "type": "text",
                    "source": "static",
                    "text": "73М",
        ...
        # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_ammoname_right [Indent level: 2],
        "rhs_rus_ammoname_right": {
            # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_ammoname_right|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_ammoname_right|Draw [Indent level: 3],
            "draw": {
                "condition": "PylonSelected",
                "color": [0.15,1,0.15],
                "alpha": 1,
                # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_ammoname_right|Draw|PylonText1 [Indent level: 4],
                "pylontext1": {
                    "type": "text",
                    "source": "static",
                    "text": "73М",
        ...
        # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_su25_box [Indent level: 2],
        "rhs_su25_box": {
            # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_su25_box|Bones [Indent level: 3]
            "bones": {
            },
            # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_su25_box|Draw [Indent level: 3],
            "draw": {
                "condition": "1-pylonMagazineEmpty",
                "color": [0.15,1,0.15,1],
                "alpha": 0.22,
                # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_su25_box|Draw|Shape [Indent level: 4],
                "shape": {
                    "type": "polygon",
                    "width": 4,
                    "points": [[[[-0.022,-0.04],1],[[0.022,-0.04],1],[[0.022,0.04],1],[[-0.022,0.04],1]]]
                },
                # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_su25_box|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "PylonSelected*(PylonAmmoRelative>=0.001)",
                    "color": [0.58,0.23,0],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_su25_box|Draw|Selected|Shape [Indent level: 5],
                    "shape": {
                        "type": "polygon",
                        "width": 4,
        ...
        # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle [Indent level: 2],
        "rhs_rus_circle": {
            # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Bones [Indent level: 3]
            "bones": {
                # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Bones|Center [Indent level: 4]
                "center": {
                    "type": "fixed",
                    "pos": [0,0]
                }
            },
            # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw [Indent level: 3],
            "draw": {
                "color": [0.15,1,0.15,1],
                "alpha": 0.22,
                # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Default [Indent level: 4],
                "default": {
                    "condition": "1-PylonSelected-pylonMagazineEmpty",
                    "color": [1,1,1],
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Default|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "73М",
                    ...
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Default|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0141423],1],["Center",[0.00625,-0.0122473],1],["Center",[0.010825,-0.00707117],1],["Center",[0.0125,0],1],["Center",[0.010825,0.00707117],1],["Center",[0.00625,0.0122473],1],["Center",[0,0.0141423],1],["Center",[-0.00625,0.0122473],1],["Center",[-0.010825,0.00707117],1],["Center",[-0.0125,0],1],["Center",[-0.010825,-0.00707117],1],["Center",[-0.00625,-0.0122473],1],["Center",[0,-0.0141423],1],[],["Center",[0.00883884,-0.0100001],1],["Center",[0.0176777,-0.0200003],1],[],["Center",[0.00883884,0.0100001],1],["Center",[0.0176777,0.0200003],1],[],["Center",[-0.00883883,0.0100001],1],["Center",[-0.0176777,0.0200003],1],[],["Center",[-0.00883884,-0.0100001],1],["Center",[-0.0176777,-0.0200003],1],[]]
                    }
                },
                # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Selected [Indent level: 4],
                "selected": {
                    "condition": "PylonSelected*(PylonAmmoRelative>=0.001)",
                    "color": [0.15,1,0.15,1],
                    "alpha": 0.22,
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Selected|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "73М",
                    ...
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Selected|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0141423],1],["Center",[0.00625,-0.0122473],1],["Center",[0.010825,-0.00707117],1],["Center",[0.0125,0],1],["Center",[0.010825,0.00707117],1],["Center",[0.00625,0.0122473],1],["Center",[0,0.0141423],1],["Center",[-0.00625,0.0122473],1],["Center",[-0.010825,0.00707117],1],["Center",[-0.0125,0],1],["Center",[-0.010825,-0.00707117],1],["Center",[-0.00625,-0.0122473],1],["Center",[0,-0.0141423],1],[],["Center",[0.00883884,-0.0100001],1],["Center",[0.0176777,-0.0200003],1],[],["Center",[0.00883884,0.0100001],1],["Center",[0.0176777,0.0200003],1],[],["Center",[-0.00883883,0.0100001],1],["Center",[-0.0176777,0.0200003],1],[],["Center",[-0.00883884,-0.0100001],1],["Center",[-0.0176777,-0.0200003],1],[]]
                    },
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Selected|Polygon [Indent level: 5],
                    "polygon": {
                        "type": "polygon",
                        "width": 4,
                        "points": [[["Center",1,[0,0],1],["Center",[0.00883884,-0.0100001],1],["Center",[0.0125,6.18181e-010],1],["Center",[0.00883884,0.0100001],1]],[["Center",1,[0,0],1],["Center",[0.00883884,0.0100001],1],["Center",[-1.09278e-009,0.0141423],1],["Center",[-0.00883883,0.0100001],1]],[["Center",1,[0,0],1],["Center",[-0.00883883,0.0100001],1],["Center",[-0.0125,-1.68646e-010],1],["Center",[-0.00883884,-0.0100001],1]],[["Center",1,[0,0],1],["Center",[-0.00883884,-0.0100001],1],["Center",[2.18557e-009,-0.0141423],1],["Center",[0.00883884,-0.0100001],1]]]
                    }
                },
                # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Empty [Indent level: 4],
                "empty": {
                    "condition": "pylonMagazineEmpty",
                    "color": [1,0,0,1],
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Empty|PylonText1 [Indent level: 5],
                    "pylontext1": {
                        "type": "text",
                        "source": "static",
                        "text": "73М",
                    ...
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Empty|Shape [Indent level: 5],
                    "shape": {
                        "type": "line",
                        "width": 4,
                        "points": [["Center",[0,-0.0141423],1],["Center",[0.00625,-0.0122473],1],["Center",[0.010825,-0.00707117],1],["Center",[0.0125,0],1],["Center",[0.010825,0.00707117],1],["Center",[0.00625,0.0122473],1],["Center",[0,0.0141423],1],["Center",[-0.00625,0.0122473],1],["Center",[-0.010825,0.00707117],1],["Center",[-0.0125,0],1],["Center",[-0.010825,-0.00707117],1],["Center",[-0.00625,-0.0122473],1],["Center",[0,-0.0141423],1],[],["Center",[0.00883884,-0.0100001],1],["Center",[0.0176777,-0.0200003],1],[],["Center",[0.00883884,0.0100001],1],["Center",[0.0176777,0.0200003],1],[],["Center",[-0.00883883,0.0100001],1],["Center",[-0.0176777,0.0200003],1],[],["Center",[-0.00883884,-0.0100001],1],["Center",[-0.0176777,-0.0200003],1],[]]
                    },
                    # Class: CfgMagazines|rhs_mag_R73M|mfdElements|rhs_rus_circle|Draw|Empty|Polygon [Indent level: 5],
                    "polygon": {
                        "type": "polygon",
                        "width": 4,
                        "points": [[["Center",1,[0,0],1],["Center",[0.00883884,-0.0100001],1],["Center",[0.0125,6.18181e-010],1],["Center",[0.00883884,0.0100001],1]],[["Center",1,[0,0],1],["Center",[0.00883884,0.0100001],1],["Center",[-1.09278e-009,0.0141423],1],["Center",[-0.00883883,0.0100001],1]],[["Center",1,[0,0],1],["Center",[-0.00883883,0.0100001],1],["Center",[-0.0125,-1.68646e-010],1],["Center",[-0.00883884,-0.0100001],1]],[["Center",1,[0,0],1],["Center",[-0.00883884,-0.0100001],1],["Center",[2.18557e-009,-0.0141423],1],["Center",[0.00883884,-0.0100001],1]]]
