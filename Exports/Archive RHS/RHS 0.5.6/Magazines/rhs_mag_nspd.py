rhs_mag_nspd = {
    ...
    # Ammo: CfgMagazines|rhs_mag_nspd|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_nspd",
    ...
    "eventhandlers": "rhs_ammo_nspd",
    "displayname": "NSP-D",
    "displaynameshort": "Orange Smoke",
    "descriptionshort": "Type: Signal Grenade<br />Rounds: 1<br />Used in: Hand",
