rhs_mag_ofab250_bd3_umk2a = {
    ...
    "hardpoints": ["RHS_HP_FAB250_BD3_UMK2A"],
    # Ammo: CfgMagazines|rhs_mag_ofab250|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_ofab250",
    ...
    "eventhandlers": "rhs_ammo_ofab250",
    "displayname": "OFAB-250",
