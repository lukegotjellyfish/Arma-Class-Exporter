rhs_laserfcsmag = {
    "scope": 1,
    # Ammo: CfgMagazines|rhs_LaserFCSMag|ammo [Indent level: 1],
    "ammo": {
        ...
        "submunitioncount": 1,
        # Ammo: CfgAmmo|rhs_laserbeam_fcs|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
            "_dictAmmoName": "rhs_fakeAmmo",
