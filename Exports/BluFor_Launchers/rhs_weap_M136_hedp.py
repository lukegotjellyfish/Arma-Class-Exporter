rhs_weap_M136_hedp = {
    ...
    # Class: CfgWeapons\rhs_weap_M136_hedp\GunParticles,
    "GunParticles": {
        # Class: CfgWeapons\rhs_weap_M136_hedp\GunParticles\effect1
        "effect1": {
    ...
    "optics": 1,
    # Class: CfgWeapons\rhs_weap_M136\OpticsModes,
    "OpticsModes": {
        # Class: CfgWeapons\rhs_weap_M136\OpticsModes\ironsight
        "ironsight": {
            "opticsID": 2,
    ...
    # Class: CfgWeapons\rhs_weap_M136\Library,
    "Library": {
        "libTextDesc": "The M136 is a Swedish disposable anti-tank rocket launcher licensed and manufactured by the United States."
    },
    # Class: CfgWeapons\rhs_weap_M136\WeaponSlotsInfo,
    "WeaponSlotsInfo": {
        "allowedSlots": [901],
        "mass": 147.4,
        # Class: CfgWeapons\rhs_weap_M136\WeaponSlotsInfo\PointerSlot,
        "PointerSlot": {
            "linkProxy": "A3|data_f|proxies|weapon_slots|Side",
            "compatibleItems": ["rhs_acc_at4_handler"]
        }
    },
    # Class: CfgWeapons\rhs_weap_M136\ItemInfo,
    "ItemInfo": {
        "priority": 3,
        "RMBhint": "M136",
        "onHoverText": "M136"
    },
    # Class: CfgWeapons\rhs_weap_M136\Eventhandlers,
    "Eventhandlers": {
        # Class: CfgWeapons\rhs_weap_M136\Eventhandlers\RHS_DisposableWeapon
        "RHS_DisposableWeapon": {
            "fired": "_this call rhs_fnc_disposable;"
        }
    },
    "sounds": ["StandardSound"],
    # Class: CfgWeapons\rhs_weap_M136\StandardSound,
    "StandardSound": {
