rhs_weap_FFARLauncher = {
    ...
    "cursorSize": 0,
    # Class: CfgWeapons\rhs_weap_FFARLauncher\Far_AI,
    "Far_AI": {
        "displayName": "Hydra",
        "burst": 1,
        "reloadTime": 0.08,
        ...
        # Class: CfgWeapons\rhs_weap_FFARLauncher\Far_AI\StandardSound,
        "StandardSound": {
    ...
    # Class: CfgWeapons\rhs_weap_FFARLauncher\Burst,
    "Burst": {
        "displayName": "ALL",
        "burst": 1,
        "salvo": 2,
        ...
        "sounds": ["StandardSound"],
        # Class: CfgWeapons\rhs_weap_FFARLauncher\Burst\StandardSound,
        "StandardSound": {
            "weaponSoundEffect": "DefaultRifle",
            "begin1": ["rhsusf|addons|rhsusf_sounds|launcher_small|launcher_small_1",2.4,1,1400],
            "soundBegin": ["begin1",0.5,"begin2",0.5],
    ...
    # Class: CfgWeapons\rhs_weap_FFARLauncher\Single,
    "Single": {
        "displayName": "1",
        "autoFire": 0,
        "salvo": 1,
    ...
    # Class: CfgWeapons\rhs_weap_FFARLauncher\Two,
    "Two": {
        "displayName": "2",
        "salvo": 2,
        "burst": 1,
    ...
    # Class: CfgWeapons\rhs_weap_FFARLauncher\Four,
    "Four": {
        "displayName": "4",
        "salvo": 2,
        "burst": 2,
    ...
    # Class: CfgWeapons\rhs_weap_FFARLauncher\Eight,
    "Eight": {
        "displayName": "8",
        "burst": 8,
        "salvo": 2,
    ...
    # Class: CfgWeapons\rhs_weap_FFARLauncher\Twelve,
    "Twelve": {
        "displayName": "12",
        "burst": 12,
        "salvo": 2,
    ...
    # Class: CfgWeapons\rhs_weap_FFARLauncher\TwentyFour,
    "TwentyFour": {
        "displayName": "24",
        "burst": 24,
        "salvo": 2,
