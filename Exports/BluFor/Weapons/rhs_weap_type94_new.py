rhs_weap_type94_new = {
    ...
    # Class: CfgWeapons\rhs_weap_type94_new\WeaponSlotsInfo [Indent level: 1],
    "WeaponSlotsInfo": {
        "mass": 18.26,
        # Class: CfgWeapons\rhs_weap_type94_new\WeaponSlotsInfo\CowsSlot [Indent level: 2],
        "CowsSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
        ...
        # Class: CfgWeapons\rhs_weap_type94_new\WeaponSlotsInfo\MuzzleSlot [Indent level: 2],
        "MuzzleSlot": {
        },
        # Class: CfgWeapons\rhs_weap_type94_new\WeaponSlotsInfo\PointerSlot [Indent level: 2],
        "PointerSlot": {
        },
    ...
    "soundBegin": ["begin1",1],
    # Class: CfgWeapons\rhs_weap_pya\SAFE_PISTOL [Indent level: 1],
    "SAFE_PISTOL": {
        "showToPlayer": 0,
        "magazines": [],
        "displayName": "SAFE",
    ...
    "drySound": ["|jsrs_soundmod_complete|JSRS_Soundmod_Soundfiles|weapons|dry|rook40_dry.ogg",1.5,1,15],
    "reloadMagazineSound": ["|jsrs_soundmod_complete|JSRS_Soundmod_Soundfiles|weapons|reload|rook40_reload.ogg",2,1,35],
    "modes": ["Single"],
