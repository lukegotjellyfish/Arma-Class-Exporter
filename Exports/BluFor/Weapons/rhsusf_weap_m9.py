rhsusf_weap_m9 = {
    ...
    "dispersion": 0.02,
    "reloadTime": 0.13,
    # Class: CfgWeapons|rhsusf_weap_m9|WeaponSlotsInfo [Indent level: 1],
    "WeaponSlotsInfo": {
        "holsterScale": 0.92,
        "holsterOffset": "holster",
        "mass": 20.9,
        # Class: CfgWeapons|rhsusf_weap_m9|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "CowsSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
        ...
        # Class: CfgWeapons|rhsusf_weap_m9|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "MuzzleSlot": {
        },
        # Class: CfgWeapons|rhsusf_weap_m9|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "PointerSlot": {
        }
    },
    "muzzles": ["this","SAFE_PISTOL"],
    # Class: CfgWeapons|rhsusf_weap_m9|SAFE_PISTOL [Indent level: 1],
    "SAFE_PISTOL": {
        "magazines": [],
        "displayName": "SAFE",
