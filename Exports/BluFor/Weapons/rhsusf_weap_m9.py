rhsusf_weap_m9 = {
    ...
    "dispersion": 0.02,
    "reloadTime": 0.13,
    # Class: CfgWeapons\rhsusf_weap_m9\WeaponSlotsInfo,
    "WeaponSlotsInfo": {
        "holsterScale": 0.92,
        "holsterOffset": "holster",
        "mass": 20.9,
        # Class: CfgWeapons\rhsusf_weap_m9\WeaponSlotsInfo\CowsSlot,
        "CowsSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
        ...
        # Class: CfgWeapons\rhsusf_weap_m9\WeaponSlotsInfo\MuzzleSlot,
        "MuzzleSlot": {
        },
        # Class: CfgWeapons\rhsusf_weap_m9\WeaponSlotsInfo\PointerSlot,
        "PointerSlot": {
        }
    },
    "muzzles": ["this","SAFE_PISTOL"],
    # Class: CfgWeapons\rhsusf_weap_m9\SAFE_PISTOL,
    "SAFE_PISTOL": {
        "magazines": [],
        "displayName": "SAFE",
