rhs_weap_savz61 = {
    ...
    "drysound": ["|jsrs_soundmod_complete|JSRS_Soundmod_Soundfiles|weapons|dry|vector_dry.ogg",1.5,1,15],
    "reloadmagazinesound": ["|jsrs_soundmod_complete|JSRS_Soundmod_Soundfiles|weapons|reload|vector_reload.ogg",2,1,35],
    "changefiremodesound": ["|jsrs_soundmod_complete|JSRS_Soundmod_Soundfiles|weapons|noises|venim_firemode.ogg",1.25,1,25],
