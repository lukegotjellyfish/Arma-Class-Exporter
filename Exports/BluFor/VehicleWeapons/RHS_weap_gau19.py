RHS_weap_gau19 = {
    ...
    "weight": 60,
    # Class: CfgWeapons\RHS_weap_gau19\GunParticles,
    "GunParticles": {
        # Class: CfgWeapons\RHS_weap_gau19\GunParticles\effect1
        "effect1": {
            "effectName": "MachineGunCloud",
            "positionName": "z_gauL_muzzle",
            "directionName": "z_gauL_chamber"
        },
        # Class: CfgWeapons\RHS_weap_gau19\GunParticles\effect2,
        "effect2": {
            "positionName": "gauL_eject_pos",
            "directionName": "gauL_eject_dir",
            "effectName": "MachineGunEject"
        },
        # Class: CfgWeapons\RHS_weap_gau19\GunParticles\effect3,
        "effect3": {
            "positionName": "gauL_eject_pos",
            "directionName": "gauL_eject_dir",
    ...
    # Class: CfgWeapons\RHS_weap_gau19\LowROF,
    "LowROF": {
        "displayName": "GAU/LO",
        "sounds": ["StandardSound"],
        # Class: CfgWeapons\RHS_weap_gau19\LowROF\StandardSound,
        "StandardSound": {
    ...
    # Class: CfgWeapons\RHS_weap_gau19\close,
    "close": {
        "showToPlayer": 0,
        "burst": 15,
        "burstRangeMax": 25,
    ...
    # Class: CfgWeapons\RHS_weap_gau19\short,
    "short": {
        "burst": 21,
        "burstRangeMax": 31,
        "aiRateOfFire": 1,
    ...
    # Class: CfgWeapons\RHS_weap_gau19\medium,
    "medium": {
        "showToPlayer": 0,
        "soundBurst": 0,
        "burst": 10,
    ...
    # Class: CfgWeapons\RHS_weap_gau19\far,
    "far": {
        "burst": 10,
        "burstRangeMax": 20,
        "aiRateOfFire": 3,
    ...
    # Class: CfgWeapons\HMG_127\manual,
    "manual": {
        "displayName": "12.7mm HMG",
        "sounds": ["StandardSound"],
        # Class: CfgWeapons\HMG_127\manual\StandardSound,
        "StandardSound": {
