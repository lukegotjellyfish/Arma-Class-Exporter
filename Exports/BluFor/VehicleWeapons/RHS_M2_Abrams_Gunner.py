RHS_M2_Abrams_Gunner = {
    ...
    # Class: CfgWeapons\RHS_M2_Abrams_Gunner\GunParticles,
    "GunParticles": {
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\GunParticles\effect1
        "effect1": {
            "positionname": "usti hlavne4",
            "directionname": "konec hlavne4",
            "effectname": "MachineGunCloud"
        },
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\GunParticles\effect2,
        "effect2": {
            "positionname": "nabojnicestart2",
            "directionname": "nabojniceend2",
            "effectname": "MachineGunEject"
        },
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\GunParticles\effect3,
        "effect3": {
            "positionname": "nabojnicestart2",
            "directionname": "nabojniceend2",
            "effectname": "MachineGunCartridge2"
        },
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\GunParticles\RHSUSF_BarrelRefract,
    ...
    # Class: CfgWeapons\RHS_M2_Abrams_Gunner\manual,
    "manual": {
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\manual\StandardSound
        "StandardSound": {
    ...
    # Class: CfgWeapons\RHS_M2_Abrams_Gunner\close,
    "close": {
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\close\StandardSound
        "StandardSound": {
            "soundSetShot": ["RHSUSF_veh_m2_Shot_SoundSet","RHSUSF_veh_m2_int_Shot_SoundSet","RHSUSF_veh_rifle2_Tail_SoundSet"]
        },
        "aiBurstTerminable": 1,
    ...
    # Class: CfgWeapons\RHS_M2_Abrams_Gunner\short,
    "short": {
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\short\StandardSound
        "StandardSound": {
            "soundSetShot": ["RHSUSF_veh_m2_Shot_SoundSet","RHSUSF_veh_m2_int_Shot_SoundSet","RHSUSF_veh_rifle2_Tail_SoundSet"]
        },
        "aiBurstTerminable": 1,
    ...
    # Class: CfgWeapons\RHS_M2_Abrams_Gunner\medium,
    "medium": {
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\medium\StandardSound
        "StandardSound": {
            "soundSetShot": ["RHSUSF_veh_m2_Shot_SoundSet","RHSUSF_veh_m2_int_Shot_SoundSet","RHSUSF_veh_rifle2_Tail_SoundSet"]
        },
        "aiBurstTerminable": 1,
    ...
    # Class: CfgWeapons\RHS_M2_Abrams_Gunner\far,
    "far": {
        # Class: CfgWeapons\RHS_M2_Abrams_Gunner\far\StandardSound
        "StandardSound": {
            "soundSetShot": ["RHSUSF_veh_m2_Shot_SoundSet","RHSUSF_veh_m2_int_Shot_SoundSet","RHSUSF_veh_rifle2_Tail_SoundSet"]
        },
        "aiBurstTerminable": 1,
