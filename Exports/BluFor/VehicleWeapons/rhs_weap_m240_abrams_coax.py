rhs_weap_m240_abrams_coax = {
    # Class: CfgWeapons\rhs_weap_m240_abrams_coax\GunParticles [Indent level: 1]    "GunParticles": {        # Class: CfgWeapons\rhs_weap_m240_abrams_coax\GunParticles\effect1 [Indent level: 2]        "effect1": {            "positionname": "usti hlavne2",            "directionname": "konec hlavne2",            "effectname": "MachineGunCloud"
        }
    },
    "type": 1,
