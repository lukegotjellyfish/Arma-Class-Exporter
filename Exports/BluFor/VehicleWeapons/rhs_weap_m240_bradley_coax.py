rhs_weap_m240_bradley_coax = {
    ...
    # Class: CfgWeapons\rhs_weap_m240veh\manual,
    "manual": {
        "reloadTime": 0.0631,
        # Class: CfgWeapons\rhs_weap_m240veh\manual\StandardSound,
        "StandardSound": {
    ...
    # Class: CfgWeapons\rhs_weap_m240veh\close,
    "close": {
        "reloadTime": 0.0631,
        # Class: CfgWeapons\rhs_weap_m240veh\close\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHSUSF_veh_M240_Shot_SoundSet","RHSUSF_veh_M240_int_Shot_SoundSet","RHSUSF_VEH_MMG1_Tail_SoundSet"]
        },
        "aiBurstTerminable": 1,
    ...
    # Class: CfgWeapons\rhs_weap_m240veh\short,
    "short": {
        "reloadTime": 0.0631,
        # Class: CfgWeapons\rhs_weap_m240veh\short\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHSUSF_veh_M240_Shot_SoundSet","RHSUSF_veh_M240_int_Shot_SoundSet","RHSUSF_VEH_MMG1_Tail_SoundSet"]
        },
        "aiBurstTerminable": 1,
    ...
    # Class: CfgWeapons\rhs_weap_m240veh\medium,
    "medium": {
        "reloadTime": 0.0631,
        # Class: CfgWeapons\rhs_weap_m240veh\medium\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHSUSF_veh_M240_Shot_SoundSet","RHSUSF_veh_M240_int_Shot_SoundSet","RHSUSF_VEH_MMG1_Tail_SoundSet"]
        },
        "aiBurstTerminable": 1,
    ...
    # Class: CfgWeapons\rhs_weap_m240veh\far,
    "far": {
        "reloadTime": 0.0631,
        # Class: CfgWeapons\rhs_weap_m240veh\far\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHSUSF_veh_M240_Shot_SoundSet","RHSUSF_veh_M240_int_Shot_SoundSet","RHSUSF_VEH_MMG1_Tail_SoundSet"]
        },
        "aiBurstTerminable": 1,
    ...
    # Class: CfgWeapons\rhs_weap_m240veh\GunParticles,
    "GunParticles": {
        # Class: CfgWeapons\rhs_weap_m240veh\GunParticles\effect1
        "effect1": {
            "directionname": "kulas",
