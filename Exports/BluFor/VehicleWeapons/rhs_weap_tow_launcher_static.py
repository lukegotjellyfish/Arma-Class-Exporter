rhs_weap_tow_launcher_static = {
    ...
    "weaponLockSystem": 2,
    "cmImmunity": 0.5,
    # Class: CfgWeapons\missiles_titan\Player,
    "Player": {
        "textureType": "semi",
        "reloadTime": 1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons\missiles_titan\Player\StandardSound,
        "StandardSound": {
    ...
    # Class: CfgWeapons\missiles_titan\TopDown,
    "TopDown": {
        "textureType": "topDown",
    ...
    # Class: CfgWeapons\missiles_titan\StandardSound,
    "StandardSound": {
        "soundSetShot": ["Static_Launcher_Titan_ATAA_Shot_SoundSet","Static_Launcher_Titan_ATAA_Tail_SoundSet"]
    },
    "holdsterAnimValue": 1,
