rhs_weap_m134_minigun_2 = {
    # Class: CfgWeapons\rhs_weap_m134_minigun_2\GunParticles [Indent level: 1]    "GunParticles": {        # Class: CfgWeapons\rhs_weap_m134_minigun_2\GunParticles\SecondEffect [Indent level: 2]        "SecondEffect": {            "effectName": "MachineGun1",            "positionName": "muzzle_2",            "directionName": "chamber_2"
        },        # Class: CfgWeapons\rhs_weap_m134_minigun_2\GunParticles\effect2 [Indent level: 2],        "effect2": {            "positionName": "machinegun_eject_2_pos",            "directionName": "machinegun_eject_2_dir",            "effectName": "MachineGunCartridge"
        },        # Class: CfgWeapons\rhs_weap_m134_minigun_2\GunParticles\RHSUSF_BarrelRefract [Indent level: 2],        "RHSUSF_BarrelRefract": {            "positionName": "muzzle_2",            "directionName": "muzzle_2",            "effectName": "RHSUSF_BarrelRefractHeavy"
        }
    },
