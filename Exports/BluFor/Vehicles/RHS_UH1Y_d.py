RHS_UH1Y_d = {
    ...
    # Class: CfgVehicles\RHS_UH1Y\Attributes [Indent level: 1],
    "Attributes": {
        # Class: CfgVehicles\RHS_UH1Y\Attributes\ace_fastroping_equipFRIES [Indent level: 2]
        "ace_fastroping_equipFRIES": {
    ...
    # Class: CfgVehicles\RHS_UH1Y_base\textureSources [Indent level: 1],
    "textureSources": {
        # Class: CfgVehicles\RHS_UH1Y_base\textureSources\standard [Indent level: 2]
        "standard": {
