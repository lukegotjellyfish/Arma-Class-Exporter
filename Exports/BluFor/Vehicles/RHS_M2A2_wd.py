RHS_M2A2_wd = {
    ...
    # Class: CfgVehicles\RHS_M2A2\AnimationSources,
    "AnimationSources": {
        ...
        # Class: CfgVehicles\RHS_M2A2\AnimationSources\Select_TOW,
        "Select_TOW": {
            "author": "Red Hammer Studios",
        ...
        # Class: CfgVehicles\RHS_M2A2\AnimationSources\Select_Stinger,
        "Select_Stinger": {
            "initPhase": 1,
            "forceAnimatePhase": 1,
