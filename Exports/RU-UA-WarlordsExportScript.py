...
mod = "RU_vs_UA_Warlords"  # Folder name of RHS Export
...
# Export listed weapons with all the magazines they can use
allLoadouts = []  # List to append loadouts to
...
print(f"\nScript took {round((default_timer() - scriptStart), 3)}s")  # Print time taken for the entire script
