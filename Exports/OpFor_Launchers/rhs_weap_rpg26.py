rhs_weap_rpg26 = {
    ...
    # Class: CfgWeapons\rhs_weap_rpg26\GunParticles,
    "GunParticles": {
        # Class: CfgWeapons\rhs_weap_rpg26\GunParticles\effect1
        "effect1": {
    ...
    "optics": 1,
    # Class: CfgWeapons\rhs_weap_rpg26\OpticsModes,
    "OpticsModes": {
        # Class: CfgWeapons\rhs_weap_rpg26\OpticsModes\ironsight
        "ironsight": {
            "opticsID": 2,
        ...
        # Class: CfgWeapons\rhs_weap_rpg26\OpticsModes\ironsight2,
        "ironsight2": {
            "opticsID": 1,
    ...
    # Class: CfgWeapons\rhs_weap_rpg26\Library,
    "Library": {
        "libTextDesc": "The RPG-26 Aglen is a disposable anti-tank rocket launcher developed by the Soviet Union."
    },
    # Class: CfgWeapons\rhs_weap_rpg26\WeaponSlotsInfo,
    "WeaponSlotsInfo": {
        "allowedSlots": [901],
        "mass": 63.8
    },
    # Class: CfgWeapons\rhs_weap_rpg26\ItemInfo,
    "ItemInfo": {
        "priority": 3,
        "RMBhint": "RPG-26",
        "onHoverText": "RPG-26"
