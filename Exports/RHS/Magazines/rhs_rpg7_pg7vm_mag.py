rhs_rpg7_pg7vm_mag = {
    ...
    # Ammo: CfgMagazines|rhs_rpg7_PG7VM_mag|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_rpg7v2_pg7vm",
        "model": "rhsafrf|addons|rhs_weapons|rpg7|projectiles|pg7vm",
        "airfriction": 0.87,
        "sideairfriction": 0.175,
        # Ammo: CfgAmmo|rhs_rpg7v2_pg7vm|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
        ...
        "eventhandlers": "rhs_rpg7v2_pg7vm_penetrator",
        "submunitiondirectiontype": "SubmunitionModelDirection",
