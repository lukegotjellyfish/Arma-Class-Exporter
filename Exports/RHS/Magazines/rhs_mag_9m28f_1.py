rhs_mag_9m28f_1 = {
    # Ammo: CfgMagazines|rhs_mag_9m28f_1|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_9m28f",
        # Ammo: CfgAmmo|rhs_ammo_9m28f|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
