rhs_mag_9m521_1 = {
    # Ammo: CfgMagazines|rhs_mag_9m521_1|ammo [Indent level: 1],
    "ammo": {
        "_dictAmmoName": "rhs_ammo_9m521",
        # Ammo: CfgAmmo|rhs_ammo_9m521|submunitionAmmo [Indent level: 1],
        "submunitionammo": {
    ...
    "descriptionshort": "High explosive extended range 21kg warhead. 40km range",
    "scope": 2,
