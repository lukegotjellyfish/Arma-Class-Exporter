rhs_weap_fnfal_base = {
    ...
    # Class: CfgWeapons|rhs_weap_fnfal_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 95,
        # Class: CfgWeapons|rhs_weap_fnfal_base|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
        },
    ...
    # Class: CfgWeapons|rhs_weap_fnfal_base|Single [Indent level: 1],
    "single": {
    ...
    # Class: CfgWeapons|rhs_weap_fnfal_base|Single_AI [Indent level: 1],
    "single_ai": {
        "aiburstterminable": 1,
        "showtoplayer": 0,
        "burstrangemax": 3,
    ...
    # Class: CfgWeapons|rhs_weap_fnfal_base|single_medium_optics1 [Indent level: 1],
    ...
    # Class: CfgWeapons|rhs_weap_fnfal_base|single_far_optics2 [Indent level: 1],
    "single_far_optics2": {
        "requiredoptictype": 2,
        "minrange": 100,
        "minrangeprobab": 0.1,
