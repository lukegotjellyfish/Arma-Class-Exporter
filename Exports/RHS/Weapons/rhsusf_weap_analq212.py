rhsusf_weap_analq212 = {
    ...
    # Class: CfgWeapons|rhsusf_weap_ANALQ212|Burst1 [Indent level: 1],
    "burst1": {
        "displayname": "AN/ALQ-212",
        "reloadtime": 0.5,
        "burst": 120,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhsusf_weap_ANALQ144|Burst1|StandardSound [Indent level: 2],
        "standardsound": {
            "begin1": ["rhsafrf|addons|rhs_c_heavyweapons|Sound|ircm_on1",2,1,5],
            "begin2": ["rhsafrf|addons|rhs_c_heavyweapons|Sound|ircm_on2",2,1,5],
    ...
    "scope": 2,
    "magazines": ["rhsusf_mag_LWIRCM","rhsusf_mag_DIRCM"],
