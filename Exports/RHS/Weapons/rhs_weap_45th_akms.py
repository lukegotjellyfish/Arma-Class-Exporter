rhs_weap_45th_akms = {
    # Class: CfgWeapons|rhs_weap_45th_akms|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_45th_akms|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_pbs1"
        }
    ...
    # Recoil Class: recoil,
    # Class: CfgRecoils|rhs_recoil_akms [Indent level: 0],
    "recoil": {
    ...
    # Class: CfgWeapons|rhs_weap_akms|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 72.6,
