rhsgref_tacvest_erdl = {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|tacticalvest_erdl_co.paa"],
    "model": "A3|Characters_F|Common|equip_tacticalvest",
    # Class: CfgWeapons|rhsgref_TacVest_ERDL|ItemInfo [Indent level: 1],
    "iteminfo": {
        ...
        # Class: CfgWeapons|rhsgref_TacVest_ERDL|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|rhsgref_TacVest_ERDL|ItemInfo|HitpointsProtectionInfo|Neck [Indent level: 3]
            "neck": {
                "hitpointname": "HitNeck",
                "armor": 0,
                "passthrough": 0.9
            },
            # Class: CfgWeapons|rhsgref_TacVest_ERDL|ItemInfo|HitpointsProtectionInfo|Chest [Indent level: 3],
            "chest": {
                "hitpointname": "HitChest",
                "armor": 8,
                "passthrough": 0.5
            },
            # Class: CfgWeapons|rhsgref_TacVest_ERDL|ItemInfo|HitpointsProtectionInfo|Diaphragm [Indent level: 3],
            "diaphragm": {
                "hitpointname": "HitDiaphragm",
                "armor": 8,
                "passthrough": 0.5
            },
            # Class: CfgWeapons|rhsgref_TacVest_ERDL|ItemInfo|HitpointsProtectionInfo|Abdomen [Indent level: 3],
            "abdomen": {
                "hitpointname": "HitAbdomen",
                "armor": 3,
                "passthrough": 0.6
            },
            # Class: CfgWeapons|rhsgref_TacVest_ERDL|ItemInfo|HitpointsProtectionInfo|Body [Indent level: 3],
            "body": {
