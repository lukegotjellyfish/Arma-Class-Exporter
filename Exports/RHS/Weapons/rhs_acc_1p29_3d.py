rhs_acc_1p29_3d = {
    ...
    # Class: CfgWeapons|rhs_acc_1p29_3d|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_1p29_3d|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhs_acc_1p29_3d|ItemInfo|OpticsModes|rhs_1p29_scope [Indent level: 3]
            "rhs_1p29_scope": {
                "usemodeloptics": 0,
            ...
            # Class: CfgWeapons|rhs_acc_1p29_3d|ItemInfo|OpticsModes|rhs_1p29_iron [Indent level: 3],
            "rhs_1p29_iron": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
