rhs_weap_cmflarelauncher = {
    ...
    # Class: CfgWeapons|rhs_weap_CMFlareLauncher|AITimed [Indent level: 1],
    "aitimed": {
        "showtoplayer": 0,
        "minrange": 0,
        "maxrange": 3000,
    ...
    # Class: CfgWeapons|rhs_weap_CMFlareLauncher|LongTimed [Indent level: 1],
    "longtimed": {
