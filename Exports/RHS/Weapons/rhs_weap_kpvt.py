rhs_weap_kpvt = {
    ...
    "canlock": 0,
    "initspeed": 0,
    # Class: CfgWeapons|rhs_weap_kpvt|gunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_kpvt|gunParticles|effect1 [Indent level: 2]
        "effect1": {
            "effectname": "MachineGunCloud",
            "positionname": "Usti hlavne",
            "directionname": "Konec hlavne"
        },
        # Class: CfgWeapons|rhs_weap_kpvt|gunParticles|effect2 [Indent level: 2],
        "effect2": {
    ...
    # Class: CfgWeapons|rhs_weap_kpvt|manual [Indent level: 1],
    "manual": {
        "displayname": "KPVT",
        "autofire": 1,
        "reloadtime": 0.1,
    ...
    # Class: CfgWeapons|rhs_weap_kpvt|close [Indent level: 1],
    "close": {
        "showtoplayer": 0,
        "soundburst": 0,
        "burst": 8,
    ...
    # Class: CfgWeapons|rhs_weap_kpvt|short [Indent level: 1],
    "short": {
        "burst": 6,
        "burstrangemax": 14,
        "airateoffire": 2,
    ...
    # Class: CfgWeapons|rhs_weap_kpvt|medium [Indent level: 1],
    "medium": {
        "burst": 4,
        "burstrangemax": 9,
        "airateoffire": 3,
    ...
    # Class: CfgWeapons|rhs_weap_kpvt|far [Indent level: 1],
    "far": {
        "burst": 5,
        "burstrangemax": 9,
        "airateoffire": 5,
