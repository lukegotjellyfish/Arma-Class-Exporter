rhsusf_hgu56p_visor_saf = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_hgu56p_visor_saf_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_hgu56p_visor_saf|ItemInfo [Indent level: 1],
    "iteminfo": {
        "hiddenselections": ["camo","visor"],
