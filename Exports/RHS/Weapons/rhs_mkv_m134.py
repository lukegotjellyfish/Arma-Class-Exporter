rhs_mkv_m134 = {
    ...
    # Class: CfgWeapons|RHS_MKV_M134|gunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|RHS_MKV_M134|gunParticles|effect1 [Indent level: 2]
        "effect1": {
            "positionname": "m134_p_caseStart",
            "directionname": "m134_p_caseEnd",
            "effectname": "MachineGunCartridge1"
        },
        # Class: CfgWeapons|RHS_MKV_M134|gunParticles|effect2 [Indent level: 2],
        "effect2": {
