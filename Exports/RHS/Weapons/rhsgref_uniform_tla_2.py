rhsgref_uniform_tla_2 = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|uniform|rhsgref_uniform_TLA_2_ca.paa",
    "scope": 2,
    "dlc": "RHS_GREF",
    "displayname": "Guerilla Uniform (Tanoa Lizard/Olive)",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|data_tanoa|tla_igl_lizard_half_co.paa"],
    # Class: CfgWeapons|rhsgref_uniform_TLA_2|ItemInfo [Indent level: 1],
    "iteminfo": {
