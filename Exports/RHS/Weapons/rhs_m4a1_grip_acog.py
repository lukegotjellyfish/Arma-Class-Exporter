rhs_m4a1_grip_acog = {
    # Class: CfgWeapons|rhs_m4a1_grip_acog|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_m4a1_grip_acog|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_ACOG"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_acog|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
            "item": "rhsusf_acc_anpeq15_top"
        },
        # Class: CfgWeapons|rhs_m4a1_grip_acog|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
