rhs_weap_gsh301 = {
    ...
    "displayname": "GSh-30-1",
    "ballisticscomputer": "4 + 8",
    # Class: CfgWeapons|rhs_weap_gsh301|gunParticles [Indent level: 1],
    "gunparticles": {
        # Class: CfgWeapons|rhs_weap_gsh301|gunParticles|effect2 [Indent level: 2]
        "effect2": {
    ...
    "muzzles": ["this","rhs_burst_safe"],
    # Class: CfgWeapons|rhs_weap_gsh301|rhs_burst_safe [Indent level: 1],
    "rhs_burst_safe": {
        "displayname": "Burst Lock - GSh-30-1",
        "modes": ["manual"],
        # Class: CfgWeapons|rhs_weap_gsh301|rhs_burst_safe|manual [Indent level: 2],
        "manual": {
            "showtoplayer": 0,
            "autofire": 0,
            "maxrangeprobab": 0,
        ...
        # Class: CfgWeapons|rhs_weap_gsh30|gunParticles [Indent level: 1],
        "gunparticles": {
            # Class: CfgWeapons|rhs_weap_gsh30|gunParticles|effect2 [Indent level: 2]
            "effect2": {
                "directionname": "chamber_1_dir",
                "positionname": "chamber_1",
                "effectname": "RHS_AutoCannonFired"
            },
            # Class: CfgWeapons|rhs_weap_gsh30|gunParticles|effect1 [Indent level: 2],
            "effect1": {
        ...
        # Class: CfgWeapons|rhs_weap_gsh30|close [Indent level: 1],
        "close": {
            "airateoffire": 0.001,
            "airateoffiredistance": 50,
        ...
        # Class: CfgWeapons|rhs_weap_gsh30|short [Indent level: 1],
        "short": {
            "airateoffire": 0.25,
        ...
        # Class: CfgWeapons|rhs_weap_gsh30|medium [Indent level: 1],
        "medium": {
            "airateoffire": 3,
        ...
        # Class: CfgWeapons|rhs_weap_gsh30|far [Indent level: 1],
        "far": {
            "airateoffire": 4,
    ...
    # Class: CfgWeapons|rhs_weap_gsh301|manual [Indent level: 1],
    "manual": {
        "autofire": 1,
        "texturetype": "burst",
        "displayname": "GSh-30-1",
        ...
        "burst": 1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons|rhs_weap_gsh301|manual|StandardSound [Indent level: 2],
        "standardsound": {
            "soundsetshot": ["RHS_KPVT_Closure_SoundSet","RHS_KPVT_Shot_SoundSet","RHS_KPVT_Int_Shot_SoundSet","RHS_autocannon_Tail_SoundSet"]
        },
        "airateoffire": 0.5,
    ...
    # Class: CfgWeapons|rhs_weap_gsh301|close [Indent level: 1],
    "close": {
        "reloadtime": 0.04,
        "airateoffire": 0.001,
        "airateoffiredistance": 50,
    ...
    # Class: CfgWeapons|rhs_weap_gsh301|short [Indent level: 1],
    "short": {
        "reloadtime": 0.04,
        "airateoffire": 0.25,
        "airateoffiredistance": 300,
    ...
    # Class: CfgWeapons|rhs_weap_gsh301|medium [Indent level: 1],
    "medium": {
        "airateoffire": 3,
        "airateoffiredistance": 600,
        "burst": 7,
    ...
    # Class: CfgWeapons|rhs_weap_gsh301|far [Indent level: 1],
    "far": {
        "airateoffire": 4,
        "airateoffiredistance": 1000,
        "airateoffiredispersion": 3,
