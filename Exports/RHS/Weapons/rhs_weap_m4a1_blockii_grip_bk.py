rhs_weap_m4a1_blockii_grip_bk = {
    ...
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_bk|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_bk|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
            "item": "rhsusf_acc_grip1",
            "slot": "UnderBarrelSlot"
        }
    },
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_grip_bk|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 67.78,
