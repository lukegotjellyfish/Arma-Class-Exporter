rhs_6b5_officer_ttsko = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhs_6b5_officer_ttsko_ca.paa",
    "displayname": "6B5-19 TTsKO (Officer)",
    ...
    # Class: CfgWeapons|rhs_6b5_officer|ItemInfo [Indent level: 1],
    "iteminfo": {
