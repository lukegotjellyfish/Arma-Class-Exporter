rhsgref_helmet_pasgt_3color_desert_rhino = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_pasgt_3color_desert_rhino_ca.paa",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsgref_helmet_pasgt_3color_desert_rhino|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 40,
        "uniformmodel": "rhsgref|addons|rhsgref_infantry|gear_tanoa|head|pasgt_helmet_rhino",
        "modelsides": [3,1],
        "hiddenselections": ["camo"],
        # Class: CfgWeapons|H_HelmetB|ItemInfo|HitpointsProtectionInfo [Indent level: 2],
        "hitpointsprotectioninfo": {
            # Class: CfgWeapons|H_HelmetB|ItemInfo|HitpointsProtectionInfo|Head [Indent level: 3]
            "head": {
