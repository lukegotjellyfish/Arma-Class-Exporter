rhs_acc_dtk2 = {
    ...
    "displayname": "DTK-2",
    # Class: CfgWeapons|rhs_acc_dtk2|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhs_acc_dtk2|ItemInfo|AmmoCoef [Indent level: 2]
        "ammocoef": {
            "visiblefire": 0.8,
            "visiblefiretime": 0.8,
            "hit": 1,
        ...
        # Class: CfgWeapons|rhs_acc_dtk2|ItemInfo|MuzzleCoef [Indent level: 2],
        "muzzlecoef": {
