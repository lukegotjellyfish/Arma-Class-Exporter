rhsusf_acc_su230_3d = {
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|accessories|rhsusf_acc_su230_ca.paa",
    "author": "Red Hammer Studios",
    "rhs_optic_base": "rhsusf_acc_su230",
    "scope": 1,
    "weaponinfotype": "rhsusf_acc_su230_3d_handler",
    "scopearsenal": 0,
    # Class: CfgWeapons|rhsusf_acc_su230_base_3d|ItemInfo [Indent level: 1],
    "iteminfo": {
        # Class: CfgWeapons|rhsusf_acc_su230_base_3d|ItemInfo|OpticsModes [Indent level: 2]
        "opticsmodes": {
            # Class: CfgWeapons|rhsusf_acc_su230_base_3d|ItemInfo|OpticsModes|Elcan_x1 [Indent level: 3]
            "elcan_x1": {
                "opticsid": 1,
                "usemodeloptics": 0,
                "opticszoommin": 0.25,
            ...
            # Class: CfgWeapons|rhsusf_acc_su230_base_3d|ItemInfo|OpticsModes|Elcan_x4 [Indent level: 3],
            "elcan_x4": {
                "opticsid": 2,
                "usemodeloptics": 0,
                "opticsppeffects": ["OpticsCHAbera1","OpticsBlur1","rhs_su230_Blur"],
            ...
            # Class: CfgWeapons|rhsusf_acc_su230_base_3d|ItemInfo|OpticsModes|Elcan_iron [Indent level: 3],
            "elcan_iron": {
                "opticsid": 3,
                "usemodeloptics": 0,
                "opticsppeffects": [""],
    ...
    "dlc": "RHS_USAF",
    "displayname": "SU-230/PVS",
    "model": "rhsusf|addons|rhsusf_scopes|specter|rhs_su230",
