rhsgref_6b23_ttsko_mountain_officer = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Vests|rhsgref_6b23_ttsko_mountain_officer_ca.paa",
    "scope": 2,
    ...
    # Class: CfgWeapons|rhsgref_6b23_ttsko_mountain_officer|ItemInfo [Indent level: 1],
    "iteminfo": {
