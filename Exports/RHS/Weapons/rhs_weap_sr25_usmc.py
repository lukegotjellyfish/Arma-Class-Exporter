rhs_weap_sr25_usmc = {
    # Class: CfgWeapons|rhs_weap_sr25_usmc|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_sr25_usmc|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_premier"
        },
        # Class: CfgWeapons|rhs_weap_sr25_usmc|LinkedItems|LinkedItemsUnder [Indent level: 2],
        "linkeditemsunder": {
