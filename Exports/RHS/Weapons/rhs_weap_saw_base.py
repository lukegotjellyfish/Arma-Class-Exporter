rhs_weap_saw_base = {
    ...
    # Class: CfgWeapons|rhs_weap_saw_base|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 151.8,
        # Class: CfgWeapons|rhs_weap_saw_base|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
    ...
    # Class: CfgWeapons|rhs_weap_saw_base|FullAuto [Indent level: 1],
    "fullauto": {
        "reloadtime": 0.075,
