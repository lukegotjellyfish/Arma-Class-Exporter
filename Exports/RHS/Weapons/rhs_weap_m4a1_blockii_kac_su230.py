rhs_weap_m4a1_blockii_kac_su230 = {
    # Class: CfgWeapons|rhs_weap_m4a1_blockII_KAC_SU230|LinkedItems [Indent level: 1]
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_KAC_SU230|LinkedItems|LinkedItemsOptic [Indent level: 2]
        "linkeditemsoptic": {
            "slot": "CowsSlot",
            "item": "rhsusf_acc_su230"
        },
        # Class: CfgWeapons|rhs_weap_m4a1_blockII_KAC_SU230|LinkedItems|LinkedItemsAcc [Indent level: 2],
        "linkeditemsacc": {
            "slot": "PointerSlot",
