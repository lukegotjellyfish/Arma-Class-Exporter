rhs_item_flightrecorder = {
    ...
    # Class: CfgWeapons|rhs_item_flightrecorder|ItemInfo [Indent level: 1],
    "iteminfo": {
        "mass": 110,
        "type": 301,
        # Class: CfgWeapons|rhs_item_flightrecorder|ItemInfo|Pointer [Indent level: 2],
        "pointer": {
        },
        # Class: CfgWeapons|rhs_item_flightrecorder|ItemInfo|FlashLight [Indent level: 2],
        "flashlight": {
        },
        "scope": 0
    },
