rhsgref_helmet_m1942_heergreycover = {
    ...
    "picture": "rhsgref|addons|rhsgref_inventoryicons|data|Headgear|rhsgref_helmet_m1942_heergreycover_ca.paa",
    "displayname": "M42 Covered (Mouse Grey)",
    "scope": 2,
    "scopecurator": 2,
    "model": "rhsgref|addons|rhsgref_infantry|gear|Head|M1942_heercoversummer",
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_infantry|gear|Head|data|m1942cover_mousegrey_co.paa"],
    # Class: CfgWeapons|rhsgref_helmet_m1942_heergreycover|ItemInfo [Indent level: 1],
    "iteminfo": {
