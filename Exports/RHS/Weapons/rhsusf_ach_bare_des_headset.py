rhsusf_ach_bare_des_headset = {
    ...
    "dlc": "RHS_USAF",
    "picture": "rhsusf|addons|rhsusf_inventoryicons|data|headgear|rhsusf_ach_bare_des_headset_ca.paa",
    ...
    # Class: CfgWeapons|rhsusf_ach_bare_des_headset|ItemInfo [Indent level: 1],
    "iteminfo": {
