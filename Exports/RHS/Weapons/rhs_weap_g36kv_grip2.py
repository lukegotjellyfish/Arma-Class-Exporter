rhs_weap_g36kv_grip2 = {
    ...
    "scope": 1,
    "displayname": "HK G36KV (AFG)",
    "dexterity": 1.54958,
    "rhs_fold": "rhs_weap_g36kv_Folded_grip2",
    "handanim": ["OFP2_ManSkeleton","|rhssaf|addons|rhssaf_c_weapons|anims|rhs_hand_g36k_afg.rtm"],
    # Class: CfgWeapons|rhs_weap_g36kv_grip2|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_g36kv_grip2|LinkedItems|LinkedItemsUnder [Indent level: 2]
        "linkeditemsunder": {
