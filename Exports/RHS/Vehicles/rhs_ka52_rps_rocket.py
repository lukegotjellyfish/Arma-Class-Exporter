rhs_ka52_rps_rocket = {
    ...
    # Class: CfgVehicles|rhs_ka52_rps_rocket|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_ka52_rps_rocket|AnimationSources|hide_booster [Indent level: 2]
        "hide_booster": {
            "source": "user",
            "animperiod": 0.6,
            "initphase": 0
    ...
    "armor": 1e+011,
    # Class: CfgVehicles|rhs_ka52_rps_rocket|Eventhandlers [Indent level: 1],
    "eventhandlers": {
    ...
    "hideunitinfo": 1,
    "cargoaction": ["RHS_ka52_Pilot_Eject"],
    "hasdriver": 0,
    "weapons": [],
    "magazines": [],
    "fuelcapacity": 0,
    ...
    # Class: CfgVehicles|rhs_ka52_ejection_vest|Turrets [Indent level: 1],
    "turrets": {
    },
    # Class: CfgVehicles|rhs_ka52_ejection_vest|UserActions [Indent level: 1],
    "useractions": {
    },
    "slx_xeh_disabled": 1,
    "mapsize": 16,
    ...
    # Class: CfgVehicles|Car_F|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|Car_F|TransportItems|_xx_FirstAidKit [Indent level: 2]
        "_xx_firstaidkit": {
            "name": "FirstAidKit",
            "count": 1
        }
