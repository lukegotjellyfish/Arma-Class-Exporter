rhs_mig29sm_vvsc = {
    ...
    "texturelist": ["Green_camo",1,"Green_camo2",1,"Green_camo3",0.2,"Green_camo4",0.2,"Green_camo5",0.2,"Green_camo6",0.2,"Green_camo7",0.5,"Green_camo_kubinka",0.2],
    "rhs_decalparameters": ["['Number',[cRHSAIRMIG29NumberPlaces,cRHSAIRMIG29TailNumberPlaces, cRHSAIRMIG29TailTopNumberPlaces],[['AviaWhite','AviaRed','AviaBlue','AviaOrange','AviaWhiteShadow'],['AviaWhite','AviaYellow','Empty'],['AviaWhite','Empty']]]","['Label', cRHSAIRMIG29StarPlaces, 'Aviation', 2]","['Label', cRHSAIRMIG29TailPlaces, 'Mig29TailSign', 3]","['Label', cRHSAIRMIG29NosePlaces, 'Mig29NoseArt', 1]"],
    "side": 0,
    "crew": "rhs_pilot",
