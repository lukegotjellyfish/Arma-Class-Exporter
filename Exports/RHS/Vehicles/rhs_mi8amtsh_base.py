rhs_mi8amtsh_base = {
    ...
    # Class: CfgVehicles|rhs_mi8amtsh_base|Components [Indent level: 1],
    "components": {
        # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent [Indent level: 2]
        "transportpylonscomponent": {
            "uipicture": "rhsafrf|addons|rhs_a2port_air|data|loadouts|RHS_Mi8_EDEN_CA.paa",
            # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent|pylons [Indent level: 3],
            "pylons": {
                # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent|pylons|pylon1 [Indent level: 4]
                "pylon1": {
                ...
                # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent|pylons|pylon2 [Indent level: 4],
                "pylon2": {
                ...
                # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent|pylons|pylon3 [Indent level: 4],
                "pylon3": {
                ...
                # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent|pylons|pylon4 [Indent level: 4],
                "pylon4": {
                ...
                # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent|pylons|pylon5 [Indent level: 4],
                "pylon5": {
                ...
                # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent|pylons|pylon6 [Indent level: 4],
                "pylon6": {
                ...
                # Class: CfgVehicles|rhs_mi8amtsh_base|Components|TransportPylonsComponent|pylons|cmDispenser [Indent level: 4],
                "cmdispenser": {
