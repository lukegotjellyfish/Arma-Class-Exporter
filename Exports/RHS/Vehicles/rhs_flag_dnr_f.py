rhs_flag_dnr_f = {
    ...
    "scope": 2,
    "displayname": "Flag (DNR)",
    # Class: CfgVehicles|rhs_Flag_DNR_F|EventHandlers [Indent level: 1],
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '|rhsafrf|addons|rhs_main|data|Flag_dnr_CO.paa'"
    },
    "scopecurator": 2,
