rhs_m2a2_base = {
    ...
    "hiddenselectionstextures": ["|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|base_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|a3_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|ultralp_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|base_co.paa","|rhsusf|addons|rhsusf_a2port_armor|m2a2_bradley|data|base_co.paa"],
    ...
    # Class: CfgVehicles|APC_Tracked_03_base_F|Damage [Indent level: 1],
    "damage": {
        "tex": [],
    ...
    # Class: CfgVehicles|APC_Tracked_03_base_F|AnimationSources [Indent level: 1],
    "animationsources": {
    ...
    # Class: CfgVehicles|APC_Tracked_03_base_F|Library [Indent level: 1],
    "library": {
