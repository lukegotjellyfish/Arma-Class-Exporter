rhsgref_ins_pack_demo = {
    ...
    # Class: CfgVehicles|rhsgref_ins_pack_demo|TransportItems [Indent level: 1],
    "transportitems": {
        # Class: CfgVehicles|rhsgref_ins_pack_demo|TransportItems|_xx_DemoCharge_Remote_Mag [Indent level: 2]
        "_xx_democharge_remote_mag": {
            "name": "DemoCharge_Remote_Mag",
            "count": 1
        },
        # Class: CfgVehicles|rhsgref_ins_pack_demo|TransportItems|_xx_rhs_mine_tm62m_mag [Indent level: 2],
        "_xx_rhs_mine_tm62m_mag": {
            "name": "rhs_mine_tm62m_mag",
            "count": 1
        },
        # Class: CfgVehicles|rhsgref_ins_pack_demo|TransportItems|_xx_rhs_mine_pmn2_mag [Indent level: 2],
