rhsusf_m1045_w_s = {
    ...
    # Class: CfgVehicles|rhsusf_m1045_w_s|Exhausts [Indent level: 1],
    "exhausts": {
        # Class: CfgVehicles|rhsusf_m1045_w_s|Exhausts|exhaust1 [Indent level: 2]
        "exhaust1": {
            "position": "exhaust2_1",
    ...
    # Class: CfgVehicles|rhsusf_m1045_w_s|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsusf_m1045_w_s|AnimationSources|hide_snorkel [Indent level: 2]
        "hide_snorkel": {
            "initphase": 0,
