rhsgref_ins_kraz255b1_fuel = {
    ...
    "hiddenselectionstextures": ["rhsgref|addons|rhsgref_vehicles_ret|data|chdkz|kraz255b1_chdkz_co.paa","rhsafrf|addons|rhs_kraz255|data|kol255_co.paa","rhsgref|addons|rhsgref_vehicles_ret|data|chdkz|tz8_chdkz_co.paa"],
    "texturelist": ["CHDKZ",1],
    "picture": "rhsafrf|addons|rhs_kraz255|pictures|rhs_kraz255b1_fuel_ca.paa",
    "displayname": "TZ-8-255B1",
    "transportfuel": 10000,
    "supplyradius": 9.5,
    # Class: CfgVehicles|rhs_kraz255b1_fuel_base|textureSources [Indent level: 1],
    "texturesources": {
        # Class: CfgVehicles|rhs_kraz255b1_fuel_base|textureSources|Standard [Indent level: 2]
        "standard": {
            "author": "Red Hammer Studios",
            "displayname": "Standard",
            "textures": ["rhsafrf|addons|rhs_kraz255|data|kraz255b1_co.paa","rhsafrf|addons|rhs_kraz255|data|kol255_co.paa","rhsafrf|addons|rhs_kraz255|data|tz8_co.paa"],
            "factions": []
        },
        # Class: CfgVehicles|rhs_kraz255b1_fuel_base|textureSources|CHDKZ [Indent level: 2],
        "chdkz": {
            "displayname": "CHDKZ",
            "textures": ["rhsgref|addons|rhsgref_vehicles_ret|data|chdkz|kraz255b1_chdkz_co.paa","rhsafrf|addons|rhs_kraz255|data|kol255_co.paa","rhsgref|addons|rhsgref_vehicles_ret|data|chdkz|tz8_chdkz_co.paa"],
            "factions": []
        }
    },
    # Class: CfgVehicles|rhs_kraz255b1_fuel_base|Damage [Indent level: 1],
    "damage": {
        "tex": [],
        "mat": ["rhsafrf|addons|rhs_kraz255|data|kraz255b1.rvmat","rhsafrf|addons|rhs_kraz255|data|kraz255b1_dam.rvmat","rhsafrf|addons|rhs_kraz255|data|kraz255_destr.rvmat","rhsafrf|addons|rhs_kraz255|data|kol255.rvmat","rhsafrf|addons|rhs_kraz255|data|kol255_dam.rvmat","rhsafrf|addons|rhs_kraz255|data|kraz255_destr.rvmat","rhsafrf|addons|rhs_kraz255|data|kuzov_255.rvmat","rhsafrf|addons|rhs_kraz255|data|kuzov_255_dam.rvmat","rhsafrf|addons|rhs_kraz255|data|kraz255_destr.rvmat","rhsafrf|addons|rhs_kraz255|data|win_int.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","rhsafrf|addons|rhs_kraz255|data|win.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","a3|data_f|glass_veh_armored_damage.rvmat","rhsafrf|addons|rhs_kraz255|data|tz8.rvmat","rhsafrf|addons|rhs_kraz255|data|tz8_dam.rvmat","rhsafrf|addons|rhs_kraz255|data|kraz255_destr.rvmat"]
    },
    # Class: CfgVehicles|rhs_kraz255b1_fuel_base|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhs_kraz255b1_fuel_base|AnimationSources|kraz_fuel [Indent level: 2]
        "kraz_fuel": {
            "source": "user",
            "initphase": 0,
            "animperiod": 0
        },
        # Class: CfgVehicles|rhs_kraz255b1_fuel_base|AnimationSources|kraz_pmp [Indent level: 2],
        "kraz_pmp": {
            "source": "user",
            "initphase": 1,
            "animperiod": 0
        },
        # Class: CfgVehicles|rhs_kraz255b1_fuel_base|AnimationSources|kraz_bmkt [Indent level: 2],
        "kraz_bmkt": {
            "source": "user",
            "initphase": 1,
            "animperiod": 0
        },
        # Class: CfgVehicles|rhs_kraz255b1_fuel_base|AnimationSources|kraz_tools [Indent level: 2],
        "kraz_tools": {
            "source": "user",
            "initphase": 0,
            "animperiod": 0
        },
        # Class: CfgVehicles|rhs_kraz255b1_fuel_base|AnimationSources|kraz_cargo [Indent level: 2],
        "kraz_cargo": {
            "source": "user",
            "initphase": 1,
            "animperiod": 0
