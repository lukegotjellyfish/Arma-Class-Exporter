rhsgref_ins_g_uaz_ags = {
    ...
    # Class: CfgVehicles|rhsgref_ins_g_uaz_ags|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_g_uaz_ags|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
        ...
        # Class: CfgVehicles|rhsgref_ins_g_uaz_ags|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
    ...
    "editorpreview": "rhsgref|addons|rhsgref_editorPreviews|data|rhsgref_ins_uaz_ags.paa",
    # Class: CfgVehicles|rhsgref_ins_uaz_ags|AnimationSources [Indent level: 1],
    "animationsources": {
        # Class: CfgVehicles|rhsgref_ins_uaz_ags|AnimationSources|light_hide [Indent level: 2]
        "light_hide": {
            "source": "user",
            "mass": 1,
            "initphase": 1,
