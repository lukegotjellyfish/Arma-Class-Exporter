rhs_btr60_vdv = {
    ...
    "rhs_decalparameters": ["['Number', cBTR3NumberPlaces, 'Default']","['Label', cBTRBackArmSymPlaces, 'Army',2]","['Label', cBTRPlnSymPlaces, 'Platoon',11]"],
    "scope": 2,
    "dlc": "RHS_AFRF",
    "category": "Armored",
    "insidesoundcoef": 0.8,
    ...
    "hiddenselectionstextures": ["rhsafrf|addons|rhs_a2port_armor|Data|btr60_body_co.paa","rhsafrf|addons|rhs_a2port_armor|data|btr60_details_co.paa","","rhsafrf|addons|rhs_btr70|habar|data|sa_gear_02_co.paa","rhsafrf|addons|rhs_btr70|habar|data|sa_gear_02_co.paa"],
