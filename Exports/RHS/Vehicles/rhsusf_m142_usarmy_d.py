rhsusf_m142_usarmy_d = {
    ...
    "hiddenselectionstextures": ["rhsusf|addons|rhsusf_HIMARS|data|M142_Cab_D_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Rear_D_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Chassis_D_co.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Wheel_CO.paa","rhsusf|addons|rhsusf_HIMARS|data|M142_Int_CO.paa"],
    "scope": 2,
