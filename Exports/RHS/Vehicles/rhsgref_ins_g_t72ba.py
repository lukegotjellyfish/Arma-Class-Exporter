rhsgref_ins_g_t72ba = {
    ...
    # Class: CfgVehicles|rhsgref_ins_g_t72ba|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_g_t72ba|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            # Class: CfgVehicles|rhsgref_ins_g_t72ba|Turrets|MainTurret|Turrets [Indent level: 3]
            "turrets": {
                # Class: CfgVehicles|rhsgref_ins_g_t72ba|Turrets|MainTurret|Turrets|CommanderOptics [Indent level: 4]
                "commanderoptics": {
                    "gunnertype": "rhsgref_ins_g_crew",
                    "lodturnedout": 1200,
                    "body": "obsTurret",
                    "gun": "obsGun",
                ...
                # Class: CfgVehicles|rhsgref_ins_g_t72ba|Turrets|MainTurret|Turrets|CommanderMG [Indent level: 4],
                "commandermg": {
