rhsgref_ins_uaz_ags = {
    ...
    # Class: CfgVehicles|rhsgref_ins_uaz_ags|Turrets [Indent level: 1],
    "turrets": {
        # Class: CfgVehicles|rhsgref_ins_uaz_ags|Turrets|MainTurret [Indent level: 2]
        "mainturret": {
            "gunnertype": "rhsgref_ins_rifleman_aksu",
        ...
        # Class: CfgVehicles|rhsgref_ins_uaz_ags|Turrets|CargoTurret_01 [Indent level: 2],
        "cargoturret_01": {
