d = {
    ...
    "hiddenselectionstextures": [
        "a3/Characters_F_Enoch/Headgear/data/h_helmetaggressor_01_RUkhk_co.paa"
    ],
    ...
    "opticszoommax": 1.25,
    "opticszoommin": 0.25,
    "picture": "a3/Characters_F_Enoch/Headgear/data/UI/icon_H_HelmetAggressor_cover_F_CA.paa",
    "primary": 10,
    "recoil": [],
    "reloadaction": "",
    "reloadmagazinesound": [
