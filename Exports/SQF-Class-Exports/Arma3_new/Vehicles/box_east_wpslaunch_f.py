d = {
    "_generalmacro": "Box_East_WpsLaunch_F",
    "access": 0,
    "accuracy": 0.2,
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Box_East_WpsLaunch_F.jpg",
    "ejectdeadcargo": 0,
    "ejectdeaddriver": 0,
    "emptysound": [
        "",
    ...
    "transportweapons": {
        "_xx_launch_o_titan_f": {
            "count": 1,
            "weapon": "launch_O_Titan_F"
        },
        "_xx_launch_o_titan_short_f": {
            "count": 1,
            "weapon": "launch_O_Titan_short_F"
        },
        "_xx_launch_o_vorona_brown_f": {
            "count": 1,
