d = {
    ...
    "attributes": {
        "allowedobjectclassname": {
            "control": "edit",
            "defaultvalue": "Building,House",
            "displayname": "Allowed object class name / type.",
            "expression": "_this setVariable [`AllowedObjectClassName`, _value]",
            "property": "AllowedObjectClassName",
            "typename": "STRING"
        },
        "canbecompletedwithoutassigning": {
            "control": "checkbox",
            "defaultvalue": "true",
            "displayname": "Created at Start",
            "expression": "_this setVariable [`canBeCompletedWithoutAssigning`, _value]",
            "property": "canBeCompletedWithoutAssigning",
            "tooltip": "Can be completed without assigning \u2013 it is created at start.",
            "typename": "BOOL"
        },
        "checkbox": {
            "control": "Checkbox",
        ...
        "editorbuildingnames": {
            ...
            "defaultvalue": "",
            "displayname": "Allowed object class name / type.",
            "expression": "_this setVariable [`editorBuildingNames`, _value]",
            "property": "editorBuildingNames",
            "typename": "STRING"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "onlyoneobject": {
            "control": "checkbox",
            "defaultvalue": "false",
            "displayname": "One object to completion",
            "expression": "_this setVariable [`onlyOneObject`, _value]",
            "property": "onlyOneObject",
            "tooltip": "Only one building is needed to be destroyed.",
            "typename": "BOOL"
        },
        "showsmartmarker": {
            "control": "checkbox",
            "defaultvalue": "true",
            "displayname": "Show Smart Marker",
            "expression": "_this setVariable [`showSmartMarker`, _value]",
            "property": "showSmartMarker",
            "tooltip": "Whether the Smart Marker should be shown when the task is assigned.",
            "typename": "BOOL"
        },
        "tasktemplate": {
            "control": "edit",
            "defaultvalue": "DestroyQuestTemplate",
            "displayname": "Task Template",
            "expression": "_this setVariable [`TaskTemplate`, _value]",
    ...
    "detectskill": 20,
    "displayname": "Old Man Destroy Quest Objects",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_ModuleQuest_destroyObject",
    "fxexplo": {
        "access": 1
    },
    "getinaction": "",
    ...
    "icon": "A3/Ui_f/data/IGUI/Cfg/simpleTasks/types/destroy_ca.paa",
    ...
    "moduledescription": {
        ...
        "description": "Task system module. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
    ...
    "portrait": "A3/Ui_f/data/IGUI/Cfg/simpleTasks/types/destroy_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
