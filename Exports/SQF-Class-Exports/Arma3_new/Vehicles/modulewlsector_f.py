d = {
    ...
    "attributes": {
        "border": {
            ...
            "property": "ModuleWLSector_F_Border",
        ...
        "fasttravelenabled": {
            ...
            "tooltip": "Ability to fast travel to this sector.",
            "typename": "BOOL"
        },
        "funds": {
            "control": "Edit",
        ...
        "side": {
            ...
            "tooltip": "Default means Independents, unless forced progress is used in the Init module.",
            "typename": "NUMBER",
            "values": {
                "blufor": {
                    "name": "BLUFOR",
    ...
    "moduledescription": {
        ...
        "description": "Synchronize Sector modules with Base modules to create a network.",
        "direction": 0,
