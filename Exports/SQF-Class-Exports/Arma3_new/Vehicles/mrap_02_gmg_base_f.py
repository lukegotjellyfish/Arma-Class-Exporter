d = {
    "_generalmacro": "MRAP_02_gmg_base_F",
    ...
    "damage": {
        "mat": [
            ...
            "A3/Data_F/Glass_veh_armored_damage.rvmat",
            "A3/Data_F/Glass_veh_armored_damage.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_ext_01.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_ext_01_damage.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_ext_01_destruct.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_ext_02.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_ext_02_damage.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_ext_02_destruct.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_base.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_base_damage.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_base_destruct.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_board.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_board_damage.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_board_destruct.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_base_VP.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_base_damage.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_base_destruct.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_board_VP.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_board_damage.rvmat",
            "A3/Soft_F/MRAP_02/Data/MRAP_02_int_board_destruct.rvmat",
    ...
    "faction": "Default",
    "features": "Randomization: No\t\t\t\t\t\t<br />Camo selections: 2 - the body, wheels and accessories, turret\t\t\t\t\t\t<br />Script door sources: Door_LF, Door_RF, Door_LB, Door_RB, Door_rear\t\t\t\t\t\t<br />Script animations: None\t\t\t\t\t\t<br />Executed scripts: None\t\t\t\t\t\t<br />Firing from vehicles: No\t\t\t\t\t\t<br />Slingload: Slingloadable\t\t\t\t\t\t<br />Cargo proxy indexes: 1 to 3",
    "featuretype": 0,
    "fireresistance": 10,
    "forcehidedriver": 0,
    "formationtime": 5,
    ...
    "icon": "A3/soft_f/MRAP_02/Data/UI/map_MRAP_02_RCWS_CA.paa",
    "idlerpm": 1000,
    ...
    "library": {
        "libtextdesc": "The Ifrit is a new Mine-Resistant Ambush Protected (MRAP) vehicle designed and manufactured in Russia. Its strengths lie in reliability in extreme weather conditions and crew protection, but its manufacturing costs are somewhat higher compared to other MRAPs. The Ifrit can be fitted with a RCWS turret and armed with a 12.7 mm heavy machine gun or a 40 mm grenade launcher."
    },
    ...
    "model": "A3/soft_f/MRAP_02/MRAP_02_gmg_F",
    ...
    "peaktorque": 1546,
    "picture": "A3/Soft_F/MRAP_02/Data/UI/MRAP_02_RCWS_ca.paa",
    "pilotspec": {
        "showheadphones": 0
    },
    "plateinfos": {
    ...
    "soundengineoffext": [
        "A3/Sounds_F/vehicles2/soft/Mrap_02/Mrap_02_Engine_Ext_stop",
        1.99526,
        1,
        50
    ],
    ...
    "soundengineonext": [
        "A3/Sounds_F/vehicles2/soft/Mrap_02/Mrap_02_Engine_Ext_Start",
        1.99526,
        1,
        50
    ],
    ...
    "transportmagazines": {
        ...
        "_xx_1rnd_smokeyellow_grenade_shell": {
            "count": 4,
    ...
    "turrets": {
        "mainturret": {
            ...
            "soundservo": [
                "A3/Sounds_F/vehicles/soft/noises/servo_turret_MRAP02",
                0.316228,
                1,
                10
            ],
    ...
    "useractions": {
        "door_rear_close": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_rear') > 0) && (alive this)}",
        ...
        "doorlf_close": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_LF') > 0) && (alive this)}",
        ...
        "doorlf_open": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_LF')  ==  0) && (alive this) && this != vehicle player}",
        ...
        "doorlm_close": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_LM') > 0) && (alive this)}",
        ...
        "doorlm_open": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_LM')  ==  0) && (alive this) && this != vehicle player}",
        ...
        "doorrf_close": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_RF') > 0) && (alive this)}",
        ...
        "doorrf_open": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_RF')  ==  0) && (alive this) && this != vehicle player}",
        ...
        "doorrm_close": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_RM') > 0) && (alive this)}",
        ...
        "doorrm_open": {
            "available": 0,
            "condition": "false && {((this doorPhase 'Door_RM')  ==  0) && (alive this) && this != vehicle player}",
