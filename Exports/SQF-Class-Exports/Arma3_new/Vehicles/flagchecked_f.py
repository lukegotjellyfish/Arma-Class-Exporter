d = {
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Signs_F/SignSpecial/data/checker_flag_co.paa';"
    },
    "extcameraparams": [
        1
    ],
    ...
    "minfiretime": 20,
    "mingforce": 0.2,
    "model": "A3/Signs_F/SignSpecial/FlagChecked_F.p3d",
