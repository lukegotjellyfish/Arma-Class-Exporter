d = {
    ...
    "attributes": {
        "automaticresourcesincome": {
            "control": "Checkbox",
            "defaultvalue": "false",
            "displayname": "Automatic Income",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleSyndikatTeam_enableAutomaticIncome",
            "tooltip": "",
            "typename": "BOOL"
        },
        "checkbox": {
        ...
        "dependencies": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleSyndikatTeam_dependencies",
            "tooltip": "Variables which the system will wait for before initialization."
        },
        "edit": {
            "control": "Edit",
            "defaultvalue": "''",
        ...
        "enablesystem": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleSyndikatTeam_enableSystem",
            "tooltip": "If disabled, player will not be able to select any sector to attack.",
            "typename": "BOOL"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "poolmax": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleSyndikatTeam_PoolMax",
            "tooltip": "Defined by the number of inserted Camp Position modules.",
            "typename": "NUMBER"
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Insurgent Team",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_moduleSyndikatTeam",
    "functionpriority": 2,
    "fxexplo": {
        "access": 1
    },
    ...
    "moduledescription": {
        ...
        "description": "Manages size of insurgent teams and income. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
