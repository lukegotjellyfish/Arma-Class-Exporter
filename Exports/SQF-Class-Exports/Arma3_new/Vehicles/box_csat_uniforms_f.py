d = {
    "_generalmacro": "Box_CSAT_Uniforms_F",
    "access": 0,
    "accuracy": 0.2,
    ...
    "editorpreview": "A3/EditorPreviews_F_Exp/Data/CfgVehicles/Box_CSAT_Uniforms_F.jpg",
    "ejectdeadcargo": 0,
    "ejectdeaddriver": 0,
    "emptysound": [
        "",
    ...
    "hiddenselectionstextures": [
        "/A3/Supplies_F_Exp/Ammoboxes/Data/uniforms_box_opfor_co.paa",
        "/A3/Supplies_F_Exp/Ammoboxes/Data/equipment_box_opfor_ca.paa"
    ],
    ...
    "transportfuel": 0,
    "transportitems": {
        "_xx_u_o_combatuniform_ocamo": {
            "count": 4,
            "name": "U_O_CombatUniform_ocamo"
        },
        "_xx_u_o_combatuniform_oucamo": {
            "count": 4,
            "name": "U_O_CombatUniform_oucamo"
        },
        "_xx_u_o_fullghillie_ard": {
            "count": 4,
            "name": "U_O_FullGhillie_ard"
        },
        "_xx_u_o_fullghillie_lsh": {
            "count": 4,
            "name": "U_O_FullGhillie_lsh"
        },
        "_xx_u_o_fullghillie_sard": {
            "count": 4,
        ...
        "_xx_u_o_officeruniform_ocamo": {
            "count": 4,
            "name": "U_O_OfficerUniform_ocamo"
        },
        "_xx_u_o_pilotcoveralls": {
            "count": 4,
            "name": "U_O_PilotCoveralls"
        },
        "_xx_u_o_specopsuniform_ocamo": {
            "count": 4,
            "name": "U_O_SpecopsUniform_ocamo"
        },
        "_xx_u_o_t_fullghillie_tna_f": {
            "count": 4,
        ...
        "_xx_u_o_v_soldier_viper_f": {
            "count": 4,
            "name": "U_O_V_Soldier_Viper_F"
        },
        "_xx_u_o_v_soldier_viper_hex_f": {
            "count": 4,
