d = {
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Flag_UK_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F/Flags/Flag_uk_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
