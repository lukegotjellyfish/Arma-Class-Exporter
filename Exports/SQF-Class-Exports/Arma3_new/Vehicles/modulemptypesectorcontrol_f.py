d = {
    ...
    "moduledescription": {
        ...
        "description": "Initialize Sector Control game mode.<br /><br />Mission will end when the time is up (see estimatedTimeLeft scripting command), tickets of one side are depleted (see 'Respawn Tickets' module or BIS_fnc_respawnTickets function) or when the module is deleted.",
        "direction": 0,
