d = {
    ...
    "attributes": {
        ...
        "side": {
            ...
            "displayname": "Side",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleVanguardFob_side",
            "tooltip": "Starting area for one faction. At least two areas for different sides must be placed.",
            "typename": "NUMBER",
            "values": {
                "fobeast": {
                    "name": "East",
    ...
    "detectskill": 20,
    "displayname": "Vanguard: Starting Area",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_moduleVanguardFob",
    "functionpriority": 25,
    "fxexplo": {
        "access": 1
    },
