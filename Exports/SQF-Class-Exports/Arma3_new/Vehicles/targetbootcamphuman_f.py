d = {
    "_generalmacro": "TargetBootcampHuman_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "crewvulnerable": 1,
    "curatorinfotypeempty": "RscDisplayAttributesTarget",
    "damage": {
        "mat": [],
        "tex": []
    },
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/TargetBootcampHuman_F.jpg",
    ...
    "eventhandlers": {
        ...
        "init": "['initialize', _this] call BIS_fnc_target;"
    },
    "extcameraparams": [
        1
    ],
    ...
    "hiddenselectionstextures": [
        "a3/structures_f/training/data/target_inf_co",
    ...
    "textures": [
        [
            "Generic",
            "a3/Structures_F/Training/data/Target_Inf_Acc1_CO.paa"
        ],
        [
            "CSAT",
            "a3/Structures_F/Training/data/Target_Inf2_Acc1_CO.paa"
        ],
        [
            "Zombie",
            "a3/Structures_F/Training/data/Target_Zom_Acc1_CO.paa"
        ]
    ],
    "threat": [
        0,
