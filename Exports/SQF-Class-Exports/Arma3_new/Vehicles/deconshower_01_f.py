d = {
    "_generalmacro": "DeconShower_01_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "attributes": {
        "decon_shower": {
            ...
            "expression": "if(_value isEqualTo true)then{[_this,1.5,9] spawn bin_fnc_deconShowerAnim}else{[_this] spawn bin_fnc_deconShowerAnimStop};",
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/DeconShower_01_F.jpg",
    ...
    "hiddenselectionstextures": [
        "a3/props_f_enoch/military/decontamination/data/deconshower_01_co.paa"
    ],
