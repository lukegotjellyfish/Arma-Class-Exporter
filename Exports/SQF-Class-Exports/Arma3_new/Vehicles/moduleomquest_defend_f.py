d = {
    ...
    "attributes": {
        ...
        "tasktemplate": {
            "control": "edit",
            "defaultvalue": "QuestDefendTemplate",
        ...
        "useterrainobject": {
            "control": "checkbox",
            "defaultvalue": "false",
            "displayname": "Terrain Object",
            "expression": "_this setVariable ['useTerrainObject', _value]",
            "property": "useTerrainObject",
            "tooltip": "Defend terrain object.",
            "typename": "BOOL"
        }
    },
    "attributesbase": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Quest Defend",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_ModuleQuest_defend",
    "fxexplo": {
        "access": 1
    },
    "getinaction": "",
    ...
    "icon": "A3/Ui_f/data/IGUI/Cfg/simpleTasks/types/defend_ca.paa",
    ...
    "moduledescription": {
        ...
        "description": "Task system module. For this module to work correctly, a task template must be created in the cfgQuest config file. It cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
    ...
    "portrait": "A3/Ui_f/data/IGUI/Cfg/simpleTasks/types/defend_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
