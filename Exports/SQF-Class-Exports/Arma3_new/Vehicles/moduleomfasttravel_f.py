d = {
    ...
    "attributes": {
        ...
        "dependencies": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleFastTravel_dependencies",
    ...
    "detectskill": 20,
    "displayname": "Old Man Fast Travel",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_moduleFastTravel",
    "functionpriority": 2,
    "fxexplo": {
        "access": 1
    },
    ...
    "moduledescription": {
        ...
        "description": "Module for handling player Fast Travel. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
