d = {
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/Flag_Enoch_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/a3/Data_F_Enoch/Flags/flag_Enoch_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
