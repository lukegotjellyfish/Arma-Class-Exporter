d = {
    "_generalmacro": "PortableFlagPole_01_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "attributes": {
        ...
        "flag_custom": {
            ...
            "property": "Flag_Custom_Property"
        },
        "flag_source": {
            "control": "Slider",
            "defaultvalue": 0,
            "displayname": "Flag position",
            "expression": "_this animateSource ['%s',_value,true]",
            "property": "Flag_Position_Property"
        }
    },
    "audible": 0,
