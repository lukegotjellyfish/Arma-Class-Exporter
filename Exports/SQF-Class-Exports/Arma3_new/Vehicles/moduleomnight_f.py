d = {
    ...
    "attributes": {
        "ambientcivilians": {
            ...
            "property": "ModuleOmNight_AmbientCivilians",
            "tooltip": "Enable or disable civilians spawned by Civilian Presence module.",
            "typename": "BOOL"
        },
        "checkbox": {
            "control": "Checkbox",
        ...
        "deletegroups": {
            "control": "Checkbox",
            "defaultvalue": 1,
            "displayname": "Delete Unlinked Groups",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmNight_DeleteGroups",
            "tooltip": "Delete all groups that do not have units synced with Night module.",
            "typename": "BOOL"
        },
        "deletevehicles": {
            "control": "Checkbox",
            "defaultvalue": 0,
            "displayname": "Delete Unlinked Vehicles",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmNight_DeleteVehicles",
            "tooltip": "Delete all vehicles that do not have units synced with Night module.",
            "typename": "BOOL"
        },
        "edit": {
            "control": "Edit",
        ...
        "fireplaces": {
            "control": "Checkbox",
            "defaultvalue": 1,
            "displayname": "Light Fireplaces",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmNight_Fireplaces",
            "tooltip": "Light all fireplaces inside the sector.",
            "typename": "BOOL"
        },
        "flashlights": {
            "control": "Checkbox",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmNight_Flashlights",
            "tooltip": "Turn on weapon lights of synchronized units.",
            "typename": "BOOL"
        },
        "moduledescription": {
            "control": "ModuleInfo",
    ...
    "icon": "a3/Ui_f/data/IGUI/Cfg/simpleTasks/letters/n_ca.paa",
    ...
    "moduledescription": {
        ...
        "description": "Synchronize units you want to spawn to the closest sector. According to the module settings, synchronized units will remain at night. Use this module for each sector that should be different from a sector in the daytime. It cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
    ...
    "portrait": "a3/Ui_f/data/IGUI/Cfg/simpleTasks/letters/n_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
