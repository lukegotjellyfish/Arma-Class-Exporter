d = {
    ...
    "attributes": {
        ...
        "markercondition": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmMarket_MarkerCondition",
            "tooltip": "Code that must return true for the market to become visible on the map.",
            "typename": "STRING"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "name": {
            "control": "Edit",
            "defaultvalue": "localize `STR_A3_shoping_market",
            "displayname": "Name",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmMarket_Name",
            "tooltip": "Display name of this market.",
            "typename": "STRING"
        },
        "owner": {
            "control": "Combo",
        ...
        "shopcondition": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmMarket_ShopCondition",
            "tooltip": "Code that must return true for the market to become available.",
            "typename": "STRING"
        },
        "smartmarker": {
            "control": "Edit",
            "defaultvalue": "SmartMarker_C_Armory_F",
            "displayname": "Smart marker",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmMarket_SmartMarker",
    ...
    "function": "BIS_fnc_OM_moduleMarket",
    "fxexplo": {
        "access": 1
    },
    "getinaction": "",
    ...
    "moduledescription": {
        ...
        "description": "Player is able to shop at a synchronized container when talking to a synchronized shopkeeper. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
    ...
    "portrait": "a3/Ui_f/data/IGUI/Cfg/simpleTasks/letters/m_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
