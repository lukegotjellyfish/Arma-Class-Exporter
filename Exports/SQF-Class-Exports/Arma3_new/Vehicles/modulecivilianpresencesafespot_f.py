d = {
    ...
    "attributes": {
        ...
        "civilianpresencesafespot_capacity": {
            "control": "CivilianPresenceSafeSpot_Capacity",
            "defaultvalue": 3,
            "displayname": "Capacity",
            "expression": "_this setVariable [`#capacity`,_value]",
            "property": "#capacity",
            "tooltip": "Select maximum number of civilians that can use given position at any given time.",
            "value": 3
        },
        "civilianpresencesafespot_description": {
            "control": "SubCategoryNoHeader1",
            "data": "AttributeSystemSubcategory",
            "description": "Module creates a virtual cover and/or waypoint for civilians created by Civilian Presence module.",
            "displayname": "",
            "tooltip": ""
        },
        "civilianpresencesafespot_isterminal": {
            "control": "Checkbox",
            "defaultvalue": "false",
            "displayname": "Is Terminal",
            "expression": "_this setVariable [`#terminal`,_value]",
            "property": "#terminal",
            "tooltip": "Civilians at this position get deleted.",
            "value": 0
        },
        "civilianpresencesafespot_type": {
            "control": "CivilianPresenceSafeSpot_Type",
            "defaultvalue": 1,
            "displayname": "Type",
            "expression": "_this setVariable [`#type`,_value]",
            "property": "#type",
            "tooltip": "Sets position type.",
            "value": 1
        },
        "civilianpresencesafespot_usebuilding": {
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "Use Closest Building",
            "expression": "_this setVariable [`#useBuilding`,_value]",
            "property": "#useBuilding",
            "tooltip": "If there are buildings in 50m radius, the nearest one will be used as position instead.",
            "value": 0
        },
        "combo": {
            "control": "Combo",
    ...
    "detectskill": 20,
    "displayname": "Civilian Presence Position",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "bis_fnc_moduleCivilianPresenceSafeSpot",
    "functionpriority": 25,
    "fxexplo": {
        "access": 1
    },
