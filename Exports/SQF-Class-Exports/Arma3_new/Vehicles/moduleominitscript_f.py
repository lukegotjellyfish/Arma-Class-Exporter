d = {
    ...
    "attributes": {
        ...
        "code": {
            ...
            "defaultvalue": "",
            "displayname": "Sector: Init script",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmInitScript_init",
            "tooltip": "Init of the area. Variable '_this' refers to the affected object.",
            "typename": "STRING"
        },
        "combo": {
            "control": "Combo",
    ...
    "detectskill": 20,
    "displayname": "Old Man Init. Script",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "moduledescription": {
        ...
        "description": "Init. script applied to any unit synchronized with a module. Do not use system: Init. field. Instead, use the field in the lower part of the module. Script will be called every time a unit in the sector is created.",
        "direction": 0,
