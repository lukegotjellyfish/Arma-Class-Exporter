d = {
    ...
    "arguments": {
        "disablethermals": {
            "defaultvalue": 0,
            "displayname": "Disable thermal optics",
            "typename": "NUMBER",
            "values": {
                "all": {
                    "name": "All Vehicles",
        ...
        "endtime": {
            "defaultvalue": "15",
            "description": "Duration of Match Once Device has Landed (Minutes)",
            "displayname": "End game time (minutes)",
            "typename": "NUMBER"
        },
        "numberofzonerestrictions": {
            "defaultvalue": "4",
            "description": "Number of Times the Zone Contracts",
            "displayname": "Number of zone changes",
            "typename": "NUMBER"
        },
        "respawnoptions": {
            "defaultvalue": 0,
        ...
        "truckdensity": {
            "defaultvalue": 500,
            "description": "Density of trucks in the zone",
            "displayname": "Number of spawned trucks",
            "typename": "NUMBER",
            "values": {
                "dense": {
                    "name": "Heavy",
        ...
        "warmuptime": {
            "defaultvalue": "30",
            "description": "Duration of Briefing Phase (Seconds)",
            "displayname": "Briefing time (seconds)",
            "typename": "NUMBER"
        },
        "zonetime": {
            "defaultvalue": "5",
            "description": "Duration Between Zone Updates (Minutes)",
            "displayname": "Zone interval time (minutes)",
            "typename": "NUMBER"
        }
    },
    "argumentsbaseunits": {
    ...
    "detectskill": 20,
    "displayname": "Vanguard: Objective Area",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_moduleVanguardObjective",
    "functionpriority": 25,
    "fxexplo": {
        "access": 1
    },
