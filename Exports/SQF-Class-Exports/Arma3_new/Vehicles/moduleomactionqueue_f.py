d = {
    ...
    "attributes": {
        ...
        "queuemaxsize": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleActionQueue_maxSize",
            "tooltip": "How many actions can be stored in the queue at one time.",
            "typename": "NUMBER"
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Oldman Action Queue",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_moduleActionQueue",
    "functionpriority": 2,
    "fxexplo": {
        "access": 1
    },
    ...
    "moduledescription": {
        ...
        "description": "Action Queue can be used for the sequential execution of actions (scripts, dialogues) in a non-specified time.",
        "direction": 0,
