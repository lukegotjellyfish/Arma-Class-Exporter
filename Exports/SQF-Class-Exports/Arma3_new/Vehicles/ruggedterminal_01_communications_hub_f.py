d = {
    "_generalmacro": "RuggedTerminal_01_communications_hub_F",
    "access": 0,
    "accuracy": 0.1,
    ...
    "animationsources": {
        ...
        "terminal_source_sound": {
            "animperiod": 0.15,
            "initphase": 0,
            "sound": "LinkTerminal_01_node_main_F_sound_hatch",
            "soundposition": "Sound_main",
            "source": "user"
        },
        "terminal_source_sound_case_01": {
            "animperiod": 0.15,
            "initphase": 0,
            "sound": "LinkTerminal_01_node_main_F_sound_case_01",
            "soundposition": "Sound_case1",
            "source": "user"
        },
        "terminal_source_sound_case_02": {
            "animperiod": 0.15,
            "initphase": 0,
            "sound": "LinkTerminal_01_node_main_F_sound_case_02",
            "soundposition": "Sound_case2",
            "source": "user"
        }
    },
    ...
    "attributes": {
        ...
        "openterminal": {
            ...
            "expression": "[_this,['Terminal_source','Terminal_source_sound','Terminal_source_sound_case_01','Terminal_source_sound_case_02'],_value*100,true] call bis_fnc_LinkTerminal_Animations",
    ...
    "destructioneffects": {},
    "detectskill": 20,
    "displayname": "Rugged Communications Hub",
    "dlc": "Argo",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "eventhandlers": {
        "init": "this setVariable ['BIS_Link_Main', 0]"
    },
    "extcameraparams": [
        1
    ],
    ...
    "sound": "LinkTerminal_main_Standby_Loop",
    "soundarmorcrash": [
        "emptySound",
        0
    ],
