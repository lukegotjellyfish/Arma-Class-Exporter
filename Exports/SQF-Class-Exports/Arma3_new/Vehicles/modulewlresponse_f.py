d = {
    ...
    "attributes": {
        ...
        "group": {
            ...
            "tooltip": "Response group type. AAF group config is used.",
            "typename": "NUMBER",
            "values": {
                "airdrop": {
                    "name": "Paratroopers (synchronize a helicopter)",
                    "value": 6
                },
                "armor": {
                    "name": "Armor",
    ...
    "detectskill": 20,
    "displayname": "Warlords Response Team",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "moduledescription": {
        ...
        "description": "Synchronize this module with a Sector module to spawn a response team on its position when a neighboring Sector is assaulted.",
        "direction": 0,
