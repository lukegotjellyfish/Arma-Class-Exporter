d = {
    ...
    "attributes": {
        ...
        "children": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_Children",
            "tooltip": "Array of intel titles that are children to this intel class.",
            "typename": "STRING"
        },
        "combo": {
            "control": "Combo",
        ...
        "gathercondition": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_GatherCondition",
            "tooltip": "Code that must return true for the intel to become available.",
            "typename": "STRING"
        },
        "id": {
            "control": "Edit",
            "defaultvalue": "",
            "displayname": "ID (DO NOT LOCALIZE)",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_ID",
            "tooltip": "Intel system ID. This should be the same as the title.",
            "typename": "STRING"
        },
        "markers": {
            "control": "EditMulti5",
            ...
            "displayname": "Markers",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_Markers",
            "tooltip": "Markers that will be shown after intel is revealed.",
            "typename": "STRING"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "onfindcode": {
            "control": "Edit",
            "defaultvalue": "",
            "displayname": "On Find Intel",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_OnFindCode",
            "tooltip": "Code that will be executed after specific intel was found.",
            "typename": "STRING"
        },
        "priority": {
            "control": "Combo",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_Priority",
            "tooltip": "Different objects can hold intel of different priority.",
            "typename": "NUMBER",
            "values": {
                "priority_0": {
                    "name": "Low",
        ...
        "probability": {
            "control": "Edit",
            "defaultvalue": 1,
            "displayname": "Probability of finding",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_Prob",
            "tooltip": "With what probability will intel be found. When finding random intel, weighted random is used to mark probability.",
            "typename": "NUMBER"
        },
        "revealdata": {
            "control": "Edit",
            "defaultvalue": "[position _module, 100]",
            "displayname": "Automatic reveal",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_RevealData",
            "tooltip": "Intel will be revealed if player enters this area: [center, range] (ignored for intel parents).",
            "typename": "STRING"
        },
        "source": {
            "control": "Edit",
            ...
            "displayname": "Sources",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_Source",
            "tooltip": "Array of object variable names (strings) which will be specifically used to gather this intel.",
            "typename": "STRING"
        },
        "text": {
            "control": "EditMulti5",
            ...
            "displayname": "Text",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_Text",
            "tooltip": "Added diary record text.",
            "typename": "STRING"
        },
        "title": {
            "control": "Edit",
            ...
            "displayname": "Title",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmIntel_Title",
            "tooltip": "Added diary record title. Must be same as intel ID.",
            "typename": "STRING"
        },
        "units": {
    ...
    "moduledescription": {
        ...
        "description": "Module for creating collectible intel. It adds a new diary record and can reveal sector markers. It cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
