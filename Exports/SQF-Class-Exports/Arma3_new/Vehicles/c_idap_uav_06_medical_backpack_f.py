d = {
    "_generalmacro": "C_IDAP_UAV_06_medical_backpack_F",
    "access": 0,
    "accuracy": 0.2,
    ...
    "artillerytarget": 0,
    "assembleinfo": {
        "assembleto": "C_IDAP_UAV_06_medical_F",
        "base": "",
        "displayname": "UAV Bag (Utility, Medical) [IDAP]",
        "dissasembleto": [],
        "primary": 1
    },
    "attendant": 0,
    ...
    "destructioneffects": {},
    "detectskill": 20,
    "displayname": "UAV Bag (AL-6, Medical) [IDAP]",
    "dlc": "Orange",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
