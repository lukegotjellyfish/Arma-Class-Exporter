d = {
    "_generalmacro": "Flag_Redburger_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Flag_Redburger_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F_Kart/Flags/flag_redburger_co.paa'"
    },
    "extcameraparams": [
        1
    ],
