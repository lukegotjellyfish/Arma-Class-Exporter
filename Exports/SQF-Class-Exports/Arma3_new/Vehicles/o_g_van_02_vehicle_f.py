d = {
    "_generalmacro": "O_G_Van_02_vehicle_F",
    "accelaidforcecoef": 4,
    ...
    "animationsources": {
        ...
        "enable_cargo": {
            "animperiod": 0.0002,
            "displayname": "Add passenger spots",
            "lockcargo": [
                1,
                2,
                3,
            ...
            "onphasechanged": "(_this select 0) enableVehicleCargo ((_this select 1) == 0);",
            "source": "user"
        },
    ...
    "editorpreview": "A3/EditorPreviews_F_Orange/Data/CfgVehicles/O_G_Van_02_vehicle_F.jpg",
    ...
    "icon": "a3/Soft_F_Orange/Van_02/Data/UI/Map_Van_02_vehicle_CA.paa",
    "idlerpm": 900,
    ...
    "model": "a3/Soft_F_Orange/Van_02/Van_02_vehicle_F.p3d",
    ...
    "peaktorque": 836,
    "picture": "a3/Soft_F_Orange/Van_02/Data/UI/Van_02_vehicle_CA.paa",
    "pilotspec": {
        "showheadphones": 0
    },
    "plateinfos": {
    ...
    "texturesources": {
        ...
        "astra": {
            ...
            "textures": [
                "A3/Soft_F_enoch/Van_02/Data/van_body_Astra_CO.paa",
                "a3/Soft_F_Orange/Van_02/Data/van_wheel_co.paa",
                "a3/soft_f_orange/van_02/data/van_glass_utility_ca.paa",
                "a3/soft_f_enoch/van_02/data/van_body_Astra_CO.paa"
            ]
        ...
        "benzyna": {
            ...
            "textures": [
                "A3/Soft_F_enoch/Van_02/Data/van_body_benzyna_CO.paa",
                "a3/Soft_F_Orange/Van_02/Data/van_wheel_co.paa",
                "a3/soft_f_orange/van_02/data/van_glass_utility_ca.paa",
                "a3/soft_f_enoch/van_02/data/van_body_benzyna_CO.paa"
            ]
        ...
        "fia2u": {
            "author": "Bohemia Interactive",
            "displayname": "Guerrilla 02 (unfinished)",
            "factions": [
                "IND_G_F",
                "BLU_G_F",
                "OPF_G_F"
    ...
    "turrets": {
        "cargoturret_01": {
            ...
            "dontcreateai": 1,
            "ejectdeadgunner": 0,
            "enabledbyanimationsource": "Door_3_source",
            "forcehidegunner": 0,
            "forcenvg": 0,
            "gun": "",
            "gunbeg": "usti hlavne",
        ...
        "cargoturret_02": {
            ...
            "dontcreateai": 1,
            "ejectdeadgunner": 0,
            "enabledbyanimationsource": "Door_4_source",
            "forcehidegunner": 0,
            "forcenvg": 0,
            "gun": "",
            "gunbeg": "usti hlavne",
    ...
    "useractions": {
        ...
        "rear_closed": {
            "available": 0,
            "condition": "this doorPhase 'Door_4_source' > 0.5 AND Alive(this) && {((missionNamespace getVariable ['bis_fnc_moduleRemoteControl_unit', player]) in [this turretUnit [1], this turretUnit [2]])} && {this animationSourcePhase 'hide_door_4_source' < 0.5} && {((this getVariable ['bis_disabled_rearDoors',0]) != 1)}",
        ...
        "sidedoor_close": {
            "available": 0,
            "condition": "this doorPhase 'Door_3_source' > 0.5 AND Alive(this) && {((missionNamespace getVariable ['bis_fnc_moduleRemoteControl_unit', player]) in [this turretUnit [0],this turretUnit [3]])} && {this animationSourcePhase 'hide_door_3_source' < 0.5} && {((this getVariable ['bis_disabled_sideDoor',0]) != 1)}",
