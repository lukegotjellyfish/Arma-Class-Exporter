d = {
    ...
    "armorstructural": 10,
    "armory": {
        "description": "The Titan Multi-Purpose Rocket Launcher is a shoulder system for launching guided rockets against aerial targets. It's adapted to be launched from closed quarters, has several modes of guidance and thanks to its advanced jet engine, it's capable of hitting even fast moving targets at short distances."
    },
    "artilleryscanner": 0,
    "artillerytarget": 0,
    "assembleinfo": {
    ...
    "damage": {
        "mat": [
            ...
            "a3/weapons_f_beta/launchers/titan/data/titan_ltube.rvmat",
            "a3/weapons_f_beta/launchers/titan/data/titan_ltube_damage.rvmat",
            "a3/weapons_f_beta/launchers/titan/data/titan_ltube_destruct.rvmat"
        ],
        "tex": []
    },
    "damagefull": [],
