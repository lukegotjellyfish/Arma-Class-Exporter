d = {
    ...
    "attributes": {
        ...
        "radiochannel": {
            ...
            "displayname": "LODs",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_LODs",
            "tooltip": "How many LODs can be used.",
            "typename": "NUMBER",
            "values": {
                "tmarkerlod1": {
                    "name": "1 LOD",
    ...
    "detectskill": 20,
    "displayname": "Old Man Smart Markers",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_moduleSmartMarkers",
    "functionpriority": 2,
    "fxexplo": {
        "access": 1
    },
    ...
    "moduledescription": {
        ...
        "description": "Managing smart marker enhancements, interactive smart marker compositions, and LODing of the information. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
