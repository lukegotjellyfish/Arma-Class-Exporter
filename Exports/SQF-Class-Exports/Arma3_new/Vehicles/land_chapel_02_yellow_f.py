d = {
    "_generalmacro": "Land_Chapel_02_yellow_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "animationsources": {
        ...
        "ringthebell": {
            "animperiod": 1,
            "initphase": 0,
            "sound": "SmallBellSound",
            "soundposition": "Bell_soundpos",
            "source": "user"
        }
    },
    ...
    "damage": {
        "mat": [
            ...
            "A3/structures_f_enoch/cultural/chapel_02/data/chapel_02_white_multi.rvmat",
            "A3/structures_f_enoch/cultural/chapel_02/data/destruct_chapel_02_white_multi.rvmat",
            "A3/structures_f_enoch/cultural/chapel_02/data/destruct_chapel_02_white_multi.rvmat",
            "A3/structures_f_enoch/cultural/chapel_02/data/chapel_02_yellow_multi.rvmat",
            "A3/structures_f_enoch/cultural/chapel_02/data/destruct_chapel_02_yellow_multi.rvmat",
            "A3/structures_f_enoch/cultural/chapel_02/data/destruct_chapel_02_yellow_multi.rvmat"
        ],
        "tex": [
    ...
    "destructioneffects": {
        ...
        "ruin1": {
            ...
            "position": "",
            "simulation": "ruin",
            "type": "A3/Structures_F_Enoch/Cultural/Chapel_02/Chapel_02_yellow_ruins_F.p3d"
        },
        "smoke1": {
            "intensity": 0.15,
            "interval": 1,
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/Land_Chapel_02_yellow_F.jpg",
    ...
    "model": "A3/Structures_F_Enoch/Cultural/Chapel_02/Chapel_02_yellow_F.p3d",
    ...
    "useractions": {
        ...
        "ringthebell": {
            "actionnamedsel": "RingTheBell_action",
            "aimaxrange": 2,
            "condition": "((this animationSourcePhase 'RingTheBell' == 0) or (this animationSourcePhase 'RingTheBell' == 2.75)) && (cameraOn isKindOf 'CAManBase')",
            "displayname": "Ring the bell",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/take_ca.paa' size='2.5' />",
            "onlyforplayer": 1,
            "position": "RingTheBell_trigger",
            "priority": 10,
            "radius": 2,
            "statement": "if (this animationSourcePhase 'RingTheBell' == 2.75) then\t\t\t\t{\t\t\t\t\tthis animateSource ['RingTheBell', 0, true];\t\t\t\t};\t\t\t\tthis animateSource ['RingTheBell', 2.75]"
        }
    },
    "viewcargo": {
        "initanglex": 5,
