d = {
    ...
    "attributes": {
        "3dendrawprecision": {
            "control": "EditShort",
            "defaultvalue": "0.25",
            "displayname": "3DEN Draw Precision",
            "expression": "_this setVariable ['%s',_value];",
            "property": "3DENDrawPrecision",
            "tooltip": "When editing in 3DEN, this sets the curve drawing precision. It can be manually scaled per curve.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        },
        "3dendrawprecisiondrag": {
            "control": "EditShort",
            "defaultvalue": "0.25",
            "displayname": "3DEN Draw Precision Drag",
            "expression": "_this setVariable ['%s',_value];",
            "property": "3DENDrawPrecisionDrag",
            "tooltip": "When editing in 3DEN, this sets the curve drawing precision when dragging. It can be manually scaled per curve.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        },
        "lookat": {
            "control": "EditShort",
            "defaultvalue": "[-1, objNull]",
            "displayname": "Look At",
            "expression": "_this setVariable ['%s',_value];",
            "property": "LookAt",
            "tooltip": "The look at target <EdenId, ObjectName>",
            "typename": "ARRAY",
            "unique": 0,
            "validate": "none"
        },
        "orientationmode": {
            "control": "combo",
            "defaultvalue": "0",
            "displayname": "Orientation Mode",
            "expression": "_this setVariable ['%s',_value];",
            "property": "OrientationMode",
            "tooltip": "The orientation mode of the animated object.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none",
            "values": {
        ...
        "timeinseconds": {
            ...
            "tooltip": "Whether the time set in this key is in seconds. If false, time is alpha (between 0 - 1).",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        }
    ...
    "eventhandlers": {
        "keyframeanimation": {
            "attributeschanged3den": "_this call BIS_fnc_richCurve_edenAttributesChanged;",
            "connectionchanged3den": "_this call BIS_fnc_richCurve_edenConnectionChanged;",
            "dragged3den": "_this call BIS_fnc_richCurve_edenDragged;",
            "registeredtoworld3den": "_this call BIS_fnc_richCurve_edenRegisteredToWorld;",
            "unregisteredfromworld3den": "_this call BIS_fnc_richCurve_edenUnregisteredFromWorld;"
        }
    },
    "extcameraparams": [
        1
