d = {
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Flag_FD_Blue_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F/Flags/flag_fd_blue_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
