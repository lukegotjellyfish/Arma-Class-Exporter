d = {
    "_generalmacro": "Box_IND_WpsLaunch_F",
    "access": 0,
    "accuracy": 0.2,
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Box_IND_WpsLaunch_F.jpg",
    "ejectdeadcargo": 0,
    "ejectdeaddriver": 0,
    "emptysound": [
        "",
    ...
    "transportweapons": {
        "_xx_launch_i_titan_f": {
            "count": 1,
            "weapon": "launch_I_Titan_F"
        },
        "_xx_launch_i_titan_short_f": {
            "count": 1,
            "weapon": "launch_I_Titan_short_F"
        },
        "_xx_launch_mraws_olive_rail_f": {
            "count": 1,
