d = {
    ...
    "attributes": {
        ...
        "customcondition": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmTracked_CustomCondition",
            "tooltip": "Must return true for the cache to become available.",
            "typename": "STRING"
        },
        "default": {
            "expression": "_this setVariable ['%s',_value,true];"
        ...
        "findcode": {
            "control": "Edit",
            "defaultvalue": "",
            "displayname": "On Find Code",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmTracked_FindCode",
            "tooltip": "Code that will be performed when player discovered cache.",
            "typename": "STRING"
        },
        "findrange": {
            "control": "Edit",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmTracked_FindRange",
            "tooltip": "Distance at which entity will stop beeping.",
            "typename": "NUMBER"
        },
        "inrangecode": {
            "control": "Edit",
            "defaultvalue": "",
            "displayname": "In Range Code",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmTracked_InRangeCode",
            "tooltip": "Code that will be executed when cache is beeping.",
            "typename": "STRING"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "range": {
            ...
            "displayname": "Range",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmTracked_Range",
            "tooltip": "Distance at which entity will beep.",
            "typename": "NUMBER"
        },
        "showmarker": {
            "control": "Checkbox",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmTracked_ShowMarker",
            "tooltip": "If checked, a smart marker will be created on the cache's location when discovered.",
            "typename": "BOOL"
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Tracked Device",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
