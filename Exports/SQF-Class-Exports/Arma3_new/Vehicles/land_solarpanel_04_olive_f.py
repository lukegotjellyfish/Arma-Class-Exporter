d = {
    "_generalmacro": "Land_SolarPanel_04_olive_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "attributes": {
        "panel_1_pitch": {
            "control": "edit",
            "defaultvalue": 0,
            "displayname": "Pitch panel #1",
            "expression": "_this animateSource ['%s',_value,true]",
            "property": "Panel_1_Pitch",
            "tooltip": "+/-45 degrees range",
            "validate": "number"
        },
        "panel_2_pitch": {
            "control": "edit",
            "defaultvalue": 0,
            "displayname": "Pitch panel #2",
            "expression": "_this animateSource ['%s',_value,true]",
            "property": "Panel_2_Pitch",
            "tooltip": "+/-45 degrees range",
            "validate": "number"
        },
        "panels_yaw": {
    ...
    "displayname": "Rugged Solar Panel (Olive)",
    "dlc": "Enoch",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/Land_SolarPanel_04_olive_F.jpg",
    ...
    "hiddenselectionstextures": [
        "a3/Props_F_Enoch/Military/Equipment/data/SolarPanel_04_F_Olive_CO.paa"
    ],
