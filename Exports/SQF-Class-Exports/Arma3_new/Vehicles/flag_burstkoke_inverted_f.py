d = {
    "_generalmacro": "Flag_Burstkoke_inverted_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "destructioneffects": {},
    "detectskill": 20,
    "displayname": "Flag (Burstkoke, inverted)",
    "dlc": "Kart",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Flag_Burstkoke_inverted_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F_Kart/Flags/flag_koke2_co.paa'"
    },
    "extcameraparams": [
        1
    ],
