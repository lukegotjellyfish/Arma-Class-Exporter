d = {
    "_generalmacro": "Flag_RedCrystal_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Flag_RedCrystal_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F/Flags/Flag_rcrystal_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
