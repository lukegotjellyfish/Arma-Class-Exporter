d = {
    ...
    "attributes": {
        ...
        "frequency": {
            "control": "Combo",
            "defaultvalue": "1",
            "displayname": "Frequency (disabled)",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleAwareness_Frequency",
            "tooltip": "How often the messages should be played.",
            "typename": "NUMBER",
            "values": {
                "tmarkerlod1": {
                    "name": "Occasionally",
    ...
    "function": "BIS_fnc_OM_moduleAwareness",
    "functionpriority": 2,
    "fxexplo": {
        "access": 1
    },
    ...
    "moduledescription": {
        ...
        "description": "Player's awareness regarding his relationship to the enemy via ambient radio chatter. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
