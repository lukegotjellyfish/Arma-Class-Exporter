d = {
    "_generalmacro": "Land_Carousel_01_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Land_Carousel_01_F.jpg",
    ...
    "useractions": {
        "spinthecarousel_left": {
            "actionnamedsel": "Centerpiece",
            "condition": "((this animationSourcePhase 'Platform_source_1') <= 0.01)",
            "displayname": "Spin the carousel",
            "displaynamedefault": "Spin the carousel",
            "onlyforplayer": 1,
            "position": "",
            "priority": 0.01,
            "radius": 3,
            "statement": "([this, 1] execVM `/A3/Structures_F_EPC/Civ/PlayGround/scripts/Carousel_spin.sqf`)"
        },
        "spinthecarousel_right": {
            "actionnamedsel": "Centerpiece",
            "condition": "((this animationSourcePhase 'Platform_source_1') >= 0.99)",
            "displayname": "Spin the carousel",
            "displaynamedefault": "Spin the carousel",
            "onlyforplayer": 1,
            "position": "",
            "priority": 0.01,
            "radius": 3,
            "statement": "([this, 0] execVM `/A3/Structures_F_EPC/Civ/PlayGround/scripts/Carousel_spin.sqf`)"
        }
    },
    "viewcargo": {
        "initanglex": 5,
