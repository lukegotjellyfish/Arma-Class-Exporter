d = {
    "_generalmacro": "RuggedTerminal_01_F",
    "access": 0,
    "accuracy": 0.1,
    ...
    "animationsources": {
        ...
        "terminal_source_sound": {
            "animperiod": 0.07,
            "initphase": 0,
            "sound": "RaidTerminal_01_F_sound",
            "soundposition": "Sound_raid",
            "source": "user"
        }
    },
    ...
    "attributes": {
        "downloading_source": {
            "control": "Slider",
            "defaultvalue": 0,
            "displayname": "Downloading progress bar",
        ...
        "preparing_source": {
            "control": "Slider",
            "defaultvalue": 0,
            "displayname": "Preparing progress bar",
            "expression": "_this animateSource ['%s',_value*100,true]",
            "property": "Preparing_source"
        },
        "progress_source": {
            "control": "Slider",
            "defaultvalue": 0,
        ...
        "stopping_source": {
            "control": "Slider",
            "defaultvalue": 0,
            "displayname": "Stopping progress bar",
            "expression": "_this animateSource ['%s',_value*100,true]",
            "property": "Stopping_source"
        }
    },
    "audible": 0,
    ...
    "editorpreview": "A3/EditorPreviews_F_Decade/Data/CfgVehicles/RuggedTerminal_01_F.jpg",
    ...
    "eventhandlers": {
        "init": "this setVariable ['BIS_Raid_Terminal', 0]"
    },
    "extcameraparams": [
        1
    ],
    ...
    "hiddenselectionstextures": [
        ...
        "#(argb,8,8,3)color(1,1,1,0.99,CA)",
        "a3/props_f_decade/objectives/data/linkterminal_box_01_co.paa",
        "a3/props_f_decade/objectives/data/linkterminal_box_03_co.paa",
        ...
        "a3/props_f_decade/objectives/data/raidterminal_generator_co.paa"
    ],
    ...
    "minfiretime": 20,
    "mingforce": 0.2,
    "model": "a3/Props_F_Decade/Objectives/RuggedTerminal_01_F.p3d",
    ...
    "sound": "RaidTerminal_Standby_Loop",
    "soundarmorcrash": [
        "emptySound",
        0
    ],
