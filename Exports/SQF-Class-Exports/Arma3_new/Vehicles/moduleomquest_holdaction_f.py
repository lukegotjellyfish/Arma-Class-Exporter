d = {
    ...
    "detectskill": 20,
    "displayname": "Old Man Hold Action Quest",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "icon": "A3/Ui_f/data/IGUI/Cfg/HoldActions/progress2/progress_20_ca.paa",
    ...
    "moduledescription": {
        ...
        "description": "Custom quest via hold action.  For this module to work correctly, a task template must be created in the cfgQuest config file. It cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
    ...
    "portrait": "A3/Ui_f/data/IGUI/Cfg/HoldActions/progress2/progress_20_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
    "predictturnsimul": 1.2,
    "preferroads": 0,
    "pulsationsound": {},
    "questtype": "holdAction",
    "radartype": 0,
    "reflectors": {},
    "replacedamaged": "",
