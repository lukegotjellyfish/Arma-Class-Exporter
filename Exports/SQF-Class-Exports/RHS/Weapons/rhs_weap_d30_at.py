d = {
    ...
    "burst1": {
        ...
        "standardsound": {
            "soundsetshot": [
                "RHS_155mm_Shot_SoundSet",
                "RHS_155mm_int_Shot_SoundSet",
                "RHS_cannon_Tail_SoundSet"
            ]
        },
        "texturetype": "burst",
        "useaction": 0,
    ...
    "enableattack": 1,
    "eventhandlers": {
        "rhs_artillery_eventhandlers": {
            "fired": "_this call rhs_fnc_scriptedArtilleryCharge"
        }
    },
    "far": {
        "aidispersioncoefx": 1.4,
    ...
    "reloadsound": [
        "A3/Sounds_F/vehicles/armor/noises/reload_tank_cannon_2",
        31.6228,
        1,
        15
    ],
