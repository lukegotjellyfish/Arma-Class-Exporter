d = {
    ...
    "baseweapon": "rhs_weap_ak103_2_npz",
    "bullet1": [
    ...
    "handanim": [
        "OFP2_ManSkeleton",
        "/rhsafrf/addons/rhs_c_weapons/anims/rhs_hand_ak_stock.rtm"
    ],
    "hiddenselections": [
        "body",
        "newfront",
    ...
    "opticszoommax": 1.1,
    "opticszoommin": 0.25,
    "picture": "rhsafrf/addons/rhs_inventoryicons/data/weapons/rhs_weap_ak103_2_npz_ca.paa",
    "primary": 10,
    "recoil": "recoil_sdar",
    "recoilprone": "assaultRifleBase",
    ...
    "rhs_fold": "rhs_weap_ak103_2_folded",
