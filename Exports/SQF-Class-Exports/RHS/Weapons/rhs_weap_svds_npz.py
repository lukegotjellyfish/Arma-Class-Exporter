d = {
    ...
    "handanim": [
        "OFP2_ManSkeleton",
        "/rhsafrf/addons/rhs_c_weapons/anims/rhs_hand_svd_mag.rtm"
    ],
    "hiddenselections": [
        "Camo1",
        "Camo2"
    ...
    "hiddenselectionstextures": [
        "rhsafrf/addons/rhs_weapons/svd/data/svdp_co.paa",
    ...
    "opticszoommax": 1.1,
    "opticszoommin": 0.25,
    "picture": "rhsafrf/addons/rhs_inventoryicons/data/weapons/rhs_weap_svds_npz_ca.paa",
    "primary": 10,
    "recoil": "rhs_recoil_svd",
    "recoilprone": "assaultRifleBase",
    "reloadaction": "RHS_GestureReloadSVDS",
    "reloadmagazinesound": [
        "rhsafrf/addons/rhs_sounds/svd/rhs_reload_svd",
        1.2,
        1,
        15
    ],
