d = {
    ...
    "editorpreview": "rhssaf/addons/rhssaf_editorpreviews/data/rhssaf_flag_serbia.paa",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/rhssaf/addons/rhssaf_main/data/flags/flag_serbia_co.paa'"
    },
    "extcameraparams": [
        1
    ],
