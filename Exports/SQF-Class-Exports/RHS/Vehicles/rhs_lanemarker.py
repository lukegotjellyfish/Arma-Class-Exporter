d = {
    ...
    "editorpreview": "rhsusf/addons/rhsusf_editorPreviews/data/rhs_laneMarker.paa",
    ...
    "mingforce": 0.2,
    "minheight": 0.1,
    "model": "rhsusf/addons/rhsusf_stryker/rhsusf_laneMarker.p3d",
