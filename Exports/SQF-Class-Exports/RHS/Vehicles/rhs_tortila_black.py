d = {
    ...
    "destructioneffects": {},
    "detectskill": 20,
    "displayname": "SPOSN Tortila Backpack (Black)",
    "dlc": "RHS_AFRF",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "hiddenselectionstextures": [
        "rhsafrf/addons/rhs_infantry3/data/tortilla_black_co.paa"
    ],
    ...
    "picture": "rhsafrf/addons/rhs_inventoryicons/data/backpacks/rhs_tortila_black_ca.paa",
    "pilotspec": {
        "showheadphones": 0
    },
    "portrait": "",
