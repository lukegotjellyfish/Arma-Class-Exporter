d = {
    ...
    "displayname": "RHSUSF Equipment Crate",
    "dlc": "RHS_USAF",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "transportammo": 0,
    "transportbackpacks": {
        "_xx_rhsusf_assault_eagleaiii_coy": {
            "backpack": "rhsusf_assault_eagleaiii_coy",
            "count": 4
        },
        "_xx_rhsusf_assault_eagleaiii_ocp": {
            "backpack": "rhsusf_assault_eagleaiii_ocp",
            "count": 4
        },
        "_xx_rhsusf_assault_eagleaiii_ucp": {
    ...
    "transportitems": {
        ...
        "_xx_rhs_googles_black": {
            "count": 5,
            "name": "rhs_googles_black"
        },
        "_xx_rhs_googles_clear": {
            "count": 5,
            "name": "rhs_googles_clear"
        },
        "_xx_rhs_googles_orange": {
            "count": 5,
            "name": "rhs_googles_orange"
        },
        "_xx_rhs_googles_yellow": {
            "count": 5,
