d = {
    ...
    "eventhandlers": {
        "rhs_eventhandlers": {
            "init": "(_this select 0) setFlagTexture '/rhsgref/addons/rhsgref_main/data/flag_chdkz_co.paa'"
        }
    },
    "extcameraparams": [
        1
    ...
    "minfiretime": 20,
    "mingforce": 0.2,
    "model": "rhsgref/addons/rhsgref_vehicles_ret/flag_rebel.p3d",
    "namesound": "obj_flag",
    "nightvision": 0,
