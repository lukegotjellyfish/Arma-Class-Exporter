d = {
    ...
    "editorpreview": "rhssaf/addons/rhssaf_editorpreviews/data/rhssaf_flag_yugoslavia.paa",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/rhssaf/addons/rhssaf_main/data/flags/flag_yugoslavia_co.paa'"
    },
    "extcameraparams": [
        1
    ],
