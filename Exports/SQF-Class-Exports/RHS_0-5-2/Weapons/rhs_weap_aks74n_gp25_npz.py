d = {
    ...
    "baseweapon": "rhs_weap_aks74n_gp25_npz",
    "bullet1": [
    ...
    "minrange": 1,
    "minrangeprobab": 0.3,
    "model": "rhsafrf/addons/rhs_weapons3/aks74/rhs_aks74n_gp25_npz",
    "modelmagazine": "",
    "modeloptics": "-",
    "modelspecial": "",
    "modes": [
    ...
    "opticszoommax": 1.1,
    "opticszoommin": 0.25,
    "picture": "rhsafrf/addons/rhs_inventoryicons/data/weapons/rhs_weap_aks74n_gp25_npz_ca.paa",
    "primary": 10,
    "recoil": {
        "kickback": [
            0.02,
