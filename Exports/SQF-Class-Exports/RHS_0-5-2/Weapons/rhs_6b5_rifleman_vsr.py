d = {
    ...
    "hiddenselectionstextures": [
        "rhsgref/addons/rhsgref_infantry/data_cdf/6b5_vsr_co.paa"
    ],
    ...
    "opticszoommax": 1.25,
    "opticszoommin": 0.25,
    "picture": "rhsgref/addons/rhsgref_inventoryicons/data/Vests/rhs_6b5_rifleman_vsr_ca.paa",
    "primary": 10,
    "recoil": [],
    "reloadaction": "",
    "reloadmagazinesound": [
