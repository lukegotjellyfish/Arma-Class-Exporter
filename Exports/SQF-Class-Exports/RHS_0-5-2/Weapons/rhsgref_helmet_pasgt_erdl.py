d = {
    ...
    "hiddenselectionstextures": [
        "rhsgref/addons/rhsgref_infantry/data_tanoa/pasgt_helmet_erdl_co.paa"
    ],
    ...
    "opticszoommax": 1.25,
    "opticszoommin": 0.25,
    "picture": "rhsgref/addons/rhsgref_inventoryicons/data/Headgear/rhsgref_helmet_pasgt_erdl_ca.paa",
    "primary": 10,
    "recoil": [],
    "reloadaction": "",
    "reloadmagazinesound": [
