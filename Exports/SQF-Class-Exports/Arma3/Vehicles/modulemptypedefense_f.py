d = {
    ...
    "moduledescription": {
        ...
        "description": [
            "Crate Defend mode, compatible both with single- and multiplayer.",
            "Players are defending their base sectors against incoming enemy waves.",
            "When all player sectors are captured by the enemy side, they lose.",
            "After few waves, they can call in an evacuate helicopter and leave, leading to their victory",
            "Should the enemy manage to shoot down the helicopter first, players can still repel the last wave and achieve stalemate."
        ],
        "direction": 0,
