d = {
    "_generalmacro": "Land_i_Shop_01_V1_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "damage": {
        "mat": [
            ...
            "A3/Structures_F/Households/House_Shop01/Data/i_Shop_01_V1_add_F_multi.rvmat",
            "A3/Structures_F/Households/House_Shop01/Data/destruct_i_Shop_01_V1_add_F_multi.rvmat",
            "A3/Structures_F/Households/House_Shop01/Data/destruct_i_Shop_01_V1_add_F_multi.rvmat",
            "A3/Structures_F/Households/House_Shop01/Data/i_Shop_01_V1_F_multi.rvmat",
            "A3/Structures_F/Households/House_Shop01/Data/destruct_i_Shop_01_V1_F_multi.rvmat",
            "A3/Structures_F/Households/House_Shop01/Data/destruct_i_Shop_01_V1_F_multi.rvmat"
        ],
        "tex": [
    ...
    "destructioneffects": {
        ...
        "ruin1": {
            ...
            "position": "",
            "simulation": "ruin",
            "type": "A3/Structures_F/Households/House_Shop01/Shop_01_V1_ruins_F.p3d"
        },
        "smoke1": {
            "intensity": 0.15,
            "interval": 1,
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Land_i_Shop_01_V1_F.jpg",
    ...
    "radartype": 0,
    "reflectors": {},
    "replacedamaged": "Land_i_Shop_01_V1_dam_F",
    ...
    "useractions": {
        "closedoor_1": {
            ...
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_1_sound_source') >= 0.5) && ((this getVariable ['bis_disabled_Door_1', 0]) != 1) && (cameraOn isKindOf 'CAManBase') && ((this animationSourcePhase 'Hitzone_2_source') < 0.99999\t\t\t\t)",
        ...
        "closedoor_2": {
            ...
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_2_sound_source') >= 0.5) && ((this getVariable ['bis_disabled_Door_2', 0]) != 1) && (cameraOn isKindOf 'CAManBase') && ((this animationSourcePhase 'Hitzone_2_source') < 0.99999\t\t\t\t)",
            "displayname": "Close door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
        ...
        "closedoor_4": {
            ...
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_4_sound_source') >= 0.5) && ((this getVariable ['bis_disabled_Door_4', 0]) != 1) && (cameraOn isKindOf 'CAManBase') && ((this animationSourcePhase 'Hitzone_1_source') < 0.99999\t\t\t\t)",
            "displayname": "Close door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
        ...
        "opendoor_1": {
            "actionnamedsel": "Door_1_action",
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_1_sound_source') < 0.5) && (cameraOn isKindOf 'CAManBase') && ((this animationSourcePhase 'Hitzone_2_source') < 0.99999\t\t\t\t)",
        ...
        "opendoor_2": {
            "actionnamedsel": "Door_2_action",
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_2_sound_source') < 0.5) && (cameraOn isKindOf 'CAManBase') && ((this animationSourcePhase 'Hitzone_2_source') < 0.99999\t\t\t\t)",
            "displayname": "Open door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
            "position": "Door_2_trigger",
        ...
        "opendoor_4": {
            "actionnamedsel": "Door_4_action",
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_4_sound_source') < 0.5) && (cameraOn isKindOf 'CAManBase') && ((this animationSourcePhase 'Hitzone_1_source') < 0.99999\t\t\t\t)",
            "displayname": "Open door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
            "position": "Door_4_trigger",
