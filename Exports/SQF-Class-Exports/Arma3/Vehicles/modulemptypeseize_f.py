d = {
    ...
    "moduledescription": {
        ...
        "description": [
            "Create Seize mission mode, compatible both with single- and multiplayer.",
            "",
            "Players are capturing AI controlled sectors.",
            "When they seize all of them, they win.",
            "If they run out of time or respawn tickets, they lose",
            "",
            "Note: Curator spawning costs and limited time or respawns have to be configured separately."
        ],
        "direction": 0,
