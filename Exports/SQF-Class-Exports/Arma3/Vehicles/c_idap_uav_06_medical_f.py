d = {
    "_generalmacro": "C_IDAP_UAV_06_medical_F",
    ...
    "armor": 0.5,
    "armorcrash1": [
        "A3/Sounds_F_Orange/Vehicles/Air/UAV_06/UAV_06_Collission_01",
        0.316228,
        1,
        50
    ],
    "armorcrash2": [
        "A3/Sounds_F_Orange/Vehicles/Air/UAV_06/UAV_06_Collission_02",
        0.316228,
        1,
        50
    ],
    "armorcrash3": [
        "A3/Sounds_F_Orange/Vehicles/Air/UAV_06/UAV_06_Collission_03",
        0.316228,
        1,
        50
    ],
    "armorcrash4": [
        "A3/Sounds_F_Orange/Vehicles/Air/UAV_06/UAV_06_Collission_04",
        0.316228,
        1,
        50
    ],
    ...
    "detectskill": 20,
    "disableinventory": 0,
    "displayname": "Utility Drone (Medical)",
    "dlc": "Orange",
    "driveraction": "",
    "drivercaneject": 0,
    ...
    "editorpreview": "A3/EditorPreviews_F_Orange/Data/CfgVehicles/C_IDAP_UAV_06_medical_F.jpg",
    ...
    "hiddenselectionstextures": [
        "A3/Air_F_Orange/UAV_06/Data/C_IDAP_UAV_06_medical_CO.paa"
    ],
    ...
    "sounds": {
        "engine_01_ext": {
            "frequency": "1  * (1.2 + 0.3  * ((abs(speed) factor [0,\t30]) - (15 - 0)/(30 - 0))) + ((1-engineon) * 0.01*(rpm factor [0,1]))",
            "sound": [
        ...
        "engine_02_ext": {
            "frequency": "1  * (1.2 + 0.3  * ((abs(speed) factor [0,\t30]) - (25 - 0)/(30 - 0))) + ((1-engineon) * 0.01*(rpm factor [0,1]))",
            "sound": [
        ...
        "engine_03_ext": {
            "frequency": "1  * (1.2 + 0.3  * ((abs(speed) factor [0,\t30]) - (29 - 0)/(30 - 0))) + ((1-engineon) * 0.01*(rpm factor [0,1]))",
            "sound": [
        ...
        "engine_idle_int": {
            "frequency": "1  * (1 + 0.3  * ((abs(speed) factor [0,\t30]) - 0)) + ((1-engineon) * 0.01*(rpm factor [0,1]))",
            "sound": [
                "A3/Sounds_F_Orange/Vehicles/Air/UAV_06/UAV_06_Eng_01_Int",
                0.398107,
                1
        ...
        "engine_lateral_movement_01_ext": {
            ...
            "volume": "camPos * (abs(speed) factor[10, 25]) * (angVelocity factor [0.1,2])"
        },
        "engine_lateral_movement_int": {
            ...
            "volume": "(1-camPos) * (abs(speed) factor[10, 25]) * (angVelocity factor [0,4])"
        },
        "idle_ext": {
            "frequency": "1  * (1 + 0.3  * ((abs(speed) factor [0,\t30]) - 0)) +  ((1-engineon) * 0.01*(rpm factor [0,1]))",
            "sound": [
    ...
    "texturesources": {
        ...
        "civ": {
            ...
            "textures": [
                "/A3/Air_F_Orange/UAV_06/Data/C_UAV_06_medical_CO.paa"
            ]
        },
        "eaf": {
            "author": "Bohemia Interactive",
