d = {
    "_generalmacro": "O_Heli_Transport_04_black_F",
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/O_Heli_Transport_04_F.jpg",
    ...
    "faction": "OPF_F",
    "features": "Randomization: No\t\t\t\t\t\t<br />Camo selections: 2 - exterior\t\t\t\t\t\t<br />Script door sources: Door_1_source (pilot's door), Door_2_source (co-pilot's door), Door_3_source (lodamaster's door)\t\t\t\t\t\t<br />Script animations: None\t\t\t\t\t\t<br />Executed scripts: None\t\t\t\t\t\t<br />Available scripts: camo variant /a3/Air_F_Heli/Heli_Transport_04/Scripts/Heli_Transport_04_basic_camo.sqf, black variant /a3/Air_F_Heli/Heli_Transport_04/Scripts/Heli_Transport_04_basic_black.sqf\t\t\t\t\t\t<br />Firing from vehicles: No\t\t\t\t\t\t<br />Slingload: Slingloads up to 13500 kg\t\t\t\t\t\t<br />Cargo proxy indexes: None",
    "featuretype": 0,
    "fireresistance": 10,
    "flarevelocity": 100,
    "forcehidedriver": 0,
