d = {
    ...
    "attributes": {
        ...
        "markercondition": {
            "control": "Edit",
            "defaultvalue": "TRUE",
            "displayname": "Marker Condition",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestPoint_MarkerCondition",
            "tooltip": "Code that must return true for the rest point to become visible on the map.",
            "typename": "STRING"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "name": {
            "control": "Edit",
            "defaultvalue": "localize `str_a3_om_syndikatCommon_Safehouses",
            "displayname": "Name",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestPoint_Name",
            "tooltip": "Display name of this rest point.",
            "typename": "STRING"
        },
        "owner": {
            "control": "Combo",
            ...
            "displayname": "Owner",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestPoint_Owner",
            "tooltip": "",
            "typename": "NUMBER",
            "values": {
                "owner_0": {
        ...
        "paid": {
            ...
            "displayname": "Paid",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestPoint_Paid",
            "tooltip": "If checked, player has to pay to rest here.",
            "typename": "BOOL"
        },
        "restcondition": {
            "control": "Edit",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestPoint_RestCondition",
            "tooltip": "Code that must return true for the rest point to become available.",
            "typename": "STRING"
        },
        "smartmarker": {
            "control": "Edit",
            "defaultvalue": "SmartMarker_C_Sleep_F",
            "displayname": "Smart Marker",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestPoint_SmartMarker",
            "tooltip": "Smart marker class name.",
            "typename": "STRING"
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Rest Point",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_moduleRestPoint",
    "fxexplo": {
        "access": 1
    },
    "getinaction": "",
    ...
    "moduledescription": {
        ...
        "description": "Player is able to rest at synchronized object(s). This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
    ...
    "portrait": "a3/Ui_f/data/IGUI/Cfg/simpleTasks/letters/r_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
