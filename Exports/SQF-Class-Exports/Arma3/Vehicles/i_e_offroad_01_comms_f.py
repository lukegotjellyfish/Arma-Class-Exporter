d = {
    "_generalmacro": "I_E_Offroad_01_comms_F",
    ...
    "animationsources": {
        ...
        "hidedoor3": {
            ...
            "initphase": 0,
            "mass": -4,
            "onphasechanged": "(_this # 0) animateSource ['HideCoverTailGate',_this # 1];",
            "source": "Proxy"
        },
        "hideglass2": {
            "author": "Bohemia Interactive",
        ...
        "opendoor3": {
            ...
            "forceanimatephase": 1,
            "initphase": 0,
            "sound": "Sfx_Offroad_01_Covered_Backdoor",
            "soundposition": "doplnovani",
            "source": "door"
        },
        "proxy": {
            "animperiod": 0.001,
        ...
        "startbeaconlight": {
            "animperiod": 0.01,
            "displayname": "Start beacon light",
            "initphase": 0,
            "onphasechanged": "if((_this # 1) isEqualTo 1 && !is3den)then{(_this # 0) switchLight 'On'}; ",
            "source": "user",
            "usesource": 1
        },
        "wheel_1_1_damper": {
    ...
    "damage": {
        "mat": [
            "A3/soft_F_Enoch/Offroad_01/Data/Offroad_01_cover.rvmat",
            "A3/soft_F_Enoch/Offroad_01/Data/Offroad_01_cover_damage.rvmat",
            "A3/soft_F_Enoch/Offroad_01/Data/Offroad_01_cover_destruct.rvmat",
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/I_E_Offroad_01_comms_F.jpg",
    ...
    "hitpoints": {
        ...
        "hitglass3": {
            "armor": -4,
            "armorcomponent": "cover_tailgate_glass",
            "explosionshielding": 2,
            "material": -1,
            "name": "cover_tailgate_glass",
            "passthrough": 0,
            "radius": 0.5,
            "visual": "cover_tailgate_glass"
        },
        "hitglass4": {
            "armor": 0.1,
            "explosionshielding": 2,
    ...
    "model": "A3/soft_f_enoch/Offroad_01/Offroad_01_covered_F",
    "namesound": "veh_car",
    "newturret": {
        "aggregatereflectors": [],
        "allowlauncherin": 0,
    ...
    "peaktorque": 425,
    "picture": "a3/Soft_F_Enoch/Offroad_01/Data/UI/Offroad_01_comms_F_ca.paa",
    "pilotspec": {
        "showheadphones": 0
    },
    "plateinfos": {
    ...
    "simpleobject": {
        "animate": [
            ...
            [
                "antenna_1_1_horizondive",
                -0.02
            ],
            [
                "antenna_1_1_horizonbank",
                0
            ],
            [
                "antenna_1_1_damper0_x",
                0
            ],
            [
                "antenna_1_1_damper0_y",
                0
            ],
            [
                "antenna_1_2_gmeterx",
            ...
            [
                "antenna_1_2_damper_x",
                0
            ],
            [
                "antenna_1_2_damper_y",
                0
            ],
            [
                "antenna_1_3_gmeterx",
            ...
            [
                "antenna_1_3_horizondive",
                -0.02
            ],
            [
                "antenna_1_3_horizonbank",
                0
            ],
            [
                "antenna_1_3_damper_x",
                0
            ],
            [
                "antenna_1_3_damper_y",
                0
            ],
            [
                "antenna_1_4_gmeterx",
            ...
            [
                "antenna_1_4_damper_x",
                0
            ],
            [
                "antenna_1_4_damper_y",
                0
            ],
            [
                "antenna_2_1_gmeterx",
            ...
            [
                "antenna_2_1_damper_x",
                0
            ],
            [
                "antenna_2_1_damper_y",
                0
            ],
            [
                "antenna_2_2_gmeterx",
            ...
            [
                "antenna_2_2_damper_x",
                0
            ],
            [
                "antenna_2_2_damper_y",
                0
            ],
            [
                "antenna_2_3_gmeterx",
            ...
            [
                "antenna_2_3_horizondive",
                -0.02
            ],
            [
                "antenna_2_3_horizonbank",
                0
            ],
            [
                "antenna_2_3_damper_x",
                0
            ],
            [
                "antenna_2_3_damper_y",
                0
            ],
            [
                "antenna_2_4_gmeterx",
            ...
            [
                "antenna_2_4_horizondive",
                -0.02
            ],
            [
                "antenna_2_4_horizonbank",
                0
            ],
            [
                "antenna_2_4_damper_x",
                0
            ],
            [
                "antenna_2_4_damper_y",
                0
            ],
            [
                "hidecover",
        ...
        "verticaloffset": 1.606,
        "verticaloffsetworld": -0.111
    },
    "simulation": "carx",
    ...
    "transportmagazines": {
        "_xx_30rnd_65x39_caseless_msbs_mag": {
            "count": 8,
    ...
    "turrets": {
        "cargoturret_01": {
            ...
            "ejectdeadgunner": 0,
            "enabledbyanimationsource": "OpenDoor3",
            "forcehidegunner": 0,
            "forcenvg": 0,
            "gun": "",
            "gunbeg": "usti hlavne",
        ...
        "cargoturret_03": {
            ...
            "ejectdeadgunner": 0,
            "enabledbyanimationsource": "HideCover",
            "forcehidegunner": 1,
            "forcenvg": 0,
            "gun": "",
            "gunbeg": "usti hlavne",
    ...
    "useractions": {
        "beacons_start": {
            "animperiod": 2,
            "condition": "driver this == player AND {this animationPhase 'hidePolice' < 0.5 OR this animationPhase 'HideBeacon' < 0.5} AND {this animationSourcePhase 'Beacons' < 0.5}",
            ...
            "priority": 1.5,
            "radius": 2,
            "statement": "this animateSource ['Beacons',1];this animateSource ['StartBeaconLight',1];this switchLight 'On'",
            "useractionid": 50
        },
        "beacons_stop": {
            "animperiod": 2,
            ...
            "priority": 1.5,
            "radius": 2,
            "statement": "this animateSource ['Beacons',0];this animateSource ['StartBeaconLight',0];this switchLight 'On'",
            "useractionid": 51
        },
        "rear_closed": {
            "available": 0,
            "condition": "this doorPhase 'OpenDoor3' > 0.5 AND Alive(this) && {((missionNamespace getVariable ['bis_fnc_moduleRemoteControl_unit', player]) in [this turretUnit [0], this turretUnit [1]])} && {this animationSourcePhase 'hide_door_4_source' < 0.5} && {((this getVariable ['bis_disabled_rearDoors',0]) != 1)}",
            ...
            "showin3d": 17,
            "showwindow": 0,
            "statement": "this animateDoor ['OpenDoor3', 0]",
            "texttooltip": "Close door",
            "useractionid": 63
        },
        "rear_open": {
            "available": 0,
            "condition": "this doorPhase 'OpenDoor3' < 0.5 AND Alive(this) && {((missionNamespace getVariable ['bis_fnc_moduleRemoteControl_unit', player]) in [this turretUnit [0], this turretUnit [1]])} && {this animationSourcePhase 'hide_door_3_source' < 0.5} && {((this getVariable ['bis_disabled_rearDoors',0]) != 1)}",
            ...
            "showin3d": 17,
            "showwindow": 0,
            "statement": "this animateDoor ['OpenDoor3', 1]",
