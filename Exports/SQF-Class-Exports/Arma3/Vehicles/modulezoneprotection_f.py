d = {
    ...
    "arguments": {
        "executionexpression": {
            "defaultvalue": "",
            "description": "Code that gets executed when player is to be killed by the zone protection. If code returns true, default behavior is suppressed.",
            "displayname": "Execution Expression",
            "typename": "STRING"
        },
        "show": {
        ...
        "warningexpression": {
            "defaultvalue": "",
            "description": "Code that gets executed when player triggers the zone protection warning. If code returns true, default behavior is suppressed.",
            "displayname": "Warning Expression",
            "typename": "STRING"
        },
        "warningwidth": {
            "description": "Sets how wide the warning area is.",
            "displayname": "Warning Area Width",
            "typename": "NUMBER",
            "values": {
                "standard": {
                    "default": 1,
