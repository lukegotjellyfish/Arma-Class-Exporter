d = {
    ...
    "alwaystarget": 0,
    "ammo": {
        "_dictAmmoName": "UnderwaterMinePDM_Range_Ammo",
        "access": 3,
    ...
    "lasertarget": 0,
    "library": {
        "libtextdesc": "The PDM-7 is an amphibious mine used in shallow waters against light assault boats and amphibious vehicles. A fuse placed on the base serves to discourage handling of the armed mine."
    },
