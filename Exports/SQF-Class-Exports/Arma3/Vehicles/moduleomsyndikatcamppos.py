d = {
    ...
    "attributes": {
        ...
        "positionbehavior": {
            "control": "Combo",
            "defaultvalue": 0,
            "displayname": "Position Behavior",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleSyndikatCampPos_PositionBehavior",
            "tooltip": "Defines the behavior of the unit on this position.",
            "typename": "NUMBER",
            "values": {
                "nplayanim": {
                    "name": "Play Animation",
        ...
        "positioncode": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleSyndikatCampPos_PositionCode",
            "tooltip": "Code to be executed on start (sector init.).",
            "typename": "STRING"
        },
        "positiontype": {
            "control": "Combo",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleSyndikatCampPos_PositionType",
            "tooltip": "Type of units that can be spawned (e.g. Rifleman, Autorifleman, etc.).",
            "typename": "NUMBER",
            "values": {
                "nat": {
                    "name": "Rifleman (AT)",
    ...
    "detectskill": 20,
    "displayname": "Old Man Insurgent Camp Position",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
