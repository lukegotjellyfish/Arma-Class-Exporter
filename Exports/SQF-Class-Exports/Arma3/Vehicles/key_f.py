d = {
    ...
    "attributes": {
        "arrivetangent": {
            ...
            "property": "ArriveTangent",
            "tooltip": "The arrive tangent associated with this key.",
            "typename": "ARRAY",
            "unique": 0,
            "validate": "none"
        },
        "arrivetangentweight": {
            ...
            "control": "EditShort",
            "defaultvalue": "10.0",
            "displayname": "Arrive Tangent Weight",
            "expression": "_this setVariable ['%s',_value];",
            "property": "ArriveTangentWeight",
            "tooltip": "The arrive tangent weight associated with this key.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        },
        "camerafov": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "CameraFOV",
            "tooltip": "When animating one or several cameras, use this Field of View for this key.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        },
        "event": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "Event",
            "tooltip": "This key is reached during the animation. Place any scripted behavior here.",
            "typename": "STRING",
            "unique": 0,
            "validate": "none"
        },
        "interpmode": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "InterpMode",
            "tooltip": "The Interpolation Mode defines how this point will be interpolated with the next and previous keys.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none",
            "values": {
        ...
        "leavetangent": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "LeaveTangent",
            "tooltip": "The leave tangent associated with this key.",
            "typename": "ARRAY",
            "unique": 0,
            "validate": "none"
        },
        "leavetangentweight": {
            ...
            "control": "EditShort",
            "defaultvalue": "10.0",
            "displayname": "Leave Tangent Weight",
            "expression": "_this setVariable ['%s',_value];",
            "property": "LeaveTangentWeight",
            "tooltip": "The leave tangent weight associated with this key.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        },
        "lockcontrolpoints": {
            ...
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "Lock Control Points",
            "expression": "_this setVariable ['%s',_value];",
            "property": "LockControlPoints",
            "tooltip": "Whether to lock the control points. Moving one of them will also move the other with the inversed relative location.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        },
        "time": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "Time",
            "tooltip": "The time at which to place this key on its owner curve.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        }
    ...
    "eventhandlers": {
        "keyframeanimation": {
            "attributeschanged3den": "_this call BIS_fnc_key_edenAttributesChanged;",
            "connectionchanged3den": "_this call BIS_fnc_key_edenConnectionChanged;",
            "dragged3den": "_this call BIS_fnc_key_edenDragged;",
            "registeredtoworld3den": "_this call BIS_fnc_key_edenRegisteredToWorld;",
            "unregisteredfromworld3den": "_this call BIS_fnc_key_edenUnregisteredFromWorld;"
        }
    },
    "extcameraparams": [
        1
