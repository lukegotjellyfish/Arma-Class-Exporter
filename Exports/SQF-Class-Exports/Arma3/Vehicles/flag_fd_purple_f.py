d = {
    "_generalmacro": "Flag_FD_Purple_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Flag_FD_Purple_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F/Flags/flag_fd_purple_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
