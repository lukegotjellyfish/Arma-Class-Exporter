d = {
    "_generalmacro": "Land_i_House_Small_01_V1_dam_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Land_i_House_Small_01_V1_F.jpg",
    ...
    "useractions": {
        ...
        "closedoor_3": {
            ...
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_3_sound_source') >= 0.5) && ((this getVariable ['bis_disabled_Door_3', 0]) != 1) && (cameraOn isKindOf 'CAManBase') && ((this animationSourcePhase 'Hitzone_2_source') < 0.99999\t\t\t\t)",
            "displayname": "Close door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
        ...
        "opendoor_3": {
            "actionnamedsel": "Door_3_action",
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_3_sound_source') < 0.5) && (cameraOn isKindOf 'CAManBase') && ((this animationSourcePhase 'Hitzone_2_source') < 0.99999\t\t\t\t)",
            "displayname": "Open door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
            "position": "Door_3_trigger",
