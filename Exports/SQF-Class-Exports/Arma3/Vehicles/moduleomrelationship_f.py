d = {
    ...
    "attributes": {
        "allytreshold": {
            "control": "Edit",
            "defaultvalue": -2000,
            "displayname": "Ally Threshold",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRelationship_F_AllyTreshold",
            "tooltip": "Threat level at which player is considered an ally.",
            "typename": "NUMBER"
        },
        "checkbox": {
            "control": "Checkbox",
        ...
        "defaultrating": {
            "control": "Edit",
            "defaultvalue": 0,
            "displayname": "Default Threat Level",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRelationship_F_DefaultRating",
            "typename": "NUMBER"
        },
        "edit": {
            "control": "Edit",
        ...
        "enemytreshold": {
            "control": "Edit",
            "defaultvalue": 100,
            "displayname": "Enemy Threshold",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRelationship_F_EnemyTreshold",
            "tooltip": "Threat level at which player is considered an enemy.",
            "typename": "NUMBER"
        },
        "ignorerestrictedzones": {
            "control": "Checkbox",
            "defaultvalue": "false",
            "displayname": "Ignore Restricted Zones",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRelationship_F_IgnoreRestrictedZones",
            "tooltip": "If set and player is allied with the side (Ally Threshold), then the player is allowed to enter the restricted zones owned by the specified side.",
            "typename": "BOOL"
        },
        "maxrating": {
            "control": "Edit",
            "defaultvalue": 5000,
            "displayname": "Maximum Threat Level",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRelationship_F_MaxRating",
            "typename": "NUMBER"
        },
        "minrating": {
            "control": "Edit",
            "defaultvalue": -5000,
            "displayname": "Minimum Threat Level",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRelationship_F_MinRating",
            "typename": "NUMBER"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "side": {
            ...
            "displayname": "Side",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleRelationship_F_Side",
            "tooltip": "Relationship Side",
            "typename": "NUMBER",
            "values": {
                "east": {
                    "name": "East",
        ...
        "stabilization": {
            "control": "Edit",
            "defaultvalue": 1,
            "displayname": "Threat Level Stabilization",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRelationship_F_stabilization",
            "tooltip": "How quickly threat level diminishes over time (points per second).",
            "typename": "NUMBER"
        },
        "threattreshold": {
            "control": "Edit",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRelationship_F_ThreatTreshold",
            "tooltip": "Threat level at which player is considered a threat.",
            "typename": "NUMBER"
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Relationship",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "moduledescription": {
        ...
        "description": "Set up the relationship with a given side. Do not set up for player's own side. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
