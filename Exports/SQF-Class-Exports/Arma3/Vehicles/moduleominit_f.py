d = {
    ...
    "attributes": {
        ...
        "csataiming": {
            "control": "Edit",
            "defaultvalue": "1",
            "displayname": "OPFOR Aiming Modifier",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmInit_CsatAiming",
            "tooltip": "Global aimingAccuracy adjustment for OPFOR factions.",
            "typename": "NUMBER"
        },
        "default": {
            "expression": "_this setVariable ['%s',_value,true];"
        ...
        "missions": {
            "control": "EditMulti3",
            "defaultvalue": "[]",
            "displayname": "Included Missions",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmInit_Missions",
            "tooltip": "Array of mission names to load. For example: ['csatIsland', 'patrolAreas'].",
            "typename": "STRING"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "path": {
            "control": "Edit",
            "defaultvalue": "/a3/Missions_F_Oldman/Campaign/Missions/",
            "displayname": "Included Mission Paths",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmInit_Path",
            "tooltip": "Path to mission folder in which mission SQFs can be included.",
            "typename": "STRING"
        },
        "syndikataiming": {
            "control": "Edit",
            "defaultvalue": "1",
            "displayname": "INDEPENDENT Aiming Modifier",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmInit_SyndikatAiming",
            "tooltip": "Global aimingAccuracy adjustment for Independent factions.",
            "typename": "NUMBER"
        },
        "units": {
