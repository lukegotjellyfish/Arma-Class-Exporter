d = {
    ...
    "attributes": {
        ...
        "enablesystem": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_enableSystem",
            "tooltip": "If disabled, radio won't be played anywhere.",
            "typename": "BOOL"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "newsperiod": {
            "control": "Combo",
            "defaultvalue": "86400",
            "displayname": "News Frequency",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_newsPeriod",
            "tooltip": "How often news will be played.",
            "typename": "NUMBER",
            "values": {
                "thalf": {
        ...
        "newstypestoplay_events": {
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "Local News",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_NewsTypesToPlay_Events",
            "tooltip": "Play only news stories relating to actual events",
            "typename": "BOOL"
        },
        "newstypestoplay_infection": {
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "Outbreak News",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_NewsTypesToPlay_Infection",
            "tooltip": "Play only news stories relating to \u2018malaria\u2019 outbreaks.",
            "typename": "BOOL"
        },
        "newstypestoplay_manhunt": {
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "Player Manhunt News",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_NewsTypesToPlay_ManHunt",
            "tooltip": "Play also news stories about authorities searching for player.",
            "typename": "BOOL"
        },
        "newstypestoplay_unimportant": {
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "All News",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_NewsTypesToPlay_Unimportant",
            "tooltip": "Play all news stories.",
            "typename": "BOOL"
        },
        "newstypestoplay_weather": {
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "Weather Forecasts",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_NewsTypesToPlay_Weather",
            "tooltip": "Add a weather forecast.",
            "typename": "BOOL"
        },
        "radiochannel": {
            "control": "Combo",
            ...
            "displayname": "Station",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleRadio_channel",
            "tooltip": "The radio station to be played.",
            "typename": "NUMBER",
            "values": {
                "tradiotanoa": {
                    "name": "Radio Tanoa News",
                    "value": 0
                },
                "tradiotanoaretro": {
                    "name": "Radio Tanoa Retro",
                    "value": 2
                },
                "tradiotanoarock": {
                    "name": "Radio Tanoa Rock",
                    "value": 1
                }
            }
        },
    ...
    "function": "BIS_fnc_OM_moduleRadio",
    "functionpriority": 2,
    "fxexplo": {
        "access": 1
    },
    ...
    "moduledescription": {
        ...
        "description": "Sets parameters for radio stations and what content will be aired. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
