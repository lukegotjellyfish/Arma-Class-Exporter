d = {
    "_generalmacro": "B_Static_Designator_01_weapon_F",
    "access": 0,
    "accuracy": 0.2,
    ...
    "artillerytarget": 0,
    "assembleinfo": {
        "assembleto": "B_Static_Designator_01_F",
        "base": [
            ""
        ],
    ...
    "destructioneffects": {},
    "detectskill": 20,
    "displayname": "Remote Designator Bag [NATO]",
    "dlc": "Mark",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "hiddenselectionstextures": [
        "/A3/weapons_f/ammoboxes/bags/data/backpack_compact_mcamo_co.paa"
    ],
