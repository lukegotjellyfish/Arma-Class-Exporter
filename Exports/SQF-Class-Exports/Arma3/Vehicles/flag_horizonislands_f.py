d = {
    "_generalmacro": "Flag_HorizonIslands_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "destructioneffects": {},
    "detectskill": 20,
    "displayname": "Flag (Horizon Islands)",
    "dlc": "Expansion",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "editorpreview": "A3/EditorPreviews_F_Exp/Data/CfgVehicles/Flag_HorizonIslands_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F_Exp/Flags/flag_Tanoa_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
