d = {
    ...
    "attributes": {
        "tangenttype": {
            "control": "combo",
            "defaultvalue": "0",
            "displayname": "Tangent Type",
            "expression": "_this setVariable ['%s',_value];",
            "property": "TangentType",
            "tooltip": "This control point\u2019s type.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none",
            "values": {
    ...
    "detectskill": 20,
    "displayname": "Rich Curve Key Control Point",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "eventhandlers": {
        "keyframeanimation": {
            "attributeschanged3den": "_this call BIS_fnc_controlPoint_edenAttributesChanged;",
            "connectionchanged3den": "_this call BIS_fnc_controlPoint_edenConnectionChanged;",
            "dragged3den": "_this call BIS_fnc_controlPoint_edenDragged;",
            "registeredtoworld3den": "_this call BIS_fnc_controlPoint_edenRegisteredToWorld;",
            "unregisteredfromworld3den": "_this call BIS_fnc_controlPoint_edenUnregisteredFromWorld;"
        }
    },
    "extcameraparams": [
        1
