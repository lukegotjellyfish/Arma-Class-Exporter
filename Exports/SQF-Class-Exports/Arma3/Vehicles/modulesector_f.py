d = {
    ...
    "moduledescription": {
        ...
        "description": [
            "Add a contested sector.",
            "Side with the strongest force within the area (calculated by number and type of the units) will be capturing it.",
            "Delete or disable the sector module to 'finalize' the sector. Once done, capturing will be disabled and the last owner will retain control forever."
        ],
        "direction": 0,
