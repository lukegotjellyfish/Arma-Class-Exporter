d = {
    ...
    "attributes": {
        ...
        "reputationlevelmax": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleReputationLevel_Max",
            "tooltip": "Value defining the maximum threat level that can be reached.",
            "typename": "NUMBER"
        },
        "reputationlevelmin": {
            "control": "Edit",
            "defaultvalue": "-3",
            "displayname": "Lowest Level",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleReputationLevel_Min",
            "tooltip": "Value defining the minimum threat level that can be reached.",
            "typename": "NUMBER"
        },
        "reputationlevelstart": {
            "control": "Edit",
            "defaultvalue": "0",
            "displayname": "Start Level",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleReputationLevel_Start",
            "tooltip": "The default reputation level which will be set on system activation.",
            "typename": "NUMBER"
        },
        "reputationlevelwidth": {
            "control": "Edit",
            "defaultvalue": "600",
            "displayname": "Level Scope",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleReputationLevel_Width",
            "tooltip": "How many points are needed to reach the next / previous level.",
            "typename": "NUMBER"
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Reputation",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_moduleReputation",
    "functionpriority": 2,
    "fxexplo": {
        "access": 1
    },
    ...
    "moduledescription": {
        ...
        "description": "Reputation calculated in conjunction with the Relationship module. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
