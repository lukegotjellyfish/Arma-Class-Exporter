d = {
    ...
    "attributes": {
        "enablehud": {
            ...
            "property": "EnableHUD",
            "tooltip": "Whether to allow HUD to be visible when this camera is the view point of the player.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        },
        "focus": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "Focus",
            "tooltip": "Focus Range is in format [distance, blur]. This sets the camera focus blur.",
            "typename": "ARRAY",
            "unique": 0,
            "validate": "none"
        },
        "fov": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "FOV",
            "tooltip": "The default field of view of this camera.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        },
        "showcinemaborders": {
            ...
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "Show Cinema Borders",
            "expression": "_this setVariable ['%s',_value];",
            "property": "ShowCinemaBorders",
            "tooltip": "Whether or not to show cinema borders when this camera is the view point of the player.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        },
        "switchtoatstart": {
            ...
            "control": "Checkbox",
            "defaultvalue": "false",
            "displayname": "Switch To At Start",
            "expression": "_this setVariable ['%s',_value];",
            "property": "SwitchToAtStart",
            "tooltip": "Whether to switch to this camera when the mission starts.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        },
        "visionmode": {
            "control": "combo",
            "defaultvalue": "0",
            "displayname": "Vision Mode",
            "expression": "_this setVariable ['%s',_value];",
            "property": "VisionMode",
            "tooltip": "The vision mode of this camera.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none",
            "values": {
    ...
    "eventhandlers": {
        "keyframeanimation": {
            "attributeschanged3den": "_this call BIS_fnc_camera_edenAttributesChanged;",
            "connectionchanged3den": "_this call BIS_fnc_camera_edenConnectionChanged;",
            "deleted": "if (is3DEN) then {_this call BIS_fnc_camera_edenDeleted} else {_this call BIS_fnc_camera_deleted};",
            "init": "if (is3DEN) then {_this call BIS_fnc_camera_edenInit} else {_this call BIS_fnc_camera_init};",
            "registeredtoworld3den": "_this call BIS_fnc_camera_edenRegisteredToWorld;",
            "unregisteredfromworld3den": "_this call BIS_fnc_camera_edenUnregisteredFromWorld;"
        }
    },
    "extcameraparams": [
        1
