d = {
    ...
    "attributes": {
        ...
        "useanims": {
            "control": "Checkbox",
            "defaultvalue": "TRUE",
            "displayname": "Random Speaker Animations",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRandomConversation_UseAnims",
            "tooltip": "Allows random animations for speakers. Disable this if the units are sitting down etc.",
            "typename": "BOOL"
        }
    },
    "attributesbase": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Random Conversations",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "moduledescription": {
        ...
        "description": "Synchronize one or two units to talk to each other or to the player. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
    ...
    "portrait": "a3/Ui_f/data/IGUI/Cfg/simpleTasks/letters/c_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
