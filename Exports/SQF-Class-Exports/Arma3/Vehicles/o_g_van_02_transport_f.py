d = {
    "_generalmacro": "O_G_Van_02_transport_F",
    "accelaidforcecoef": 4,
    ...
    "editorpreview": "A3/EditorPreviews_F_Orange/Data/CfgVehicles/O_G_Van_02_transport_F.jpg",
    ...
    "icon": "a3/Soft_F_Orange/Van_02/Data/UI/Map_Van_02_transport_CA.paa",
    "idlerpm": 900,
    ...
    "model": "a3/Soft_F_Orange/Van_02/Van_02_transport_F.p3d",
    ...
    "peaktorque": 836,
    "picture": "a3/Soft_F_Orange/Van_02/Data/UI/Van_02_transport_CA.paa",
    "pilotspec": {
        "showheadphones": 0
    },
    "plateinfos": {
    ...
    "simpleobject": {
        ...
        "verticaloffset": 1.523,
        "verticaloffsetworld": -0.209
    },
    "simulation": "carx",
    ...
    "texturesources": {
        ...
        "idap": {
            ...
            "textures": [
                "/a3/Soft_F_Orange/Van_02/Data/van_body_IdapTrans_CO.paa",
                "/a3/Soft_F_Orange/Van_02/Data/van_wheel_transport_dirty_CO.paa",
        ...
        "ldf_mp": {
            "author": "Bohemia Interactive",
            "displayname": "LDF Military Police",
            "factions": [
                "IND_E_F"
            ],
            "materials": [
    ...
    "useractions": {
        ...
        "sidedoor_close": {
            "available": 0,
            "condition": "this doorPhase 'Door_3_source' > 0.5 AND Alive(this) && {((missionNamespace getVariable ['bis_fnc_moduleRemoteControl_unit', player]) in [this turretUnit [0]])} && {this animationSourcePhase 'hide_door_3_source' < 0.5} && {((this getVariable ['bis_disabled_sideDoor',0]) != 1)}",
