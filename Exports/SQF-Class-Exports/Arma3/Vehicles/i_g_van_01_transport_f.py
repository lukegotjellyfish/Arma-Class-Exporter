d = {
    "_generalmacro": "I_G_Van_01_transport_F",
    ...
    "damage": {
        "mat": [
            ...
            "A3/soft_f_gamma/van_01/Data/van_01_ext_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_ext_destruct.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_base.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_base_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_base_destruct.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_board.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_board_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_board_destruct.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_base_VP.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_base_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_base_destruct.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_board_VP.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_board_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_int_board_destruct.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_tank.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_tank_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_tank_destruct.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_adds.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_adds_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_adds_destruct.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_glass.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_glass_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_glass_damage.rvmat",
            "A3/data_f/Glass_veh.rvmat",
            "A3/data_f/Glass_veh_damage.rvmat",
            "A3/data_f/Glass_veh_damage.rvmat",
            "A3/soft_f_gamma/van_01/Data/van_01_glass_int.rvmat",
            "A3/data_f/Glass_veh_damage.rvmat",
            "A3/data_f/Glass_veh_damage.rvmat"
        ],
        "tex": []
    ...
    "faction": "IND_G_F",
    "features": "Randomization: Yes, 8 skins, disabled by: this setVariable [`BIS_enableRandomization`,false];\t\t\t\t\t\t<br />Specific skin may be set by: this setVariable [`color`,X]; (the number ranges from 0 to 7)\t\t\t\t\t\t<br />Camo selections: 2 - cabin and rear\t\t\t\t\t\t<br />Script door sources: None\t\t\t\t\t\t<br />Script animations: None\t\t\t\t\t\t<br />Executed scripts: /A3/Soft_F_Bootcamp/Van_01/scripts/randomize_transport.sqf, /A3/soft_f_gamma/van_01/scripts/clock.sqf \t\t\t\t\t\t<br />Firing from vehicles: No\t\t\t\t\t\t<br />Slingload: Slingloadable\t\t\t\t\t\t<br />Cargo proxy indexes: 1 and 2",
    "featuretype": 0,
    "fireresistance": 10,
    "forcehidedriver": 0,
    "formationtime": 5,
    ...
    "simpleobject": {
        ...
        "verticaloffset": 1.754,
        "verticaloffsetworld": -0.117
    },
    "simulation": "carx",
    ...
    "soundengineoffext": [
        "A3/Sounds_F/vehicles2/soft/Van_01/Van_01_Engine_Ext_Stop",
        1.99526,
        1,
        50
    ],
    "soundengineoffint": [
        "A3/Sounds_F/vehicles2/soft/Van_01/Van_01_Engine_Int_Stop",
        0.562341,
        1
    ],
    "soundengineonext": [
        "A3/Sounds_F/vehicles2/soft/Van_01/Van_01_Engine_Ext_Start",
        1.99526,
        1,
        50
    ],
    "soundengineonint": [
        "A3/Sounds_F/vehicles2/soft/Van_01/Van_01_Engine_Int_Start",
        0.707946,
        1
    ],
    "soundenviron": [
    ...
    "soundgetin": [
        "A3/Sounds_F/vehicles2/soft/Van_01/Van_01_Enter",
        0.446684,
        1
    ],
    "soundgetout": [
        "A3/Sounds_F/vehicles2/soft/Van_01/Van_01_Exit",
        0.446684,
        1,
        40
    ],
    ...
    "turrets": {
        "cargoturret_l1": {
            ...
            "memorypointgunneroptics": "gunnerview",
            "memorypointgunneroutoptics": "",
            "memorypointsgetingunner": "pos cargo L1",
            "memorypointsgetingunnerdir": "pos cargo L1 dir",
            "memorypointsgetingunnerprecise": "",
            "mgunclouds": {
                "access": 0,
                "cloudletaccy": 0,
        ...
        "cargoturret_l4": {
            ...
            "gunnerlefthandanimname": "",
            "gunnerleftleganimname": "",
            "gunnername": "Passenger (Left Seat 4)",
            "gunneropticscolor": [
                0,
                0,
                0,
        ...
        "cargoturret_l5": {
            ...
            "gunnerlefthandanimname": "",
            "gunnerleftleganimname": "",
            "gunnername": "Passenger (Left Seat 5)",
            "gunneropticscolor": [
                0,
                0,
                0,
        ...
        "cargoturret_r1": {
            ...
            "memorypointgunneroptics": "gunnerview",
            "memorypointgunneroutoptics": "",
            "memorypointsgetingunner": "pos cargo R1",
            "memorypointsgetingunnerdir": "pos cargo R1 dir",
            "memorypointsgetingunnerprecise": "",
            "mgunclouds": {
                "access": 0,
                "cloudletaccy": 0,
        ...
        "cargoturret_r4": {
            ...
            "gunnerlefthandanimname": "",
            "gunnerleftleganimname": "",
            "gunnername": "Passenger (Right Seat 4)",
            "gunneropticscolor": [
                0,
                0,
                0,
        ...
        "cargoturret_r5": {
            ...
            "gunnerlefthandanimname": "",
            "gunnerleftleganimname": "",
            "gunnername": "Passenger (Right Seat 5)",
            "gunneropticscolor": [
                0,
                0,
                0,
