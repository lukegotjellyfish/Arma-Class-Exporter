d = {
    ...
    "attributes": {
        ...
        "hidelocally": {
            "control": "Checkbox",
            "defaultvalue": "false",
            "displayname": "Operate Locally",
            "expression": "_this setVariable [`#hideLocally`,_value]",
            "property": "#hideLocally",
            "tooltip": "Force the module to hide objects locally on each client. This option is recommended for MP scenarios with thousands of objects to hide, otherwise it is usually better to keep the module operating globally."
        },
        "moduledescription": {
            "control": "ModuleInfo",
            "property": "ModuleInfo"
        ...
        "objecttypefilter": {
            "control": "ObjectTypeFilterWithCounter",
            "defaultvalue": "15",
    ...
    "detectskill": 20,
    "displayname": "Hide Terrain Objects",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "bis_fnc_moduleHideTerrainObjects",
    "functionpriority": 25,
    "fxexplo": {
        "access": 1
    },
