d = {
    ...
    "attributes": {
        ...
        "incomesum": {
            ...
            "displayname": "Income",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleEconomy_incomeSum",
            "tooltip": "How much money will be added periodically.",
            "typename": "NUMBER"
        },
        "incometime": {
            "control": "Edit",
            "defaultvalue": "60",
            "displayname": "Time Between Payments",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleEconomy_incomeTime",
            "tooltip": "Select the time period after a sum will be added. The given value will be calculated in minutes.",
            "typename": "NUMBER"
        },
        "initialsum": {
            "control": "Edit",
            "defaultvalue": "10",
            "displayname": "Starting Sum of Money",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "BIS_ModuleEconomy_initialSum",
            "tooltip": "How much money the player will have on start.",
            "typename": "NUMBER"
        },
        "moduledescription": {
            "control": "ModuleInfo",
    ...
    "function": "BIS_fnc_OM_moduleEconomy",
    "functionpriority": 2,
    "fxexplo": {
        "access": 1
    },
    ...
    "moduledescription": {
        ...
        "description": "Manage player income and starting money. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
