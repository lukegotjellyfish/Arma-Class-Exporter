d = {
    ...
    "animationsources": {
        ...
        "valve_source": {
            "animperiod": 2,
            "initphase": 0,
            "sound": "Sfx_DeconShowerSmall_Valves",
            "soundposition": "valve_1_axis",
            "source": "user"
        }
    },
    ...
    "attributes": {
        "decon_shower": {
            ...
            "expression": "if(_value)then{[_this,1.5,9] spawn bin_fnc_deconShowerAnim;};",
    ...
    "mingforce": 0.2,
    "minheight": 0.1,
    "model": "a3/Props_F_Enoch/Military/Decontamination/DeconShower_01_F.p3d",
    ...
    "useractions": {
        "activate": {
            ...
            "position": "",
            "radius": 1.7,
            "statement": "player playActionNow 'PutDown';[this,1.5,9] spawn bin_fnc_deconShowerAnim"
        },
        "deactivate": {
            "actionnamedsel": "ControlBox_Action",
