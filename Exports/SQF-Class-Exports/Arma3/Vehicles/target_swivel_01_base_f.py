d = {
    "_generalmacro": "Target_Swivel_01_base_F",
    "access": 0,
    "accuracy": 0.2,
    ...
    "eventhandlers": {
        ...
        "init": "(_this select 0) setVariable ['BIS_angleMin', 0]; (_this select 0) setVariable ['BIS_angleMax', 180]; (_this select 0) execVM '/A3/Structures_F_Mark/Training/Scripts/Target_Swivel_01_F_init.sqf';"
    },
    "extcameraparams": [
        1
    ],
