d = {
    "_generalmacro": "Land_MedicalTent_01_wdl_generic_closed_F",
    "access": 0,
    "accuracy": 0.1,
    ...
    "attributes": {
        ...
        "solarpanel1_hide": {
            "control": "CheckboxNumber",
            "defaultvalue": 1,
            "displayname": "Hide solar panel #1",
            "expression": "_this animateSource ['%s',_value,true]",
        ...
        "solarpanel2_hide": {
            "control": "CheckboxNumber",
            "defaultvalue": 0,
            "displayname": "Hide solar panel #2",
            "expression": "_this animateSource ['%s',_value,true]",
    ...
    "detectskill": 20,
    "disableinventory": 1,
    "displayname": "Tent (Field, Closed) [LDF]",
    "dlc": "Orange",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/Land_MedicalTent_01_wdl_generic_closed_F.jpg",
    ...
    "hiddenselectionstextures": [
        "A3/Structures_F_Enoch/Military/Camps/data/MedicalTent_01_wdl_F_CO.paa"
    ],
