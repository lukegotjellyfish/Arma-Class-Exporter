d = {
    ...
    "mingforce": 0.2,
    "minheight": 0.1,
    "model": "a3/Props_F_Enoch/Items/Tools/AluminiumFoil_01.p3d",
    ...
    "useractions": {
        "makehat": {
            ...
            "displayname": "Make a hat",
            "displaynamedefault": "<img image='/a3/Props_F_Enoch/Items/Tools/Data/tinfoil_action_ca.paa' size='2.5' />",
            "onlyforplayer": 1,
            "position": "",
            "priority": 0.1,
            "radius": 2.5,
            "shortcut": "",
            "showwindow": 1,
            "statement": "[this] execVM 'a3/Props_F_Enoch/Items/Tools/scripts/makeHat.sqf'"
        }
    },
