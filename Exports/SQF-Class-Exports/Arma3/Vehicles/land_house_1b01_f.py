d = {
    ...
    "damage": {
        "mat": [
            ...
            "A3/Structures_F_Enoch/Civilian/Houses/data/housev_2i_redold_bricks.rvmat",
            "A3/Structures_F_Enoch/Civilian/Houses/data/destruct_housev_2i_redold_bricks.rvmat",
            "A3/Structures_F_Enoch/Civilian/Houses/data/destruct_housev_2i_redold_bricks.rvmat",
            "A3/Structures_F_Enoch/Civilian/Houses/data/housev_2i_roof_wood_door_planks.rvmat",
            "A3/Structures_F_Enoch/Civilian/Houses/data/destruct_housev_2i_roof_wood_door_planks.rvmat",
            "A3/Structures_F_Enoch/Civilian/Houses/data/destruct_housev_2i_roof_wood_door_planks.rvmat",
            "A3/Structures_F_Enoch/Civilian/Houses/data/housev_2i_int_multi.rvmat",
            "A3/Structures_F_Enoch/Civilian/Houses/data/destruct_housev_2i_int_multi.rvmat",
            "A3/Structures_F_Enoch/Civilian/Houses/data/destruct_housev_2i_int_multi.rvmat"
        ],
        "tex": [
