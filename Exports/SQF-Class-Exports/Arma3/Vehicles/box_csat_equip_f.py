d = {
    "_generalmacro": "Box_CSAT_Equip_F",
    "access": 0,
    "accuracy": 0.2,
    ...
    "displayname": "Equipment Box [CSAT]",
    "dlc": "Expansion",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "transportitems": {
        ...
        "_xx_h_cap_brn_specops": {
            "count": 2,
            "name": "H_Cap_brn_SPECOPS"
        },
        "_xx_h_crewhelmetheli_o": {
            "count": 2,
        ...
        "_xx_h_helmetcrew_o_ghex_f": {
            "count": 2,
            "name": "H_HelmetCrew_O_ghex_F"
        },
        "_xx_h_helmetleadero_ghex_f": {
            "count": 2,
            "name": "H_HelmetLeaderO_ghex_F"
        },
        "_xx_h_helmetleadero_ocamo": {
            "count": 2,
            "name": "H_HelmetLeaderO_ocamo"
        },
        "_xx_h_helmetleadero_oucamo": {
            "count": 2,
            "name": "H_HelmetLeaderO_oucamo"
        },
        "_xx_h_helmeto_ghex_f": {
            "count": 2,
        ...
        "_xx_h_helmeto_oucamo": {
            "count": 2,
            "name": "H_HelmetO_oucamo"
        },
        "_xx_h_helmeto_vipersp_ghex_f": {
            "count": 2,
            "name": "H_HelmetO_ViperSP_ghex_F"
        },
        "_xx_h_helmeto_vipersp_hex_f": {
            "count": 2,
            "name": "H_HelmetO_ViperSP_hex_F"
        },
        "_xx_h_helmetspeco_blk": {
            "count": 2,
            "name": "H_HelmetSpecO_blk"
        },
        "_xx_h_helmetspeco_ghex_f": {
            "count": 2,
            "name": "H_HelmetSpecO_ghex_F"
        },
        "_xx_h_helmetspeco_ocamo": {
            "count": 2,
        ...
        "_xx_h_pilothelmetfighter_o": {
            "count": 2,
            "name": "H_PilotHelmetFighter_O"
        },
        "_xx_h_pilothelmetheli_o": {
            "count": 2,
            "name": "H_PilotHelmetHeli_O"
        },
        "_xx_h_shemagopen_khk": {
            "count": 2,
            "name": "H_ShemagOpen_khk"
        },
        "_xx_h_shemagopen_tan": {
            "count": 2,
