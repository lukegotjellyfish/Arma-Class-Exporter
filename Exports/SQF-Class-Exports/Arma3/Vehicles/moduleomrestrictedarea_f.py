d = {
    ...
    "attributes": {
        ...
        "condition": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestrictedArea_Condition",
            "tooltip": "Condition for activation of the restricted area.",
            "typename": "STRING"
        },
        "default": {
            "expression": "_this setVariable ['%s',_value,true];"
        ...
        "restrictedarea": {
            "control": "CheckboxNumber",
            "defaultvalue": "1",
            "displayname": "Area Restricted",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestrictedArea_Restricted",
            "tooltip": "Set if restricted area is enabled.",
            "typename": "NUMBER"
        },
        "side": {
            "control": "Combo",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmRestrictedArea_Owner",
    ...
    "detectskill": 20,
    "displayname": "Old Man Restricted Area",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "moduledescription": {
        ...
        "description": "Sets up restricted areas which will raise player's threat level if seen within it. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
