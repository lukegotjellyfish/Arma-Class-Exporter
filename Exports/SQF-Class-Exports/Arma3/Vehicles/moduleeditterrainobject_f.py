d = {
    ...
    "attributes": {
        "allowdamage": {
            ...
            "tooltip": "Controls if the object can be damaged after it was edited by the module."
        },
        "checkbox": {
            "control": "Checkbox",
            "defaultvalue": "false",
        ...
        "doorstates": {
            "control": "DoorStatesModule",
            "defaultvalue": "[0,0,0]",
            "displayname": "Doors States",
            "expression": "_this setVariable [`#doorStates`,_value]",
            "property": "#doorStates",
            "tooltip": "Set closed, locked or opened state for terrain object doors./n/nLMB - cycle between states/nRMB - close door (reset to default state)/nLMB + Alt - open door/nLMB + Shift - lock door/nLMB + Ctrl - close door"
        },
        "edit": {
            "control": "Edit",
            "defaultvalue": "''",
        ...
        "objectinit": {
            ...
            "defaultvalue": "''",
            "displayname": "Global Object Init",
            "expression": "_this setVariable [`#init`,_value]",
            "property": "#init",
            "tooltip": "Code executed on terrain object (referenced as _this) after edits are done. Code is executed everywhere, clients joining in progress are also supported./n/nNote: In multiplayer scenarios, code is sent from server to each client over the network. Try to make the code as short as possible.",
            "value": "''"
        },
        "objectinitserver": {
            "control": "EditCodeMulti3",
            "defaultvalue": "''",
            "displayname": "Object Init",
            "expression": "_this setVariable [`#initServer`,_value]",
            "property": "#initServer",
            "tooltip": "Code executed on terrain object (referenced as _this) after edits are done. Code is executed only on server (or in single player).",
            "value": "''"
        },
        "objectname": {
            "control": "EditCode",
            ...
            "property": "#name",
            "tooltip": "Name of global variable referencing edited terrain object."
        },
        "objectstate": {
            "control": "ObjectState",
            "defaultvalue": 0,
            "displayname": "Object States",
            "expression": "_this setVariable [`#state`,_value]",
            "property": "#state",
            "tooltip": "Select damage or visibility state of selected terrain object.",
            "value": 0
        },
        "objecttypefilter": {
            "control": "ObjectTypeFilter",
            "defaultvalue": "7",
            "displayname": "Object Types",
            "expression": "_this setVariable [`#filter`,_value]",
            "property": "#filter",
            "tooltip": "Select types of terrain objects affected by module. Other object types will be ignored."
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Edit Terrain Object",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "bis_fnc_moduleEditTerrainObject",
    "functionpriority": 25,
    "fxexplo": {
        "access": 1
    },
    ...
    "portrait": "A3/Modules_F/Data/EditTerrainObject/icon32_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
