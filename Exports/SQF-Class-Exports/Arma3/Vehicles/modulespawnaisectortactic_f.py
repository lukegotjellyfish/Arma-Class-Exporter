d = {
    ...
    "moduledescription": {
        ...
        "description": [
            "Module controls behavior of groups spawned by [Spawn AI] module. If no [Spawn AI] modules are synced to the module, the module controls all of the spawned groups. If there are some [Spawn AI] modules synced with the module, only groups belonging to those synced modules are being controlled."
        ],
        "direction": 0,
