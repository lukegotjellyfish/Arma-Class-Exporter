d = {
    "_generalmacro": "Land_Radar_01_antenna_base_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "destructioneffects": {},
    "detectskill": 20,
    "displayname": "Radar Complex (Antenna Base)",
    "dlc": "Enoch",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/Land_Radar_01_antenna_base_F.jpg",
    ...
    "model": "A3/Structures_F_Enoch/Military/Radar/Radar_01_antenna_base_F.p3d",
    ...
    "simpleobject": {
        "animate": [
            ...
            [
                "door18_geo_translation_beg",
                0
            ],
            [
                "door18_geo_translation_end",
                0
            ]
        ],
        "eden": 0,
    ...
    "useractions": {
        ...
        "closedoor_16": {
            ...
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_16_sound_source') >= 0.5) && ((this getVariable ['bis_disabled_Door_16', 0]) != 1) && (cameraOn isKindOf 'CAManBase')",
            "displayname": "Close door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
        ...
        "closedoor_17": {
            ...
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_17_sound_source') >= 0.5) && ((this getVariable ['bis_disabled_Door_17', 0]) != 1) && (cameraOn isKindOf 'CAManBase')",
            "displayname": "Close door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
        ...
        "opendoor_16": {
            "actionnamedsel": "Door_16_action",
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_16_sound_source') < 0.5) && (cameraOn isKindOf 'CAManBase')",
            "displayname": "Open door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
            "position": "Door_16_trigger",
        ...
        "opendoor_17": {
            "actionnamedsel": "Door_17_action",
            "aimaxrange": 5.25,
            "condition": "((this animationSourcePhase 'Door_17_sound_source') < 0.5) && (cameraOn isKindOf 'CAManBase')",
            "displayname": "Open door",
            "displaynamedefault": "<img image='/A3/Ui_f/data/IGUI/Cfg/Actions/open_door_ca.paa' size='2.5' />",
            "onlyforplayer": 0,
            "position": "Door_17_trigger",
