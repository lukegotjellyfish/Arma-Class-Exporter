d = {
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Flag_Blueking_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F_Kart/Flags/flag_bluking1_co.paa'"
    },
    "extcameraparams": [
        1
    ],
