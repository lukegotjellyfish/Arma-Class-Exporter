d = {
    ...
    "attributes": {
        "chanceofspawn": {
            ...
            "property": "ModulePatrolArea_F_Probability",
            "tooltip": "Probability of spawning one unit (checked every 10 seconds).",
            "typename": "NUMBER"
        },
        "checkbox": {
            "control": "Checkbox",
        ...
        "condition": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModulePatrolArea_F_Condition",
            "tooltip": "Code that has to return true for spawning the patrol.",
            "typename": "STRING"
        },
        "default": {
            "expression": "_this setVariable ['%s',_value,true];"
        ...
        "maxspawned": {
            "control": "Edit",
            "defaultvalue": 3,
            "displayname": "Max Spawned Units",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModulePatrolArea_F_MaxSpawned",
            "tooltip": "Maximum number of units that can be spawned.",
            "typename": "NUMBER"
        },
        "moduledescription": {
            "control": "ModuleInfo",
        ...
        "replenish": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModulePatrolArea_F_Replenish",
            "tooltip": "If checked, the area will be constantly reinforced.",
            "typename": "BOOL"
        },
        "spawndistance": {
            "control": "Edit",
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModulePatrolArea_F_Distance",
            "tooltip": "The distance from the outer edge of the module that units should be spawned.",
            "typename": "NUMBER"
        },
        "timeout": {
            "control": "Edit",
            "defaultvalue": 600,
            "displayname": "Next Spawn Timeout:",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModulePatrolArea_F_Timeout",
            "tooltip": "Timeout before another QRF is dispatched to sector.",
            "typename": "NUMBER"
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Patrol Area",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "portrait": "a3/Ui_f/data/IGUI/Cfg/simpleTasks/letters/p_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
