d = {
    ...
    "hiddenselectionstextures": [
        "/a3/Supplies_F_Enoch/Ammoboxes/Data/equipment_box_EAF_co.paa",
        "/a3/Supplies_F_Enoch/Ammoboxes/Data/equipment_box_EAF_ca.paa"
    ],
    ...
    "transportitems": {
        ...
        "_xx_h_crewhelmetheli_i_e": {
            "count": 2,
            "name": "H_CrewHelmetHeli_I_E"
        },
        "_xx_h_helmetcrew_i_e": {
            "count": 2,
            "name": "H_HelmetCrew_I_E"
        },
        "_xx_h_helmethbk_chops_f": {
            "count": 10,
            "name": "H_HelmetHBK_chops_F"
        },
        "_xx_h_helmethbk_ear_f": {
            "count": 10,
            "name": "H_HelmetHBK_ear_F"
        },
        "_xx_h_helmethbk_headset_f": {
            "count": 10,
        ...
        "_xx_h_pilothelmetfighter_i_e": {
            "count": 2,
            "name": "H_PilotHelmetFighter_I_E"
        },
        "_xx_h_pilothelmetheli_i_e": {
            "count": 2,
        ...
        "_xx_v_bandollierb_oli": {
            "count": 2,
            "name": "V_BandollierB_oli"
        },
        "_xx_v_carrierrigkbt_01_eaf_f": {
            "count": 2,
            "name": "V_CarrierRigKBT_01_EAF_F"
        },
        "_xx_v_carrierrigkbt_01_heavy_eaf_f": {
            "count": 2,
            "name": "V_CarrierRigKBT_01_heavy_EAF_F"
        },
        "_xx_v_carrierrigkbt_01_light_eaf_f": {
            "count": 2,
