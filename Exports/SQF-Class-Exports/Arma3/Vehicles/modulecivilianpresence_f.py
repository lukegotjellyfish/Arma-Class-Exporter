d = {
    ...
    "attributes": {
        ...
        "civilianpresence_debug": {
            "control": "Checkbox",
            "defaultvalue": "false",
            "displayname": "Debug",
            "expression": "_this setVariable [`#debug`,_value]",
            "property": "#debug",
            "tooltip": "Draw debug lines and icons in 3D to visualize state and behavior of controlled civilians.",
            "value": 0
        },
        "civilianpresence_description": {
            "control": "SubCategoryNoHeader2",
            "data": "AttributeSystemSubcategory",
            "description": "Module creates ambient civilian units and controls their 'endangered' behavior. Other 'Civilian Presence' modules extend the core behavior.",
            "displayname": "",
            "tooltip": ""
        },
        "civilianpresence_oncreated": {
            "control": "EditCodeMulti5",
            "displayname": "Code On Unit Created",
            "expression": "_this setVariable [`#onCreated`,compile _value]",
            "property": "#onCreated",
            "tooltip": "Code executed on each civilian created by Civilian Presence module. Unit is referenced in the code as _this.",
            "validate": "string"
        },
        "civilianpresence_ondeleted": {
            "control": "EditCodeMulti5",
            "displayname": "Code On Unit Deleted",
            "expression": "_this setVariable [`#onDeleted`,compile _value]",
            "property": "#onDeleted",
            "tooltip": "Code executed on each civilian deleted by Civilian Presence module. Unit is referenced in the code as _this.",
            "validate": "string"
        },
        "civilianpresence_unitcount": {
            "control": "CivilianPresence_UnitCount",
            "defaultvalue": 5,
            "displayname": "Civilian Count",
            "expression": "_this setVariable [`#unitCount`,_value]",
            "property": "#unitCount",
            "tooltip": "Select how many civilian units should be created and handled by the module. Module will create 1 civilian on each 'Civilian Presence: Unit' module and then occasionally create civilian units at random to reach the population count in case units get killed or deleted.",
            "value": 5
        },
        "civilianpresence_useagents": {
            "control": "Checkbox",
            "defaultvalue": "true",
            "displayname": "Use Agents",
            "expression": "_this setVariable [`#useAgents`,_value]",
            "property": "#useAgents",
            "tooltip": "Controls if civilians should be created as agents (units with simplified behavior) or standard units.",
            "value": 0
        },
        "civilianpresence_usepanicmode": {
            "control": "Checkbox",
            "defaultvalue": "false",
            "displayname": "Use Panic Action",
            "expression": "_this setVariable [`#usePanicMode`,_value]",
            "property": "#usePanicMode",
            "tooltip": "Controls if civilians should use 'Panic' action when fleeing from danger.",
            "value": 0
        },
        "combo": {
            "control": "Combo",
    ...
    "function": "bis_fnc_moduleCivilianPresence",
    "functionpriority": 25,
    "fxexplo": {
        "access": 1
    },
