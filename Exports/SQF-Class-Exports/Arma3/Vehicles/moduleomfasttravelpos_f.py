d = {
    ...
    "attributes": {
        ...
        "travelcondition": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmFastTravel_RestCondition",
            "tooltip": "Code that must return true for the Fast Travel point to become available.",
            "typename": "STRING"
        },
        "units": {
    ...
    "detectskill": 20,
    "displayname": "Old Man Fast Travel Position",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "moduledescription": {
        ...
        "description": "Defines the position where the player should be transported to after Fast Travel. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
