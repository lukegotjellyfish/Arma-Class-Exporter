d = {
    ...
    "editorpreview": "A3/EditorPreviews_F_Exp/Data/CfgVehicles/Flag_CTRG_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F_Exp/Flags/flag_CTRG_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
