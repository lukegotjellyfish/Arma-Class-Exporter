d = {
    "_generalmacro": "Land_ConnectorTent_01_white_cross_F",
    "access": 0,
    "accuracy": 0.1,
    ...
    "attributes": {
        "door_1_hide": {
            ...
            "defaultvalue": "1",
            "displayname": "Hide door #1",
            "expression": "_this animate ['%s',_value,true]",
            "property": "Door_1_Hide"
        },
        "door_2_hide": {
            "control": "CheckboxNumber",
            "defaultvalue": "1",
            "displayname": "Hide door #2",
            "expression": "_this animate ['%s',_value,true]",
            "property": "Door_2_Hide"
        },
        "door_3_hide": {
            "control": "CheckboxNumber",
            "defaultvalue": "1",
            "displayname": "Hide door #3",
            "expression": "_this animate ['%s',_value,true]",
            "property": "Door_3_Hide"
        },
        "door_4_hide": {
            "control": "CheckboxNumber",
            "defaultvalue": "1",
            "displayname": "Hide door #4",
            "expression": "_this animate ['%s',_value,true]",
            "property": "Door_4_Hide"
        }
    },
    "audible": 0,
    ...
    "detectskill": 20,
    "disableinventory": 1,
    "displayname": "Connector Tent (White, Cross)",
    "dlc": "Contact",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/Land_ConnectorTent_01_white_cross_F.jpg",
    ...
    "hiddenselectionstextures": [
        "a3/Structures_F_Orange/Humanitarian/Camps/Data/MedicalTent_01_white_generic_F_CO.paa"
    ],
