d = {
    ...
    "attributes": {
        ...
        "penalty": {
            "control": "Edit",
            "defaultvalue": 200,
            "displayname": "Threat Level Modifier",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmProtectedVehicle_penalty",
            "tooltip": "How much this event will increase the player\u2019s threat level.",
            "typename": "NUMBER"
        },
        "side": {
            "control": "Combo",
            ...
            "displayname": "Side",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmProtectedVehicle_side",
            "tooltip": "Which relation the vehicle affects.",
            "typename": "NUMBER",
            "values": {
                "civilian": {
                    "name": "Civilian",
    ...
    "detectskill": 20,
    "displayname": "Old Man Protected Vehicle",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "moduledescription": {
        ...
        "description": "Vehicle that will be marked as stolen by a given side. It will elicit an appropriate response if taken. Note that all CSAT, NATO, and Gendarmerie vehicles are registered by default. This module must be synchronized to a vehicle. It cannot be used without first adding the Old Man Init. Module.",
        "direction": 0,
