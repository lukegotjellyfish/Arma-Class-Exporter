d = {
    ...
    "attributes": {
        ...
        "onstatechangecode": {
            ...
            "tooltip": "Code that will be executed when sector's state is changed (_this = [sector, state]).",
            "typename": "STRING"
        },
        "qrfenabled": {
            "control": "Checkbox",
    ...
    "moduledescription": {
        ...
        "description": "Module for configuring sectors. All vehicles and groups placed inside will be persistently spawned. Sectors must not overlap! This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
