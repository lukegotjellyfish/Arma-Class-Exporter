d = {
    ...
    "editorpreview": "A3/EditorPreviews_F_Exp/Data/CfgVehicles/Flag_Viper_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F_Exp/Flags/flag_VIPER_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
