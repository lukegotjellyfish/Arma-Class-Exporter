d = {
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Flag_Redstone_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F_Kart/Flags/flag_redstone_co.paa'"
    },
    "extcameraparams": [
        1
    ],
