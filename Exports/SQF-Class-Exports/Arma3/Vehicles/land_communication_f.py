d = {
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Land_Communication_F.jpg",
    ...
    "eventhandlers": {
        "killed": "[(_this select 0)] execVM `/A3/Structures_F/Ind/Transmitter_Tower/Scripts/tower_ruins.sqf"
    },
