d = {
    ...
    "attributes": {
        "destroywhenfinished": {
            ...
            "control": "Checkbox",
            "defaultvalue": "false",
            "displayname": "Destroy When Finished",
            "expression": "_this setVariable ['%s',_value];",
            "property": "DestroyWhenFinished",
            "tooltip": "Whether this timeline should be removed when it finishes playing.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        },
        "eventfinished": {
            ...
            "defaultvalue": "",
            "displayname": "Event Finished",
            "expression": "_this setVariable ['%s',_value];",
            "property": "EventFinished",
            "tooltip": "The timeline finished playing. Here you can script the desired behavior.",
            "typename": "STRING",
            "unique": 0,
            "validate": "none"
        },
        "eventlooped": {
            ...
            "control": "EditCodeMulti5",
            "defaultvalue": "",
            "displayname": "Event Looped",
            "expression": "_this setVariable ['%s',_value];",
            "property": "EventLooped",
            "tooltip": "The timeline loop occurs. Here you can script the desired behavior.",
            "typename": "STRING",
            "unique": 0,
            "validate": "none"
        },
        "eventstarted": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "EventStarted",
            "tooltip": "The timeline started playing. Here you can script the desired behavior.",
            "typename": "STRING",
            "unique": 0,
            "validate": "none"
        },
        "interpmode": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "InterpMode",
            "tooltip": "The Interpolation Mode defines how the alpha from this timeline is computed and applied on simulated objects. Note it will affect the whole animation.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none",
            "values": {
        ...
        "length": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "Length",
            "tooltip": "The length of this timeline in seconds.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        },
        "loop": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "Loop",
            "tooltip": "Whether this timeline should loop.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        },
        "paused": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "Paused",
            "tooltip": "Whether this timeline is paused.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        },
        "playfromstart": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "PlayFromStart",
            "tooltip": "Whether this timeline should start playing when the scenario begins.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        },
        "playrate": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "PlayRate",
            "tooltip": "The play rate of this timeline.",
            "typename": "NUMBER",
            "unique": 0,
            "validate": "none"
        },
        "reverse": {
            ...
            "expression": "_this setVariable ['%s',_value];",
            "property": "Reverse",
            "tooltip": "Whether this timeline should be played in reverse.",
            "typename": "BOOL",
            "unique": 0,
            "validate": "none"
        }
    ...
    "eventhandlers": {
        "keyframeanimation": {
            "attributeschanged3den": "_this call BIS_fnc_timeline_edenAttributesChanged;",
            "connectionchanged3den": "_this call BIS_fnc_timeline_edenConnectionChanged;",
            "deleted": "if (is3DEN) then {_this call BIS_fnc_timeline_edenDeleted} else {_this call BIS_fnc_timeline_deleted};",
            "dragged3den": "_this call BIS_fnc_timeline_edenDragged;",
            "init": "if (is3DEN) then {_this call BIS_fnc_timeline_edenInit} else {_this call BIS_fnc_timeline_init};",
            "registeredtoworld3den": "_this call BIS_fnc_timeline_edenRegisteredToWorld;",
            "unregisteredfromworld3den": "_this call BIS_fnc_timeline_edenUnregisteredFromWorld;"
        }
    },
    "extcameraparams": [
        1
