d = {
    ...
    "moduledescription": {
        ...
        "description": "Initialize Game Master game mode. It lets Zeus to insert respawn module for every involved side first and then gives him challenges to complete. No rules are present, it is up to Zeus what he creates.<br /><br />Mission ends when the time is up (see estimatedTimeLeft scripting command), tickets of one side are depleted (see 'Respawn Tickets' module or BIS_fnc_respawnTickets function) or when the module is deleted.",
        "direction": 0,
