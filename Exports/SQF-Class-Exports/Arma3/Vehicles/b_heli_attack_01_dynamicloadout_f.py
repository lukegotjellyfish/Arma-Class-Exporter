d = {
    "_generalmacro": "B_Heli_Attack_01_dynamicLoadout_F",
    ...
    "library": {
        "libtextdesc": "A two-seat attack helicopter armed with 20 mm Minigun, ASRAAM and DAGR missiles. Even though the construction dates back some time and the program faced cancelation in the first years of the 21st century, the project was finished successfully and the Blackfoot became the first attack helicopter with stealth technology applied even to the main rotor. The Blackfoot is extremely fast, agile and hard to detect even by contemporary sensors, but it's slowly becoming outdated."
    },
    "liftforcecoef": 1.2,
    ...
    "simpleobject": {
        "animate": [
            ...
            [
                "leftholdster_dynloadout",
                0
            ],
            [
                "rightholdster_dynloadout",
                0
            ],
            [
                "hidepg_1",
