d = {
    ...
    "editorpreview": "A3/EditorPreviews_F_Orange/Data/CfgVehicles/Flag_IDAP_F.jpg",
    ...
    "eventhandlers": {
        "init": "(_this select 0) setFlagTexture '/A3/Data_F_Orange/Flags/flag_IDAP_CO.paa'"
    },
    "extcameraparams": [
        1
    ],
