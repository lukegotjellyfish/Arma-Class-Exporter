d = {
    "_generalmacro": "Land_MobileRadar_01_radar_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "attributes": {
        "rotation_speed": {
            ...
            "expression": "_this animateSource ['Radar_Rotation',1e6-1,_value]",
    ...
    "destructioneffects": {
        ...
        "ruin1": {
            ...
            "position": "",
            "simulation": "ruin",
            "type": "A3/Structures_F_Enoch/Military/Radar/MobileRadar_01_radar_ruins_F.p3d"
        },
        "smoke1": {
            "intensity": 0.15,
            "interval": 1,
    ...
    "editorpreview": "A3/EditorPreviews_F_Enoch/Data/CfgVehicles/Land_MobileRadar_01_radar_F.jpg",
