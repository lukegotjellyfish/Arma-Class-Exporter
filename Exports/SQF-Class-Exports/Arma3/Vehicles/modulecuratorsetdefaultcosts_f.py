d = {
    ...
    "moduledescription": {
        ...
        "description": [
            ...
            "The object costs defined are based on the threat level - more dangerous units will be more expensive. Values can range from 1 (minimal threat: used by basic soldiers or empty objects) to 10 (maximal threat: typically airplanes and gunships).",
            "Module cost is tailored for each module specifically."
        ],
        "direction": 0,
