d = {
    "_generalmacro": "C_Offroad_02_unarmed_orange_F",
    ...
    "animationsources": {
        ...
        "hideheadsupportfront": {
            "animperiod": 0.001,
            "author": "Bohemia Interactive",
            "displayname": "Hide front head support",
            "initphase": 0,
            "mass": -2.5,
            "source": "user"
        },
        "hideheadsupportrear": {
            "animperiod": 0.001,
            "author": "Bohemia Interactive",
            "displayname": "Hide rear head support",
            "initphase": 0,
            "mass": -2.5,
            "source": "user"
        },
    ...
    "damage": {
        "mat": [
            ...
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_dash_chrome.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_dash_chrome.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_int_destruct.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_dash_plastic.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_dash_plastic_damage.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_int_destruct.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_ext_chrome.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_ext_chrome.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_ext_destruct.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_ext_metal.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_ext_metal_damage.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_ext_destruct.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_glass.rvmat",
            "A3/data_f/Glass_veh_damage.rvmat",
            "A3/data_f/Glass_veh_damage.rvmat",
            "A3/Soft_F_Exp/Offroad_02/Data/offroad_02_glass_int.rvmat",
            "A3/data_f/Glass_veh_damage.rvmat",
            "A3/data_f/Glass_veh_damage.rvmat",
    ...
    "library": {
        "libtextdesc": "The MB 4WD is a modern four-wheel drive off-road vehicle with a distinctive construction, which could be tracked up to World War II. The vehicle was produced in the US and exists in a number of different editions. A light machine gun or anti-tank recoilless rifle can be mounted on top of the roll cage. Paramilitary groups often use such variants as lightweight weapon carriers. Thanks to the powerful engine, durable chassis and great maneuverability, this vehicle can handle all levels of difficult terrains from dry deserts to humid jungles or artic wastelands."
    },
    ...
    "mfd": {
        "dashboard": {
            ...
            "draw": {
                ...
                "condition": 1,
                "east": {
                    "condition": "(heading >= 67.501) * (heading <= 112.5)",
                    "direction": {
                        "align": "center",
                        "down": [
                            [
                ...
                "north": {
                    "condition": "(heading >= 337.501) + (heading <= 22.5)",
                    "direction": {
                        "align": "center",
                        "down": [
                            [
                ...
                "northeast": {
                    "condition": "(heading >= 22.501) * (heading <= 67.5)",
                    "direction": {
                        "align": "center",
                        "down": [
                            [
                ...
                "northwest": {
                    "condition": "(heading >= 292.501) * (heading <= 337.5)",
                    "direction": {
                        "align": "center",
                        "down": [
                            [
                ...
                "south": {
                    "condition": "(heading >= 157.501) * (heading <= 202.5)",
                    "direction": {
                        "align": "center",
                        "down": [
                            [
                ...
                "southeast": {
                    "condition": "(heading >= 112.501) * (heading <= 157.5)",
                    "direction": {
                        "align": "center",
                        "down": [
                            [
                ...
                "southwest": {
                    "condition": "(heading >= 202.501) * (heading <= 247.5)",
                    "direction": {
                        "align": "center",
                        "down": [
                            [
                ...
                "west": {
                    "condition": "(heading >= 247.501) * (heading <= 292.5)",
                    "direction": {
                        "align": "center",
                        "down": [
                            [
    ...
    "simpleobject": {
        "animate": [
            ...
            [
                "damagehideseats_front",
                0
            ],
            [
                "damagehideseats_rear",
                0
            ],
            [
                "damagehidefuel",
    ...
    "soundengineoffext": [
        "A3/Sounds_F/vehicles2/soft/Offroad_02/Offroad_02_Engine_Ext_stop",
        0.398107,
        1,
        50
    ],
    "soundengineoffint": [
        "A3/Sounds_F/vehicles2/soft/Offroad_02/Offroad_02_Engine_Int_stop",
        0.398107,
        1
    ],
    "soundengineonext": [
        "A3/Sounds_F/vehicles2/soft/Offroad_02/Offroad_02_Engine_Ext_Start",
        0.501187,
        1,
        50
    ],
    "soundengineonint": [
        "A3/Sounds_F/vehicles2/soft/Offroad_02/Offroad_02_Engine_Int_Start",
        0.501187,
        1
    ],
    "soundenviron": [
    ...
    "soundgetin": [
        "A3/Sounds_F/vehicles2/soft/Offroad_02/Offroad_02_Enter",
        0.446684,
        1
    ],
    "soundgetout": [
        "A3/Sounds_F/vehicles2/soft/Offroad_02/Offroad_02_Exit",
        0.446684,
        1,
        40
    ],
