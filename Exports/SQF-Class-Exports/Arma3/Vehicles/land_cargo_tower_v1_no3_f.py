d = {
    "_generalmacro": "Land_Cargo_Tower_V1_No3_F",
    "access": 0,
    "accuracy": 1000,
    ...
    "damage": {
        "mat": [
            "A3/Structures_F/Mil/Cargo/Data/Cargo_Tower_V1_multi.rvmat",
            "A3/Structures_F/Mil/Cargo/Data/destruct_Cargo_Tower_V1_multi.rvmat",
            "A3/Structures_F/Mil/Cargo/Data/destruct_Cargo_Tower_V1_multi.rvmat"
        ],
        "tex": []
    },
    ...
    "destructioneffects": {
        ...
        "ruin1": {
            ...
            "position": "",
            "simulation": "ruin",
            "type": "A3/Structures_F/Mil/Cargo/Cargo_Tower_V1_ruins_F.p3d"
        },
        "smoke1": {
            "intensity": 0.15,
            "interval": 1,
    ...
    "detectskill": 20,
    "displayname": "Military Cargo Tower (#3)",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "editorpreview": "A3/EditorPreviews_F/Data/CfgVehicles/Land_Cargo_Tower_V1_No3_F.jpg",
    ...
    "useractions": {
        ...
        "closehatch_1": {
            "actionnamedsel": "Hatch_1_action",
            "aimaxrange": 6,
            "condition": "((this animationPhase 'Hatch_1_rot') >= 0.5)",
            "displayname": "Close hatch",
            "displaynamedefault": "Close hatch",
            "onlyforplayer": 0,
            "position": "Hatch_1_trigger",
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_1_rot'] call BIS_fnc_HatchClose)"
        },
        "closehatch_2": {
            "actionnamedsel": "Hatch_2_action",
            "aimaxrange": 6,
            "condition": "((this animationPhase 'Hatch_2_rot') >= 0.5)",
            "displayname": "Close hatch",
            "displaynamedefault": "Close hatch",
            "onlyforplayer": 0,
            "position": "Hatch_2_trigger",
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_2_rot'] call BIS_fnc_HatchClose)"
        },
        "closehatch_3": {
            "actionnamedsel": "Hatch_3_action",
            "aimaxrange": 6,
            "condition": "((this animationPhase 'Hatch_3_rot') >= 0.5)",
            "displayname": "Close hatch",
            "displaynamedefault": "Close hatch",
            "onlyforplayer": 0,
            "position": "Hatch_3_trigger",
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_3_rot'] call BIS_fnc_HatchClose)"
        },
        "closehatch_4": {
            "actionnamedsel": "Hatch_4_action",
            "aimaxrange": 6,
            "condition": "((this animationPhase 'Hatch_4_rot') >= 0.5)",
            "displayname": "Close hatch",
            "displaynamedefault": "Close hatch",
            "onlyforplayer": 0,
            "position": "Hatch_4_trigger",
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_4_rot'] call BIS_fnc_HatchClose)"
        },
        "closehatch_5": {
            "actionnamedsel": "Hatch_5_action",
            "aimaxrange": 6,
            "condition": "((this animationPhase 'Hatch_5_rot') >= 0.5)",
            "displayname": "Close hatch",
            "displaynamedefault": "Close hatch",
            "onlyforplayer": 0,
            "position": "Hatch_5_trigger",
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_5_rot'] call BIS_fnc_HatchClose)"
        },
        "closehatch_6": {
            "actionnamedsel": "Hatch_6_action",
            "aimaxrange": 6,
            "condition": "((this animationPhase 'Hatch_6_rot') >= 0.5)",
            "displayname": "Close hatch",
            "displaynamedefault": "Close hatch",
            "onlyforplayer": 0,
            "position": "Hatch_6_trigger",
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_6_rot'] call BIS_fnc_HatchClose)"
        },
        "opendoor_1": {
            "actionnamedsel": "Door_1_action",
            "aimaxrange": 5.25,
        ...
        "openhatch_2": {
            ...
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_2_rot'] call BIS_fnc_HatchOpen)"
        },
        "openhatch_3": {
            "actionnamedsel": "Hatch_3_action",
            "aimaxrange": 6,
            ...
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_3_rot'] call BIS_fnc_HatchOpen)"
        },
        "openhatch_4": {
            "actionnamedsel": "Hatch_4_action",
            "aimaxrange": 6,
            ...
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_4_rot'] call BIS_fnc_HatchOpen)"
        },
        "openhatch_5": {
            "actionnamedsel": "Hatch_5_action",
            "aimaxrange": 6,
            ...
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_5_rot'] call BIS_fnc_HatchOpen)"
        },
        "openhatch_6": {
            "actionnamedsel": "Hatch_6_action",
            "aimaxrange": 6,
            ...
            "priority": 11,
            "radius": 2,
            "statement": "([this, 'Hatch_6_rot'] call BIS_fnc_HatchOpen)"
        }
    },
