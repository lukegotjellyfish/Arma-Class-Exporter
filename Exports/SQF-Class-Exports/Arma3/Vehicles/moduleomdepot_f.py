d = {
    ...
    "attributes": {
        ...
        "depotcondition": {
            ...
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmDepot_DepotCondition",
            "tooltip": "Code that must return true for the depot to become available.",
            "typename": "STRING"
        },
        "edit": {
            "control": "Edit",
        ...
        "name": {
            "control": "Edit",
            "defaultvalue": "Localize `str_a3_smartmarkers_smartmarker_o_depo_f_sections_markertext0",
            "displayname": "Name",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmDepot_Name",
            "tooltip": "Display name of this depot.",
            "typename": "STRING"
        },
        "smartmarker": {
            "control": "Edit",
            "defaultvalue": "SmartMarker_C_Trucks_F",
            "displayname": "Smart marker",
            "expression": "_this setVariable ['%s',_value,true];",
            "property": "ModuleOmDepot_SmartMarker",
    ...
    "detectskill": 20,
    "displayname": "Old Man Drop-off Point",
    "driveraction": "",
    "drivercaneject": 1,
    "drivercansee": "2+8+16",
    ...
    "function": "BIS_fnc_OM_moduleDepot",
    "fxexplo": {
        "access": 1
    },
    "getinaction": "",
    ...
    "moduledescription": {
        ...
        "description": "Player is able to unload/sell equipment inside of the sector area. Synchronize a container so it can be used to store items from inventory. This module cannot be used without first adding the Old Man Init. module.",
        "direction": 0,
    ...
    "portrait": "a3/Ui_f/data/IGUI/Cfg/simpleTasks/letters/d_ca.paa",
    "precision": 5,
    "predictturnplan": 1,
