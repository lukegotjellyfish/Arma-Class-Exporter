rhs_weap_l1a1_base = {
    ...
    # Class: CfgWeapons\rhs_weap_l1a1_base\WeaponSlotsInfo,
    "WeaponSlotsInfo": {
        # Class: CfgWeapons\rhs_weap_l1a1_base\WeaponSlotsInfo\CowsSlot
        "CowsSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
            ...
            # Class: asdg_OpticRailL1A1\compatibleItems,
            "compatibleItems": {
        ...
        "mass": 95,
        # Class: CfgWeapons\rhs_weap_fnfal_base\WeaponSlotsInfo\MuzzleSlot,
        "MuzzleSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
            "iconPicture": "A3|Weapons_F|Data|clear_empty.paa",
            "iconPinPoint": "Left",
            # Class: rhs_FAL_muzzle_slot\compatibleItems,
            "compatibleItems": {
        ...
        # Class: CfgWeapons\rhs_weap_fnfal_base\WeaponSlotsInfo\PointerSlot,
        "PointerSlot": {
        },
        "allowedSlots": [901]
    },
    # Class: CfgWeapons\rhs_weap_l1a1_base\LinkedItems,
    "LinkedItems": {
        # Class: CfgWeapons\rhs_weap_l1a1_base\LinkedItems\LinkedItemsMuzzle
        "LinkedItemsMuzzle": {
            "slot": "MuzzleSlot",
    ...
    # Class: CfgWeapons\rhs_weap_l1a1_base\Single,
    "Single": {
        ...
        # Class: CfgWeapons\rhs_weap_fnfal_base\Single\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHSGREF_fnfal_Shot_SoundSet","RHSGREF_mmg1_Tail_SoundSet"]
        },
        # Class: CfgWeapons\rhs_weap_fnfal_base\Single\SilencedSound,
        "SilencedSound": {
    ...
    # Class: CfgWeapons\rhs_weap_l1a1_base\Single_AI,
    "Single_AI": {
        "aiBurstTerminable": 1,
        "showToPlayer": 0,
        "burstRangeMax": 3,
    ...
    # Class: CfgWeapons\rhs_weap_l1a1_base\single_medium_optics1,
    ...
    # Class: CfgWeapons\rhs_weap_l1a1_base\single_far_optics2,
    "single_far_optics2": {
        "requiredOpticType": 2,
        "minRange": 100,
        "minRangeProbab": 0.1,
    ...
    # Class: CfgWeapons\rhs_weap_fnfal_base\GunParticles,
    "GunParticles": {
        # Class: CfgWeapons\rhs_weap_fnfal_base\GunParticles\SecondEffect
        "SecondEffect": {
            "positionName": "Nabojnicestart",
            "directionName": "Nabojniceend",
            "effectName": "CaselessAmmoCloud"
        },
        # Class: CfgWeapons\rhs_weap_fnfal_base\GunParticles\RHS_BarrelRefract,
        "RHS_BarrelRefract": {
    ...
    # Class: CfgWeapons\rhs_weap_fnfal_base\SAFE,
    "SAFE": {
        "showToPlayer": 0,
        "magazines": [],
        "displayName": "SAFE",
    ...
    # Class: CfgWeapons\rhs_weap_fnfal_base\FullAuto,
    "FullAuto": {
        ...
        "aiRateOfFire": 1e-006,
        "sounds": ["StandardSound","SilencedSound"],
        # Class: CfgWeapons\rhs_weap_fnfal_base\FullAuto\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHSGREF_fnfal_Shot_SoundSet","RHSGREF_mmg1_Tail_SoundSet"]
        },
        # Class: CfgWeapons\rhs_weap_fnfal_base\FullAuto\SilencedSound,
        "SilencedSound": {
            "soundSetShot": ["RHSGREF_sd_fnfal_Shot_SoundSet","RHSGREF_sd_mmg1_Tail_SoundSet"]
        },
        "sound": ["",10,1],
    ...
    # Class: CfgWeapons\rhs_weap_fnfal_base\fullauto_medium,
    "fullauto_medium": {
        "aiBurstTerminable": 1,
        "showToPlayer": 0,
        "burst": 3,
