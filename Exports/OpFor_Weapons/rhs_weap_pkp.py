rhs_weap_pkp = {
    ...
    # Class: CfgWeapons\rhs_weap_pkp\WeaponSlotsInfo,
    "WeaponSlotsInfo": {
        "mass": 191.4,
        # Class: CfgWeapons\rhs_pkp_base\WeaponSlotsInfo\MuzzleSlot,
        "MuzzleSlot": {
        },
        # Class: CfgWeapons\rhs_pkp_base\WeaponSlotsInfo\CowsSlot,
        "CowsSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
        ...
        # Class: CfgWeapons\rhs_pkp_base\WeaponSlotsInfo\PointerSlot,
        "PointerSlot": {
        },
        "allowedSlots": []
    },
    ...
    # Class: CfgWeapons\rhs_pkp_base\close,
    "close": {
        "burst": 6,
        "burstRangeMax": 12,
        "aiRateOfFire": 0.5,
    ...
    # Class: CfgWeapons\rhs_pkp_base\short,
    "short": {
        "burst": 5,
        "burstRangeMax": 10,
        "aiRateOfFire": 2,
    ...
    # Class: CfgWeapons\rhs_pkp_base\medium,
    "medium": {
        "burst": 4,
        "burstRangeMax": 8,
        "aiRateOfFire": 4,
    ...
    # Class: CfgWeapons\rhs_pkp_base\far_optic1,
    "far_optic1": {
        "requiredOpticType": 1,
        "showToPlayer": 0,
        "burst": 3,
    ...
    # Class: CfgWeapons\rhs_pkp_base\far_optic2,
    "far_optic2": {
        "requiredOpticType": 2,
        "autoFire": 0,
        "burst": 2,
