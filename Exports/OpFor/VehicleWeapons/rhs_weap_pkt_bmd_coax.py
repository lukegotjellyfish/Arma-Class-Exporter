rhs_weap_pkt_bmd_coax = {
    # Class: CfgWeapons\rhs_weap_pkt_bmd_coax\gunParticles    "gunParticles": {        # Class: CfgWeapons\rhs_weap_pkt_bmd_coax\gunParticles\effect1        "effect1": {            "effectname": "MachineGunCloud",            "positionname": "Usti hlavne2",            "directionname": "Konec hlavne2"
        }
    },
    "type": 1,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\manual,
    "manual": {
        "displayName": "PKT",
        "autoFire": 1,
        "reloadTime": 0.075,
        ...
        # Class: CfgWeapons\rhs_weap_pkt\manual\StandardSound,
        "StandardSound": {
    ...
    # Class: CfgWeapons\rhs_weap_pkt\close,
    "close": {
        "showToPlayer": 0,
        "soundBurst": 0,
        "burst": 12,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\short,
    "short": {
        "burst": 10,
        "aiRateOfFire": 2,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\medium,
    "medium": {
        "burst": 7,
        "aiRateOfFire": 4,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\far,
    "far": {
        "burst": 6,
        "aiRateOfFire": 5,
