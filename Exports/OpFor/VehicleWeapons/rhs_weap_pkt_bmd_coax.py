rhs_weap_pkt_bmd_coax = {
    # Class: CfgWeapons\rhs_weap_pkt_bmd_coax\gunParticles [Indent level: 1]    "gunParticles": {        # Class: CfgWeapons\rhs_weap_pkt_bmd_coax\gunParticles\effect1 [Indent level: 2]        "effect1": {            "effectname": "MachineGunCloud",            "positionname": "Usti hlavne2",            "directionname": "Konec hlavne2"
        }
    },
    "type": 1,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\manual [Indent level: 1],
    "manual": {
        "displayName": "PKT",
        "autoFire": 1,
        "reloadTime": 0.075,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\close [Indent level: 1],
    "close": {
        "showToPlayer": 0,
        "soundBurst": 0,
        "burst": 12,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\short [Indent level: 1],
    "short": {
        "burst": 10,
        "aiRateOfFire": 2,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\medium [Indent level: 1],
    "medium": {
        "burst": 7,
        "aiRateOfFire": 4,
    ...
    # Class: CfgWeapons\rhs_weap_pkt\far [Indent level: 1],
    "far": {
        "burst": 6,
        "aiRateOfFire": 5,
