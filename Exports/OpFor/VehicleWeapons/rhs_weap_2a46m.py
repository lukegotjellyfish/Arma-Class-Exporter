rhs_weap_2a46m = {
    ...
    # Class: CfgWeapons\rhs_weap_d81\player,
    "player": {
        "aiRateOfFireDistance": 10,
        "aiRateOfFire": 6.6,
        "autoReload": 0,
        # Class: CfgWeapons\rhs_weap_d81\player\StandardSound,
        "StandardSound": {
    ...
    # Class: CfgWeapons\rhs_weap_d81\close,
    "close": {
        "aiRateOfFireDistance": 10,
        "aiRateOfFire": 6.6,
        # Class: CfgWeapons\rhs_weap_d81\close\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHS_120mm_Shot_SoundSet","RHS_120mm_int_Shot_SoundSet","RHS_cannon_Tail_SoundSet"]
        },
        "showToPlayer": 0,
    ...
    # Class: CfgWeapons\rhs_weap_d81\short,
    "short": {
        "aiRateOfFireDistance": 10,
        "aiRateOfFire": 6.6,
        # Class: CfgWeapons\rhs_weap_d81\short\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHS_120mm_Shot_SoundSet","RHS_120mm_int_Shot_SoundSet","RHS_cannon_Tail_SoundSet"]
        },
        "showToPlayer": 0,
    ...
    # Class: CfgWeapons\rhs_weap_d81\medium,
    "medium": {
        "aiRateOfFireDistance": 10,
        "aiRateOfFire": 6.6,
        # Class: CfgWeapons\rhs_weap_d81\medium\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHS_120mm_Shot_SoundSet","RHS_120mm_int_Shot_SoundSet","RHS_cannon_Tail_SoundSet"]
        },
    ...
    # Class: CfgWeapons\rhs_weap_d81\far,
    "far": {
        "aiRateOfFireDistance": 10,
        "aiRateOfFire": 6.6,
        # Class: CfgWeapons\rhs_weap_d81\far\StandardSound,
        "StandardSound": {
            "soundSetShot": ["RHS_120mm_Shot_SoundSet","RHS_120mm_int_Shot_SoundSet","RHS_cannon_Tail_SoundSet"]
        },
        "dispersion": 0.0007125,
