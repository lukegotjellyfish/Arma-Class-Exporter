rhs_weap_s8 = {
    ...
    # Class: CfgWeapons\rhs_weap_s8\Far_AI,
    "Far_AI": {
        "displayName": "S8",
        "aiRateOfFire": 5,
        ...
        # Class: CfgWeapons\rhs_weap_s5\Far_AI\StandardSound,
        "StandardSound": {
    ...
    # Class: CfgWeapons\rhs_weap_s8\Medium_AI,
    "Medium_AI": {
        "displayName": "S8",
        "aiRateOfFire": 3,
        ...
        "maxRangeProbab": 0.1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons\rhs_weap_s5\Medium_AI\StandardSound,
        "StandardSound": {
            "weaponSoundEffect": "DefaultRifle",
            "begin1": ["rhsafrf|addons|rhs_sounds|atgm|atgm_1",2.35,1,1400],
            "begin2": ["rhsafrf|addons|rhs_sounds|atgm|atgm_2",2.35,1,1400],
    ...
    # Class: CfgWeapons\rhs_weap_s8\Close_AI,
    "Close_AI": {
        "displayName": "S8",
        "aiRateOfFire": 0.5,
        ...
        "maxRangeProbab": 0.1,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons\rhs_weap_s5\Close_AI\StandardSound,
        "StandardSound": {
            "weaponSoundEffect": "DefaultRifle",
            "begin1": ["rhsafrf|addons|rhs_sounds|atgm|atgm_1",2.35,1,1400],
            "begin2": ["rhsafrf|addons|rhs_sounds|atgm|atgm_2",2.35,1,1400],
    ...
    # Class: CfgWeapons\rhs_weap_s8\AI_Burst,
    "AI_Burst": {
        "dispersion": 0.032,
        "displayName": "S8",
        "showToPlayer": 0,
    ...
    # Class: CfgWeapons\rhs_weap_s8\Burst,
    "Burst": {
        "dispersion": 0.032,
        "displayName": "S8",
        "showToPlayer": 1,
        ...
        "maxRangeProbab": 0.05,
        "sounds": ["StandardSound"],
        # Class: CfgWeapons\rhs_weap_s5\Burst\StandardSound,
        "StandardSound": {
            "weaponSoundEffect": "DefaultRifle",
            "begin1": ["rhsafrf|addons|rhs_sounds|atgm|atgm_1",2.35,1,1400],
            "begin2": ["rhsafrf|addons|rhs_sounds|atgm|atgm_2",2.35,1,1400],
    ...
    # Class: CfgWeapons\rhs_weap_s5\gunClouds,
    "gunClouds": {
    },
    "fireLightAmbient": [0,0,0],
    ...
    # Class: CfgWeapons\rhs_weap_s5\Burst_AI,
    "Burst_AI": {
        "sounds": ["StandardSound"],
        # Class: CfgWeapons\rhs_weap_s5\Burst_AI\StandardSound,
        "StandardSound": {
            "weaponSoundEffect": "DefaultRifle",
            "begin1": ["rhsafrf|addons|rhs_sounds|atgm|atgm_1",2.35,1,1400],
            "begin2": ["rhsafrf|addons|rhs_sounds|atgm|atgm_2",2.35,1,1400],
