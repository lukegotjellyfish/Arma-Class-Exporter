rhs_weap_pkt_btr80a = {
    # Class: CfgWeapons\rhs_weap_pkt_btr80a\gunParticles [Indent level: 1]    "gunParticles": {        # Class: CfgWeapons\rhs_weap_pkt_btr80a\gunParticles\effect1 [Indent level: 2]        "effect1": {            "effectname": "MachineGunCloud",            "positionname": "kulas",            "directionname": "kulas end"
        },        # Class: CfgWeapons\rhs_weap_pkt_btr80a\gunParticles\effect2 [Indent level: 2],        "effect2": {            "effectName": "MachineGunCartridge2",            "positionName": "machinegun_eject_pos",            "directionName": "machinegun_eject_dir"
        }
    },
    "type": 1,
