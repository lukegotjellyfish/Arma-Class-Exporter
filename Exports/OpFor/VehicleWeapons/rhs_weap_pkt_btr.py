rhs_weap_pkt_btr = {
    # Class: CfgWeapons\rhs_weap_pkt_btr\gunParticles [Indent level: 1]    "gunParticles": {        # Class: CfgWeapons\rhs_weap_pkt_btr\gunParticles\effect1 [Indent level: 2]        "effect1": {            "effectname": "MachineGunCloud",            "positionname": "kulas",            "directionname": "kulas end"
        }
    },
    "type": 1,
