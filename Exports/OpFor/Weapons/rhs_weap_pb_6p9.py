rhs_weap_pb_6p9 = {
    ...
    "picture": "rhsafrf|addons|rhs_inventoryicons|data|weapons|rhs_weap_pb_6p9_ca.paa",
    "displayname": "6P9",
    "model": "rhsafrf|addons|rhs_weapons3|pb6p9|6p9",
    "baseweapon": "rhs_weap_pb_6p9",
    # Class: CfgWeapons|rhs_weap_pb_6p9|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "holsterscale": 0.94,
        # Class: CfgWeapons|rhs_weap_pb_6p9|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
            "iconposition": [0,0],
            "iconscale": 1,
            ...
            "compatibleitems": ["rhs_acc_6p9_suppressor"],
            "access": 1,
            "scope": 0
        },
        "mass": 16.72,
    ...
    # Class: CfgWeapons|rhs_weap_pb_6p9|LinkedItems [Indent level: 1],
    "linkeditems": {
        # Class: CfgWeapons|rhs_weap_pb_6p9|LinkedItems|LinkedItemsMuzzle [Indent level: 2]
        "linkeditemsmuzzle": {
            "slot": "MuzzleSlot",
            "item": "rhs_acc_6p9_suppressor"
        }
    },
    "scope": 2,
