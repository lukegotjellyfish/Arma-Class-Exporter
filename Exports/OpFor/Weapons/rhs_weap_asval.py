rhs_weap_asval = {
    ...
    # Class: CfgWeapons|rhs_weap_asval|WeaponSlotsInfo [Indent level: 1],
    "WeaponSlotsInfo": {
        "mass": 65.12,
        # Class: CfgWeapons|rhs_weap_asval|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "MuzzleSlot": {
        },
        # Class: CfgWeapons|rhs_weap_asval|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "CowsSlot": {
            # Class: CfgWeapons|rhs_weap_asval|WeaponSlotsInfo|CowsSlot|compatibleItems [Indent level: 3],
        ...
        # Class: CfgWeapons|rhs_weap_asval|WeaponSlotsInfo|rhs_npz_slot [Indent level: 2],
        "rhs_npz_slot": {
        ...
        # Class: CfgWeapons|rhs_weap_asval|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "PointerSlot": {
        },
        "allowedSlots": [901]
    },
