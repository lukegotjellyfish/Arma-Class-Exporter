rhs_weap_tt33 = {
    ...
    "model": "rhsgref|addons|rhsgref_weapons|tt33|rhs_tt33",
    "modeloptics": "-",
    # Class: CfgWeapons|rhs_weap_tt33|SAFE_PISTOL [Indent level: 1],
    "safe_pistol": {
        "discretedistance": [25],
    ...
    # Class: CfgWeapons|rhs_weap_tt33|WeaponSlotsInfo [Indent level: 1],
    "weaponslotsinfo": {
        "mass": 18.26,
        # Class: CfgWeapons|rhs_weap_tt33|WeaponSlotsInfo|CowsSlot [Indent level: 2],
        "cowsslot": {
            "iconposition": [0,0],
            "iconscale": 1,
        ...
        # Class: CfgWeapons|rhs_weap_tt33|WeaponSlotsInfo|MuzzleSlot [Indent level: 2],
        "muzzleslot": {
        },
        # Class: CfgWeapons|rhs_weap_tt33|WeaponSlotsInfo|PointerSlot [Indent level: 2],
        "pointerslot": {
        },
    ...
    # Class: CfgWeapons|rhs_weap_tt33|Single [Indent level: 1],
    "single": {
        # Class: CfgWeapons|rhs_weap_tt33|Single|StandardSound [Indent level: 2]
        "standardsound": {
            "soundsetshot": ["RHSGREF_tokarev_Shot_SoundSet","RHSGREF_Pistol1_Tail_SoundSet"]
        },
        # Class: CfgWeapons|rhs_weap_tt33|Single|SilencedSound [Indent level: 2],
        "silencedsound": {
            "soundsetshot": ["RHSGREF_tokarev_Shot_SoundSet","RHSGREF_Pistol1_Tail_SoundSet"]
        },
        "multiplier": 1,
