rhs_weap_pkm = {
    ...
    # Class: CfgWeapons\rhs_weap_pkm\WeaponSlotsInfo [Indent level: 1],
    "WeaponSlotsInfo": {
        "mass": 165,
        # Class: CfgWeapons\rhs_weap_pkm\WeaponSlotsInfo\MuzzleSlot [Indent level: 2],
        "MuzzleSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
        ...
        # Class: CfgWeapons\rhs_weap_pkm\WeaponSlotsInfo\CowsSlot [Indent level: 2],
        "CowsSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
            "iconPicture": "A3|Weapons_F|Data|clear_empty.paa",
        ...
        # Class: CfgWeapons\rhs_weap_pkm\WeaponSlotsInfo\PointerSlot [Indent level: 2],
        "PointerSlot": {
            "iconPosition": [0,0],
            "iconScale": 1,
            "iconPicture": "A3|Weapons_F|Data|clear_empty.paa",
    ...
    # Class: CfgWeapons\rhs_weap_pkm\manual [Indent level: 1],
    "manual": {
        "reloadTime": 0.092,
        "dispersion": 0.00093,
        "soundContinuous": 0,
    ...
    # Class: CfgWeapons\rhs_weap_pkm\close [Indent level: 1],
    "close": {
        "burst": 6,
        "burstRangeMax": 12,
        "aiRateOfFire": 0.5,
    ...
    # Class: CfgWeapons\rhs_weap_pkm\short [Indent level: 1],
    "short": {
        "burst": 6,
        "burstRangeMax": 10,
        "aiRateOfFire": 2,
    ...
    # Class: CfgWeapons\rhs_weap_pkm\medium [Indent level: 1],
    "medium": {
        "burst": 5,
        "burstRangeMax": 9,
        "aiRateOfFire": 4,
    ...
    # Class: CfgWeapons\rhs_weap_pkm\far_optic1 [Indent level: 1],
    "far_optic1": {
        "requiredOpticType": 1,
        "showToPlayer": 0,
        "burst": 3,
    ...
    # Class: CfgWeapons\rhs_weap_pkm\far_optic2 [Indent level: 1],
    "far_optic2": {
        "burst": 3,
        "burstRangeMax": 6,
        "requiredOpticType": 2,
