rhs_t72bd_tv = {
    ...
    # Class: CfgVehicles\rhs_t72bd_tv\textureSources [Indent level: 1],
    "textureSources": {
        # Class: CfgVehicles\rhs_t72bd_tv\textureSources\standard [Indent level: 2]
        "standard": {
        ...
        # Class: CfgVehicles\rhs_t72bd_tv\textureSources\rhs_Sand [Indent level: 2],
        "rhs_Sand": {
