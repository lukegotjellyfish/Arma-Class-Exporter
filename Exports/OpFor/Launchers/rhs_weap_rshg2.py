rhs_weap_rshg2 = {
    ...
    "modelOptics": "-",
    "dispersion": 0.18,
    # Class: CfgWeapons\rhs_weap_rshg2\OpticsModes,
    "OpticsModes": {
        # Class: CfgWeapons\rhs_weap_rshg2\OpticsModes\ironsight
        "ironsight": {
            "opticsID": 2,
        ...
        # Class: CfgWeapons\rhs_weap_rshg2\OpticsModes\ironsight2,
        "ironsight2": {
            "opticsID": 1,
    ...
    # Class: CfgWeapons\rhs_weap_rshg2\GunParticles,
    "GunParticles": {
        # Class: CfgWeapons\rhs_weap_rshg2\GunParticles\effect1
        "effect1": {
    ...
    # Class: CfgWeapons\rhs_weap_rshg2\Library,
    "Library": {
        "libTextDesc": "The RShG-2 is a disposable thermobaric rocket launcher derived from the RPG-26."
    },
    # Class: CfgWeapons\rhs_weap_rshg2\ItemInfo,
    "ItemInfo": {
        "priority": 3,
        "RMBhint": "RShG-2",
        "onHoverText": "RShG-2"
    },
    # Class: CfgWeapons\rhs_weap_rshg2\WeaponSlotsInfo,
    "WeaponSlotsInfo": {
        "allowedSlots": [901],
        "mass": 83.6
    },
    ...
    # Class: CfgWeapons\rhs_weap_rpg26\StandardSound,
    "StandardSound": {
    ...
    "optics": 1,
    # Class: CfgWeapons\rhs_weap_rpg26\Eventhandlers,
    "Eventhandlers": {
        # Class: CfgWeapons\rhs_weap_rpg26\Eventhandlers\RHS_DisposableWeapon
